...
--*************************************************************************************
--*                                                                                   *
--* File Name:               TT_RPT4_Test_Unsupported_Bridge.adb
...
package body TT_RPT4_Test_Unsupported_Bridge is
   
   procedure TT_RPT4_Test_Unsupported (
...
--
   ...
   end TT_RPT4_Test_Unsupported;
   
end TT_RPT4_Test_Unsupported_Bridge;

--
-- End of file TT_RPT4_Test_Unsupported_Bridge.adb
--
