...
--*************************************************************************************
--*                                                                                   *
--* File Name:               TT_RPT6_Domain_Test_Start_Bridge.adb
...
--*  -----------------                                                                *
--*                                                                                   *
--*  Project Key Letter : Timers_Build_Set
--*  Project Version    : 0
--*  Build Set          : 0
--*                                                                                   *
--*  Build Target       : Dos
...
package body TT_RPT6_Domain_Test_Start_Bridge is
   
   procedure TT_RPT6_Domain_Test_Start (
...
--
         ...
         Root_Object.TT.RD.TT_RD_type(My_Report.all).Reported_Domain_Number := New_Domain_Number;
         
      end if;
      
      
   end TT_RPT6_Domain_Test_Start;
   
end TT_RPT6_Domain_Test_Start_Bridge;

--
-- End of file TT_RPT6_Domain_Test_Start_Bridge.adb
--
