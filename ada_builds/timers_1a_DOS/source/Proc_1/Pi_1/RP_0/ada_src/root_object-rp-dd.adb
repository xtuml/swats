...
------------------------------------------------------------------------
--
package body Root_Object.RP.DD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Domain_Number_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Domain_Number return Application_Types.Base_Integer_Type is
   begin
      Domain_Number_Value :=
         Application_Types.Base_Integer_Type'succ (Domain_Number_Value);
      return Domain_Number_Value;
   end Obtain_Subsequent_Domain_Number;
...
--ADATEST IGNORE_ON
   ...
   begin
       return RP_DD_Type (This_Object.all).Domain_Number;
   end Get_Domain_Number;
...
--ADATEST IGNORE_ON
   procedure Put_Domain_Number (
      This_Object : in Root_Object.Object_Access;
      Domain_Number_Value : in Application_Types.Base_Integer_Type) is
   begin
      RP_DD_Type (This_Object.all).Domain_Number :=
         Domain_Number_Value;
   end Put_Domain_Number;
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_DD_Type (This_Object.all).Domain_Name;
   end Get_Domain_Name;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Domain_Name (
      This_Object : in Root_Object.Object_Access;
      Domain_Name_Value : in Application_Types.Base_Text_Type) is
   begin
      RP_DD_Type (This_Object.all).Domain_Name :=
         Domain_Name_Value;
   end Put_Domain_Name;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Last_Reported_Test_Number (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return RP_DD_Type (This_Object.all).Last_Reported_Test_Number;
   end Get_Last_Reported_Test_Number;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Last_Reported_Test_Number (
      This_Object : in Root_Object.Object_Access;
      Last_Reported_Test_Number_Value : in Application_Types.Base_Integer_Type) is
   begin
      RP_DD_Type (This_Object.all).Last_Reported_Test_Number :=
         Last_Reported_Test_Number_Value;
   end Put_Last_Reported_Test_Number;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------
   --
   -- procedure Put_Unique_TS_Identifier and 
   --
   -- function Get_Unique_TS_Identifier
   --
   -- have not been generated for Unique_TS_Identifier
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_DD_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      RP_DD_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_DD_Type (This_Object.all).R1_B;
   end Get_R1_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      RP_DD_Type (This_Object.all).R1_B :=
         R1_B_Value;
   end Put_R1_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R2_B (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return RP_DD_Type (This_Object.all).R2_B;
   end Get_R2_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R2_B (
      This_Object : in Root_Object.Object_Access;
      R2_B_Value : in Root_Object.Object_Access) is
   begin
      RP_DD_Type (This_Object.all).R2_B :=
         R2_B_Value;
   end Put_R2_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R3_B (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return RP_DD_Type (This_Object.all).R3_B;
   end Get_R3_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      RP_DD_Type (This_Object.all).R3_B :=
         R3_B_Value;
   end Put_R3_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_DD_Type (This_Object.all).R4_B;
   end Get_R4_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R4_B (
      This_Object : in Root_Object.Object_Access;
      R4_B_Value : in Root_Object.Object_List.List_Header_Access_Type) is
   begin
      RP_DD_Type (This_Object.all).R4_B :=
         R4_B_Value;
   end Put_R4_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_R8_B  (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_List.List_Header_Access_Type is
   begin
      return RP_DD_Type (This_Object.all).R8_B;
   end Get_R8_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R8_B (
      This_Object : in Root_Object.Object_Access;
      R8_B_Value : in Root_Object.Object_List.List_Header_Access_Type) is
   begin
      RP_DD_Type (This_Object.all).R8_B :=
         R8_B_Value;
   end Put_R8_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R10_A (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return RP_DD_Type (This_Object.all).R10_A;
   end Get_R10_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R10_A (
      This_Object : in Root_Object.Object_Access;
      R10_A_Value : in Root_Object.Object_Access) is
   begin
      RP_DD_Type (This_Object.all).R10_A :=
         R10_A_Value;
   end Put_R10_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_R9_B  (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_List.List_Header_Access_Type is
   begin
      return RP_DD_Type (This_Object.all).R9_B;
   end Get_R9_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R9_B (
      This_Object : in Root_Object.Object_Access;
      R9_B_Value : in Root_Object.Object_List.List_Header_Access_Type) is
   begin
      RP_DD_Type (This_Object.all).R9_B :=
         R9_B_Value;
   end Put_R9_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new RP_DD_Type;
   
         RP_DD_Type(This_Object.all).R4_B := Root_Object.Object_List.Initialise;
         RP_DD_Type(This_Object.all).R8_B := Root_Object.Object_List.Initialise;
         RP_DD_Type(This_Object.all).R9_B := Root_Object.Object_List.Initialise;
      else
         This_Object := Free_List.First_Entry;
         RP_DD_Type(This_Object.all).Domain_Number := Application_Types.Base_Integer_Type_First;
         RP_DD_Type(This_Object.all).Domain_Name := Application_Types.Base_Text_Type_First;
         RP_DD_Type(This_Object.all).Last_Reported_Test_Number := Application_Types.Base_Integer_Type_First;
         RP_DD_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      RP_DD_Type(This_Object.all).Domain_Number :=
         Obtain_Subsequent_Domain_Number;
...
--
   procedure DD1_To_Report_Your_Findings (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      RP_DD_Type (This_Instance.all).Current_State := 
         Root_Object.RP.DD.Object_State_Type(Report_Your_Findings);

      RP_DD_2 (
         This_Instance => This_Instance );

   end DD1_To_Report_Your_Findings;
--
   procedure DD2_To_Kill_Yourself (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      RP_DD_Type (This_Instance.all).Current_State := 
         Root_Object.RP.DD.Object_State_Type(Kill_Yourself);

      RP_DD_3 (
         This_Instance => This_Instance );

   end DD2_To_Kill_Yourself;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     RP_DD_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     RP_DD_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      RP_DD_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => RP_DD_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return RP_DD_Event_Queue.Queue_Length (RP_DD_Queue);
...
--
   This_Event_Dispatch_Matrix (DD1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (DD2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (DD1, Idle) := DD1_To_Report_Your_Findings'access;
   This_Event_Dispatch_Matrix (DD2, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (DD1, Report_Your_Findings) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (DD2, Report_Your_Findings) := DD2_To_Kill_Yourself'access;

end Root_Object.RP.DD;
