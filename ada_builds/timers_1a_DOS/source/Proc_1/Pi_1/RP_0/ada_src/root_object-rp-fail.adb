...
--* Description:             
--*                          Domain body Root_Object.RPFAIL
...
------------------------------------------------------------------------
--
package body Root_Object.RP.FAIL is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   fail_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_fail_id return Application_Types.Base_Integer_Type is
   begin
      fail_id_Value :=
         Application_Types.Base_Integer_Type'succ (fail_id_Value);
      return fail_id_Value;
   end Obtain_Subsequent_fail_id;
...
--ADATEST IGNORE_ON
   procedure Put_fail_id (
      This_Object : in Root_Object.Object_Access;
      fail_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      RP_FAIL_Type (This_Object.all).fail_id :=
         fail_id_Value;
   end Put_fail_id;
...
--ADATEST IGNORE_ON
   function Get_Failed_Counter (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return RP_FAIL_Type (This_Object.all).Failed_Counter;
   end Get_Failed_Counter;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Failed_Counter (
      This_Object : in Root_Object.Object_Access;
      Failed_Counter_Value : in Application_Types.Base_Integer_Type) is
   begin
      RP_FAIL_Type (This_Object.all).Failed_Counter :=
         Failed_Counter_Value;
   end Put_Failed_Counter;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_FAIL_Type (This_Object.all).R2_A;
   end Get_R2_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      RP_FAIL_Type (This_Object.all).R2_A :=
         R2_A_Value;
   end Put_R2_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new RP_FAIL_Type;
   
      else
         This_Object := Free_List.First_Entry;
         RP_FAIL_Type(This_Object.all).fail_id := Application_Types.Base_Integer_Type_First;
         RP_FAIL_Type(This_Object.all).Failed_Counter := Application_Types.Base_Integer_Type_First;
