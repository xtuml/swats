...
--* Description:             
--*                          Domain specification Root_Object.TTT
...
package Root_Object.TT.T is
--
------------------------------------------------------------------------
   --
   --**************  Object Test Information **************
   --
   -- Object T is PASSIVE
   --
   -- Object T participates in a super sub type relationship
   --
   --
   --
   -- Object T is a SUPER type of 
   --    BT,
   --    U,
   --    DT,
   --    RT,
   ...
   --    via Relationship R2
   --
   -- Object T has an identifying non-referential attribute id 
   -- and therefore may be uniquely created.
   -- 
   -- Object T has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "T";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TT_T_Type is new TT_Type with record
   ...
   procedure Put_R1_A (
      This_Object :   in  Root_Object.Object_Access;
      R1_A_Value : in Root_Object.Object_Access);

   pragma inline (Get_R1_A);
   pragma inline (Put_R1_A);
   ...
   --
   type TT_T_Event_Type is new TT_Event_Type with
   record
   ...
   --    
   type TT_T_Instance_Event_Type is new TT_T_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type TT_T_Description_Event is new TT_T_Instance_Event_Type with
   record
      null;
   end record;
   --
   ...
   --
   --
   type TT_T1 is new TT_T_Instance_Event_Type with
   record 
      null;
   end record;
   --
   type TT_T2 is new TT_T_Instance_Event_Type with
   record 
      null;
   end record;
