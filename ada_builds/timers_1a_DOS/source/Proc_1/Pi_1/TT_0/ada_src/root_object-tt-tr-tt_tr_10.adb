...
separate(Root_Object.TT.TR)
   ...
   procedure TT_TR_10 (This_Instance : in out Root_Object.Object_Access) is
   ...
   begin
      ...
      TT_RPT3_Test_Failed_Bridge.TT_RPT3_Test_Failed (
         Failed_Domain_Object => "Get_Time_Remaining returns 0 for",
      ...
      begin
         Pushed_Event := new
         Root_Object.TT.TR.TT_TR10'(Root_Object.Root_Event_Type with
            This_Event_Class => Root_Object.TT.TR.TR10,
