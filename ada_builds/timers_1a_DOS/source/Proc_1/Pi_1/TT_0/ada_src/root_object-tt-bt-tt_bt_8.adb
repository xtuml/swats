...
separate(Root_Object.TT.BT)
   ...
   begin
      ...
      Timer.Create_Timer (Timer_ID       => Root_Object.TT.BT.TT_BT_type(This_Instance.all).timer_id_one);
      Timer.Create_Timer (Timer_ID       => Root_Object.TT.BT.TT_BT_type(This_Instance.all).timer_id_two);
