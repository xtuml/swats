...
separate(Root_Object.TT.TS)
   ...
   procedure TT_TS_2 (test_instance : in     Root_Object.Object_Access;
   ...
   begin
      ...
      if (the_next_test /= Null) then
         ...
         begin
            Pushed_Event := new
            Root_Object.TT.TS.TT_TS4'(Root_Object.Root_Event_Type with
               This_Event_Class => Root_Object.TT.TS.TS4,
