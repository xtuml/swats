...
--* Description:             
--*                          Domain specification Root_Object.TTU
...
package Root_Object.TT.U is
--
------------------------------------------------------------------------
   --
   --**************  Object Unsupported Information **************
   --
   -- Object U is ACTIVE
   --
   -- Object U participates in a super sub type relationship
   --
   --
   --
   -- Object U is ACTIVE and has the following state actions defined
   --   Non_Existent,
   --   idle,
   --   complete,
   --   log_test_results,
   --   deletion.
   --
   -- Object U is a SUB type of T via Relationship R2
   --
   -- Object U has an identifying non-referential attribute id 
   -- and therefore may be uniquely created.
   -- 
   -- Object U has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "U";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TT_U_Type is new TT_Type with record
   ...
   -- EVENT DECLARATION
   --
   type TT_U_Event_Type is new TT_Event_Type with
   record
   ...
   --    
   type TT_U_Instance_Event_Type is new TT_U_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type TT_U_Description_Event is new TT_U_Instance_Event_Type with
   record
      null;
   end record;  
   --
   ...
   type TT_U1 is new TT_U_Instance_Event_Type with
   record 
      null;
   end record;

   type TT_T1 is new TT_U_Instance_Event_Type with
   record 
      null;
   end record;

   type TT_T2 is new TT_U_Instance_Event_Type with
   record 
      null;
   end record;
   ...
   package TT_U_Event_Queue is new Generic_FIFO (Root_Object.Root_Event_Access_Type); 

   TT_U_Queue: TT_U_Event_Queue.FIFO_Type;
