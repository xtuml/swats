...
------------------------------------------------------------------------
--
package body Root_Object.TT.TS is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return TT_TS_Type (This_Object.all).id;
   end Get_id;
...
------------------------------------------------------------------------
   --
   -- procedure Put_initial_test_id and 
   --
   -- function Get_initial_test_id
   --
   -- have not been generated for initial_test_id
   -- as this attribute is non-identifying referential.
   --
------------------------------------------------------------------------
   --
   -- procedure Put_report_data_id and 
   --
   -- function Get_report_data_id
   --
   -- have not been generated for report_data_id
   -- as this attribute is non-identifying referential.
   --
------------------------------------------------------------------------

--ADATEST IGNORE_ON
   function Get_current_test_number (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TT_TS_Type (This_Object.all).current_test_number;
   end Get_current_test_number;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_current_test_number (
      This_Object : in Root_Object.Object_Access;
      current_test_number_Value : in Application_Types.Base_Integer_Type) is
   begin
      TT_TS_Type (This_Object.all).current_test_number :=
         current_test_number_Value;
   end Put_current_test_number;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return TT_TS_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      TT_TS_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return TT_TS_Type (This_Object.all).R1_B;
   end Get_R1_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R1_B (
      This_Object : in Root_Object.Object_Access;
      R1_B_Value : in Root_Object.Object_Access) is
   begin
      TT_TS_Type (This_Object.all).R1_B :=
         R1_B_Value;
   end Put_R1_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R3_B (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return TT_TS_Type (This_Object.all).R3_B;
   end Get_R3_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R3_B (
      This_Object : in Root_Object.Object_Access;
      R3_B_Value : in Root_Object.Object_Access) is
   begin
      TT_TS_Type (This_Object.all).R3_B :=
         R3_B_Value;
   end Put_R3_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new TT_TS_Type;
   
      else
         This_Object := Free_List.First_Entry;
         TT_TS_Type(This_Object.all).id := Application_Types.Base_Integer_Type_First;
         TT_TS_Type(This_Object.all).current_test_number := Application_Types.Base_Integer_Type_First;
         TT_TS_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure TT_TS_2 (
      test_instance : in  Root_Object.Object_Access;
      This_Instance : in out Root_Object.Object_Access ) is separate;
...
--
   procedure TS1_To_setup (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      TT_TS_Type (This_Instance.all).Current_State := 
         Root_Object.TT.TS.Object_State_Type(setup);
...
--
   procedure TS2_To_perform_subsequent_tests (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      TT_TS_Type (This_Instance.all).Current_State := 
         Root_Object.TT.TS.Object_State_Type(perform_subsequent_tests);

      TT_TS_2 (
         test_instance =>  TT_TS2(This_Event.all).test_instance,
         This_Instance => This_Instance );

   end TS2_To_perform_subsequent_tests;
--
   procedure TS4_To_finished (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      TT_TS_Type (This_Instance.all).Current_State := 
         Root_Object.TT.TS.Object_State_Type(finished);
...
--
   procedure TS3_To_perform_first_test (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      TT_TS_Type (This_Instance.all).Current_State := 
         Root_Object.TT.TS.Object_State_Type(perform_first_test);

      TT_TS_9 (
         test_instance =>  TT_TS3(This_Event.all).test_instance,
         This_Instance => This_Instance );

   end TS3_To_perform_first_test;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     TT_TS_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     TT_TS_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      TT_TS_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => TT_TS_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return TT_TS_Event_Queue.Queue_Length (TT_TS_Queue);
...
--
   This_Event_Dispatch_Matrix (TS1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TS2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TS3, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TS4, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TS1, idle) := TS1_To_setup'access;
   This_Event_Dispatch_Matrix (TS2, idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TS3, idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TS4, idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TS1, perform_subsequent_tests) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TS2, perform_subsequent_tests) := TS2_To_perform_subsequent_tests'access;
   This_Event_Dispatch_Matrix (TS3, perform_subsequent_tests) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TS4, perform_subsequent_tests) := TS4_To_finished'access;
   This_Event_Dispatch_Matrix (TS1, setup) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TS2, setup) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TS3, setup) := TS3_To_perform_first_test'access;
   This_Event_Dispatch_Matrix (TS4, setup) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TS1, perform_first_test) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TS2, perform_first_test) := TS2_To_perform_subsequent_tests'access;
   This_Event_Dispatch_Matrix (TS3, perform_first_test) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TS4, perform_first_test) :=  Cannot_Happen_Action'access;

end Root_Object.TT.TS;
