...
separate(Root_Object.TT.BT)
   ...
   procedure TT_BT_4 (This_Instance : in out Root_Object.Object_Access) is
   ...
   begin
      ...
      begin
         ...
         Timer.Set_Timer (
            Timer_ID       => Root_Object.TT.BT.TT_BT_type(This_Instance.all).timer_id_two,
            Time_Remaining => 5000,
