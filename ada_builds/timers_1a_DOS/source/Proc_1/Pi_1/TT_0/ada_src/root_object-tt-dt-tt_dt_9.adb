...
separate(Root_Object.TT.DT)
   ...
   begin
      ...
      Timer.Create_Timer (Timer_ID       => Root_Object.TT.DT.TT_DT_type(This_Instance.all).timer_id_one);
      Timer.Create_Timer (Timer_ID       => Root_Object.TT.DT.TT_DT_type(This_Instance.all).timer_id_two);
