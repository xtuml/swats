...
------------------------------------------------------------------------
--
package body Root_Object.TT.BT is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return TT_BT_Type (This_Object.all).id;
   end Get_id;
...
--ADATEST IGNORE_ON
   function Get_test_id (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TT_BT_Type (This_Object.all).test_id;
   end Get_test_id;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TT_BT_Type (This_Object.all).test_id :=
         test_id_Value;
   end Put_test_id;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_timer_id_one (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TT_BT_Type (This_Object.all).timer_id_one;
...
--ADATEST IGNORE_ON
   ...
   begin
      TT_BT_Type (This_Object.all).timer_id_one :=
         timer_id_one_Value;
...
--ADATEST IGNORE_ON
   function Get_timer_id_two (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TT_BT_Type (This_Object.all).timer_id_two;
...
--ADATEST IGNORE_ON
   ...
   begin
      TT_BT_Type (This_Object.all).timer_id_two :=
         timer_id_two_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return TT_BT_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      TT_BT_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return TT_BT_Type (This_Object.all).R2_Super;
   end Get_R2_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TT_BT_Type (This_Object.all).R2_Super :=
         R2_Super_Value;
   end Put_R2_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new TT_BT_Type;
   
      else
         This_Object := Free_List.First_Entry;
         TT_BT_Type(This_Object.all).id := Application_Types.Base_Integer_Type_First;
         TT_BT_Type(This_Object.all).test_id := Application_Types.Base_Integer_Type_First;
         TT_BT_Type(This_Object.all).timer_id_one := Application_Types.Base_Integer_Type_First;
         TT_BT_Type(This_Object.all).timer_id_two := Application_Types.Base_Integer_Type_First;
         TT_BT_Type(This_Object.all).Current_State :=  Object_State_Type_First;
   ...
   begin
      ...
      case Parent_Event_Type is
         ...
         when Root_Object.TT.T.T1 =>
            ...
            Next_Event := new Root_Object.TT.BT.TT_T1'(
            Root_Event_Type with
               This_Event_Class => Root_Object.TT.BT.T1,
               Target_Instance  => This_Object'Unchecked_Access);

         when Root_Object.TT.T.T2 =>

            Next_Event := new Root_Object.TT.BT.TT_T2'(
            Root_Event_Type with
               This_Event_Class => Root_Object.TT.BT.T2,
               Target_Instance  => This_Object'Unchecked_Access);
...
--
   ...
   begin
      ...
      TT_BT_Type (This_Instance.all).Current_State := 
         Root_Object.TT.BT.Object_State_Type(setup);
...
--
   procedure BT1_To_executing_part_two (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      TT_BT_Type (This_Instance.all).Current_State := 
         Root_Object.TT.BT.Object_State_Type(executing_part_two);

      TT_BT_4 (
         This_Instance => This_Instance );

   end BT1_To_executing_part_two;
--
   ...
   begin
      ...
      TT_BT_Type (This_Instance.all).Current_State := 
         Root_Object.TT.BT.Object_State_Type(deletion);
...
--
   ...
   begin
      ...
      TT_BT_Type (This_Instance.all).Current_State := 
         Root_Object.TT.BT.Object_State_Type(test_passed);

      TT_BT_5 (
         This_Instance => This_Instance );

   end BT1_To_test_passed;
--
   procedure BT2_To_complete (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      TT_BT_Type (This_Instance.all).Current_State := 
         Root_Object.TT.BT.Object_State_Type(complete);
...
--
   procedure BT3_To_executing_part_one (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      TT_BT_Type (This_Instance.all).Current_State := 
         Root_Object.TT.BT.Object_State_Type(executing_part_one);

      TT_BT_2 (
         This_Instance => This_Instance );

   end BT3_To_executing_part_one;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     TT_BT_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     TT_BT_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      TT_BT_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => TT_BT_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return TT_BT_Event_Queue.Queue_Length (TT_BT_Queue);
...
--
   ...
   This_Event_Dispatch_Matrix (BT1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BT2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BT3, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (T1, idle) := T1_To_setup'access;
   This_Event_Dispatch_Matrix (T2, idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (BT1, idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BT2, idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BT3, idle) :=  Cannot_Happen_Action'access;
   ...
   This_Event_Dispatch_Matrix (BT1, executing_part_one) := BT1_To_executing_part_two'access;
   This_Event_Dispatch_Matrix (BT2, executing_part_one) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BT3, executing_part_one) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (T1, complete) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (T2, complete) := T2_To_deletion'access;
   This_Event_Dispatch_Matrix (BT1, complete) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BT2, complete) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BT3, complete) :=  Cannot_Happen_Action'access;
   ...
   This_Event_Dispatch_Matrix (BT1, executing_part_two) := BT1_To_test_passed'access;
   This_Event_Dispatch_Matrix (BT2, executing_part_two) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BT3, executing_part_two) :=  Cannot_Happen_Action'access;
   ...
   This_Event_Dispatch_Matrix (BT1, test_passed) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BT2, test_passed) := BT2_To_complete'access;
   This_Event_Dispatch_Matrix (BT3, test_passed) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (T1, setup) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (T2, setup) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (BT1, setup) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BT2, setup) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BT3, setup) := BT3_To_executing_part_one'access;

end Root_Object.TT.BT;
