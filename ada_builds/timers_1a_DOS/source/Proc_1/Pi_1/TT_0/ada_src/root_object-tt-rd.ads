...
--* Description:             
--*                          Domain specification Root_Object.TTRD
...
------------------------------------------------------------------------
   ...
   --
   --
   -- Object RD has an identifying non-referential attribute id 
   ...
   type TT_RD_Type is new TT_Type with record
