...
separate(Root_Object.TT.TR)
   ...
   procedure TT_TR_9 (This_Instance : in out Root_Object.Object_Access) is
   ...
   begin
      ...
      begin
         Pushed_Event := new
         Root_Object.TT.TR.TT_TR9'(Root_Object.Root_Event_Type with
            This_Event_Class => Root_Object.TT.TR.TR9,
