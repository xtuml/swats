...
separate(Root_Object.TT.RT)
   ...
   procedure TT_RT_9 (This_Instance : in out Root_Object.Object_Access) is
   ...
   begin
      ...
      TT_RPT3_Test_Failed_Bridge.TT_RPT3_Test_Failed (
         Failed_Domain_Object => "Reset_Timer                     ",
      ...
      begin
         Pushed_Event := new
         Root_Object.TT.RT.TT_RT6'(Root_Object.Root_Event_Type with
            This_Event_Class => Root_Object.TT.RT.RT6,
