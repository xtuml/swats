...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.drenemy.ads
...
--* Description:             
--*                          Domain specification Root_Object.Creation_Deletiondrenemy
...
--  ----------------------------------  
--  package Root_Object.Creation_Deletion.drenemy
...
package Root_Object.Creation_Deletion.drenemy is
--
------------------------------------------------------------------------
   --
   --**************  Object Doctors_Enemy Information **************
   --
   -- Object drenemy is PASSIVE
   --
   --
   --
   -- Object drenemy does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object drenemy has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "drenemy";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Creation_Deletion_drenemy_Type is new Creation_Deletion_Type with record
      ...
      -- Actor : Creation_Deletion_Domain_Types.actors_who_have_played_the_doctor;
   
      --
      -- Initialised Non identifying non referential
      battlefield_arena : Creation_Deletion_Domain_Types.battlefield_arena_type := Creation_Deletion_Domain_Types.battlefield_arena_type_First;
   ...
   procedure Put_Humanoid (
      ...
      Humanoid_Value : in  Boolean);

   pragma inline (Get_Humanoid);
   pragma inline (Put_Humanoid);


   function Get_battlefield_arena (
      This_Object : Root_Object.Object_Access) 
   return Creation_Deletion_Domain_Types.battlefield_arena_type;

   procedure Put_battlefield_arena (
      This_Object : in Root_Object.Object_Access;
      battlefield_arena_Value : in Creation_Deletion_Domain_Types.battlefield_arena_type);

   pragma inline (Get_battlefield_arena);
   pragma inline (Put_battlefield_arena);
