...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.objB.adb
...
--* Description:             
--*                          Domain body Root_Object.Creation_DeletionobjB
...
------------------------------------------------------------------------
--
package body Root_Object.Creation_Deletion.objB is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return Creation_Deletion_objB_Type (This_Object.all).ReferenceB;
   end Get_ReferenceB;
...
--ADATEST IGNORE_ON
   ...
   begin
      Creation_Deletion_objB_Type (This_Object.all).ReferenceB :=
         ReferenceB_Value;
   end Put_ReferenceB;
...
--ADATEST IGNORE_ON
   function Get_IntegerA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Creation_Deletion_objB_Type (This_Object.all).IntegerA;
   end Get_IntegerA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Creation_Deletion_objB_Type (This_Object.all).IntegerA :=
         IntegerA_Value;
   end Put_IntegerA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Creation_Deletion_objB_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Creation_Deletion_objB_Type(This_Object.all).ReferenceB := Application_Types.Base_Integer_Type_First;
         Creation_Deletion_objB_Type(This_Object.all).IntegerA := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Creation_Deletion.objB;
