...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Creation_Deletion_objCS_4.ada
...
separate(Root_Object.Creation_Deletion.objCS)
   ...
   procedure Creation_Deletion_objCS_4 (This_Instance : in out Root_Object.Object_Access) is
   ...
   end Creation_Deletion_objCS_4;
   
--
-- End of file Creation_Deletion_objCS_4.ada
--
