...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.objD.adb
...
--* Description:             
--*                          Domain body Root_Object.Creation_DeletionobjD
...
------------------------------------------------------------------------
--
package body Root_Object.Creation_Deletion.objD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return Creation_Deletion_objD_Type (This_Object.all).ReferenceD;
   end Get_ReferenceD;
...
--ADATEST IGNORE_ON
   ...
   begin
      Creation_Deletion_objD_Type (This_Object.all).ReferenceD :=
         ReferenceD_Value;
   end Put_ReferenceD;
...
--ADATEST IGNORE_ON
   function Get_IntegerA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Creation_Deletion_objD_Type (This_Object.all).IntegerA;
   end Get_IntegerA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Creation_Deletion_objD_Type (This_Object.all).IntegerA :=
         IntegerA_Value;
   end Put_IntegerA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Creation_Deletion_objD_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Creation_Deletion_objD_Type(This_Object.all).ReferenceD := Application_Types.Base_Integer_Type_First;
         Creation_Deletion_objD_Type(This_Object.all).IntegerA := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Creation_Deletion.objD;
