...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.objA.ads
...
--* Description:             
--*                          Domain specification Root_Object.Creation_DeletionobjA
...
--  ----------------------------------  
--  package Root_Object.Creation_Deletion.objA
...
package Root_Object.Creation_Deletion.objA is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_A Information **************
   --
   -- Object objA is PASSIVE
   --
   --
   --
   ...
   type Creation_Deletion_objA_Type is new Creation_Deletion_Type with record
      ...
      IntegerA : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      TextA : Application_Types.Base_Text_Type := Application_Types.Base_Text_Type_First;
      ...
      --
      -- Initialised Non identifying non referential
      ColourA : Creation_Deletion_Domain_Types.Base_Colour := Creation_Deletion_Domain_Types.Base_Colour_First;
   ...
   procedure Put_IntegerA (
      This_Object : in Root_Object.Object_Access;
      IntegerA_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_IntegerA);
   pragma inline (Put_IntegerA);
   ...
   procedure Put_TextA (
      This_Object : in Root_Object.Object_Access;
      TextA_Value : in Application_Types.Base_Text_Type);

   pragma inline (Get_TextA);
   pragma inline (Put_TextA);
   ...
   procedure Put_BooleanA (
      This_Object : in Root_Object.Object_Access;
      BooleanA_Value : in  Boolean);

   pragma inline (Get_BooleanA);
   pragma inline (Put_BooleanA);


   function Get_ColourA (
      This_Object : Root_Object.Object_Access) 
   return Creation_Deletion_Domain_Types.Base_Colour;

   procedure Put_ColourA (
      This_Object : in Root_Object.Object_Access;
      ColourA_Value : in Creation_Deletion_Domain_Types.Base_Colour);

   pragma inline (Get_ColourA);
   pragma inline (Put_ColourA);
