...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.fandc.adb
...
--* Description:             
--*                          Domain body Root_Object.Creation_Deletionfandc
...
------------------------------------------------------------------------
--
package body Root_Object.Creation_Deletion.fandc is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   function Get_Coloured (
      This_Object: Root_Object.Object_Access) return Creation_Deletion_Domain_Types.Coloured_Type is
   begin
      return Creation_Deletion_fandc_Type (This_Object.all).Coloured;
   end Get_Coloured;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Coloured (
      This_Object : in Root_Object.Object_Access;
      Coloured_Value : in Creation_Deletion_Domain_Types.Coloured_Type) is
   begin
      Creation_Deletion_fandc_Type (This_Object.all).Coloured :=
         Coloured_Value;
   end Put_Coloured;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Flavoured (
      This_Object: Root_Object.Object_Access) return Creation_Deletion_Domain_Types.Flavoured_Type is
   begin
      return Creation_Deletion_fandc_Type (This_Object.all).Flavoured;
   end Get_Flavoured;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Flavoured (
      This_Object : in Root_Object.Object_Access;
      Flavoured_Value : in Creation_Deletion_Domain_Types.Flavoured_Type) is
   begin
      Creation_Deletion_fandc_Type (This_Object.all).Flavoured :=
         Flavoured_Value;
   end Put_Flavoured;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Dish_Number (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Creation_Deletion_fandc_Type (This_Object.all).Dish_Number;
   end Get_Dish_Number;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Dish_Number (
      This_Object : in Root_Object.Object_Access;
      Dish_Number_Value : in Application_Types.Base_Integer_Type) is
   begin
      Creation_Deletion_fandc_Type (This_Object.all).Dish_Number :=
         Dish_Number_Value;
   end Put_Dish_Number;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Creation_Deletion_fandc_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Creation_Deletion_fandc_Type(This_Object.all).Coloured := Creation_Deletion_Domain_Types.Coloured_Type_First;
         Creation_Deletion_fandc_Type(This_Object.all).Flavoured := Creation_Deletion_Domain_Types.Flavoured_Type_First;
         Creation_Deletion_fandc_Type(This_Object.all).Dish_Number := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Creation_Deletion.fandc;
