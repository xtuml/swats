...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Creation_Deletion_coloured1_Colourize_It_Service.ads
...
package Creation_Deletion_coloured1_Colourize_It_Service is
   
   
   procedure Creation_Deletion_coloured1_Colourize_It (
      Test_Number     : in     Application_Types.Base_Integer_Type;
      Returned_Number :    out Application_Types.Base_Integer_Type);
   
end Creation_Deletion_coloured1_Colourize_It_Service;

--
-- End of file Creation_Deletion_coloured1_Colourize_It_Service.ads
--
