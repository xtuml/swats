...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.objC.ads
...
--* Description:             
--*                          Domain specification Root_Object.Creation_DeletionobjC
...
--  ----------------------------------  
--  package Root_Object.Creation_Deletion.objC
...
package Root_Object.Creation_Deletion.objC is
--
------------------------------------------------------------------------
   --
   ...
   --
   --
   -- Object objC has an identifying non-referential attribute Reference1C 
   -- and therefore may be uniquely created.
   --
   -- Object objC has an identifying non-referential attribute Reference2C 
   -- and therefore may be uniquely created.
   -- 
   ...
   type Creation_Deletion_objC_Type is new Creation_Deletion_Type with record

      --
      -- Non initialised identifying non referential
      Reference1C : Application_Types.Base_Integer_Type;

      --
      -- Non initialised identifying non referential
      Reference2C : Application_Types.Base_Integer_Type;
   ...
   procedure Put_Reference1C (
      ...
      Reference1C_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Reference1C);
   pragma inline (Put_Reference1C);
   ...
   procedure Put_Reference2C (
      This_Object : in Root_Object.Object_Access;
      Reference2C_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Reference2C);
   pragma inline (Put_Reference2C);
