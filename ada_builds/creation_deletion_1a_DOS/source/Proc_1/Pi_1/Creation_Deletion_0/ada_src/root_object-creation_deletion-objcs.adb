...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.objCS.adb
...
--* Description:             
--*                          Domain body Root_Object.Creation_DeletionobjCS
...
------------------------------------------------------------------------
--
package body Root_Object.Creation_Deletion.objCS is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   ReferenceCS_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceCS return Application_Types.Base_Integer_Type is
   begin
      ReferenceCS_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceCS_Value);
      return ReferenceCS_Value;
   end Obtain_Subsequent_ReferenceCS;
...
--ADATEST IGNORE_ON
   function Get_ReferenceCS (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return Creation_Deletion_objCS_Type (This_Object.all).ReferenceCS;
   end Get_ReferenceCS;
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceCS (
      This_Object : in Root_Object.Object_Access;
      ReferenceCS_Value : in Application_Types.Base_Integer_Type) is
   begin
      Creation_Deletion_objCS_Type (This_Object.all).ReferenceCS :=
         ReferenceCS_Value;
   end Put_ReferenceCS;
...
--ADATEST IGNORE_ON
   function Get_ResultCS (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Creation_Deletion_objCS_Type (This_Object.all).ResultCS;
   end Get_ResultCS;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_ResultCS (
      This_Object : in Root_Object.Object_Access;
      ResultCS_Value : in Application_Types.Base_Integer_Type) is
   begin
      Creation_Deletion_objCS_Type (This_Object.all).ResultCS :=
         ResultCS_Value;
   end Put_ResultCS;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Creation_Deletion_objCS_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Creation_Deletion_objCS_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Creation_Deletion_objCS_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Creation_Deletion_objCS_Type(This_Object.all).ReferenceCS := Application_Types.Base_Integer_Type_First;
         Creation_Deletion_objCS_Type(This_Object.all).ResultCS := Application_Types.Base_Integer_Type_First;
         Creation_Deletion_objCS_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure Creation_Deletion_objCS_1 (
      Test : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Creation_Deletion_objCS_3 (
      Test : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Creation_Deletion_objCS_4 (
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Creation_Deletion_objCS_5 (
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure objCS1_To_Instance_creation (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Creation_Deletion_objCS_Type (This_Instance.all).Current_State := 
         Root_Object.Creation_Deletion.objCS.Object_State_Type(Instance_creation);

      Creation_Deletion_objCS_1 (
         Test =>  Creation_Deletion_objCS1(This_Event.all).Test,
         This_Instance => This_Instance );

   end objCS1_To_Instance_creation;
--
   procedure objCS4_To_Verify_instance_creation (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Creation_Deletion_objCS_Type (This_Instance.all).Current_State := 
         Root_Object.Creation_Deletion.objCS.Object_State_Type(Verify_instance_creation);

      Creation_Deletion_objCS_3 (
         Test =>  Creation_Deletion_objCS4(This_Event.all).Test,
         This_Instance => This_Instance );

   end objCS4_To_Verify_instance_creation;
--
   procedure objCS3_To_Fail (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Creation_Deletion_objCS_Type (This_Instance.all).Current_State := 
         Root_Object.Creation_Deletion.objCS.Object_State_Type(Fail);

      Creation_Deletion_objCS_4 (
         This_Instance => This_Instance );

   end objCS3_To_Fail;
--
   procedure objCS5_To_Passed (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Creation_Deletion_objCS_Type (This_Instance.all).Current_State := 
         Root_Object.Creation_Deletion.objCS.Object_State_Type(Passed);

      Creation_Deletion_objCS_5 (
         This_Instance => This_Instance );

   end objCS5_To_Passed;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Creation_Deletion_objCS_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Creation_Deletion_objCS_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Creation_Deletion_objCS_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Creation_Deletion_objCS_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Creation_Deletion_objCS_Event_Queue.Pop (
         Item        => Temp_Event,
         Target_FIFO => Creation_Deletion_objCS_Queue);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Creation_Deletion_objCS_Event_Queue.Queue_Length (Creation_Deletion_objCS_Queue);
...
--ADATEST IGNORE_ON
   procedure Put_Event (
      ...
      To_Class : in Creation_Deletion_objCS_Type;
...
--
   This_Event_Dispatch_Matrix (objCS1, Non_Existent) := objCS1_To_Instance_creation'access;
   This_Event_Dispatch_Matrix (objCS2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objCS3, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objCS4, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objCS5, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objCS1, Instance_creation) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objCS2, Instance_creation) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objCS3, Instance_creation) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objCS4, Instance_creation) := objCS4_To_Verify_instance_creation'access;
   This_Event_Dispatch_Matrix (objCS5, Instance_creation) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objCS1, Verify_instance_creation) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objCS2, Verify_instance_creation) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objCS3, Verify_instance_creation) := objCS3_To_Fail'access;
   This_Event_Dispatch_Matrix (objCS4, Verify_instance_creation) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objCS5, Verify_instance_creation) := objCS5_To_Passed'access;
   This_Event_Dispatch_Matrix (objCS1, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objCS2, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objCS3, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objCS4, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objCS5, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objCS1, Passed) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objCS2, Passed) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objCS3, Passed) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objCS4, Passed) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objCS5, Passed) :=  Ignore_Action'access;

end Root_Object.Creation_Deletion.objCS;
