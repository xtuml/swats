...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.coloured.ads
...
--* Description:             
--*                          Domain specification Root_Object.Creation_Deletioncoloured
...
--  ----------------------------------  
--  package Root_Object.Creation_Deletion.coloured
...
package Root_Object.Creation_Deletion.coloured is
--
------------------------------------------------------------------------
   --
   --**************  Object Coloured_Object Information **************
   --
   -- Object coloured is PASSIVE
   --
   --
   --
   -- Object coloured has an identifying non-referential attribute Coloured 
   -- and therefore may be uniquely created.
   -- 
   -- Object coloured has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "coloured";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Creation_Deletion_coloured_Type is new Creation_Deletion_Type with record
      ...
      Intensity : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_Intensity (
      This_Object : in Root_Object.Object_Access;
      Intensity_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Intensity);
   pragma inline (Put_Intensity);
