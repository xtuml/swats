...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.enemy.adb
...
--* Description:             
--*                          Domain body Root_Object.Creation_Deletionenemy
...
------------------------------------------------------------------------
--
package body Root_Object.Creation_Deletion.enemy is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Humanoid_Value :  Boolean := Application_Types.Boolean_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Humanoid return  Boolean is
   begin
      Humanoid_Value :=
          Boolean'succ (Humanoid_Value);
      return Humanoid_Value;
   end Obtain_Subsequent_Humanoid;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Creation_Deletion_enemy_Type (This_Object.all).Humanoid;
   end Get_Humanoid;
...
--ADATEST IGNORE_ON
   ...
   begin
      Creation_Deletion_enemy_Type (This_Object.all).Humanoid :=
         Humanoid_Value;
   end Put_Humanoid;
...
--ADATEST IGNORE_ON
   function Get_can_climb_stairs (
      This_Object: Root_Object.Object_Access) return  Boolean is
   begin
      return Creation_Deletion_enemy_Type (This_Object.all).can_climb_stairs;
   end Get_can_climb_stairs;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_can_climb_stairs (
      This_Object : in Root_Object.Object_Access;
      can_climb_stairs_Value : in  Boolean) is
   begin
      Creation_Deletion_enemy_Type (This_Object.all).can_climb_stairs :=
         can_climb_stairs_Value;
   end Put_can_climb_stairs;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Creation_Deletion_enemy_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Creation_Deletion_enemy_Type(This_Object.all).Humanoid := Application_Types.Boolean_First;
         Creation_Deletion_enemy_Type(This_Object.all).can_climb_stairs := Application_Types.Boolean_First;
...
end Root_Object.Creation_Deletion.enemy;
