...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.drenemy.adb
...
--* Description:             
--*                          Domain body Root_Object.Creation_Deletiondrenemy
...
------------------------------------------------------------------------
--
package body Root_Object.Creation_Deletion.drenemy is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Creation_Deletion_drenemy_Type (This_Object.all).Humanoid;
   end Get_Humanoid;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Humanoid (
      This_Object : in Root_Object.Object_Access;
      Humanoid_Value : in  Boolean) is
   begin
      Creation_Deletion_drenemy_Type (This_Object.all).Humanoid :=
         Humanoid_Value;
   end Put_Humanoid;
--ADATEST IGNORE_OFF
...
------------------------------------------------------------------------
   --
   -- procedure Put_Actor and 
   --
   -- function Get_Actor
   --
   -- have not been generated for Actor
   -- as this attribute is non-identifying referential.
   --
------------------------------------------------------------------------

--ADATEST IGNORE_ON
   function Get_battlefield_arena (
      This_Object: Root_Object.Object_Access) return Creation_Deletion_Domain_Types.battlefield_arena_type is
   begin
      return Creation_Deletion_drenemy_Type (This_Object.all).battlefield_arena;
   end Get_battlefield_arena;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_battlefield_arena (
      This_Object : in Root_Object.Object_Access;
      battlefield_arena_Value : in Creation_Deletion_Domain_Types.battlefield_arena_type) is
   begin
      Creation_Deletion_drenemy_Type (This_Object.all).battlefield_arena :=
         battlefield_arena_Value;
   end Put_battlefield_arena;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Creation_Deletion_drenemy_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Creation_Deletion_drenemy_Type(This_Object.all).Humanoid := Application_Types.Boolean_First;
         Creation_Deletion_drenemy_Type(This_Object.all).battlefield_arena := Creation_Deletion_Domain_Types.battlefield_arena_type_First;
...
end Root_Object.Creation_Deletion.drenemy;
