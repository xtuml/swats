...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.flavoured.ads
...
--* Description:             
--*                          Domain specification Root_Object.Creation_Deletionflavoured
...
--  ----------------------------------  
--  package Root_Object.Creation_Deletion.flavoured
...
package Root_Object.Creation_Deletion.flavoured is
--
------------------------------------------------------------------------
   --
   --**************  Object Flavoured_Object Information **************
   --
   -- Object flavoured is PASSIVE
   --
   --
   --
   -- Object flavoured has an identifying non-referential attribute Flavoured 
   -- and therefore may be uniquely created.
   -- 
   -- Object flavoured has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "flavoured";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Creation_Deletion_flavoured_Type is new Creation_Deletion_Type with record
      ...
      How_Spicy : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_How_Spicy (
      This_Object : in Root_Object.Object_Access;
      How_Spicy_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_How_Spicy);
   pragma inline (Put_How_Spicy);
