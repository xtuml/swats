...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.objA.adb
...
--* Description:             
--*                          Domain body Root_Object.Creation_DeletionobjA
...
------------------------------------------------------------------------
--
package body Root_Object.Creation_Deletion.objA is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return Creation_Deletion_objA_Type (This_Object.all).ReferenceA;
   end Get_ReferenceA;
...
--ADATEST IGNORE_ON
   ...
   begin
      Creation_Deletion_objA_Type (This_Object.all).ReferenceA :=
         ReferenceA_Value;
   end Put_ReferenceA;
...
--ADATEST IGNORE_ON
   function Get_IntegerA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Creation_Deletion_objA_Type (This_Object.all).IntegerA;
   end Get_IntegerA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_IntegerA (
      This_Object : in Root_Object.Object_Access;
      IntegerA_Value : in Application_Types.Base_Integer_Type) is
   begin
      Creation_Deletion_objA_Type (This_Object.all).IntegerA :=
         IntegerA_Value;
   end Put_IntegerA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Creation_Deletion_objA_Type (This_Object.all).TextA;
   end Get_TextA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_TextA (
      This_Object : in Root_Object.Object_Access;
      TextA_Value : in Application_Types.Base_Text_Type) is
   begin
      Creation_Deletion_objA_Type (This_Object.all).TextA :=
         TextA_Value;
   end Put_TextA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_BooleanA (
      This_Object: Root_Object.Object_Access) return  Boolean is
   begin
      return Creation_Deletion_objA_Type (This_Object.all).BooleanA;
   end Get_BooleanA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_BooleanA (
      This_Object : in Root_Object.Object_Access;
      BooleanA_Value : in  Boolean) is
   begin
      Creation_Deletion_objA_Type (This_Object.all).BooleanA :=
         BooleanA_Value;
   end Put_BooleanA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_ColourA (
      This_Object: Root_Object.Object_Access) return Creation_Deletion_Domain_Types.Base_Colour is
   begin
      return Creation_Deletion_objA_Type (This_Object.all).ColourA;
   end Get_ColourA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_ColourA (
      This_Object : in Root_Object.Object_Access;
      ColourA_Value : in Creation_Deletion_Domain_Types.Base_Colour) is
   begin
      Creation_Deletion_objA_Type (This_Object.all).ColourA :=
         ColourA_Value;
   end Put_ColourA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Creation_Deletion_objA_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Creation_Deletion_objA_Type(This_Object.all).ReferenceA := Application_Types.Base_Integer_Type_First;
         Creation_Deletion_objA_Type(This_Object.all).IntegerA := Application_Types.Base_Integer_Type_First;
         Creation_Deletion_objA_Type(This_Object.all).TextA := Application_Types.Base_Text_Type_First;
         Creation_Deletion_objA_Type(This_Object.all).BooleanA := Application_Types.Boolean_First;
         Creation_Deletion_objA_Type(This_Object.all).ColourA := Creation_Deletion_Domain_Types.Base_Colour_First;
...
end Root_Object.Creation_Deletion.objA;
