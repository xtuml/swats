...
--*************************************************************************************
--*                                                                                   *
--* File Name:               RP_DD3_A_Test_Is_Unsupported_Service.adb
...
with RP_UNSUPPORTED1_Not_Done_It_Yet_Service;
...
package body RP_DD3_A_Test_Is_Unsupported_Service is
   
   procedure RP_DD3_A_Test_Is_Unsupported (
      New_Test_Number : in     Application_Types.Base_Integer_Type;
      Invoking_Domain : in     Application_Types.Base_Integer_Type) is
   ...
   begin
   -- start of DD3_A_Test_Is_Unsupported
      ...
      RP_RP13_Requirement_Tracker_Service.RP_RP13_Requirement_Tracker (
         ...
         Updated_Result      => RP_Domain_Types.Unsupported);
      ...
      if The_Domain_IH /= Null then
         ...
         if New_Test_Number /= Root_Object.RP.DD.RP_DD_type(The_Domain_IH.all).Last_Reported_Test_Number then
            ...
            RP_UNSUPPORTED1_Not_Done_It_Yet_Service.RP_UNSUPPORTED1_Not_Done_It_Yet (
            ...
            Root_Object.RP.RESULTS.RP_RESULTS_Type(new_results_of_test_instance.all).The_Result_Of_Test    := RP_Domain_Types.Unsupported;
            Root_Object.RP.RESULTS.RP_RESULTS_Type(new_results_of_test_instance.all).The_Value_Of_The_Result         := 0;
            ...
            Root_Object.RP.RESULTS.RP_RESULTS_Type(new_results_of_test_instance.all).Domain_Test_Details     := "                                ";
            ...
            if Matching_Test_Details /= Null then
               ...
               RP_RP9_Test_Anomalous_Behaviour_Service.RP_RP9_Test_Anomalous_Behaviour (
                  ...
                  Anomalous_Detail      => "Unsupported. No Test Details Fou");
            ...
            if the_d_r_ih =  Null then
               ...
               if Previous_Reported_Result /= Null then
                  ...
                  if Root_Object.RP.RESULTS.RP_RESULTS_type(Previous_Reported_Result.all).The_Result_Of_Test /= RP_Domain_Types.Unsupported then
                     
                     RP_RP9_Test_Anomalous_Behaviour_Service.RP_RP9_Test_Anomalous_Behaviour (
                        Anomalous_Test_Number => New_Test_Number,
                        Anomalous_Detail      => "Inconsistent duplicated unsuppor");
                  ...
                  RP_RP9_Test_Anomalous_Behaviour_Service.RP_RP9_Test_Anomalous_Behaviour (
                     Anomalous_Test_Number => New_Test_Number,
                     Anomalous_Detail      => "Error in duplication of test uns");
   ...
   end RP_DD3_A_Test_Is_Unsupported;
   
end RP_DD3_A_Test_Is_Unsupported_Service;

--
-- End of file RP_DD3_A_Test_Is_Unsupported_Service.adb
--
