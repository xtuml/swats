...
------------------------------------------------------------------------
--
package body Root_Object.RP.TD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_TD_Type (This_Object.all).Domain_Number;
...
--ADATEST IGNORE_ON
   ...
   begin
      RP_TD_Type (This_Object.all).Domain_Number :=
         Domain_Number_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_TD_Type (This_Object.all).Test_Purpose;
   end Get_Test_Purpose;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Test_Purpose (
      This_Object : in Root_Object.Object_Access;
      Test_Purpose_Value : in Application_Types.Base_Text_Type) is
   begin
      RP_TD_Type (This_Object.all).Test_Purpose :=
         Test_Purpose_Value;
   end Put_Test_Purpose;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   function Get_Tested_Object (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Text_Type is
   begin
      return RP_TD_Type (This_Object.all).Tested_Object;
   end Get_Tested_Object;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Tested_Object (
      This_Object : in Root_Object.Object_Access;
      Tested_Object_Value : in Application_Types.Base_Text_Type) is
   begin
      RP_TD_Type (This_Object.all).Tested_Object :=
         Tested_Object_Value;
   end Put_Tested_Object;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_The_Test_No (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return RP_TD_Type (This_Object.all).The_Test_No;
   end Get_The_Test_No;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      RP_TD_Type (This_Object.all).The_Test_No :=
         The_Test_No_Value;
   end Put_The_Test_No;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Result_Found (
      This_Object: Root_Object.Object_Access) return  Boolean is
   begin
      return RP_TD_Type (This_Object.all).Result_Found;
   end Get_Result_Found;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Result_Found (
      This_Object : in Root_Object.Object_Access;
      Result_Found_Value : in  Boolean) is
   begin
      RP_TD_Type (This_Object.all).Result_Found :=
         Result_Found_Value;
   end Put_Result_Found;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_TD_Type (This_Object.all).R8_A;
   end Get_R8_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R8_A (
      This_Object : in Root_Object.Object_Access;
      R8_A_Value : in Root_Object.Object_Access) is
   begin
      RP_TD_Type (This_Object.all).R8_A :=
         R8_A_Value;
   end Put_R8_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R6_B (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return RP_TD_Type (This_Object.all).R6_B;
   end Get_R6_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R6_B (
      This_Object : in Root_Object.Object_Access;
      R6_B_Value : in Root_Object.Object_Access) is
   begin
      RP_TD_Type (This_Object.all).R6_B :=
         R6_B_Value;
   end Put_R6_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_TD_Type (This_Object.all).R7_B;
   end Get_R7_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R7_B (
      This_Object : in Root_Object.Object_Access;
      R7_B_Value : in Root_Object.Object_List.List_Header_Access_Type) is
   begin
      RP_TD_Type (This_Object.all).R7_B :=
         R7_B_Value;
   end Put_R7_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new RP_TD_Type;
   
         RP_TD_Type(This_Object.all).R7_B := Root_Object.Object_List.Initialise;
      else
         This_Object := Free_List.First_Entry;
         RP_TD_Type(This_Object.all).Domain_Number := Application_Types.Base_Integer_Type_First;
         RP_TD_Type(This_Object.all).Test_Purpose := Application_Types.Base_Text_Type_First;
         RP_TD_Type(This_Object.all).Tested_Object := Application_Types.Base_Text_Type_First;
         RP_TD_Type(This_Object.all).The_Test_No := Application_Types.Base_Integer_Type_First;
         RP_TD_Type(This_Object.all).Result_Found := Application_Types.Boolean_First;
