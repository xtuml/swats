...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Creation_Deletion_RPT2_Test_Passed_Bridge.adb
...
package body Creation_Deletion_RPT2_Test_Passed_Bridge is
   
   procedure Creation_Deletion_RPT2_Test_Passed (
...
--
   ...
   end Creation_Deletion_RPT2_Test_Passed;
   
end Creation_Deletion_RPT2_Test_Passed_Bridge;

--
-- End of file Creation_Deletion_RPT2_Test_Passed_Bridge.adb
--
