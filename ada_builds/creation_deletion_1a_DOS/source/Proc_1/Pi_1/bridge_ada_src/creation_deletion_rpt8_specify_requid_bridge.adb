...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Creation_Deletion_RPT8_Specify_Requid_Bridge.adb
...
package body Creation_Deletion_RPT8_Specify_Requid_Bridge is
   
   procedure Creation_Deletion_RPT8_Specify_Requid (
...
--
   ...
   end Creation_Deletion_RPT8_Specify_Requid;
   
end Creation_Deletion_RPT8_Specify_Requid_Bridge;

--
-- End of file Creation_Deletion_RPT8_Specify_Requid_Bridge.adb
--
