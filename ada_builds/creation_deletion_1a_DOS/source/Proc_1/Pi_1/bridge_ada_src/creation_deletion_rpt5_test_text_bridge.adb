...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Creation_Deletion_RPT5_Test_Text_Bridge.adb
...
package body Creation_Deletion_RPT5_Test_Text_Bridge is
   
   procedure Creation_Deletion_RPT5_Test_Text (
...
--
   ...
   end Creation_Deletion_RPT5_Test_Text;
   
end Creation_Deletion_RPT5_Test_Text_Bridge;

--
-- End of file Creation_Deletion_RPT5_Test_Text_Bridge.adb
--
