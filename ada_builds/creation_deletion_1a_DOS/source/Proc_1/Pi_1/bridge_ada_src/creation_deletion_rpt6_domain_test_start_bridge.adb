...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Creation_Deletion_RPT6_Domain_Test_Start_Bridge.adb
...
package body Creation_Deletion_RPT6_Domain_Test_Start_Bridge is
   
   procedure Creation_Deletion_RPT6_Domain_Test_Start (
...
--
         ...
         Root_Object.Creation_Deletion.RD.Creation_Deletion_RD_type(My_Report.all).Reported_Domain_Number := New_Domain_Number;
         
      end if;
      
      
   end Creation_Deletion_RPT6_Domain_Test_Start;
   
end Creation_Deletion_RPT6_Domain_Test_Start_Bridge;

--
-- End of file Creation_Deletion_RPT6_Domain_Test_Start_Bridge.adb
--
