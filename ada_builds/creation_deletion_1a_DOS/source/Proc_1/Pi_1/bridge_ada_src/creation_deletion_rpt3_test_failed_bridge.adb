...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Creation_Deletion_RPT3_Test_Failed_Bridge.adb
...
package body Creation_Deletion_RPT3_Test_Failed_Bridge is
   
   procedure Creation_Deletion_RPT3_Test_Failed (
...
--
   ...
   end Creation_Deletion_RPT3_Test_Failed;
   
end Creation_Deletion_RPT3_Test_Failed_Bridge;

--
-- End of file Creation_Deletion_RPT3_Test_Failed_Bridge.adb
--
