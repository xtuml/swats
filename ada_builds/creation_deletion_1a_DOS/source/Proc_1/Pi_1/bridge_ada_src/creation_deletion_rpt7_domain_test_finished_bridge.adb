...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Creation_Deletion_RPT7_Domain_Test_Finished_Bridge.adb
...
--*  -----------------                                                                *
--*                                                                                   *
--*  Project Key Letter : Creation_Deletion_Build_Set
--*  Project Version    : 0
--*  Build Set          : 0
--*                                                                                   *
--*  Build Target       : Dos
...
package body Creation_Deletion_RPT7_Domain_Test_Finished_Bridge is
   
   procedure Creation_Deletion_RPT7_Domain_Test_Finished (
      This_Domain_Name   : in     Application_Types.Base_Text_Type;
      This_Domain_Number : in     Application_Types.Base_Integer_Type) is
   ...
   -- start of RPT7_Domain_Test_Finished
      ...
      My_Report := Root_Object.Creation_Deletion.RD.Unconditional_Find_One;
...
--
         ...
         local_domain_number := Root_Object.Creation_Deletion.RD.Creation_Deletion_RD_type(My_Report.all).Reported_Domain_Number;
...
--
   ...
   end Creation_Deletion_RPT7_Domain_Test_Finished;
   
end Creation_Deletion_RPT7_Domain_Test_Finished_Bridge;

--
-- End of file Creation_Deletion_RPT7_Domain_Test_Finished_Bridge.adb
--
