...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Creation_Deletion_RPT4_Test_Unsupported_Bridge.adb
...
package body Creation_Deletion_RPT4_Test_Unsupported_Bridge is
   
   procedure Creation_Deletion_RPT4_Test_Unsupported (
   ...
   -- start of RPT4_Test_Unsupported
      ...
      The_Reporter_Object := Root_Object.Creation_Deletion.RD.Unconditional_Find_One;
...
--
         ...
         Unique_Domain_ID := Root_Object.Creation_Deletion.RD.Creation_Deletion_RD_type(The_Reporter_Object.all).Reported_Domain_Number;
...
--
   ...
   end Creation_Deletion_RPT4_Test_Unsupported;
   
end Creation_Deletion_RPT4_Test_Unsupported_Bridge;

--
-- End of file Creation_Deletion_RPT4_Test_Unsupported_Bridge.adb
--
