...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Events_RPT8_Specify_Requid_Bridge.adb
...
package body Events_RPT8_Specify_Requid_Bridge is
   
   procedure Events_RPT8_Specify_Requid (
...
--
   ...
   end Events_RPT8_Specify_Requid;
   
end Events_RPT8_Specify_Requid_Bridge;

--
-- End of file Events_RPT8_Specify_Requid_Bridge.adb
--
