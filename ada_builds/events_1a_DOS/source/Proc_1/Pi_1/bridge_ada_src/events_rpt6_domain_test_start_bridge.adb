...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Events_RPT6_Domain_Test_Start_Bridge.adb
...
package body Events_RPT6_Domain_Test_Start_Bridge is
   
   procedure Events_RPT6_Domain_Test_Start (
...
--
         ...
         Root_Object.Events.RD.Events_RD_type(My_Report.all).Reported_Domain_Number := New_Domain_Number;
         
      end if;
      
      
   end Events_RPT6_Domain_Test_Start;
   
end Events_RPT6_Domain_Test_Start_Bridge;

--
-- End of file Events_RPT6_Domain_Test_Start_Bridge.adb
--
