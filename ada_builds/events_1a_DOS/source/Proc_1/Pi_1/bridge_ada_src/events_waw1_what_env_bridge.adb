...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Events_WAW1_What_Env_Bridge.adb
...
package body Events_WAW1_What_Env_Bridge is
   
   procedure Events_WAW1_What_Env (
      Local_Env_Text :    out Application_Types.Base_Text_Type) is
      
      Env_Text : Application_Types.Base_Text_Type := (others => ' ');
...
--
   ...
   end Events_WAW1_What_Env;
   
end Events_WAW1_What_Env_Bridge;

--
-- End of file Events_WAW1_What_Env_Bridge.adb
--
