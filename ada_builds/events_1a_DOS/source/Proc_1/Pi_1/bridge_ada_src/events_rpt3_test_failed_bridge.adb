...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Events_RPT3_Test_Failed_Bridge.adb
...
package body Events_RPT3_Test_Failed_Bridge is
   
   procedure Events_RPT3_Test_Failed (
...
--
   ...
   end Events_RPT3_Test_Failed;
   
end Events_RPT3_Test_Failed_Bridge;

--
-- End of file Events_RPT3_Test_Failed_Bridge.adb
--
