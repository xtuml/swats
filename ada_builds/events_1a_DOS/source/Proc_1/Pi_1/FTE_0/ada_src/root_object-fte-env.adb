...
--* Description:             
--*                          Domain body Root_Object.FTEENV
...
------------------------------------------------------------------------
--
package body Root_Object.FTE.ENV is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return FTE_ENV_Type (This_Object.all).Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      FTE_ENV_Type (This_Object.all).Unique_Identifier :=
         Unique_Identifier_Value;
...
--ADATEST IGNORE_ON
   function Get_Where_Are_We (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Text_Type is
   begin
      return FTE_ENV_Type (This_Object.all).Where_Are_We;
   end Get_Where_Are_We;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Where_Are_We (
      This_Object : in Root_Object.Object_Access;
      Where_Are_We_Value : in Application_Types.Base_Text_Type) is
   begin
      FTE_ENV_Type (This_Object.all).Where_Are_We :=
         Where_Are_We_Value;
   end Put_Where_Are_We;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new FTE_ENV_Type;
   
      else
         This_Object := Free_List.First_Entry;
         FTE_ENV_Type(This_Object.all).Unique_Identifier := Application_Types.Base_Integer_Type_First;
         FTE_ENV_Type(This_Object.all).Where_Are_We := Application_Types.Base_Text_Type_First;
