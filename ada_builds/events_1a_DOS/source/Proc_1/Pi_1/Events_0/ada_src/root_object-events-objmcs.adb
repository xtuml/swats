...
--* Description:             
--*                          Domain body Root_Object.EventsobjMCS
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objMCS is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idMCS_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idMCS return Application_Types.Base_Integer_Type is
   begin
      idMCS_Value :=
         Application_Types.Base_Integer_Type'succ (idMCS_Value);
      return idMCS_Value;
   end Obtain_Subsequent_idMCS;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_objMCS_Type (This_Object.all).idMCS;
   end Get_idMCS;
...
--ADATEST IGNORE_ON
   procedure Put_idMCS (
      ...
      idMCS_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objMCS_Type (This_Object.all).idMCS :=
         idMCS_Value;
   end Put_idMCS;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objMCS_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objMCS_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objMCS_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objMCS_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objMCS_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objMCS_Type(This_Object.all).idMCS := Application_Types.Base_Integer_Type_First;
         Events_objMCS_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
         Events_objMCS_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure Events_objMCS_3 (
      Test : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_objMCS_4 (
      Test : in Application_Types.Base_Integer_Type;
      Test_Number : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_objMCS_5 (
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure objMCS3_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_objMCS_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objMCS.Object_State_Type(Idle);

      Events_objMCS_3 (
         Test =>  Events_objMCS3(This_Event.all).Test,
         This_Instance => This_Instance );

   end objMCS3_To_Idle;
--
   procedure objMCS6_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objMCS_3 (
         Test =>  Events_objMCS6(This_Event.all).Test,
         This_Instance => This_Instance );

   end objMCS6_To_Idle;
--
   procedure objMCS4_To_Verify_Tests (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objMCS_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objMCS.Object_State_Type(Verify_Tests);

      Events_objMCS_4 (
         Test =>  Events_objMCS4(This_Event.all).Test,
         Test_Number =>  Events_objMCS4(This_Event.all).Test_Number,
         This_Instance => This_Instance );

   end objMCS4_To_Verify_Tests;
--
   procedure objMCS5_To_Fail (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objMCS_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objMCS.Object_State_Type(Fail);
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_objMCS_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_objMCS_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objMCS_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_objMCS_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_objMCS_Event_Queue.Queue_Length (Events_objMCS_Queue);
...
--ADATEST IGNORE_ON
   procedure Put_Event (
      ...
      To_Class : in Events_objMCS_Type;
...
--
   This_Event_Dispatch_Matrix (objMCS1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS3, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS4, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS5, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS6, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS1, Creation_stateA) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objMCS2, Creation_stateA) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objMCS3, Creation_stateA) := objMCS3_To_Idle'access;
   This_Event_Dispatch_Matrix (objMCS4, Creation_stateA) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS5, Creation_stateA) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS6, Creation_stateA) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS1, Creation_stateB) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objMCS2, Creation_stateB) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objMCS3, Creation_stateB) := objMCS3_To_Idle'access;
   This_Event_Dispatch_Matrix (objMCS4, Creation_stateB) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS5, Creation_stateB) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS6, Creation_stateB) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS1, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objMCS2, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objMCS3, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS4, Idle) := objMCS4_To_Verify_Tests'access;
   This_Event_Dispatch_Matrix (objMCS5, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS6, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS1, Verify_Tests) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objMCS2, Verify_Tests) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objMCS3, Verify_Tests) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS4, Verify_Tests) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS5, Verify_Tests) := objMCS5_To_Fail'access;
   This_Event_Dispatch_Matrix (objMCS6, Verify_Tests) := objMCS6_To_Idle'access;
   This_Event_Dispatch_Matrix (objMCS1, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS2, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS3, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS4, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS5, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objMCS6, Fail) :=  Cannot_Happen_Action'access;

end Root_Object.Events.objMCS;
