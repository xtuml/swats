...
--* Description:             
--*                          Domain body Root_Object.EventsBLJ
...
------------------------------------------------------------------------
--
package body Root_Object.Events.BLJ is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   BLJ_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_BLJ_id return Application_Types.Base_Integer_Type is
   begin
      BLJ_id_Value :=
         Application_Types.Base_Integer_Type'succ (BLJ_id_Value);
      return BLJ_id_Value;
   end Obtain_Subsequent_BLJ_id;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_BLJ_Type (This_Object.all).BLJ_id;
   end Get_BLJ_id;
...
--ADATEST IGNORE_ON
   procedure Put_BLJ_id (
      This_Object : in Root_Object.Object_Access;
      BLJ_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_BLJ_Type (This_Object.all).BLJ_id :=
         BLJ_id_Value;
   end Put_BLJ_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_BLJ_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BLJ_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_BLJ_Type (This_Object.all).R16_Super;
   end Get_R16_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BLJ_Type (This_Object.all).R16_Super :=
         R16_Super_Value;
   end Put_R16_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_BLJ_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_BLJ_Type(This_Object.all).BLJ_id := Application_Types.Base_Integer_Type_First;
         Events_BLJ_Type(This_Object.all).Current_State :=  Object_State_Type_First;
