...
--* Description:             
--*                          Domain body Root_Object.EventsSC
...
------------------------------------------------------------------------
--
package body Root_Object.Events.SC is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   The_ID_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_The_ID return Application_Types.Base_Integer_Type is
   begin
      The_ID_Value :=
         Application_Types.Base_Integer_Type'succ (The_ID_Value);
      return The_ID_Value;
   end Obtain_Subsequent_The_ID;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_SC_Type (This_Object.all).The_ID;
   end Get_The_ID;
...
--ADATEST IGNORE_ON
   procedure Put_The_ID (
      This_Object : in Root_Object.Object_Access;
      The_ID_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_SC_Type (This_Object.all).The_ID :=
         The_ID_Value;
   end Put_The_ID;
...
--ADATEST IGNORE_ON
   function Get_The_Test_No (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_SC_Type (This_Object.all).The_Test_No;
   end Get_The_Test_No;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SC_Type (This_Object.all).The_Test_No :=
         The_Test_No_Value;
   end Put_The_Test_No;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Whats_The_State (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Text_Type is
   begin
      return Events_SC_Type (This_Object.all).Whats_The_State;
   end Get_Whats_The_State;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Whats_The_State (
      This_Object : in Root_Object.Object_Access;
      Whats_The_State_Value : in Application_Types.Base_Text_Type) is
   begin
      Events_SC_Type (This_Object.all).Whats_The_State :=
         Whats_The_State_Value;
   end Put_Whats_The_State;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SC_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SC_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_SC_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_SC_Type(This_Object.all).The_ID := Application_Types.Base_Integer_Type_First;
         Events_SC_Type(This_Object.all).The_Test_No := Application_Types.Base_Integer_Type_First;
         Events_SC_Type(This_Object.all).Whats_The_State := Application_Types.Base_Text_Type_First;
         Events_SC_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure Events_SC_2 (
      Test_No : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_SC_1 (
      Test_No : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure SC1_To_Check_State (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_SC_Type (This_Instance.all).Current_State := 
         Root_Object.Events.SC.Object_State_Type(Check_State);

      Events_SC_2 (
         Test_No =>  Events_SC1(This_Event.all).Test_No,
         This_Instance => This_Instance );

   end SC1_To_Check_State;
--
   procedure SC2_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_SC_Type (This_Instance.all).Current_State := 
         Root_Object.Events.SC.Object_State_Type(Idle);

      Events_SC_1 (
         Test_No =>  Events_SC2(This_Event.all).Test_No,
         This_Instance => This_Instance );
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_SC_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_SC_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_SC_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_SC_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_SC_Event_Queue.Queue_Length (Events_SC_Queue);
...
--
   This_Event_Dispatch_Matrix (SC1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (SC2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (SC1, Idle) := SC1_To_Check_State'access;
   This_Event_Dispatch_Matrix (SC2, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (SC1, Check_State) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (SC2, Check_State) := SC2_To_Idle'access;

end Root_Object.Events.SC;
