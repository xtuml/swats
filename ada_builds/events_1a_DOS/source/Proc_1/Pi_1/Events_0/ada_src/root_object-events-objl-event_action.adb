...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.objL.event_action.ada
...
--*  separate of Root_Object.EventsobjL
--*     Event_Action
--*
--*************************************************************************************
--  MODIFICATION RECORD
...
separate (Root_Object.Events.objL)
...
begin
   ...
   This_Action := Events_objL_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := Events_objL_Instance_Event_Type(This_Event.all).Target_Instance;


   -- Ensure that the source instance still exists. 
   if This /= null then
      This_Event_Dispatch_Matrix (This_Action, Events_objL_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
