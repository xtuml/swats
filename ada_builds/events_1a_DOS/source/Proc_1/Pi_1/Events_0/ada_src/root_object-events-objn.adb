...
--* Description:             
--*                          Domain body Root_Object.EventsobjN
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objN is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objN_Type (This_Object.all).Reference_N;
   end Get_Reference_N;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Reference_N (
      ...
      Reference_N_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objN_Type (This_Object.all).Reference_N :=
         Reference_N_Value;
   end Put_Reference_N;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Reference_M (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objN_Type (This_Object.all).Reference_M;
   end Get_Reference_M;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Reference_M (
      This_Object : in Root_Object.Object_Access;
      Reference_M_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objN_Type (This_Object.all).Reference_M :=
         Reference_M_Value;
   end Put_Reference_M;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Result_N (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objN_Type (This_Object.all).Result_N;
   end Get_Result_N;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Result_N (
      This_Object : in Root_Object.Object_Access;
      Result_N_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objN_Type (This_Object.all).Result_N :=
         Result_N_Value;
   end Put_Result_N;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objN_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objN_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objN_Type (This_Object.all).R3_Sub;
   end Get_R3_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R3_Sub (
      This_Object : in Root_Object.Object_Access;
      R3_Sub_Value : in Root_Object.Object_Access) is
   begin
      Events_objN_Type (This_Object.all).R3_Sub :=
         R3_Sub_Value;
   end Put_R3_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R2_Super (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Events_objN_Type (This_Object.all).R2_Super;
   end Get_R2_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objN_Type (This_Object.all).R2_Super :=
         R2_Super_Value;
   end Put_R2_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objN_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objN_Type(This_Object.all).Reference_N := Application_Types.Base_Integer_Type_First;
         Events_objN_Type(This_Object.all).Reference_M := Application_Types.Base_Integer_Type_First;
         Events_objN_Type(This_Object.all).Result_N := Application_Types.Base_Integer_Type_First;
         Events_objN_Type(This_Object.all).Current_State :=  Object_State_Type_First;
