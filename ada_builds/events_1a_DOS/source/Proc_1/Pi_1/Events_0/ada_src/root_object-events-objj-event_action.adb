...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.objJ.event_action.ada
...
--*  separate of Root_Object.EventsobjJ
--*     Event_Action
--*
--*************************************************************************************
--  MODIFICATION RECORD
...
begin
   ...
   This_Action := Events_objJ_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := Events_objJ_Instance_Event_Type(This_Event.all).Target_Instance;
   ...
   if This /= null then
      ...
      --  
      This_Event_Dispatch_Matrix (This_Action, Events_objJ_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
