...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.SL_ONE_A.adb
...
--* Description:             
--*                          Domain body Root_Object.EventsSL_ONE_A
...
------------------------------------------------------------------------
--
package body Root_Object.Events.SL_ONE_A is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   SL1A_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_SL1A_id return Application_Types.Base_Integer_Type is
   begin
      SL1A_id_Value :=
         Application_Types.Base_Integer_Type'succ (SL1A_id_Value);
      return SL1A_id_Value;
   end Obtain_Subsequent_SL1A_id;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_SL_ONE_A_Type (This_Object.all).SL1A_id;
   end Get_SL1A_id;
...
--ADATEST IGNORE_ON
   procedure Put_SL1A_id (
      ...
      SL1A_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_SL_ONE_A_Type (This_Object.all).SL1A_id :=
         SL1A_id_Value;
   end Put_SL1A_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SL_ONE_A_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SL_ONE_A_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SL_ONE_A_Type (This_Object.all).R10_Sub;
   end Get_R10_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R10_Sub (
      This_Object : in Root_Object.Object_Access;
      R10_Sub_Value : in Root_Object.Object_Access) is
   begin
      Events_SL_ONE_A_Type (This_Object.all).R10_Sub :=
         R10_Sub_Value;
   end Put_R10_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R9_Super (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Events_SL_ONE_A_Type (This_Object.all).R9_Super;
   end Get_R9_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SL_ONE_A_Type (This_Object.all).R9_Super :=
         R9_Super_Value;
   end Put_R9_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_SL_ONE_A_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_SL_ONE_A_Type(This_Object.all).SL1A_id := Application_Types.Base_Integer_Type_First;
         Events_SL_ONE_A_Type(This_Object.all).Current_State :=  Object_State_Type_First;
