...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.SL_TWO_D.ads
...
--* Description:             
--*                          Domain specification Root_Object.EventsSL_TWO_D
...
--  ----------------------------------  
--  package Root_Object.Events.SL_TWO_D
...
package Root_Object.Events.SL_TWO_D is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_Level_2_D Information **************
   --
   -- Object SL_TWO_D is PASSIVE
   --
   -- Object SL_TWO_D participates in a super sub type relationship
   --
   --
   --
   -- Object SL_TWO_D is a SUPER type of 
   --    SL_THREE_D,
   --    SL_THREE_C
   --    via Relationship R17
   --
   -- Object SL_TWO_D is a SUB type of SL_ONE_B via Relationship R11
   --
   -- Object SL_TWO_D has an identifying non-referential attribute SL2D_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object SL_TWO_D has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "SL_TWO_D";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_SL_TWO_D_Type is new Events_Type with record
      ...
      R17_Sub : Root_Object.Object_Access := null;
      R11_Super : Root_Object.Object_Access := null;
   ...
   function Get_SL2D_id (
      This_Object : Root_Object.Object_Access) 
   return Application_Types.Base_Integer_Type;

   procedure Put_SL2D_id (
      This_Object : in Root_Object.Object_Access;
      SL2D_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_SL2D_id);
   pragma inline (Put_SL2D_id);
   ...
   function  Get_R17_Sub (
      This_Object : Root_Object.Object_Access) 
   return Root_Object.Object_Access;

   procedure Put_R17_Sub (
      This_Object :   in  Root_Object.Object_Access;
      R17_Sub_Value : in Root_Object.Object_Access);

   pragma inline (Get_R17_Sub);
   pragma inline (Put_R17_Sub);


   function  Get_R11_Super (
      This_Object : Root_Object.Object_Access) 
   return Root_Object.Object_Access;

   procedure Put_R11_Super (
      This_Object : in  Root_Object.Object_Access;
      R11_Super_Value : in Root_Object.Object_Access);

   pragma inline (Get_R11_Super);
   pragma inline (Put_R11_Super);
   ...
   --
   type Events_SL_TWO_D_Event_Type is new Events_Event_Type with
   record
      This_Event_Class : Event_Class;
   end record;

   procedure Event_Action (
      Dispatch_Event : in     Events_SL_TWO_D_Event_Type;
      This_Event     : in out Root_Object.Root_Event_Access_Type);


   --    
   type Events_SL_TWO_D_Instance_Event_Type is new Events_SL_TWO_D_Event_Type with
   record
   ...
   -- 
   procedure Event_Action (
      Dispatch_Event : in     Events_SL_TWO_D_Instance_Event_Type;
      This_Event     : in out Root_Object.Root_Event_Access_Type);



   ------------------------------------------------------------------------
   type Events_SL_TWO_D_Description_Event is new Events_SL_TWO_D_Instance_Event_Type with
   record
      null;
   end record;
   --
   ...
   --
   --
   type Events_SL_ONE_B1 is new Events_SL_TWO_D_Instance_Event_Type with
   record 
      null;
   end record;

end Root_Object.Events.SL_TWO_D;
