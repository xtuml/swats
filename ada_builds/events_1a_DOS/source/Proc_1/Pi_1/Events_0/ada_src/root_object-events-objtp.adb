...
--* Description:             
--*                          Domain body Root_Object.EventsobjTP
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objTP is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   TPID_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_TPID return Application_Types.Base_Integer_Type is
   begin
      TPID_Value :=
         Application_Types.Base_Integer_Type'succ (TPID_Value);
      return TPID_Value;
   end Obtain_Subsequent_TPID;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_objTP_Type (This_Object.all).TPID;
   end Get_TPID;
...
--ADATEST IGNORE_ON
   procedure Put_TPID (
      ...
      TPID_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objTP_Type (This_Object.all).TPID :=
         TPID_Value;
   end Put_TPID;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objTP_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objTP_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objTP_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objTP_Type(This_Object.all).TPID := Application_Types.Base_Integer_Type_First;
         Events_objTP_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure Events_objTP_4 (
      Test_No : in Application_Types.Base_Integer_Type;
      Real_Val : in Application_Types.Base_Float_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_objTP_5 (
      Test_No : in Application_Types.Base_Integer_Type;
      Text_Input : in Application_Types.Base_Text_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_objTP_1 (
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure objTP1_To_Stage_A (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_objTP_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objTP.Object_State_Type(Stage_A);

      Events_objTP_2 (
         Test_No =>  Events_objTP1(This_Event.all).Test_No,
         A_Val =>  Events_objTP1(This_Event.all).A_Val,
         This_Instance => This_Instance );

   end objTP1_To_Stage_A;
--
   procedure objTP4_To_Test_Real (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objTP_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objTP.Object_State_Type(Test_Real);

      Events_objTP_4 (
         Test_No =>  Events_objTP4(This_Event.all).Test_No,
         Real_Val =>  Events_objTP4(This_Event.all).Real_Val,
         This_Instance => This_Instance );

   end objTP4_To_Test_Real;
--
   procedure objTP6_To_Test_Text (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objTP_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objTP.Object_State_Type(Test_Text);

      Events_objTP_5 (
         Test_No =>  Events_objTP6(This_Event.all).Test_No,
         Text_Input =>  Events_objTP6(This_Event.all).Text_Input,
         This_Instance => This_Instance );

   end objTP6_To_Test_Text;
--
   procedure objTP3_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objTP_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objTP.Object_State_Type(Idle);
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_objTP_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_objTP_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objTP_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_objTP_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_objTP_Event_Queue.Queue_Length (Events_objTP_Queue);
...
--
   This_Event_Dispatch_Matrix (objTP1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objTP2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objTP3, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objTP4, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objTP5, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objTP6, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objTP1, Idle) := objTP1_To_Stage_A'access;
   This_Event_Dispatch_Matrix (objTP2, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objTP3, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objTP4, Idle) := objTP4_To_Test_Real'access;
   This_Event_Dispatch_Matrix (objTP5, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objTP6, Idle) := objTP6_To_Test_Text'access;
   This_Event_Dispatch_Matrix (objTP1, Stage_A) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objTP2, Stage_A) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objTP3, Stage_A) := objTP3_To_Idle'access;
   This_Event_Dispatch_Matrix (objTP4, Stage_A) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objTP5, Stage_A) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objTP6, Stage_A) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objTP1, Test_Real) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objTP2, Test_Real) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objTP3, Test_Real) := objTP3_To_Idle'access;
   This_Event_Dispatch_Matrix (objTP4, Test_Real) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objTP5, Test_Real) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objTP6, Test_Real) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objTP1, Test_Text) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objTP2, Test_Text) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objTP3, Test_Text) := objTP3_To_Idle'access;
   This_Event_Dispatch_Matrix (objTP4, Test_Text) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objTP5, Test_Text) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objTP6, Test_Text) :=  Ignore_Action'access;

end Root_Object.Events.objTP;
