...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.SL_TWO_B.ads
...
--* Description:             
--*                          Domain specification Root_Object.EventsSL_TWO_B
...
--  ----------------------------------  
--  package Root_Object.Events.SL_TWO_B
...
package Root_Object.Events.SL_TWO_B is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_Level_2_B Information **************
   --
   -- Object SL_TWO_B is PASSIVE
   --
   -- Object SL_TWO_B participates in a super sub type relationship
   --
   --
   --
   -- Object SL_TWO_B is a SUB type of SL_ONE_A via Relationship R10
   --
   -- Object SL_TWO_B has an identifying non-referential attribute SL2B_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object SL_TWO_B has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "SL_TWO_B";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_SL_TWO_B_Type is new Events_Type with record

      --
      -- Non initialised identifying non referential
      SL2B_id : Application_Types.Base_Integer_Type;
   ...
   procedure Put_SL2B_id (
      ...
      SL2B_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_SL2B_id);
   pragma inline (Put_SL2B_id);
