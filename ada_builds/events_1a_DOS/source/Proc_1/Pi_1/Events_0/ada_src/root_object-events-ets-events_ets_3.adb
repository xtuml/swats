...
separate(Root_Object.Events.ETS)
   ...
   procedure Events_ETS_3 (Test          : in     Application_Types.Base_Integer_Type;
                           This_Instance : in out Root_Object.Object_Access) is
   
      
      temp    : Application_Types.Base_Integer_Type := 1;
      newtemp : Application_Types.Base_Integer_Type := 1;
   ...
   begin
      ...
      if Test =  1 then
         ...
         temp := Root_Object.Events.ETS.Events_ETS_type(This_Instance.all).NewResult;
         ...
         Root_Object.Events.ETS.Events_ETS_type(This_Instance.all).NewResult := newtemp;
