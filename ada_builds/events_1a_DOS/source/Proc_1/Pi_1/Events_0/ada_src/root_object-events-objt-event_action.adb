...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.objT.event_action.ada
...
--*  separate of Root_Object.EventsobjT
--*     Event_Action
--*
--*************************************************************************************
--  MODIFICATION RECORD
...
separate (Root_Object.Events.objT)
...
begin
   ...
   This_Action := Events_objT_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := Events_objT_Instance_Event_Type(This_Event.all).Target_Instance;
   ...
   if This /= null then
      ...
      --  
      This_Event_Dispatch_Matrix (This_Action, Events_objT_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
