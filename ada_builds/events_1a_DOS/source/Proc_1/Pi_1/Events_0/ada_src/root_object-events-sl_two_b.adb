...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.SL_TWO_B.adb
...
--* Description:             
--*                          Domain body Root_Object.EventsSL_TWO_B
...
------------------------------------------------------------------------
--
package body Root_Object.Events.SL_TWO_B is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   SL2B_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_SL2B_id return Application_Types.Base_Integer_Type is
   begin
      SL2B_id_Value :=
         Application_Types.Base_Integer_Type'succ (SL2B_id_Value);
      return SL2B_id_Value;
   end Obtain_Subsequent_SL2B_id;
...
--ADATEST IGNORE_ON
   procedure Put_SL2B_id (
      This_Object : in Root_Object.Object_Access;
      SL2B_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_SL_TWO_B_Type (This_Object.all).SL2B_id :=
         SL2B_id_Value;
   end Put_SL2B_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SL_TWO_B_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SL_TWO_B_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SL_TWO_B_Type (This_Object.all).R10_Super;
   end Get_R10_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SL_TWO_B_Type (This_Object.all).R10_Super :=
         R10_Super_Value;
   end Put_R10_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_SL_TWO_B_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_SL_TWO_B_Type(This_Object.all).SL2B_id := Application_Types.Base_Integer_Type_First;
         Events_SL_TWO_B_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
end Root_Object.Events.SL_TWO_B;
