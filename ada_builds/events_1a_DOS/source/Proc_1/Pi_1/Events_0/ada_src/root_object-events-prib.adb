...
--* Description:             
--*                          Domain body Root_Object.EventsPriB
...
------------------------------------------------------------------------
--
package body Root_Object.Events.PriB is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   B_ID_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_B_ID return Application_Types.Base_Integer_Type is
   begin
      B_ID_Value :=
         Application_Types.Base_Integer_Type'succ (B_ID_Value);
      return B_ID_Value;
   end Obtain_Subsequent_B_ID;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_PriB_Type (This_Object.all).B_ID;
   end Get_B_ID;
...
--ADATEST IGNORE_ON
   procedure Put_B_ID (
      ...
      B_ID_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_PriB_Type (This_Object.all).B_ID :=
         B_ID_Value;
   end Put_B_ID;
...
------------------------------------------------------------------------
   --
   -- procedure Put_A_ID and 
   --
   -- function Get_A_ID
   --
   -- have not been generated for A_ID
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_PriB_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_PriB_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   procedure Put_R20_Super (
      This_Object : in  Root_Object.Object_Access;
      R20_Super_Value : in Root_Object.Object_Access) is
   begin
      Events_PriB_Type (This_Object.all).R20_Super :=
         R20_Super_Value;
   end Put_R20_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_PriB_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_PriB_Type(This_Object.all).B_ID := Application_Types.Base_Integer_Type_First;
         Events_PriB_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
----------------------------------------------------------------------------
   ...
   procedure Polymorphic_Put (
      This_Object : in out Events_PriB_Type;
      This_Event  : in     Root_Object.Root_Event_Access_Type) is

      Parent_Event_Type : Root_Object.Events.PriA.Event_Class;
      Next_Event        : Root_Object.Root_Event_Access_Type;

   begin

      Parent_Event_Type := Root_Object.Events.PriA.Events_PriA_Event_Type(This_Event.all).This_Event_Class;

      case Parent_Event_Type is

         when Root_Object.Events.PriA.PriA1 =>

            Next_Event := new Root_Object.Events.PriB.Events_PriA1'(
            Root_Event_Type with
               Test_No =>
                  Root_Object.Events.PriA.Events_PriA1(This_Event.all).Test_No,
               Index =>
                  Root_Object.Events.PriA.Events_PriA1(This_Event.all).Index,
               This_Event_Class => Root_Object.Events.PriB.PriA1,
               Target_Instance  => This_Object'Unchecked_Access);

         when Root_Object.Events.PriA.PriA2 =>

            Next_Event := new Root_Object.Events.PriB.Events_PriA2'(
            Root_Event_Type with
               Test_No =>
                  Root_Object.Events.PriA.Events_PriA2(This_Event.all).Test_No,
               This_Event_Class => Root_Object.Events.PriB.PriA2,
               Target_Instance  => This_Object'Unchecked_Access);

         when Root_Object.Events.PriA.PriA3 =>

            Next_Event := new Root_Object.Events.PriB.Events_PriA3'(
            Root_Event_Type with
               Test_No =>
                  Root_Object.Events.PriA.Events_PriA3(This_Event.all).Test_No,
               Index =>
                  Root_Object.Events.PriA.Events_PriA3(This_Event.all).Index,
               This_Event_Class => Root_Object.Events.PriB.PriA3,
               Target_Instance  => This_Object'Unchecked_Access);


         when Root_Object.Events.PriA.Class_Event =>
...
--
   ...
   procedure Events_PriB_1 (
      Test_No : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure PriA1_To_Check (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_PriB_Type (This_Instance.all).Current_State := 
         Root_Object.Events.PriB.Object_State_Type(Check);

      Events_PriB_2 (
         Test_No =>  Events_PriA1(This_Event.all).Test_No,
         Index =>  Events_PriA1(This_Event.all).Index,
         This_Instance => This_Instance );

   end PriA1_To_Check;
--
   procedure PriB2_To_Check (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_PriB_2 (
         Test_No =>  Events_PriB2(This_Event.all).Test_No,
         Index =>  Events_PriB2(This_Event.all).Index,
         This_Instance => This_Instance );

   end PriB2_To_Check;
--
   procedure PriB1_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_PriB_Type (This_Instance.all).Current_State := 
         Root_Object.Events.PriB.Object_State_Type(Idle);

      Events_PriB_1 (
         Test_No =>  Events_PriB1(This_Event.all).Test_No,
         This_Instance => This_Instance );

   end PriB1_To_Idle;
--
   procedure PriA2_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_PriB_1 (
         Test_No =>  Events_PriA2(This_Event.all).Test_No,
         This_Instance => This_Instance );
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_PriB_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_PriB_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_PriB_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_PriB_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_PriB_Event_Queue.Queue_Length (Events_PriB_Queue);
...
--
   This_Event_Dispatch_Matrix (PriA1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (PriA2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (PriA3, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (PriB1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (PriB2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (PriA1, Idle) := PriA1_To_Check'access;
   This_Event_Dispatch_Matrix (PriA2, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (PriA3, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (PriB1, Idle) := PriB1_To_Idle'access;
   This_Event_Dispatch_Matrix (PriB2, Idle) := PriB2_To_Check'access;
   This_Event_Dispatch_Matrix (PriA1, Check) := PriA1_To_Check'access;
   This_Event_Dispatch_Matrix (PriA2, Check) := PriA2_To_Idle'access;
   This_Event_Dispatch_Matrix (PriA3, Check) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (PriB1, Check) := PriB1_To_Idle'access;
   This_Event_Dispatch_Matrix (PriB2, Check) := PriB2_To_Check'access;

end Root_Object.Events.PriB;
