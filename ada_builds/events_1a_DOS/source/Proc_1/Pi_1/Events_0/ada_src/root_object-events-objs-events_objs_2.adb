...
separate(Root_Object.Events.objS)
   ...
   procedure Events_objS_2 (Test          : in     Application_Types.Base_Integer_Type;
   ...
   begin
      ...
      temp := Root_Object.Events.objS.Events_objS_type(This_Instance.all).Result_S + 
      Root_Object.Events.objS.Events_objS_type(This_Instance.all).Value_To_Add;
      
      
      Root_Object.Events.objS.Events_objS_type(This_Instance.all).Result_S := temp;
      
      
      temp := Root_Object.Events.objP.Events_objP_type(my_super.all).Result_P + Root_Object.Events.objS.Events_objS_type(This_Instance.all).Value_To_Add;
      ...
      begin
         Pushed_Event := new
         Root_Object.Events.objS.Events_objS1'(Root_Object.Root_Event_Type with
            This_Event_Class => Root_Object.Events.objS.objS1,
            Target_Instance  => This_Instance);
         
         Root_Object.Events.objS.Push (
            Event  => Pushed_Event,
            To_Top => True);
      end;
