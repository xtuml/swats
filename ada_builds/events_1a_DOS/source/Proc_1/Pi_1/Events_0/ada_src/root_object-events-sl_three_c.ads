...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.SL_THREE_C.ads
...
--* Description:             
--*                          Domain specification Root_Object.EventsSL_THREE_C
...
--  ----------------------------------  
--  package Root_Object.Events.SL_THREE_C
...
package Root_Object.Events.SL_THREE_C is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_Level_3_C Information **************
   --
   -- Object SL_THREE_C is PASSIVE
   --
   -- Object SL_THREE_C participates in a super sub type relationship
   --
   --
   --
   -- Object SL_THREE_C is a SUB type of SL_TWO_D via Relationship R17
   --
   -- Object SL_THREE_C has an identifying non-referential attribute SL3C_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object SL_THREE_C has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "SL_THREE_C";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_SL_THREE_C_Type is new Events_Type with record

      --
      -- Non initialised identifying non referential
      SL3C_id : Application_Types.Base_Integer_Type;
   ...
   procedure Put_SL3C_id (
      ...
      SL3C_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_SL3C_id);
   pragma inline (Put_SL3C_id);
