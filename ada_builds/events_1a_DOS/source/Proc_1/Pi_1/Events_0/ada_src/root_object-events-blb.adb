...
--* Description:             
--*                          Domain body Root_Object.EventsBLB
...
------------------------------------------------------------------------
--
package body Root_Object.Events.BLB is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   BLB_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_BLB_id return Application_Types.Base_Integer_Type is
   begin
      BLB_id_Value :=
         Application_Types.Base_Integer_Type'succ (BLB_id_Value);
      return BLB_id_Value;
   end Obtain_Subsequent_BLB_id;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_BLB_Type (This_Object.all).BLB_id;
   end Get_BLB_id;
...
--ADATEST IGNORE_ON
   procedure Put_BLB_id (
      This_Object : in Root_Object.Object_Access;
      BLB_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_BLB_Type (This_Object.all).BLB_id :=
         BLB_id_Value;
   end Put_BLB_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_BLB_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BLB_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   procedure Put_R15_Super (
      This_Object : in  Root_Object.Object_Access;
      R15_Super_Value : in Root_Object.Object_Access) is
   begin
      Events_BLB_Type (This_Object.all).R15_Super :=
         R15_Super_Value;
   end Put_R15_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_BLB_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_BLB_Type(This_Object.all).BLB_id := Application_Types.Base_Integer_Type_First;
         Events_BLB_Type(This_Object.all).Current_State :=  Object_State_Type_First;
