...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.SL_THREE_D.adb
...
--* Description:             
--*                          Domain body Root_Object.EventsSL_THREE_D
...
------------------------------------------------------------------------
--
package body Root_Object.Events.SL_THREE_D is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   SL3D_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_SL3D_id return Application_Types.Base_Integer_Type is
   begin
      SL3D_id_Value :=
         Application_Types.Base_Integer_Type'succ (SL3D_id_Value);
      return SL3D_id_Value;
   end Obtain_Subsequent_SL3D_id;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_SL_THREE_D_Type (This_Object.all).SL3D_id;
   end Get_SL3D_id;
...
--ADATEST IGNORE_ON
   procedure Put_SL3D_id (
      ...
      SL3D_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_SL_THREE_D_Type (This_Object.all).SL3D_id :=
         SL3D_id_Value;
   end Put_SL3D_id;
...
------------------------------------------------------------------------
   --
   -- procedure Put_SL2D_id and 
   --
   -- function Get_SL2D_id
   --
   -- have not been generated for SL2D_id
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SL_THREE_D_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SL_THREE_D_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SL_THREE_D_Type (This_Object.all).R16_Sub;
   end Get_R16_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R16_Sub (
      This_Object : in Root_Object.Object_Access;
      R16_Sub_Value : in Root_Object.Object_Access) is
   begin
      Events_SL_THREE_D_Type (This_Object.all).R16_Sub :=
         R16_Sub_Value;
   end Put_R16_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R17_Super (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Events_SL_THREE_D_Type (This_Object.all).R17_Super;
   end Get_R17_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SL_THREE_D_Type (This_Object.all).R17_Super :=
         R17_Super_Value;
   end Put_R17_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_SL_THREE_D_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_SL_THREE_D_Type(This_Object.all).SL3D_id := Application_Types.Base_Integer_Type_First;
         Events_SL_THREE_D_Type(This_Object.all).Current_State :=  Object_State_Type_First;
