...
--* Description:             
--*                          Domain specification Root_Object.EventsobjO
...
--  ----------------------------------  
--  package Root_Object.Events.objO
...
package Root_Object.Events.objO is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_O Information **************
   --
   -- Object objO is PASSIVE
   --
   -- Object objO participates in a super sub type relationship
   --
   --
   --
   -- Object objO is a SUB type of objN via Relationship R3
   --
   -- Object objO does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objO has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_objO_Type is new Events_Type with record

      --
      -- Initialised Non identifying non referential
      Reference_O : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
      ...
      --
      -- Initialised Non identifying non referential
      Result_O : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      Current_State :  Object_State_Type :=  Object_State_Type_First;

      R3_Super : Root_Object.Object_Access := null;
   ...
   function Get_Reference_O (
      This_Object : Root_Object.Object_Access) 
   return Application_Types.Base_Integer_Type;

   procedure Put_Reference_O (
      This_Object : in Root_Object.Object_Access;
      Reference_O_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Reference_O);
   pragma inline (Put_Reference_O);
   ...
   function Get_Result_O (
      This_Object : Root_Object.Object_Access) 
   return Application_Types.Base_Integer_Type;

   procedure Put_Result_O (
      This_Object : in Root_Object.Object_Access;
      Result_O_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Result_O);
   pragma inline (Put_Result_O);
   ...
   function  Get_R3_Super (
      This_Object : Root_Object.Object_Access) 
   return Root_Object.Object_Access;

   procedure Put_R3_Super (
      This_Object : in  Root_Object.Object_Access;
      R3_Super_Value : in Root_Object.Object_Access);

   pragma inline (Get_R3_Super);
   pragma inline (Put_R3_Super);
