...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.objVERCETL.adb
...
--* Description:             
--*                          Domain body Root_Object.EventsobjVERCETL
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objVERCETL is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   ReferenceCETL_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceCETL return Application_Types.Base_Integer_Type is
   begin
      ReferenceCETL_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceCETL_Value);
      return ReferenceCETL_Value;
   end Obtain_Subsequent_ReferenceCETL;
...
--ADATEST IGNORE_ON
   function Get_ReferenceCETL (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return Events_objVERCETL_Type (This_Object.all).ReferenceCETL;
   end Get_ReferenceCETL;
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceCETL (
      This_Object : in Root_Object.Object_Access;
      ReferenceCETL_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objVERCETL_Type (This_Object.all).ReferenceCETL :=
         ReferenceCETL_Value;
   end Put_ReferenceCETL;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objVERCETL_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objVERCETL_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objVERCETL_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objVERCETL_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objVERCETL_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objVERCETL_Type(This_Object.all).ReferenceCETL := Application_Types.Base_Integer_Type_First;
         Events_objVERCETL_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
         Events_objVERCETL_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objVERCETL_Type(This_Object.all).ReferenceCETL :=
         Obtain_Subsequent_ReferenceCETL;
...
--
   ...
   procedure Events_objVERCETL_1 (
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure objVERCETL2_To_Verify_State (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_objVERCETL_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objVERCETL.Object_State_Type(Verify_State);

      Events_objVERCETL_2 (
         Test =>  Events_objVERCETL2(This_Event.all).Test,
         Test_Number =>  Events_objVERCETL2(This_Event.all).Test_Number,
         This_Instance => This_Instance );

   end objVERCETL2_To_Verify_State;
--
   procedure objVERCETL1_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objVERCETL_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objVERCETL.Object_State_Type(Idle);

      Events_objVERCETL_1 (
         This_Instance => This_Instance );

   end objVERCETL1_To_Idle;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_objVERCETL_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_objVERCETL_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objVERCETL_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_objVERCETL_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objVERCETL_Event_Queue.Pop (
         Item        => Temp_Event,
         Target_FIFO => Events_objVERCETL_Queue);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_objVERCETL_Event_Queue.Queue_Length (Events_objVERCETL_Queue);
...
--ADATEST IGNORE_ON
   procedure Put_Event (
      ...
      To_Class : in Events_objVERCETL_Type;
...
--
   This_Event_Dispatch_Matrix (objVERCETL1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objVERCETL2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objVERCETL3, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objVERCETL1, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objVERCETL2, Idle) := objVERCETL2_To_Verify_State'access;
   This_Event_Dispatch_Matrix (objVERCETL3, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objVERCETL1, Verify_State) := objVERCETL1_To_Idle'access;
   This_Event_Dispatch_Matrix (objVERCETL2, Verify_State) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objVERCETL3, Verify_State) :=  Ignore_Action'access;

end Root_Object.Events.objVERCETL;
