...
--* Description:             
--*                          Domain body Root_Object.EventsobjCD
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objCD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idCD_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idCD return Application_Types.Base_Integer_Type is
   begin
      idCD_Value :=
         Application_Types.Base_Integer_Type'succ (idCD_Value);
      return idCD_Value;
   end Obtain_Subsequent_idCD;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_objCD_Type (This_Object.all).idCD;
   end Get_idCD;
...
--ADATEST IGNORE_ON
   procedure Put_idCD (
      ...
      idCD_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objCD_Type (This_Object.all).idCD :=
         idCD_Value;
   end Put_idCD;
...
--ADATEST IGNORE_ON
   function Get_CDTotal (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objCD_Type (This_Object.all).CDTotal;
   end Get_CDTotal;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_CDTotal (
      This_Object : in Root_Object.Object_Access;
      CDTotal_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objCD_Type (This_Object.all).CDTotal :=
         CDTotal_Value;
   end Put_CDTotal;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objCD_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objCD_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objCD_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objCD_Type(This_Object.all).idCD := Application_Types.Base_Integer_Type_First;
         Events_objCD_Type(This_Object.all).CDTotal := Application_Types.Base_Integer_Type_First;
         Events_objCD_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   procedure objCD1_To_Check (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_objCD_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objCD.Object_State_Type(Check);

      Events_objCD_2 (
         Test_No =>  Events_objCD1(This_Event.all).Test_No,
         Deleted =>  Events_objCD1(This_Event.all).Deleted,
         This_Instance => This_Instance );

   end objCD1_To_Check;
--
   procedure objCD2_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objCD_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objCD.Object_State_Type(Idle);

      Events_objCD_1 (
         Test_No =>  Events_objCD2(This_Event.all).Test_No,
         Deleted =>  Events_objCD2(This_Event.all).Deleted,
         This_Instance => This_Instance );
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_objCD_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_objCD_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objCD_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_objCD_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_objCD_Event_Queue.Queue_Length (Events_objCD_Queue);
...
--
   This_Event_Dispatch_Matrix (objCD1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objCD2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objCD1, Idle) := objCD1_To_Check'access;
   This_Event_Dispatch_Matrix (objCD2, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objCD1, Check) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objCD2, Check) := objCD2_To_Idle'access;

end Root_Object.Events.objCD;
