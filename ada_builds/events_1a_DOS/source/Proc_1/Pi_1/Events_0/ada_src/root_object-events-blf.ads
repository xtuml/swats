...
--* Description:             
--*                          Domain specification Root_Object.EventsBLF
...
--  ----------------------------------  
--  package Root_Object.Events.BLF
...
package Root_Object.Events.BLF is
--
------------------------------------------------------------------------
   --
   --**************  Object Bottom_Level_F Information **************
   --
   -- Object BLF is PASSIVE
   --
   -- Object BLF participates in a super sub type relationship
   --
   --
   --
   -- Object BLF is a SUB type of SL_THREE_A via Relationship R18
   --
   -- Object BLF has an identifying non-referential attribute BLF_Identifier 
   -- and therefore may be uniquely created.
   -- 
   -- Object BLF has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "BLF";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_BLF_Type is new Events_Type with record

      --
      -- Non initialised identifying non referential
      BLF_Identifier : Application_Types.Base_Integer_Type;
   ...
   procedure Put_BLF_Identifier (
      ...
      BLF_Identifier_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_BLF_Identifier);
   pragma inline (Put_BLF_Identifier);
