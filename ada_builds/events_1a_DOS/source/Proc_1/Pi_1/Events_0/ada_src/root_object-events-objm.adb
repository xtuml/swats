...
--* Description:             
--*                          Domain body Root_Object.EventsobjM
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objM is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Reference_M_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Reference_M return Application_Types.Base_Integer_Type is
   begin
      Reference_M_Value :=
         Application_Types.Base_Integer_Type'succ (Reference_M_Value);
      return Reference_M_Value;
   end Obtain_Subsequent_Reference_M;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_objM_Type (This_Object.all).Reference_M;
   end Get_Reference_M;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objM_Type (This_Object.all).Reference_M :=
         Reference_M_Value;
   end Put_Reference_M;
...
--ADATEST IGNORE_ON
   function Get_Result_M (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objM_Type (This_Object.all).Result_M;
   end Get_Result_M;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Result_M (
      This_Object : in Root_Object.Object_Access;
      Result_M_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objM_Type (This_Object.all).Result_M :=
         Result_M_Value;
   end Put_Result_M;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objM_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objM_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objM_Type (This_Object.all).R2_Sub;
   end Get_R2_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R2_Sub (
      This_Object : in Root_Object.Object_Access;
      R2_Sub_Value : in Root_Object.Object_Access) is
   begin
      Events_objM_Type (This_Object.all).R2_Sub :=
         R2_Sub_Value;
   end Put_R2_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objM_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objM_Type(This_Object.all).Reference_M := Application_Types.Base_Integer_Type_First;
         Events_objM_Type(This_Object.all).Result_M := Application_Types.Base_Integer_Type_First;
         Events_objM_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_objM_Event_Type;
...
------------------------------------------------------------------------
   procedure Event_Action (
      Dispatch_Event : in     Events_objM_Instance_Event_Type;
      This_Event     : in out Root_Object.Root_Event_Access_Type) is separate;


end Root_Object.Events.objM;
