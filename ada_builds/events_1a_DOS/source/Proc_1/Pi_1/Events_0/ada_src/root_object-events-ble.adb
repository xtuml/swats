...
--* Description:             
--*                          Domain body Root_Object.EventsBLE
...
------------------------------------------------------------------------
--
package body Root_Object.Events.BLE is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   BLE_Identifier_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_BLE_Identifier return Application_Types.Base_Integer_Type is
   begin
      BLE_Identifier_Value :=
         Application_Types.Base_Integer_Type'succ (BLE_Identifier_Value);
      return BLE_Identifier_Value;
   end Obtain_Subsequent_BLE_Identifier;
...
--ADATEST IGNORE_ON
   function Get_BLE_Identifier (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return Events_BLE_Type (This_Object.all).BLE_Identifier;
   end Get_BLE_Identifier;
...
--ADATEST IGNORE_ON
   procedure Put_BLE_Identifier (
      This_Object : in Root_Object.Object_Access;
      BLE_Identifier_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_BLE_Type (This_Object.all).BLE_Identifier :=
         BLE_Identifier_Value;
   end Put_BLE_Identifier;
...
--ADATEST IGNORE_ON
   function Get_Value_To_Add (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_BLE_Type (This_Object.all).Value_To_Add;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BLE_Type (This_Object.all).Value_To_Add :=
         Value_To_Add_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_BLE_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BLE_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_BLE_Type (This_Object.all).R18_Super;
   end Get_R18_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BLE_Type (This_Object.all).R18_Super :=
         R18_Super_Value;
   end Put_R18_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_BLE_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_BLE_Type(This_Object.all).BLE_Identifier := Application_Types.Base_Integer_Type_First;
         Events_BLE_Type(This_Object.all).Value_To_Add := Application_Types.Base_Integer_Type_First;
         Events_BLE_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_BLE_Type(This_Object.all).BLE_Identifier :=
         Obtain_Subsequent_BLE_Identifier;
