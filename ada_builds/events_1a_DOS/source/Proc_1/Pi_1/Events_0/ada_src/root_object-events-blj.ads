...
--* Description:             
--*                          Domain specification Root_Object.EventsBLJ
...
--  ----------------------------------  
--  package Root_Object.Events.BLJ
...
package Root_Object.Events.BLJ is
--
------------------------------------------------------------------------
   --
   --**************  Object Bottom_Level_J Information **************
   --
   -- Object BLJ is PASSIVE
   --
   -- Object BLJ participates in a super sub type relationship
   --
   --
   --
   -- Object BLJ is a SUB type of SL_THREE_D via Relationship R16
   --
   -- Object BLJ has an identifying non-referential attribute BLJ_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object BLJ has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "BLJ";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_BLJ_Type is new Events_Type with record

      --
      -- Non initialised identifying non referential
      BLJ_id : Application_Types.Base_Integer_Type;
   ...
   procedure Put_BLJ_id (
      ...
      BLJ_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_BLJ_id);
   pragma inline (Put_BLJ_id);
