...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.SL_ONE_B.adb
...
--* Description:             
--*                          Domain body Root_Object.EventsSL_ONE_B
...
------------------------------------------------------------------------
--
package body Root_Object.Events.SL_ONE_B is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   SL1B_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_SL1B_id return Application_Types.Base_Integer_Type is
   begin
      SL1B_id_Value :=
         Application_Types.Base_Integer_Type'succ (SL1B_id_Value);
      return SL1B_id_Value;
   end Obtain_Subsequent_SL1B_id;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_SL_ONE_B_Type (This_Object.all).SL1B_id;
   end Get_SL1B_id;
...
--ADATEST IGNORE_ON
   procedure Put_SL1B_id (
      ...
      SL1B_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_SL_ONE_B_Type (This_Object.all).SL1B_id :=
         SL1B_id_Value;
   end Put_SL1B_id;
...
------------------------------------------------------------------------
   --
   -- procedure Put_TL_id and 
   --
   -- function Get_TL_id
   --
   -- have not been generated for TL_id
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SL_ONE_B_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SL_ONE_B_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SL_ONE_B_Type (This_Object.all).R11_Sub;
   end Get_R11_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R11_Sub (
      This_Object : in Root_Object.Object_Access;
      R11_Sub_Value : in Root_Object.Object_Access) is
   begin
      Events_SL_ONE_B_Type (This_Object.all).R11_Sub :=
         R11_Sub_Value;
   end Put_R11_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R9_Super (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Events_SL_ONE_B_Type (This_Object.all).R9_Super;
   end Get_R9_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SL_ONE_B_Type (This_Object.all).R9_Super :=
         R9_Super_Value;
   end Put_R9_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_SL_ONE_B_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_SL_ONE_B_Type(This_Object.all).SL1B_id := Application_Types.Base_Integer_Type_First;
         Events_SL_ONE_B_Type(This_Object.all).Current_State :=  Object_State_Type_First;
