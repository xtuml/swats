...
separate(Root_Object.Events.objTP)
   ...
   procedure Events_objTP_4 (Test_No       : in     Application_Types.Base_Integer_Type;
   ...
   begin
      ...
      if Real_Val =  99.9 then
         ...
         Events_RPT2_Test_Passed_Bridge.Events_RPT2_Test_Passed (
            Test_Object_Domain => "Real Input                      ",
            Test_Number        => Test_No,
            Test_Value         => 0);
         
      else
         Events_RPT3_Test_Failed_Bridge.Events_RPT3_Test_Failed (
            Failed_Domain_Object => "Real Input                      ",
...
--
-- End of file Events_objTP_4.ada
--
