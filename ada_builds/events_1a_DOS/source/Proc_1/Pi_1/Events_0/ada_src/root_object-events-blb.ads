...
--* Description:             
--*                          Domain specification Root_Object.EventsBLB
...
--  ----------------------------------  
--  package Root_Object.Events.BLB
...
package Root_Object.Events.BLB is
--
------------------------------------------------------------------------
   --
   --**************  Object Bottom_Level_B Information **************
   --
   -- Object BLB is PASSIVE
   --
   -- Object BLB participates in a super sub type relationship
   --
   --
   --
   -- Object BLB is a SUB type of SL_THREE_A via Relationship R15
   --
   -- Object BLB has an identifying non-referential attribute BLB_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object BLB has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "BLB";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_BLB_Type is new Events_Type with record

      --
      -- Non initialised identifying non referential
      BLB_id : Application_Types.Base_Integer_Type;
   ...
   procedure Put_BLB_id (
      ...
      BLB_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_BLB_id);
   pragma inline (Put_BLB_id);
