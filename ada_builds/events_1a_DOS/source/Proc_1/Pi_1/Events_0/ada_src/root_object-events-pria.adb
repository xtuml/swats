...
--* Description:             
--*                          Domain body Root_Object.EventsPriA
...
------------------------------------------------------------------------
--
package body Root_Object.Events.PriA is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   A_ID_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_A_ID return Application_Types.Base_Integer_Type is
   begin
      A_ID_Value :=
         Application_Types.Base_Integer_Type'succ (A_ID_Value);
      return A_ID_Value;
   end Obtain_Subsequent_A_ID;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_PriA_Type (This_Object.all).A_ID;
   end Get_A_ID;
...
--ADATEST IGNORE_ON
   procedure Put_A_ID (
      ...
      A_ID_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_PriA_Type (This_Object.all).A_ID :=
         A_ID_Value;
   end Put_A_ID;
...
--ADATEST IGNORE_ON
   function Get_RefA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_PriA_Type (This_Object.all).RefA;
   end Get_RefA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_RefA (
      This_Object : in Root_Object.Object_Access;
      RefA_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_PriA_Type (This_Object.all).RefA :=
         RefA_Value;
   end Put_RefA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Event_Count (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_PriA_Type (This_Object.all).Event_Count;
   end Get_Event_Count;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Event_Count (
      This_Object : in Root_Object.Object_Access;
      Event_Count_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_PriA_Type (This_Object.all).Event_Count :=
         Event_Count_Value;
   end Put_Event_Count;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Done_It (
      This_Object: Root_Object.Object_Access) return  Boolean is
   begin
      return Events_PriA_Type (This_Object.all).Done_It;
   end Get_Done_It;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Done_It (
      This_Object : in Root_Object.Object_Access;
      Done_It_Value : in  Boolean) is
   begin
      Events_PriA_Type (This_Object.all).Done_It :=
         Done_It_Value;
   end Put_Done_It;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Poly_A (
      This_Object: Root_Object.Object_Access) return  Boolean is
   begin
      return Events_PriA_Type (This_Object.all).Poly_A;
   end Get_Poly_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Poly_A (
      This_Object : in Root_Object.Object_Access;
      Poly_A_Value : in  Boolean) is
   begin
      Events_PriA_Type (This_Object.all).Poly_A :=
         Poly_A_Value;
   end Put_Poly_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Poly_B (
      This_Object: Root_Object.Object_Access) return  Boolean is
   begin
      return Events_PriA_Type (This_Object.all).Poly_B;
   end Get_Poly_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Poly_B (
      This_Object : in Root_Object.Object_Access;
      Poly_B_Value : in  Boolean) is
   begin
      Events_PriA_Type (This_Object.all).Poly_B :=
         Poly_B_Value;
   end Put_Poly_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_PriA_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_PriA_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   procedure Put_R20_Sub (
      This_Object : in Root_Object.Object_Access;
      R20_Sub_Value : in Root_Object.Object_Access) is
   begin
      Events_PriA_Type (This_Object.all).R20_Sub :=
         R20_Sub_Value;
   end Put_R20_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_PriA_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_PriA_Type(This_Object.all).A_ID := Application_Types.Base_Integer_Type_First;
         Events_PriA_Type(This_Object.all).RefA := Application_Types.Base_Integer_Type_First;
         Events_PriA_Type(This_Object.all).Event_Count := Application_Types.Base_Integer_Type_First;
         Events_PriA_Type(This_Object.all).Done_It := Application_Types.Boolean_First;
         Events_PriA_Type(This_Object.all).Poly_A := Application_Types.Boolean_First;
         Events_PriA_Type(This_Object.all).Poly_B := Application_Types.Boolean_First;
         Events_PriA_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure Events_PriA_1 (
      Test_No : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure PriA1_To_Check_Priority (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_PriA_Type (This_Instance.all).Current_State := 
         Root_Object.Events.PriA.Object_State_Type(Check_Priority);
   ...
   end PriA1_To_Check_Priority;
--
   procedure PriA3_To_Check_Priority (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_PriA_2 (
         Test_No =>  Events_PriA3(This_Event.all).Test_No,
         Index =>  Events_PriA3(This_Event.all).Index,
         This_Instance => This_Instance );

   end PriA3_To_Check_Priority;
--
   ...
   begin
      ...
      Events_PriA_Type (This_Instance.all).Current_State := 
         Root_Object.Events.PriA.Object_State_Type(Idle);
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_PriA_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_PriA_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_PriA_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_PriA_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_PriA_Event_Queue.Queue_Length (Events_PriA_Queue);
...
--
   ...
   This_Event_Dispatch_Matrix (PriA1, Idle) := PriA1_To_Check_Priority'access;
   This_Event_Dispatch_Matrix (PriA2, Idle) := PriA2_To_Idle'access;
   This_Event_Dispatch_Matrix (PriA3, Idle) := PriA3_To_Check_Priority'access;
   This_Event_Dispatch_Matrix (PriA1, Check_Priority) := PriA1_To_Check_Priority'access;
   This_Event_Dispatch_Matrix (PriA2, Check_Priority) := PriA2_To_Idle'access;
   This_Event_Dispatch_Matrix (PriA3, Check_Priority) := PriA3_To_Check_Priority'access;

end Root_Object.Events.PriA;
