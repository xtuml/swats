...
--* Description:             
--*                          Domain body Root_Object.EventsTD
...
------------------------------------------------------------------------
--
package body Root_Object.Events.TD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_TD_Type (This_Object.all).td_id;
   end Get_td_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_TD_Type (This_Object.all).td_id :=
         td_id_Value;
   end Put_td_id;
...
--ADATEST IGNORE_ON
   function Get_Current_Test_Number (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_TD_Type (This_Object.all).Current_Test_Number;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_TD_Type (This_Object.all).Current_Test_Number :=
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_TD_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_TD_Type(This_Object.all).td_id := Application_Types.Base_Integer_Type_First;
         Events_TD_Type(This_Object.all).Current_Test_Number := Application_Types.Base_Integer_Type_First;
