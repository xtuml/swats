...
--* Description:             
--*                          Domain specification Root_Object.EventsBLG
...
--  ----------------------------------  
--  package Root_Object.Events.BLG
...
package Root_Object.Events.BLG is
--
------------------------------------------------------------------------
   --
   --**************  Object Bottom_Level_G Information **************
   --
   -- Object BLG is PASSIVE
   --
   -- Object BLG participates in a super sub type relationship
   --
   --
   --
   -- Object BLG is a SUB type of SL_THREE_A via Relationship R19
   --
   -- Object BLG has an identifying non-referential attribute BLG_Identifier 
   -- and therefore may be uniquely created.
   -- 
   -- Object BLG has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "BLG";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_BLG_Type is new Events_Type with record

      --
      -- Non initialised identifying non referential
      BLG_Identifier : Application_Types.Base_Integer_Type;
   ...
   procedure Put_BLG_Identifier (
      ...
      BLG_Identifier_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_BLG_Identifier);
   pragma inline (Put_BLG_Identifier);
