...
--* Description:             
--*                          Domain body Root_Object.EventsobjC
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objC is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objC_Type (This_Object.all).ReferenceA;
   end Get_ReferenceA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objC_Type (This_Object.all).ReferenceA :=
         ReferenceA_Value;
   end Put_ReferenceA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_ResultC (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objC_Type (This_Object.all).ResultC;
   end Get_ResultC;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_ResultC (
      This_Object : in Root_Object.Object_Access;
      ResultC_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objC_Type (This_Object.all).ResultC :=
         ResultC_Value;
   end Put_ResultC;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objC_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objC_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objC_Type (This_Object.all).R1_Super;
   end Get_R1_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objC_Type (This_Object.all).R1_Super :=
         R1_Super_Value;
   end Put_R1_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objC_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objC_Type(This_Object.all).ReferenceA := Application_Types.Base_Integer_Type_First;
         Events_objC_Type(This_Object.all).ResultC := Application_Types.Base_Integer_Type_First;
         Events_objC_Type(This_Object.all).Current_State :=  Object_State_Type_First;
