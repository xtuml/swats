...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.objTERMINAL.ads
...
--* Description:             
--*                          Domain specification Root_Object.EventsobjTERMINAL
...
--  ----------------------------------  
--  package Root_Object.Events.objTERMINAL
...
package Root_Object.Events.objTERMINAL is
--
------------------------------------------------------------------------
   --
   --**************  Object Terminal_Object Information **************
   --
   -- Object objTERMINAL is ACTIVE
   --
   --
   --
   -- Object objTERMINAL is ACTIVE and has the following state actions defined
   --   Non_Existent,
   --   Idle,
   --   Terminal_State.
   --
   -- Object objTERMINAL has an identifying non-referential attribute ReferenceTERM 
   -- and therefore may be uniquely created.
   -- 
   -- Object objTERMINAL has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objTERMINAL";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_objTERMINAL_Type is new Events_Type with record

      --
      -- Non initialised identifying non referential
      ReferenceTERM : Application_Types.Base_Integer_Type;
   ...
   procedure Put_ReferenceTERM (
      ...
      ReferenceTERM_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_ReferenceTERM);
   pragma inline (Put_ReferenceTERM);
   ...
   -- EVENT DECLARATION
   --
   type Events_objTERMINAL_Event_Type is new Events_Event_Type with
   record
   ...
   --    
   type Events_objTERMINAL_Instance_Event_Type is new Events_objTERMINAL_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type Events_objTERMINAL_Description_Event is new Events_objTERMINAL_Instance_Event_Type with
   record
      null;
   end record;  
   --
   ...
   type Events_objTERMINAL1 is new Events_objTERMINAL_Instance_Event_Type with
   record 
   ...
   package Events_objTERMINAL_Event_Queue is new Generic_FIFO (Root_Object.Root_Event_Access_Type); 

   Events_objTERMINAL_Queue: Events_objTERMINAL_Event_Queue.FIFO_Type;
