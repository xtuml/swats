...
--* Description:             
--*                          Domain specification Root_Object.EventsSprA
...
--  ----------------------------------  
--  package Root_Object.Events.SprA
...
package Root_Object.Events.SprA is
--
------------------------------------------------------------------------
   --
   --**************  Object SuperA Information **************
   --
   -- Object SprA is ACTIVE
   --
   -- Object SprA participates in a super sub type relationship
   --
   --
   --
   -- Object SprA is ACTIVE and has the following state actions defined
   --   Non_Existent,
   --   Wait_Here,
   --   Fail,
   --   Verify_Migration,
   ...
   --   Idle.
   --
   -- Object SprA is a SUPER type of 
   --    sbB,
   --    sbA
   --    via Relationship R13
   --
   -- Object SprA is a SUPER type of 
   --    sbC,
   --    sbD
   --    via Relationship R14
   --
   -- Object SprA is a SUPER type of 
   --    sbE,
   --    sbF
   --    via Relationship R6
   --
   -- Object SprA has an identifying non-referential attribute idA 
   -- and therefore may be uniquely created.
   -- 
   -- Object SprA has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "SprA";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_SprA_Type is new Events_Type with record
      ...
      --
      -- Initialised Non identifying non referential
      Reference_ID : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      Current_State :  Object_State_Type :=  Object_State_Type_First;

      R13_Sub : Root_Object.Object_Access := null;
      R14_Sub : Root_Object.Object_Access := null;
      R6_Sub : Root_Object.Object_Access := null;
   ...
   procedure Put_Reference_ID (
      This_Object : in Root_Object.Object_Access;
      Reference_ID_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Reference_ID);
   pragma inline (Put_Reference_ID);
   ...
   procedure Put_R13_Sub (
      This_Object :   in  Root_Object.Object_Access;
      R13_Sub_Value : in Root_Object.Object_Access);

   pragma inline (Get_R13_Sub);
   pragma inline (Put_R13_Sub);
   ...
   procedure Put_R14_Sub (
      This_Object :   in  Root_Object.Object_Access;
      R14_Sub_Value : in Root_Object.Object_Access);

   pragma inline (Get_R14_Sub);
   pragma inline (Put_R14_Sub);
   ...
   procedure Put_R6_Sub (
      This_Object :   in  Root_Object.Object_Access;
      R6_Sub_Value : in Root_Object.Object_Access);

   pragma inline (Get_R6_Sub);
   pragma inline (Put_R6_Sub);
   ...
   -- EVENT DECLARATION
   --
   type Events_SprA_Event_Type is new Events_Event_Type with
   record
   ...
   --    
   type Events_SprA_Instance_Event_Type is new Events_SprA_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type Events_SprA_Description_Event is new Events_SprA_Instance_Event_Type with
   record
      null;
   end record;  
   --
   ...
   type Events_SprA1 is new Events_SprA_Instance_Event_Type with
   record 
      Test : Application_Types.Base_Integer_Type;
   end record;

   type Events_SprA2 is new Events_SprA_Instance_Event_Type with
   record 
      Test : Application_Types.Base_Integer_Type;
   end record;

   type Events_SprA3 is new Events_SprA_Instance_Event_Type with
   record 
      null;
   end record;

   type Events_SprA4 is new Events_SprA_Instance_Event_Type with
   record 
      Test : Application_Types.Base_Integer_Type;
   end record;

   type Events_SprA5 is new Events_SprA_Instance_Event_Type with
   record 
      Test : Application_Types.Base_Integer_Type;
   end record;

   type Events_SprA6 is new Events_SprA_Instance_Event_Type with
   record 
      Test : Application_Types.Base_Integer_Type;
   end record;
   ...
   package Events_SprA_Event_Queue is new Generic_FIFO (Root_Object.Root_Event_Access_Type); 

   Events_SprA_Queue: Events_SprA_Event_Queue.FIFO_Type;
