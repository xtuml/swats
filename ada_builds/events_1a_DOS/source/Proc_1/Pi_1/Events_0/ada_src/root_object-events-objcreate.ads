...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.objCREATE.ads
...
--* Description:             
--*                          Domain specification Root_Object.EventsobjCREATE
...
--  ----------------------------------  
--  package Root_Object.Events.objCREATE
...
package Root_Object.Events.objCREATE is
--
------------------------------------------------------------------------
   --
   --**************  Object Creation_Object Information **************
   --
   -- Object objCREATE is ACTIVE
   --
   --
   --
   -- Object objCREATE is ACTIVE and has the following state actions defined
   --   Non_Existent,
   --   Creation_State.
   --
   -- Object objCREATE has an identifying non-referential attribute ReferenceCREATE 
   -- and therefore may be uniquely created.
   -- 
   -- Object objCREATE has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objCREATE";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_objCREATE_Type is new Events_Type with record

      --
      -- Non initialised identifying non referential
      ReferenceCREATE : Application_Types.Base_Integer_Type;
   ...
   procedure Put_ReferenceCREATE (
      ...
      ReferenceCREATE_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_ReferenceCREATE);
   pragma inline (Put_ReferenceCREATE);
   ...
   -- EVENT DECLARATION
   --
   type Events_objCREATE_Event_Type is new Events_Event_Type with
   record
   ...
   --    
   type Events_objCREATE_Instance_Event_Type is new Events_objCREATE_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type Events_objCREATE_Description_Event is new Events_objCREATE_Instance_Event_Type with
   record
      null;
   end record;  
   --
   ...
   type Events_objCREATE1 is new Events_objCREATE_Instance_Event_Type with
   record 
   ...
   package Events_objCREATE_Event_Queue is new Generic_FIFO (Root_Object.Root_Event_Access_Type); 

   Events_objCREATE_Queue: Events_objCREATE_Event_Queue.FIFO_Type;
