...
--* Description:             
--*                          Domain body Root_Object.EventsobjO
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objO_Type (This_Object.all).Reference_O;
   end Get_Reference_O;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Reference_O (
      ...
      Reference_O_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objO_Type (This_Object.all).Reference_O :=
         Reference_O_Value;
   end Put_Reference_O;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Reference_M (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objO_Type (This_Object.all).Reference_M;
   end Get_Reference_M;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objO_Type (This_Object.all).Reference_M :=
         Reference_M_Value;
   end Put_Reference_M;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Result_O (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objO_Type (This_Object.all).Result_O;
   end Get_Result_O;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Result_O (
      This_Object : in Root_Object.Object_Access;
      Result_O_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objO_Type (This_Object.all).Result_O :=
         Result_O_Value;
   end Put_Result_O;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objO_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objO_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objO_Type (This_Object.all).R3_Super;
   end Get_R3_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R3_Super (
      This_Object : in  Root_Object.Object_Access;
      R3_Super_Value : in Root_Object.Object_Access) is
   begin
      Events_objO_Type (This_Object.all).R3_Super :=
         R3_Super_Value;
   end Put_R3_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objO_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objO_Type(This_Object.all).Reference_O := Application_Types.Base_Integer_Type_First;
         Events_objO_Type(This_Object.all).Reference_M := Application_Types.Base_Integer_Type_First;
         Events_objO_Type(This_Object.all).Result_O := Application_Types.Base_Integer_Type_First;
         Events_objO_Type(This_Object.all).Current_State :=  Object_State_Type_First;
