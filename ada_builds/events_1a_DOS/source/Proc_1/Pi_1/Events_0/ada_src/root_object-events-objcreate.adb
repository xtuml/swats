...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.objCREATE.adb
...
--* Description:             
--*                          Domain body Root_Object.EventsobjCREATE
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objCREATE is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   ReferenceCREATE_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceCREATE return Application_Types.Base_Integer_Type is
   begin
      ReferenceCREATE_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceCREATE_Value);
      return ReferenceCREATE_Value;
   end Obtain_Subsequent_ReferenceCREATE;
...
--ADATEST IGNORE_ON
   function Get_ReferenceCREATE (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return Events_objCREATE_Type (This_Object.all).ReferenceCREATE;
   end Get_ReferenceCREATE;
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceCREATE (
      This_Object : in Root_Object.Object_Access;
      ReferenceCREATE_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objCREATE_Type (This_Object.all).ReferenceCREATE :=
         ReferenceCREATE_Value;
   end Put_ReferenceCREATE;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objCREATE_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objCREATE_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objCREATE_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objCREATE_Type(This_Object.all).ReferenceCREATE := Application_Types.Base_Integer_Type_First;
         Events_objCREATE_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objCREATE_Type(This_Object.all).ReferenceCREATE :=
         Obtain_Subsequent_ReferenceCREATE;
...
--
   procedure objCREATE1_To_Creation_State (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_objCREATE_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objCREATE.Object_State_Type(Creation_State);

      Events_objCREATE_1 (
         Test =>  Events_objCREATE1(This_Event.all).Test,
         Test_Number =>  Events_objCREATE1(This_Event.all).Test_Number,
         This_Instance => This_Instance );

   end objCREATE1_To_Creation_State;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_objCREATE_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_objCREATE_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objCREATE_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_objCREATE_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objCREATE_Event_Queue.Pop (
         Item        => Temp_Event,
         Target_FIFO => Events_objCREATE_Queue);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_objCREATE_Event_Queue.Queue_Length (Events_objCREATE_Queue);
...
--ADATEST IGNORE_ON
   procedure Put_Event (
      ...
      To_Class : in Events_objCREATE_Type;
...
--
   This_Event_Dispatch_Matrix (objCREATE1, Non_Existent) := objCREATE1_To_Creation_State'access;
   This_Event_Dispatch_Matrix (objCREATE1, Creation_State) :=  Cannot_Happen_Action'access;

end Root_Object.Events.objCREATE;
