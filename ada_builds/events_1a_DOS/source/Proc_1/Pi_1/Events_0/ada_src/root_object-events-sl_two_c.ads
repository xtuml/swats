...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.SL_TWO_C.ads
...
--* Description:             
--*                          Domain specification Root_Object.EventsSL_TWO_C
...
--  ----------------------------------  
--  package Root_Object.Events.SL_TWO_C
...
package Root_Object.Events.SL_TWO_C is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_Level_2_C Information **************
   --
   -- Object SL_TWO_C is PASSIVE
   --
   -- Object SL_TWO_C participates in a super sub type relationship
   --
   --
   --
   -- Object SL_TWO_C is a SUB type of SL_ONE_B via Relationship R11
   --
   -- Object SL_TWO_C has an identifying non-referential attribute SL2C_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object SL_TWO_C has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "SL_TWO_C";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_SL_TWO_C_Type is new Events_Type with record

      --
      -- Non initialised identifying non referential
      SL2C_id : Application_Types.Base_Integer_Type;
   ...
   procedure Put_SL2C_id (
      ...
      SL2C_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_SL2C_id);
   pragma inline (Put_SL2C_id);
