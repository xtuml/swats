...
--* Description:             
--*                          Domain body Root_Object.EventsBLI
...
------------------------------------------------------------------------
--
package body Root_Object.Events.BLI is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   BLI_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_BLI_id return Application_Types.Base_Integer_Type is
   begin
      BLI_id_Value :=
         Application_Types.Base_Integer_Type'succ (BLI_id_Value);
      return BLI_id_Value;
   end Obtain_Subsequent_BLI_id;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_BLI_Type (This_Object.all).BLI_id;
   end Get_BLI_id;
...
--ADATEST IGNORE_ON
   procedure Put_BLI_id (
      This_Object : in Root_Object.Object_Access;
      BLI_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_BLI_Type (This_Object.all).BLI_id :=
         BLI_id_Value;
   end Put_BLI_id;
...
------------------------------------------------------------------------
   --
   -- procedure Put_SL3D_id and 
   --
   -- function Get_SL3D_id
   --
   -- have not been generated for SL3D_id
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_BLI_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BLI_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   procedure Put_R16_Super (
      This_Object : in  Root_Object.Object_Access;
      R16_Super_Value : in Root_Object.Object_Access) is
   begin
      Events_BLI_Type (This_Object.all).R16_Super :=
         R16_Super_Value;
   end Put_R16_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_BLI_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_BLI_Type(This_Object.all).BLI_id := Application_Types.Base_Integer_Type_First;
         Events_BLI_Type(This_Object.all).Current_State :=  Object_State_Type_First;
