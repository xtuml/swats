...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.objTERMINAL.adb
...
--* Description:             
--*                          Domain body Root_Object.EventsobjTERMINAL
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objTERMINAL is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   ReferenceTERM_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceTERM return Application_Types.Base_Integer_Type is
   begin
      ReferenceTERM_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceTERM_Value);
      return ReferenceTERM_Value;
   end Obtain_Subsequent_ReferenceTERM;
...
--ADATEST IGNORE_ON
   function Get_ReferenceTERM (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return Events_objTERMINAL_Type (This_Object.all).ReferenceTERM;
   end Get_ReferenceTERM;
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceTERM (
      This_Object : in Root_Object.Object_Access;
      ReferenceTERM_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objTERMINAL_Type (This_Object.all).ReferenceTERM :=
         ReferenceTERM_Value;
   end Put_ReferenceTERM;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objTERMINAL_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objTERMINAL_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objTERMINAL_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objTERMINAL_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objTERMINAL_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objTERMINAL_Type(This_Object.all).ReferenceTERM := Application_Types.Base_Integer_Type_First;
         Events_objTERMINAL_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
         Events_objTERMINAL_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objTERMINAL_Type(This_Object.all).ReferenceTERM :=
         Obtain_Subsequent_ReferenceTERM;
...
--
   ...
   procedure Events_objTERMINAL_2 (
...
--
   procedure objTERMINAL1_To_Terminal_State (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_objTERMINAL_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objTERMINAL.Object_State_Type(Terminal_State);

      Events_objTERMINAL_2 (
         Test =>  Events_objTERMINAL1(This_Event.all).Test,
         Test_Number =>  Events_objTERMINAL1(This_Event.all).Test_Number,
         This_Instance => This_Instance );

   end objTERMINAL1_To_Terminal_State;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_objTERMINAL_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_objTERMINAL_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objTERMINAL_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_objTERMINAL_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objTERMINAL_Event_Queue.Pop (
         Item        => Temp_Event,
         Target_FIFO => Events_objTERMINAL_Queue);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_objTERMINAL_Event_Queue.Queue_Length (Events_objTERMINAL_Queue);
...
--ADATEST IGNORE_ON
   procedure Put_Event (
      ...
      To_Class : in Events_objTERMINAL_Type;
...
--
   This_Event_Dispatch_Matrix (objTERMINAL1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objTERMINAL1, Idle) := objTERMINAL1_To_Terminal_State'access;

end Root_Object.Events.objTERMINAL;
