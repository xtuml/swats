...
--* Description:             
--*                          Domain body Root_Object.EventsobjD
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   ReferenceD_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceD return Application_Types.Base_Integer_Type is
   begin
      ReferenceD_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceD_Value);
      return ReferenceD_Value;
   end Obtain_Subsequent_ReferenceD;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_objD_Type (This_Object.all).ReferenceD;
   end Get_ReferenceD;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objD_Type (This_Object.all).ReferenceD :=
         ReferenceD_Value;
   end Put_ReferenceD;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objD_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objD_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_no_of_received_events (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objD_Type (This_Object.all).no_of_received_events;
   end Get_no_of_received_events;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_no_of_received_events (
      This_Object : in Root_Object.Object_Access;
      no_of_received_events_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objD_Type (This_Object.all).no_of_received_events :=
         no_of_received_events_Value;
   end Put_no_of_received_events;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_latest_test (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objD_Type (This_Object.all).latest_test;
   end Get_latest_test;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_latest_test (
      This_Object : in Root_Object.Object_Access;
      latest_test_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objD_Type (This_Object.all).latest_test :=
         latest_test_Value;
   end Put_latest_test;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objD_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objD_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objD_Type (This_Object.all).R5_Sub;
   end Get_R5_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R5_Sub (
      This_Object : in Root_Object.Object_Access;
      R5_Sub_Value : in Root_Object.Object_Access) is
   begin
      Events_objD_Type (This_Object.all).R5_Sub :=
         R5_Sub_Value;
   end Put_R5_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objD_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objD_Type(This_Object.all).ReferenceD := Application_Types.Base_Integer_Type_First;
         Events_objD_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
         Events_objD_Type(This_Object.all).no_of_received_events := Application_Types.Base_Integer_Type_First;
         Events_objD_Type(This_Object.all).latest_test := Application_Types.Base_Integer_Type_First;
         Events_objD_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure Events_objD_1 (
      Test_Number : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure objD2_To_Supertype_Object (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_objD_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objD.Object_State_Type(Supertype_Object);
   ...
   end objD2_To_Supertype_Object;
--
   procedure objD3_To_Supertype_Object (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objD_3 (
         Test =>  Events_objD3(This_Event.all).Test,
         Test_Number =>  Events_objD3(This_Event.all).Test_Number,
         This_Instance => This_Instance );

   end objD3_To_Supertype_Object;
--
   procedure objD1_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objD_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objD.Object_State_Type(Idle);

      Events_objD_1 (
         Test_Number =>  Events_objD1(This_Event.all).Test_Number,
         This_Instance => This_Instance );
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_objD_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_objD_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objD_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_objD_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_objD_Event_Queue.Queue_Length (Events_objD_Queue);
...
--
   ...
   This_Event_Dispatch_Matrix (objD1, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objD2, Idle) := objD2_To_Supertype_Object'access;
   This_Event_Dispatch_Matrix (objD3, Idle) := objD3_To_Supertype_Object'access;
   This_Event_Dispatch_Matrix (objD4, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objD1, Supertype_Object) := objD1_To_Idle'access;
   This_Event_Dispatch_Matrix (objD2, Supertype_Object) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objD3, Supertype_Object) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objD4, Supertype_Object) :=  Cannot_Happen_Action'access;

end Root_Object.Events.objD;
