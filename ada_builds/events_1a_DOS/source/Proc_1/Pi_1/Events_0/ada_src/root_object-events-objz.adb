...
--* Description:             
--*                          Domain body Root_Object.EventsobjZ
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objZ is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   objZ_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_objZ_id return Application_Types.Base_Integer_Type is
   begin
      objZ_id_Value :=
         Application_Types.Base_Integer_Type'succ (objZ_id_Value);
      return objZ_id_Value;
   end Obtain_Subsequent_objZ_id;
...
--ADATEST IGNORE_ON
   procedure Put_objZ_id (
      This_Object : in Root_Object.Object_Access;
      objZ_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objZ_Type (This_Object.all).objZ_id :=
         objZ_id_Value;
   end Put_objZ_id;
...
--ADATEST IGNORE_ON
   function Get_The_Test_No (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objZ_Type (This_Object.all).The_Test_No;
   end Get_The_Test_No;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objZ_Type (This_Object.all).The_Test_No :=
         The_Test_No_Value;
   end Put_The_Test_No;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Int_Att (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objZ_Type (This_Object.all).Int_Att;
   end Get_Int_Att;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Int_Att (
      This_Object : in Root_Object.Object_Access;
      Int_Att_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objZ_Type (This_Object.all).Int_Att :=
         Int_Att_Value;
   end Put_Int_Att;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objZ_Type (This_Object.all).Real_Att;
   end Get_Real_Att;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objZ_Type (This_Object.all).Real_Att :=
         Real_Att_Value;
   end Put_Real_Att;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objZ_Type (This_Object.all).Text_Att;
   end Get_Text_Att;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objZ_Type (This_Object.all).Text_Att :=
         Text_Att_Value;
   end Put_Text_Att;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objZ_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objZ_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objZ_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objZ_Type(This_Object.all).objZ_id := Application_Types.Base_Integer_Type_First;
         Events_objZ_Type(This_Object.all).The_Test_No := Application_Types.Base_Integer_Type_First;
         Events_objZ_Type(This_Object.all).Int_Att := Application_Types.Base_Integer_Type_First;
         Events_objZ_Type(This_Object.all).Real_Att := Application_Types.Base_Float_Type_First;
         Events_objZ_Type(This_Object.all).Text_Att := Application_Types.Base_Text_Type_First;
         Events_objZ_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure Events_objZ_2 (
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_objZ_3 (
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_objZ_1 (
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure objZ1_To_Add (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_objZ_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objZ.Object_State_Type(Add);
...
--
   ...
   begin
      ...
      Events_objZ_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objZ.Object_State_Type(Check);
...
--
   ...
   begin
      ...
      Events_objZ_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objZ.Object_State_Type(Idle);
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_objZ_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_objZ_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objZ_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_objZ_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_objZ_Event_Queue.Queue_Length (Events_objZ_Queue);
...
--
   This_Event_Dispatch_Matrix (objZ1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objZ2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objZ3, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objZ4, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objZ1, Idle) := objZ1_To_Add'access;
   This_Event_Dispatch_Matrix (objZ2, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objZ3, Idle) := objZ3_To_Check'access;
   This_Event_Dispatch_Matrix (objZ4, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objZ1, Add) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objZ2, Add) := objZ2_To_Idle'access;
   This_Event_Dispatch_Matrix (objZ3, Add) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objZ4, Add) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objZ1, Check) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objZ2, Check) := objZ2_To_Idle'access;
   This_Event_Dispatch_Matrix (objZ3, Check) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objZ4, Check) :=  Ignore_Action'access;

end Root_Object.Events.objZ;
