...
--* Description:             
--*                          Domain body Root_Object.EventsBLG
...
------------------------------------------------------------------------
--
package body Root_Object.Events.BLG is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   BLG_Identifier_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_BLG_Identifier return Application_Types.Base_Integer_Type is
   begin
      BLG_Identifier_Value :=
         Application_Types.Base_Integer_Type'succ (BLG_Identifier_Value);
      return BLG_Identifier_Value;
   end Obtain_Subsequent_BLG_Identifier;
...
--ADATEST IGNORE_ON
   function Get_BLG_Identifier (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return Events_BLG_Type (This_Object.all).BLG_Identifier;
   end Get_BLG_Identifier;
...
--ADATEST IGNORE_ON
   procedure Put_BLG_Identifier (
      This_Object : in Root_Object.Object_Access;
      BLG_Identifier_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_BLG_Type (This_Object.all).BLG_Identifier :=
         BLG_Identifier_Value;
   end Put_BLG_Identifier;
...
--ADATEST IGNORE_ON
   function Get_Value_To_Add (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_BLG_Type (This_Object.all).Value_To_Add;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BLG_Type (This_Object.all).Value_To_Add :=
         Value_To_Add_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_BLG_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BLG_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_BLG_Type (This_Object.all).R19_Super;
   end Get_R19_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BLG_Type (This_Object.all).R19_Super :=
         R19_Super_Value;
   end Put_R19_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_BLG_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_BLG_Type(This_Object.all).BLG_Identifier := Application_Types.Base_Integer_Type_First;
         Events_BLG_Type(This_Object.all).Value_To_Add := Application_Types.Base_Integer_Type_First;
         Events_BLG_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_BLG_Type(This_Object.all).BLG_Identifier :=
         Obtain_Subsequent_BLG_Identifier;
