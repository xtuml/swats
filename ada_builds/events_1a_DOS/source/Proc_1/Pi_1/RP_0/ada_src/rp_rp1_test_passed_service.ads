...
--*************************************************************************************
--*                                                                                   *
--* File Name:               RP1_Test_Passed_Service.ads
...
package RP_RP1_Test_Passed_Service is
   ...
   procedure RP_RP1_Test_Passed (
      ...
      Passed_Domain_Number     : in     Application_Types.Base_Integer_Type);
   
end RP_RP1_Test_Passed_Service;

--
-- End of file RP_RP1_Test_Passed_Service.ads
--
