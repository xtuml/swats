...
--* Description:             
--*                          Domain specification Root_Object.RPTD
...
package Root_Object.RP.TD is
--
------------------------------------------------------------------------
   --
   --**************  Object Test_Details Information **************
   --
   -- Object TD is PASSIVE
   --
   --
   --
   -- Object TD does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object TD has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "TD";

   --
   -------------------------------------------------------------------------------------------------
   --

   type RP_TD_Type is new RP_Type with record
      ...
      Test_Purpose : Application_Types.Base_Text_Type := Application_Types.Base_Text_Type_First;

      --
      -- Initialised Non identifying non referential
      Tested_Object : Application_Types.Base_Text_Type := Application_Types.Base_Text_Type_First;
      ...
      --
      R8_A : Root_Object.Object_Access := null;
      R6_B : Root_Object.Object_Access := null;
      R7_B : Root_Object.Object_List.List_Header_Access_Type;
   ...
   procedure Put_Test_Purpose (
      This_Object : in Root_Object.Object_Access;
      Test_Purpose_Value : in Application_Types.Base_Text_Type);

   pragma inline (Get_Test_Purpose);
   pragma inline (Put_Test_Purpose);
   ...
   procedure Put_Tested_Object (
      This_Object : in Root_Object.Object_Access;
      Tested_Object_Value : in Application_Types.Base_Text_Type);

   pragma inline (Get_Tested_Object);
   pragma inline (Put_Tested_Object);
   ...
   procedure Put_Result_Found (
      This_Object : in Root_Object.Object_Access;
      Result_Found_Value : in  Boolean);

   pragma inline (Get_Result_Found);
   pragma inline (Put_Result_Found);
   ...
   procedure Put_R8_A (
      This_Object :   in  Root_Object.Object_Access;
      R8_A_Value : in Root_Object.Object_Access);

   pragma inline (Get_R8_A);
   pragma inline (Put_R8_A);
   ...
   procedure Put_R7_B  (
      This_Object :    in  Root_Object.Object_Access;
      R7_B_Value : in Root_Object.Object_List.List_Header_Access_Type);

   pragma inline (Get_R7_B);
   pragma inline (Put_R7_B);
