...
--* Description:             
--*                          Domain body Root_Object.RPREQS
...
------------------------------------------------------------------------
--
package body Root_Object.RP.REQS is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Unique_REQS_ID_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Unique_REQS_ID return Application_Types.Base_Integer_Type is
   begin
      Unique_REQS_ID_Value :=
         Application_Types.Base_Integer_Type'succ (Unique_REQS_ID_Value);
      return Unique_REQS_ID_Value;
   end Obtain_Subsequent_Unique_REQS_ID;
...
--ADATEST IGNORE_ON
   ...
   begin
       return RP_REQS_Type (This_Object.all).Unique_REQS_ID;
   end Get_Unique_REQS_ID;
...
--ADATEST IGNORE_ON
   procedure Put_Unique_REQS_ID (
      This_Object : in Root_Object.Object_Access;
      Unique_REQS_ID_Value : in Application_Types.Base_Integer_Type) is
   begin
      RP_REQS_Type (This_Object.all).Unique_REQS_ID :=
         Unique_REQS_ID_Value;
   end Put_Unique_REQS_ID;
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_REQS_Type (This_Object.all).REQUID;
   end Get_REQUID;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_REQUID (
      This_Object : in Root_Object.Object_Access;
      REQUID_Value : in Application_Types.Base_Text_Type) is
   begin
      RP_REQS_Type (This_Object.all).REQUID :=
         REQUID_Value;
   end Put_REQUID;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Requid_Test_Status (
      This_Object: Root_Object.Object_Access) return RP_Domain_Types.Requid_Status_Type is
   begin
      return RP_REQS_Type (This_Object.all).Requid_Test_Status;
   end Get_Requid_Test_Status;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Requid_Test_Status (
      This_Object : in Root_Object.Object_Access;
      Requid_Test_Status_Value : in RP_Domain_Types.Requid_Status_Type) is
   begin
      RP_REQS_Type (This_Object.all).Requid_Test_Status :=
         Requid_Test_Status_Value;
   end Put_Requid_Test_Status;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   function Get_Requid_Text (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Text_Type is
   begin
      return RP_REQS_Type (This_Object.all).Requid_Text;
   end Get_Requid_Text;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Requid_Text (
      This_Object : in Root_Object.Object_Access;
      Requid_Text_Value : in Application_Types.Base_Text_Type) is
   begin
      RP_REQS_Type (This_Object.all).Requid_Text :=
         Requid_Text_Value;
   end Put_Requid_Text;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_REQS_Type (This_Object.all).R11_B;
   end Get_R11_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      RP_REQS_Type (This_Object.all).R11_B :=
         R11_B_Value;
   end Put_R11_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_REQS_Type (This_Object.all).R12_B;
   end Get_R12_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R12_B (
      This_Object : in Root_Object.Object_Access;
      R12_B_Value : in Root_Object.Object_List.List_Header_Access_Type) is
   begin
      RP_REQS_Type (This_Object.all).R12_B :=
         R12_B_Value;
   end Put_R12_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new RP_REQS_Type;
   
         RP_REQS_Type(This_Object.all).R12_B := Root_Object.Object_List.Initialise;
      else
         This_Object := Free_List.First_Entry;
         RP_REQS_Type(This_Object.all).Unique_REQS_ID := Application_Types.Base_Integer_Type_First;
         RP_REQS_Type(This_Object.all).REQUID := Application_Types.Base_Text_Type_First;
         RP_REQS_Type(This_Object.all).Requid_Test_Status := RP_Domain_Types.Requid_Status_Type_First;
         RP_REQS_Type(This_Object.all).Requid_Text := Application_Types.Base_Text_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      RP_REQS_Type(This_Object.all).Unique_REQS_ID :=
         Obtain_Subsequent_Unique_REQS_ID;
