...
--* Description:             
--*                          Domain specification Root_Object.RPRM
...
package Root_Object.RP.RM is
--
------------------------------------------------------------------------
   --
   --**************  Object Requirement_Met Information **************
   --
   -- Object RM is PASSIVE
   --
   --
   --
   -- Object RM has an identifying non-referential attribute Unique_Req_Met_ID 
   -- and therefore may be uniquely created.
   -- 
   -- Object RM has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "RM";

   --
   -------------------------------------------------------------------------------------------------
   --

   type RP_RM_Type is new RP_Type with record

      --
      -- Non initialised identifying non referential
      Unique_Req_Met_ID : Application_Types.Base_Integer_Type;

      --
      -- Non Identifying referential. Thou Shalt Not Use. 
      -- Unique_REQS_ID : Application_Types.Base_Integer_Type;
      ...
      --
      -- Initialised Non identifying non referential
      Meeting_Test_Number : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      Requid_Test_Result : RP_Domain_Types.Result_Type := RP_Domain_Types.Result_Type_First;

      --
      -- Initialised Non identifying non referential
      Domain_Number : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      R12_A : Root_Object.Object_Access := null;
   ...
   procedure Put_Unique_Req_Met_ID (
      ...
      Unique_Req_Met_ID_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Unique_Req_Met_ID);
   pragma inline (Put_Unique_Req_Met_ID);
   ...
   procedure Put_Meeting_Test_Number (
      This_Object : in Root_Object.Object_Access;
      Meeting_Test_Number_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Meeting_Test_Number);
   pragma inline (Put_Meeting_Test_Number);
   ...
   procedure Put_Requid_Test_Result (
      This_Object : in Root_Object.Object_Access;
      Requid_Test_Result_Value : in RP_Domain_Types.Result_Type);

   pragma inline (Get_Requid_Test_Result);
   pragma inline (Put_Requid_Test_Result);
   ...
   procedure Put_R12_A (
      This_Object :   in  Root_Object.Object_Access;
      R12_A_Value : in Root_Object.Object_Access);

   pragma inline (Get_R12_A);
   pragma inline (Put_R12_A);
