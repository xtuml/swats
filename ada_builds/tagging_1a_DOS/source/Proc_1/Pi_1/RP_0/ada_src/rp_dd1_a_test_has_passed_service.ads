...
--*************************************************************************************
--*                                                                                   *
--* File Name:               RP_DD1_A_Test_Has_Passed_Service.ads
...
package RP_DD1_A_Test_Has_Passed_Service is
   ...
   procedure RP_DD1_A_Test_Has_Passed (
      ...
      Details_Of_Test       : in     Application_Types.Base_Text_Type);
   
end RP_DD1_A_Test_Has_Passed_Service;

--
-- End of file RP_DD1_A_Test_Has_Passed_Service.ads
--
