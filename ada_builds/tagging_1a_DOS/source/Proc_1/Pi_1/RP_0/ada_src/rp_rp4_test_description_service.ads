...
--*************************************************************************************
--*                                                                                   *
--* File Name:               RP4_Test_Description_Service.ads
...
package RP_RP4_Test_Description_Service is
   ...
   procedure RP_RP4_Test_Description (
      ...
      Write_Invoker_Domain_Number : in     Application_Types.Base_Integer_Type);
   
end RP_RP4_Test_Description_Service;

--
-- End of file RP_RP4_Test_Description_Service.ads
--
