...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.TAGS.ATSUPER.event_action.ada
...
--*  separate of Root_Object.TAGSATSUPER
--*     Event_Action
--*
--*************************************************************************************
--  MODIFICATION RECORD
...
separate (Root_Object.TAGS.ATSUPER)
...
begin
   ...
   This_Action := TAGS_ATSUPER_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := TAGS_ATSUPER_Instance_Event_Type(This_Event.all).Target_Instance;
   ...
   if This /= null then
      ...
      --  
      This_Event_Dispatch_Matrix (This_Action, TAGS_ATSUPER_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
