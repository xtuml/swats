...
--* Description:             
--*                          Domain specification Root_Object.TAGSJM
...
package Root_Object.TAGS.JM is
--
------------------------------------------------------------------------
   --
   --**************  Object Just_Multiple Information **************
   --
   -- Object JM is PASSIVE
   --
   --
   --
   -- Object JM has an identifying non-referential attribute idJM 
   -- and therefore may be uniquely created.
   --
   -- Object JM has the following TAGS attached :
   --    ARRAY (2)
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ...
   Object_String : String := "JM";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_JM_Type is new TAGS_Type with record

      --
      -- Non initialised identifying non referential
      idJM : Application_Types.Base_Integer_Type;
   ...
   procedure Put_idJM (
      ...
      idJM_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idJM);
   pragma inline (Put_idJM);
