...
--*************************************************************************************
--*                                                                                   *
--* File Name:               TAGS8_Perform_Passive_Array_of_1_Object_Tests_Service.adb
...
package body TAGS_TAGS8_Perform_Passive_Array_of_1_Object_Tests_Service is
   
   procedure TAGS_TAGS8_Perform_Passive_Array_of_1_Object_Tests (
   ...
   begin
   -- start of TAGS8_Perform_Passive_Array_of_1_Object_Tests
      ...
      -- --------------------------------------------------------------------------
      Obj := Root_Object.TAGS.APAOOO.Create_Unique;
      
      TAGS_RPT1_Start_Test_Bridge.TAGS_RPT1_Start_Test (
         Test_Number     => Test,
         Requid          => "Null Requid                     ",
         Invoking_Domain => "TAGGING                         ",
         Invoking_Object => "Passive Array 1 UNIQUE object   ",
         Purpose         => "Create one                      ");
      ...
      Any_Object := Root_Object.TAGS.APAOOO.Unconditional_Find_One;
      
      Root_Object.TAGS.APAOOO.Delete (
      ...
      replacement_object := Root_Object.TAGS.APAOOO.Create_Unique;
      ...
      if total_count =  1 then
         ...
         if total_count =  0 then
            new_object := Root_Object.TAGS.APAOOO.Create_Unique;
   ...
   end TAGS_TAGS8_Perform_Passive_Array_of_1_Object_Tests;
   
end TAGS_TAGS8_Perform_Passive_Array_of_1_Object_Tests_Service;

--
-- End of file TAGS_TAGS8_Perform_Passive_Array_of_1_Object_Tests_Service.adb
--
