...
--* Description:             
--*                          Domain specification Root_Object.TAGSRD
...
package Root_Object.TAGS.RD is
--
------------------------------------------------------------------------
   --
   ...
   type TAGS_RD_Type is new TAGS_Type with record
