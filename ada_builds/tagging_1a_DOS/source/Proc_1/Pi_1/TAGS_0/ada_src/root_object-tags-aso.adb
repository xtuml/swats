...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSASO
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.ASO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return TAGS_ASO_Type (This_Object.all).Unique_ID;
   end Get_Unique_ID;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ASO_Type (This_Object.all).Unique_ID :=
         Unique_ID_Value;
   end Put_Unique_ID;
