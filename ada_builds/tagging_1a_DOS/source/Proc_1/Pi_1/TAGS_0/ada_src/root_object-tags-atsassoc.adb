...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSATSASSOC
...
--*  OVERVIEW                                                                         *
--*  --------                                                                         *
--*  Object has been tagged MULTIPLICITY ARRAY with 9 elements
--*
--*  ERROR HANDLING                                                                   *
--*  --------------                                                                   *
--*  None                                                                             *
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.ATSASSOC is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
   ...
   Maximum_Number_Of_Instances : constant Application_Types.Base_Integer_Type := 9;
...
--ADATEST IGNORE_ON
   function Get_Assoc_Unique_Identifier (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_ATSASSOC_Type (This_Object.all).Assoc_Unique_Identifier;
   end Get_Assoc_Unique_Identifier;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Assoc_Unique_Identifier (
      This_Object : in Root_Object.Object_Access;
      Assoc_Unique_Identifier_Value : in Application_Types.Base_Integer_Type) is
   begin
      TAGS_ATSASSOC_Type (This_Object.all).Assoc_Unique_Identifier :=
         Assoc_Unique_Identifier_Value;
   end Put_Assoc_Unique_Identifier;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   function Get_Attribute_Three (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_ATSASSOC_Type (This_Object.all).Attribute_Three;
   end Get_Attribute_Three;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Attribute_Three (
      This_Object : in Root_Object.Object_Access;
      Attribute_Three_Value : in Application_Types.Base_Integer_Type) is
   begin
      TAGS_ATSASSOC_Type (This_Object.all).Attribute_Three :=
         Attribute_Three_Value;
   end Put_Attribute_Three;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_ATSASSOC_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ATSASSOC_Type (This_Object.all).Current_State :=
         Current_State_Value;
   ...
   begin
      ...
      if Object_List.Size < Maximum_Number_Of_Instances then
         ...
         if Free_List.First_Entry = null then
            This_Object := new TAGS_ATSASSOC_Type;
   
         else
            This_Object := Free_List.First_Entry;
            TAGS_ATSASSOC_Type(This_Object.all).Assoc_Unique_Identifier := Application_Types.Base_Integer_Type_First;
            TAGS_ATSASSOC_Type(This_Object.all).Attribute_Three := Application_Types.Base_Integer_Type_First;
            TAGS_ATSASSOC_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure TAGS_ATSASSOC_2 (
      ATS_ASSOC_Test_No : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure ATSASSOC1_To_Blast_Off (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      TAGS_ATSASSOC_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.ATSASSOC.Object_State_Type(Blast_Off);

      TAGS_ATSASSOC_2 (
         ATS_ASSOC_Test_No =>  TAGS_ATSASSOC1(This_Event.all).ATS_ASSOC_Test_No,
         This_Instance => This_Instance );

   end ATSASSOC1_To_Blast_Off;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     TAGS_ATSASSOC_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     TAGS_ATSASSOC_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      TAGS_ATSASSOC_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => TAGS_ATSASSOC_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return TAGS_ATSASSOC_Event_Queue.Queue_Length (TAGS_ATSASSOC_Queue);
...
--ADATEST IGNORE_ON
   procedure Put_Event (
      ...
      To_Class : in TAGS_ATSASSOC_Type;
...
--
   This_Event_Dispatch_Matrix (ATSASSOC1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ATSASSOC1, Idle) := ATSASSOC1_To_Blast_Off'access;
   This_Event_Dispatch_Matrix (ATSASSOC1, Blast_Off) :=  Cannot_Happen_Action'access;

end Root_Object.TAGS.ATSASSOC;
