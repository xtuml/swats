...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.TAGS.ATSUBTWO.event_action.ada
...
--*  separate of Root_Object.TAGSATSUBTWO
--*     Event_Action
--*
--*************************************************************************************
--  MODIFICATION RECORD
...
separate (Root_Object.TAGS.ATSUBTWO)
...
begin
   ...
   This_Action := TAGS_ATSUBTWO_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := TAGS_ATSUBTWO_Instance_Event_Type(This_Event.all).Target_Instance;


   -- Ensure that the source instance still exists. 
   if This /= null then
      This_Event_Dispatch_Matrix (This_Action, TAGS_ATSUBTWO_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
