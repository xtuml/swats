...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.TAGS.TAG_SUPER.adb
...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSTAG_SUPER
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.TAG_SUPER is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return TAGS_TAG_SUPER_Type (This_Object.all).Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_TAG_SUPER_Type (This_Object.all).Unique_Identifier :=
         Unique_Identifier_Value;
...
--ADATEST IGNORE_ON
   function Get_Supertype_Data (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_TAG_SUPER_Type (This_Object.all).Supertype_Data;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_TAG_SUPER_Type (This_Object.all).Supertype_Data :=
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_TAG_SUPER_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_TAG_SUPER_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_TAG_SUPER_Type (This_Object.all).R4_Sub;
   end Get_R4_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_TAG_SUPER_Type (This_Object.all).R4_Sub :=
         R4_Sub_Value;
   end Put_R4_Sub;
--ADATEST IGNORE_OFF
   ...
   begin
      ...
      if Object_List.Size < Maximum_Number_Of_Instances then
         ...
         if Free_List.First_Entry = null then
            This_Object := new TAGS_TAG_SUPER_Type;
   
         else
            This_Object := Free_List.First_Entry;
            TAGS_TAG_SUPER_Type(This_Object.all).Unique_Identifier := Application_Types.Base_Integer_Type_First;
            TAGS_TAG_SUPER_Type(This_Object.all).Supertype_Data := Application_Types.Base_Integer_Type_First;
            TAGS_TAG_SUPER_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     TAGS_TAG_SUPER_Event_Type;
...
------------------------------------------------------------------------
   procedure Event_Action (
      Dispatch_Event : in     TAGS_TAG_SUPER_Instance_Event_Type;
      This_Event     : in out Root_Object.Root_Event_Access_Type) is separate;


end Root_Object.TAGS.TAG_SUPER;
