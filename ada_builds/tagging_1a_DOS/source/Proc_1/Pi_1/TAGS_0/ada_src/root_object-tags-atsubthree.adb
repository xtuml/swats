...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.TAGS.ATSUBTHREE.adb
...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSATSUBTHREE
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.ATSUBTHREE is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_ATSUBTHREE_Type (This_Object.all).Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ATSUBTHREE_Type (This_Object.all).Unique_Identifier :=
...
--ADATEST IGNORE_ON
   function Get_Subtype_Three_Data (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_ATSUBTHREE_Type (This_Object.all).Subtype_Three_Data;
   end Get_Subtype_Three_Data;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Subtype_Three_Data (
      This_Object : in Root_Object.Object_Access;
      Subtype_Three_Data_Value : in Application_Types.Base_Integer_Type) is
   begin
      TAGS_ATSUBTHREE_Type (This_Object.all).Subtype_Three_Data :=
         Subtype_Three_Data_Value;
   end Put_Subtype_Three_Data;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Test_No (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_ATSUBTHREE_Type (This_Object.all).Test_No;
   end Get_Test_No;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Test_No (
      This_Object : in Root_Object.Object_Access;
      Test_No_Value : in Application_Types.Base_Integer_Type) is
   begin
      TAGS_ATSUBTHREE_Type (This_Object.all).Test_No :=
         Test_No_Value;
   end Put_Test_No;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_ATSUBTHREE_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ATSUBTHREE_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   function  Get_R6_Super (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return TAGS_ATSUBTHREE_Type (This_Object.all).R6_Super;
   end Get_R6_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R6_Super (
      This_Object : in  Root_Object.Object_Access;
      R6_Super_Value : in Root_Object.Object_Access) is
   begin
      TAGS_ATSUBTHREE_Type (This_Object.all).R6_Super :=
         R6_Super_Value;
   end Put_R6_Super;
--ADATEST IGNORE_OFF
   ...
   begin
      ...
      if Object_List.Size < Maximum_Number_Of_Instances then
         ...
         if Free_List.First_Entry = null then
            This_Object := new TAGS_ATSUBTHREE_Type;
   
         else
            This_Object := Free_List.First_Entry;
            TAGS_ATSUBTHREE_Type(This_Object.all).Unique_Identifier := Application_Types.Base_Integer_Type_First;
            TAGS_ATSUBTHREE_Type(This_Object.all).Subtype_Three_Data := Application_Types.Base_Integer_Type_First;
            TAGS_ATSUBTHREE_Type(This_Object.all).Test_No := Application_Types.Base_Integer_Type_First;
            TAGS_ATSUBTHREE_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
----------------------------------------------------------------------------
   ...
   procedure Polymorphic_Put (
      This_Object : in out TAGS_ATSUBTHREE_Type;
      This_Event  : in     Root_Object.Root_Event_Access_Type) is

      Parent_Event_Type : Root_Object.TAGS.ATSUPER.Event_Class;
      Next_Event        : Root_Object.Root_Event_Access_Type;

   begin

      Parent_Event_Type := Root_Object.TAGS.ATSUPER.TAGS_ATSUPER_Event_Type(This_Event.all).This_Event_Class;

      case Parent_Event_Type is

         when Root_Object.TAGS.ATSUPER.ATSUPER1 =>

            Next_Event := new Root_Object.TAGS.ATSUBTHREE.TAGS_ATSUPER1'(
            Root_Event_Type with
               This_Event_Class => Root_Object.TAGS.ATSUBTHREE.ATSUPER1,
               Target_Instance  => This_Object'Unchecked_Access);


         when Root_Object.TAGS.ATSUPER.Class_Event =>
...
--
   ...
   procedure TAGS_ATSUBTHREE_2 (
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure ATSUPER1_To_Sub_Three_State (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      TAGS_ATSUBTHREE_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.ATSUBTHREE.Object_State_Type(Sub_Three_State);

      TAGS_ATSUBTHREE_2 (
         This_Instance => This_Instance );

   end ATSUPER1_To_Sub_Three_State;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     TAGS_ATSUBTHREE_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     TAGS_ATSUBTHREE_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      TAGS_ATSUBTHREE_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => TAGS_ATSUBTHREE_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      TAGS_ATSUBTHREE_Event_Queue.Pop (
         Item        => Temp_Event,
         Target_FIFO => TAGS_ATSUBTHREE_Queue);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return TAGS_ATSUBTHREE_Event_Queue.Queue_Length (TAGS_ATSUBTHREE_Queue);
...
--ADATEST IGNORE_ON
   procedure Put_Event (
      ...
      To_Class : in TAGS_ATSUBTHREE_Type;
...
--
   ...
   This_Event_Dispatch_Matrix (ATSUPER1, Idle) := ATSUPER1_To_Sub_Three_State'access;
   This_Event_Dispatch_Matrix (ATSUPER1, Sub_Three_State) :=  Ignore_Action'access;

end Root_Object.TAGS.ATSUBTHREE;
