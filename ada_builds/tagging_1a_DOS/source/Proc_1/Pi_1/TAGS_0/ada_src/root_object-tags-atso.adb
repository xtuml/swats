...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSATSO
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.ATSO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
   ...
   The_Object: aliased TAGS_ATSO_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
       return TAGS_ATSO_Type (This_Object.all).Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ATSO_Type (This_Object.all).Unique_Identifier :=
         Unique_Identifier_Value;
...
--ADATEST IGNORE_ON
   function Get_Attribute_One (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_ATSO_Type (This_Object.all).Attribute_One;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ATSO_Type (This_Object.all).Attribute_One :=
         Attribute_One_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_ATSO_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ATSO_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_ATSO_Type (This_Object.all).R2_B;
   end Get_R2_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R2_B (
      This_Object : in Root_Object.Object_Access;
      R2_B_Value : in Root_Object.Object_List.List_Header_Access_Type) is
   begin
      TAGS_ATSO_Type (This_Object.all).R2_B :=
         R2_B_Value;
   end Put_R2_B;
--ADATEST IGNORE_OFF
...
---------------------------------------------------------------------
   ...
   begin
      ...
      TAGS_ATSO_Type(Old_Instance.all).Created := FALSE;
...
--
   ...
   procedure TAGS_ATSO_2 (
      The_Test_No : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure ATSO1_To_State_1 (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      TAGS_ATSO_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.ATSO.Object_State_Type(State_1);

      TAGS_ATSO_2 (
         The_Test_No =>  TAGS_ATSO1(This_Event.all).The_Test_No,
         This_Instance => This_Instance );

   end ATSO1_To_State_1;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      TAGS_ATSO_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => TAGS_ATSO_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return TAGS_ATSO_Event_Queue.Queue_Length (TAGS_ATSO_Queue);
...
--
   This_Event_Dispatch_Matrix (ATSO1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ATSO1, Idle) := ATSO1_To_State_1'access;
   This_Event_Dispatch_Matrix (ATSO1, State_1) :=  Ignore_Action'access;
