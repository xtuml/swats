...
--* Description:             
--*                          Domain specification Root_Object.TAGSATMO
...
package Root_Object.TAGS.ATMO is
--
------------------------------------------------------------------------
   --
   --**************  Object Active_Tagged_Many_Objects Information **************
   --
   -- Object ATMO is ACTIVE
   --
   --
   --
   -- Object ATMO is ACTIVE and has the following state actions defined
   --   Non_Existent,
   --   Idle,
   --   State_One.
   --
   -- Object ATMO has an identifying non-referential attribute Other_Unique_Identifier 
   -- and therefore may be uniquely created.
   --
   -- Object ATMO has the following TAGS attached :
   --    ARRAY (3)
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ...
   Object_String : String := "ATMO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_ATMO_Type is new TAGS_Type with record
      ...
      Other_Unique_Identifier : Application_Types.Base_Integer_Type;

      --
      -- Initialised Non identifying non referential
      Attribute_Two : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      Current_State :  Object_State_Type :=  Object_State_Type_First;

      R2_A : Root_Object.Object_Access := null;
   ...
   procedure Put_Other_Unique_Identifier (
      ...
      Other_Unique_Identifier_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Other_Unique_Identifier);
   pragma inline (Put_Other_Unique_Identifier);
   ...
   procedure Put_Attribute_Two (
      This_Object : in Root_Object.Object_Access;
      Attribute_Two_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Attribute_Two);
   pragma inline (Put_Attribute_Two);
   ...
   procedure Put_R2_A (
      This_Object :   in  Root_Object.Object_Access;
      R2_A_Value : in Root_Object.Object_Access);

   pragma inline (Get_R2_A);
   pragma inline (Put_R2_A);
   ...
   -- EVENT DECLARATION
   --
   type TAGS_ATMO_Event_Type is new TAGS_Event_Type with
   record
   ...
   --    
   type TAGS_ATMO_Instance_Event_Type is new TAGS_ATMO_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type TAGS_ATMO_Description_Event is new TAGS_ATMO_Instance_Event_Type with
   record
      null;
   end record;  
   --
   ...
   type TAGS_ATMO1 is new TAGS_ATMO_Instance_Event_Type with
   record 
      ATMO_Test_No : Application_Types.Base_Integer_Type;
   end record;
   ...
   package TAGS_ATMO_Event_Queue is new Generic_FIFO (Root_Object.Root_Event_Access_Type); 

   TAGS_ATMO_Queue: TAGS_ATMO_Event_Queue.FIFO_Type;
