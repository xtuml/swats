...
--* Description:             
--*                          Domain body Root_Object.TAGSTD
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.TD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return TAGS_TD_Type (This_Object.all).td_id;
   end Get_td_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_TD_Type (This_Object.all).td_id :=
         td_id_Value;
   end Put_td_id;
...
--ADATEST IGNORE_ON
   function Get_Number (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_TD_Type (This_Object.all).Number;
   end Get_Number;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Number (
      This_Object : in Root_Object.Object_Access;
      Number_Value : in Application_Types.Base_Integer_Type) is
   begin
      TAGS_TD_Type (This_Object.all).Number :=
         Number_Value;
   end Put_Number;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Environment (
      This_Object: Root_Object.Object_Access) return TAGS_Domain_Types.Environment_Type is
   begin
      return TAGS_TD_Type (This_Object.all).Environment;
   end Get_Environment;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Environment (
      This_Object : in Root_Object.Object_Access;
      Environment_Value : in TAGS_Domain_Types.Environment_Type) is
   begin
      TAGS_TD_Type (This_Object.all).Environment :=
         Environment_Value;
   end Put_Environment;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_TD_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_TD_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new TAGS_TD_Type;
   
      else
         This_Object := Free_List.First_Entry;
         TAGS_TD_Type(This_Object.all).td_id := Application_Types.Base_Integer_Type_First;
         TAGS_TD_Type(This_Object.all).Number := Application_Types.Base_Integer_Type_First;
         TAGS_TD_Type(This_Object.all).Environment := TAGS_Domain_Types.Environment_Type_First;
         TAGS_TD_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   procedure TD1_To_Tests_Complete (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      TAGS_TD_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.TD.Object_State_Type(Tests_Complete);

      TAGS_TD_2 (
         This_Instance => This_Instance );

   end TD1_To_Tests_Complete;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     TAGS_TD_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     TAGS_TD_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      TAGS_TD_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => TAGS_TD_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return TAGS_TD_Event_Queue.Queue_Length (TAGS_TD_Queue);
...
--
   This_Event_Dispatch_Matrix (TD1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TD1, Idle) := TD1_To_Tests_Complete'access;

end Root_Object.TAGS.TD;
