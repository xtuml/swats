...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSJM
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.JM is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idJM_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idJM return Application_Types.Base_Integer_Type is
   begin
      idJM_Value :=
         Application_Types.Base_Integer_Type'succ (idJM_Value);
      return idJM_Value;
   end Obtain_Subsequent_idJM;
...
--ADATEST IGNORE_ON
   ...
   begin
       return TAGS_JM_Type (This_Object.all).idJM;
   end Get_idJM;
...
--ADATEST IGNORE_ON
   procedure Put_idJM (
      ...
      idJM_Value : in Application_Types.Base_Integer_Type) is
   begin
      TAGS_JM_Type (This_Object.all).idJM :=
         idJM_Value;
   end Put_idJM;
   ...
   begin
      ...
      if Object_List.Size < Maximum_Number_Of_Instances then
         ...
         if Free_List.First_Entry = null then
            This_Object := new TAGS_JM_Type;
   
         else
            This_Object := Free_List.First_Entry;
            TAGS_JM_Type(This_Object.all).idJM := Application_Types.Base_Integer_Type_First;
