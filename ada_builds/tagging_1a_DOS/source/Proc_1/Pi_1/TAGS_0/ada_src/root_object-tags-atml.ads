...
--* Description:             
--*                          Domain specification Root_Object.TAGSATML
...
package Root_Object.TAGS.ATML is
--
------------------------------------------------------------------------
   --
   --**************  Object Active_Tagged_Many_Left Information **************
   --
   -- Object ATML is ACTIVE
   --
   --
   --
   -- Object ATML is ACTIVE and has the following state actions defined
   --   Non_Existent,
   --   Idle,
   --   Active.
   --
   -- Object ATML has an identifying non-referential attribute Unique_Identifier 
   -- and therefore may be uniquely created.
   --
   -- Object ATML has the following TAGS attached :
   --    ARRAY (3)
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ...
   Object_String : String := "ATML";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_ATML_Type is new TAGS_Type with record
   ...
   -- EVENT DECLARATION
   --
   type TAGS_ATML_Event_Type is new TAGS_Event_Type with
   record
   ...
   --    
   type TAGS_ATML_Instance_Event_Type is new TAGS_ATML_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type TAGS_ATML_Description_Event is new TAGS_ATML_Instance_Event_Type with
   record
      null;
   end record;  
   --
   ...
   type TAGS_ATML1 is new TAGS_ATML_Instance_Event_Type with
   record 
      ATML_Test_No : Application_Types.Base_Integer_Type;
   end record;
   ...
   package TAGS_ATML_Event_Queue is new Generic_FIFO (Root_Object.Root_Event_Access_Type); 

   TAGS_ATML_Queue: TAGS_ATML_Event_Queue.FIFO_Type;
