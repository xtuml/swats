...
--* Description:             
--*                          Domain specification Root_Object.TAGSATMR
...
package Root_Object.TAGS.ATMR is
--
------------------------------------------------------------------------
   --
   --**************  Object Active_Tagged_Many_Right Information **************
   --
   -- Object ATMR is ACTIVE
   --
   --
   --
   -- Object ATMR is ACTIVE and has the following state actions defined
   --   Non_Existent,
   --   Idle,
   --   Under_Power.
   --
   -- Object ATMR has an identifying non-referential attribute Other_Unique_Identifier 
   -- and therefore may be uniquely created.
   --
   -- Object ATMR has the following TAGS attached :
   --    ARRAY (3)
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ...
   Object_String : String := "ATMR";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_ATMR_Type is new TAGS_Type with record
   ...
   -- EVENT DECLARATION
   --
   type TAGS_ATMR_Event_Type is new TAGS_Event_Type with
   record
   ...
   --    
   type TAGS_ATMR_Instance_Event_Type is new TAGS_ATMR_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type TAGS_ATMR_Description_Event is new TAGS_ATMR_Instance_Event_Type with
   record
      null;
   end record;  
   --
   ...
   type TAGS_ATMR1 is new TAGS_ATMR_Instance_Event_Type with
   record 
      ATMR_Test_No : Application_Types.Base_Integer_Type;
   end record;
   ...
   package TAGS_ATMR_Event_Queue is new Generic_FIFO (Root_Object.Root_Event_Access_Type); 

   TAGS_ATMR_Queue: TAGS_ATMR_Event_Queue.FIFO_Type;
