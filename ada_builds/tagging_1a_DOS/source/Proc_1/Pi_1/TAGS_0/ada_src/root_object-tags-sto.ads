...
--* Description:             
--*                          Domain specification Root_Object.TAGSSTO
...
package Root_Object.TAGS.STO is
--
------------------------------------------------------------------------
   --
   --**************  Object Single_Tagged_Object Information **************
   --
   -- Object STO is PASSIVE
   --
   --
   --
   -- Object STO has an identifying non-referential attribute Unique_Identifier 
   -- and therefore may be uniquely created.
   --
   -- Object STO has the following TAGS attached :
   --    SINGLETON 
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ...
   Object_String : String := "STO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_STO_Type is new TAGS_Type with record
      ...
      --
      R1_B : Root_Object.Object_List.List_Header_Access_Type  := Root_Object.Object_List.Initialise;
   ...
   procedure Put_R1_B  (
      This_Object :    in  Root_Object.Object_Access;
      R1_B_Value : in Root_Object.Object_List.List_Header_Access_Type);
