...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSSTO
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.STO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
   ...
   The_Object: aliased TAGS_STO_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
       return TAGS_STO_Type (This_Object.all).Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_STO_Type (This_Object.all).Unique_Identifier :=
         Unique_Identifier_Value;
...
--ADATEST IGNORE_ON
   function Get_Attribute_One (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_STO_Type (This_Object.all).Attribute_One;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_STO_Type (This_Object.all).Attribute_One :=
         Attribute_One_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_STO_Type (This_Object.all).R1_B;
   end Get_R1_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R1_B (
      This_Object : in Root_Object.Object_Access;
      R1_B_Value : in Root_Object.Object_List.List_Header_Access_Type) is
   begin
      TAGS_STO_Type (This_Object.all).R1_B :=
         R1_B_Value;
   end Put_R1_B;
--ADATEST IGNORE_OFF
...
---------------------------------------------------------------------
   ...
   begin
      ...
      TAGS_STO_Type(Old_Instance.all).Created := FALSE;
