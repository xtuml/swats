...
--* Description:             
--*                          Domain specification Root_Object.TAGSSUB_ONE
...
--  ----------------------------------  
--  package Root_Object.TAGS.SUB_ONE
...
package Root_Object.TAGS.SUB_ONE is
--
------------------------------------------------------------------------
   --
   --**************  Object Subtype_1 Information **************
   --
   -- Object SUB_ONE is PASSIVE
   --
   -- Object SUB_ONE participates in a super sub type relationship
   --
   --
   --
   -- Object SUB_ONE is a SUB type of TAG_SUPER via Relationship R4
   --
   -- Object SUB_ONE does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   --
   -- Object SUB_ONE has the following TAGS attached :
   --    ARRAY (2)
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ...
   Object_String : String := "SUB_ONE";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_SUB_ONE_Type is new TAGS_Type with record
      ...
      Subtype_1_Data : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_Subtype_1_Data (
      This_Object : in Root_Object.Object_Access;
      Subtype_1_Data_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Subtype_1_Data);
   pragma inline (Put_Subtype_1_Data);
