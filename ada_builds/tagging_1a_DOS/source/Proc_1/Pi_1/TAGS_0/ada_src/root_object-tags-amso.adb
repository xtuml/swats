...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSAMSO
--* Comments:                Header written by header.macro                           *
--*                          Static object, delete removed 
--*                                                                                   *
--*************************************************************************************
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.AMSO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Unique_ID_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Unique_ID return Application_Types.Base_Integer_Type is
   begin
      Unique_ID_Value :=
         Application_Types.Base_Integer_Type'succ (Unique_ID_Value);
      return Unique_ID_Value;
   end Obtain_Subsequent_Unique_ID;
...
--ADATEST IGNORE_ON
   ...
   begin
       return TAGS_AMSO_Type (This_Object.all).Unique_ID;
   end Get_Unique_ID;
...
--ADATEST IGNORE_ON
   procedure Put_Unique_ID (
      This_Object : in Root_Object.Object_Access;
      Unique_ID_Value : in Application_Types.Base_Integer_Type) is
   begin
      TAGS_AMSO_Type (This_Object.all).Unique_ID :=
         Unique_ID_Value;
   end Put_Unique_ID;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Object_List.Size < Maximum_Number_Of_Instances then
         ...
         -- Static object, no free list to worry about here!
         This_Object := new TAGS_AMSO_Type;
         --
...
---------------------------------------------------------------------
   ...
   --
   -- Procedure Delete removed for Static Object.
   --
