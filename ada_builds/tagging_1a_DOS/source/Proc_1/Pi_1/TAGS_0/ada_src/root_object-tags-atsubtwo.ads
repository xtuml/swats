...
--* Description:             
--*                          Domain specification Root_Object.TAGSATSUBTWO
...
--  ----------------------------------  
--  package Root_Object.TAGS.ATSUBTWO
...
package Root_Object.TAGS.ATSUBTWO is
--
------------------------------------------------------------------------
   --
   --**************  Object Active_Tagged_Subtype_Two Information **************
   --
   -- Object ATSUBTWO is ACTIVE
   --
   -- Object ATSUBTWO participates in a super sub type relationship
   --
   --
   --
   -- Object ATSUBTWO is ACTIVE and has the following state actions defined
   --   Non_Existent,
   --   Idle,
   --   Sub_Two_State.
   --
   -- Object ATSUBTWO is a SUB type of ATSUPER via Relationship R6
   --
   -- Object ATSUBTWO does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   --
   -- Object ATSUBTWO has the following TAGS attached :
   --    SINGLETON 
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ...
   Object_String : String := "ATSUBTWO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_ATSUBTWO_Type is new TAGS_Type with record
      ...
      Subtype_Two_Data : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_Subtype_Two_Data (
      This_Object : in Root_Object.Object_Access;
      Subtype_Two_Data_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Subtype_Two_Data);
   pragma inline (Put_Subtype_Two_Data);
   ...
   -- EVENT DECLARATION
   --
   type TAGS_ATSUBTWO_Event_Type is new TAGS_Event_Type with
   record
   ...
   --    
   type TAGS_ATSUBTWO_Instance_Event_Type is new TAGS_ATSUBTWO_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type TAGS_ATSUBTWO_Description_Event is new TAGS_ATSUBTWO_Instance_Event_Type with
   record
      null;
   end record;  
   --
   ...
   type TAGS_ATSUPER1 is new TAGS_ATSUBTWO_Instance_Event_Type with
   record 
      null;
   end record;
   ...
   package TAGS_ATSUBTWO_Event_Queue is new Generic_FIFO (Root_Object.Root_Event_Access_Type); 

   TAGS_ATSUBTWO_Queue: TAGS_ATSUBTWO_Event_Queue.FIFO_Type;
