...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.TAGS.ATSUBTHREE.ads
...
--* Description:             
--*                          Domain specification Root_Object.TAGSATSUBTHREE
...
--  ----------------------------------  
--  package Root_Object.TAGS.ATSUBTHREE
...
package Root_Object.TAGS.ATSUBTHREE is
--
------------------------------------------------------------------------
   --
   --**************  Object Active_Tagged_Subtype_Three Information **************
   --
   -- Object ATSUBTHREE is ACTIVE
   --
   -- Object ATSUBTHREE participates in a super sub type relationship
   --
   --
   --
   -- Object ATSUBTHREE is ACTIVE and has the following state actions defined
   --   Non_Existent,
   --   Idle,
   --   Sub_Three_State.
   --
   -- Object ATSUBTHREE is a SUB type of ATSUPER via Relationship R6
   --
   -- Object ATSUBTHREE does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   --
   -- Object ATSUBTHREE has the following TAGS attached :
   --    ARRAY (1)
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ...
   Object_String : String := "ATSUBTHREE";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_ATSUBTHREE_Type is new TAGS_Type with record
      ...
      Subtype_Three_Data : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      Test_No : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      Current_State :  Object_State_Type :=  Object_State_Type_First;

      R6_Super : Root_Object.Object_Access := null;
   ...
   procedure Put_Subtype_Three_Data (
      This_Object : in Root_Object.Object_Access;
      Subtype_Three_Data_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Subtype_Three_Data);
   pragma inline (Put_Subtype_Three_Data);
   ...
   procedure Put_Test_No (
      This_Object : in Root_Object.Object_Access;
      Test_No_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Test_No);
   pragma inline (Put_Test_No);
   ...
   procedure Put_R6_Super (
      This_Object : in  Root_Object.Object_Access;
      R6_Super_Value : in Root_Object.Object_Access);

   pragma inline (Get_R6_Super);
   pragma inline (Put_R6_Super);
   ...
   -- EVENT DECLARATION
   --
   type TAGS_ATSUBTHREE_Event_Type is new TAGS_Event_Type with
   record
   ...
   --    
   type TAGS_ATSUBTHREE_Instance_Event_Type is new TAGS_ATSUBTHREE_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type TAGS_ATSUBTHREE_Description_Event is new TAGS_ATSUBTHREE_Instance_Event_Type with
   record
      null;
   end record;  
   --
   ...
   type TAGS_ATSUPER1 is new TAGS_ATSUBTHREE_Instance_Event_Type with
   record 
      null;
   end record;
   ...
   package TAGS_ATSUBTHREE_Event_Queue is new Generic_FIFO (Root_Object.Root_Event_Access_Type); 

   TAGS_ATSUBTHREE_Queue: TAGS_ATSUBTHREE_Event_Queue.FIFO_Type;
