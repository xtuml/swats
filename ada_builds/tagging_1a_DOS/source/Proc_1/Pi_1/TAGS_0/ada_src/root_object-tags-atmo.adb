...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSATMO
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.ATMO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   --
   -- procedure Put_Unique_Identifier and 
   --
   -- function Get_Unique_Identifier
   --
   -- have not been generated for Unique_Identifier
   -- as this attribute is non-identifying referential.
   --
------------------------------------------------------------------------

   Other_Unique_Identifier_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Other_Unique_Identifier return Application_Types.Base_Integer_Type is
   begin
      Other_Unique_Identifier_Value :=
         Application_Types.Base_Integer_Type'succ (Other_Unique_Identifier_Value);
      return Other_Unique_Identifier_Value;
   end Obtain_Subsequent_Other_Unique_Identifier;
...
--ADATEST IGNORE_ON
   function Get_Other_Unique_Identifier (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return TAGS_ATMO_Type (This_Object.all).Other_Unique_Identifier;
   end Get_Other_Unique_Identifier;
...
--ADATEST IGNORE_ON
   procedure Put_Other_Unique_Identifier (
      This_Object : in Root_Object.Object_Access;
      Other_Unique_Identifier_Value : in Application_Types.Base_Integer_Type) is
   begin
      TAGS_ATMO_Type (This_Object.all).Other_Unique_Identifier :=
         Other_Unique_Identifier_Value;
   end Put_Other_Unique_Identifier;
...
--ADATEST IGNORE_ON
   function Get_Attribute_Two (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_ATMO_Type (This_Object.all).Attribute_Two;
   end Get_Attribute_Two;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Attribute_Two (
      This_Object : in Root_Object.Object_Access;
      Attribute_Two_Value : in Application_Types.Base_Integer_Type) is
   begin
      TAGS_ATMO_Type (This_Object.all).Attribute_Two :=
         Attribute_Two_Value;
   end Put_Attribute_Two;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_ATMO_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ATMO_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_ATMO_Type (This_Object.all).R2_A;
   end Get_R2_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R2_A (
      This_Object : in Root_Object.Object_Access;
      R2_A_Value : in Root_Object.Object_Access) is
   begin
      TAGS_ATMO_Type (This_Object.all).R2_A :=
         R2_A_Value;
   end Put_R2_A;
--ADATEST IGNORE_OFF
   ...
   begin
      ...
      if Object_List.Size < Maximum_Number_Of_Instances then
         ...
         if Free_List.First_Entry = null then
            This_Object := new TAGS_ATMO_Type;
   
         else
            This_Object := Free_List.First_Entry;
            TAGS_ATMO_Type(This_Object.all).Other_Unique_Identifier := Application_Types.Base_Integer_Type_First;
            TAGS_ATMO_Type(This_Object.all).Attribute_Two := Application_Types.Base_Integer_Type_First;
            TAGS_ATMO_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if This_Object /= null then
         ...
         TAGS_ATMO_Type(This_Object.all).Other_Unique_Identifier :=
            Obtain_Subsequent_Other_Unique_Identifier;
...
--
   ...
   procedure TAGS_ATMO_2 (
      ATMO_Test_No : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure ATMO1_To_State_One (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      TAGS_ATMO_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.ATMO.Object_State_Type(State_One);

      TAGS_ATMO_2 (
         ATMO_Test_No =>  TAGS_ATMO1(This_Event.all).ATMO_Test_No,
         This_Instance => This_Instance );

   end ATMO1_To_State_One;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     TAGS_ATMO_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     TAGS_ATMO_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      TAGS_ATMO_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => TAGS_ATMO_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return TAGS_ATMO_Event_Queue.Queue_Length (TAGS_ATMO_Queue);
...
--
   This_Event_Dispatch_Matrix (ATMO1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ATMO1, Idle) := ATMO1_To_State_One'access;
   This_Event_Dispatch_Matrix (ATMO1, State_One) :=  Ignore_Action'access;

end Root_Object.TAGS.ATMO;
