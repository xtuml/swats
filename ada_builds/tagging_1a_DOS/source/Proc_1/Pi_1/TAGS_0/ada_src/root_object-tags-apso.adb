...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSAPSO
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.APSO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
   ...
   The_Object: aliased TAGS_APSO_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
       return TAGS_APSO_Type (This_Object.all).Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_APSO_Type (This_Object.all).Unique_Identifier :=
         Unique_Identifier_Value;
...
--ADATEST IGNORE_ON
   function Get_Size (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_APSO_Type (This_Object.all).Size;
   end Get_Size;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Size (
      This_Object : in Root_Object.Object_Access;
      Size_Value : in Application_Types.Base_Integer_Type) is
   begin
      TAGS_APSO_Type (This_Object.all).Size :=
         Size_Value;
   end Put_Size;
--ADATEST IGNORE_OFF
...
---------------------------------------------------------------------
   ...
   begin
      ...
      TAGS_APSO_Type(Old_Instance.all).Created := FALSE;
