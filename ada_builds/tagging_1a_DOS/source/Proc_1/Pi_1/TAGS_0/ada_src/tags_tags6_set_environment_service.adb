...
--*************************************************************************************
--*                                                                                   *
--* File Name:               TAGS6_Set_Environment_Service.adb
...
package body TAGS_TAGS6_Set_Environment_Service is
   
   procedure TAGS_TAGS6_Set_Environment (
   ...
   begin
   -- start of TAGS6_Set_Environment
   ...
   end TAGS_TAGS6_Set_Environment;
   
end TAGS_TAGS6_Set_Environment_Service;

--
-- End of file TAGS_TAGS6_Set_Environment_Service.adb
--
