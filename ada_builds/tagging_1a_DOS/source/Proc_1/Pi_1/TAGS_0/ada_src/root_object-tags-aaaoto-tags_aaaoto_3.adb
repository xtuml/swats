...
separate(Root_Object.TAGS.AAAOTO)
   ...
   procedure TAGS_AAAOTO_3 (This_Instance : in out Root_Object.Object_Access) is
   
      
      my_test              : Root_Object.Object_Access;
      Replacement_Instance : Root_Object.Object_Access;
   ...
   begin
      ...
      Root_Object.TAGS.AAAOTO.Delete (
      ...
      TAGS_RPT1_Start_Test_Bridge.TAGS_RPT1_Start_Test (
         ...
         Invoking_Domain => "Tagging                         ",
         Invoking_Object => "Multiple Array Active Object    ",
         Purpose         => "Recreate self                   ");
      
      Replacement_Instance := Root_Object.TAGS.AAAOTO.Create_Unique;
      Root_Object.TAGS.AAAOTO.TAGS_AAAOTO_Type(Replacement_Instance.all).Result        := 0;
      Root_Object.TAGS.AAAOTO.TAGS_AAAOTO_Type(Replacement_Instance.all).Current_State := Root_Object.TAGS.AAAOTO.Idle;
      
      
      if Replacement_Instance /= Null then
      ...
      begin
         ...
         Root_Object.TAGS.AAAOTO.TAGS_AAAOTO1'(Root_Object.Root_Event_Type with
            ...
            Target_Instance   => Replacement_Instance,
            Test_Number       => Test,
            Add               => Value_To_Add,
