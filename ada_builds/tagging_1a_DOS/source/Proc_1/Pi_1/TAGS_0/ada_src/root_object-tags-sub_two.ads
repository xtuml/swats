...
--* Description:             
--*                          Domain specification Root_Object.TAGSSUB_TWO
...
--  ----------------------------------  
--  package Root_Object.TAGS.SUB_TWO
...
package Root_Object.TAGS.SUB_TWO is
--
------------------------------------------------------------------------
   --
   --**************  Object Subtype_2 Information **************
   --
   -- Object SUB_TWO is PASSIVE
   --
   -- Object SUB_TWO participates in a super sub type relationship
   --
   --
   --
   -- Object SUB_TWO is a SUB type of TAG_SUPER via Relationship R4
   --
   -- Object SUB_TWO does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object SUB_TWO has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "SUB_TWO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_SUB_TWO_Type is new TAGS_Type with record
      ...
      Subtype_2_Data : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_Subtype_2_Data (
      This_Object : in Root_Object.Object_Access;
      Subtype_2_Data_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Subtype_2_Data);
   pragma inline (Put_Subtype_2_Data);
