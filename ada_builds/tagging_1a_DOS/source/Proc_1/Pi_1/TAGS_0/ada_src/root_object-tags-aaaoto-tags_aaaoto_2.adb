...
separate(Root_Object.TAGS.AAAOTO)
   ...
   procedure TAGS_AAAOTO_2 (Test_Number     : in     Application_Types.Base_Integer_Type;
   ...
   begin
      ...
      Root_Object.TAGS.AAAOTO.TAGS_AAAOTO_type(This_Instance.all).Result := Add;
