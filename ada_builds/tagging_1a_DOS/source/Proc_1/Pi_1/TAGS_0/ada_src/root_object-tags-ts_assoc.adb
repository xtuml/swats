...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSTS_ASSOC
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.TS_ASSOC is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_TS_ASSOC_Type (This_Object.all).Assoc_Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_TS_ASSOC_Type (This_Object.all).Assoc_Unique_Identifier :=
...
--ADATEST IGNORE_ON
   function Get_Unique_Identifier (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_TS_ASSOC_Type (This_Object.all).Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_TS_ASSOC_Type (This_Object.all).Unique_Identifier :=
...
--ADATEST IGNORE_ON
   function Get_Other_Unique_Identifier (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_TS_ASSOC_Type (This_Object.all).Other_Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_TS_ASSOC_Type (This_Object.all).Other_Unique_Identifier :=
...
--ADATEST IGNORE_ON
   function Get_Attribute_Three (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_TS_ASSOC_Type (This_Object.all).Attribute_Three;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_TS_ASSOC_Type (This_Object.all).Attribute_Three :=
   ...
   begin
      ...
      if Object_List.Size < Maximum_Number_Of_Instances then
         ...
         if Free_List.First_Entry = null then
            This_Object := new TAGS_TS_ASSOC_Type;
   
         else
            This_Object := Free_List.First_Entry;
            TAGS_TS_ASSOC_Type(This_Object.all).Assoc_Unique_Identifier := Application_Types.Base_Integer_Type_First;
            TAGS_TS_ASSOC_Type(This_Object.all).Unique_Identifier := Application_Types.Base_Integer_Type_First;
            TAGS_TS_ASSOC_Type(This_Object.all).Other_Unique_Identifier := Application_Types.Base_Integer_Type_First;
            TAGS_TS_ASSOC_Type(This_Object.all).Attribute_Three := Application_Types.Base_Integer_Type_First;
