...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSATSUBTWO
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.ATSUBTWO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
   ...
   The_Object: aliased TAGS_ATSUBTWO_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_ATSUBTWO_Type (This_Object.all).Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ATSUBTWO_Type (This_Object.all).Unique_Identifier :=
...
--ADATEST IGNORE_ON
   function Get_Subtype_Two_Data (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_ATSUBTWO_Type (This_Object.all).Subtype_Two_Data;
   end Get_Subtype_Two_Data;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Subtype_Two_Data (
      This_Object : in Root_Object.Object_Access;
      Subtype_Two_Data_Value : in Application_Types.Base_Integer_Type) is
   begin
      TAGS_ATSUBTWO_Type (This_Object.all).Subtype_Two_Data :=
         Subtype_Two_Data_Value;
   end Put_Subtype_Two_Data;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Test_No (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_ATSUBTWO_Type (This_Object.all).Test_No;
   end Get_Test_No;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ATSUBTWO_Type (This_Object.all).Test_No :=
         Test_No_Value;
   end Put_Test_No;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_ATSUBTWO_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ATSUBTWO_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_ATSUBTWO_Type (This_Object.all).R6_Super;
   end Get_R6_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ATSUBTWO_Type (This_Object.all).R6_Super :=
         R6_Super_Value;
   end Put_R6_Super;
--ADATEST IGNORE_OFF
...
---------------------------------------------------------------------
   ...
   begin
      ...
      TAGS_ATSUBTWO_Type(Old_Instance.all).Created := FALSE;
...
----------------------------------------------------------------------------
   ...
   procedure Polymorphic_Put (
      This_Object : in out TAGS_ATSUBTWO_Type;
   ...
   begin
      ...
      case Parent_Event_Type is
         ...
         when Root_Object.TAGS.ATSUPER.ATSUPER1 =>
            ...
            Next_Event := new Root_Object.TAGS.ATSUBTWO.TAGS_ATSUPER1'(
            Root_Event_Type with
               This_Event_Class => Root_Object.TAGS.ATSUBTWO.ATSUPER1,
...
--
   ...
   procedure TAGS_ATSUBTWO_2 (
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure ATSUPER1_To_Sub_Two_State (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      TAGS_ATSUBTWO_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.ATSUBTWO.Object_State_Type(Sub_Two_State);

      TAGS_ATSUBTWO_2 (
         This_Instance => This_Instance );

   end ATSUPER1_To_Sub_Two_State;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     TAGS_ATSUBTWO_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     TAGS_ATSUBTWO_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      TAGS_ATSUBTWO_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => TAGS_ATSUBTWO_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return TAGS_ATSUBTWO_Event_Queue.Queue_Length (TAGS_ATSUBTWO_Queue);
...
--ADATEST IGNORE_ON
   procedure Put_Event (
      ...
      To_Class : in TAGS_ATSUBTWO_Type;
...
--
   ...
   This_Event_Dispatch_Matrix (ATSUPER1, Idle) := ATSUPER1_To_Sub_Two_State'access;
   This_Event_Dispatch_Matrix (ATSUPER1, Sub_Two_State) :=  Ignore_Action'access;

end Root_Object.TAGS.ATSUBTWO;
