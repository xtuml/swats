...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSSGR
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.SGR is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
   ...
   The_Object: aliased TAGS_SGR_Type;
...
------------------------------------------------------------------------
   ...
   sgr_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_sgr_id return Application_Types.Base_Integer_Type is
   begin
      sgr_id_Value :=
         Application_Types.Base_Integer_Type'succ (sgr_id_Value);
      return sgr_id_Value;
   end Obtain_Subsequent_sgr_id;
...
--ADATEST IGNORE_ON
   ...
   begin
       return TAGS_SGR_Type (This_Object.all).sgr_id;
   end Get_sgr_id;
...
--ADATEST IGNORE_ON
   procedure Put_sgr_id (
      This_Object : in Root_Object.Object_Access;
      sgr_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      TAGS_SGR_Type (This_Object.all).sgr_id :=
         sgr_id_Value;
   end Put_sgr_id;
...
--ADATEST IGNORE_ON
   function Get_An_Integer (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_SGR_Type (This_Object.all).An_Integer;
   end Get_An_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_SGR_Type (This_Object.all).An_Integer :=
         An_Integer_Value;
   end Put_An_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_SGR_Type (This_Object.all).A_Boolean;
   end Get_A_Boolean;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_SGR_Type (This_Object.all).A_Boolean :=
         A_Boolean_Value;
   end Put_A_Boolean;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_SGR_Type (This_Object.all).A_Real;
   end Get_A_Real;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_SGR_Type (This_Object.all).A_Real :=
         A_Real_Value;
   end Put_A_Real;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_SGR_Type (This_Object.all).Environment;
   end Get_Environment;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_SGR_Type (This_Object.all).Environment :=
         Environment_Value;
   end Put_Environment;
--ADATEST IGNORE_OFF
...
---------------------------------------------------------------------
   ...
   begin
      ...
      TAGS_SGR_Type(Old_Instance.all).Created := FALSE;
