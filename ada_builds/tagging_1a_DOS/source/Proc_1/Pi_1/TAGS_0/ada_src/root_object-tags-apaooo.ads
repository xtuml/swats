...
--* Description:             
--*                          Domain specification Root_Object.TAGSAPAOOO
...
--  ----------------------------------  
--  package Root_Object.TAGS.APAOOO
...
package Root_Object.TAGS.APAOOO is
--
------------------------------------------------------------------------
   --
   --**************  Object A_Passive_Array_Of_One_Object Information **************
   --
   -- Object APAOOO is PASSIVE
   --
   --
   --
   -- Object APAOOO has an identifying non-referential attribute Unique_Identifier 
   -- and therefore may be uniquely created.
   --
   -- Object APAOOO has the following TAGS attached :
   --    ARRAY (1)
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ...
   Object_String : String := "APAOOO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_APAOOO_Type is new TAGS_Type with record
