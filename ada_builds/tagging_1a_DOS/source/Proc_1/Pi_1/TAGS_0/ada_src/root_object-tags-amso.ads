...
--* Description:             
--*                          TAGGED Domain specification Root_Object.TAGSAMSO
...
--*  Object has been tagged as STATIC 
--*
--*  ERROR HANDLING                                                                   *
--*  --------------                                                                   *
--*  None                                                                             *
...
package Root_Object.TAGS.AMSO is
--
------------------------------------------------------------------------
   --
   --**************  Object A_Multiple_Static_Object Information **************
   --
   -- Object AMSO is PASSIVE
   --
   --
   --
   -- Object AMSO has an identifying non-referential attribute Unique_ID 
   -- and therefore may be uniquely created.
   --
   -- Object AMSO is STATIC and therefore may not be deleted.
   --
   -- Object AMSO has the following TAGS attached :
   --    STATIC 
   --    ARRAY (2)
   --
   ------------------------------------------------------------------------
   ...
   Object_String : String := "AMSO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_AMSO_Type is new TAGS_Type with record

      --
      -- Non initialised identifying non referential
      Unique_ID : Application_Types.Base_Integer_Type;
   ...
   procedure Put_Unique_ID (
      ...
      Unique_ID_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Unique_ID);
   pragma inline (Put_Unique_ID);
   ...
   -- This object has been tagged as STATIC, therefore Delete operation has been removed.
