...
--*************************************************************************************
--*                                                                                   *
--* File Name:               TAGS_RPT2_Test_Passed_Bridge.adb
...
package body TAGS_RPT2_Test_Passed_Bridge is
   
   procedure TAGS_RPT2_Test_Passed (
...
--
   ...
   end TAGS_RPT2_Test_Passed;
   
end TAGS_RPT2_Test_Passed_Bridge;

--
-- End of file TAGS_RPT2_Test_Passed_Bridge.adb
--
