...
--*************************************************************************************
--*                                                                                   *
--* File Name:               TAGS_RPT5_Test_Text_Bridge.adb
...
package body TAGS_RPT5_Test_Text_Bridge is
   
   procedure TAGS_RPT5_Test_Text (
...
--
   ...
   end TAGS_RPT5_Test_Text;
   
end TAGS_RPT5_Test_Text_Bridge;

--
-- End of file TAGS_RPT5_Test_Text_Bridge.adb
--
