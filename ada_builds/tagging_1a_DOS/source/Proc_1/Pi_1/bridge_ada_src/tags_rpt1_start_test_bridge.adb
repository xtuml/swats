...
--*************************************************************************************
--*                                                                                   *
--* File Name:               TAGS_RPT1_Start_Test_Bridge.adb
...
package body TAGS_RPT1_Start_Test_Bridge is
   
   procedure TAGS_RPT1_Start_Test (
...
--
   ...
   end TAGS_RPT1_Start_Test;
   
end TAGS_RPT1_Start_Test_Bridge;

--
-- End of file TAGS_RPT1_Start_Test_Bridge.adb
--
