...
--*************************************************************************************
--*                                                                                   *
--* File Name:               TAGS_RPT6_Domain_Test_Start_Bridge.adb
...
package body TAGS_RPT6_Domain_Test_Start_Bridge is
   
   procedure TAGS_RPT6_Domain_Test_Start (
...
--
         ...
         Root_Object.TAGS.RD.TAGS_RD_type(My_Report.all).Reported_Domain_Number := New_Domain_Number;
         
      end if;
      
      
   end TAGS_RPT6_Domain_Test_Start;
   
end TAGS_RPT6_Domain_Test_Start_Bridge;

--
-- End of file TAGS_RPT6_Domain_Test_Start_Bridge.adb
--
