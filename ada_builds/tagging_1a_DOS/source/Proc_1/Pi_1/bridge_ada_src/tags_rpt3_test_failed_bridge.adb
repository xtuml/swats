...
--*************************************************************************************
--*                                                                                   *
--* File Name:               TAGS_RPT3_Test_Failed_Bridge.adb
...
package body TAGS_RPT3_Test_Failed_Bridge is
   
   procedure TAGS_RPT3_Test_Failed (
...
--
   ...
   end TAGS_RPT3_Test_Failed;
   
end TAGS_RPT3_Test_Failed_Bridge;

--
-- End of file TAGS_RPT3_Test_Failed_Bridge.adb
--
