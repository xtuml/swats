...
--* Description:             
--*                          TAGGED Domain specification Root_Object.FTEENV
...
package Root_Object.FTE.ENV is
--
------------------------------------------------------------------------
   --
   --**************  Object The_Environment Information **************
   --
   -- Object ENV is PASSIVE
   --
   --
   --
   -- Object ENV has an identifying non-referential attribute Unique_Identifier 
   -- and therefore may be uniquely created.
   -- 
   -- Object ENV has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "ENV";

   --
   -------------------------------------------------------------------------------------------------
   --

   type FTE_ENV_Type is new FTE_Type with record
      ...
      Where_Are_We : Application_Types.Base_Text_Type := Application_Types.Base_Text_Type_First;
   ...
   procedure Put_Where_Are_We (
      This_Object : in Root_Object.Object_Access;
      Where_Are_We_Value : in Application_Types.Base_Text_Type);

   pragma inline (Get_Where_Are_We);
   pragma inline (Put_Where_Are_We);
