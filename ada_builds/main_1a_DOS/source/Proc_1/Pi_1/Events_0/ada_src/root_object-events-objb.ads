...
--* Description:             
--*                          Domain specification Root_Object.EventsobjB
...
--  ----------------------------------  
--  package Root_Object.Events.objB
...
package Root_Object.Events.objB is
--
------------------------------------------------------------------------
   --
   ...
   --
   -- Object objB participates in a super sub type relationship
   --
   --
   --
   -- Object objB is a SUB type of objA via Relationship R1
   --
   ...
   type Events_objB_Type is new Events_Type with record
