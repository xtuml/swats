...
--* Description:             
--*                          Domain body Root_Object.EventsobjP
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objP is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Reference_P_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Reference_P return Application_Types.Base_Integer_Type is
   begin
      Reference_P_Value :=
         Application_Types.Base_Integer_Type'succ (Reference_P_Value);
      return Reference_P_Value;
   end Obtain_Subsequent_Reference_P;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_objP_Type (This_Object.all).Reference_P;
   end Get_Reference_P;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objP_Type (This_Object.all).Reference_P :=
         Reference_P_Value;
   end Put_Reference_P;
...
--ADATEST IGNORE_ON
   function Get_Result_P (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objP_Type (This_Object.all).Result_P;
   end Get_Result_P;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Result_P (
      This_Object : in Root_Object.Object_Access;
      Result_P_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objP_Type (This_Object.all).Result_P :=
         Result_P_Value;
   end Put_Result_P;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_number_of_received_events (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objP_Type (This_Object.all).number_of_received_events;
   end Get_number_of_received_events;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_number_of_received_events (
      This_Object : in Root_Object.Object_Access;
      number_of_received_events_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objP_Type (This_Object.all).number_of_received_events :=
         number_of_received_events_Value;
   end Put_number_of_received_events;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_latest_test (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objP_Type (This_Object.all).latest_test;
   end Get_latest_test;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objP_Type (This_Object.all).latest_test :=
         latest_test_Value;
   end Put_latest_test;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Value_To_Add (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objP_Type (This_Object.all).Value_To_Add;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objP_Type (This_Object.all).Value_To_Add :=
         Value_To_Add_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objP_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objP_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objP_Type (This_Object.all).R4_Sub;
   end Get_R4_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R4_Sub (
      This_Object : in Root_Object.Object_Access;
      R4_Sub_Value : in Root_Object.Object_Access) is
   begin
      Events_objP_Type (This_Object.all).R4_Sub :=
         R4_Sub_Value;
   end Put_R4_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objP_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objP_Type(This_Object.all).Reference_P := Application_Types.Base_Integer_Type_First;
         Events_objP_Type(This_Object.all).Result_P := Application_Types.Base_Integer_Type_First;
         Events_objP_Type(This_Object.all).number_of_received_events := Application_Types.Base_Integer_Type_First;
         Events_objP_Type(This_Object.all).latest_test := Application_Types.Base_Integer_Type_First;
         Events_objP_Type(This_Object.all).Value_To_Add := Application_Types.Base_Integer_Type_First;
         Events_objP_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure Events_objP_3 (
      Test : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_objP_2 (
      Test : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure objP1_To_Supertype_State (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_objP_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objP.Object_State_Type(Supertype_State);

      Events_objP_3 (
         Test =>  Events_objP1(This_Event.all).Test,
         This_Instance => This_Instance );

   end objP1_To_Supertype_State;
--
   procedure objP2_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objP_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objP.Object_State_Type(Idle);

      Events_objP_2 (
         Test =>  Events_objP2(This_Event.all).Test,
         This_Instance => This_Instance );
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objP_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_objP_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_objP_Event_Queue.Queue_Length (Events_objP_Queue);
...
--
   ...
   This_Event_Dispatch_Matrix (objP1, Idle) := objP1_To_Supertype_State'access;
   This_Event_Dispatch_Matrix (objP2, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objP1, Supertype_State) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objP2, Supertype_State) := objP2_To_Idle'access;
