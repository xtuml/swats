...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.objVERCETL.ads
...
--* Description:             
--*                          Domain specification Root_Object.EventsobjVERCETL
...
--  ----------------------------------  
--  package Root_Object.Events.objVERCETL
...
package Root_Object.Events.objVERCETL is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_Verify_Creation_Terminal Information **************
   --
   -- Object objVERCETL is ACTIVE
   --
   --
   --
   -- Object objVERCETL is ACTIVE and has the following state actions defined
   --   Non_Existent,
   --   Idle,
   --   Verify_State.
   --
   -- Object objVERCETL has an identifying non-referential attribute ReferenceCETL 
   -- and therefore may be uniquely created.
   -- 
   -- Object objVERCETL has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objVERCETL";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_objVERCETL_Type is new Events_Type with record

      --
      -- Non initialised identifying non referential
      ReferenceCETL : Application_Types.Base_Integer_Type;
   ...
   procedure Put_ReferenceCETL (
      ...
      ReferenceCETL_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_ReferenceCETL);
   pragma inline (Put_ReferenceCETL);
   ...
   -- EVENT DECLARATION
   --
   type Events_objVERCETL_Event_Type is new Events_Event_Type with
   record
   ...
   --    
   type Events_objVERCETL_Instance_Event_Type is new Events_objVERCETL_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type Events_objVERCETL_Description_Event is new Events_objVERCETL_Instance_Event_Type with
   record
      null;
   end record;  
   --
   ...
   type Events_objVERCETL1 is new Events_objVERCETL_Instance_Event_Type with
   record 
      null;
   end record;

   type Events_objVERCETL2 is new Events_objVERCETL_Instance_Event_Type with
   record 
      Test : Application_Types.Base_Integer_Type;
      Test_Number : Application_Types.Base_Integer_Type;
   end record;

   type Events_objVERCETL3 is new Events_objVERCETL_Instance_Event_Type with
   record 
      null;
   end record;
   ...
   package Events_objVERCETL_Event_Queue is new Generic_FIFO (Root_Object.Root_Event_Access_Type); 

   Events_objVERCETL_Queue: Events_objVERCETL_Event_Queue.FIFO_Type;
