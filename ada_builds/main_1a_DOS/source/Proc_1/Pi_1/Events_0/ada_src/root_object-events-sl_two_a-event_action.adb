...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.SL_TWO_A.event_action.ada
...
--*  separate of Root_Object.EventsSL_TWO_A
--*     Event_Action
--*
--*************************************************************************************
--  MODIFICATION RECORD
...
separate (Root_Object.Events.SL_TWO_A)
...
begin
   ...
   This_Action := Events_SL_TWO_A_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := Events_SL_TWO_A_Instance_Event_Type(This_Event.all).Target_Instance;
   ...
   if This /= null then
      ...
      --  
      This_Event_Dispatch_Matrix (This_Action, Events_SL_TWO_A_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
