...
--* Description:             
--*                          Domain specification Root_Object.EventsobjE
...
--  ----------------------------------  
--  package Root_Object.Events.objE
...
package Root_Object.Events.objE is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_E Information **************
   --
   -- Object objE is ACTIVE
   --
   -- Object objE participates in a super sub type relationship
   --
   --
   --
   -- Object objE is ACTIVE and has the following state actions defined
   --   Non_Existent,
   --   Idle,
   --   Subtype_object.
   --
   -- Object objE is a SUB type of objD via Relationship R5
   --
   -- Object objE does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objE has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objE";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_objE_Type is new Events_Type with record

      --
      -- Initialised Non identifying non referential
      ReferenceE : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_ReferenceE (
      ...
      ReferenceE_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_ReferenceE);
   pragma inline (Put_ReferenceE);
   ...
   -- EVENT DECLARATION
   --
   type Events_objE_Event_Type is new Events_Event_Type with
   record
   ...
   --    
   type Events_objE_Instance_Event_Type is new Events_objE_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type Events_objE_Description_Event is new Events_objE_Instance_Event_Type with
   record
      null;
   end record;  
   --
   ...
   type Events_objE1 is new Events_objE_Instance_Event_Type with
   record 
      Test_Number : Application_Types.Base_Integer_Type;
   end record;

   type Events_objE6 is new Events_objE_Instance_Event_Type with
   record 
      Test : Application_Types.Base_Integer_Type;
      Test_Number : Application_Types.Base_Integer_Type;
   end record;

   type Events_objD1 is new Events_objE_Instance_Event_Type with
   record 
      Test_Number : Application_Types.Base_Integer_Type;
   end record;

   type Events_objD2 is new Events_objE_Instance_Event_Type with
   record 
      Test : Application_Types.Base_Integer_Type;
      Test_Number : Application_Types.Base_Integer_Type;
   end record;

   type Events_objD3 is new Events_objE_Instance_Event_Type with
   record 
      Test : Application_Types.Base_Integer_Type;
      Test_Number : Application_Types.Base_Integer_Type;
   end record;

   type Events_objD4 is new Events_objE_Instance_Event_Type with
   record 
      null;
   end record;
   ...
   package Events_objE_Event_Queue is new Generic_FIFO (Root_Object.Root_Event_Access_Type); 

   Events_objE_Queue: Events_objE_Event_Queue.FIFO_Type;
