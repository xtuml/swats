...
--* Description:             
--*                          Domain body Root_Object.EventsobjT
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objT is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Reference_T_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Reference_T return Application_Types.Base_Integer_Type is
   begin
      Reference_T_Value :=
         Application_Types.Base_Integer_Type'succ (Reference_T_Value);
      return Reference_T_Value;
   end Obtain_Subsequent_Reference_T;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_objT_Type (This_Object.all).Reference_T;
   end Get_Reference_T;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objT_Type (This_Object.all).Reference_T :=
         Reference_T_Value;
   end Put_Reference_T;
...
--ADATEST IGNORE_ON
   function Get_Result_T (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objT_Type (This_Object.all).Result_T;
   end Get_Result_T;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Result_T (
      This_Object : in Root_Object.Object_Access;
      Result_T_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objT_Type (This_Object.all).Result_T :=
         Result_T_Value;
   end Put_Result_T;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objT_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objT_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objT_Type (This_Object.all).R8_Sub;
   end Get_R8_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R8_Sub (
      This_Object : in Root_Object.Object_Access;
      R8_Sub_Value : in Root_Object.Object_Access) is
   begin
      Events_objT_Type (This_Object.all).R8_Sub :=
         R8_Sub_Value;
   end Put_R8_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objT_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objT_Type(This_Object.all).Reference_T := Application_Types.Base_Integer_Type_First;
         Events_objT_Type(This_Object.all).Result_T := Application_Types.Base_Integer_Type_First;
         Events_objT_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_objT_Event_Type;
...
------------------------------------------------------------------------
   procedure Event_Action (
      Dispatch_Event : in     Events_objT_Instance_Event_Type;
      This_Event     : in out Root_Object.Root_Event_Access_Type) is separate;


end Root_Object.Events.objT;
