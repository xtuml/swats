...
--* Description:             
--*                          Domain body Root_Object.EventsTE
...
------------------------------------------------------------------------
--
package body Root_Object.Events.TE is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_TE_Type (This_Object.all).ID;
   end Get_ID;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_TE_Type (This_Object.all).ID :=
         ID_Value;
   end Put_ID;
...
--ADATEST IGNORE_ON
   function Get_Result (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_TE_Type (This_Object.all).Result;
   end Get_Result;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Result (
      This_Object : in Root_Object.Object_Access;
      Result_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_TE_Type (This_Object.all).Result :=
         Result_Value;
   end Put_Result;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_TE_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_TE_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_TE_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_TE_Type(This_Object.all).ID := Application_Types.Base_Integer_Type_First;
         Events_TE_Type(This_Object.all).Result := Application_Types.Base_Integer_Type_First;
         Events_TE_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   procedure TE1_To_Gen_Ignore_Event (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_TE_Type (This_Instance.all).Current_State := 
         Root_Object.Events.TE.Object_State_Type(Gen_Ignore_Event);

      Events_TE_2 (
         Test_No =>  Events_TE1(This_Event.all).Test_No,
         This_Instance => This_Instance );

   end TE1_To_Gen_Ignore_Event;
--
   procedure TE2_To_Check_Ignore_State (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_TE_Type (This_Instance.all).Current_State := 
         Root_Object.Events.TE.Object_State_Type(Check_Ignore_State);

      Events_TE_4 (
         Test_No =>  Events_TE2(This_Event.all).Test_No,
         This_Instance => This_Instance );

   end TE2_To_Check_Ignore_State;
--
   procedure TE4_To_Gen_Cannot_Happen_Event (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_TE_Type (This_Instance.all).Current_State := 
         Root_Object.Events.TE.Object_State_Type(Gen_Cannot_Happen_Event);

      Events_TE_5 (
         Test_No =>  Events_TE4(This_Event.all).Test_No,
         This_Instance => This_Instance );

   end TE4_To_Gen_Cannot_Happen_Event;
--
   procedure TE5_To_Check_Cannot_Happen_State (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_TE_Type (This_Instance.all).Current_State := 
         Root_Object.Events.TE.Object_State_Type(Check_Cannot_Happen_State);

      Events_TE_6 (
         Test_No =>  Events_TE5(This_Event.all).Test_No,
         This_Instance => This_Instance );

   end TE5_To_Check_Cannot_Happen_State;
--
   procedure TE6_To_Unsupported (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_TE_Type (This_Instance.all).Current_State := 
         Root_Object.Events.TE.Object_State_Type(Unsupported);

      Events_TE_7 (
         Test_No =>  Events_TE6(This_Event.all).Test_No,
         The_Reqid =>  Events_TE6(This_Event.all).The_Reqid,
         Effect_Type =>  Events_TE6(This_Event.all).Effect_Type,
         This_Instance => This_Instance );

   end TE6_To_Unsupported;
--
   procedure TE7_To_Gen_Indefined_Event (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_TE_Type (This_Instance.all).Current_State := 
         Root_Object.Events.TE.Object_State_Type(Gen_Indefined_Event);

      Events_TE_8 (
         Test_No =>  Events_TE7(This_Event.all).Test_No,
         This_Instance => This_Instance );

   end TE7_To_Gen_Indefined_Event;
--
   procedure TE3_To_Update_Result (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_TE_Type (This_Instance.all).Current_State := 
         Root_Object.Events.TE.Object_State_Type(Update_Result);

      Events_TE_3 (
         Test_No =>  Events_TE3(This_Event.all).Test_No,
         Effect_Type =>  Events_TE3(This_Event.all).Effect_Type,
         This_Instance => This_Instance );

   end TE3_To_Update_Result;
--
   procedure TE3_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_TE_Type (This_Instance.all).Current_State := 
         Root_Object.Events.TE.Object_State_Type(Idle);
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_TE_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_TE_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_TE_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_TE_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_TE_Event_Queue.Queue_Length (Events_TE_Queue);
...
--
   This_Event_Dispatch_Matrix (TE1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TE2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TE3, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TE4, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TE5, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TE6, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TE7, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TE1, Idle) := TE1_To_Gen_Ignore_Event'access;
   This_Event_Dispatch_Matrix (TE2, Idle) := TE2_To_Check_Ignore_State'access;
   This_Event_Dispatch_Matrix (TE3, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE4, Idle) := TE4_To_Gen_Cannot_Happen_Event'access;
   This_Event_Dispatch_Matrix (TE5, Idle) := TE5_To_Check_Cannot_Happen_State'access;
   This_Event_Dispatch_Matrix (TE6, Idle) := TE6_To_Unsupported'access;
   This_Event_Dispatch_Matrix (TE7, Idle) := TE7_To_Gen_Indefined_Event'access;
   This_Event_Dispatch_Matrix (TE1, Gen_Ignore_Event) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE2, Gen_Ignore_Event) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TE3, Gen_Ignore_Event) := TE3_To_Update_Result'access;
   This_Event_Dispatch_Matrix (TE4, Gen_Ignore_Event) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE5, Gen_Ignore_Event) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE6, Gen_Ignore_Event) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE7, Gen_Ignore_Event) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE1, Update_Result) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TE2, Update_Result) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TE3, Update_Result) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TE4, Update_Result) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE5, Update_Result) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE6, Update_Result) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE7, Update_Result) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE1, Check_Ignore_State) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE2, Check_Ignore_State) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TE3, Check_Ignore_State) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TE4, Check_Ignore_State) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE5, Check_Ignore_State) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE6, Check_Ignore_State) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE7, Check_Ignore_State) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE1, Gen_Cannot_Happen_Event) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE2, Gen_Cannot_Happen_Event) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE3, Gen_Cannot_Happen_Event) := TE3_To_Update_Result'access;
   This_Event_Dispatch_Matrix (TE4, Gen_Cannot_Happen_Event) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TE5, Gen_Cannot_Happen_Event) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE6, Gen_Cannot_Happen_Event) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE7, Gen_Cannot_Happen_Event) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE1, Check_Cannot_Happen_State) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE2, Check_Cannot_Happen_State) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE3, Check_Cannot_Happen_State) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE4, Check_Cannot_Happen_State) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TE5, Check_Cannot_Happen_State) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE6, Check_Cannot_Happen_State) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE7, Check_Cannot_Happen_State) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE1, Unsupported) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE2, Unsupported) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE3, Unsupported) := TE3_To_Idle'access;
   This_Event_Dispatch_Matrix (TE4, Unsupported) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE5, Unsupported) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE6, Unsupported) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE7, Unsupported) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE1, Gen_Indefined_Event) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE2, Gen_Indefined_Event) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE3, Gen_Indefined_Event) := TE3_To_Update_Result'access;
   This_Event_Dispatch_Matrix (TE4, Gen_Indefined_Event) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE5, Gen_Indefined_Event) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE6, Gen_Indefined_Event) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TE7, Gen_Indefined_Event) :=  Ignore_Action'access;

end Root_Object.Events.TE;
