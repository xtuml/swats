...
--* Description:             
--*                          Domain body Root_Object.EventsobjS
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objS is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objS_Type (This_Object.all).Reference_P;
   end Get_Reference_P;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objS_Type (This_Object.all).Reference_P :=
         Reference_P_Value;
   end Put_Reference_P;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Value_To_Add (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objS_Type (This_Object.all).Value_To_Add;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objS_Type (This_Object.all).Value_To_Add :=
         Value_To_Add_Value;
...
--ADATEST IGNORE_ON
   function Get_latest_test (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objS_Type (This_Object.all).latest_test;
   end Get_latest_test;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objS_Type (This_Object.all).latest_test :=
         latest_test_Value;
   end Put_latest_test;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Result_S (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objS_Type (This_Object.all).Result_S;
   end Get_Result_S;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Result_S (
      This_Object : in Root_Object.Object_Access;
      Result_S_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objS_Type (This_Object.all).Result_S :=
         Result_S_Value;
   end Put_Result_S;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objS_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objS_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objS_Type (This_Object.all).R4_Super;
   end Get_R4_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objS_Type (This_Object.all).R4_Super :=
         R4_Super_Value;
   end Put_R4_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objS_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objS_Type(This_Object.all).Reference_P := Application_Types.Base_Integer_Type_First;
         Events_objS_Type(This_Object.all).Value_To_Add := Application_Types.Base_Integer_Type_First;
         Events_objS_Type(This_Object.all).latest_test := Application_Types.Base_Integer_Type_First;
         Events_objS_Type(This_Object.all).Result_S := Application_Types.Base_Integer_Type_First;
         Events_objS_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
----------------------------------------------------------------------------
   ...
   procedure Polymorphic_Put (
      This_Object : in out Events_objS_Type;
...
--
   ...
   begin
      ...
      Events_objS_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objS.Object_State_Type(Subtype_State);
...
--
   ...
   begin
      ...
      Events_objS_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objS.Object_State_Type(Idle);
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_objS_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_objS_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objS_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_objS_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_objS_Event_Queue.Queue_Length (Events_objS_Queue);
...
--
   ...
   This_Event_Dispatch_Matrix (objS1, Non_Existent) :=  Cannot_Happen_Action'access;
   ...
   This_Event_Dispatch_Matrix (objS1, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objP1, Subtype_State) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objP2, Subtype_State) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objS1, Subtype_State) := objS1_To_Idle'access;

end Root_Object.Events.objS;
