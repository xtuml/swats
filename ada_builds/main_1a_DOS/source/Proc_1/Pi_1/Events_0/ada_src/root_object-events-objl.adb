...
--* Description:             
--*                          Domain body Root_Object.EventsobjL
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objL is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   ReferenceL_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceL return Application_Types.Base_Integer_Type is
   begin
      ReferenceL_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceL_Value);
      return ReferenceL_Value;
   end Obtain_Subsequent_ReferenceL;
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceL (
      This_Object : in Root_Object.Object_Access;
      ReferenceL_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objL_Type (This_Object.all).ReferenceL :=
         ReferenceL_Value;
   end Put_ReferenceL;
...
--ADATEST IGNORE_ON
   function Get_ResultL (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objL_Type (This_Object.all).ResultL;
   end Get_ResultL;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_ResultL (
      This_Object : in Root_Object.Object_Access;
      ResultL_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objL_Type (This_Object.all).ResultL :=
         ResultL_Value;
   end Put_ResultL;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objL_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objL_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objL_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objL_Type(This_Object.all).ReferenceL := Application_Types.Base_Integer_Type_First;
         Events_objL_Type(This_Object.all).ResultL := Application_Types.Base_Integer_Type_First;
         Events_objL_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure Events_objL_2 (
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure objL1_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_objL_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objL.Object_State_Type(Idle);
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_objL_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_objL_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objL_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_objL_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_objL_Event_Queue.Queue_Length (Events_objL_Queue);
...
--
   This_Event_Dispatch_Matrix (objL1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objL1, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objL1, Sub_sub_state) := objL1_To_Idle'access;

end Root_Object.Events.objL;
