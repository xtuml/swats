...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.objEDATA.ads
...
--* Description:             
--*                          Domain specification Root_Object.EventsobjEDATA
...
--  ----------------------------------  
--  package Root_Object.Events.objEDATA
...
package Root_Object.Events.objEDATA is
--
------------------------------------------------------------------------
   --
   --**************  Object Event_Data Information **************
   --
   -- Object objEDATA is ACTIVE
   --
   --
   --
   -- Object objEDATA is ACTIVE and has the following state actions defined
   --   Non_Existent,
   --   Idle,
   --   Verification_State_One,
   --   Fail,
   --   Verification_State_TWO.
   --
   -- Object objEDATA has an identifying non-referential attribute ReferenceEDATA 
   -- and therefore may be uniquely created.
   -- 
   -- Object objEDATA has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objEDATA";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_objEDATA_Type is new Events_Type with record

      --
      -- Non initialised identifying non referential
      ReferenceEDATA : Application_Types.Base_Integer_Type;
   ...
   procedure Put_ReferenceEDATA (
      ...
      ReferenceEDATA_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_ReferenceEDATA);
   pragma inline (Put_ReferenceEDATA);
   ...
   -- EVENT DECLARATION
   --
   type Events_objEDATA_Event_Type is new Events_Event_Type with
   record
   ...
   --    
   type Events_objEDATA_Instance_Event_Type is new Events_objEDATA_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type Events_objEDATA_Description_Event is new Events_objEDATA_Instance_Event_Type with
   record
      null;
   end record;  
   --
   ...
   type Events_objEDATA1 is new Events_objEDATA_Instance_Event_Type with
   record 
      null;
   end record;

   type Events_objEDATA2 is new Events_objEDATA_Instance_Event_Type with
   record 
      null;
   end record;

   type Events_objEDATA3 is new Events_objEDATA_Instance_Event_Type with
   record 
      A : Application_Types.Base_Integer_Type;
      B : Application_Types.Base_Integer_Type;
      C : Application_Types.Base_Integer_Type;
      E : Application_Types.Base_Integer_Type;
      F : Application_Types.Base_Integer_Type;
      Test : Application_Types.Base_Integer_Type;
      Test_Number : Application_Types.Base_Integer_Type;
   end record;

   type Events_objEDATA4 is new Events_objEDATA_Instance_Event_Type with
   record 
      A : Application_Types.Base_Integer_Type;
      B : Application_Types.Base_Integer_Type;
      C : Application_Types.Base_Integer_Type;
   ...
   type Events_objEDATA5 is new Events_objEDATA_Instance_Event_Type with
   record 
      A : Application_Types.Base_Integer_Type;
      B : Application_Types.Base_Integer_Type;
      C : Application_Types.Base_Integer_Type;
   ...
   type Events_objEDATA7 is new Events_objEDATA_Instance_Event_Type with
   record 
      A : Application_Types.Base_Integer_Type;
      B : Application_Types.Base_Integer_Type;
      Test : Application_Types.Base_Integer_Type;
   ...
   package Events_objEDATA_Event_Queue is new Generic_FIFO (Root_Object.Root_Event_Access_Type); 

   Events_objEDATA_Queue: Events_objEDATA_Event_Queue.FIFO_Type;
