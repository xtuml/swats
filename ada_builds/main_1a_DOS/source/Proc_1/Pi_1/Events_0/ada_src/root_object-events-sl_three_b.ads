...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.SL_THREE_B.ads
...
--* Description:             
--*                          Domain specification Root_Object.EventsSL_THREE_B
...
--  ----------------------------------  
--  package Root_Object.Events.SL_THREE_B
...
package Root_Object.Events.SL_THREE_B is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_Level_3_B Information **************
   --
   -- Object SL_THREE_B is PASSIVE
   --
   -- Object SL_THREE_B participates in a super sub type relationship
   --
   --
   --
   -- Object SL_THREE_B is a SUB type of SL_TWO_A via Relationship R12
   --
   -- Object SL_THREE_B has an identifying non-referential attribute SL3B_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object SL_THREE_B has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "SL_THREE_B";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_SL_THREE_B_Type is new Events_Type with record

      --
      -- Non initialised identifying non referential
      SL3B_id : Application_Types.Base_Integer_Type;
   ...
   procedure Put_SL3B_id (
      ...
      SL3B_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_SL3B_id);
   pragma inline (Put_SL3B_id);
