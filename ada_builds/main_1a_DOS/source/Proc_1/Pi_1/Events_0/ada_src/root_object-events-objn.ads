...
--* Description:             
--*                          Domain specification Root_Object.EventsobjN
...
--  ----------------------------------  
--  package Root_Object.Events.objN
...
package Root_Object.Events.objN is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_N Information **************
   --
   -- Object objN is PASSIVE
   --
   -- Object objN participates in a super sub type relationship
   --
   --
   --
   -- Object objN is a SUPER type of 
   --    objO
   --    via Relationship R3
   --
   -- Object objN is a SUB type of objM via Relationship R2
   --
   -- Object objN does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objN has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objN";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_objN_Type is new Events_Type with record

      --
      -- Initialised Non identifying non referential
      Reference_N : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Non initialised identifying referential
      Reference_M : Application_Types.Base_Integer_Type;

      --
      -- Initialised Non identifying non referential
      Result_N : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      Current_State :  Object_State_Type :=  Object_State_Type_First;

      R3_Sub : Root_Object.Object_Access := null;
   ...
   function Get_Reference_N (
      This_Object : Root_Object.Object_Access) 
   return Application_Types.Base_Integer_Type;

   procedure Put_Reference_N (
      This_Object : in Root_Object.Object_Access;
      Reference_N_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Reference_N);
   pragma inline (Put_Reference_N);


   function Get_Reference_M (
      This_Object : Root_Object.Object_Access) 
   return Application_Types.Base_Integer_Type;

   procedure Put_Reference_M (
      This_Object : in Root_Object.Object_Access;
      Reference_M_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Reference_M);
   pragma inline (Put_Reference_M);


   function Get_Result_N (
      This_Object : Root_Object.Object_Access) 
   return Application_Types.Base_Integer_Type;

   procedure Put_Result_N (
      This_Object : in Root_Object.Object_Access;
      Result_N_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Result_N);
   pragma inline (Put_Result_N);
   ...
   procedure Put_R3_Sub (
      This_Object :   in  Root_Object.Object_Access;
      R3_Sub_Value : in Root_Object.Object_Access);

   pragma inline (Get_R3_Sub);
   pragma inline (Put_R3_Sub);
   ...
   --
   type Events_objN_Event_Type is new Events_Event_Type with
   record
      This_Event_Class : Event_Class;
   end record;

   procedure Event_Action (
      Dispatch_Event : in     Events_objN_Event_Type;
      This_Event     : in out Root_Object.Root_Event_Access_Type);


   --    
   type Events_objN_Instance_Event_Type is new Events_objN_Event_Type with
   record
   ...
   -- 
   procedure Event_Action (
      Dispatch_Event : in     Events_objN_Instance_Event_Type;
      This_Event     : in out Root_Object.Root_Event_Access_Type);



   ------------------------------------------------------------------------
   type Events_objN_Description_Event is new Events_objN_Instance_Event_Type with
   record
      null;
   end record;
   --
