...
--* Description:             
--*                          Domain body Root_Object.EventsBLA
...
------------------------------------------------------------------------
--
package body Root_Object.Events.BLA is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   BLA_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_BLA_id return Application_Types.Base_Integer_Type is
   begin
      BLA_id_Value :=
         Application_Types.Base_Integer_Type'succ (BLA_id_Value);
      return BLA_id_Value;
   end Obtain_Subsequent_BLA_id;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_BLA_Type (This_Object.all).BLA_id;
   end Get_BLA_id;
...
--ADATEST IGNORE_ON
   procedure Put_BLA_id (
      This_Object : in Root_Object.Object_Access;
      BLA_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_BLA_Type (This_Object.all).BLA_id :=
         BLA_id_Value;
   end Put_BLA_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_BLA_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BLA_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_BLA_Type (This_Object.all).R15_Super;
   end Get_R15_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BLA_Type (This_Object.all).R15_Super :=
         R15_Super_Value;
   end Put_R15_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_BLA_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_BLA_Type(This_Object.all).BLA_id := Application_Types.Base_Integer_Type_First;
         Events_BLA_Type(This_Object.all).Current_State :=  Object_State_Type_First;
