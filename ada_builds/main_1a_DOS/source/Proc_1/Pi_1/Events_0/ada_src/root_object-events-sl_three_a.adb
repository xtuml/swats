...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.SL_THREE_A.adb
...
--* Description:             
--*                          Domain body Root_Object.EventsSL_THREE_A
...
------------------------------------------------------------------------
--
package body Root_Object.Events.SL_THREE_A is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   SL3A_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_SL3A_id return Application_Types.Base_Integer_Type is
   begin
      SL3A_id_Value :=
         Application_Types.Base_Integer_Type'succ (SL3A_id_Value);
      return SL3A_id_Value;
   end Obtain_Subsequent_SL3A_id;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_SL_THREE_A_Type (This_Object.all).SL3A_id;
   end Get_SL3A_id;
...
--ADATEST IGNORE_ON
   procedure Put_SL3A_id (
      ...
      SL3A_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_SL_THREE_A_Type (This_Object.all).SL3A_id :=
         SL3A_id_Value;
   end Put_SL3A_id;
...
------------------------------------------------------------------------
   --
   -- procedure Put_SL2A_id and 
   --
   -- function Get_SL2A_id
   --
   -- have not been generated for SL2A_id
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SL_THREE_A_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SL_THREE_A_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SL_THREE_A_Type (This_Object.all).R15_Sub;
   end Get_R15_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R15_Sub (
      This_Object : in Root_Object.Object_Access;
      R15_Sub_Value : in Root_Object.Object_Access) is
   begin
      Events_SL_THREE_A_Type (This_Object.all).R15_Sub :=
         R15_Sub_Value;
   end Put_R15_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R18_Sub (
      This_Object: Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Events_SL_THREE_A_Type (This_Object.all).R18_Sub;
   end Get_R18_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R18_Sub (
      This_Object : in Root_Object.Object_Access;
      R18_Sub_Value : in Root_Object.Object_Access) is
   begin
      Events_SL_THREE_A_Type (This_Object.all).R18_Sub :=
         R18_Sub_Value;
   end Put_R18_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R19_Sub (
      This_Object: Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Events_SL_THREE_A_Type (This_Object.all).R19_Sub;
   end Get_R19_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R19_Sub (
      This_Object : in Root_Object.Object_Access;
      R19_Sub_Value : in Root_Object.Object_Access) is
   begin
      Events_SL_THREE_A_Type (This_Object.all).R19_Sub :=
         R19_Sub_Value;
   end Put_R19_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R12_Super (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Events_SL_THREE_A_Type (This_Object.all).R12_Super;
   end Get_R12_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R12_Super (
      This_Object : in  Root_Object.Object_Access;
      R12_Super_Value : in Root_Object.Object_Access) is
   begin
      Events_SL_THREE_A_Type (This_Object.all).R12_Super :=
         R12_Super_Value;
   end Put_R12_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_SL_THREE_A_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_SL_THREE_A_Type(This_Object.all).SL3A_id := Application_Types.Base_Integer_Type_First;
         Events_SL_THREE_A_Type(This_Object.all).Current_State :=  Object_State_Type_First;
