...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.SL_THREE_C.adb
...
--* Description:             
--*                          Domain body Root_Object.EventsSL_THREE_C
...
------------------------------------------------------------------------
--
package body Root_Object.Events.SL_THREE_C is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   SL3C_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_SL3C_id return Application_Types.Base_Integer_Type is
   begin
      SL3C_id_Value :=
         Application_Types.Base_Integer_Type'succ (SL3C_id_Value);
      return SL3C_id_Value;
   end Obtain_Subsequent_SL3C_id;
...
--ADATEST IGNORE_ON
   procedure Put_SL3C_id (
      This_Object : in Root_Object.Object_Access;
      SL3C_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_SL_THREE_C_Type (This_Object.all).SL3C_id :=
         SL3C_id_Value;
   end Put_SL3C_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SL_THREE_C_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SL_THREE_C_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SL_THREE_C_Type (This_Object.all).R17_Super;
   end Get_R17_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SL_THREE_C_Type (This_Object.all).R17_Super :=
         R17_Super_Value;
   end Put_R17_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_SL_THREE_C_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_SL_THREE_C_Type(This_Object.all).SL3C_id := Application_Types.Base_Integer_Type_First;
         Events_SL_THREE_C_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
end Root_Object.Events.SL_THREE_C;
