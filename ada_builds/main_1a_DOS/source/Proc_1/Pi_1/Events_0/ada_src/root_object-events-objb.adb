...
--* Description:             
--*                          Domain body Root_Object.EventsobjB
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objB is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objB_Type (This_Object.all).ReferenceA;
   end Get_ReferenceA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objB_Type (This_Object.all).ReferenceA :=
         ReferenceA_Value;
   end Put_ReferenceA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_ResultB (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objB_Type (This_Object.all).ResultB;
   end Get_ResultB;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objB_Type (This_Object.all).ResultB :=
         ResultB_Value;
   end Put_ResultB;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objB_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objB_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objB_Type (This_Object.all).R1_Super;
   end Get_R1_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R1_Super (
      This_Object : in  Root_Object.Object_Access;
      R1_Super_Value : in Root_Object.Object_Access) is
   begin
      Events_objB_Type (This_Object.all).R1_Super :=
         R1_Super_Value;
   end Put_R1_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objB_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objB_Type(This_Object.all).ReferenceA := Application_Types.Base_Integer_Type_First;
         Events_objB_Type(This_Object.all).ResultB := Application_Types.Base_Integer_Type_First;
         Events_objB_Type(This_Object.all).Current_State :=  Object_State_Type_First;
