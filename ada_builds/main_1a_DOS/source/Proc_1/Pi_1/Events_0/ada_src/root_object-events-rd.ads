...
--* Description:             
--*                          Domain specification Root_Object.EventsRD
...
package Root_Object.Events.RD is
--
------------------------------------------------------------------------
   --
   ...
   type Events_RD_Type is new Events_Type with record
