...
--* Description:             
--*                          Domain body Root_Object.EventsobjE
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objE is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceE (
      This_Object : in Root_Object.Object_Access;
      ReferenceE_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objE_Type (This_Object.all).ReferenceE :=
         ReferenceE_Value;
   end Put_ReferenceE;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objE_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objE_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_ReferenceD (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objE_Type (This_Object.all).ReferenceD;
   end Get_ReferenceD;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objE_Type (This_Object.all).ReferenceD :=
         ReferenceD_Value;
   end Put_ReferenceD;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Report_Test_No (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objE_Type (This_Object.all).Report_Test_No;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objE_Type (This_Object.all).Report_Test_No :=
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objE_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objE_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objE_Type (This_Object.all).R5_Super;
   end Get_R5_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objE_Type (This_Object.all).R5_Super :=
         R5_Super_Value;
   end Put_R5_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objE_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objE_Type(This_Object.all).ReferenceE := Application_Types.Base_Integer_Type_First;
         Events_objE_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
         Events_objE_Type(This_Object.all).ReferenceD := Application_Types.Base_Integer_Type_First;
         Events_objE_Type(This_Object.all).Report_Test_No := Application_Types.Base_Integer_Type_First;
         Events_objE_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
----------------------------------------------------------------------------
   ...
   procedure Polymorphic_Put (
      This_Object : in out Events_objE_Type;
...
--
   ...
   begin
      ...
      Events_objE_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objE.Object_State_Type(Subtype_object);
...
--
   procedure objE6_To_Subtype_object (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objE_3 (
         Test =>  Events_objE6(This_Event.all).Test,
         Test_Number =>  Events_objE6(This_Event.all).Test_Number,
         This_Instance => This_Instance );

   end objE6_To_Subtype_object;
--
   procedure objE1_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objE_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objE.Object_State_Type(Idle);

      Events_objE_1 (
         Test_Number =>  Events_objE1(This_Event.all).Test_Number,
         This_Instance => This_Instance );
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_objE_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_objE_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objE_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_objE_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_objE_Event_Queue.Queue_Length (Events_objE_Queue);
...
--
   ...
   This_Event_Dispatch_Matrix (objE1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objE6, Non_Existent) :=  Cannot_Happen_Action'access;
   ...
   This_Event_Dispatch_Matrix (objE1, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objE6, Idle) := objE6_To_Subtype_object'access;
   ...
   This_Event_Dispatch_Matrix (objE1, Subtype_object) := objE1_To_Idle'access;
   This_Event_Dispatch_Matrix (objE6, Subtype_object) :=  Cannot_Happen_Action'access;

end Root_Object.Events.objE;
