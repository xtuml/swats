...
--* Description:             
--*                          Domain body Root_Object.EventsobjF
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objF is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceD (
      This_Object : in Root_Object.Object_Access;
      ReferenceD_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objF_Type (This_Object.all).ReferenceD :=
         ReferenceD_Value;
   end Put_ReferenceD;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_ReferenceF (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objF_Type (This_Object.all).ReferenceF;
   end Get_ReferenceF;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceF (
      This_Object : in Root_Object.Object_Access;
      ReferenceF_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objF_Type (This_Object.all).ReferenceF :=
         ReferenceF_Value;
   end Put_ReferenceF;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objF_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objF_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Report_Test_No (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objF_Type (This_Object.all).Report_Test_No;
   end Get_Report_Test_No;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Report_Test_No (
      This_Object : in Root_Object.Object_Access;
      Report_Test_No_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objF_Type (This_Object.all).Report_Test_No :=
         Report_Test_No_Value;
   end Put_Report_Test_No;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objF_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objF_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   procedure Put_R5_Super (
      This_Object : in  Root_Object.Object_Access;
      R5_Super_Value : in Root_Object.Object_Access) is
   begin
      Events_objF_Type (This_Object.all).R5_Super :=
         R5_Super_Value;
   end Put_R5_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objF_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objF_Type(This_Object.all).ReferenceD := Application_Types.Base_Integer_Type_First;
         Events_objF_Type(This_Object.all).ReferenceF := Application_Types.Base_Integer_Type_First;
         Events_objF_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
         Events_objF_Type(This_Object.all).Report_Test_No := Application_Types.Base_Integer_Type_First;
         Events_objF_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
----------------------------------------------------------------------------
   ...
   procedure Polymorphic_Put (
      This_Object : in out Events_objF_Type;
      This_Event  : in     Root_Object.Root_Event_Access_Type) is

      Parent_Event_Type : Root_Object.Events.objD.Event_Class;
      Next_Event        : Root_Object.Root_Event_Access_Type;

   begin

      Parent_Event_Type := Root_Object.Events.objD.Events_objD_Event_Type(This_Event.all).This_Event_Class;

      case Parent_Event_Type is

         when Root_Object.Events.objD.objD1 =>

            Next_Event := new Root_Object.Events.objF.Events_objD1'(
            Root_Event_Type with
               Test_Number =>
                  Root_Object.Events.objD.Events_objD1(This_Event.all).Test_Number,
               This_Event_Class => Root_Object.Events.objF.objD1,
               Target_Instance  => This_Object'Unchecked_Access);

         when Root_Object.Events.objD.objD2 =>

            Next_Event := new Root_Object.Events.objF.Events_objD2'(
            Root_Event_Type with
               Test =>
                  Root_Object.Events.objD.Events_objD2(This_Event.all).Test,
               Test_Number =>
                  Root_Object.Events.objD.Events_objD2(This_Event.all).Test_Number,
               This_Event_Class => Root_Object.Events.objF.objD2,
               Target_Instance  => This_Object'Unchecked_Access);

         when Root_Object.Events.objD.objD3 =>

            Next_Event := new Root_Object.Events.objF.Events_objD3'(
            Root_Event_Type with
               Test =>
                  Root_Object.Events.objD.Events_objD3(This_Event.all).Test,
               Test_Number =>
                  Root_Object.Events.objD.Events_objD3(This_Event.all).Test_Number,
               This_Event_Class => Root_Object.Events.objF.objD3,
               Target_Instance  => This_Object'Unchecked_Access);

         when Root_Object.Events.objD.objD4 =>

            Next_Event := new Root_Object.Events.objF.Events_objD4'(
            Root_Event_Type with
               This_Event_Class => Root_Object.Events.objF.objD4,
               Target_Instance  => This_Object'Unchecked_Access);


         when Root_Object.Events.objD.Class_Event =>
...
--
   ...
   procedure Events_objF_1 (
      Test_Number : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure objD2_To_Subtype_object (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_objF_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objF.Object_State_Type(Subtype_object);

      Events_objF_2 (
         Test =>  Events_objD2(This_Event.all).Test,
         Test_Number =>  Events_objD2(This_Event.all).Test_Number,
         This_Instance => This_Instance );

   end objD2_To_Subtype_object;
--
   procedure objF2_To_Subtype_object (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objF_2 (
         Test =>  Events_objF2(This_Event.all).Test,
         Test_Number =>  Events_objF2(This_Event.all).Test_Number,
         This_Instance => This_Instance );

   end objF2_To_Subtype_object;
--
   procedure objF1_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objF_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objF.Object_State_Type(Idle);

      Events_objF_1 (
         Test_Number =>  Events_objF1(This_Event.all).Test_Number,
         This_Instance => This_Instance );
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_objF_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_objF_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objF_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_objF_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_objF_Event_Queue.Queue_Length (Events_objF_Queue);
...
--
   This_Event_Dispatch_Matrix (objD1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objD2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objD3, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objD4, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objF1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objF2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objD1, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objD2, Idle) := objD2_To_Subtype_object'access;
   This_Event_Dispatch_Matrix (objD3, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objD4, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objF1, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objF2, Idle) := objF2_To_Subtype_object'access;
   This_Event_Dispatch_Matrix (objD1, Subtype_object) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objD2, Subtype_object) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objD3, Subtype_object) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objD4, Subtype_object) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objF1, Subtype_object) := objF1_To_Idle'access;
   This_Event_Dispatch_Matrix (objF2, Subtype_object) :=  Cannot_Happen_Action'access;

end Root_Object.Events.objF;
