...
separate(Root_Object.Events.objR)
   ...
   procedure Events_objR_1 (This_Instance : in out Root_Object.Object_Access) is
   ...
   begin
      ...
      if Root_Object.Events.objP.Events_objP_type(my_super.all).number_of_received_events =  2 then
         ...
         Events_objVERPOL1_verify_polymorphic_Service.Events_objVERPOL1_verify_polymorphic (
            ...
            Test_Number    => Root_Object.Events.objR.Events_objR_type(This_Instance.all).latest_test);
