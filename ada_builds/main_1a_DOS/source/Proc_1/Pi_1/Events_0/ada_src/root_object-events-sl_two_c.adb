...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.SL_TWO_C.adb
...
--* Description:             
--*                          Domain body Root_Object.EventsSL_TWO_C
...
------------------------------------------------------------------------
--
package body Root_Object.Events.SL_TWO_C is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   SL2C_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_SL2C_id return Application_Types.Base_Integer_Type is
   begin
      SL2C_id_Value :=
         Application_Types.Base_Integer_Type'succ (SL2C_id_Value);
      return SL2C_id_Value;
   end Obtain_Subsequent_SL2C_id;
...
--ADATEST IGNORE_ON
   procedure Put_SL2C_id (
      This_Object : in Root_Object.Object_Access;
      SL2C_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_SL_TWO_C_Type (This_Object.all).SL2C_id :=
         SL2C_id_Value;
   end Put_SL2C_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SL_TWO_C_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SL_TWO_C_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SL_TWO_C_Type (This_Object.all).R11_Super;
   end Get_R11_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SL_TWO_C_Type (This_Object.all).R11_Super :=
         R11_Super_Value;
   end Put_R11_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_SL_TWO_C_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_SL_TWO_C_Type(This_Object.all).SL2C_id := Application_Types.Base_Integer_Type_First;
         Events_SL_TWO_C_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
end Root_Object.Events.SL_TWO_C;
