...
--* Description:             
--*                          Domain body Root_Object.EventsRD
...
------------------------------------------------------------------------
--
package body Root_Object.Events.RD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_RD_Type (This_Object.all).Report_Data_Unique_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_RD_Type (This_Object.all).Report_Data_Unique_id :=
         Report_Data_Unique_id_Value;
...
--ADATEST IGNORE_ON
   function Get_Reported_Domain_Number (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_RD_Type (This_Object.all).Reported_Domain_Number;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_RD_Type (This_Object.all).Reported_Domain_Number :=
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_RD_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_RD_Type(This_Object.all).Report_Data_Unique_id := Application_Types.Base_Integer_Type_First;
         Events_RD_Type(This_Object.all).Reported_Domain_Number := Application_Types.Base_Integer_Type_First;
