...
--* Description:             
--*                          Domain specification Root_Object.EventsTE
...
package Root_Object.Events.TE is
--
------------------------------------------------------------------------
   --
   --**************  Object Test_Effects Information **************
   --
   -- Object TE is ACTIVE
   --
   --
   --
   -- Object TE is ACTIVE and has the following state actions defined
   --   Non_Existent,
   --   Idle,
   --   Gen_Ignore_Event,
   --   Update_Result,
   --   Check_Ignore_State,
   --   Gen_Cannot_Happen_Event,
   --   Check_Cannot_Happen_State,
   --   Unsupported,
   --   Gen_Indefined_Event.
   --
   -- Object TE has an identifying non-referential attribute ID 
   -- and therefore may be uniquely created.
   -- 
   -- Object TE has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "TE";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_TE_Type is new Events_Type with record
   ...
   -- EVENT DECLARATION
   --
   type Events_TE_Event_Type is new Events_Event_Type with
   record
   ...
   --    
   type Events_TE_Instance_Event_Type is new Events_TE_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type Events_TE_Description_Event is new Events_TE_Instance_Event_Type with
   record
      null;
   end record;  
   --
   ...
   type Events_TE1 is new Events_TE_Instance_Event_Type with
   record 
      Test_No : Application_Types.Base_Integer_Type;
   end record;

   type Events_TE2 is new Events_TE_Instance_Event_Type with
   record 
      Test_No : Application_Types.Base_Integer_Type;
   end record;

   type Events_TE3 is new Events_TE_Instance_Event_Type with
   record 
      Test_No : Application_Types.Base_Integer_Type;
      Effect_Type : Application_Types.Base_Text_Type;
   end record;

   type Events_TE4 is new Events_TE_Instance_Event_Type with
   record 
      Test_No : Application_Types.Base_Integer_Type;
   end record;

   type Events_TE5 is new Events_TE_Instance_Event_Type with
   record 
      Test_No : Application_Types.Base_Integer_Type;
   end record;

   type Events_TE6 is new Events_TE_Instance_Event_Type with
   record 
      Test_No : Application_Types.Base_Integer_Type;
      The_Reqid : Application_Types.Base_Text_Type;
      Effect_Type : Application_Types.Base_Text_Type;
   end record;

   type Events_TE7 is new Events_TE_Instance_Event_Type with
   record 
      Test_No : Application_Types.Base_Integer_Type;
   end record;
   ...
   package Events_TE_Event_Queue is new Generic_FIFO (Root_Object.Root_Event_Access_Type); 

   Events_TE_Queue: Events_TE_Event_Queue.FIFO_Type;
