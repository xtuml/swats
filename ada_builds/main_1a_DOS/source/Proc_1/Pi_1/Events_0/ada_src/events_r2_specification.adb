...
--*  package Events_Rel_R2 is new Super_Sub
--*  package Events_R2_Specification 
...
package body Events_R2_Specification is
   ...
   begin
      ...
      if This_Object'tag = Root_Object.Events.objN.Events_objN_Type'tag then
         Local_Value := Root_Object.Events.objN.Get_R2_Super(This_Object); 
...
--
   ...
   begin
      ...
      if This_Object'tag = Root_Object.Events.objN.Events_objN_Type'tag then
         ...
         Root_Object.Events.objN.Put_R2_Super(This_Object, R2_Super_Value);

      end if; 

   end Subtype_Write_Accessor;

end Events_R2_Specification;
