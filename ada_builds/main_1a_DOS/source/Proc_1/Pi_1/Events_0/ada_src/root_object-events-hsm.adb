...
--* Description:             
--*                          Domain body Root_Object.EventsHSM
...
------------------------------------------------------------------------
--
package body Root_Object.Events.HSM is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   hsm_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_hsm_id return Application_Types.Base_Integer_Type is
   begin
      hsm_id_Value :=
         Application_Types.Base_Integer_Type'succ (hsm_id_Value);
      return hsm_id_Value;
   end Obtain_Subsequent_hsm_id;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_HSM_Type (This_Object.all).hsm_id;
   end Get_hsm_id;
...
--ADATEST IGNORE_ON
   procedure Put_hsm_id (
      This_Object : in Root_Object.Object_Access;
      hsm_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_HSM_Type (This_Object.all).hsm_id :=
         hsm_id_Value;
   end Put_hsm_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_HSM_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_HSM_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_HSM_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_HSM_Type(This_Object.all).hsm_id := Application_Types.Base_Integer_Type_First;
         Events_HSM_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure Events_HSM_3 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_4 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_5 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_6 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_7 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_8 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_9 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_10 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_11 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_12 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_13 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_14 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_15 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_16 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_17 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_18 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_19 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_20 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_21 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_22 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_23 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_24 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_25 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_26 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_HSM_27 (
      Test_No : in Application_Types.Base_Integer_Type;
      Count : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;
...
--
   procedure HSM1_To_State_A (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_A);

      Events_HSM_2 (
         Test_No =>  Events_HSM1(This_Event.all).Test_No,
         Count =>  Events_HSM1(This_Event.all).Count,
         This_Instance => This_Instance );

   end HSM1_To_State_A;
--
   procedure HSM1_To_State_B (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_B);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_C);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_D);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_E);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_F);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_G);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_H);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_I);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_J);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_K);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_L);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_M);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_N);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_O);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_P);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_Q);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_R);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(StateS);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_T);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_U);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_V);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_W);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_X);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_Y);
...
--
   ...
   begin
      ...
      Events_HSM_Type (This_Instance.all).Current_State := 
         Root_Object.Events.HSM.Object_State_Type(State_Z);
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_HSM_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_HSM_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_HSM_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_HSM_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_HSM_Event_Queue.Queue_Length (Events_HSM_Queue);
...
--
   This_Event_Dispatch_Matrix (HSM1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (HSM1, Idle) := HSM1_To_State_A'access;
   This_Event_Dispatch_Matrix (HSM1, State_A) := HSM1_To_State_B'access;
   This_Event_Dispatch_Matrix (HSM1, State_B) := HSM1_To_State_C'access;
   This_Event_Dispatch_Matrix (HSM1, State_C) := HSM1_To_State_D'access;
   This_Event_Dispatch_Matrix (HSM1, State_D) := HSM1_To_State_E'access;
   This_Event_Dispatch_Matrix (HSM1, State_E) := HSM1_To_State_F'access;
   This_Event_Dispatch_Matrix (HSM1, State_F) := HSM1_To_State_G'access;
   This_Event_Dispatch_Matrix (HSM1, State_G) := HSM1_To_State_H'access;
   This_Event_Dispatch_Matrix (HSM1, State_H) := HSM1_To_State_I'access;
   This_Event_Dispatch_Matrix (HSM1, State_I) := HSM1_To_State_J'access;
   This_Event_Dispatch_Matrix (HSM1, State_J) := HSM1_To_State_K'access;
   This_Event_Dispatch_Matrix (HSM1, State_K) := HSM1_To_State_L'access;
   This_Event_Dispatch_Matrix (HSM1, State_L) := HSM1_To_State_M'access;
   This_Event_Dispatch_Matrix (HSM1, State_M) := HSM1_To_State_N'access;
   This_Event_Dispatch_Matrix (HSM1, State_N) := HSM1_To_State_O'access;
   This_Event_Dispatch_Matrix (HSM1, State_O) := HSM1_To_State_P'access;
   This_Event_Dispatch_Matrix (HSM1, State_P) := HSM1_To_State_Q'access;
   This_Event_Dispatch_Matrix (HSM1, State_Q) := HSM1_To_State_R'access;
   This_Event_Dispatch_Matrix (HSM1, State_R) := HSM1_To_StateS'access;
   This_Event_Dispatch_Matrix (HSM1, StateS) := HSM1_To_State_T'access;
   This_Event_Dispatch_Matrix (HSM1, State_T) := HSM1_To_State_U'access;
   This_Event_Dispatch_Matrix (HSM1, State_U) := HSM1_To_State_V'access;
   This_Event_Dispatch_Matrix (HSM1, State_V) := HSM1_To_State_W'access;
   This_Event_Dispatch_Matrix (HSM1, State_W) := HSM1_To_State_X'access;
   This_Event_Dispatch_Matrix (HSM1, State_X) := HSM1_To_State_Y'access;
   This_Event_Dispatch_Matrix (HSM1, State_Y) := HSM1_To_State_Z'access;
   This_Event_Dispatch_Matrix (HSM1, State_Z) :=  Ignore_Action'access;

end Root_Object.Events.HSM;
