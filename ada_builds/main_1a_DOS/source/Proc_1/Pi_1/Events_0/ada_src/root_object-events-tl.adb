...
--* Description:             
--*                          Domain body Root_Object.EventsTL
...
------------------------------------------------------------------------
--
package body Root_Object.Events.TL is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   TL_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_TL_id return Application_Types.Base_Integer_Type is
   begin
      TL_id_Value :=
         Application_Types.Base_Integer_Type'succ (TL_id_Value);
      return TL_id_Value;
   end Obtain_Subsequent_TL_id;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_TL_Type (This_Object.all).TL_id;
   end Get_TL_id;
...
--ADATEST IGNORE_ON
   procedure Put_TL_id (
      ...
      TL_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_TL_Type (This_Object.all).TL_id :=
         TL_id_Value;
   end Put_TL_id;
...
--ADATEST IGNORE_ON
   function Get_Result (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_TL_Type (This_Object.all).Result;
   end Get_Result;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_TL_Type (This_Object.all).Result :=
         Result_Value;
   end Put_Result;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_TL_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_TL_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_TL_Type (This_Object.all).R9_Sub;
   end Get_R9_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R9_Sub (
      This_Object : in Root_Object.Object_Access;
      R9_Sub_Value : in Root_Object.Object_Access) is
   begin
      Events_TL_Type (This_Object.all).R9_Sub :=
         R9_Sub_Value;
   end Put_R9_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_TL_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_TL_Type(This_Object.all).TL_id := Application_Types.Base_Integer_Type_First;
         Events_TL_Type(This_Object.all).Result := Application_Types.Base_Integer_Type_First;
         Events_TL_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure Events_TL_1 (
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_TL_2 (
      Test_No : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure TL1_To_Check (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_TL_Type (This_Instance.all).Current_State := 
         Root_Object.Events.TL.Object_State_Type(Check);
...
--
   ...
   begin
      ...
      Events_TL_Type (This_Instance.all).Current_State := 
         Root_Object.Events.TL.Object_State_Type(Finish);

      Events_TL_2 (
         Test_No =>  Events_TL2(This_Event.all).Test_No,
         This_Instance => This_Instance );
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_TL_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_TL_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_TL_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_TL_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_TL_Event_Queue.Queue_Length (Events_TL_Queue);
...
--
   This_Event_Dispatch_Matrix (TL1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TL2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TL1, Check) := TL1_To_Check'access;
   This_Event_Dispatch_Matrix (TL2, Check) := TL2_To_Finish'access;
   This_Event_Dispatch_Matrix (TL1, Finish) := TL1_To_Check'access;
   This_Event_Dispatch_Matrix (TL2, Finish) :=  Ignore_Action'access;

end Root_Object.Events.TL;
