...
--* Description:             
--*                          Domain body Root_Object.EventsBLH
...
------------------------------------------------------------------------
--
package body Root_Object.Events.BLH is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   BLH_Identifier_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_BLH_Identifier return Application_Types.Base_Integer_Type is
   begin
      BLH_Identifier_Value :=
         Application_Types.Base_Integer_Type'succ (BLH_Identifier_Value);
      return BLH_Identifier_Value;
   end Obtain_Subsequent_BLH_Identifier;
...
--ADATEST IGNORE_ON
   function Get_BLH_Identifier (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return Events_BLH_Type (This_Object.all).BLH_Identifier;
   end Get_BLH_Identifier;
...
--ADATEST IGNORE_ON
   procedure Put_BLH_Identifier (
      This_Object : in Root_Object.Object_Access;
      BLH_Identifier_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_BLH_Type (This_Object.all).BLH_Identifier :=
         BLH_Identifier_Value;
   end Put_BLH_Identifier;
...
--ADATEST IGNORE_ON
   function Get_Value_To_Add (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_BLH_Type (This_Object.all).Value_To_Add;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BLH_Type (This_Object.all).Value_To_Add :=
         Value_To_Add_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_BLH_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BLH_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   procedure Put_R19_Super (
      This_Object : in  Root_Object.Object_Access;
      R19_Super_Value : in Root_Object.Object_Access) is
   begin
      Events_BLH_Type (This_Object.all).R19_Super :=
         R19_Super_Value;
   end Put_R19_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_BLH_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_BLH_Type(This_Object.all).BLH_Identifier := Application_Types.Base_Integer_Type_First;
         Events_BLH_Type(This_Object.all).Value_To_Add := Application_Types.Base_Integer_Type_First;
         Events_BLH_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_BLH_Type(This_Object.all).BLH_Identifier :=
         Obtain_Subsequent_BLH_Identifier;
