...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.SL_TWO_A.adb
...
--* Description:             
--*                          Domain body Root_Object.EventsSL_TWO_A
...
------------------------------------------------------------------------
--
package body Root_Object.Events.SL_TWO_A is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   SL2A_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_SL2A_id return Application_Types.Base_Integer_Type is
   begin
      SL2A_id_Value :=
         Application_Types.Base_Integer_Type'succ (SL2A_id_Value);
      return SL2A_id_Value;
   end Obtain_Subsequent_SL2A_id;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_SL_TWO_A_Type (This_Object.all).SL2A_id;
   end Get_SL2A_id;
...
--ADATEST IGNORE_ON
   procedure Put_SL2A_id (
      ...
      SL2A_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_SL_TWO_A_Type (This_Object.all).SL2A_id :=
         SL2A_id_Value;
   end Put_SL2A_id;
...
------------------------------------------------------------------------
   --
   -- procedure Put_SL1A_id and 
   --
   -- function Get_SL1A_id
   --
   -- have not been generated for SL1A_id
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SL_TWO_A_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SL_TWO_A_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SL_TWO_A_Type (This_Object.all).R12_Sub;
   end Get_R12_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R12_Sub (
      This_Object : in Root_Object.Object_Access;
      R12_Sub_Value : in Root_Object.Object_Access) is
   begin
      Events_SL_TWO_A_Type (This_Object.all).R12_Sub :=
         R12_Sub_Value;
   end Put_R12_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R10_Super (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Events_SL_TWO_A_Type (This_Object.all).R10_Super;
   end Get_R10_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SL_TWO_A_Type (This_Object.all).R10_Super :=
         R10_Super_Value;
   end Put_R10_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_SL_TWO_A_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_SL_TWO_A_Type(This_Object.all).SL2A_id := Application_Types.Base_Integer_Type_First;
         Events_SL_TWO_A_Type(This_Object.all).Current_State :=  Object_State_Type_First;
