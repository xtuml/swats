...
--* Description:             
--*                          Domain body Root_Object.EventsBLF
...
------------------------------------------------------------------------
--
package body Root_Object.Events.BLF is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   BLF_Identifier_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_BLF_Identifier return Application_Types.Base_Integer_Type is
   begin
      BLF_Identifier_Value :=
         Application_Types.Base_Integer_Type'succ (BLF_Identifier_Value);
      return BLF_Identifier_Value;
   end Obtain_Subsequent_BLF_Identifier;
...
--ADATEST IGNORE_ON
   function Get_BLF_Identifier (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return Events_BLF_Type (This_Object.all).BLF_Identifier;
   end Get_BLF_Identifier;
...
--ADATEST IGNORE_ON
   procedure Put_BLF_Identifier (
      This_Object : in Root_Object.Object_Access;
      BLF_Identifier_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_BLF_Type (This_Object.all).BLF_Identifier :=
         BLF_Identifier_Value;
   end Put_BLF_Identifier;
...
--ADATEST IGNORE_ON
   function Get_Value_To_Add (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_BLF_Type (This_Object.all).Value_To_Add;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BLF_Type (This_Object.all).Value_To_Add :=
         Value_To_Add_Value;
...
------------------------------------------------------------------------
   --
   -- procedure Put_SL3A_id and 
   --
   -- function Get_SL3A_id
   --
   -- have not been generated for SL3A_id
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_BLF_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BLF_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   procedure Put_R18_Super (
      This_Object : in  Root_Object.Object_Access;
      R18_Super_Value : in Root_Object.Object_Access) is
   begin
      Events_BLF_Type (This_Object.all).R18_Super :=
         R18_Super_Value;
   end Put_R18_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_BLF_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_BLF_Type(This_Object.all).BLF_Identifier := Application_Types.Base_Integer_Type_First;
         Events_BLF_Type(This_Object.all).Value_To_Add := Application_Types.Base_Integer_Type_First;
         Events_BLF_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_BLF_Type(This_Object.all).BLF_Identifier :=
         Obtain_Subsequent_BLF_Identifier;
