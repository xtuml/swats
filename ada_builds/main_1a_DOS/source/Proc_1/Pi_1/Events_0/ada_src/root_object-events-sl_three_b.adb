...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.SL_THREE_B.adb
...
--* Description:             
--*                          Domain body Root_Object.EventsSL_THREE_B
...
------------------------------------------------------------------------
--
package body Root_Object.Events.SL_THREE_B is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   SL3B_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_SL3B_id return Application_Types.Base_Integer_Type is
   begin
      SL3B_id_Value :=
         Application_Types.Base_Integer_Type'succ (SL3B_id_Value);
      return SL3B_id_Value;
   end Obtain_Subsequent_SL3B_id;
...
--ADATEST IGNORE_ON
   procedure Put_SL3B_id (
      This_Object : in Root_Object.Object_Access;
      SL3B_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_SL_THREE_B_Type (This_Object.all).SL3B_id :=
         SL3B_id_Value;
   end Put_SL3B_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SL_THREE_B_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SL_THREE_B_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SL_THREE_B_Type (This_Object.all).R12_Super;
   end Get_R12_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SL_THREE_B_Type (This_Object.all).R12_Super :=
         R12_Super_Value;
   end Put_R12_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_SL_THREE_B_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_SL_THREE_B_Type(This_Object.all).SL3B_id := Application_Types.Base_Integer_Type_First;
         Events_SL_THREE_B_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
end Root_Object.Events.SL_THREE_B;
