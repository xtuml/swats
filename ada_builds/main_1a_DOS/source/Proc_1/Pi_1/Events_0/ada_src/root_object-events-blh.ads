...
--* Description:             
--*                          Domain specification Root_Object.EventsBLH
...
--  ----------------------------------  
--  package Root_Object.Events.BLH
...
package Root_Object.Events.BLH is
--
------------------------------------------------------------------------
   --
   --**************  Object Bottom_Level_H Information **************
   --
   -- Object BLH is PASSIVE
   --
   -- Object BLH participates in a super sub type relationship
   --
   --
   --
   -- Object BLH is a SUB type of SL_THREE_A via Relationship R19
   --
   -- Object BLH has an identifying non-referential attribute BLH_Identifier 
   -- and therefore may be uniquely created.
   -- 
   -- Object BLH has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "BLH";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_BLH_Type is new Events_Type with record

      --
      -- Non initialised identifying non referential
      BLH_Identifier : Application_Types.Base_Integer_Type;
      ...
      R19_Super : Root_Object.Object_Access := null;
   ...
   procedure Put_BLH_Identifier (
      ...
      BLH_Identifier_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_BLH_Identifier);
   pragma inline (Put_BLH_Identifier);
   ...
   procedure Put_R19_Super (
      This_Object : in  Root_Object.Object_Access;
      R19_Super_Value : in Root_Object.Object_Access);

   pragma inline (Get_R19_Super);
   pragma inline (Put_R19_Super);
