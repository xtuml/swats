...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.objN.event_action.ada
...
--*  separate of Root_Object.EventsobjN
--*     Event_Action
--*
--*************************************************************************************
--  MODIFICATION RECORD
...
separate (Root_Object.Events.objN)
...
begin
   ...
   This_Action := Events_objN_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := Events_objN_Instance_Event_Type(This_Event.all).Target_Instance;
   ...
   if This /= null then
      ...
      --  
      This_Event_Dispatch_Matrix (This_Action, Events_objN_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
