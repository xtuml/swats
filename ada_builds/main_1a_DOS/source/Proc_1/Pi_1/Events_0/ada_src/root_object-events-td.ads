...
--* Description:             
--*                          Domain specification Root_Object.EventsTD
...
package Root_Object.Events.TD is
--
------------------------------------------------------------------------
   --
   ...
   type Events_TD_Type is new Events_Type with record
