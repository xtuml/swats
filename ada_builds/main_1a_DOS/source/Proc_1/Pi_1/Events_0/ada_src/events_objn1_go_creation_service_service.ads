...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Events_objN1_GO_Creation_Service_Service.ads
...
package Events_objN1_GO_Creation_Service_Service is
   
   
   procedure Events_objN1_GO_Creation_Service (
      Specific_Type          : in     Events_Domain_Types.Specific_Classes_JTT;
      Created_Generic_Object :    out Root_Object.Object_Access);
   
end Events_objN1_GO_Creation_Service_Service;

--
-- End of file Events_objN1_GO_Creation_Service_Service.ads
--
