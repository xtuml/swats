...
--* Description:             
--*                          Domain body Root_Object.EventsCP
...
------------------------------------------------------------------------
--
package body Root_Object.Events.CP is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   CP_ID_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_CP_ID return Application_Types.Base_Integer_Type is
   begin
      CP_ID_Value :=
         Application_Types.Base_Integer_Type'succ (CP_ID_Value);
      return CP_ID_Value;
   end Obtain_Subsequent_CP_ID;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_CP_Type (This_Object.all).CP_ID;
   end Get_CP_ID;
...
--ADATEST IGNORE_ON
   procedure Put_CP_ID (
      ...
      CP_ID_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_CP_Type (This_Object.all).CP_ID :=
         CP_ID_Value;
   end Put_CP_ID;
...
--ADATEST IGNORE_ON
   function Get_Number_Of_Test (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_CP_Type (This_Object.all).Number_Of_Test;
   end Get_Number_Of_Test;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Number_Of_Test (
      This_Object : in Root_Object.Object_Access;
      Number_Of_Test_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_CP_Type (This_Object.all).Number_Of_Test :=
         Number_Of_Test_Value;
   end Put_Number_Of_Test;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_CP_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_CP_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_CP_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_CP_Type(This_Object.all).CP_ID := Application_Types.Base_Integer_Type_First;
         Events_CP_Type(This_Object.all).Number_Of_Test := Application_Types.Base_Integer_Type_First;
         Events_CP_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure Events_CP_2 (
      Start_Val : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_CP_1 (
      Start_Val : in Application_Types.Base_Integer_Type;
...
--
   procedure CP1_To_StartA (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_CP_Type (This_Instance.all).Current_State := 
         Root_Object.Events.CP.Object_State_Type(StartA);

      Events_CP_2 (
         Start_Val =>  Events_CP1(This_Event.all).Start_Val,
         This_Instance => This_Instance );

   end CP1_To_StartA;
--
   procedure CP2_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_CP_Type (This_Instance.all).Current_State := 
         Root_Object.Events.CP.Object_State_Type(Idle);

      Events_CP_1 (
         Start_Val =>  Events_CP2(This_Event.all).Start_Val,
         Got_To_End =>  Events_CP2(This_Event.all).Got_To_End,
         This_Instance => This_Instance );
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_CP_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_CP_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_CP_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_CP_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_CP_Event_Queue.Queue_Length (Events_CP_Queue);
...
--
   This_Event_Dispatch_Matrix (CP1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (CP2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (CP1, Idle) := CP1_To_StartA'access;
   This_Event_Dispatch_Matrix (CP2, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (CP1, StartA) := CP1_To_StartA'access;
   This_Event_Dispatch_Matrix (CP2, StartA) := CP2_To_Idle'access;

end Root_Object.Events.CP;
