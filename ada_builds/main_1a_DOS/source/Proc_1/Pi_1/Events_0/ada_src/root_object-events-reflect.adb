...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.REFLECT.adb
...
--* Description:             
--*                          Domain body Root_Object.EventsREFLECT
...
------------------------------------------------------------------------
--
package body Root_Object.Events.REFLECT is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_REFLECT_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_REFLECT_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
------------------------------------------------------------------------
   ...
   ReferenceREFLECT_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceREFLECT return Application_Types.Base_Integer_Type is
   begin
      ReferenceREFLECT_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceREFLECT_Value);
      return ReferenceREFLECT_Value;
   end Obtain_Subsequent_ReferenceREFLECT;
...
--ADATEST IGNORE_ON
   function Get_ReferenceREFLECT (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return Events_REFLECT_Type (This_Object.all).ReferenceREFLECT;
   end Get_ReferenceREFLECT;
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceREFLECT (
      This_Object : in Root_Object.Object_Access;
      ReferenceREFLECT_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_REFLECT_Type (This_Object.all).ReferenceREFLECT :=
         ReferenceREFLECT_Value;
   end Put_ReferenceREFLECT;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_REFLECT_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_REFLECT_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_REFLECT_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_REFLECT_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
         Events_REFLECT_Type(This_Object.all).ReferenceREFLECT := Application_Types.Base_Integer_Type_First;
         Events_REFLECT_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_REFLECT_Type(This_Object.all).ReferenceREFLECT :=
         Obtain_Subsequent_ReferenceREFLECT;
...
--
   ...
   procedure Events_REFLECT_1 (
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_REFLECT_3 (
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure REFLECT3_To_Test_state (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_REFLECT_Type (This_Instance.all).Current_State := 
         Root_Object.Events.REFLECT.Object_State_Type(Test_state);

      Events_REFLECT_2 (
         Test =>  Events_REFLECT3(This_Event.all).Test,
         Counter =>  Events_REFLECT3(This_Event.all).Counter,
         Test_Number =>  Events_REFLECT3(This_Event.all).Test_Number,
         This_Instance => This_Instance );

   end REFLECT3_To_Test_state;
--
   procedure REFLECT1_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_REFLECT_Type (This_Instance.all).Current_State := 
         Root_Object.Events.REFLECT.Object_State_Type(Idle);

      Events_REFLECT_1 (
         This_Instance => This_Instance );

   end REFLECT1_To_Idle;
--
   procedure REFLECT2_To_Fail (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_REFLECT_Type (This_Instance.all).Current_State := 
         Root_Object.Events.REFLECT.Object_State_Type(Fail);

      Events_REFLECT_3 (
         This_Instance => This_Instance );

   end REFLECT2_To_Fail;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_REFLECT_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_REFLECT_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_REFLECT_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_REFLECT_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_REFLECT_Event_Queue.Pop (
         Item        => Temp_Event,
         Target_FIFO => Events_REFLECT_Queue);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_REFLECT_Event_Queue.Queue_Length (Events_REFLECT_Queue);
...
--ADATEST IGNORE_ON
   procedure Put_Event (
      ...
      To_Class : in Events_REFLECT_Type;
...
--
   This_Event_Dispatch_Matrix (REFLECT1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (REFLECT2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (REFLECT3, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (REFLECT1, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (REFLECT2, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (REFLECT3, Idle) := REFLECT3_To_Test_state'access;
   This_Event_Dispatch_Matrix (REFLECT1, Test_state) := REFLECT1_To_Idle'access;
   This_Event_Dispatch_Matrix (REFLECT2, Test_state) := REFLECT2_To_Fail'access;
   This_Event_Dispatch_Matrix (REFLECT3, Test_state) := REFLECT3_To_Test_state'access;
   This_Event_Dispatch_Matrix (REFLECT1, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (REFLECT2, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (REFLECT3, Fail) :=  Cannot_Happen_Action'access;

end Root_Object.Events.REFLECT;
