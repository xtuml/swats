...
separate(Root_Object.Events.TE)
   ...
   procedure Events_TE_5 (Test_No       : in     Application_Types.Base_Integer_Type;
   ...
   begin
      ...
      Events_RPT1_Start_Test_Bridge.Events_RPT1_Start_Test (
         Test_Number     => Test_No,
         Requid          => "1241-0000-01-0212               ",
         Invoking_Domain => "Events                          ",
         Invoking_Object => "State                           ",
         Purpose         => "Cannot Happen Event             ");
