...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Events_objQ_1.ada
--* Drawing Number:          Refer to release documentation                           *
--* Version:                 As detailed by Configuration Management System           *
--* Version Date:            As detailed by Configuration Management System           *
--* Creation Date:           As detailed by Configuration Management System           *
--* Section/Unit:            Refer to release documentation                           *
--* Description               model in the supertype.
--*                          Not Defined
...
separate(Root_Object.Events.objQ)
   ...
   procedure Events_objQ_1 (This_Instance : in out Root_Object.Object_Access) is
   ...
   begin
      ...
      if Root_Object.Events.objP.Events_objP_type(my_super.all).number_of_received_events =  2 then
         ...
         Events_objVERPOL1_verify_polymorphic_Service.Events_objVERPOL1_verify_polymorphic (
            ...
            Test_Number    => Root_Object.Events.objQ.Events_objQ_type(This_Instance.all).latest_test);
