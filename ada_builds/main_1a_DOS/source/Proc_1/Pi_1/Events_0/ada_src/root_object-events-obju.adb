...
--* Description:             
--*                          Domain body Root_Object.EventsobjU
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objU is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   procedure Put_Reference_T (
      This_Object : in Root_Object.Object_Access;
      Reference_T_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objU_Type (This_Object.all).Reference_T :=
         Reference_T_Value;
   end Put_Reference_T;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Result_U (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objU_Type (This_Object.all).Result_U;
   end Get_Result_U;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Result_U (
      This_Object : in Root_Object.Object_Access;
      Result_U_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objU_Type (This_Object.all).Result_U :=
         Result_U_Value;
   end Put_Result_U;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_latest_test (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objU_Type (This_Object.all).latest_test;
   end Get_latest_test;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objU_Type (This_Object.all).latest_test :=
         latest_test_Value;
   end Put_latest_test;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objU_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objU_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   procedure Put_R8_Super (
      This_Object : in  Root_Object.Object_Access;
      R8_Super_Value : in Root_Object.Object_Access) is
   begin
      Events_objU_Type (This_Object.all).R8_Super :=
         R8_Super_Value;
   end Put_R8_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objU_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objU_Type(This_Object.all).Reference_T := Application_Types.Base_Integer_Type_First;
         Events_objU_Type(This_Object.all).Result_U := Application_Types.Base_Integer_Type_First;
         Events_objU_Type(This_Object.all).latest_test := Application_Types.Base_Integer_Type_First;
         Events_objU_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
----------------------------------------------------------------------------
   ...
   procedure Polymorphic_Put (
      This_Object : in out Events_objU_Type;
      This_Event  : in     Root_Object.Root_Event_Access_Type) is

      Parent_Event_Type : Root_Object.Events.objT.Event_Class;
      Next_Event        : Root_Object.Root_Event_Access_Type;

   begin

      Parent_Event_Type := Root_Object.Events.objT.Events_objT_Event_Type(This_Event.all).This_Event_Class;

      case Parent_Event_Type is

         when Root_Object.Events.objT.objT1 =>

            Next_Event := new Root_Object.Events.objU.Events_objT1'(
            Root_Event_Type with
               Test_Number =>
                  Root_Object.Events.objT.Events_objT1(This_Event.all).Test_Number,
               This_Event_Class => Root_Object.Events.objU.objT1,
               Target_Instance  => This_Object'Unchecked_Access);


         when Root_Object.Events.objT.Class_Event =>
...
--
   ...
   procedure Events_objU_2 (
      Test_Number : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_objU_1 (
      Test_Number : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure objT1_To_Subtype_State (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_objU_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objU.Object_State_Type(Subtype_State);

      Events_objU_2 (
         Test_Number =>  Events_objT1(This_Event.all).Test_Number,
         This_Instance => This_Instance );

   end objT1_To_Subtype_State;
--
   procedure objU1_To_Subtype_State (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objU_2 (
         Test_Number =>  Events_objU1(This_Event.all).Test_Number,
         This_Instance => This_Instance );

   end objU1_To_Subtype_State;
--
   procedure objU2_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objU_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objU.Object_State_Type(Idle);

      Events_objU_1 (
         Test_Number =>  Events_objU2(This_Event.all).Test_Number,
         This_Instance => This_Instance );
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_objU_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_objU_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objU_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_objU_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_objU_Event_Queue.Queue_Length (Events_objU_Queue);
...
--
   This_Event_Dispatch_Matrix (objT1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objU1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objU2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objT1, Idle) := objT1_To_Subtype_State'access;
   This_Event_Dispatch_Matrix (objU1, Idle) := objU1_To_Subtype_State'access;
   This_Event_Dispatch_Matrix (objU2, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objT1, Subtype_State) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objU1, Subtype_State) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objU2, Subtype_State) := objU2_To_Idle'access;

end Root_Object.Events.objU;
