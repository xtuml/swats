...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.SL_TWO_D.adb
...
--* Description:             
--*                          Domain body Root_Object.EventsSL_TWO_D
...
------------------------------------------------------------------------
--
package body Root_Object.Events.SL_TWO_D is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   SL2D_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_SL2D_id return Application_Types.Base_Integer_Type is
   begin
      SL2D_id_Value :=
         Application_Types.Base_Integer_Type'succ (SL2D_id_Value);
      return SL2D_id_Value;
   end Obtain_Subsequent_SL2D_id;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_SL_TWO_D_Type (This_Object.all).SL2D_id;
   end Get_SL2D_id;
...
--ADATEST IGNORE_ON
   procedure Put_SL2D_id (
      ...
      SL2D_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_SL_TWO_D_Type (This_Object.all).SL2D_id :=
         SL2D_id_Value;
   end Put_SL2D_id;
...
------------------------------------------------------------------------
   --
   -- procedure Put_SL1B_id and 
   --
   -- function Get_SL1B_id
   --
   -- have not been generated for SL1B_id
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SL_TWO_D_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SL_TWO_D_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_SL_TWO_D_Type (This_Object.all).R17_Sub;
   end Get_R17_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R17_Sub (
      This_Object : in Root_Object.Object_Access;
      R17_Sub_Value : in Root_Object.Object_Access) is
   begin
      Events_SL_TWO_D_Type (This_Object.all).R17_Sub :=
         R17_Sub_Value;
   end Put_R17_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R11_Super (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Events_SL_TWO_D_Type (This_Object.all).R11_Super;
   end Get_R11_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_SL_TWO_D_Type (This_Object.all).R11_Super :=
         R11_Super_Value;
   end Put_R11_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_SL_TWO_D_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_SL_TWO_D_Type(This_Object.all).SL2D_id := Application_Types.Base_Integer_Type_First;
         Events_SL_TWO_D_Type(This_Object.all).Current_State :=  Object_State_Type_First;
