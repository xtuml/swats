...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.objVERPOL.adb
...
--* Description:             
--*                          Domain body Root_Object.EventsobjVERPOL
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objVERPOL is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   ReferenceVER_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceVER return Application_Types.Base_Integer_Type is
   begin
      ReferenceVER_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceVER_Value);
      return ReferenceVER_Value;
   end Obtain_Subsequent_ReferenceVER;
...
--ADATEST IGNORE_ON
   function Get_ReferenceVER (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return Events_objVERPOL_Type (This_Object.all).ReferenceVER;
   end Get_ReferenceVER;
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceVER (
      This_Object : in Root_Object.Object_Access;
      ReferenceVER_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objVERPOL_Type (This_Object.all).ReferenceVER :=
         ReferenceVER_Value;
   end Put_ReferenceVER;
...
--ADATEST IGNORE_ON
   function Get_ResultSUPERTYPE (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objVERPOL_Type (This_Object.all).ResultSUPERTYPE;
   end Get_ResultSUPERTYPE;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_ResultSUPERTYPE (
      This_Object : in Root_Object.Object_Access;
      ResultSUPERTYPE_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objVERPOL_Type (This_Object.all).ResultSUPERTYPE :=
         ResultSUPERTYPE_Value;
   end Put_ResultSUPERTYPE;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   function Get_ResultSUBTYPE (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objVERPOL_Type (This_Object.all).ResultSUBTYPE;
   end Get_ResultSUBTYPE;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_ResultSUBTYPE (
      This_Object : in Root_Object.Object_Access;
      ResultSUBTYPE_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objVERPOL_Type (This_Object.all).ResultSUBTYPE :=
         ResultSUBTYPE_Value;
   end Put_ResultSUBTYPE;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objVERPOL_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objVERPOL_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objVERPOL_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objVERPOL_Type(This_Object.all).ReferenceVER := Application_Types.Base_Integer_Type_First;
         Events_objVERPOL_Type(This_Object.all).ResultSUPERTYPE := Application_Types.Base_Integer_Type_First;
         Events_objVERPOL_Type(This_Object.all).ResultSUBTYPE := Application_Types.Base_Integer_Type_First;
         Events_objVERPOL_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objVERPOL_Type(This_Object.all).ReferenceVER :=
         Obtain_Subsequent_ReferenceVER;
...
--
   ...
   procedure Events_objVERPOL_2 (
      Test : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_objVERPOL_1 (
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_objVERPOL_3 (
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure objVERPOL3_To_Verify_Event_Received (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_objVERPOL_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objVERPOL.Object_State_Type(Verify_Event_Received);

      Events_objVERPOL_2 (
         Test =>  Events_objVERPOL3(This_Event.all).Test,
         This_Instance => This_Instance );

   end objVERPOL3_To_Verify_Event_Received;
--
   procedure objVERPOL1_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objVERPOL_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objVERPOL.Object_State_Type(Idle);

      Events_objVERPOL_1 (
         This_Instance => This_Instance );

   end objVERPOL1_To_Idle;
--
   procedure objVERPOL2_To_Fail (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objVERPOL_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objVERPOL.Object_State_Type(Fail);

      Events_objVERPOL_3 (
         This_Instance => This_Instance );

   end objVERPOL2_To_Fail;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_objVERPOL_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_objVERPOL_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objVERPOL_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_objVERPOL_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objVERPOL_Event_Queue.Pop (
         Item        => Temp_Event,
         Target_FIFO => Events_objVERPOL_Queue);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_objVERPOL_Event_Queue.Queue_Length (Events_objVERPOL_Queue);
...
--ADATEST IGNORE_ON
   procedure Put_Event (
      ...
      To_Class : in Events_objVERPOL_Type;
...
--
   This_Event_Dispatch_Matrix (objVERPOL1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objVERPOL2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objVERPOL3, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objVERPOL1, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objVERPOL2, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objVERPOL3, Idle) := objVERPOL3_To_Verify_Event_Received'access;
   This_Event_Dispatch_Matrix (objVERPOL1, Verify_Event_Received) := objVERPOL1_To_Idle'access;
   This_Event_Dispatch_Matrix (objVERPOL2, Verify_Event_Received) := objVERPOL2_To_Fail'access;
   This_Event_Dispatch_Matrix (objVERPOL3, Verify_Event_Received) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objVERPOL1, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objVERPOL2, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objVERPOL3, Fail) :=  Cannot_Happen_Action'access;

end Root_Object.Events.objVERPOL;
