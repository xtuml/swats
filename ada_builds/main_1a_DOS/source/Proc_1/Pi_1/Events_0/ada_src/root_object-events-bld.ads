...
--* Description:             
--*                          Domain specification Root_Object.EventsBLD
...
--  ----------------------------------  
--  package Root_Object.Events.BLD
...
package Root_Object.Events.BLD is
--
------------------------------------------------------------------------
   --
   --**************  Object Bottom_Level_D Information **************
   --
   -- Object BLD is PASSIVE
   --
   -- Object BLD participates in a super sub type relationship
   --
   --
   --
   -- Object BLD is a SUB type of SL_THREE_A via Relationship R18
   --
   -- Object BLD has an identifying non-referential attribute BLD_Identifier 
   -- and therefore may be uniquely created.
   -- 
   -- Object BLD has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "BLD";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_BLD_Type is new Events_Type with record

      --
      -- Non initialised identifying non referential
      BLD_Identifier : Application_Types.Base_Integer_Type;
   ...
   procedure Put_BLD_Identifier (
      ...
      BLD_Identifier_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_BLD_Identifier);
   pragma inline (Put_BLD_Identifier);
