...
--* Description:             
--*                          Domain body Root_Object.EventsBLD
...
------------------------------------------------------------------------
--
package body Root_Object.Events.BLD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   BLD_Identifier_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_BLD_Identifier return Application_Types.Base_Integer_Type is
   begin
      BLD_Identifier_Value :=
         Application_Types.Base_Integer_Type'succ (BLD_Identifier_Value);
      return BLD_Identifier_Value;
   end Obtain_Subsequent_BLD_Identifier;
...
--ADATEST IGNORE_ON
   function Get_BLD_Identifier (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return Events_BLD_Type (This_Object.all).BLD_Identifier;
   end Get_BLD_Identifier;
...
--ADATEST IGNORE_ON
   procedure Put_BLD_Identifier (
      This_Object : in Root_Object.Object_Access;
      BLD_Identifier_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_BLD_Type (This_Object.all).BLD_Identifier :=
         BLD_Identifier_Value;
   end Put_BLD_Identifier;
...
--ADATEST IGNORE_ON
   function Get_Value_To_Add (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_BLD_Type (This_Object.all).Value_To_Add;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BLD_Type (This_Object.all).Value_To_Add :=
         Value_To_Add_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_BLD_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BLD_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_BLD_Type (This_Object.all).R18_Super;
   end Get_R18_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BLD_Type (This_Object.all).R18_Super :=
         R18_Super_Value;
   end Put_R18_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_BLD_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_BLD_Type(This_Object.all).BLD_Identifier := Application_Types.Base_Integer_Type_First;
         Events_BLD_Type(This_Object.all).Value_To_Add := Application_Types.Base_Integer_Type_First;
         Events_BLD_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_BLD_Type(This_Object.all).BLD_Identifier :=
         Obtain_Subsequent_BLD_Identifier;
