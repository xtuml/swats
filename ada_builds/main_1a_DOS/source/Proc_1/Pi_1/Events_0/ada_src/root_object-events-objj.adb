...
--* Description:             
--*                          Domain body Root_Object.EventsobjJ
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objJ is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   ReferenceJ_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceJ return Application_Types.Base_Integer_Type is
   begin
      ReferenceJ_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceJ_Value);
      return ReferenceJ_Value;
   end Obtain_Subsequent_ReferenceJ;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_objJ_Type (This_Object.all).ReferenceJ;
   end Get_ReferenceJ;
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceJ (
      ...
      ReferenceJ_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objJ_Type (This_Object.all).ReferenceJ :=
         ReferenceJ_Value;
   end Put_ReferenceJ;
...
--ADATEST IGNORE_ON
   function Get_ResultJ (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objJ_Type (This_Object.all).ResultJ;
   end Get_ResultJ;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_ResultJ (
      This_Object : in Root_Object.Object_Access;
      ResultJ_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objJ_Type (This_Object.all).ResultJ :=
         ResultJ_Value;
   end Put_ResultJ;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_action_count (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objJ_Type (This_Object.all).action_count;
...
--ADATEST IGNORE_ON
   procedure Put_action_count (
      This_Object : in Root_Object.Object_Access;
      action_count_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objJ_Type (This_Object.all).action_count :=
         action_count_Value;
   end Put_action_count;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_latest_test (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objJ_Type (This_Object.all).latest_test;
   end Get_latest_test;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objJ_Type (This_Object.all).latest_test :=
         latest_test_Value;
   end Put_latest_test;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objJ_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objJ_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objJ_Type (This_Object.all).R7_Sub;
   end Get_R7_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R7_Sub (
      This_Object : in Root_Object.Object_Access;
      R7_Sub_Value : in Root_Object.Object_Access) is
   begin
      Events_objJ_Type (This_Object.all).R7_Sub :=
         R7_Sub_Value;
   end Put_R7_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objJ_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objJ_Type(This_Object.all).ReferenceJ := Application_Types.Base_Integer_Type_First;
         Events_objJ_Type(This_Object.all).ResultJ := Application_Types.Base_Integer_Type_First;
         Events_objJ_Type(This_Object.all).action_count := Application_Types.Base_Integer_Type_First;
         Events_objJ_Type(This_Object.all).latest_test := Application_Types.Base_Integer_Type_First;
         Events_objJ_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure Events_objJ_4 (
      Test_Number : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_objJ_3 (
      Test_Number : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure objJ1_To_Supertype_state (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_objJ_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objJ.Object_State_Type(Supertype_state);

      Events_objJ_4 (
         Test_Number =>  Events_objJ1(This_Event.all).Test_Number,
         This_Instance => This_Instance );

   end objJ1_To_Supertype_state;
--
   procedure objJ2_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objJ_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objJ.Object_State_Type(Idle);

      Events_objJ_3 (
         Test_Number =>  Events_objJ2(This_Event.all).Test_Number,
         This_Instance => This_Instance );
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_objJ_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_objJ_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objJ_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_objJ_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_objJ_Event_Queue.Queue_Length (Events_objJ_Queue);
...
--
   This_Event_Dispatch_Matrix (objJ1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objJ2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objJ1, Idle) := objJ1_To_Supertype_state'access;
   This_Event_Dispatch_Matrix (objJ2, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objJ1, Supertype_state) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objJ2, Supertype_state) := objJ2_To_Idle'access;

end Root_Object.Events.objJ;
