...
--* Description:             
--*                          Domain body Root_Object.EventsBTD
...
------------------------------------------------------------------------
--
package body Root_Object.Events.BTD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idBTD_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idBTD return Application_Types.Base_Integer_Type is
   begin
      idBTD_Value :=
         Application_Types.Base_Integer_Type'succ (idBTD_Value);
      return idBTD_Value;
   end Obtain_Subsequent_idBTD;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_BTD_Type (This_Object.all).idBTD;
   end Get_idBTD;
...
--ADATEST IGNORE_ON
   procedure Put_idBTD (
      ...
      idBTD_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_BTD_Type (This_Object.all).idBTD :=
         idBTD_Value;
   end Put_idBTD;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_BTD_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BTD_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_BTD_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_BTD_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_BTD_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_BTD_Type(This_Object.all).idBTD := Application_Types.Base_Integer_Type_First;
         Events_BTD_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
         Events_BTD_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure Events_BTD_4 (
      Test : in Application_Types.Base_Integer_Type;
      Test_Number : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_BTD_5 (
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_BTD_3 (
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure BTD5_To_Termination_state (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_BTD_Type (This_Instance.all).Current_State := 
         Root_Object.Events.BTD.Object_State_Type(Termination_state);

      Events_BTD_2 (
         Test =>  Events_BTD5(This_Event.all).Test,
         Test_Number =>  Events_BTD5(This_Event.all).Test_Number,
         This_Instance => This_Instance );

   end BTD5_To_Termination_state;
--
   procedure BTD3_To_Verify_Tests (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_BTD_Type (This_Instance.all).Current_State := 
         Root_Object.Events.BTD.Object_State_Type(Verify_Tests);

      Events_BTD_4 (
         Test =>  Events_BTD3(This_Event.all).Test,
         Test_Number =>  Events_BTD3(This_Event.all).Test_Number,
         This_Instance => This_Instance );

   end BTD3_To_Verify_Tests;
--
   procedure BTD1_To_Fail (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_BTD_Type (This_Instance.all).Current_State := 
         Root_Object.Events.BTD.Object_State_Type(Fail);
...
--
   ...
   begin
      ...
      Events_BTD_Type (This_Instance.all).Current_State := 
         Root_Object.Events.BTD.Object_State_Type(Idle);
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_BTD_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_BTD_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_BTD_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_BTD_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_BTD_Event_Queue.Queue_Length (Events_BTD_Queue);
...
--
   This_Event_Dispatch_Matrix (BTD1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BTD2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BTD3, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BTD5, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BTD1, Creation_state) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BTD2, Creation_state) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BTD3, Creation_state) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BTD5, Creation_state) := BTD5_To_Termination_state'access;
   This_Event_Dispatch_Matrix (BTD1, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BTD2, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BTD3, Idle) := BTD3_To_Verify_Tests'access;
   This_Event_Dispatch_Matrix (BTD5, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BTD1, Verify_Tests) := BTD1_To_Fail'access;
   This_Event_Dispatch_Matrix (BTD2, Verify_Tests) := BTD2_To_Idle'access;
   This_Event_Dispatch_Matrix (BTD3, Verify_Tests) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BTD5, Verify_Tests) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BTD1, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BTD2, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BTD3, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (BTD5, Fail) :=  Cannot_Happen_Action'access;

end Root_Object.Events.BTD;
