...
--* Description:             
--*                          Domain body Root_Object.EventsobjQ
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objQ is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objQ_Type (This_Object.all).Reference_P;
   end Get_Reference_P;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Reference_P (
      ...
      Reference_P_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objQ_Type (This_Object.all).Reference_P :=
         Reference_P_Value;
   end Put_Reference_P;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Value_To_Add (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objQ_Type (This_Object.all).Value_To_Add;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objQ_Type (This_Object.all).Value_To_Add :=
         Value_To_Add_Value;
...
--ADATEST IGNORE_ON
   function Get_latest_test (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objQ_Type (This_Object.all).latest_test;
   end Get_latest_test;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objQ_Type (This_Object.all).latest_test :=
         latest_test_Value;
   end Put_latest_test;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Result_Q (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objQ_Type (This_Object.all).Result_Q;
   end Get_Result_Q;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Result_Q (
      This_Object : in Root_Object.Object_Access;
      Result_Q_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objQ_Type (This_Object.all).Result_Q :=
         Result_Q_Value;
   end Put_Result_Q;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objQ_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objQ_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   procedure Put_R4_Super (
      This_Object : in  Root_Object.Object_Access;
      R4_Super_Value : in Root_Object.Object_Access) is
   begin
      Events_objQ_Type (This_Object.all).R4_Super :=
         R4_Super_Value;
   end Put_R4_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objQ_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objQ_Type(This_Object.all).Reference_P := Application_Types.Base_Integer_Type_First;
         Events_objQ_Type(This_Object.all).Value_To_Add := Application_Types.Base_Integer_Type_First;
         Events_objQ_Type(This_Object.all).latest_test := Application_Types.Base_Integer_Type_First;
         Events_objQ_Type(This_Object.all).Result_Q := Application_Types.Base_Integer_Type_First;
         Events_objQ_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
----------------------------------------------------------------------------
   ...
   procedure Polymorphic_Put (
      This_Object : in out Events_objQ_Type;
      This_Event  : in     Root_Object.Root_Event_Access_Type) is

      Parent_Event_Type : Root_Object.Events.objP.Event_Class;
      Next_Event        : Root_Object.Root_Event_Access_Type;

   begin

      Parent_Event_Type := Root_Object.Events.objP.Events_objP_Event_Type(This_Event.all).This_Event_Class;

      case Parent_Event_Type is

         when Root_Object.Events.objP.objP1 =>

            Next_Event := new Root_Object.Events.objQ.Events_objP1'(
            Root_Event_Type with
               Test =>
                  Root_Object.Events.objP.Events_objP1(This_Event.all).Test,
               This_Event_Class => Root_Object.Events.objQ.objP1,
               Target_Instance  => This_Object'Unchecked_Access);

         when Root_Object.Events.objP.objP2 =>

            Next_Event := new Root_Object.Events.objQ.Events_objP2'(
            Root_Event_Type with
               Test =>
                  Root_Object.Events.objP.Events_objP2(This_Event.all).Test,
               This_Event_Class => Root_Object.Events.objQ.objP2,
               Target_Instance  => This_Object'Unchecked_Access);


         when Root_Object.Events.objP.Class_Event =>
...
--
   ...
   procedure Events_objQ_2 (
      Test : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_objQ_1 (
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure objP1_To_Subtype_State (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_objQ_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objQ.Object_State_Type(Subtype_State);

      Events_objQ_2 (
         Test =>  Events_objP1(This_Event.all).Test,
         This_Instance => This_Instance );

   end objP1_To_Subtype_State;
--
   procedure objQ1_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_objQ_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objQ.Object_State_Type(Idle);
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_objQ_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_objQ_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objQ_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_objQ_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_objQ_Event_Queue.Queue_Length (Events_objQ_Queue);
...
--
   This_Event_Dispatch_Matrix (objP1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objP2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objQ1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objP1, Idle) := objP1_To_Subtype_State'access;
   This_Event_Dispatch_Matrix (objP2, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objQ1, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objP1, Subtype_State) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objP2, Subtype_State) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objQ1, Subtype_State) := objQ1_To_Idle'access;

end Root_Object.Events.objQ;
