...
--* Description:             
--*                          Domain body Root_Object.EventsobjA
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objA is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_objA_Type (This_Object.all).ReferenceA;
   end Get_ReferenceA;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objA_Type (This_Object.all).ReferenceA :=
         ReferenceA_Value;
   end Put_ReferenceA;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objA_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objA_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_latest_test (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objA_Type (This_Object.all).latest_test;
   end Get_latest_test;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objA_Type (This_Object.all).latest_test :=
         latest_test_Value;
   end Put_latest_test;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objA_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objA_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objA_Type (This_Object.all).R1_Sub;
   end Get_R1_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R1_Sub (
      This_Object : in Root_Object.Object_Access;
      R1_Sub_Value : in Root_Object.Object_Access) is
   begin
      Events_objA_Type (This_Object.all).R1_Sub :=
         R1_Sub_Value;
   end Put_R1_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objA_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objA_Type(This_Object.all).ReferenceA := Application_Types.Base_Integer_Type_First;
         Events_objA_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
         Events_objA_Type(This_Object.all).latest_test := Application_Types.Base_Integer_Type_First;
         Events_objA_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure Events_objA_1 (
      Test_Number : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure objA1_To_Supertype_Object (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_objA_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objA.Object_State_Type(Supertype_Object);

      Events_objA_2 (
         Test =>  Events_objA1(This_Event.all).Test,
         Test_Number =>  Events_objA1(This_Event.all).Test_Number,
         This_Instance => This_Instance );

   end objA1_To_Supertype_Object;
--
   ...
   begin
      ...
      Events_objA_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objA.Object_State_Type(Idle);

      Events_objA_1 (
         Test_Number =>  Events_objA2(This_Event.all).Test_Number,
         This_Instance => This_Instance );
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_objA_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_objA_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objA_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_objA_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_objA_Event_Queue.Queue_Length (Events_objA_Queue);
...
--
   ...
   This_Event_Dispatch_Matrix (objA1, Idle) := objA1_To_Supertype_Object'access;
   This_Event_Dispatch_Matrix (objA2, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objA1, Supertype_Object) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objA2, Supertype_Object) := objA2_To_Idle'access;

end Root_Object.Events.objA;
