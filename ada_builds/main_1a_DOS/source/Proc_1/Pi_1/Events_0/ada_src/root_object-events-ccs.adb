...
--* Description:             
--*                          Domain body Root_Object.EventsCCS
...
------------------------------------------------------------------------
--
package body Root_Object.Events.CCS is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   ccs_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ccs_id return Application_Types.Base_Integer_Type is
   begin
      ccs_id_Value :=
         Application_Types.Base_Integer_Type'succ (ccs_id_Value);
      return ccs_id_Value;
   end Obtain_Subsequent_ccs_id;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_CCS_Type (This_Object.all).ccs_id;
   end Get_ccs_id;
...
--ADATEST IGNORE_ON
   procedure Put_ccs_id (
      This_Object : in Root_Object.Object_Access;
      ccs_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_CCS_Type (This_Object.all).ccs_id :=
         ccs_id_Value;
   end Put_ccs_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_CCS_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_CCS_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_CCS_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_CCS_Type(This_Object.all).ccs_id := Application_Types.Base_Integer_Type_First;
         Events_CCS_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   procedure CCS1_To_Check (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_CCS_Type (This_Instance.all).Current_State := 
         Root_Object.Events.CCS.Object_State_Type(Check);

      Events_CCS_2 (
         Test_No =>  Events_CCS1(This_Event.all).Test_No,
         Which_Test =>  Events_CCS1(This_Event.all).Which_Test,
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_CCS_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_CCS_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_CCS_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_CCS_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_CCS_Event_Queue.Queue_Length (Events_CCS_Queue);
...
--
   This_Event_Dispatch_Matrix (CCS1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (CCS1, Check) := CCS1_To_Check'access;

end Root_Object.Events.CCS;
