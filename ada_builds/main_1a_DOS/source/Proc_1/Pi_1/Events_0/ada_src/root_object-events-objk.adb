...
--* Description:             
--*                          Domain body Root_Object.EventsobjK
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objK is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objK_Type (This_Object.all).ResultK;
   end Get_ResultK;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_ResultK (
      ...
      ResultK_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objK_Type (This_Object.all).ResultK :=
         ResultK_Value;
   end Put_ResultK;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_ReferenceK (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objK_Type (This_Object.all).ReferenceK;
   end Get_ReferenceK;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceK (
      This_Object : in Root_Object.Object_Access;
      ReferenceK_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objK_Type (This_Object.all).ReferenceK :=
         ReferenceK_Value;
   end Put_ReferenceK;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_ReferenceJ (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objK_Type (This_Object.all).ReferenceJ;
   end Get_ReferenceJ;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objK_Type (This_Object.all).ReferenceJ :=
         ReferenceJ_Value;
   end Put_ReferenceJ;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objK_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objK_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objK_Type (This_Object.all).R7_Super;
   end Get_R7_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objK_Type (This_Object.all).R7_Super :=
         R7_Super_Value;
   end Put_R7_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objK_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objK_Type(This_Object.all).ResultK := Application_Types.Base_Integer_Type_First;
         Events_objK_Type(This_Object.all).ReferenceK := Application_Types.Base_Integer_Type_First;
         Events_objK_Type(This_Object.all).ReferenceJ := Application_Types.Base_Integer_Type_First;
         Events_objK_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
----------------------------------------------------------------------------
   ...
   procedure Polymorphic_Put (
      ...
      Parent_Event_Type : Root_Object.Events.objJ.Event_Class;
      Next_Event        : Root_Object.Root_Event_Access_Type;

   begin

      Parent_Event_Type := Root_Object.Events.objJ.Events_objJ_Event_Type(This_Event.all).This_Event_Class;

      case Parent_Event_Type is

         when Root_Object.Events.objJ.objJ1 =>

            Next_Event := new Root_Object.Events.objK.Events_objJ1'(
            Root_Event_Type with
               Test_Number =>
                  Root_Object.Events.objJ.Events_objJ1(This_Event.all).Test_Number,
               This_Event_Class => Root_Object.Events.objK.objJ1,
               Target_Instance  => This_Object'Unchecked_Access);

         when Root_Object.Events.objJ.objJ2 =>

            Next_Event := new Root_Object.Events.objK.Events_objJ2'(
            Root_Event_Type with
               Test_Number =>
                  Root_Object.Events.objJ.Events_objJ2(This_Event.all).Test_Number,
               This_Event_Class => Root_Object.Events.objK.objJ2,
               Target_Instance  => This_Object'Unchecked_Access);


         when Root_Object.Events.objJ.Class_Event =>
...
--
   ...
   procedure Events_objK_1 (
      Test_Number : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure objK1_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_objK_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objK.Object_State_Type(Idle);

      Events_objK_1 (
         Test_Number =>  Events_objK1(This_Event.all).Test_Number,
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objK_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_objK_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_objK_Event_Queue.Queue_Length (Events_objK_Queue);
...
--
   ...
   This_Event_Dispatch_Matrix (objK1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objJ1, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objJ2, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objK1, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objJ1, Sub_Super_state) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objJ2, Sub_Super_state) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objK1, Sub_Super_state) := objK1_To_Idle'access;
