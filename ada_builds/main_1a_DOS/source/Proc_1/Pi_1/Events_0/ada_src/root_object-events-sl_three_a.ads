...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.SL_THREE_A.ads
...
--* Description:             
--*                          Domain specification Root_Object.EventsSL_THREE_A
...
--  ----------------------------------  
--  package Root_Object.Events.SL_THREE_A
...
package Root_Object.Events.SL_THREE_A is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_Level_3_A Information **************
   --
   -- Object SL_THREE_A is PASSIVE
   --
   -- Object SL_THREE_A participates in a super sub type relationship
   --
   --
   --
   -- Object SL_THREE_A is a SUPER type of 
   --    BLA,
   --    BLB
   --    via Relationship R15
   --
   -- Object SL_THREE_A is a SUPER type of 
   --    BLF,
   --    BLE,
   --    BLD,
   --    BLC
   --    via Relationship R18
   --
   -- Object SL_THREE_A is a SUPER type of 
   --    BLG,
   --    BLH
   --    via Relationship R19
   --
   -- Object SL_THREE_A is a SUB type of SL_TWO_A via Relationship R12
   --
   -- Object SL_THREE_A has an identifying non-referential attribute SL3A_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object SL_THREE_A has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "SL_THREE_A";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_SL_THREE_A_Type is new Events_Type with record

      --
      -- Non initialised identifying non referential
      SL3A_id : Application_Types.Base_Integer_Type;

      --
      -- Non Identifying referential. Thou Shalt Not Use. 
      -- SL2A_id : Application_Types.Base_Integer_Type;
   
      --
      -- Initialised Non identifying non referential
      Current_State :  Object_State_Type :=  Object_State_Type_First;

      R15_Sub : Root_Object.Object_Access := null;
      R18_Sub : Root_Object.Object_Access := null;
      R19_Sub : Root_Object.Object_Access := null;
      R12_Super : Root_Object.Object_Access := null;
   ...
   function Get_SL3A_id (
      This_Object : Root_Object.Object_Access) 
   return Application_Types.Base_Integer_Type;

   procedure Put_SL3A_id (
      This_Object : in Root_Object.Object_Access;
      SL3A_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_SL3A_id);
   pragma inline (Put_SL3A_id);
   ...
   function  Get_R15_Sub (
      This_Object : Root_Object.Object_Access) 
   return Root_Object.Object_Access;

   procedure Put_R15_Sub (
      This_Object :   in  Root_Object.Object_Access;
      R15_Sub_Value : in Root_Object.Object_Access);

   pragma inline (Get_R15_Sub);
   pragma inline (Put_R15_Sub);


   function  Get_R18_Sub (
      This_Object : Root_Object.Object_Access) 
   return Root_Object.Object_Access;

   procedure Put_R18_Sub (
      This_Object :   in  Root_Object.Object_Access;
      R18_Sub_Value : in Root_Object.Object_Access);

   pragma inline (Get_R18_Sub);
   pragma inline (Put_R18_Sub);


   function  Get_R19_Sub (
      This_Object : Root_Object.Object_Access) 
   return Root_Object.Object_Access;

   procedure Put_R19_Sub (
      This_Object :   in  Root_Object.Object_Access;
      R19_Sub_Value : in Root_Object.Object_Access);

   pragma inline (Get_R19_Sub);
   pragma inline (Put_R19_Sub);


   function  Get_R12_Super (
      This_Object : Root_Object.Object_Access) 
   return Root_Object.Object_Access;

   procedure Put_R12_Super (
      This_Object : in  Root_Object.Object_Access;
      R12_Super_Value : in Root_Object.Object_Access);

   pragma inline (Get_R12_Super);
   pragma inline (Put_R12_Super);
   ...
   --
   type Events_SL_THREE_A_Event_Type is new Events_Event_Type with
   record
      This_Event_Class : Event_Class;
   end record;

   procedure Event_Action (
      Dispatch_Event : in     Events_SL_THREE_A_Event_Type;
      This_Event     : in out Root_Object.Root_Event_Access_Type);


   --    
   type Events_SL_THREE_A_Instance_Event_Type is new Events_SL_THREE_A_Event_Type with
   record
   ...
   -- 
   procedure Event_Action (
      Dispatch_Event : in     Events_SL_THREE_A_Instance_Event_Type;
      This_Event     : in out Root_Object.Root_Event_Access_Type);



   ------------------------------------------------------------------------
   type Events_SL_THREE_A_Description_Event is new Events_SL_THREE_A_Instance_Event_Type with
   record
      null;
   end record;
   --
   ...
   --
   --
   type Events_SL_THREE_A1 is new Events_SL_THREE_A_Instance_Event_Type with
   record 
      null;
   end record;

end Root_Object.Events.SL_THREE_A;
