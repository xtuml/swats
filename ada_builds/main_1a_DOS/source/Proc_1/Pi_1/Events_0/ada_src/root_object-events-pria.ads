...
--* Description:             
--*                          Domain specification Root_Object.EventsPriA
...
--  ----------------------------------  
--  package Root_Object.Events.PriA
...
package Root_Object.Events.PriA is
--
------------------------------------------------------------------------
   --
   --**************  Object Priority_A Information **************
   --
   -- Object PriA is ACTIVE
   --
   -- Object PriA participates in a super sub type relationship
   --
   --
   --
   -- Object PriA is ACTIVE and has the following state actions defined
   --   Non_Existent,
   --   Idle,
   --   Check_Priority.
   --
   -- Object PriA is a SUPER type of 
   --    PriB
   --    via Relationship R20
   --
   -- Object PriA has an identifying non-referential attribute A_ID 
   -- and therefore may be uniquely created.
   -- 
   -- Object PriA has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "PriA";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_PriA_Type is new Events_Type with record

      --
      -- Non initialised identifying non referential
      A_ID : Application_Types.Base_Integer_Type;

      --
      -- Initialised Non identifying non referential
      RefA : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      Event_Count : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      Done_It :  Boolean := Application_Types.Boolean_First;

      --
      -- Initialised Non identifying non referential
      Poly_A :  Boolean := Application_Types.Boolean_First;

      --
      -- Initialised Non identifying non referential
      Poly_B :  Boolean := Application_Types.Boolean_First;

      --
      -- Initialised Non identifying non referential
      Current_State :  Object_State_Type :=  Object_State_Type_First;

      R20_Sub : Root_Object.Object_Access := null;
   ...
   procedure Put_A_ID (
      ...
      A_ID_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_A_ID);
   pragma inline (Put_A_ID);
   ...
   procedure Put_RefA (
      This_Object : in Root_Object.Object_Access;
      RefA_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_RefA);
   pragma inline (Put_RefA);
   ...
   procedure Put_Event_Count (
      This_Object : in Root_Object.Object_Access;
      Event_Count_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Event_Count);
   pragma inline (Put_Event_Count);
   ...
   procedure Put_Done_It (
      This_Object : in Root_Object.Object_Access;
      Done_It_Value : in  Boolean);

   pragma inline (Get_Done_It);
   pragma inline (Put_Done_It);
   ...
   procedure Put_Poly_A (
      This_Object : in Root_Object.Object_Access;
      Poly_A_Value : in  Boolean);

   pragma inline (Get_Poly_A);
   pragma inline (Put_Poly_A);
   ...
   procedure Put_Poly_B (
      This_Object : in Root_Object.Object_Access;
      Poly_B_Value : in  Boolean);

   pragma inline (Get_Poly_B);
   pragma inline (Put_Poly_B);
   ...
   procedure Put_R20_Sub (
      This_Object :   in  Root_Object.Object_Access;
      R20_Sub_Value : in Root_Object.Object_Access);

   pragma inline (Get_R20_Sub);
   pragma inline (Put_R20_Sub);
   ...
   -- EVENT DECLARATION
   --
   type Events_PriA_Event_Type is new Events_Event_Type with
   record
   ...
   --    
   type Events_PriA_Instance_Event_Type is new Events_PriA_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type Events_PriA_Description_Event is new Events_PriA_Instance_Event_Type with
   record
      null;
   end record;  
   --
   ...
   type Events_PriA1 is new Events_PriA_Instance_Event_Type with
   record 
      Test_No : Application_Types.Base_Integer_Type;
      Index : Application_Types.Base_Integer_Type;
   end record;

   type Events_PriA2 is new Events_PriA_Instance_Event_Type with
   record 
      Test_No : Application_Types.Base_Integer_Type;
   end record;

   type Events_PriA3 is new Events_PriA_Instance_Event_Type with
   record 
      Test_No : Application_Types.Base_Integer_Type;
      Index : Application_Types.Base_Integer_Type;
   end record;
   ...
   package Events_PriA_Event_Queue is new Generic_FIFO (Root_Object.Root_Event_Access_Type); 

   Events_PriA_Queue: Events_PriA_Event_Queue.FIFO_Type;
