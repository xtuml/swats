...
--* Description:             
--*                          Domain body Root_Object.EventsETS
...
------------------------------------------------------------------------
--
package body Root_Object.Events.ETS is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idETS_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idETS return Application_Types.Base_Integer_Type is
   begin
      idETS_Value :=
         Application_Types.Base_Integer_Type'succ (idETS_Value);
      return idETS_Value;
   end Obtain_Subsequent_idETS;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Events_ETS_Type (This_Object.all).idETS;
   end Get_idETS;
...
--ADATEST IGNORE_ON
   procedure Put_idETS (
      ...
      idETS_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_ETS_Type (This_Object.all).idETS :=
         idETS_Value;
   end Put_idETS;
...
--ADATEST IGNORE_ON
   function Get_NewResult (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_ETS_Type (This_Object.all).NewResult;
   end Get_NewResult;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_NewResult (
      This_Object : in Root_Object.Object_Access;
      NewResult_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_ETS_Type (This_Object.all).NewResult :=
         NewResult_Value;
   end Put_NewResult;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_OldResult (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_ETS_Type (This_Object.all).OldResult;
   end Get_OldResult;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_OldResult (
      This_Object : in Root_Object.Object_Access;
      OldResult_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_ETS_Type (This_Object.all).OldResult :=
         OldResult_Value;
   end Put_OldResult;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_ETS_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_ETS_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_ETS_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_ETS_Type(This_Object.all).idETS := Application_Types.Base_Integer_Type_First;
         Events_ETS_Type(This_Object.all).NewResult := Application_Types.Base_Integer_Type_First;
         Events_ETS_Type(This_Object.all).OldResult := Application_Types.Base_Integer_Type_First;
         Events_ETS_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure Events_ETS_2 (
      Test : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_ETS_4 (
      Test : in Application_Types.Base_Integer_Type;
      Test_Number : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_ETS_3 (
      Test : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_ETS_1 (
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Events_ETS_5 (
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure ETS3_To_State_One (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Events_ETS_Type (This_Instance.all).Current_State := 
         Root_Object.Events.ETS.Object_State_Type(State_One);

      Events_ETS_2 (
         Test =>  Events_ETS3(This_Event.all).Test,
         This_Instance => This_Instance );

   end ETS3_To_State_One;
--
   procedure ETS5_To_Verify_event_to_self (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_ETS_Type (This_Instance.all).Current_State := 
         Root_Object.Events.ETS.Object_State_Type(Verify_event_to_self);

      Events_ETS_4 (
         Test =>  Events_ETS5(This_Event.all).Test,
         Test_Number =>  Events_ETS5(This_Event.all).Test_Number,
         This_Instance => This_Instance );

   end ETS5_To_Verify_event_to_self;
--
   procedure ETS4_To_State_Two (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_ETS_Type (This_Instance.all).Current_State := 
         Root_Object.Events.ETS.Object_State_Type(State_Two);

      Events_ETS_3 (
         Test =>  Events_ETS4(This_Event.all).Test,
         This_Instance => This_Instance );

   end ETS4_To_State_Two;
--
   procedure ETS2_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Events_ETS_Type (This_Instance.all).Current_State := 
         Root_Object.Events.ETS.Object_State_Type(Idle);
...
--
   ...
   begin
      ...
      Events_ETS_Type (This_Instance.all).Current_State := 
         Root_Object.Events.ETS.Object_State_Type(Fail);
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_ETS_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_ETS_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_ETS_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_ETS_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_ETS_Event_Queue.Queue_Length (Events_ETS_Queue);
...
--
   This_Event_Dispatch_Matrix (ETS1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS3, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS4, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS5, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS1, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS2, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS3, Idle) := ETS3_To_State_One'access;
   This_Event_Dispatch_Matrix (ETS4, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS5, Idle) := ETS5_To_Verify_event_to_self'access;
   This_Event_Dispatch_Matrix (ETS1, State_One) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS2, State_One) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS3, State_One) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS4, State_One) := ETS4_To_State_Two'access;
   This_Event_Dispatch_Matrix (ETS5, State_One) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS1, State_Two) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS2, State_Two) := ETS2_To_Idle'access;
   This_Event_Dispatch_Matrix (ETS3, State_Two) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS4, State_Two) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS5, State_Two) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS1, Verify_event_to_self) := ETS1_To_Fail'access;
   This_Event_Dispatch_Matrix (ETS2, Verify_event_to_self) := ETS2_To_Idle'access;
   This_Event_Dispatch_Matrix (ETS3, Verify_event_to_self) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS4, Verify_event_to_self) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS5, Verify_event_to_self) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS1, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS2, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS3, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS4, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ETS5, Fail) :=  Cannot_Happen_Action'access;

end Root_Object.Events.ETS;
