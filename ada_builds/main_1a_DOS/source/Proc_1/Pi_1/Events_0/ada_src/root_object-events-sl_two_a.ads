...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Events.SL_TWO_A.ads
...
--* Description:             
--*                          Domain specification Root_Object.EventsSL_TWO_A
...
--  ----------------------------------  
--  package Root_Object.Events.SL_TWO_A
...
package Root_Object.Events.SL_TWO_A is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_Level_2_A Information **************
   --
   -- Object SL_TWO_A is PASSIVE
   --
   -- Object SL_TWO_A participates in a super sub type relationship
   --
   --
   --
   -- Object SL_TWO_A is a SUPER type of 
   --    SL_THREE_A,
   --    SL_THREE_B
   --    via Relationship R12
   --
   -- Object SL_TWO_A is a SUB type of SL_ONE_A via Relationship R10
   --
   -- Object SL_TWO_A has an identifying non-referential attribute SL2A_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object SL_TWO_A has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "SL_TWO_A";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Events_SL_TWO_A_Type is new Events_Type with record
      ...
      R12_Sub : Root_Object.Object_Access := null;
      R10_Super : Root_Object.Object_Access := null;
   ...
   procedure Put_SL2A_id (
      This_Object : in Root_Object.Object_Access;
      SL2A_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_SL2A_id);
   pragma inline (Put_SL2A_id);
   ...
   function  Get_R12_Sub (
      This_Object : Root_Object.Object_Access) 
   return Root_Object.Object_Access;

   procedure Put_R12_Sub (
      This_Object :   in  Root_Object.Object_Access;
      R12_Sub_Value : in Root_Object.Object_Access);

   pragma inline (Get_R12_Sub);
   pragma inline (Put_R12_Sub);


   function  Get_R10_Super (
      This_Object : Root_Object.Object_Access) 
   return Root_Object.Object_Access;

   procedure Put_R10_Super (
      This_Object : in  Root_Object.Object_Access;
      R10_Super_Value : in Root_Object.Object_Access);

   pragma inline (Get_R10_Super);
   pragma inline (Put_R10_Super);
   ...
   --
   type Events_SL_TWO_A_Event_Type is new Events_Event_Type with
   record
      This_Event_Class : Event_Class;
   end record;

   procedure Event_Action (
      Dispatch_Event : in     Events_SL_TWO_A_Event_Type;
      This_Event     : in out Root_Object.Root_Event_Access_Type);


   --    
   type Events_SL_TWO_A_Instance_Event_Type is new Events_SL_TWO_A_Event_Type with
   record
   ...
   -- 
   procedure Event_Action (
      Dispatch_Event : in     Events_SL_TWO_A_Instance_Event_Type;
      This_Event     : in out Root_Object.Root_Event_Access_Type);



   ------------------------------------------------------------------------
   type Events_SL_TWO_A_Description_Event is new Events_SL_TWO_A_Instance_Event_Type with
   record
      null;
   end record;
   --
...
end Root_Object.Events.SL_TWO_A;
