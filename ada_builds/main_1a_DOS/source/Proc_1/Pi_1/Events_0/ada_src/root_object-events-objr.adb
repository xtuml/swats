...
--* Description:             
--*                          Domain body Root_Object.EventsobjR
...
------------------------------------------------------------------------
--
package body Root_Object.Events.objR is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objR_Type (This_Object.all).Reference_P;
   end Get_Reference_P;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objR_Type (This_Object.all).Reference_P :=
         Reference_P_Value;
   end Put_Reference_P;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Value_To_Add (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objR_Type (This_Object.all).Value_To_Add;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objR_Type (This_Object.all).Value_To_Add :=
         Value_To_Add_Value;
...
--ADATEST IGNORE_ON
   function Get_latest_test (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objR_Type (This_Object.all).latest_test;
   end Get_latest_test;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objR_Type (This_Object.all).latest_test :=
         latest_test_Value;
   end Put_latest_test;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Result_R (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Events_objR_Type (This_Object.all).Result_R;
   end Get_Result_R;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Result_R (
      This_Object : in Root_Object.Object_Access;
      Result_R_Value : in Application_Types.Base_Integer_Type) is
   begin
      Events_objR_Type (This_Object.all).Result_R :=
         Result_R_Value;
   end Put_Result_R;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objR_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objR_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Events_objR_Type (This_Object.all).R4_Super;
   end Get_R4_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Events_objR_Type (This_Object.all).R4_Super :=
         R4_Super_Value;
   end Put_R4_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Events_objR_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Events_objR_Type(This_Object.all).Reference_P := Application_Types.Base_Integer_Type_First;
         Events_objR_Type(This_Object.all).Value_To_Add := Application_Types.Base_Integer_Type_First;
         Events_objR_Type(This_Object.all).latest_test := Application_Types.Base_Integer_Type_First;
         Events_objR_Type(This_Object.all).Result_R := Application_Types.Base_Integer_Type_First;
         Events_objR_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
----------------------------------------------------------------------------
   ...
   procedure Polymorphic_Put (
      This_Object : in out Events_objR_Type;
...
--
   ...
   begin
      ...
      Events_objR_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objR.Object_State_Type(Subtype_State);
...
--
   ...
   begin
      ...
      Events_objR_Type (This_Instance.all).Current_State := 
         Root_Object.Events.objR.Object_State_Type(Idle);
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Events_objR_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Events_objR_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Events_objR_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Events_objR_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Events_objR_Event_Queue.Queue_Length (Events_objR_Queue);
...
--
   ...
   This_Event_Dispatch_Matrix (objR1, Non_Existent) :=  Cannot_Happen_Action'access;
   ...
   This_Event_Dispatch_Matrix (objR1, Idle) :=  Ignore_Action'access;
   ...
   This_Event_Dispatch_Matrix (objR1, Subtype_State) := objR1_To_Idle'access;

end Root_Object.Events.objR;
