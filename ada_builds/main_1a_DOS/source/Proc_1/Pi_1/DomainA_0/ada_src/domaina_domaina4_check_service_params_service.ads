...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainA4_Check_Service_Params_Service.ads
...
package DomainA_DomainA4_Check_Service_Params_Service is
   ...
   procedure DomainA_DomainA4_Check_Service_Params (
      ...
      The_Returning_Val :    out Application_Types.Base_Integer_Type);
   
end DomainA_DomainA4_Check_Service_Params_Service;

--
-- End of file DomainA_DomainA4_Check_Service_Params_Service.ads
--
