...
separate(Root_Object.DomainA.objA)
   ...
   procedure DomainA_objA_6 (Test          : in     Application_Types.Base_Integer_Type;
   ...
   begin
      ...
      if has_failed =  False then
         ...
         Root_Object.DomainA.objA.DomainA_objA_type(This_Instance.all).ResultA := 20;
...
--
-- End of file DomainA_objA_6.ada
--
