...
--* Description:             
--*                          Domain body Root_Object.DomainAotols
...
------------------------------------------------------------------------
--
package body Root_Object.DomainA.otols is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   otols_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_otols_id return Application_Types.Base_Integer_Type is
   begin
      otols_id_Value :=
         Application_Types.Base_Integer_Type'succ (otols_id_Value);
      return otols_id_Value;
   end Obtain_Subsequent_otols_id;
...
--ADATEST IGNORE_ON
   procedure Put_otols_id (
      This_Object : in Root_Object.Object_Access;
      otols_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      DomainA_otols_Type (This_Object.all).otols_id :=
         otols_id_Value;
   end Put_otols_id;
...
------------------------------------------------------------------------
   --
   -- procedure Put_otors_id and 
   --
   -- function Get_otors_id
   --
   -- have not been generated for otors_id
...
--ADATEST IGNORE_ON
   ...
   begin
      return DomainA_otols_Type (This_Object.all).R1_B;
   end Get_R1_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainA_otols_Type (This_Object.all).R1_B :=
         R1_B_Value;
   end Put_R1_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new DomainA_otols_Type;
   
      else
         This_Object := Free_List.First_Entry;
         DomainA_otols_Type(This_Object.all).otols_id := Application_Types.Base_Integer_Type_First;
