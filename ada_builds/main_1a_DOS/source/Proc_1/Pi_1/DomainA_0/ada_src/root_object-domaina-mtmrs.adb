...
--* Description:             
--*                          Domain body Root_Object.DomainAmtmrs
...
------------------------------------------------------------------------
--
package body Root_Object.DomainA.mtmrs is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   mtmrs_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_mtmrs_id return Application_Types.Base_Integer_Type is
   begin
      mtmrs_id_Value :=
         Application_Types.Base_Integer_Type'succ (mtmrs_id_Value);
      return mtmrs_id_Value;
   end Obtain_Subsequent_mtmrs_id;
...
--ADATEST IGNORE_ON
   ...
   begin
       return DomainA_mtmrs_Type (This_Object.all).mtmrs_id;
   end Get_mtmrs_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainA_mtmrs_Type (This_Object.all).mtmrs_id :=
         mtmrs_id_Value;
   end Put_mtmrs_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new DomainA_mtmrs_Type;
   
      else
         This_Object := Free_List.First_Entry;
         DomainA_mtmrs_Type(This_Object.all).mtmrs_id := Application_Types.Base_Integer_Type_First;
