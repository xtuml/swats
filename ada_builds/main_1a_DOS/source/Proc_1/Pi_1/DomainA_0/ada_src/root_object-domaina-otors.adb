...
--* Description:             
--*                          Domain body Root_Object.DomainAotors
...
------------------------------------------------------------------------
--
package body Root_Object.DomainA.otors is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   otors_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_otors_id return Application_Types.Base_Integer_Type is
   begin
      otors_id_Value :=
         Application_Types.Base_Integer_Type'succ (otors_id_Value);
      return otors_id_Value;
   end Obtain_Subsequent_otors_id;
...
--ADATEST IGNORE_ON
   ...
   begin
       return DomainA_otors_Type (This_Object.all).otors_id;
   end Get_otors_id;
...
--ADATEST IGNORE_ON
   procedure Put_otors_id (
      This_Object : in Root_Object.Object_Access;
      otors_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      DomainA_otors_Type (This_Object.all).otors_id :=
         otors_id_Value;
   end Put_otors_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      return DomainA_otors_Type (This_Object.all).R1_A;
   end Get_R1_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainA_otors_Type (This_Object.all).R1_A :=
         R1_A_Value;
   end Put_R1_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new DomainA_otors_Type;
   
      else
         This_Object := Free_List.First_Entry;
         DomainA_otors_Type(This_Object.all).otors_id := Application_Types.Base_Integer_Type_First;
