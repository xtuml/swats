...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.DomainA.DOMAIN_A_SUPER.adb
...
--* Description:             
--*                          Domain body Root_Object.DomainADOMAIN_A_SUPER
...
------------------------------------------------------------------------
--
package body Root_Object.DomainA.DOMAIN_A_SUPER is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idSUPER_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idSUPER return Application_Types.Base_Integer_Type is
   begin
      idSUPER_Value :=
         Application_Types.Base_Integer_Type'succ (idSUPER_Value);
      return idSUPER_Value;
   end Obtain_Subsequent_idSUPER;
...
--ADATEST IGNORE_ON
   ...
   begin
       return DomainA_DOMAIN_A_SUPER_Type (This_Object.all).idSUPER;
   end Get_idSUPER;
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainA_DOMAIN_A_SUPER_Type (This_Object.all).idSUPER :=
         idSUPER_Value;
   end Put_idSUPER;
...
--ADATEST IGNORE_ON
   ...
   begin
      return DomainA_DOMAIN_A_SUPER_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainA_DOMAIN_A_SUPER_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return DomainA_DOMAIN_A_SUPER_Type (This_Object.all).R4_Sub;
   end Get_R4_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainA_DOMAIN_A_SUPER_Type (This_Object.all).R4_Sub :=
         R4_Sub_Value;
   end Put_R4_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new DomainA_DOMAIN_A_SUPER_Type;
   
      else
         This_Object := Free_List.First_Entry;
         DomainA_DOMAIN_A_SUPER_Type(This_Object.all).idSUPER := Application_Types.Base_Integer_Type_First;
         DomainA_DOMAIN_A_SUPER_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     DomainA_DOMAIN_A_SUPER_Event_Type;
...
------------------------------------------------------------------------
   procedure Event_Action (
      Dispatch_Event : in     DomainA_DOMAIN_A_SUPER_Instance_Event_Type;
      This_Event     : in out Root_Object.Root_Event_Access_Type) is separate;


end Root_Object.DomainA.DOMAIN_A_SUPER;
