...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.DomainA.DOMAIN_A_SUPER.ads
...
--* Description:             
--*                          Domain specification Root_Object.DomainADOMAIN_A_SUPER
...
--  ----------------------------------  
--  package Root_Object.DomainA.DOMAIN_A_SUPER
...
package Root_Object.DomainA.DOMAIN_A_SUPER is
--
------------------------------------------------------------------------
   --
   --**************  Object Domain_A_Object_Super Information **************
   --
   -- Object DOMAIN_A_SUPER is PASSIVE
   --
   -- Object DOMAIN_A_SUPER participates in a super sub type relationship
   --
   --
   --
   -- Object DOMAIN_A_SUPER is a SUPER type of 
   --    DOMAIN_A_SUBA,
   --    DOMAIN_A_SUBB
   --    via Relationship R4
   --
   -- Object DOMAIN_A_SUPER has an identifying non-referential attribute idSUPER 
   -- and therefore may be uniquely created.
   -- 
   -- Object DOMAIN_A_SUPER has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "DOMAIN_A_SUPER";

   --
   -------------------------------------------------------------------------------------------------
   --

   type DomainA_DOMAIN_A_SUPER_Type is new DomainA_Type with record
   ...
   --
   type DomainA_DOMAIN_A_SUPER_Event_Type is new DomainA_Event_Type with
   record
   ...
   --    
   type DomainA_DOMAIN_A_SUPER_Instance_Event_Type is new DomainA_DOMAIN_A_SUPER_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type DomainA_DOMAIN_A_SUPER_Description_Event is new DomainA_DOMAIN_A_SUPER_Instance_Event_Type with
   record
      null;
   end record;
   --
