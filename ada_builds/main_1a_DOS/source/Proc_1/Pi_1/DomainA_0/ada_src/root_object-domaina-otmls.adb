...
--* Description:             
--*                          Domain body Root_Object.DomainAotmls
...
------------------------------------------------------------------------
--
package body Root_Object.DomainA.otmls is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   otmls_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_otmls_id return Application_Types.Base_Integer_Type is
   begin
      otmls_id_Value :=
         Application_Types.Base_Integer_Type'succ (otmls_id_Value);
      return otmls_id_Value;
   end Obtain_Subsequent_otmls_id;
...
--ADATEST IGNORE_ON
   procedure Put_otmls_id (
      This_Object : in Root_Object.Object_Access;
      otmls_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      DomainA_otmls_Type (This_Object.all).otmls_id :=
         otmls_id_Value;
   end Put_otmls_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      return DomainA_otmls_Type (This_Object.all).R2_B;
   end Get_R2_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainA_otmls_Type (This_Object.all).R2_B :=
         R2_B_Value;
   end Put_R2_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new DomainA_otmls_Type;
   
         DomainA_otmls_Type(This_Object.all).R2_B := Root_Object.Object_List.Initialise;
      else
         This_Object := Free_List.First_Entry;
         DomainA_otmls_Type(This_Object.all).otmls_id := Application_Types.Base_Integer_Type_First;
