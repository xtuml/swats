...
--* Description:             
--*                          Domain body Root_Object.DomainAmtmls
...
------------------------------------------------------------------------
--
package body Root_Object.DomainA.mtmls is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   mtmls_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_mtmls_id return Application_Types.Base_Integer_Type is
   begin
      mtmls_id_Value :=
         Application_Types.Base_Integer_Type'succ (mtmls_id_Value);
      return mtmls_id_Value;
   end Obtain_Subsequent_mtmls_id;
...
--ADATEST IGNORE_ON
   ...
   begin
       return DomainA_mtmls_Type (This_Object.all).mtmls_id;
   end Get_mtmls_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainA_mtmls_Type (This_Object.all).mtmls_id :=
         mtmls_id_Value;
   end Put_mtmls_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new DomainA_mtmls_Type;
   
      else
         This_Object := Free_List.First_Entry;
         DomainA_mtmls_Type(This_Object.all).mtmls_id := Application_Types.Base_Integer_Type_First;
