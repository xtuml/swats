...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainA_domain_types.ads
...
--* Description:             
--*                          DomainA Domain Data Types Package Specification
...
--*  package specification DomainA_Domain_Types 
--*
--*************************************************************************************
--  MODIFICATION RECORD
--  --------------------
...
package DomainA_Domain_Types is
