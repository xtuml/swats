...
--* Description:             
--*                          Domain specification Root_Object.DomainAmtmls
...
--  ----------------------------------  
--  package Root_Object.DomainA.mtmls
...
package Root_Object.DomainA.mtmls is
--
------------------------------------------------------------------------
   --
   --**************  Object Many_To_Many_Left_Side Information **************
   --
   -- Object mtmls is PASSIVE
   --
   --
   --
   -- Object mtmls has an identifying non-referential attribute mtmls_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object mtmls has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "mtmls";

   --
   -------------------------------------------------------------------------------------------------
   --

   type DomainA_mtmls_Type is new DomainA_Type with record
