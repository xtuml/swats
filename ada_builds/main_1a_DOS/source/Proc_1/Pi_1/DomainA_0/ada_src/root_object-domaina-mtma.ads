...
--* Description:             
--*                          Domain specification Root_Object.DomainAmtma
...
--  ----------------------------------  
--  package Root_Object.DomainA.mtma
...
package Root_Object.DomainA.mtma is
--
------------------------------------------------------------------------
   --
   --**************  Object Many_To_Many_Associative Information **************
   --
   -- Object mtma is PASSIVE
   --
   --
   --
   -- Object mtma does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object mtma has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "mtma";

   --
   -------------------------------------------------------------------------------------------------
   --

   type DomainA_mtma_Type is new DomainA_Type with record

      --
      -- Non initialised identifying referential
      mtmls_id : Application_Types.Base_Integer_Type;

      --
      -- Non initialised identifying referential
      mtmrs_id : Application_Types.Base_Integer_Type;

      --
      -- Initialised Non identifying non referential
      mtma_data : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   function Get_mtmls_id (
      This_Object : Root_Object.Object_Access) 
   return Application_Types.Base_Integer_Type;

   procedure Put_mtmls_id (
      This_Object : in Root_Object.Object_Access;
      mtmls_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_mtmls_id);
   pragma inline (Put_mtmls_id);


   function Get_mtmrs_id (
      This_Object : Root_Object.Object_Access) 
   return Application_Types.Base_Integer_Type;

   procedure Put_mtmrs_id (
      This_Object : in Root_Object.Object_Access;
      mtmrs_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_mtmrs_id);
   pragma inline (Put_mtmrs_id);


   function Get_mtma_data (
      This_Object : Root_Object.Object_Access) 
   return Application_Types.Base_Integer_Type;

   procedure Put_mtma_data (
      This_Object : in Root_Object.Object_Access;
      mtma_data_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_mtma_data);
   pragma inline (Put_mtma_data);
