...
--* Description:             
--*                          Domain specification Root_Object.DomainAotors
...
--  ----------------------------------  
--  package Root_Object.DomainA.otors
...
package Root_Object.DomainA.otors is
--
------------------------------------------------------------------------
   --
   --**************  Object One_To_One_Right_Side Information **************
   --
   -- Object otors is PASSIVE
   --
   --
   --
   -- Object otors has an identifying non-referential attribute otors_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object otors has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "otors";

   --
   -------------------------------------------------------------------------------------------------
   --

   type DomainA_otors_Type is new DomainA_Type with record
   ...
   procedure Put_otors_id (
      ...
      otors_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_otors_id);
   pragma inline (Put_otors_id);
