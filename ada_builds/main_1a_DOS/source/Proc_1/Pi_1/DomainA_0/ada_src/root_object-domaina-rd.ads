...
--* Description:             
--*                          Domain specification Root_Object.DomainARD
...
--  ----------------------------------  
--  package Root_Object.DomainA.RD
...
package Root_Object.DomainA.RD is
--
------------------------------------------------------------------------
   --
   ...
   type DomainA_RD_Type is new DomainA_Type with record
