...
--* Description:             
--*                          Domain body Root_Object.DomainAotmrs
...
------------------------------------------------------------------------
--
package body Root_Object.DomainA.otmrs is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   otmrs_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_otmrs_id return Application_Types.Base_Integer_Type is
   begin
      otmrs_id_Value :=
         Application_Types.Base_Integer_Type'succ (otmrs_id_Value);
      return otmrs_id_Value;
   end Obtain_Subsequent_otmrs_id;
...
--ADATEST IGNORE_ON
   procedure Put_otmrs_id (
      This_Object : in Root_Object.Object_Access;
      otmrs_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      DomainA_otmrs_Type (This_Object.all).otmrs_id :=
         otmrs_id_Value;
   end Put_otmrs_id;
...
------------------------------------------------------------------------
   --
   -- procedure Put_otmls_id and 
   --
   -- function Get_otmls_id
   --
   -- have not been generated for otmls_id
...
--ADATEST IGNORE_ON
   ...
   begin
      return DomainA_otmrs_Type (This_Object.all).R2_A;
   end Get_R2_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainA_otmrs_Type (This_Object.all).R2_A :=
         R2_A_Value;
   end Put_R2_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new DomainA_otmrs_Type;
   
      else
         This_Object := Free_List.First_Entry;
         DomainA_otmrs_Type(This_Object.all).otmrs_id := Application_Types.Base_Integer_Type_First;
