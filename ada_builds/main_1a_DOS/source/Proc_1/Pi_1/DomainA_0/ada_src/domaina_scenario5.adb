...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainA_Scenario5.ada
...
with DomainA_NAV2_Shared_Bridge_Navigate_Bridge;
...
use type Root_Object.Object_Access;
   ...
   procedure DomainA_Scenario5 is
   ...
   begin
      ...
      DomainA_NAV2_Shared_Bridge_Navigate_Bridge.DomainA_NAV2_Shared_Bridge_Navigate (
         Test => Test);
   ...
   end DomainA_Scenario5;
   
--
-- End of file DomainA_Scenario5.ada
--
