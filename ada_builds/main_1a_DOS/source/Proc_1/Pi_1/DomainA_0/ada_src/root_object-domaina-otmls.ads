...
--* Description:             
--*                          Domain specification Root_Object.DomainAotmls
...
--  ----------------------------------  
--  package Root_Object.DomainA.otmls
...
package Root_Object.DomainA.otmls is
--
------------------------------------------------------------------------
   --
   --**************  Object One_To_Many_Left_Side Information **************
   --
   -- Object otmls is PASSIVE
   --
   --
   --
   -- Object otmls has an identifying non-referential attribute otmls_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object otmls has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "otmls";

   --
   -------------------------------------------------------------------------------------------------
   --

   type DomainA_otmls_Type is new DomainA_Type with record
      ...
      --
      R2_B : Root_Object.Object_List.List_Header_Access_Type;
   ...
   procedure Put_otmls_id (
      ...
      otmls_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_otmls_id);
   pragma inline (Put_otmls_id);
