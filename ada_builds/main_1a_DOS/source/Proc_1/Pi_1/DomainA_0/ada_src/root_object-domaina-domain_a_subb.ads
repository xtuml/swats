...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.DomainA.DOMAIN_A_SUBB.ads
...
--* Description:             
--*                          Domain specification Root_Object.DomainADOMAIN_A_SUBB
...
--  ----------------------------------  
--  package Root_Object.DomainA.DOMAIN_A_SUBB
...
package Root_Object.DomainA.DOMAIN_A_SUBB is
--
------------------------------------------------------------------------
   --
   --**************  Object Domain_A_Object_SubB Information **************
   --
   -- Object DOMAIN_A_SUBB is PASSIVE
   --
   -- Object DOMAIN_A_SUBB participates in a super sub type relationship
   --
   --
   --
   -- Object DOMAIN_A_SUBB is a SUB type of DOMAIN_A_SUPER via Relationship R4
   --
   -- Object DOMAIN_A_SUBB does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object DOMAIN_A_SUBB has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "DOMAIN_A_SUBB";

   --
   -------------------------------------------------------------------------------------------------
   --

   type DomainA_DOMAIN_A_SUBB_Type is new DomainA_Type with record
