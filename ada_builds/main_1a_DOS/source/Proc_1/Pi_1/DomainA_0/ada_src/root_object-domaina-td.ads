...
--* Description:             
--*                          Domain specification Root_Object.DomainATD
...
--  ----------------------------------  
--  package Root_Object.DomainA.TD
...
package Root_Object.DomainA.TD is
--
------------------------------------------------------------------------
   --
   ...
   type DomainA_TD_Type is new DomainA_Type with record

      --
      -- Initialised Non identifying non referential
      This_Test_Number : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_This_Test_Number (
      ...
      This_Test_Number_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_This_Test_Number);
   pragma inline (Put_This_Test_Number);
