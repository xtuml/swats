...
--* Description:             
--*                          Domain body Root_Object.DomainAobjA
...
------------------------------------------------------------------------
--
package body Root_Object.DomainA.objA is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return DomainA_objA_Type (This_Object.all).idA;
   end Get_idA;
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainA_objA_Type (This_Object.all).idA :=
         idA_Value;
   end Put_idA;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return DomainA_objA_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainA_objA_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return DomainA_objA_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainA_objA_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new DomainA_objA_Type;
   
      else
         This_Object := Free_List.First_Entry;
         DomainA_objA_Type(This_Object.all).idA := Application_Types.Base_Integer_Type_First;
         DomainA_objA_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
         DomainA_objA_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure DomainA_objA_5 (
      Test : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure DomainA_objA_6 (
      Test : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure DomainA_objA_9 (
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure DomainA_objA_4 (
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure objA3_To_Sync_service_invocation_to_sync_service (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      DomainA_objA_Type (This_Instance.all).Current_State := 
         Root_Object.DomainA.objA.Object_State_Type(Sync_service_invocation_to_sync_service);

      DomainA_objA_5 (
         Test =>  DomainA_objA3(This_Event.all).Test,
         This_Instance => This_Instance );

   end objA3_To_Sync_service_invocation_to_sync_service;
--
   procedure objA6_To_Sync_service_invocation_to_event (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      DomainA_objA_Type (This_Instance.all).Current_State := 
         Root_Object.DomainA.objA.Object_State_Type(Sync_service_invocation_to_event);

      DomainA_objA_6 (
         Test =>  DomainA_objA6(This_Event.all).Test,
         This_Instance => This_Instance );

   end objA6_To_Sync_service_invocation_to_event;
--
   procedure objA1_To_Fail (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      DomainA_objA_Type (This_Instance.all).Current_State := 
         Root_Object.DomainA.objA.Object_State_Type(Fail);
...
--
   ...
   begin
      ...
      DomainA_objA_Type (This_Instance.all).Current_State := 
         Root_Object.DomainA.objA.Object_State_Type(Idle);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      DomainA_objA_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => DomainA_objA_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return DomainA_objA_Event_Queue.Queue_Length (DomainA_objA_Queue);
...
--
   This_Event_Dispatch_Matrix (objA1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objA2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objA3, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objA6, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objA1, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objA2, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objA3, Idle) := objA3_To_Sync_service_invocation_to_sync_service'access;
   This_Event_Dispatch_Matrix (objA6, Idle) := objA6_To_Sync_service_invocation_to_event'access;
   This_Event_Dispatch_Matrix (objA1, Sync_service_invocation_to_sync_service) := objA1_To_Fail'access;
   This_Event_Dispatch_Matrix (objA2, Sync_service_invocation_to_sync_service) := objA2_To_Idle'access;
   This_Event_Dispatch_Matrix (objA3, Sync_service_invocation_to_sync_service) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objA6, Sync_service_invocation_to_sync_service) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objA1, Sync_service_invocation_to_event) := objA1_To_Fail'access;
   This_Event_Dispatch_Matrix (objA2, Sync_service_invocation_to_event) := objA2_To_Idle'access;
   This_Event_Dispatch_Matrix (objA3, Sync_service_invocation_to_event) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objA6, Sync_service_invocation_to_event) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objA1, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objA2, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objA3, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objA6, Fail) :=  Cannot_Happen_Action'access;
