...
--* Description:             
--*                          Domain specification Root_Object.DomainAotols
...
--  ----------------------------------  
--  package Root_Object.DomainA.otols
...
package Root_Object.DomainA.otols is
--
------------------------------------------------------------------------
   --
   --**************  Object One_To_One_Left_Side Information **************
   --
   -- Object otols is PASSIVE
   --
   --
   --
   -- Object otols has an identifying non-referential attribute otols_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object otols has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "otols";

   --
   -------------------------------------------------------------------------------------------------
   --

   type DomainA_otols_Type is new DomainA_Type with record

      --
      -- Non initialised identifying non referential
      otols_id : Application_Types.Base_Integer_Type;

      --
      -- Non Identifying referential. Thou Shalt Not Use. 
      -- otors_id : Application_Types.Base_Integer_Type;
   ...
   procedure Put_otols_id (
      ...
      otols_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_otols_id);
   pragma inline (Put_otols_id);
