...
--* Description:             
--*                          Domain specification Root_Object.DomainAmtmrs
...
--  ----------------------------------  
--  package Root_Object.DomainA.mtmrs
...
package Root_Object.DomainA.mtmrs is
--
------------------------------------------------------------------------
   --
   --**************  Object Many_To_Many_Right_Side Information **************
   --
   -- Object mtmrs is PASSIVE
   --
   --
   --
   -- Object mtmrs has an identifying non-referential attribute mtmrs_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object mtmrs has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "mtmrs";

   --
   -------------------------------------------------------------------------------------------------
   --

   type DomainA_mtmrs_Type is new DomainA_Type with record
