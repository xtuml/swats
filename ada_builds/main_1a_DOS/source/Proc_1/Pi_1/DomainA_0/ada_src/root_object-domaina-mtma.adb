...
--* Description:             
--*                          Domain body Root_Object.DomainAmtma
...
------------------------------------------------------------------------
--
package body Root_Object.DomainA.mtma is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return DomainA_mtma_Type (This_Object.all).mtmls_id;
   end Get_mtmls_id;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_mtmls_id (
      ...
      mtmls_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      DomainA_mtma_Type (This_Object.all).mtmls_id :=
         mtmls_id_Value;
   end Put_mtmls_id;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_mtmrs_id (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return DomainA_mtma_Type (This_Object.all).mtmrs_id;
   end Get_mtmrs_id;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_mtmrs_id (
      This_Object : in Root_Object.Object_Access;
      mtmrs_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      DomainA_mtma_Type (This_Object.all).mtmrs_id :=
         mtmrs_id_Value;
   end Put_mtmrs_id;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_mtma_data (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return DomainA_mtma_Type (This_Object.all).mtma_data;
   end Get_mtma_data;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_mtma_data (
      This_Object : in Root_Object.Object_Access;
      mtma_data_Value : in Application_Types.Base_Integer_Type) is
   begin
      DomainA_mtma_Type (This_Object.all).mtma_data :=
         mtma_data_Value;
   end Put_mtma_data;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new DomainA_mtma_Type;
   
      else
         This_Object := Free_List.First_Entry;
         DomainA_mtma_Type(This_Object.all).mtmls_id := Application_Types.Base_Integer_Type_First;
         DomainA_mtma_Type(This_Object.all).mtmrs_id := Application_Types.Base_Integer_Type_First;
         DomainA_mtma_Type(This_Object.all).mtma_data := Application_Types.Base_Integer_Type_First;
