...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.DomainA.DOMAIN_A_SUPER.event_action.ada
...
--*  separate of Root_Object.DomainADOMAIN_A_SUPER
--*     Event_Action
--*
--*************************************************************************************
--  MODIFICATION RECORD
...
separate (Root_Object.DomainA.DOMAIN_A_SUPER)
...
begin
   ...
   This_Action := DomainA_DOMAIN_A_SUPER_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := DomainA_DOMAIN_A_SUPER_Instance_Event_Type(This_Event.all).Target_Instance;
   ...
   if This /= null then
      ...
      --  
      This_Event_Dispatch_Matrix (This_Action, DomainA_DOMAIN_A_SUPER_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
