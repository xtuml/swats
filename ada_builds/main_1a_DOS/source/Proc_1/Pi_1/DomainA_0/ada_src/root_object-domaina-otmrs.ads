...
--* Description:             
--*                          Domain specification Root_Object.DomainAotmrs
...
--  ----------------------------------  
--  package Root_Object.DomainA.otmrs
...
package Root_Object.DomainA.otmrs is
--
------------------------------------------------------------------------
   --
   --**************  Object One_To_Many_Right_Side Information **************
   --
   -- Object otmrs is PASSIVE
   --
   --
   --
   -- Object otmrs has an identifying non-referential attribute otmrs_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object otmrs has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "otmrs";

   --
   -------------------------------------------------------------------------------------------------
   --

   type DomainA_otmrs_Type is new DomainA_Type with record

      --
      -- Non initialised identifying non referential
      otmrs_id : Application_Types.Base_Integer_Type;

      --
      -- Non Identifying referential. Thou Shalt Not Use. 
      -- otmls_id : Application_Types.Base_Integer_Type;
   ...
   procedure Put_otmrs_id (
      ...
      otmrs_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_otmrs_id);
   pragma inline (Put_otmrs_id);
