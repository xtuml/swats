...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.DomainA.DOMAIN_A_SUBA.ads
...
--* Description:             
--*                          Domain specification Root_Object.DomainADOMAIN_A_SUBA
...
--  ----------------------------------  
--  package Root_Object.DomainA.DOMAIN_A_SUBA
...
package Root_Object.DomainA.DOMAIN_A_SUBA is
--
------------------------------------------------------------------------
   --
   --**************  Object Domain_A_Object_SubA Information **************
   --
   -- Object DOMAIN_A_SUBA is PASSIVE
   --
   -- Object DOMAIN_A_SUBA participates in a super sub type relationship
   --
   --
   --
   -- Object DOMAIN_A_SUBA is a SUB type of DOMAIN_A_SUPER via Relationship R4
   --
   -- Object DOMAIN_A_SUBA does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object DOMAIN_A_SUBA has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "DOMAIN_A_SUBA";

   --
   -------------------------------------------------------------------------------------------------
   --

   type DomainA_DOMAIN_A_SUBA_Type is new DomainA_Type with record

      --
      -- Non initialised identifying referential
      idSUPER : Application_Types.Base_Integer_Type;
   ...
   procedure Put_idSUPER (
      ...
      idSUPER_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idSUPER);
   pragma inline (Put_idSUPER);
