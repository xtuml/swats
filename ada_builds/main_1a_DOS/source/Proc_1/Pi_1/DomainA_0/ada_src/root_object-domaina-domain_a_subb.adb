...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.DomainA.DOMAIN_A_SUBB.adb
...
--* Description:             
--*                          Domain body Root_Object.DomainADOMAIN_A_SUBB
...
------------------------------------------------------------------------
--
package body Root_Object.DomainA.DOMAIN_A_SUBB is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return DomainA_DOMAIN_A_SUBB_Type (This_Object.all).idSUPER;
   end Get_idSUPER;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainA_DOMAIN_A_SUBB_Type (This_Object.all).idSUPER :=
         idSUPER_Value;
   end Put_idSUPER;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_SubB_Attribute (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return DomainA_DOMAIN_A_SUBB_Type (This_Object.all).SubB_Attribute;
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainA_DOMAIN_A_SUBB_Type (This_Object.all).SubB_Attribute :=
...
--ADATEST IGNORE_ON
   ...
   begin
      return DomainA_DOMAIN_A_SUBB_Type (This_Object.all).B_Text;
   end Get_B_Text;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainA_DOMAIN_A_SUBB_Type (This_Object.all).B_Text :=
         B_Text_Value;
   end Put_B_Text;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return DomainA_DOMAIN_A_SUBB_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainA_DOMAIN_A_SUBB_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return DomainA_DOMAIN_A_SUBB_Type (This_Object.all).R4_Super;
   end Get_R4_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainA_DOMAIN_A_SUBB_Type (This_Object.all).R4_Super :=
         R4_Super_Value;
   end Put_R4_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new DomainA_DOMAIN_A_SUBB_Type;
   
      else
         This_Object := Free_List.First_Entry;
         DomainA_DOMAIN_A_SUBB_Type(This_Object.all).idSUPER := Application_Types.Base_Integer_Type_First;
         DomainA_DOMAIN_A_SUBB_Type(This_Object.all).SubB_Attribute := Application_Types.Base_Integer_Type_First;
         DomainA_DOMAIN_A_SUBB_Type(This_Object.all).B_Text := Application_Types.Base_Text_Type_First;
         DomainA_DOMAIN_A_SUBB_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
end Root_Object.DomainA.DOMAIN_A_SUBB;
