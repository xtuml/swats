...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.BO.adb
...
--* Description:             
--*                          Domain body Root_Object.Function_CallsBO
...
------------------------------------------------------------------------
--
package body Root_Object.Function_Calls.BO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   procedure Put_Big_Attribute (
      ...
      Big_Attribute_Value : in Application_Types.Base_Integer_Type) is
   begin
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Function_Calls_BO_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Function_Calls_BO_Type(This_Object.all).Big_Attribute := Application_Types.Base_Integer_Type_First;
