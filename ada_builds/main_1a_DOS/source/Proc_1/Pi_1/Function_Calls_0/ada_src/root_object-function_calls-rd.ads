...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.RD.ads
...
--* Description:             
--*                          Domain specification Root_Object.Function_CallsRD
...
--  ----------------------------------  
--  package Root_Object.Function_Calls.RD
...
package Root_Object.Function_Calls.RD is
--
------------------------------------------------------------------------
   --
   ...
   type Function_Calls_RD_Type is new Function_Calls_Type with record
