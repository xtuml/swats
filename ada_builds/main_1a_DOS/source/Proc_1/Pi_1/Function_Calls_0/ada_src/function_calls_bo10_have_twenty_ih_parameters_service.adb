...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_BO10_Have_Twenty_IH_Parameters_Service.adb
...
package body Function_Calls_BO10_Have_Twenty_IH_Parameters_Service is
   
   procedure Function_Calls_BO10_Have_Twenty_IH_Parameters (
      ...
      Param11       : in     Root_Object.Object_Access;
      Param12       : in     Root_Object.Object_Access;
      Param13       : in     Root_Object.Object_Access;
      Param14       : in     Root_Object.Object_Access;
      Param15       : in     Root_Object.Object_Access;
      Param16       : in     Root_Object.Object_Access;
      Param17       : in     Root_Object.Object_Access;
      Param18       : in     Root_Object.Object_Access;
      Param19       : in     Root_Object.Object_Access;
      Param20       : in     Root_Object.Object_Access;
      Has_It_Passed :    out Boolean;
      What_With     :    out Application_Types.Base_Integer_Type) is
      
   begin
   -- start of BO10_Have_Twenty_IH_Parameters
      ...
      if Root_Object.Function_Calls.OBJONE.Function_Calls_OBJONE_type(Param1.all).Attribute_One        =  1 and then
         ...
         Root_Object.Function_Calls.OBJTEN.Function_Calls_OBJTEN_type(Param10.all).Attribute_Ten       =  10 and then
         Root_Object.Function_Calls.OBJONE.Function_Calls_OBJONE_type(Param11.all).Attribute_One       =  1 and then
         Root_Object.Function_Calls.OBJTWO.Function_Calls_OBJTWO_type(Param12.all).Attribute_Two       =  2 and then
         Root_Object.Function_Calls.OBJTHREE.Function_Calls_OBJTHREE_type(Param13.all).Attribute_Three =  3 and then
         Root_Object.Function_Calls.OBJFOUR.Function_Calls_OBJFOUR_type(Param14.all).Attribute_Four    =  4 and then
         Root_Object.Function_Calls.OBJFIVE.Function_Calls_OBJFIVE_type(Param15.all).Attribute_Five    =  5 and then
         Root_Object.Function_Calls.OBJSIX.Function_Calls_OBJSIX_type(Param16.all).Attribute_Six       =  6 and then
         Root_Object.Function_Calls.OBJSEVEN.Function_Calls_OBJSEVEN_type(Param17.all).Attribute_Seven =  7 and then
         Root_Object.Function_Calls.OBJEIGHT.Function_Calls_OBJEIGHT_type(Param18.all).Attribute_Eight =  8 and then
         Root_Object.Function_Calls.OBJNINE.Function_Calls_OBJNINE_type(Param19.all).Attribute_Nine    =  9 and then
         Root_Object.Function_Calls.OBJTEN.Function_Calls_OBJTEN_type(Param20.all).Attribute_Ten       =  10 then
         Has_It_Passed := True;
         What_With     := 0;
      else
         Has_It_Passed := False;
   ...
   end Function_Calls_BO10_Have_Twenty_IH_Parameters;
   
end Function_Calls_BO10_Have_Twenty_IH_Parameters_Service;

--
-- End of file Function_Calls_BO10_Have_Twenty_IH_Parameters_Service.adb
--
