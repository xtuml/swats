...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.objB.adb
...
--* Description:             
--*                          Domain body Root_Object.Function_CallsobjB
...
------------------------------------------------------------------------
--
package body Root_Object.Function_Calls.objB is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   ReferenceB_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceB return Application_Types.Base_Integer_Type is
   begin
      ReferenceB_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceB_Value);
      return ReferenceB_Value;
   end Obtain_Subsequent_ReferenceB;
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceB (
      This_Object : in Root_Object.Object_Access;
      ReferenceB_Value : in Application_Types.Base_Integer_Type) is
   begin
      Function_Calls_objB_Type (This_Object.all).ReferenceB :=
         ReferenceB_Value;
   end Put_ReferenceB;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Function_Calls_objB_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Function_Calls_objB_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Function_Calls_objB_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Function_Calls_objB_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Function_Calls_objB_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Function_Calls_objB_Type(This_Object.all).ReferenceB := Application_Types.Base_Integer_Type_First;
         Function_Calls_objB_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
         Function_Calls_objB_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure Function_Calls_objB_8 (
      Test_Case_ID : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Function_Calls_objB_2 (
      Test_Case_ID : in Application_Types.Base_Integer_Type;
      Invocation : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Function_Calls_objB_3 (
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Function_Calls_objB_1 (
      Test_Case_ID : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure objB3_To_Initial (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Function_Calls_objB_Type (This_Instance.all).Current_State := 
         Root_Object.Function_Calls.objB.Object_State_Type(Initial);

      Function_Calls_objB_8 (
         Test_Case_ID =>  Function_Calls_objB3(This_Event.all).Test_Case_ID,
         This_Instance => This_Instance );

   end objB3_To_Initial;
--
   procedure objB4_To_Verification (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Function_Calls_objB_Type (This_Instance.all).Current_State := 
         Root_Object.Function_Calls.objB.Object_State_Type(Verification);

      Function_Calls_objB_2 (
         Test_Case_ID =>  Function_Calls_objB4(This_Event.all).Test_Case_ID,
         Invocation =>  Function_Calls_objB4(This_Event.all).Invocation,
         This_Instance => This_Instance );

   end objB4_To_Verification;
--
   procedure objB1_To_Fail (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Function_Calls_objB_Type (This_Instance.all).Current_State := 
         Root_Object.Function_Calls.objB.Object_State_Type(Fail);

      Function_Calls_objB_3 (
         This_Instance => This_Instance );

   end objB1_To_Fail;
--
   procedure objB2_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Function_Calls_objB_Type (This_Instance.all).Current_State := 
         Root_Object.Function_Calls.objB.Object_State_Type(Idle);

      Function_Calls_objB_1 (
         Test_Case_ID =>  Function_Calls_objB2(This_Event.all).Test_Case_ID,
         This_Instance => This_Instance );

   end objB2_To_Idle;
--
   procedure objB6_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Function_Calls_objB_1 (
         Test_Case_ID =>  Function_Calls_objB6(This_Event.all).Test_Case_ID,
         This_Instance => This_Instance );
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Function_Calls_objB_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Function_Calls_objB_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Function_Calls_objB_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Function_Calls_objB_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Function_Calls_objB_Event_Queue.Pop (
         Item        => Temp_Event,
         Target_FIFO => Function_Calls_objB_Queue);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Function_Calls_objB_Event_Queue.Queue_Length (Function_Calls_objB_Queue);
...
--ADATEST IGNORE_ON
   procedure Put_Event (
      ...
      To_Class : in Function_Calls_objB_Type;
...
--
   This_Event_Dispatch_Matrix (objB1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objB2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objB3, Non_Existent) := objB3_To_Initial'access;
   This_Event_Dispatch_Matrix (objB4, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objB6, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objB1, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objB2, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objB3, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objB4, Idle) := objB4_To_Verification'access;
   This_Event_Dispatch_Matrix (objB6, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objB1, Verification) := objB1_To_Fail'access;
   This_Event_Dispatch_Matrix (objB2, Verification) := objB2_To_Idle'access;
   This_Event_Dispatch_Matrix (objB3, Verification) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objB4, Verification) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objB6, Verification) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objB1, Fail) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objB2, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objB3, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objB4, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objB6, Fail) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objB1, Initial) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (objB2, Initial) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objB3, Initial) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objB4, Initial) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objB6, Initial) := objB6_To_Idle'access;

end Root_Object.Function_Calls.objB;
