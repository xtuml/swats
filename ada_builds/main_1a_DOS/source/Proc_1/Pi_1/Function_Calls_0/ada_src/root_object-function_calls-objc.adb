...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.objC.adb
...
--* Description:             
--*                          Domain body Root_Object.Function_CallsobjC
...
------------------------------------------------------------------------
--
package body Root_Object.Function_Calls.objC is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idC_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idC return Application_Types.Base_Integer_Type is
   begin
      idC_Value :=
         Application_Types.Base_Integer_Type'succ (idC_Value);
      return idC_Value;
   end Obtain_Subsequent_idC;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Function_Calls_objC_Type (This_Object.all).idC;
   end Get_idC;
...
--ADATEST IGNORE_ON
   procedure Put_idC (
      ...
      idC_Value : in Application_Types.Base_Integer_Type) is
   begin
      Function_Calls_objC_Type (This_Object.all).idC :=
         idC_Value;
   end Put_idC;
...
--ADATEST IGNORE_ON
   function Get_IntC (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Function_Calls_objC_Type (This_Object.all).IntC;
   end Get_IntC;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_IntC (
      This_Object : in Root_Object.Object_Access;
      IntC_Value : in Application_Types.Base_Integer_Type) is
   begin
      Function_Calls_objC_Type (This_Object.all).IntC :=
         IntC_Value;
   end Put_IntC;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Function_Calls_objC_Type (This_Object.all).RealC;
   end Get_RealC;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_RealC (
      This_Object : in Root_Object.Object_Access;
      RealC_Value : in Application_Types.Base_Float_Type) is
   begin
      Function_Calls_objC_Type (This_Object.all).RealC :=
         RealC_Value;
   end Put_RealC;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Function_Calls_objC_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Function_Calls_objC_Type(This_Object.all).idC := Application_Types.Base_Integer_Type_First;
         Function_Calls_objC_Type(This_Object.all).IntC := Application_Types.Base_Integer_Type_First;
         Function_Calls_objC_Type(This_Object.all).RealC := Application_Types.Base_Float_Type_First;
...
end Root_Object.Function_Calls.objC;
