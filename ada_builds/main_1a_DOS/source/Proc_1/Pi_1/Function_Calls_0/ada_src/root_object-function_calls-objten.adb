...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.OBJTEN.adb
...
--* Description:             
--*                          Domain body Root_Object.Function_CallsOBJTEN
...
------------------------------------------------------------------------
--
package body Root_Object.Function_Calls.OBJTEN is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   procedure Put_Attribute_Ten (
      ...
      Attribute_Ten_Value : in Application_Types.Base_Integer_Type) is
   begin
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Function_Calls_OBJTEN_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Function_Calls_OBJTEN_Type(This_Object.all).Attribute_Ten := Application_Types.Base_Integer_Type_First;
