...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.objB.event_action.ada
...
--*  separate of Root_Object.Function_CallsobjB
--*     Event_Action
--*
--*************************************************************************************
--  MODIFICATION RECORD
...
begin
   ...
   This_Action := Function_Calls_objB_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := Function_Calls_objB_Instance_Event_Type(This_Event.all).Target_Instance;


   -- Ensure that the source instance still exists. 
   if This /= null then
      This_Event_Dispatch_Matrix (This_Action, Function_Calls_objB_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
