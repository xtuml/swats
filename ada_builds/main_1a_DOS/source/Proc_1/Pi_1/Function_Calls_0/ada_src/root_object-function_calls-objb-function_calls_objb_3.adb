...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_objB_3.ada
...
separate(Root_Object.Function_Calls.objB)
   ...
   procedure Function_Calls_objB_3 (This_Instance : in out Root_Object.Object_Access) is
   ...
   end Function_Calls_objB_3;
   
--
-- End of file Function_Calls_objB_3.ada
--
