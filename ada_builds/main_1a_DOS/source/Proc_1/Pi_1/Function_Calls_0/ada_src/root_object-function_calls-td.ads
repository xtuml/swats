...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.TD.ads
...
--* Description:             
--*                          Domain specification Root_Object.Function_CallsTD
...
--  ----------------------------------  
--  package Root_Object.Function_Calls.TD
...
package Root_Object.Function_Calls.TD is
--
------------------------------------------------------------------------
   --
   ...
   type Function_Calls_TD_Type is new Function_Calls_Type with record
...
end Root_Object.Function_Calls.TD;
