...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_BO4_Have_Five_IH_Parameters_Service.adb
...
package body Function_Calls_BO4_Have_Five_IH_Parameters_Service is
   
   procedure Function_Calls_BO4_Have_Five_IH_Parameters (
   ...
   begin
   -- start of BO4_Have_Five_IH_Parameters
      ...
      if Root_Object.Function_Calls.OBJONE.Function_Calls_OBJONE_type(Param1.all).Attribute_One       =  1 and then
         ...
         Root_Object.Function_Calls.OBJFIVE.Function_Calls_OBJFIVE_type(Param5.all).Attribute_Five    =  5 then
   ...
   end Function_Calls_BO4_Have_Five_IH_Parameters;
   
end Function_Calls_BO4_Have_Five_IH_Parameters_Service;

--
-- End of file Function_Calls_BO4_Have_Five_IH_Parameters_Service.adb
--
