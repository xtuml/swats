...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_objA3_FunctionC_Service.ads
...
package Function_Calls_objA3_FunctionC_Service is
   ...
   procedure Function_Calls_objA3_FunctionC (
      ...
      OutputB :    out Boolean;
      OutputC :    out Boolean;
      OutputD :    out Application_Types.Base_Integer_Type);
   
end Function_Calls_objA3_FunctionC_Service;

--
-- End of file Function_Calls_objA3_FunctionC_Service.ads
--
