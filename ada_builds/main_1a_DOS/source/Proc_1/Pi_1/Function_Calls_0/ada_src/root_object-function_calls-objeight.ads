...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.OBJEIGHT.ads
...
--* Description:             
--*                          Domain specification Root_Object.Function_CallsOBJEIGHT
...
--  ----------------------------------  
--  package Root_Object.Function_Calls.OBJEIGHT
...
package Root_Object.Function_Calls.OBJEIGHT is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_Eight Information **************
   --
   -- Object OBJEIGHT is PASSIVE
   --
   --
   --
   -- Object OBJEIGHT does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object OBJEIGHT has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "OBJEIGHT";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Function_Calls_OBJEIGHT_Type is new Function_Calls_Type with record

      --
      -- Initialised Non identifying non referential
      Attribute_Eight : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_Attribute_Eight (
      ...
      Attribute_Eight_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Attribute_Eight);
   pragma inline (Put_Attribute_Eight);
