...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.OBJTHREE.adb
...
--* Description:             
--*                          Domain body Root_Object.Function_CallsOBJTHREE
...
------------------------------------------------------------------------
--
package body Root_Object.Function_Calls.OBJTHREE is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Attribute_Three_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Attribute_Three return Application_Types.Base_Integer_Type is
   begin
      Attribute_Three_Value :=
         Application_Types.Base_Integer_Type'succ (Attribute_Three_Value);
      return Attribute_Three_Value;
   end Obtain_Subsequent_Attribute_Three;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Function_Calls_OBJTHREE_Type (This_Object.all).Attribute_Three;
...
--ADATEST IGNORE_ON
   ...
   begin
      Function_Calls_OBJTHREE_Type (This_Object.all).Attribute_Three :=
         Attribute_Three_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Function_Calls_OBJTHREE_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Function_Calls_OBJTHREE_Type(This_Object.all).Attribute_Three := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Function_Calls_OBJTHREE_Type(This_Object.all).Attribute_Three :=
         Obtain_Subsequent_Attribute_Three;
...
end Root_Object.Function_Calls.OBJTHREE;
