...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.objB.ads
...
--* Description:             
--*                          Domain specification Root_Object.Function_CallsobjB
...
--  ----------------------------------  
--  package Root_Object.Function_Calls.objB
...
package Root_Object.Function_Calls.objB is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_B Information **************
   --
   -- Object objB is ACTIVE
   --
   --
   --
   -- Object objB is ACTIVE and has the following state actions defined
   --   Non_Existent,
   --   Idle,
   --   Verification,
   --   Fail,
   --   Initial.
   --
   -- Object objB has an identifying non-referential attribute ReferenceB 
   -- and therefore may be uniquely created.
   -- 
   -- Object objB has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objB";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Function_Calls_objB_Type is new Function_Calls_Type with record

      --
      -- Non initialised identifying non referential
      ReferenceB : Application_Types.Base_Integer_Type;
   ...
   procedure Put_ReferenceB (
      ...
      ReferenceB_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_ReferenceB);
   pragma inline (Put_ReferenceB);
   ...
   -- EVENT DECLARATION
   --
   type Function_Calls_objB_Event_Type is new Function_Calls_Event_Type with
   record
   ...
   --    
   type Function_Calls_objB_Instance_Event_Type is new Function_Calls_objB_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type Function_Calls_objB_Description_Event is new Function_Calls_objB_Instance_Event_Type with
   record
      null;
   end record;  
   --
   ...
   type Function_Calls_objB1 is new Function_Calls_objB_Instance_Event_Type with
   record 
      null;
   end record;

   type Function_Calls_objB2 is new Function_Calls_objB_Instance_Event_Type with
   record 
      Test_Case_ID : Application_Types.Base_Integer_Type;
   end record;

   type Function_Calls_objB3 is new Function_Calls_objB_Instance_Event_Type with
   record 
      Test_Case_ID : Application_Types.Base_Integer_Type;
   end record;

   type Function_Calls_objB4 is new Function_Calls_objB_Instance_Event_Type with
   record 
      Test_Case_ID : Application_Types.Base_Integer_Type;
      Invocation : Application_Types.Base_Integer_Type;
   end record;

   type Function_Calls_objB6 is new Function_Calls_objB_Instance_Event_Type with
   record 
      Test_Case_ID : Application_Types.Base_Integer_Type;
   end record;
   ...
   package Function_Calls_objB_Event_Queue is new Generic_FIFO (Root_Object.Root_Event_Access_Type); 

   Function_Calls_objB_Queue: Function_Calls_objB_Event_Queue.FIFO_Type;
