...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_objA2_FunctionB_Service.adb
...
package body Function_Calls_objA2_FunctionB_Service is
   
   procedure Function_Calls_objA2_FunctionB (
   ...
   begin
   -- start of objA2_FunctionB
      an_instance_A := Root_Object.Function_Calls.objA.Conditional_Find_One;
      while (an_instance_A /= null) and then (not (Root_Object.Function_Calls.objA.Function_Calls_objA_Type(an_instance_A.all).ReferenceA =  2) ) loop
         
         an_instance_A := an_instance_A.Next_Object;
      end loop;
      
      
      if ((InputA /= 10) or else
          (InputB /= 20) or else
          (InputC /= 30)) then
   ...
   end Function_Calls_objA2_FunctionB;
   
end Function_Calls_objA2_FunctionB_Service;

--
-- End of file Function_Calls_objA2_FunctionB_Service.adb
--
