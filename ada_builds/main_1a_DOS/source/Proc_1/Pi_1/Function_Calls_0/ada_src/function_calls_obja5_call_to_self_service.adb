...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_objA5_Call_To_Self_Service.adb
...
package body Function_Calls_objA5_Call_To_Self_Service is
   
   procedure Function_Calls_objA5_Call_To_Self (
   ...
   end Function_Calls_objA5_Call_To_Self;
   
end Function_Calls_objA5_Call_To_Self_Service;

--
-- End of file Function_Calls_objA5_Call_To_Self_Service.adb
--
