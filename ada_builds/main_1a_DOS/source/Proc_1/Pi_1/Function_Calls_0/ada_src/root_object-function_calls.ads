...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.ads
...
--
--    db      07/05/02        SRLE100001027     Conditionally generated 'with' for Function_Calls domain types package.
--
...
package Root_Object.Function_Calls is
-------------------------------------------------------------------------------------------------
  type Function_Calls_Type is new Root_Object.Object_Type with
    record
      null;
    end record;
-------------------------------------------------------------------------------------------------
  type Function_Calls_Event_Type is new Root_Object.Root_Event_Type with
    record
      null;
    end record;
-------------------------------------------------------------------------------------------------
...
end Root_Object.Function_Calls;
