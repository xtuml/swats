...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.OBJFOUR.adb
...
--* Description:             
--*                          Domain body Root_Object.Function_CallsOBJFOUR
...
------------------------------------------------------------------------
--
package body Root_Object.Function_Calls.OBJFOUR is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   procedure Put_Attribute_Four (
      ...
      Attribute_Four_Value : in Application_Types.Base_Integer_Type) is
   begin
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Function_Calls_OBJFOUR_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Function_Calls_OBJFOUR_Type(This_Object.all).Attribute_Four := Application_Types.Base_Integer_Type_First;
