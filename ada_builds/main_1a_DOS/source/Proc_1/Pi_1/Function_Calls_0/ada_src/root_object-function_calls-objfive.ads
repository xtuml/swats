...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.OBJFIVE.ads
...
--* Description:             
--*                          Domain specification Root_Object.Function_CallsOBJFIVE
...
--  ----------------------------------  
--  package Root_Object.Function_Calls.OBJFIVE
...
package Root_Object.Function_Calls.OBJFIVE is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_Five Information **************
   --
   -- Object OBJFIVE is PASSIVE
   --
   --
   --
   -- Object OBJFIVE does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object OBJFIVE has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "OBJFIVE";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Function_Calls_OBJFIVE_Type is new Function_Calls_Type with record

      --
      -- Initialised Non identifying non referential
      Attribute_Five : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_Attribute_Five (
      ...
      Attribute_Five_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Attribute_Five);
   pragma inline (Put_Attribute_Five);
