...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.ATO.adb
...
--* Description:             
--*                          Domain body Root_Object.Function_CallsATO
...
------------------------------------------------------------------------
--
package body Root_Object.Function_Calls.ATO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   function Get_Start_Value (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Function_Calls_ATO_Type (This_Object.all).Start_Value;
   end Get_Start_Value;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Start_Value (
      This_Object : in Root_Object.Object_Access;
      Start_Value_Value : in Application_Types.Base_Integer_Type) is
   begin
      Function_Calls_ATO_Type (This_Object.all).Start_Value :=
         Start_Value_Value;
   end Put_Start_Value;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Increment_Value (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Function_Calls_ATO_Type (This_Object.all).Increment_Value;
...
--ADATEST IGNORE_ON
   procedure Put_Increment_Value (
      This_Object : in Root_Object.Object_Access;
      Increment_Value_Value : in Application_Types.Base_Integer_Type) is
   begin
      Function_Calls_ATO_Type (This_Object.all).Increment_Value :=
         Increment_Value_Value;
   end Put_Increment_Value;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Function_Calls_ATO_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Function_Calls_ATO_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Function_Calls_ATO_Type;
...
--
   ...
   procedure Function_Calls_ATO_2 (
      Termination_Required : in  Boolean;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Function_Calls_ATO_3 (
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure ATO1_To_Operations (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Function_Calls_ATO_Type (This_Instance.all).Current_State := 
         Root_Object.Function_Calls.ATO.Object_State_Type(Operations);

      Function_Calls_ATO_2 (
         Termination_Required =>  Function_Calls_ATO1(This_Event.all).Termination_Required,
         This_Instance => This_Instance );

   end ATO1_To_Operations;
--
   procedure ATO2_To_Dead (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      Function_Calls_ATO_Type (This_Instance.all).Current_State := 
         Root_Object.Function_Calls.ATO.Object_State_Type(Dead);

      Function_Calls_ATO_3 (
         This_Instance => This_Instance );
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Function_Calls_ATO_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Function_Calls_ATO_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Function_Calls_ATO_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Function_Calls_ATO_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Function_Calls_ATO_Event_Queue.Pop (
         Item        => Temp_Event,
         Target_FIFO => Function_Calls_ATO_Queue);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Function_Calls_ATO_Event_Queue.Queue_Length (Function_Calls_ATO_Queue);
...
--ADATEST IGNORE_ON
   procedure Put_Event (
      ...
      To_Class : in Function_Calls_ATO_Type;
...
--
   This_Event_Dispatch_Matrix (ATO1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ATO2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ATO1, Idle) := ATO1_To_Operations'access;
   This_Event_Dispatch_Matrix (ATO2, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (ATO1, Operations) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (ATO2, Operations) := ATO2_To_Dead'access;

end Root_Object.Function_Calls.ATO;
