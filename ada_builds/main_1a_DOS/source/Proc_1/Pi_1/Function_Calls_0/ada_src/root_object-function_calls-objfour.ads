...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.OBJFOUR.ads
...
--* Description:             
--*                          Domain specification Root_Object.Function_CallsOBJFOUR
...
--  ----------------------------------  
--  package Root_Object.Function_Calls.OBJFOUR
...
package Root_Object.Function_Calls.OBJFOUR is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_Four Information **************
   --
   -- Object OBJFOUR is PASSIVE
   --
   --
   --
   -- Object OBJFOUR does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object OBJFOUR has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "OBJFOUR";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Function_Calls_OBJFOUR_Type is new Function_Calls_Type with record

      --
      -- Initialised Non identifying non referential
      Attribute_Four : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_Attribute_Four (
      This_Object : in Root_Object.Object_Access;
      Attribute_Four_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Attribute_Four);
   pragma inline (Put_Attribute_Four);
...
end Root_Object.Function_Calls.OBJFOUR;
