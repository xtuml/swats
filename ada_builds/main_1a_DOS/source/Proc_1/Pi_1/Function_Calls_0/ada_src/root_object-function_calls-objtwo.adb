...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.OBJTWO.adb
...
--* Description:             
--*                          Domain body Root_Object.Function_CallsOBJTWO
...
------------------------------------------------------------------------
--
package body Root_Object.Function_Calls.OBJTWO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Attribute_Two_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Attribute_Two return Application_Types.Base_Integer_Type is
   begin
      Attribute_Two_Value :=
         Application_Types.Base_Integer_Type'succ (Attribute_Two_Value);
      return Attribute_Two_Value;
   end Obtain_Subsequent_Attribute_Two;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Function_Calls_OBJTWO_Type (This_Object.all).Attribute_Two;
...
--ADATEST IGNORE_ON
   ...
   begin
      Function_Calls_OBJTWO_Type (This_Object.all).Attribute_Two :=
         Attribute_Two_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Function_Calls_OBJTWO_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Function_Calls_OBJTWO_Type(This_Object.all).Attribute_Two := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Function_Calls_OBJTWO_Type(This_Object.all).Attribute_Two :=
         Obtain_Subsequent_Attribute_Two;
...
end Root_Object.Function_Calls.OBJTWO;
