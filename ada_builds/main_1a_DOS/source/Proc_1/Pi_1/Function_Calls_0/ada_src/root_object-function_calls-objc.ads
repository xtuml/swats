...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.objC.ads
...
--* Description:             
--*                          Domain specification Root_Object.Function_CallsobjC
...
--  ----------------------------------  
--  package Root_Object.Function_Calls.objC
...
package Root_Object.Function_Calls.objC is
--
------------------------------------------------------------------------
   --
   ...
   type Function_Calls_objC_Type is new Function_Calls_Type with record
      ...
      IntC : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      RealC : Application_Types.Base_Float_Type := Application_Types.Base_Float_Type_First;
   ...
   procedure Put_IntC (
      This_Object : in Root_Object.Object_Access;
      IntC_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_IntC);
   pragma inline (Put_IntC);
   ...
   procedure Put_RealC (
      This_Object : in Root_Object.Object_Access;
      RealC_Value : in Application_Types.Base_Float_Type);

   pragma inline (Get_RealC);
   pragma inline (Put_RealC);
