...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_objA4_FunctionD_Service.adb
...
package body Function_Calls_objA4_FunctionD_Service is
   
   procedure Function_Calls_objA4_FunctionD (
      InputA  : in     Application_Types.Base_Integer_Type;
      InputB  : in     Application_Types.Base_Integer_Type;
      InputC  : in     Application_Types.Base_Integer_Type;
      OutputA :    out Application_Types.Base_Integer_Type;
      OutputB :    out Application_Types.Base_Integer_Type;
      OutputC :    out Application_Types.Base_Integer_Type) is
   ...
   begin
   -- start of objA4_FunctionD
      an_instance_A := Root_Object.Function_Calls.objA.Conditional_Find_One;
      while (an_instance_A /= null) and then (not (Root_Object.Function_Calls.objA.Function_Calls_objA_Type(an_instance_A.all).ReferenceA =  4) ) loop
   ...
   end Function_Calls_objA4_FunctionD;
   
end Function_Calls_objA4_FunctionD_Service;

--
-- End of file Function_Calls_objA4_FunctionD_Service.adb
--
