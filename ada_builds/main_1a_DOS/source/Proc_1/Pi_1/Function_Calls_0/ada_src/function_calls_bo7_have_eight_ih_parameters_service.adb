...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_BO7_Have_Eight_IH_Parameters_Service.adb
...
package body Function_Calls_BO7_Have_Eight_IH_Parameters_Service is
   
   procedure Function_Calls_BO7_Have_Eight_IH_Parameters (
   ...
   begin
   -- start of BO7_Have_Eight_IH_Parameters
      ...
      if Root_Object.Function_Calls.OBJONE.Function_Calls_OBJONE_type(Param1.all).Attribute_One       =  1 and then
         ...
         Root_Object.Function_Calls.OBJEIGHT.Function_Calls_OBJEIGHT_type(Param8.all).Attribute_Eight =  8 then
         Has_It_Passed := True;
         What_With     := 0;
      else
         Has_It_Passed := False;
   ...
   end Function_Calls_BO7_Have_Eight_IH_Parameters;
   
end Function_Calls_BO7_Have_Eight_IH_Parameters_Service;

--
-- End of file Function_Calls_BO7_Have_Eight_IH_Parameters_Service.adb
--
