...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.OBJTWO.ads
...
--* Description:             
--*                          Domain specification Root_Object.Function_CallsOBJTWO
...
--  ----------------------------------  
--  package Root_Object.Function_Calls.OBJTWO
...
package Root_Object.Function_Calls.OBJTWO is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_Two Information **************
   --
   -- Object OBJTWO is PASSIVE
   --
   --
   --
   -- Object OBJTWO does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object OBJTWO has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "OBJTWO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Function_Calls_OBJTWO_Type is new Function_Calls_Type with record
