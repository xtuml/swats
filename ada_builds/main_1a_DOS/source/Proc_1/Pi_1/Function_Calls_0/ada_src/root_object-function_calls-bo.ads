...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.BO.ads
...
--* Description:             
--*                          Domain specification Root_Object.Function_CallsBO
...
--  ----------------------------------  
--  package Root_Object.Function_Calls.BO
...
package Root_Object.Function_Calls.BO is
--
------------------------------------------------------------------------
   --
   --**************  Object Big_Object Information **************
   --
   -- Object BO is PASSIVE
   --
   --
   --
   -- Object BO does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object BO has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "BO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Function_Calls_BO_Type is new Function_Calls_Type with record

      --
      -- Initialised Non identifying non referential
      Big_Attribute : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_Big_Attribute (
      This_Object : in Root_Object.Object_Access;
      Big_Attribute_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Big_Attribute);
   pragma inline (Put_Big_Attribute);
...
end Root_Object.Function_Calls.BO;
