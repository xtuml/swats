...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.OBJSIX.adb
...
--* Description:             
--*                          Domain body Root_Object.Function_CallsOBJSIX
...
------------------------------------------------------------------------
--
package body Root_Object.Function_Calls.OBJSIX is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Attribute_Six_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Attribute_Six return Application_Types.Base_Integer_Type is
   begin
      Attribute_Six_Value :=
         Application_Types.Base_Integer_Type'succ (Attribute_Six_Value);
      return Attribute_Six_Value;
   end Obtain_Subsequent_Attribute_Six;
...
--ADATEST IGNORE_ON
   function Get_Attribute_Six (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return Function_Calls_OBJSIX_Type (This_Object.all).Attribute_Six;
   end Get_Attribute_Six;
...
--ADATEST IGNORE_ON
   procedure Put_Attribute_Six (
      This_Object : in Root_Object.Object_Access;
      Attribute_Six_Value : in Application_Types.Base_Integer_Type) is
   begin
      Function_Calls_OBJSIX_Type (This_Object.all).Attribute_Six :=
         Attribute_Six_Value;
   end Put_Attribute_Six;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Function_Calls_OBJSIX_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Function_Calls_OBJSIX_Type(This_Object.all).Attribute_Six := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Function_Calls_OBJSIX_Type(This_Object.all).Attribute_Six :=
         Obtain_Subsequent_Attribute_Six;
...
end Root_Object.Function_Calls.OBJSIX;
