...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_BO2_Have_Three_IH_Parameters_Service.adb
...
package body Function_Calls_BO2_Have_Three_IH_Parameters_Service is
   
   procedure Function_Calls_BO2_Have_Three_IH_Parameters (
   ...
   begin
   -- start of BO2_Have_Three_IH_Parameters
      ...
      if Root_Object.Function_Calls.OBJONE.Function_Calls_OBJONE_type(Param1.all).Attribute_One       =  1 and then
         ...
         Root_Object.Function_Calls.OBJTHREE.Function_Calls_OBJTHREE_type(Param3.all).Attribute_Three =  3 then
         
         --    Param4.Attribute_Four  = 4 &\
         --    Param5.Attribute_Five  = 5 &\
         --    Param6.Attribute_Six   = 6 &\
   ...
   end Function_Calls_BO2_Have_Three_IH_Parameters;
   
end Function_Calls_BO2_Have_Three_IH_Parameters_Service;

--
-- End of file Function_Calls_BO2_Have_Three_IH_Parameters_Service.adb
--
