...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.OBJSEVEN.ads
...
--* Description:             
--*                          Domain specification Root_Object.Function_CallsOBJSEVEN
...
--  ----------------------------------  
--  package Root_Object.Function_Calls.OBJSEVEN
...
package Root_Object.Function_Calls.OBJSEVEN is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_Seven Information **************
   --
   -- Object OBJSEVEN is PASSIVE
   --
   --
   --
   -- Object OBJSEVEN does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object OBJSEVEN has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "OBJSEVEN";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Function_Calls_OBJSEVEN_Type is new Function_Calls_Type with record

      --
      -- Initialised Non identifying non referential
      Attribute_Seven : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_Attribute_Seven (
      ...
      Attribute_Seven_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Attribute_Seven);
   pragma inline (Put_Attribute_Seven);
