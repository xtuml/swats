...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.OBJSIX.ads
...
--* Description:             
--*                          Domain specification Root_Object.Function_CallsOBJSIX
...
--  ----------------------------------  
--  package Root_Object.Function_Calls.OBJSIX
...
package Root_Object.Function_Calls.OBJSIX is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_Six Information **************
   --
   -- Object OBJSIX is PASSIVE
   --
   --
   --
   -- Object OBJSIX does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object OBJSIX has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "OBJSIX";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Function_Calls_OBJSIX_Type is new Function_Calls_Type with record

      --
      -- Initialised Non identifying non referential
      Attribute_Six : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_Attribute_Six (
      ...
      Attribute_Six_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Attribute_Six);
   pragma inline (Put_Attribute_Six);
