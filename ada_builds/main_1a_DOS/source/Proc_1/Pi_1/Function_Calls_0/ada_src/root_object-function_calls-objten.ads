...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.OBJTEN.ads
...
--* Description:             
--*                          Domain specification Root_Object.Function_CallsOBJTEN
...
--  ----------------------------------  
--  package Root_Object.Function_Calls.OBJTEN
...
package Root_Object.Function_Calls.OBJTEN is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_Ten Information **************
   --
   -- Object OBJTEN is PASSIVE
   --
   --
   --
   -- Object OBJTEN does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object OBJTEN has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "OBJTEN";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Function_Calls_OBJTEN_Type is new Function_Calls_Type with record

      --
      -- Initialised Non identifying non referential
      Attribute_Ten : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_Attribute_Ten (
      This_Object : in Root_Object.Object_Access;
      Attribute_Ten_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Attribute_Ten);
   pragma inline (Put_Attribute_Ten);
...
end Root_Object.Function_Calls.OBJTEN;
