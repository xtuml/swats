...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.TD.adb
...
--* Description:             
--*                          Domain body Root_Object.Function_CallsTD
...
------------------------------------------------------------------------
--
package body Root_Object.Function_Calls.TD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Function_Calls_TD_Type (This_Object.all).The_Test_Number;
...
--ADATEST IGNORE_ON
   ...
   begin
      Function_Calls_TD_Type (This_Object.all).The_Test_Number :=
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Function_Calls_TD_Type;
