...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.OBJFIVE.adb
...
--* Description:             
--*                          Domain body Root_Object.Function_CallsOBJFIVE
...
------------------------------------------------------------------------
--
package body Root_Object.Function_Calls.OBJFIVE is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Attribute_Five_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Attribute_Five return Application_Types.Base_Integer_Type is
   begin
      Attribute_Five_Value :=
         Application_Types.Base_Integer_Type'succ (Attribute_Five_Value);
      return Attribute_Five_Value;
   end Obtain_Subsequent_Attribute_Five;
...
--ADATEST IGNORE_ON
   function Get_Attribute_Five (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return Function_Calls_OBJFIVE_Type (This_Object.all).Attribute_Five;
   end Get_Attribute_Five;
...
--ADATEST IGNORE_ON
   procedure Put_Attribute_Five (
      This_Object : in Root_Object.Object_Access;
      Attribute_Five_Value : in Application_Types.Base_Integer_Type) is
   begin
      Function_Calls_OBJFIVE_Type (This_Object.all).Attribute_Five :=
         Attribute_Five_Value;
   end Put_Attribute_Five;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Function_Calls_OBJFIVE_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Function_Calls_OBJFIVE_Type(This_Object.all).Attribute_Five := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Function_Calls_OBJFIVE_Type(This_Object.all).Attribute_Five :=
         Obtain_Subsequent_Attribute_Five;
...
end Root_Object.Function_Calls.OBJFIVE;
