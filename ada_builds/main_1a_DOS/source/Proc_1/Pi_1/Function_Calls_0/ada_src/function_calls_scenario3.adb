...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_Scenario3.ada
...
use type Root_Object.Object_Access;
   ...
   procedure Function_Calls_Scenario3 is
   ...
   begin
      ...
      if my_test /= Null then
         ...
         Root_Object.Function_Calls.TD.Delete (
            Old_Instance => my_test);
      end if;
      
      
      --  [] = Function_Calls3::Delete_Report_Data[]
   end Function_Calls_Scenario3;
   
--
-- End of file Function_Calls_Scenario3.ada
--
