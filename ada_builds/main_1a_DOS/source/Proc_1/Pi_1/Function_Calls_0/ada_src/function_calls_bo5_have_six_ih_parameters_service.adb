...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_BO5_Have_Six_IH_Parameters_Service.adb
...
package body Function_Calls_BO5_Have_Six_IH_Parameters_Service is
   
   procedure Function_Calls_BO5_Have_Six_IH_Parameters (
   ...
   begin
   -- start of BO5_Have_Six_IH_Parameters
      ...
      if Root_Object.Function_Calls.OBJONE.Function_Calls_OBJONE_type(Param1.all).Attribute_One       =  1 and then
         ...
         Root_Object.Function_Calls.OBJSIX.Function_Calls_OBJSIX_type(Param6.all).Attribute_Six       =  6 then
   ...
   end Function_Calls_BO5_Have_Six_IH_Parameters;
   
end Function_Calls_BO5_Have_Six_IH_Parameters_Service;

--
-- End of file Function_Calls_BO5_Have_Six_IH_Parameters_Service.adb
--
