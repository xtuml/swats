...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.OBJEIGHT.adb
...
--* Description:             
--*                          Domain body Root_Object.Function_CallsOBJEIGHT
...
------------------------------------------------------------------------
--
package body Root_Object.Function_Calls.OBJEIGHT is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Attribute_Eight_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Attribute_Eight return Application_Types.Base_Integer_Type is
   begin
      Attribute_Eight_Value :=
         Application_Types.Base_Integer_Type'succ (Attribute_Eight_Value);
      return Attribute_Eight_Value;
   end Obtain_Subsequent_Attribute_Eight;
...
--ADATEST IGNORE_ON
   function Get_Attribute_Eight (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return Function_Calls_OBJEIGHT_Type (This_Object.all).Attribute_Eight;
   end Get_Attribute_Eight;
...
--ADATEST IGNORE_ON
   procedure Put_Attribute_Eight (
      This_Object : in Root_Object.Object_Access;
      Attribute_Eight_Value : in Application_Types.Base_Integer_Type) is
   begin
      Function_Calls_OBJEIGHT_Type (This_Object.all).Attribute_Eight :=
         Attribute_Eight_Value;
   end Put_Attribute_Eight;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Function_Calls_OBJEIGHT_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Function_Calls_OBJEIGHT_Type(This_Object.all).Attribute_Eight := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Function_Calls_OBJEIGHT_Type(This_Object.all).Attribute_Eight :=
         Obtain_Subsequent_Attribute_Eight;
...
end Root_Object.Function_Calls.OBJEIGHT;
