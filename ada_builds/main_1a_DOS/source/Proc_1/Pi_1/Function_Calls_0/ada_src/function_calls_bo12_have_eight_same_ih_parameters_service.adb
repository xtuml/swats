...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_BO12_Have_EIGHT_Same_IH_Parameters_Service.adb
...
package body Function_Calls_BO12_Have_EIGHT_Same_IH_Parameters_Service is
   
   procedure Function_Calls_BO12_Have_EIGHT_Same_IH_Parameters (
   ...
   begin
   -- start of BO12_Have_EIGHT_Same_IH_Parameters
      ...
      if Root_Object.Function_Calls.OBJONE.Function_Calls_OBJONE_type(Param1.all).Attribute_One =  1 and then
         ...
         Root_Object.Function_Calls.OBJONE.Function_Calls_OBJONE_type(Param7.all).Attribute_One =  7 and then
         Root_Object.Function_Calls.OBJONE.Function_Calls_OBJONE_type(Param8.all).Attribute_One =  8 then
         Has_It_Passed := True;
         What_With     := 0;
      else
         Has_It_Passed := False;
   ...
   end Function_Calls_BO12_Have_EIGHT_Same_IH_Parameters;
   
end Function_Calls_BO12_Have_EIGHT_Same_IH_Parameters_Service;

--
-- End of file Function_Calls_BO12_Have_EIGHT_Same_IH_Parameters_Service.adb
--
