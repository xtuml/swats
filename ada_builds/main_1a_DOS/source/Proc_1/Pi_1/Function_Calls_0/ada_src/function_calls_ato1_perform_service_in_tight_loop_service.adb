...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_ATO1_Perform_Service_In_Tight_Loop_Service.adb
...
package body Function_Calls_ATO1_Perform_Service_In_Tight_Loop_Service is
   ...
   begin
   -- start of ATO1_Perform_Service_In_Tight_Loop
   ...
   end Function_Calls_ATO1_Perform_Service_In_Tight_Loop;
   
end Function_Calls_ATO1_Perform_Service_In_Tight_Loop_Service;

--
-- End of file Function_Calls_ATO1_Perform_Service_In_Tight_Loop_Service.adb
--
