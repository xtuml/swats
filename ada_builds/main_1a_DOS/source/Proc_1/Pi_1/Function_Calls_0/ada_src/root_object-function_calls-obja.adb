...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.objA.adb
...
--* Description:             
--*                          Domain body Root_Object.Function_CallsobjA
...
------------------------------------------------------------------------
--
package body Root_Object.Function_Calls.objA is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   ReferenceA_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceA return Application_Types.Base_Integer_Type is
   begin
      ReferenceA_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceA_Value);
      return ReferenceA_Value;
   end Obtain_Subsequent_ReferenceA;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Function_Calls_objA_Type (This_Object.all).ReferenceA;
   end Get_ReferenceA;
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceA (
      ...
      ReferenceA_Value : in Application_Types.Base_Integer_Type) is
   begin
      Function_Calls_objA_Type (This_Object.all).ReferenceA :=
         ReferenceA_Value;
   end Put_ReferenceA;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Function_Calls_objA_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Function_Calls_objA_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Function_Calls_objA_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Function_Calls_objA_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Function_Calls_objA_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Function_Calls_objA_Type(This_Object.all).ReferenceA := Application_Types.Base_Integer_Type_First;
         Function_Calls_objA_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
         Function_Calls_objA_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure Function_Calls_objA_2 (
   ...
   procedure Function_Calls_objA_3 (
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure Function_Calls_objA_1 (
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure objA3_To_Verification (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Function_Calls_objA_Type (This_Instance.all).Current_State := 
         Root_Object.Function_Calls.objA.Object_State_Type(Verification);

      Function_Calls_objA_2 (
         Test_Case_ID =>  Function_Calls_objA3(This_Event.all).Test_Case_ID,
         Invocation =>  Function_Calls_objA3(This_Event.all).Invocation,
         This_Instance => This_Instance );

   end objA3_To_Verification;
--
   ...
   begin
      ...
      Function_Calls_objA_Type (This_Instance.all).Current_State := 
         Root_Object.Function_Calls.objA.Object_State_Type(Fail);

      Function_Calls_objA_3 (
         This_Instance => This_Instance );
...
--
   ...
   begin
      ...
      Function_Calls_objA_Type (This_Instance.all).Current_State := 
         Root_Object.Function_Calls.objA.Object_State_Type(Idle);

      Function_Calls_objA_1 (
         This_Instance => This_Instance );
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Function_Calls_objA_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Function_Calls_objA_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Function_Calls_objA_Event_Queue.Pop (
         Item        => Temp_Event,
         Target_FIFO => Function_Calls_objA_Queue);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Function_Calls_objA_Event_Queue.Queue_Length (Function_Calls_objA_Queue);
...
--
   ...
   This_Event_Dispatch_Matrix (objA3, Idle) := objA3_To_Verification'access;
   This_Event_Dispatch_Matrix (objA1, Verification) := objA1_To_Fail'access;
   This_Event_Dispatch_Matrix (objA2, Verification) := objA2_To_Idle'access;
   This_Event_Dispatch_Matrix (objA3, Verification) :=  Cannot_Happen_Action'access;
