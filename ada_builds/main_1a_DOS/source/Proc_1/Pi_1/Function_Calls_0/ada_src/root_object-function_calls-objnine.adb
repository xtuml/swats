...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.OBJNINE.adb
...
--* Description:             
--*                          Domain body Root_Object.Function_CallsOBJNINE
...
------------------------------------------------------------------------
--
package body Root_Object.Function_Calls.OBJNINE is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   procedure Put_Attribute_Nine (
      ...
      Attribute_Nine_Value : in Application_Types.Base_Integer_Type) is
   begin
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Function_Calls_OBJNINE_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Function_Calls_OBJNINE_Type(This_Object.all).Attribute_Nine := Application_Types.Base_Integer_Type_First;
