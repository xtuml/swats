...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.OBJONE.adb
...
--* Description:             
--*                          Domain body Root_Object.Function_CallsOBJONE
...
------------------------------------------------------------------------
--
package body Root_Object.Function_Calls.OBJONE is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Attribute_One_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Attribute_One return Application_Types.Base_Integer_Type is
   begin
      Attribute_One_Value :=
         Application_Types.Base_Integer_Type'succ (Attribute_One_Value);
      return Attribute_One_Value;
   end Obtain_Subsequent_Attribute_One;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Function_Calls_OBJONE_Type (This_Object.all).Attribute_One;
...
--ADATEST IGNORE_ON
   ...
   begin
      Function_Calls_OBJONE_Type (This_Object.all).Attribute_One :=
         Attribute_One_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Function_Calls_OBJONE_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Function_Calls_OBJONE_Type(This_Object.all).Attribute_One := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Function_Calls_OBJONE_Type(This_Object.all).Attribute_One :=
         Obtain_Subsequent_Attribute_One;
...
end Root_Object.Function_Calls.OBJONE;
