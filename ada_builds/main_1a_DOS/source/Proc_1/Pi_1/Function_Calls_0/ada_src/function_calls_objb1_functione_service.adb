...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_objB1_FunctionE_Service.adb
...
package body Function_Calls_objB1_FunctionE_Service is
   
   procedure Function_Calls_objB1_FunctionE (
   ...
   end Function_Calls_objB1_FunctionE;
   
end Function_Calls_objB1_FunctionE_Service;

--
-- End of file Function_Calls_objB1_FunctionE_Service.adb
--
