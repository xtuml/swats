...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.ATO.ads
...
--* Description:             
--*                          Domain specification Root_Object.Function_CallsATO
...
--  ----------------------------------  
--  package Root_Object.Function_Calls.ATO
...
package Root_Object.Function_Calls.ATO is
--
------------------------------------------------------------------------
   --
   --**************  Object A_Tight_Object Information **************
   --
   -- Object ATO is ACTIVE
   --
   --
   --
   -- Object ATO is ACTIVE and has the following state actions defined
   --   Non_Existent,
   --   Idle,
   --   Operations,
   --   Dead.
   ...
   type Function_Calls_ATO_Type is new Function_Calls_Type with record
      ...
      --
      -- Initialised Non identifying non referential
      Increment_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_Start_Value (
      ...
      Start_Value_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Start_Value);
   pragma inline (Put_Start_Value);
   ...
   procedure Put_Increment_Value (
      This_Object : in Root_Object.Object_Access;
      Increment_Value_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Increment_Value);
   pragma inline (Put_Increment_Value);
   ...
   -- EVENT DECLARATION
   --
   type Function_Calls_ATO_Event_Type is new Function_Calls_Event_Type with
   record
   ...
   --    
   type Function_Calls_ATO_Instance_Event_Type is new Function_Calls_ATO_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type Function_Calls_ATO_Description_Event is new Function_Calls_ATO_Instance_Event_Type with
   record
      null;
   end record;  
   --
   ...
   type Function_Calls_ATO1 is new Function_Calls_ATO_Instance_Event_Type with
   record 
      Termination_Required :  Boolean;
   end record;

   type Function_Calls_ATO2 is new Function_Calls_ATO_Instance_Event_Type with
   record 
      null;
   end record;
   ...
   package Function_Calls_ATO_Event_Queue is new Generic_FIFO (Root_Object.Root_Event_Access_Type); 

   Function_Calls_ATO_Queue: Function_Calls_ATO_Event_Queue.FIFO_Type;
