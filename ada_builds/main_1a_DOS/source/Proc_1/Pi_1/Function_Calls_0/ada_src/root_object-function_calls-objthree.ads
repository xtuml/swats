...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.OBJTHREE.ads
...
--* Description:             
--*                          Domain specification Root_Object.Function_CallsOBJTHREE
...
--  ----------------------------------  
--  package Root_Object.Function_Calls.OBJTHREE
...
package Root_Object.Function_Calls.OBJTHREE is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_Three Information **************
   --
   -- Object OBJTHREE is PASSIVE
   --
   --
   --
