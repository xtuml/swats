...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.OBJONE.ads
...
--* Description:             
--*                          Domain specification Root_Object.Function_CallsOBJONE
...
--  ----------------------------------  
--  package Root_Object.Function_Calls.OBJONE
...
package Root_Object.Function_Calls.OBJONE is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_One Information **************
   --
   -- Object OBJONE is PASSIVE
   --
   --
   --
   -- Object OBJONE does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object OBJONE has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "OBJONE";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Function_Calls_OBJONE_Type is new Function_Calls_Type with record
