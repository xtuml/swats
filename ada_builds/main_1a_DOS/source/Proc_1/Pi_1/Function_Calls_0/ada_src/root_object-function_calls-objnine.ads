...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Function_Calls.OBJNINE.ads
...
--* Description:             
--*                          Domain specification Root_Object.Function_CallsOBJNINE
...
--  ----------------------------------  
--  package Root_Object.Function_Calls.OBJNINE
...
package Root_Object.Function_Calls.OBJNINE is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_Nine Information **************
   --
   -- Object OBJNINE is PASSIVE
   --
   --
   --
   -- Object OBJNINE does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object OBJNINE has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "OBJNINE";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Function_Calls_OBJNINE_Type is new Function_Calls_Type with record

      --
      -- Initialised Non identifying non referential
      Attribute_Nine : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_Attribute_Nine (
      This_Object : in Root_Object.Object_Access;
      Attribute_Nine_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Attribute_Nine);
   pragma inline (Put_Attribute_Nine);
...
end Root_Object.Function_Calls.OBJNINE;
