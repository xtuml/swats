...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objE.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjE
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objE is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_objE_Type (This_Object.all).idE;
   end Get_idE;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objE_Type (This_Object.all).idE :=
         idE_Value;
   end Put_idE;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_objE_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objE_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objE_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objE_Type(This_Object.all).idE := Application_Types.Base_Integer_Type_First;
         Relationships_objE_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.objE;
