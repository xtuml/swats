...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSSL4.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjSSL4
...
--  ----------------------------------  
--  package Root_Object.Relationships.objSSL4
...
package Root_Object.Relationships.objSSL4 is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_Sub_L4 Information **************
   --
   -- Object objSSL4 is PASSIVE
   --
   -- Object objSSL4 participates in a super sub type relationship
   --
   --
   --
   -- Object objSSL4 is a SUB type of objSL3 via Relationship R27
   --
   -- Object objSSL4 does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objSSL4 has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objSSL4";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objSSL4_Type is new Relationships_Type with record
      ...
      idSSL4 : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_idSSL4 (
      This_Object : in Root_Object.Object_Access;
      idSSL4_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idSSL4);
   pragma inline (Put_idSSL4);
