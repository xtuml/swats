...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSSL8.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjSSL8
...
--  ----------------------------------  
--  package Root_Object.Relationships.objSSL8
...
package Root_Object.Relationships.objSSL8 is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_Sub_L8 Information **************
   --
   -- Object objSSL8 is PASSIVE
   --
   -- Object objSSL8 participates in a super sub type relationship
   --
   --
   --
   -- Object objSSL8 is a SUB type of objSL3 via Relationship R30
   --
   -- Object objSSL8 does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objSSL8 has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objSSL8";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objSSL8_Type is new Relationships_Type with record
      ...
      idSSL8 : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_idSSL8 (
      This_Object : in Root_Object.Object_Access;
      idSSL8_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idSSL8);
   pragma inline (Put_idSSL8);
