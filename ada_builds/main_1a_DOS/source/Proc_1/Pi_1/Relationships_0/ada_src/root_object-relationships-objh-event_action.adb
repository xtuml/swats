...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objH.event_action.ada
...
--*  separate of Root_Object.RelationshipsobjH
--*     Event_Action
--*
--*************************************************************************************
--  MODIFICATION RECORD
...
separate (Root_Object.Relationships.objH)
...
begin
   ...
   This_Action := Relationships_objH_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := Relationships_objH_Instance_Event_Type(This_Event.all).Target_Instance;
   ...
   if This /= null then
      ...
      --  
      This_Event_Dispatch_Matrix (This_Action, Relationships_objH_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
