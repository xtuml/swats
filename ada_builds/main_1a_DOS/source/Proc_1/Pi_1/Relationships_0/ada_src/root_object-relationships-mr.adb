...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.MR.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsMR
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.MR is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Right_Identifier_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Right_Identifier return Application_Types.Base_Integer_Type is
   begin
      Right_Identifier_Value :=
         Application_Types.Base_Integer_Type'succ (Right_Identifier_Value);
      return Right_Identifier_Value;
   end Obtain_Subsequent_Right_Identifier;
...
--ADATEST IGNORE_ON
   function Get_Right_Identifier (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return Relationships_MR_Type (This_Object.all).Right_Identifier;
   end Get_Right_Identifier;
...
--ADATEST IGNORE_ON
   procedure Put_Right_Identifier (
      This_Object : in Root_Object.Object_Access;
      Right_Identifier_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_MR_Type (This_Object.all).Right_Identifier :=
         Right_Identifier_Value;
   end Put_Right_Identifier;
...
--ADATEST IGNORE_ON
   function Get_Right_Data (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_MR_Type (This_Object.all).Right_Data;
   end Get_Right_Data;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Right_Data (
      This_Object : in Root_Object.Object_Access;
      Right_Data_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_MR_Type (This_Object.all).Right_Data :=
         Right_Data_Value;
   end Put_Right_Data;
--ADATEST IGNORE_OFF
...
------------------------------------------------------------------------
   --
   -- procedure Put_Middle_Identifier and 
   --
   -- function Get_Middle_Identifier
   --
   -- have not been generated for Middle_Identifier
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_MR_Type (This_Object.all).R7_A;
   end Get_R7_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R7_A (
      This_Object : in Root_Object.Object_Access;
      R7_A_Value : in Root_Object.Object_Access) is
   begin
      Relationships_MR_Type (This_Object.all).R7_A :=
         R7_A_Value;
   end Put_R7_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_MR_Type (This_Object.all).R10_B;
   end Get_R10_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_MR_Type (This_Object.all).R10_B :=
         R10_B_Value;
   end Put_R10_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_MR_Type;
   
         Relationships_MR_Type(This_Object.all).R10_B := Root_Object.Object_List.Initialise;
      else
         This_Object := Free_List.First_Entry;
         Relationships_MR_Type(This_Object.all).Right_Identifier := Application_Types.Base_Integer_Type_First;
         Relationships_MR_Type(This_Object.all).Right_Data := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Relationships_MR_Type(This_Object.all).Right_Identifier :=
         Obtain_Subsequent_Right_Identifier;
...
end Root_Object.Relationships.MR;
