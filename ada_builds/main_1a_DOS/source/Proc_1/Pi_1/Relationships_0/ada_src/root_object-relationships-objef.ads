...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.OBJEF.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsOBJEF
...
--  ----------------------------------  
--  package Root_Object.Relationships.OBJEF
...
package Root_Object.Relationships.OBJEF is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_EF Information **************
   --
   -- Object OBJEF is PASSIVE
   --
   --
   --
   -- Object OBJEF does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object OBJEF has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "OBJEF";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_OBJEF_Type is new Relationships_Type with record
      ...
      --
      -- Non initialised identifying referential
      idF : Application_Types.Base_Integer_Type;
      ...
      --
      -- Initialised Non identifying non referential
      idEF : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_idF (
      This_Object : in Root_Object.Object_Access;
      idF_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idF);
   pragma inline (Put_idF);
   ...
   procedure Put_idEF (
      This_Object : in Root_Object.Object_Access;
      idEF_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idEF);
   pragma inline (Put_idEF);
