...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSSSL2.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjSSSL2
...
--  ----------------------------------  
--  package Root_Object.Relationships.objSSSL2
...
package Root_Object.Relationships.objSSSL2 is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_Sub_Sub_L2 Information **************
   --
   -- Object objSSSL2 is PASSIVE
   --
   -- Object objSSSL2 participates in a super sub type relationship
   --
   --
   --
   -- Object objSSSL2 is a SUB type of objSSL2 via Relationship R28
   --
   -- Object objSSSL2 does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objSSSL2 has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objSSSL2";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objSSSL2_Type is new Relationships_Type with record
      ...
      idSSSL2 : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      Current_State :  Object_State_Type :=  Object_State_Type_First;

      R28_Super : Root_Object.Object_Access := null;
   ...
   procedure Put_idSSSL2 (
      This_Object : in Root_Object.Object_Access;
      idSSSL2_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idSSSL2);
   pragma inline (Put_idSSSL2);
   ...
   procedure Put_R28_Super (
      This_Object : in  Root_Object.Object_Access;
      R28_Super_Value : in Root_Object.Object_Access);

   pragma inline (Get_R28_Super);
   pragma inline (Put_R28_Super);
