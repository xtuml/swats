...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objE.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjE
...
--  ----------------------------------  
--  package Root_Object.Relationships.objE
...
package Root_Object.Relationships.objE is
--
------------------------------------------------------------------------
   --
   ...
   type Relationships_objE_Type is new Relationships_Type with record
