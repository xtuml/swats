...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSL2.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjSL2
...
--  ----------------------------------  
--  package Root_Object.Relationships.objSL2
...
package Root_Object.Relationships.objSL2 is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_L2 Information **************
   --
   -- Object objSL2 is PASSIVE
   --
   -- Object objSL2 participates in a super sub type relationship
   --
   --
   --
   -- Object objSL2 is a SUB type of objL via Relationship R26
   --
   -- Object objSL2 does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objSL2 has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objSL2";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objSL2_Type is new Relationships_Type with record
      ...
      idSL2 : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_idSL2 (
      This_Object : in Root_Object.Object_Access;
      idSL2_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idSL2);
   pragma inline (Put_idSL2);
