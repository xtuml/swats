...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objI.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjI
...
--  ----------------------------------  
--  package Root_Object.Relationships.objI
...
package Root_Object.Relationships.objI is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_I Information **************
   --
   -- Object objI is PASSIVE
   --
   -- Object objI participates in a super sub type relationship
   --
   --
   --
   -- Object objI is a SUB type of objH via Relationship R9
   --
   -- Object objI does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objI has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objI";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objI_Type is new Relationships_Type with record
      ...
      --
      -- Initialised Non identifying non referential
      IDI : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_IDI (
      This_Object : in Root_Object.Object_Access;
      IDI_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_IDI);
   pragma inline (Put_IDI);
