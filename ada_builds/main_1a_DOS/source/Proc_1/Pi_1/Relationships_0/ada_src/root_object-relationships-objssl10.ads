...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSSL10.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjSSL10
...
--  ----------------------------------  
--  package Root_Object.Relationships.objSSL10
...
package Root_Object.Relationships.objSSL10 is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_Sub_L10 Information **************
   --
   -- Object objSSL10 is PASSIVE
   --
   -- Object objSSL10 participates in a super sub type relationship
   --
   --
   --
   -- Object objSSL10 is a SUB type of objSL3 via Relationship R31
   --
   -- Object objSSL10 does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objSSL10 has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objSSL10";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objSSL10_Type is new Relationships_Type with record
      ...
      idSSL10 : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_idSSL10 (
      This_Object : in Root_Object.Object_Access;
      idSSL10_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idSSL10);
   pragma inline (Put_idSSL10);
