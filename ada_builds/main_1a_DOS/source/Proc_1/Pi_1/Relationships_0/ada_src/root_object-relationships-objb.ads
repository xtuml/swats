...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objB.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjB
...
--  ----------------------------------  
--  package Root_Object.Relationships.objB
...
package Root_Object.Relationships.objB is
--
------------------------------------------------------------------------
   --
   ...
   type Relationships_objB_Type is new Relationships_Type with record
      ...
      --
      -- Non Identifying referential. Thou Shalt Not Use. 
      -- idM : Application_Types.Base_Integer_Type;
   
      --
      R1_A : Root_Object.Object_Access := null;
      R18_B : Root_Object.Object_Access := null;
   ...
   procedure Put_R18_B (
      This_Object :   in  Root_Object.Object_Access;
      R18_B_Value : in Root_Object.Object_Access);

   pragma inline (Get_R18_B);
   pragma inline (Put_R18_B);
