...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.FL.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsFL
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.FL is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Left_Identifier_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Left_Identifier return Application_Types.Base_Integer_Type is
   begin
      Left_Identifier_Value :=
         Application_Types.Base_Integer_Type'succ (Left_Identifier_Value);
      return Left_Identifier_Value;
   end Obtain_Subsequent_Left_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_FL_Type (This_Object.all).Left_Identifier;
   end Get_Left_Identifier;
...
--ADATEST IGNORE_ON
   procedure Put_Left_Identifier (
      ...
      Left_Identifier_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_FL_Type (This_Object.all).Left_Identifier :=
         Left_Identifier_Value;
   end Put_Left_Identifier;
...
--ADATEST IGNORE_ON
   function Get_Left_Data (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_FL_Type (This_Object.all).Left_Data;
   end Get_Left_Data;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Left_Data (
      This_Object : in Root_Object.Object_Access;
      Left_Data_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_FL_Type (This_Object.all).Left_Data :=
         Left_Data_Value;
   end Put_Left_Data;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_FL_Type (This_Object.all).R6_B;
   end Get_R6_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_FL_Type (This_Object.all).R6_B :=
         R6_B_Value;
   end Put_R6_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_FL_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_FL_Type(This_Object.all).Left_Identifier := Application_Types.Base_Integer_Type_First;
         Relationships_FL_Type(This_Object.all).Left_Data := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Relationships_FL_Type(This_Object.all).Left_Identifier :=
         Obtain_Subsequent_Left_Identifier;
