...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSSL6.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjSSL6
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objSSL6 is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSSL6_Type (This_Object.all).idH;
   end Get_idH;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSSL6_Type (This_Object.all).idH :=
         idH_Value;
   end Put_idH;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_idSSL6 (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_objSSL6_Type (This_Object.all).idSSL6;
   end Get_idSSL6;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_idSSL6 (
      This_Object : in Root_Object.Object_Access;
      idSSL6_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objSSL6_Type (This_Object.all).idSSL6 :=
         idSSL6_Value;
   end Put_idSSL6;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSSL6_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSSL6_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSSL6_Type (This_Object.all).R32_A;
   end Get_R32_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R32_A (
      This_Object : in Root_Object.Object_Access;
      R32_A_Value : in Root_Object.Object_List.List_Header_Access_Type) is
   begin
      Relationships_objSSL6_Type (This_Object.all).R32_A :=
         R32_A_Value;
   end Put_R32_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R29_Super (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Relationships_objSSL6_Type (This_Object.all).R29_Super;
   end Get_R29_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R29_Super (
      This_Object : in  Root_Object.Object_Access;
      R29_Super_Value : in Root_Object.Object_Access) is
   begin
      Relationships_objSSL6_Type (This_Object.all).R29_Super :=
         R29_Super_Value;
   end Put_R29_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objSSL6_Type;
   
         Relationships_objSSL6_Type(This_Object.all).R32_A := Root_Object.Object_List.Initialise;
      else
         This_Object := Free_List.First_Entry;
         Relationships_objSSL6_Type(This_Object.all).idH := Application_Types.Base_Integer_Type_First;
         Relationships_objSSL6_Type(This_Object.all).idSSL6 := Application_Types.Base_Integer_Type_First;
         Relationships_objSSL6_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
end Root_Object.Relationships.objSSL6;
