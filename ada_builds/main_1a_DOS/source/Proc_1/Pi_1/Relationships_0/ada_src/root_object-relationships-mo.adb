...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.MO.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsMO
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.MO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idMO_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idMO return Application_Types.Base_Integer_Type is
   begin
      idMO_Value :=
         Application_Types.Base_Integer_Type'succ (idMO_Value);
      return idMO_Value;
   end Obtain_Subsequent_idMO;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_MO_Type (This_Object.all).idMO;
   end Get_idMO;
...
--ADATEST IGNORE_ON
   procedure Put_idMO (
      ...
      idMO_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_MO_Type (This_Object.all).idMO :=
         idMO_Value;
   end Put_idMO;
...
------------------------------------------------------------------------
   --
   -- procedure Put_idLO and 
   --
   -- function Get_idLO
   --
   -- have not been generated for idLO
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_MO_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_MO_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_MO_Type (This_Object.all).R12_A;
   end Get_R12_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_MO_Type (This_Object.all).R12_A :=
         R12_A_Value;
   end Put_R12_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_MO_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_MO_Type(This_Object.all).idMO := Application_Types.Base_Integer_Type_First;
         Relationships_MO_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.MO;
