...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objF.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjF
...
--  ----------------------------------  
--  package Root_Object.Relationships.objF
...
package Root_Object.Relationships.objF is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_F Information **************
   --
   -- Object objF is PASSIVE
   --
   --
   --
   -- Object objF has an identifying non-referential attribute idF 
   ...
   type Relationships_objF_Type is new Relationships_Type with record
