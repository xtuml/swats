...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objH.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjH
...
--  ----------------------------------  
--  package Root_Object.Relationships.objH
...
package Root_Object.Relationships.objH is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_H Information **************
   --
   -- Object objH is PASSIVE
   --
   -- Object objH participates in a super sub type relationship
   --
   --
   --
   -- Object objH is a SUPER type of 
   --    objL,
   --    objI
   --    via Relationship R9
   --
   -- Object objH has an identifying non-referential attribute idH 
   -- and therefore may be uniquely created.
   -- 
   -- Object objH has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objH";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objH_Type is new Relationships_Type with record
   ...
   --
   type Relationships_objH_Event_Type is new Relationships_Event_Type with
   record
      This_Event_Class : Event_Class;
   end record;

   procedure Event_Action (
      Dispatch_Event : in     Relationships_objH_Event_Type;
      This_Event     : in out Root_Object.Root_Event_Access_Type);


   --    
   type Relationships_objH_Instance_Event_Type is new Relationships_objH_Event_Type with
   record
   ...
   -- 
   procedure Event_Action (
      Dispatch_Event : in     Relationships_objH_Instance_Event_Type;
      This_Event     : in out Root_Object.Root_Event_Access_Type);



   ------------------------------------------------------------------------
   type Relationships_objH_Description_Event is new Relationships_objH_Instance_Event_Type with
   record
      null;
   end record;
   --
   ...
   --
   --
   type Relationships_objH1 is new Relationships_objH_Instance_Event_Type with
   record 
      null;
   end record;
   --
   type Relationships_objH2 is new Relationships_objH_Instance_Event_Type with
   record 
      null;
   end record;
   --
   type Relationships_objH3 is new Relationships_objH_Instance_Event_Type with
   record 
      Test: Application_Types.Base_Integer_Type;
      Iteration: Application_Types.Base_Integer_Type;
   end record;
   --
   type Relationships_objH4 is new Relationships_objH_Instance_Event_Type with
   record 
      Test: Application_Types.Base_Integer_Type;
      Iteration: Application_Types.Base_Integer_Type;
   end record;

end Root_Object.Relationships.objH;
