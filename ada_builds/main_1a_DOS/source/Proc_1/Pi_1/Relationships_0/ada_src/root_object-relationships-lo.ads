...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.LO.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsLO
...
--  ----------------------------------  
--  package Root_Object.Relationships.LO
...
package Root_Object.Relationships.LO is
--
------------------------------------------------------------------------
   --
   --**************  Object Left_Object Information **************
   --
   -- Object LO is PASSIVE
   --
   --
   --
   -- Object LO has an identifying non-referential attribute idLO 
   -- and therefore may be uniquely created.
   -- 
   -- Object LO has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "LO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_LO_Type is new Relationships_Type with record
   ...
   procedure Put_idLO (
      ...
      idLO_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idLO);
   pragma inline (Put_idLO);
