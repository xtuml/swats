...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objLMRM.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjLMRM
...
--  ----------------------------------  
--  package Root_Object.Relationships.objLMRM
...
package Root_Object.Relationships.objLMRM is
--
------------------------------------------------------------------------
   --
   --**************  Object LMRM_Assoc Information **************
   --
   -- Object objLMRM is PASSIVE
   --
   --
   --
   -- Object objLMRM does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objLMRM has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objLMRM";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objLMRM_Type is new Relationships_Type with record

      --
      -- Non initialised identifying referential
      idLM : Application_Types.Base_Integer_Type;

      --
      -- Non initialised identifying referential
      idRM : Application_Types.Base_Integer_Type;

      --
      -- Initialised Non identifying non referential
      idLMRM : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      R16_B : Root_Object.Object_List.List_Header_Access_Type;
   ...
   procedure Put_idLM (
      ...
      idLM_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idLM);
   pragma inline (Put_idLM);
   ...
   procedure Put_idRM (
      This_Object : in Root_Object.Object_Access;
      idRM_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idRM);
   pragma inline (Put_idRM);
   ...
   procedure Put_idLMRM (
      This_Object : in Root_Object.Object_Access;
      idLMRM_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idLMRM);
   pragma inline (Put_idLMRM);
   ...
   procedure Put_R16_B  (
      This_Object :    in  Root_Object.Object_Access;
      R16_B_Value : in Root_Object.Object_List.List_Header_Access_Type);

   pragma inline (Get_R16_B);
   pragma inline (Put_R16_B);
