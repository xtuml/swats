...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSSL9.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjSSL9
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objSSL9 is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSSL9_Type (This_Object.all).idH;
   end Get_idH;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSSL9_Type (This_Object.all).idH :=
         idH_Value;
   end Put_idH;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_idSSL9 (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_objSSL9_Type (This_Object.all).idSSL9;
   end Get_idSSL9;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_idSSL9 (
      This_Object : in Root_Object.Object_Access;
      idSSL9_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objSSL9_Type (This_Object.all).idSSL9 :=
         idSSL9_Value;
   end Put_idSSL9;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSSL9_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSSL9_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   function  Get_R30_Super (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Relationships_objSSL9_Type (This_Object.all).R30_Super;
   end Get_R30_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R30_Super (
      This_Object : in  Root_Object.Object_Access;
      R30_Super_Value : in Root_Object.Object_Access) is
   begin
      Relationships_objSSL9_Type (This_Object.all).R30_Super :=
         R30_Super_Value;
   end Put_R30_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objSSL9_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objSSL9_Type(This_Object.all).idH := Application_Types.Base_Integer_Type_First;
         Relationships_objSSL9_Type(This_Object.all).idSSL9 := Application_Types.Base_Integer_Type_First;
         Relationships_objSSL9_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
end Root_Object.Relationships.objSSL9;
