...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.M.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsM
...
--  ----------------------------------  
--  package Root_Object.Relationships.M
...
package Root_Object.Relationships.M is
--
------------------------------------------------------------------------
   --
   --**************  Object Middle Information **************
   --
   -- Object M is PASSIVE
   --
   --
   --
   -- Object M has an identifying non-referential attribute Middle_Identifier 
   -- and therefore may be uniquely created.
   -- 
   -- Object M has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "M";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_M_Type is new Relationships_Type with record
      ...
      Middle_Data : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_Middle_Identifier (
      ...
      Middle_Identifier_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Middle_Identifier);
   pragma inline (Put_Middle_Identifier);
   ...
   procedure Put_Middle_Data (
      This_Object : in Root_Object.Object_Access;
      Middle_Data_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Middle_Data);
   pragma inline (Put_Middle_Data);
