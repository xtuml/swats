...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSL1.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjSL1
...
--  ----------------------------------  
--  package Root_Object.Relationships.objSL1
...
package Root_Object.Relationships.objSL1 is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_L1 Information **************
   --
   -- Object objSL1 is PASSIVE
   --
   -- Object objSL1 participates in a super sub type relationship
   --
   --
   --
   -- Object objSL1 is a SUB type of objL via Relationship R26
   --
   -- Object objSL1 does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objSL1 has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objSL1";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objSL1_Type is new Relationships_Type with record
      ...
      idSL1 : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_idSL1 (
      This_Object : in Root_Object.Object_Access;
      idSL1_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idSL1);
   pragma inline (Put_idSL1);
