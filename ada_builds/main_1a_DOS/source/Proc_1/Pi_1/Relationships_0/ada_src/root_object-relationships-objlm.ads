...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objLM.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjLM
...
--  ----------------------------------  
--  package Root_Object.Relationships.objLM
...
package Root_Object.Relationships.objLM is
--
------------------------------------------------------------------------
   --
   --**************  Object Left_Many Information **************
   --
   -- Object objLM is PASSIVE
   --
   --
   --
   -- Object objLM has an identifying non-referential attribute idLM 
   -- and therefore may be uniquely created.
   -- 
   -- Object objLM has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objLM";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objLM_Type is new Relationships_Type with record
