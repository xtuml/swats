...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objBM.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjBM
...
--  ----------------------------------  
--  package Root_Object.Relationships.objBM
...
package Root_Object.Relationships.objBM is
--
------------------------------------------------------------------------
   --
   --**************  Object Bottom_Many Information **************
   --
   -- Object objBM is PASSIVE
   --
   --
   --
   -- Object objBM has an identifying non-referential attribute idBM 
   -- and therefore may be uniquely created.
   -- 
   -- Object objBM has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objBM";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objBM_Type is new Relationships_Type with record
      ...
      idBM : Application_Types.Base_Integer_Type;

      --
      R16_A : Root_Object.Object_Access := null;
   ...
   procedure Put_idBM (
      ...
      idBM_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idBM);
   pragma inline (Put_idBM);
   ...
   procedure Put_R16_A (
      This_Object :   in  Root_Object.Object_Access;
      R16_A_Value : in Root_Object.Object_Access);

   pragma inline (Get_R16_A);
   pragma inline (Put_R16_A);
