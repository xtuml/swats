...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objM.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjM
...
--  ----------------------------------  
--  package Root_Object.Relationships.objM
...
package Root_Object.Relationships.objM is
--
------------------------------------------------------------------------
   --
   ...
   --
   --
   -- Object objM has an identifying non-referential attribute idM 
   ...
   type Relationships_objM_Type is new Relationships_Type with record
      ...
      --
      R18_A : Root_Object.Object_Access := null;
   ...
   procedure Put_idM (
      ...
      idM_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idM);
   pragma inline (Put_idM);
   ...
   procedure Put_R18_A (
      This_Object :   in  Root_Object.Object_Access;
      R18_A_Value : in Root_Object.Object_Access);

   pragma inline (Get_R18_A);
   pragma inline (Put_R18_A);
