...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSL1.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjSL1
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objSL1 is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSL1_Type (This_Object.all).idH;
   end Get_idH;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSL1_Type (This_Object.all).idH :=
         idH_Value;
   end Put_idH;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_idSL1 (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_objSL1_Type (This_Object.all).idSL1;
   end Get_idSL1;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_idSL1 (
      This_Object : in Root_Object.Object_Access;
      idSL1_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objSL1_Type (This_Object.all).idSL1 :=
         idSL1_Value;
   end Put_idSL1;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSL1_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSL1_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSL1_Type (This_Object.all).R26_Super;
   end Get_R26_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSL1_Type (This_Object.all).R26_Super :=
         R26_Super_Value;
   end Put_R26_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objSL1_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objSL1_Type(This_Object.all).idH := Application_Types.Base_Integer_Type_First;
         Relationships_objSL1_Type(This_Object.all).idSL1 := Application_Types.Base_Integer_Type_First;
         Relationships_objSL1_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
end Root_Object.Relationships.objSL1;
