...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSSSL1.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjSSSL1
...
--  ----------------------------------  
--  package Root_Object.Relationships.objSSSL1
...
package Root_Object.Relationships.objSSSL1 is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_Sub_Sub_L1 Information **************
   --
   -- Object objSSSL1 is PASSIVE
   --
   -- Object objSSSL1 participates in a super sub type relationship
   --
   --
   --
   -- Object objSSSL1 is a SUB type of objSSL2 via Relationship R28
   --
   -- Object objSSSL1 does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objSSSL1 has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objSSSL1";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objSSSL1_Type is new Relationships_Type with record
      ...
      idSSSL1 : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_idSSSL1 (
      This_Object : in Root_Object.Object_Access;
      idSSSL1_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idSSSL1);
   pragma inline (Put_idSSSL1);
