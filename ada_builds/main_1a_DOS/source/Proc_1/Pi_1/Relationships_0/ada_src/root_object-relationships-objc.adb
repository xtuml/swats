...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objC.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjC
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objC is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_objC_Type (This_Object.all).idC;
   end Get_idC;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objC_Type (This_Object.all).idC :=
         idC_Value;
   end Put_idC;
...
------------------------------------------------------------------------
   --
   -- procedure Put_idD and 
   --
   -- function Get_idD
   --
   -- have not been generated for idD
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objC_Type (This_Object.all).R3_B;
   end Get_R3_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objC_Type (This_Object.all).R3_B :=
         R3_B_Value;
   end Put_R3_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objC_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objC_Type(This_Object.all).idC := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.objC;
