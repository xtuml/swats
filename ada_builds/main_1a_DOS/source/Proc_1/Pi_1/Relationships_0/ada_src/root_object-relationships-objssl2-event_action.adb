...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSSL2.event_action.ada
...
--*  separate of Root_Object.RelationshipsobjSSL2
--*     Event_Action
--*
--*************************************************************************************
--  MODIFICATION RECORD
...
separate (Root_Object.Relationships.objSSL2)
...
begin
   ...
   This_Action := Relationships_objSSL2_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := Relationships_objSSL2_Instance_Event_Type(This_Event.all).Target_Instance;
   ...
   if This /= null then
      ...
      --  
      This_Event_Dispatch_Matrix (This_Action, Relationships_objSSL2_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
