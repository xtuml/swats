...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objH.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjH
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objH is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idH_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idH return Application_Types.Base_Integer_Type is
   begin
      idH_Value :=
         Application_Types.Base_Integer_Type'succ (idH_Value);
      return idH_Value;
   end Obtain_Subsequent_idH;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_objH_Type (This_Object.all).idH;
   end Get_idH;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objH_Type (This_Object.all).idH :=
         idH_Value;
   end Put_idH;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_objH_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objH_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objH_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objH_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objH_Type (This_Object.all).R9_Sub;
   end Get_R9_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objH_Type (This_Object.all).R9_Sub :=
         R9_Sub_Value;
   end Put_R9_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objH_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objH_Type(This_Object.all).idH := Application_Types.Base_Integer_Type_First;
         Relationships_objH_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
         Relationships_objH_Type(This_Object.all).Current_State :=  Object_State_Type_First;
