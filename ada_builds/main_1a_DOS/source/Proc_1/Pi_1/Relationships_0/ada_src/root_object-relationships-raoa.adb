...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.RAOA.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsRAOA
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.RAOA is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   RAOA_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_RAOA_id return Application_Types.Base_Integer_Type is
   begin
      RAOA_id_Value :=
         Application_Types.Base_Integer_Type'succ (RAOA_id_Value);
      return RAOA_id_Value;
   end Obtain_Subsequent_RAOA_id;
...
--ADATEST IGNORE_ON
   procedure Put_RAOA_id (
      This_Object : in Root_Object.Object_Access;
      RAOA_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_RAOA_Type (This_Object.all).RAOA_id :=
         RAOA_id_Value;
   end Put_RAOA_id;
...
------------------------------------------------------------------------
   --
   -- procedure Put_RAOA_id_R_SEVENTEEN and 
   --
   -- function Get_RAOA_id_R_SEVENTEEN
   --
   -- have not been generated for RAOA_id_R_SEVENTEEN
   -- as this attribute is non-identifying referential.
   --
------------------------------------------------------------------------
   --
   -- procedure Put_RAOA_id_R_TWENTY_THREE and 
   --
   -- function Get_RAOA_id_R_TWENTY_THREE
   --
   -- have not been generated for RAOA_id_R_TWENTY_THREE
   -- as this attribute is non-identifying referential.
   --
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_RAOA_Type (This_Object.all).R17_A;
   end Get_R17_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R17_A (
      This_Object : in Root_Object.Object_Access;
      R17_A_Value : in Root_Object.Object_Access) is
   begin
      Relationships_RAOA_Type (This_Object.all).R17_A :=
         R17_A_Value;
   end Put_R17_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_RAOA_Type (This_Object.all).R17_B;
   end Get_R17_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R17_B (
      This_Object : in Root_Object.Object_Access;
      R17_B_Value : in Root_Object.Object_Access) is

   begin
      Relationships_RAOA_Type (This_Object.all).R17_B :=
         R17_B_Value;
   end Put_R17_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R23_A (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Relationships_RAOA_Type (This_Object.all).R23_A;
   end Get_R23_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R23_A (
      This_Object : in Root_Object.Object_Access;
      R23_A_Value : in Root_Object.Object_Access) is
   begin
      Relationships_RAOA_Type (This_Object.all).R23_A :=
         R23_A_Value;
   end Put_R23_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_RAOA_Type (This_Object.all).R23_B;
   end Get_R23_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R23_B (
      This_Object : in Root_Object.Object_Access;
      R23_B_Value : in Root_Object.Object_Access) is

   begin
      Relationships_RAOA_Type (This_Object.all).R23_B :=
         R23_B_Value;
   end Put_R23_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_RAOA_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_RAOA_Type(This_Object.all).RAOA_id := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.RAOA;
