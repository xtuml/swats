...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSSL3.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjSSL3
...
--  ----------------------------------  
--  package Root_Object.Relationships.objSSL3
...
package Root_Object.Relationships.objSSL3 is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_Sub_L3 Information **************
   --
   -- Object objSSL3 is PASSIVE
   --
   -- Object objSSL3 participates in a super sub type relationship
   --
   --
   --
   -- Object objSSL3 is a SUB type of objSL3 via Relationship R27
   --
   -- Object objSSL3 does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objSSL3 has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objSSL3";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objSSL3_Type is new Relationships_Type with record
      ...
      idSSL3 : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_idSSL3 (
      This_Object : in Root_Object.Object_Access;
      idSSL3_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idSSL3);
   pragma inline (Put_idSSL3);
