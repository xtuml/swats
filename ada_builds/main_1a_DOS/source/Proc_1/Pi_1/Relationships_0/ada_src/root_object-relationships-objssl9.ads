...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSSL9.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjSSL9
...
--  ----------------------------------  
--  package Root_Object.Relationships.objSSL9
...
package Root_Object.Relationships.objSSL9 is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_Sub_L9 Information **************
   --
   -- Object objSSL9 is PASSIVE
   --
   -- Object objSSL9 participates in a super sub type relationship
   --
   --
   --
   -- Object objSSL9 is a SUB type of objSL3 via Relationship R30
   --
   -- Object objSSL9 does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objSSL9 has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objSSL9";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objSSL9_Type is new Relationships_Type with record
      ...
      idSSL9 : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      Current_State :  Object_State_Type :=  Object_State_Type_First;

      R30_Super : Root_Object.Object_Access := null;
   ...
   procedure Put_idSSL9 (
      This_Object : in Root_Object.Object_Access;
      idSSL9_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idSSL9);
   pragma inline (Put_idSSL9);
   ...
   procedure Put_R30_Super (
      This_Object : in  Root_Object.Object_Access;
      R30_Super_Value : in Root_Object.Object_Access);

   pragma inline (Get_R30_Super);
   pragma inline (Put_R30_Super);
