...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objLMRM.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjLMRM
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objLMRM is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objLMRM_Type (This_Object.all).idLM;
   end Get_idLM;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_idLM (
      ...
      idLM_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objLMRM_Type (This_Object.all).idLM :=
         idLM_Value;
   end Put_idLM;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_idRM (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_objLMRM_Type (This_Object.all).idRM;
   end Get_idRM;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_idRM (
      This_Object : in Root_Object.Object_Access;
      idRM_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objLMRM_Type (This_Object.all).idRM :=
         idRM_Value;
   end Put_idRM;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_idLMRM (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_objLMRM_Type (This_Object.all).idLMRM;
   end Get_idLMRM;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_idLMRM (
      This_Object : in Root_Object.Object_Access;
      idLMRM_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objLMRM_Type (This_Object.all).idLMRM :=
         idLMRM_Value;
   end Put_idLMRM;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objLMRM_Type (This_Object.all).R16_B;
   end Get_R16_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R16_B (
      This_Object : in Root_Object.Object_Access;
      R16_B_Value : in Root_Object.Object_List.List_Header_Access_Type) is
   begin
      Relationships_objLMRM_Type (This_Object.all).R16_B :=
         R16_B_Value;
   end Put_R16_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objLMRM_Type;
   
         Relationships_objLMRM_Type(This_Object.all).R16_B := Root_Object.Object_List.Initialise;
      else
         This_Object := Free_List.First_Entry;
         Relationships_objLMRM_Type(This_Object.all).idLM := Application_Types.Base_Integer_Type_First;
         Relationships_objLMRM_Type(This_Object.all).idRM := Application_Types.Base_Integer_Type_First;
         Relationships_objLMRM_Type(This_Object.all).idLMRM := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.objLMRM;
