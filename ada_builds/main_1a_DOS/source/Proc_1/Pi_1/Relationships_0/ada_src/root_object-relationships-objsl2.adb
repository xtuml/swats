...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSL2.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjSL2
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objSL2 is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSL2_Type (This_Object.all).idH;
   end Get_idH;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSL2_Type (This_Object.all).idH :=
         idH_Value;
   end Put_idH;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_idSL2 (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_objSL2_Type (This_Object.all).idSL2;
   end Get_idSL2;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_idSL2 (
      This_Object : in Root_Object.Object_Access;
      idSL2_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objSL2_Type (This_Object.all).idSL2 :=
         idSL2_Value;
   end Put_idSL2;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSL2_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSL2_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSL2_Type (This_Object.all).R26_Super;
   end Get_R26_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSL2_Type (This_Object.all).R26_Super :=
         R26_Super_Value;
   end Put_R26_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objSL2_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objSL2_Type(This_Object.all).idH := Application_Types.Base_Integer_Type_First;
         Relationships_objSL2_Type(This_Object.all).idSL2 := Application_Types.Base_Integer_Type_First;
         Relationships_objSL2_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
end Root_Object.Relationships.objSL2;
