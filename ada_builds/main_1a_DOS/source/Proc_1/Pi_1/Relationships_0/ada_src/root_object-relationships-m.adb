...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.M.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsM
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.M is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Middle_Identifier_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Middle_Identifier return Application_Types.Base_Integer_Type is
   begin
      Middle_Identifier_Value :=
         Application_Types.Base_Integer_Type'succ (Middle_Identifier_Value);
      return Middle_Identifier_Value;
   end Obtain_Subsequent_Middle_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_M_Type (This_Object.all).Middle_Identifier;
   end Get_Middle_Identifier;
...
--ADATEST IGNORE_ON
   procedure Put_Middle_Identifier (
      This_Object : in Root_Object.Object_Access;
      Middle_Identifier_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_M_Type (This_Object.all).Middle_Identifier :=
         Middle_Identifier_Value;
   end Put_Middle_Identifier;
...
--ADATEST IGNORE_ON
   function Get_Middle_Data (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_M_Type (This_Object.all).Middle_Data;
   end Get_Middle_Data;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Middle_Data (
      This_Object : in Root_Object.Object_Access;
      Middle_Data_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_M_Type (This_Object.all).Middle_Data :=
         Middle_Data_Value;
   end Put_Middle_Data;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_M_Type (This_Object.all).R6_A;
   end Get_R6_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_M_Type (This_Object.all).R6_A :=
         R6_A_Value;
   end Put_R6_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_M_Type (This_Object.all).R7_B;
   end Get_R7_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_M_Type (This_Object.all).R7_B :=
         R7_B_Value;
   end Put_R7_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_M_Type;
   
         Relationships_M_Type(This_Object.all).R7_B := Root_Object.Object_List.Initialise;
      else
         This_Object := Free_List.First_Entry;
         Relationships_M_Type(This_Object.all).Middle_Identifier := Application_Types.Base_Integer_Type_First;
         Relationships_M_Type(This_Object.all).Middle_Data := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Relationships_M_Type(This_Object.all).Middle_Identifier :=
         Obtain_Subsequent_Middle_Identifier;
...
end Root_Object.Relationships.M;
