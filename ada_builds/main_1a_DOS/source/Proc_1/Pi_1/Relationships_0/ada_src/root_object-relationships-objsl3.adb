...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSL3.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjSL3
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objSL3 is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSL3_Type (This_Object.all).idH;
   end Get_idH;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSL3_Type (This_Object.all).idH :=
         idH_Value;
   end Put_idH;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_idSL3 (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_objSL3_Type (This_Object.all).idSL3;
   end Get_idSL3;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_idSL3 (
      This_Object : in Root_Object.Object_Access;
      idSL3_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objSL3_Type (This_Object.all).idSL3 :=
         idSL3_Value;
   end Put_idSL3;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSL3_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSL3_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSL3_Type (This_Object.all).R27_Sub;
   end Get_R27_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R27_Sub (
      This_Object : in Root_Object.Object_Access;
      R27_Sub_Value : in Root_Object.Object_Access) is
   begin
      Relationships_objSL3_Type (This_Object.all).R27_Sub :=
         R27_Sub_Value;
   end Put_R27_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R29_Sub (
      This_Object: Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Relationships_objSL3_Type (This_Object.all).R29_Sub;
   end Get_R29_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R29_Sub (
      This_Object : in Root_Object.Object_Access;
      R29_Sub_Value : in Root_Object.Object_Access) is
   begin
      Relationships_objSL3_Type (This_Object.all).R29_Sub :=
         R29_Sub_Value;
   end Put_R29_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R30_Sub (
      This_Object: Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Relationships_objSL3_Type (This_Object.all).R30_Sub;
   end Get_R30_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R30_Sub (
      This_Object : in Root_Object.Object_Access;
      R30_Sub_Value : in Root_Object.Object_Access) is
   begin
      Relationships_objSL3_Type (This_Object.all).R30_Sub :=
         R30_Sub_Value;
   end Put_R30_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R31_Sub (
      This_Object: Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Relationships_objSL3_Type (This_Object.all).R31_Sub;
   end Get_R31_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R31_Sub (
      This_Object : in Root_Object.Object_Access;
      R31_Sub_Value : in Root_Object.Object_Access) is
   begin
      Relationships_objSL3_Type (This_Object.all).R31_Sub :=
         R31_Sub_Value;
   end Put_R31_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R26_Super (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Relationships_objSL3_Type (This_Object.all).R26_Super;
   end Get_R26_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSL3_Type (This_Object.all).R26_Super :=
         R26_Super_Value;
   end Put_R26_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objSL3_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objSL3_Type(This_Object.all).idH := Application_Types.Base_Integer_Type_First;
         Relationships_objSL3_Type(This_Object.all).idSL3 := Application_Types.Base_Integer_Type_First;
         Relationships_objSL3_Type(This_Object.all).Current_State :=  Object_State_Type_First;
