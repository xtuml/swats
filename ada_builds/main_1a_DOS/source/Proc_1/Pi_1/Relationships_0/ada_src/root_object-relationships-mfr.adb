...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.MFR.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsMFR
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.MFR is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   MFR_Identifier_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_MFR_Identifier return Application_Types.Base_Integer_Type is
   begin
      MFR_Identifier_Value :=
         Application_Types.Base_Integer_Type'succ (MFR_Identifier_Value);
      return MFR_Identifier_Value;
   end Obtain_Subsequent_MFR_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_MFR_Type (This_Object.all).MFR_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_MFR_Type (This_Object.all).MFR_Identifier :=
         MFR_Identifier_Value;
...
--ADATEST IGNORE_ON
   function Get_MFR_Data (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_MFR_Type (This_Object.all).MFR_Data;
   end Get_MFR_Data;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_MFR_Data (
      This_Object : in Root_Object.Object_Access;
      MFR_Data_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_MFR_Type (This_Object.all).MFR_Data :=
         MFR_Data_Value;
   end Put_MFR_Data;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_MFR_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_MFR_Type(This_Object.all).MFR_Identifier := Application_Types.Base_Integer_Type_First;
         Relationships_MFR_Type(This_Object.all).MFR_Data := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Relationships_MFR_Type(This_Object.all).MFR_Identifier :=
         Obtain_Subsequent_MFR_Identifier;
...
end Root_Object.Relationships.MFR;
