...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSSL7.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjSSL7
...
--  ----------------------------------  
--  package Root_Object.Relationships.objSSL7
...
package Root_Object.Relationships.objSSL7 is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_Sub_L7 Information **************
   --
   -- Object objSSL7 is PASSIVE
   --
   -- Object objSSL7 participates in a super sub type relationship
   --
   --
   --
   -- Object objSSL7 is a SUB type of objSL3 via Relationship R29
   --
   -- Object objSSL7 does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objSSL7 has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objSSL7";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objSSL7_Type is new Relationships_Type with record
      ...
      idSSL7 : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_idSSL7 (
      This_Object : in Root_Object.Object_Access;
      idSSL7_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idSSL7);
   pragma inline (Put_idSSL7);
