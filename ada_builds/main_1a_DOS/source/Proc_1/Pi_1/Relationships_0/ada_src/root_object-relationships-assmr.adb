...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.assMR.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsassMR
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.assMR is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_assMR_Type (This_Object.all).idMO;
   end Get_idMO;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_assMR_Type (This_Object.all).idMO :=
         idMO_Value;
   end Put_idMO;
--ADATEST IGNORE_OFF
...
------------------------------------------------------------------------
   --
   -- procedure Put_idRO and 
   --
   -- function Get_idRO
   --
   -- have not been generated for idRO
...
--ADATEST IGNORE_ON
   function Get_idMR (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_assMR_Type (This_Object.all).idMR;
   end Get_idMR;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_idMR (
      This_Object : in Root_Object.Object_Access;
      idMR_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_assMR_Type (This_Object.all).idMR :=
         idMR_Value;
   end Put_idMR;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_assMR_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_assMR_Type(This_Object.all).idMO := Application_Types.Base_Integer_Type_First;
         Relationships_assMR_Type(This_Object.all).idMR := Application_Types.Base_Integer_Type_First;
