...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSSL5.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjSSL5
...
--  ----------------------------------  
--  package Root_Object.Relationships.objSSL5
...
package Root_Object.Relationships.objSSL5 is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_Sub_L5 Information **************
   --
   -- Object objSSL5 is PASSIVE
   --
   -- Object objSSL5 participates in a super sub type relationship
   --
   --
   --
   -- Object objSSL5 is a SUB type of objSL3 via Relationship R29
   --
   -- Object objSSL5 does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objSSL5 has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objSSL5";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objSSL5_Type is new Relationships_Type with record
      ...
      idSSL5 : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_idSSL5 (
      This_Object : in Root_Object.Object_Access;
      idSSL5_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idSSL5);
   pragma inline (Put_idSSL5);
