...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objB.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjB
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objB is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_objB_Type (This_Object.all).idB;
   end Get_idB;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objB_Type (This_Object.all).idB :=
         idB_Value;
   end Put_idB;
...
------------------------------------------------------------------------
   --
   -- procedure Put_idA and 
   --
   -- function Get_idA
   --
   -- have not been generated for idA
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_objB_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objB_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
------------------------------------------------------------------------
   --
   -- procedure Put_idM and 
   --
   -- function Get_idM
   --
   -- have not been generated for idM
   -- as this attribute is non-identifying referential.
   --
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objB_Type (This_Object.all).R1_A;
   end Get_R1_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objB_Type (This_Object.all).R1_A :=
         R1_A_Value;
   end Put_R1_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R18_B (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Relationships_objB_Type (This_Object.all).R18_B;
   end Get_R18_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R18_B (
      This_Object : in Root_Object.Object_Access;
      R18_B_Value : in Root_Object.Object_Access) is
   begin
      Relationships_objB_Type (This_Object.all).R18_B :=
         R18_B_Value;
   end Put_R18_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objB_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objB_Type(This_Object.all).idB := Application_Types.Base_Integer_Type_First;
         Relationships_objB_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.objB;
