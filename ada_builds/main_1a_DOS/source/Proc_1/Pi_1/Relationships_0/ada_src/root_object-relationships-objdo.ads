...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objDO.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjDO
...
--  ----------------------------------  
--  package Root_Object.Relationships.objDO
...
package Root_Object.Relationships.objDO is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_DO Information **************
   --
   -- Object objDO is PASSIVE
   --
   --
   --
   -- Object objDO does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objDO has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objDO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objDO_Type is new Relationships_Type with record
      ...
      idO : Application_Types.Base_Integer_Type;

      --
      -- Initialised Non identifying non referential
      idDO : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_idO (
      ...
      idO_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idO);
   pragma inline (Put_idO);
   ...
   procedure Put_idDO (
      This_Object : in Root_Object.Object_Access;
      idDO_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idDO);
   pragma inline (Put_idDO);
...
end Root_Object.Relationships.objDO;
