...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSSSL2.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjSSSL2
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objSSSL2 is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSSSL2_Type (This_Object.all).idH;
   end Get_idH;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSSSL2_Type (This_Object.all).idH :=
         idH_Value;
   end Put_idH;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_idSSSL2 (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_objSSSL2_Type (This_Object.all).idSSSL2;
   end Get_idSSSL2;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_idSSSL2 (
      This_Object : in Root_Object.Object_Access;
      idSSSL2_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objSSSL2_Type (This_Object.all).idSSSL2 :=
         idSSSL2_Value;
   end Put_idSSSL2;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSSSL2_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSSSL2_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   function  Get_R28_Super (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Relationships_objSSSL2_Type (This_Object.all).R28_Super;
   end Get_R28_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R28_Super (
      This_Object : in  Root_Object.Object_Access;
      R28_Super_Value : in Root_Object.Object_Access) is
   begin
      Relationships_objSSSL2_Type (This_Object.all).R28_Super :=
         R28_Super_Value;
   end Put_R28_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objSSSL2_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objSSSL2_Type(This_Object.all).idH := Application_Types.Base_Integer_Type_First;
         Relationships_objSSSL2_Type(This_Object.all).idSSSL2 := Application_Types.Base_Integer_Type_First;
         Relationships_objSSSL2_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
end Root_Object.Relationships.objSSSL2;
