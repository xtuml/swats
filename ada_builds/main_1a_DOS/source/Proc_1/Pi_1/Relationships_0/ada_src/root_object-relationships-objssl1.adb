...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSSL1.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjSSL1
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objSSL1 is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSSL1_Type (This_Object.all).idH;
   end Get_idH;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSSL1_Type (This_Object.all).idH :=
         idH_Value;
   end Put_idH;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_idSSL1 (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_objSSL1_Type (This_Object.all).idSSL1;
   end Get_idSSL1;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_idSSL1 (
      This_Object : in Root_Object.Object_Access;
      idSSL1_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objSSL1_Type (This_Object.all).idSSL1 :=
         idSSL1_Value;
   end Put_idSSL1;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSSL1_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSSL1_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSSL1_Type (This_Object.all).R27_Super;
   end Get_R27_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSSL1_Type (This_Object.all).R27_Super :=
         R27_Super_Value;
   end Put_R27_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objSSL1_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objSSL1_Type(This_Object.all).idH := Application_Types.Base_Integer_Type_First;
         Relationships_objSSL1_Type(This_Object.all).idSSL1 := Application_Types.Base_Integer_Type_First;
         Relationships_objSSL1_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
end Root_Object.Relationships.objSSL1;
