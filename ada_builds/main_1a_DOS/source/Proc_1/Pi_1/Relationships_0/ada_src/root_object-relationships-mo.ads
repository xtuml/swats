...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.MO.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsMO
...
--  ----------------------------------  
--  package Root_Object.Relationships.MO
...
package Root_Object.Relationships.MO is
--
------------------------------------------------------------------------
   --
   --**************  Object Middle_Object Information **************
   --
   -- Object MO is PASSIVE
   --
   --
   --
   -- Object MO has an identifying non-referential attribute idMO 
   -- and therefore may be uniquely created.
   -- 
   -- Object MO has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "MO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_MO_Type is new Relationships_Type with record
      ...
      -- idLO : Application_Types.Base_Integer_Type;
