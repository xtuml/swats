...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.TN.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsTN
...
--  ----------------------------------  
--  package Root_Object.Relationships.TN
...
package Root_Object.Relationships.TN is
--
------------------------------------------------------------------------
   --
   --**************  Object Test_Data Information **************
   --
   -- Object TN is PASSIVE
   --
   --
   --
