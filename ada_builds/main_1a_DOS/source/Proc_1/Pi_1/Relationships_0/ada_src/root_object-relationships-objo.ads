...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objO.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjO
...
--  ----------------------------------  
--  package Root_Object.Relationships.objO
...
package Root_Object.Relationships.objO is
--
------------------------------------------------------------------------
   --
   ...
   --
   --
   -- Object objO has an identifying non-referential attribute idO 
   ...
   type Relationships_objO_Type is new Relationships_Type with record
