...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.RO.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsRO
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.RO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idRO_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idRO return Application_Types.Base_Integer_Type is
   begin
      idRO_Value :=
         Application_Types.Base_Integer_Type'succ (idRO_Value);
      return idRO_Value;
   end Obtain_Subsequent_idRO;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_RO_Type (This_Object.all).idRO;
   end Get_idRO;
...
--ADATEST IGNORE_ON
   procedure Put_idRO (
      ...
      idRO_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_RO_Type (This_Object.all).idRO :=
         idRO_Value;
   end Put_idRO;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_RO_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_RO_Type(This_Object.all).idRO := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.RO;
