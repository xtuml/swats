...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objA.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjA
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objA is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_objA_Type (This_Object.all).idA;
   end Get_idA;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objA_Type (This_Object.all).idA :=
         idA_Value;
   end Put_idA;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objA_Type (This_Object.all).R1_B;
   end Get_R1_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objA_Type (This_Object.all).R1_B :=
         R1_B_Value;
   end Put_R1_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objA_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objA_Type(This_Object.all).idA := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.objA;
