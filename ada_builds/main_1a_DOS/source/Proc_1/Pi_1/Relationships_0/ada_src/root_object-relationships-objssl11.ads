...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSSL11.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjSSL11
...
--  ----------------------------------  
--  package Root_Object.Relationships.objSSL11
...
package Root_Object.Relationships.objSSL11 is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_Sub_L11 Information **************
   --
   -- Object objSSL11 is PASSIVE
   --
   -- Object objSSL11 participates in a super sub type relationship
   --
   --
   --
   -- Object objSSL11 is a SUB type of objSL3 via Relationship R31
   --
   -- Object objSSL11 does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objSSL11 has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objSSL11";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objSSL11_Type is new Relationships_Type with record
      ...
      idSSL11 : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      Current_State :  Object_State_Type :=  Object_State_Type_First;

      R31_Super : Root_Object.Object_Access := null;
   ...
   procedure Put_idSSL11 (
      This_Object : in Root_Object.Object_Access;
      idSSL11_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idSSL11);
   pragma inline (Put_idSSL11);
   ...
   procedure Put_R31_Super (
      This_Object : in  Root_Object.Object_Access;
      R31_Super_Value : in Root_Object.Object_Access);

   pragma inline (Get_R31_Super);
   pragma inline (Put_R31_Super);
