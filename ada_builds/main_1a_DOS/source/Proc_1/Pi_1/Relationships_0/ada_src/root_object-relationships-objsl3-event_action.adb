...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSL3.event_action.ada
...
--*  separate of Root_Object.RelationshipsobjSL3
--*     Event_Action
--*
--*************************************************************************************
--  MODIFICATION RECORD
...
separate (Root_Object.Relationships.objSL3)
...
begin
   ...
   This_Action := Relationships_objSL3_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := Relationships_objSL3_Instance_Event_Type(This_Event.all).Target_Instance;
   ...
   if This /= null then
      ...
      --  
      This_Event_Dispatch_Matrix (This_Action, Relationships_objSL3_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
