...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objF.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjF
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objF is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idF_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idF return Application_Types.Base_Integer_Type is
   begin
      idF_Value :=
         Application_Types.Base_Integer_Type'succ (idF_Value);
      return idF_Value;
   end Obtain_Subsequent_idF;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_objF_Type (This_Object.all).idF;
   end Get_idF;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objF_Type (This_Object.all).idF :=
         idF_Value;
   end Put_idF;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objF_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objF_Type(This_Object.all).idF := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.objF;
