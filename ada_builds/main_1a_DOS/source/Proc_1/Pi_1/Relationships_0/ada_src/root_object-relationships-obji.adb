...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objI.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjI
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objI is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objI_Type (This_Object.all).idH;
   end Get_idH;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objI_Type (This_Object.all).idH :=
         idH_Value;
   end Put_idH;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_objI_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objI_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_IDI (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_objI_Type (This_Object.all).IDI;
   end Get_IDI;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_IDI (
      This_Object : in Root_Object.Object_Access;
      IDI_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objI_Type (This_Object.all).IDI :=
         IDI_Value;
   end Put_IDI;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objI_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objI_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objI_Type (This_Object.all).R9_Super;
   end Get_R9_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objI_Type (This_Object.all).R9_Super :=
         R9_Super_Value;
   end Put_R9_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objI_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objI_Type(This_Object.all).idH := Application_Types.Base_Integer_Type_First;
         Relationships_objI_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
         Relationships_objI_Type(This_Object.all).IDI := Application_Types.Base_Integer_Type_First;
         Relationships_objI_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
end Root_Object.Relationships.objI;
