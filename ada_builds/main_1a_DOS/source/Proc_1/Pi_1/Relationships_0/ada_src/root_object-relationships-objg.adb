...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objG.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjG
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objG is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objG_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objG_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
------------------------------------------------------------------------
   ...
   idG_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idG return Application_Types.Base_Integer_Type is
   begin
      idG_Value :=
         Application_Types.Base_Integer_Type'succ (idG_Value);
      return idG_Value;
   end Obtain_Subsequent_idG;
...
--ADATEST IGNORE_ON
   function Get_idG (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return Relationships_objG_Type (This_Object.all).idG;
   end Get_idG;
...
--ADATEST IGNORE_ON
   procedure Put_idG (
      This_Object : in Root_Object.Object_Access;
      idG_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objG_Type (This_Object.all).idG :=
         idG_Value;
   end Put_idG;
...
------------------------------------------------------------------------
   --
   -- procedure Put_idG_Reflexive_ID and 
   --
   -- function Get_idG_Reflexive_ID
   --
   -- have not been generated for idG_Reflexive_ID
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objG_Type (This_Object.all).R11_A;
   end Get_R11_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R11_A (
      This_Object : in Root_Object.Object_Access;
      R11_A_Value : in Root_Object.Object_Access) is
   begin
      Relationships_objG_Type (This_Object.all).R11_A :=
         R11_A_Value;
   end Put_R11_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objG_Type (This_Object.all).R11_B;
   end Get_R11_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R11_B (
      This_Object : in Root_Object.Object_Access;
      R11_B_Value : in Root_Object.Object_Access) is

   begin
      Relationships_objG_Type (This_Object.all).R11_B :=
         R11_B_Value;
   end Put_R11_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objG_Type (This_Object.all).R13_A;
   end Get_R13_A;
--ADATEST IGNORE_OFF
--
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   procedure Put_R13_A  (
      This_Object : in Root_Object.Object_Access;
      R13_A_Value : in Root_Object.Object_List.List_Header_Access_Type) is
   begin
      Relationships_objG_Type (This_Object.all).R13_A :=
         R13_A_Value;
   end Put_R13_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objG_Type (This_Object.all).R13_B;
   end Get_R13_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R13_B (
      This_Object : in Root_Object.Object_Access;
      R13_B_Value : in Root_Object.Object_Access) is

   begin
      Relationships_objG_Type (This_Object.all).R13_B :=
         R13_B_Value;
   end Put_R13_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R2_A (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Relationships_objG_Type (This_Object.all).R2_A;
   end Get_R2_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objG_Type (This_Object.all).R2_A :=
         R2_A_Value;
   end Put_R2_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objG_Type (This_Object.all).R2_B;
   end Get_R2_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objG_Type (This_Object.all).R2_B :=
         R2_B_Value;
   end Put_R2_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R4_A  (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_List.List_Header_Access_Type is
   begin
      return Relationships_objG_Type (This_Object.all).R4_A;
   end Get_R4_A;
--ADATEST IGNORE_OFF
--
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   procedure Put_R4_A  (
      This_Object : in Root_Object.Object_Access;
      R4_A_Value : in Root_Object.Object_List.List_Header_Access_Type) is
   begin
      Relationships_objG_Type (This_Object.all).R4_A :=
         R4_A_Value;
   end Put_R4_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objG_Type (This_Object.all).R4_B;
   end Get_R4_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R4_B (
      This_Object : in Root_Object.Object_Access;
      R4_B_Value : in Root_Object.Object_Access) is

   begin
      Relationships_objG_Type (This_Object.all).R4_B :=
         R4_B_Value;
   end Put_R4_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objG_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objG_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
         Relationships_objG_Type(This_Object.all).idG := Application_Types.Base_Integer_Type_First;
      ...
      Relationships_objG_Type(This_Object.all).R13_A := Root_Object.Object_List.Initialise;
      Relationships_objG_Type(This_Object.all).R4_A := Root_Object.Object_List.Initialise;
...
end Root_Object.Relationships.objG;
