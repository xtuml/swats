...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.RAOA.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsRAOA
...
--  ----------------------------------  
--  package Root_Object.Relationships.RAOA
...
package Root_Object.Relationships.RAOA is
--
------------------------------------------------------------------------
   --
   --**************  Object Ref_Att_ObjA Information **************
   --
   -- Object RAOA is PASSIVE
   --
   --
   --
   -- Object RAOA has an identifying non-referential attribute RAOA_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object RAOA has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "RAOA";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_RAOA_Type is new Relationships_Type with record

      --
      -- Non initialised identifying non referential
      RAOA_id : Application_Types.Base_Integer_Type;

      --
      -- Non Identifying referential. Thou Shalt Not Use. 
      -- RAOA_id_R_SEVENTEEN : Application_Types.Base_Integer_Type;
   
      --
      -- Non Identifying referential. Thou Shalt Not Use. 
      -- RAOA_id_R_TWENTY_THREE : Application_Types.Base_Integer_Type;
   
      --
      R17_A : Root_Object.Object_Access := null;
      R17_B : Root_Object.Object_Access := null;
      R23_A : Root_Object.Object_Access := null;
      R23_B : Root_Object.Object_Access := null;
   ...
   procedure Put_RAOA_id (
      ...
      RAOA_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_RAOA_id);
   pragma inline (Put_RAOA_id);
   ...
   procedure Put_R17_A (
      This_Object :   in  Root_Object.Object_Access;
      R17_A_Value : in Root_Object.Object_Access);

   pragma inline (Get_R17_A);
   pragma inline (Put_R17_A);
   ...
   procedure Put_R17_B (
      This_Object : in Root_Object.Object_Access;
      R17_B_Value : in Root_Object.Object_Access);

   pragma inline (Get_R17_B);
   pragma inline (Put_R17_B);
   ...
   procedure Put_R23_A (
      This_Object :   in  Root_Object.Object_Access;
      R23_A_Value : in Root_Object.Object_Access);

   pragma inline (Get_R23_A);
   pragma inline (Put_R23_A);
   ...
   procedure Put_R23_B (
      This_Object : in Root_Object.Object_Access;
      R23_B_Value : in Root_Object.Object_Access);

   pragma inline (Get_R23_B);
   pragma inline (Put_R23_B);
