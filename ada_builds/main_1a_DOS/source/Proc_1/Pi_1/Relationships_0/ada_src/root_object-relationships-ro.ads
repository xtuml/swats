...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.RO.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsRO
...
--  ----------------------------------  
--  package Root_Object.Relationships.RO
...
package Root_Object.Relationships.RO is
--
------------------------------------------------------------------------
   --
   --**************  Object Right_Object Information **************
   --
   -- Object RO is PASSIVE
   --
   --
   --
   -- Object RO has an identifying non-referential attribute idRO 
   -- and therefore may be uniquely created.
   -- 
   -- Object RO has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "RO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_RO_Type is new Relationships_Type with record
   ...
   procedure Put_idRO (
      ...
      idRO_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idRO);
   pragma inline (Put_idRO);
