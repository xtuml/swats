...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSSL1.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjSSL1
...
--  ----------------------------------  
--  package Root_Object.Relationships.objSSL1
...
package Root_Object.Relationships.objSSL1 is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_Sub_L1 Information **************
   --
   -- Object objSSL1 is PASSIVE
   --
   -- Object objSSL1 participates in a super sub type relationship
   --
   --
   --
   -- Object objSSL1 is a SUB type of objSL3 via Relationship R27
   --
   -- Object objSSL1 does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objSSL1 has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objSSL1";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objSSL1_Type is new Relationships_Type with record
      ...
      idSSL1 : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_idSSL1 (
      This_Object : in Root_Object.Object_Access;
      idSSL1_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idSSL1);
   pragma inline (Put_idSSL1);
