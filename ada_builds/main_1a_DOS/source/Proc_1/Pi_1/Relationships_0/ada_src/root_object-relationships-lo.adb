...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.LO.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsLO
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.LO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idLO_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idLO return Application_Types.Base_Integer_Type is
   begin
      idLO_Value :=
         Application_Types.Base_Integer_Type'succ (idLO_Value);
      return idLO_Value;
   end Obtain_Subsequent_idLO;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_LO_Type (This_Object.all).idLO;
   end Get_idLO;
...
--ADATEST IGNORE_ON
   procedure Put_idLO (
      ...
      idLO_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_LO_Type (This_Object.all).idLO :=
         idLO_Value;
   end Put_idLO;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_LO_Type (This_Object.all).R12_B;
   end Get_R12_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_LO_Type (This_Object.all).R12_B :=
         R12_B_Value;
   end Put_R12_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_LO_Type;
   
         Relationships_LO_Type(This_Object.all).R12_B := Root_Object.Object_List.Initialise;
      else
         This_Object := Free_List.First_Entry;
         Relationships_LO_Type(This_Object.all).idLO := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.LO;
