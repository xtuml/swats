...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objA.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjA
...
--  ----------------------------------  
--  package Root_Object.Relationships.objA
...
package Root_Object.Relationships.objA is
--
------------------------------------------------------------------------
   --
   ...
   type Relationships_objA_Type is new Relationships_Type with record
