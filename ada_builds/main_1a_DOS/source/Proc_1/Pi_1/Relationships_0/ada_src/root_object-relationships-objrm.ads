...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objRM.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjRM
...
--  ----------------------------------  
--  package Root_Object.Relationships.objRM
...
package Root_Object.Relationships.objRM is
--
------------------------------------------------------------------------
   --
   --**************  Object Right_Many Information **************
   --
   -- Object objRM is PASSIVE
   --
   --
   --
   -- Object objRM has an identifying non-referential attribute idRM 
   -- and therefore may be uniquely created.
   -- 
   -- Object objRM has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objRM";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objRM_Type is new Relationships_Type with record
