...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSSL2.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjSSL2
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objSSL2 is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSSL2_Type (This_Object.all).idH;
   end Get_idH;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSSL2_Type (This_Object.all).idH :=
         idH_Value;
   end Put_idH;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_idSSL2 (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_objSSL2_Type (This_Object.all).idSSL2;
   end Get_idSSL2;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_idSSL2 (
      This_Object : in Root_Object.Object_Access;
      idSSL2_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objSSL2_Type (This_Object.all).idSSL2 :=
         idSSL2_Value;
   end Put_idSSL2;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSSL2_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSSL2_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSSL2_Type (This_Object.all).R28_Sub;
   end Get_R28_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R28_Sub (
      This_Object : in Root_Object.Object_Access;
      R28_Sub_Value : in Root_Object.Object_Access) is
   begin
      Relationships_objSSL2_Type (This_Object.all).R28_Sub :=
         R28_Sub_Value;
   end Put_R28_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R27_Super (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Relationships_objSSL2_Type (This_Object.all).R27_Super;
   end Get_R27_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSSL2_Type (This_Object.all).R27_Super :=
         R27_Super_Value;
   end Put_R27_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objSSL2_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objSSL2_Type(This_Object.all).idH := Application_Types.Base_Integer_Type_First;
         Relationships_objSSL2_Type(This_Object.all).idSSL2 := Application_Types.Base_Integer_Type_First;
         Relationships_objSSL2_Type(This_Object.all).Current_State :=  Object_State_Type_First;
