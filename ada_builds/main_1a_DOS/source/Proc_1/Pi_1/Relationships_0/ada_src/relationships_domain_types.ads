...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Relationships_domain_types.ads
...
--* Description:             
--*                          Relationships Domain Data Types Package Specification
...
--*  package specification Relationships_Domain_Types 
--*
--*************************************************************************************
--  MODIFICATION RECORD
--  --------------------
...
package Relationships_Domain_Types is
   ...
   for Colour use (
      ...
      Green => 2,
      Black => 3);
   Colour_Enumeral_Count : constant Application_Types.Base_Integer_Type := 3;
   for Colour'Size use Application_Types.Base_Integer_Type'Size;
   Colour_First          : constant Colour := Colour'first;
   function Colour_To_Base_Integer_Type is new Ada.Unchecked_Conversion (Colour, Application_Types.Base_Integer_Type);
   function Base_Integer_Type_To_Colour is new Ada.Unchecked_Conversion (Application_Types.Base_Integer_Type, Colour);
...
----------------------------------------------------------------------------------------------
--
end Relationships_Domain_Types;
