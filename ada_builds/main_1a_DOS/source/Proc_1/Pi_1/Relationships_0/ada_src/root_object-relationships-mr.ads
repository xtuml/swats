...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.MR.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsMR
...
--  ----------------------------------  
--  package Root_Object.Relationships.MR
...
package Root_Object.Relationships.MR is
--
------------------------------------------------------------------------
   --
   --**************  Object Many_Right Information **************
   --
   -- Object MR is PASSIVE
   --
   --
   --
   -- Object MR has an identifying non-referential attribute Right_Identifier 
   -- and therefore may be uniquely created.
   -- 
   -- Object MR has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "MR";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_MR_Type is new Relationships_Type with record
      ...
      Right_Data : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
      ...
      --
      R7_A : Root_Object.Object_Access := null;
   ...
   procedure Put_Right_Data (
      This_Object : in Root_Object.Object_Access;
      Right_Data_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Right_Data);
   pragma inline (Put_Right_Data);
   ...
   procedure Put_R7_A (
      This_Object :   in  Root_Object.Object_Access;
      R7_A_Value : in Root_Object.Object_Access);

   pragma inline (Get_R7_A);
   pragma inline (Put_R7_A);
