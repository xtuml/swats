...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objR.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjR
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objR is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idR_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idR return Application_Types.Base_Integer_Type is
   begin
      idR_Value :=
         Application_Types.Base_Integer_Type'succ (idR_Value);
      return idR_Value;
   end Obtain_Subsequent_idR;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_objR_Type (This_Object.all).idR;
   end Get_idR;
...
--ADATEST IGNORE_ON
   procedure Put_idR (
      ...
      idR_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objR_Type (This_Object.all).idR :=
         idR_Value;
   end Put_idR;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objR_Type (This_Object.all).R21_A;
   end Get_R21_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R21_A (
      This_Object : in Root_Object.Object_Access;
      R21_A_Value : in Root_Object.Object_List.List_Header_Access_Type) is
   begin
      Relationships_objR_Type (This_Object.all).R21_A :=
         R21_A_Value;
   end Put_R21_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objR_Type (This_Object.all).R22_A;
   end Get_R22_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R22_A (
      This_Object : in Root_Object.Object_Access;
      R22_A_Value : in Root_Object.Object_Access) is
   begin
      Relationships_objR_Type (This_Object.all).R22_A :=
         R22_A_Value;
   end Put_R22_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objR_Type;
   
         Relationships_objR_Type(This_Object.all).R21_A := Root_Object.Object_List.Initialise;
      else
         This_Object := Free_List.First_Entry;
         Relationships_objR_Type(This_Object.all).idR := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.objR;
