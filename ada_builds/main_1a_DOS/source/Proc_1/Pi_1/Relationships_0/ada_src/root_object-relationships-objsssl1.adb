...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSSSL1.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjSSSL1
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objSSSL1 is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSSSL1_Type (This_Object.all).idH;
   end Get_idH;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSSSL1_Type (This_Object.all).idH :=
         idH_Value;
   end Put_idH;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_idSSSL1 (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_objSSSL1_Type (This_Object.all).idSSSL1;
   end Get_idSSSL1;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_idSSSL1 (
      This_Object : in Root_Object.Object_Access;
      idSSSL1_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objSSSL1_Type (This_Object.all).idSSSL1 :=
         idSSSL1_Value;
   end Put_idSSSL1;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSSSL1_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSSSL1_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objSSSL1_Type (This_Object.all).R28_Super;
   end Get_R28_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objSSSL1_Type (This_Object.all).R28_Super :=
         R28_Super_Value;
   end Put_R28_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objSSSL1_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objSSSL1_Type(This_Object.all).idH := Application_Types.Base_Integer_Type_First;
         Relationships_objSSSL1_Type(This_Object.all).idSSSL1 := Application_Types.Base_Integer_Type_First;
         Relationships_objSSSL1_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
end Root_Object.Relationships.objSSSL1;
