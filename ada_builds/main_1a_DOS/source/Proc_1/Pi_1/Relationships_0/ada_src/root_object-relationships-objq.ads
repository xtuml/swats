...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objQ.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjQ
...
--  ----------------------------------  
--  package Root_Object.Relationships.objQ
...
package Root_Object.Relationships.objQ is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_Q Information **************
   --
   -- Object objQ is PASSIVE
   --
   --
   --
   -- Object objQ has an identifying non-referential attribute idQ 
   ...
   type Relationships_objQ_Type is new Relationships_Type with record

      --
      -- Non initialised identifying non referential
      idQ : Application_Types.Base_Integer_Type;
      ...
      --
      R20_A : Root_Object.Object_Access := null;
      R21_B : Root_Object.Object_Access := null;
   ...
   procedure Put_idQ (
      ...
      idQ_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idQ);
   pragma inline (Put_idQ);
   ...
   procedure Put_R20_A (
      This_Object :   in  Root_Object.Object_Access;
      R20_A_Value : in Root_Object.Object_Access);

   pragma inline (Get_R20_A);
   pragma inline (Put_R20_A);
   ...
   procedure Put_R21_B (
      This_Object :   in  Root_Object.Object_Access;
      R21_B_Value : in Root_Object.Object_Access);

   pragma inline (Get_R21_B);
   pragma inline (Put_R21_B);
