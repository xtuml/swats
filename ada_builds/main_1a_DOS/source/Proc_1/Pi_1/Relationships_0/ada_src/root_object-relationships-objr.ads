...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objR.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjR
...
--  ----------------------------------  
--  package Root_Object.Relationships.objR
...
package Root_Object.Relationships.objR is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_R Information **************
   --
   -- Object objR is PASSIVE
   --
   --
   --
   -- Object objR has an identifying non-referential attribute idR 
   ...
   type Relationships_objR_Type is new Relationships_Type with record
   ...
   procedure Put_R21_A  (
      This_Object :    in  Root_Object.Object_Access;
      R21_A_Value : in Root_Object.Object_List.List_Header_Access_Type);

   pragma inline (Get_R21_A);
   pragma inline (Put_R21_A);
   ...
   procedure Put_R22_A (
      This_Object :   in  Root_Object.Object_Access;
      R22_A_Value : in Root_Object.Object_Access);

   pragma inline (Get_R22_A);
   pragma inline (Put_R22_A);
