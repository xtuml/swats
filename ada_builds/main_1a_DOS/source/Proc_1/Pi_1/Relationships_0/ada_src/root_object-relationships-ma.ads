...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.MA.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsMA
...
--  ----------------------------------  
--  package Root_Object.Relationships.MA
...
package Root_Object.Relationships.MA is
--
------------------------------------------------------------------------
   --
   --**************  Object Many_Above Information **************
   --
   -- Object MA is PASSIVE
   --
   --
   --
   -- Object MA has an identifying non-referential attribute ma_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object MA has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "MA";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_MA_Type is new Relationships_Type with record

      --
      -- Non initialised identifying non referential
      ma_id : Application_Types.Base_Integer_Type;
      ...
      Above_Data : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_ma_id (
      ...
      ma_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_ma_id);
   pragma inline (Put_ma_id);


   function Get_Above_Data (
      This_Object : Root_Object.Object_Access) 
   return Application_Types.Base_Integer_Type;

   procedure Put_Above_Data (
      This_Object : in Root_Object.Object_Access;
      Above_Data_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Above_Data);
   pragma inline (Put_Above_Data);
...
end Root_Object.Relationships.MA;
