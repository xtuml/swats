...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.RD.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsRD
...
--  ----------------------------------  
--  package Root_Object.Relationships.RD
...
package Root_Object.Relationships.RD is
--
------------------------------------------------------------------------
   --
   ...
   type Relationships_RD_Type is new Relationships_Type with record
