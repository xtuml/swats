...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objBM.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjBM
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objBM is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   --
   -- procedure Put_idLM and 
   --
   -- function Get_idLM
   --
   -- have not been generated for idLM
   -- as this attribute is non-identifying referential.
   --
------------------------------------------------------------------------
   --
   -- procedure Put_idRM and 
   --
   -- function Get_idRM
   --
   -- have not been generated for idRM
   -- as this attribute is non-identifying referential.
   --
------------------------------------------------------------------------

   idBM_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idBM return Application_Types.Base_Integer_Type is
   begin
      idBM_Value :=
         Application_Types.Base_Integer_Type'succ (idBM_Value);
      return idBM_Value;
   end Obtain_Subsequent_idBM;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_objBM_Type (This_Object.all).idBM;
   end Get_idBM;
...
--ADATEST IGNORE_ON
   procedure Put_idBM (
      ...
      idBM_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objBM_Type (This_Object.all).idBM :=
         idBM_Value;
   end Put_idBM;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objBM_Type (This_Object.all).R16_A;
   end Get_R16_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R16_A (
      This_Object : in Root_Object.Object_Access;
      R16_A_Value : in Root_Object.Object_Access) is
   begin
      Relationships_objBM_Type (This_Object.all).R16_A :=
         R16_A_Value;
   end Put_R16_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objBM_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objBM_Type(This_Object.all).idBM := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.objBM;
