...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.MA.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsMA
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.MA is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   --
   -- have not been generated for Right_Identifier
...
--ADATEST IGNORE_ON
   function Get_Above_Data (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_MA_Type (This_Object.all).Above_Data;
   end Get_Above_Data;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Above_Data (
      This_Object : in Root_Object.Object_Access;
      Above_Data_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_MA_Type (This_Object.all).Above_Data :=
         Above_Data_Value;
   end Put_Above_Data;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_MA_Type (This_Object.all).R10_A;
   end Get_R10_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_MA_Type (This_Object.all).R10_A :=
         R10_A_Value;
   end Put_R10_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_MA_Type;
