...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objM.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjM
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objM is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idM_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idM return Application_Types.Base_Integer_Type is
   begin
      idM_Value :=
         Application_Types.Base_Integer_Type'succ (idM_Value);
      return idM_Value;
   end Obtain_Subsequent_idM;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_objM_Type (This_Object.all).idM;
   end Get_idM;
...
--ADATEST IGNORE_ON
   procedure Put_idM (
      ...
      idM_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objM_Type (This_Object.all).idM :=
         idM_Value;
   end Put_idM;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objM_Type (This_Object.all).R18_A;
   end Get_R18_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R18_A (
      This_Object : in Root_Object.Object_Access;
      R18_A_Value : in Root_Object.Object_Access) is
   begin
      Relationships_objM_Type (This_Object.all).R18_A :=
         R18_A_Value;
   end Put_R18_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objM_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objM_Type(This_Object.all).idM := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.objM;
