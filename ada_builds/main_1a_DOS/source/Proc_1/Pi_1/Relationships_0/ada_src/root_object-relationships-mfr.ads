...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.MFR.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsMFR
...
--  ----------------------------------  
--  package Root_Object.Relationships.MFR
...
package Root_Object.Relationships.MFR is
--
------------------------------------------------------------------------
   --
   --**************  Object Many_Far_Right Information **************
   --
   -- Object MFR is PASSIVE
   --
   --
   --
   -- Object MFR has an identifying non-referential attribute MFR_Identifier 
   -- and therefore may be uniquely created.
   -- 
   -- Object MFR has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "MFR";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_MFR_Type is new Relationships_Type with record
      ...
      MFR_Data : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_MFR_Data (
      This_Object : in Root_Object.Object_Access;
      MFR_Data_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_MFR_Data);
   pragma inline (Put_MFR_Data);
