...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objG.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjG
...
--  ----------------------------------  
--  package Root_Object.Relationships.objG
...
package Root_Object.Relationships.objG is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_G Information **************
   --
   -- Object objG is PASSIVE
   --
   --
   --
   -- Object objG has an identifying non-referential attribute idG 
   -- and therefore may be uniquely created.
   -- 
   -- Object objG has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objG";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objG_Type is new Relationships_Type with record
      ...
      idG : Application_Types.Base_Integer_Type;

      --
      -- Non Identifying referential. Thou Shalt Not Use. 
      -- idG_Reflexive_ID : Application_Types.Base_Integer_Type;
   
      --
      R11_A : Root_Object.Object_Access := null;
      R11_B : Root_Object.Object_Access := null;
      R13_A : Root_Object.Object_List.List_Header_Access_Type;
      R13_B : Root_Object.Object_Access := null;
      R2_A : Root_Object.Object_Access := null;
      R2_B : Root_Object.Object_Access := null;
      R4_A : Root_Object.Object_List.List_Header_Access_Type;
      R4_B : Root_Object.Object_Access := null;
   ...
   procedure Put_idG (
      This_Object : in Root_Object.Object_Access;
      idG_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idG);
   pragma inline (Put_idG);
   ...
   procedure Put_R11_A (
      This_Object :   in  Root_Object.Object_Access;
      R11_A_Value : in Root_Object.Object_Access);

   pragma inline (Get_R11_A);
   pragma inline (Put_R11_A);
   ...
   procedure Put_R13_A  (
      This_Object : in  Root_Object.Object_Access;
      R13_A_Value : in Root_Object.Object_List.List_Header_Access_Type);

   pragma inline (Get_R13_A);
   pragma inline (Put_R13_A);
   ...
   procedure Put_R13_B (
      This_Object : in Root_Object.Object_Access;
      R13_B_Value : in Root_Object.Object_Access);

   pragma inline (Get_R13_B);
   pragma inline (Put_R13_B);
   ...
   procedure Put_R4_A  (
      This_Object : in  Root_Object.Object_Access;
      R4_A_Value : in Root_Object.Object_List.List_Header_Access_Type);
   ...
   procedure Put_R4_B (
      This_Object : in Root_Object.Object_Access;
      R4_B_Value : in Root_Object.Object_Access);
