...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.OBJEF.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsOBJEF
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.OBJEF is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_OBJEF_Type (This_Object.all).idE;
   end Get_idE;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_OBJEF_Type (This_Object.all).idE :=
         idE_Value;
   end Put_idE;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_idF (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_OBJEF_Type (This_Object.all).idF;
   end Get_idF;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_idF (
      This_Object : in Root_Object.Object_Access;
      idF_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_OBJEF_Type (This_Object.all).idF :=
         idF_Value;
   end Put_idF;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_OBJEF_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_OBJEF_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_idEF (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_OBJEF_Type (This_Object.all).idEF;
   end Get_idEF;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_idEF (
      This_Object : in Root_Object.Object_Access;
      idEF_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_OBJEF_Type (This_Object.all).idEF :=
         idEF_Value;
   end Put_idEF;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_OBJEF_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_OBJEF_Type(This_Object.all).idE := Application_Types.Base_Integer_Type_First;
         Relationships_OBJEF_Type(This_Object.all).idF := Application_Types.Base_Integer_Type_First;
         Relationships_OBJEF_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
         Relationships_OBJEF_Type(This_Object.all).idEF := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.OBJEF;
