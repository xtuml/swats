...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objK.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjK
...
--  ----------------------------------  
--  package Root_Object.Relationships.objK
...
package Root_Object.Relationships.objK is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_K Information **************
   --
   -- Object objK is PASSIVE
   --
   --
   --
   ...
   type Relationships_objK_Type is new Relationships_Type with record
      ...
      --
      R32_B : Root_Object.Object_Access := null;
   ...
   procedure Put_idK (
      ...
      idK_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idK);
   pragma inline (Put_idK);
   ...
   procedure Put_R32_B (
      This_Object :   in  Root_Object.Object_Access;
      R32_B_Value : in Root_Object.Object_Access);

   pragma inline (Get_R32_B);
   pragma inline (Put_R32_B);
