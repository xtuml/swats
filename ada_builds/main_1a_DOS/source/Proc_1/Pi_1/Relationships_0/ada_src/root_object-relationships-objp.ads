...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objP.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjP
...
--  ----------------------------------  
--  package Root_Object.Relationships.objP
...
package Root_Object.Relationships.objP is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_P Information **************
   --
   -- Object objP is PASSIVE
   --
   --
   --
   -- Object objP has an identifying non-referential attribute idP 
   ...
   type Relationships_objP_Type is new Relationships_Type with record
      ...
      --
      R20_B : Root_Object.Object_List.List_Header_Access_Type;
      R22_B : Root_Object.Object_List.List_Header_Access_Type;
   ...
   procedure Put_idP (
      ...
      idP_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idP);
   pragma inline (Put_idP);
   ...
   procedure Put_R20_B  (
      This_Object :    in  Root_Object.Object_Access;
      R20_B_Value : in Root_Object.Object_List.List_Header_Access_Type);

   pragma inline (Get_R20_B);
   pragma inline (Put_R20_B);
   ...
   procedure Put_R22_B  (
      This_Object :    in  Root_Object.Object_Access;
      R22_B_Value : in Root_Object.Object_List.List_Header_Access_Type);

   pragma inline (Get_R22_B);
   pragma inline (Put_R22_B);
