...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objD.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjD
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idD_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idD return Application_Types.Base_Integer_Type is
   begin
      idD_Value :=
         Application_Types.Base_Integer_Type'succ (idD_Value);
      return idD_Value;
   end Obtain_Subsequent_idD;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_objD_Type (This_Object.all).idD;
   end Get_idD;
...
--ADATEST IGNORE_ON
   procedure Put_idD (
      ...
      idD_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objD_Type (This_Object.all).idD :=
         idD_Value;
   end Put_idD;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_objD_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objD_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Colour_Of_D (
      This_Object: Root_Object.Object_Access) return Relationships_Domain_Types.Colour is
   begin
      return Relationships_objD_Type (This_Object.all).Colour_Of_D;
   end Get_Colour_Of_D;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Colour_Of_D (
      This_Object : in Root_Object.Object_Access;
      Colour_Of_D_Value : in Relationships_Domain_Types.Colour) is
   begin
      Relationships_objD_Type (This_Object.all).Colour_Of_D :=
         Colour_Of_D_Value;
   end Put_Colour_Of_D;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objD_Type (This_Object.all).R3_A;
   end Get_R3_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R3_A (
      This_Object : in Root_Object.Object_Access;
      R3_A_Value : in Root_Object.Object_List.List_Header_Access_Type) is
   begin
      Relationships_objD_Type (This_Object.all).R3_A :=
         R3_A_Value;
   end Put_R3_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objD_Type;
   
         Relationships_objD_Type(This_Object.all).R3_A := Root_Object.Object_List.Initialise;
      else
         This_Object := Free_List.First_Entry;
         Relationships_objD_Type(This_Object.all).idD := Application_Types.Base_Integer_Type_First;
         Relationships_objD_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
         Relationships_objD_Type(This_Object.all).Colour_Of_D := Relationships_Domain_Types.Colour_First;
...
end Root_Object.Relationships.objD;
