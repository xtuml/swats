...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objL.event_action.ada
...
--*  separate of Root_Object.RelationshipsobjL
--*     Event_Action
--*
--*************************************************************************************
--  MODIFICATION RECORD
...
separate (Root_Object.Relationships.objL)
...
begin
   ...
   This_Action := Relationships_objL_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := Relationships_objL_Instance_Event_Type(This_Event.all).Target_Instance;
   ...
   if This /= null then
      ...
      --  
      This_Event_Dispatch_Matrix (This_Action, Relationships_objL_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
