...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objL.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjL
...
--  ----------------------------------  
--  package Root_Object.Relationships.objL
...
package Root_Object.Relationships.objL is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_L Information **************
   --
   -- Object objL is PASSIVE
   --
   -- Object objL participates in a super sub type relationship
   --
   --
   --
   -- Object objL is a SUPER type of 
   --    objSL1,
   --    objSL2,
   --    objSL3
   --    via Relationship R26
   --
   -- Object objL is a SUB type of objH via Relationship R9
   --
   -- Object objL does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objL has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objL";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objL_Type is new Relationships_Type with record
      ...
      --
      -- Initialised Non identifying non referential
      idL : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      Current_State :  Object_State_Type :=  Object_State_Type_First;

      R26_Sub : Root_Object.Object_Access := null;
      R9_Super : Root_Object.Object_Access := null;
   ...
   procedure Put_idL (
      This_Object : in Root_Object.Object_Access;
      idL_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idL);
   pragma inline (Put_idL);
   ...
   procedure Put_R26_Sub (
      This_Object :   in  Root_Object.Object_Access;
      R26_Sub_Value : in Root_Object.Object_Access);

   pragma inline (Get_R26_Sub);
   pragma inline (Put_R26_Sub);
   ...
   procedure Put_R9_Super (
      This_Object : in  Root_Object.Object_Access;
      R9_Super_Value : in Root_Object.Object_Access);

   pragma inline (Get_R9_Super);
   pragma inline (Put_R9_Super);
   ...
   --
   type Relationships_objL_Event_Type is new Relationships_Event_Type with
   record
   ...
   --    
   type Relationships_objL_Instance_Event_Type is new Relationships_objL_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type Relationships_objL_Description_Event is new Relationships_objL_Instance_Event_Type with
   record
      null;
   end record;
   --
   ...
   --
   --
   type Relationships_objL1 is new Relationships_objL_Instance_Event_Type with
   record 
      null;
   end record;
   --
   type Relationships_objL2 is new Relationships_objL_Instance_Event_Type with
   record 
      null;
   end record;
   --
   type Relationships_objL3 is new Relationships_objL_Instance_Event_Type with
   record 
      Test: Application_Types.Base_Integer_Type;
   end record;
   --
   type Relationships_objL4 is new Relationships_objL_Instance_Event_Type with
   record 
      Test: Application_Types.Base_Integer_Type;
   end record;
   --
   type Relationships_objH1 is new Relationships_objL_Instance_Event_Type with
   record 
      null;
   end record;
   --
   type Relationships_objH2 is new Relationships_objL_Instance_Event_Type with
   record 
      null;
   end record;
   --
   type Relationships_objH3 is new Relationships_objL_Instance_Event_Type with
   record 
      Test: Application_Types.Base_Integer_Type;
      Iteration: Application_Types.Base_Integer_Type;
   end record;
   --
   type Relationships_objH4 is new Relationships_objL_Instance_Event_Type with
   record 
      Test: Application_Types.Base_Integer_Type;
      Iteration: Application_Types.Base_Integer_Type;
   end record;
