...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objRM.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjRM
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objRM is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idRM_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idRM return Application_Types.Base_Integer_Type is
   begin
      idRM_Value :=
         Application_Types.Base_Integer_Type'succ (idRM_Value);
      return idRM_Value;
   end Obtain_Subsequent_idRM;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_objRM_Type (This_Object.all).idRM;
   end Get_idRM;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objRM_Type (This_Object.all).idRM :=
         idRM_Value;
   end Put_idRM;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objRM_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objRM_Type(This_Object.all).idRM := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.objRM;
