...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objC.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjC
...
--  ----------------------------------  
--  package Root_Object.Relationships.objC
...
package Root_Object.Relationships.objC is
--
------------------------------------------------------------------------
   --
   ...
   type Relationships_objC_Type is new Relationships_Type with record
