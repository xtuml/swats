...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objP.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjP
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objP is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idP_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idP return Application_Types.Base_Integer_Type is
   begin
      idP_Value :=
         Application_Types.Base_Integer_Type'succ (idP_Value);
      return idP_Value;
   end Obtain_Subsequent_idP;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_objP_Type (This_Object.all).idP;
   end Get_idP;
...
--ADATEST IGNORE_ON
   procedure Put_idP (
      ...
      idP_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objP_Type (This_Object.all).idP :=
         idP_Value;
   end Put_idP;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_objP_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objP_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objP_Type (This_Object.all).R20_B;
   end Get_R20_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R20_B (
      This_Object : in Root_Object.Object_Access;
      R20_B_Value : in Root_Object.Object_List.List_Header_Access_Type) is
   begin
      Relationships_objP_Type (This_Object.all).R20_B :=
         R20_B_Value;
   end Put_R20_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_R22_B  (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_List.List_Header_Access_Type is
   begin
      return Relationships_objP_Type (This_Object.all).R22_B;
   end Get_R22_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R22_B (
      This_Object : in Root_Object.Object_Access;
      R22_B_Value : in Root_Object.Object_List.List_Header_Access_Type) is
   begin
      Relationships_objP_Type (This_Object.all).R22_B :=
         R22_B_Value;
   end Put_R22_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objP_Type;
   
         Relationships_objP_Type(This_Object.all).R20_B := Root_Object.Object_List.Initialise;
         Relationships_objP_Type(This_Object.all).R22_B := Root_Object.Object_List.Initialise;
      else
         This_Object := Free_List.First_Entry;
         Relationships_objP_Type(This_Object.all).idP := Application_Types.Base_Integer_Type_First;
         Relationships_objP_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.objP;
