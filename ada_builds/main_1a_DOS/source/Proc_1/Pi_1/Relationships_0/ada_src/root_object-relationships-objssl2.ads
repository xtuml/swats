...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSSL2.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjSSL2
...
--  ----------------------------------  
--  package Root_Object.Relationships.objSSL2
...
package Root_Object.Relationships.objSSL2 is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_Sub_L2 Information **************
   --
   -- Object objSSL2 is PASSIVE
   --
   -- Object objSSL2 participates in a super sub type relationship
   --
   --
   --
   -- Object objSSL2 is a SUPER type of 
   --    objSSSL1,
   --    objSSSL2
   --    via Relationship R28
   --
   -- Object objSSL2 is a SUB type of objSL3 via Relationship R27
   --
   -- Object objSSL2 does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objSSL2 has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objSSL2";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objSSL2_Type is new Relationships_Type with record
      ...
      idSSL2 : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      Current_State :  Object_State_Type :=  Object_State_Type_First;

      R28_Sub : Root_Object.Object_Access := null;
      R27_Super : Root_Object.Object_Access := null;
   ...
   procedure Put_idSSL2 (
      This_Object : in Root_Object.Object_Access;
      idSSL2_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idSSL2);
   pragma inline (Put_idSSL2);
   ...
   function  Get_R28_Sub (
      This_Object : Root_Object.Object_Access) 
   return Root_Object.Object_Access;

   procedure Put_R28_Sub (
      This_Object :   in  Root_Object.Object_Access;
      R28_Sub_Value : in Root_Object.Object_Access);

   pragma inline (Get_R28_Sub);
   pragma inline (Put_R28_Sub);


   function  Get_R27_Super (
      This_Object : Root_Object.Object_Access) 
   return Root_Object.Object_Access;

   procedure Put_R27_Super (
      This_Object : in  Root_Object.Object_Access;
      R27_Super_Value : in Root_Object.Object_Access);

   pragma inline (Get_R27_Super);
   pragma inline (Put_R27_Super);
   ...
   --
   type Relationships_objSSL2_Event_Type is new Relationships_Event_Type with
   record
      This_Event_Class : Event_Class;
   end record;

   procedure Event_Action (
      Dispatch_Event : in     Relationships_objSSL2_Event_Type;
      This_Event     : in out Root_Object.Root_Event_Access_Type);


   --    
   type Relationships_objSSL2_Instance_Event_Type is new Relationships_objSSL2_Event_Type with
   record
   ...
   -- 
   procedure Event_Action (
      Dispatch_Event : in     Relationships_objSSL2_Instance_Event_Type;
      This_Event     : in out Root_Object.Root_Event_Access_Type);



   ------------------------------------------------------------------------
   type Relationships_objSSL2_Description_Event is new Relationships_objSSL2_Instance_Event_Type with
   record
      null;
   end record;
   --
...
end Root_Object.Relationships.objSSL2;
