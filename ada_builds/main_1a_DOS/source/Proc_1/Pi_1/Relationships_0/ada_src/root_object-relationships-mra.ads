...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.MRA.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsMRA
...
--  ----------------------------------  
--  package Root_Object.Relationships.MRA
...
package Root_Object.Relationships.MRA is
--
------------------------------------------------------------------------
   --
   --**************  Object Many_Right_Assoc Information **************
   --
   -- Object MRA is PASSIVE
   --
   --
   --
   -- Object MRA does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object MRA has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "MRA";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_MRA_Type is new Relationships_Type with record

      --
      -- Non initialised identifying referential
      Right_Identifier : Application_Types.Base_Integer_Type;

      --
      -- Non initialised identifying referential
      MFR_Identifier : Application_Types.Base_Integer_Type;

      --
      -- Initialised Non identifying non referential
      MRA_Data : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      MRA_Identifier : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_Right_Identifier (
      ...
      Right_Identifier_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Right_Identifier);
   pragma inline (Put_Right_Identifier);
   ...
   procedure Put_MFR_Identifier (
      This_Object : in Root_Object.Object_Access;
      MFR_Identifier_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_MFR_Identifier);
   pragma inline (Put_MFR_Identifier);
   ...
   procedure Put_MRA_Data (
      This_Object : in Root_Object.Object_Access;
      MRA_Data_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_MRA_Data);
   pragma inline (Put_MRA_Data);
   ...
   procedure Put_MRA_Identifier (
      This_Object : in Root_Object.Object_Access;
      MRA_Identifier_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_MRA_Identifier);
   pragma inline (Put_MRA_Identifier);
