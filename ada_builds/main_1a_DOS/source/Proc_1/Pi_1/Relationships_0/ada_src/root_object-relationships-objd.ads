...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objD.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjD
...
--  ----------------------------------  
--  package Root_Object.Relationships.objD
...
package Root_Object.Relationships.objD is
--
------------------------------------------------------------------------
   --
   ...
   --
   --
   -- Object objD has an identifying non-referential attribute idD 
   ...
   type Relationships_objD_Type is new Relationships_Type with record
      ...
      --
      -- Initialised Non identifying non referential
      Colour_Of_D : Relationships_Domain_Types.Colour := Relationships_Domain_Types.Colour_First;

      --
      R3_A : Root_Object.Object_List.List_Header_Access_Type;
   ...
   function Get_Colour_Of_D (
      This_Object : Root_Object.Object_Access) 
   return Relationships_Domain_Types.Colour;

   procedure Put_Colour_Of_D (
      This_Object : in Root_Object.Object_Access;
      Colour_Of_D_Value : in Relationships_Domain_Types.Colour);

   pragma inline (Get_Colour_Of_D);
   pragma inline (Put_Colour_Of_D);
   ...
   procedure Put_R3_A  (
      This_Object :    in  Root_Object.Object_Access;
      R3_A_Value : in Root_Object.Object_List.List_Header_Access_Type);
