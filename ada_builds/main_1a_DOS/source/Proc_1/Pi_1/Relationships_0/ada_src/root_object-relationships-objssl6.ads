...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objSSL6.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsobjSSL6
...
--  ----------------------------------  
--  package Root_Object.Relationships.objSSL6
...
package Root_Object.Relationships.objSSL6 is
--
------------------------------------------------------------------------
   --
   --**************  Object Sub_Sub_L6 Information **************
   --
   -- Object objSSL6 is PASSIVE
   --
   -- Object objSSL6 participates in a super sub type relationship
   --
   --
   --
   -- Object objSSL6 is a SUB type of objSL3 via Relationship R29
   --
   -- Object objSSL6 does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objSSL6 has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objSSL6";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_objSSL6_Type is new Relationships_Type with record
      ...
      idSSL6 : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      Current_State :  Object_State_Type :=  Object_State_Type_First;

      R32_A : Root_Object.Object_List.List_Header_Access_Type;
      R29_Super : Root_Object.Object_Access := null;
   ...
   procedure Put_idSSL6 (
      This_Object : in Root_Object.Object_Access;
      idSSL6_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idSSL6);
   pragma inline (Put_idSSL6);
   ...
   procedure Put_R32_A  (
      This_Object :    in  Root_Object.Object_Access;
      R32_A_Value : in Root_Object.Object_List.List_Header_Access_Type);

   pragma inline (Get_R32_A);
   pragma inline (Put_R32_A);
   ...
   procedure Put_R29_Super (
      This_Object : in  Root_Object.Object_Access;
      R29_Super_Value : in Root_Object.Object_Access);

   pragma inline (Get_R29_Super);
   pragma inline (Put_R29_Super);
