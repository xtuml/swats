...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.MRA.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsMRA
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.MRA is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_MRA_Type (This_Object.all).Right_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_MRA_Type (This_Object.all).Right_Identifier :=
...
--ADATEST IGNORE_ON
   function Get_MFR_Identifier (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_MRA_Type (This_Object.all).MFR_Identifier;
   end Get_MFR_Identifier;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_MFR_Identifier (
      This_Object : in Root_Object.Object_Access;
      MFR_Identifier_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_MRA_Type (This_Object.all).MFR_Identifier :=
         MFR_Identifier_Value;
   end Put_MFR_Identifier;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   function Get_MRA_Data (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_MRA_Type (This_Object.all).MRA_Data;
   end Get_MRA_Data;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_MRA_Data (
      This_Object : in Root_Object.Object_Access;
      MRA_Data_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_MRA_Type (This_Object.all).MRA_Data :=
         MRA_Data_Value;
   end Put_MRA_Data;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_MRA_Identifier (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_MRA_Type (This_Object.all).MRA_Identifier;
   end Get_MRA_Identifier;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_MRA_Identifier (
      This_Object : in Root_Object.Object_Access;
      MRA_Identifier_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_MRA_Type (This_Object.all).MRA_Identifier :=
         MRA_Identifier_Value;
   end Put_MRA_Identifier;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_MRA_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_MRA_Type(This_Object.all).Right_Identifier := Application_Types.Base_Integer_Type_First;
         Relationships_MRA_Type(This_Object.all).MFR_Identifier := Application_Types.Base_Integer_Type_First;
         Relationships_MRA_Type(This_Object.all).MRA_Data := Application_Types.Base_Integer_Type_First;
         Relationships_MRA_Type(This_Object.all).MRA_Identifier := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.MRA;
