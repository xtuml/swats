...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objO.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjO
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idO_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idO return Application_Types.Base_Integer_Type is
   begin
      idO_Value :=
         Application_Types.Base_Integer_Type'succ (idO_Value);
      return idO_Value;
   end Obtain_Subsequent_idO;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_objO_Type (This_Object.all).idO;
   end Get_idO;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objO_Type (This_Object.all).idO :=
         idO_Value;
   end Put_idO;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objO_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objO_Type(This_Object.all).idO := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.objO;
