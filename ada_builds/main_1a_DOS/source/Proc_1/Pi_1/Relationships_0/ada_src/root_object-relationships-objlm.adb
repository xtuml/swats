...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objLM.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjLM
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objLM is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idLM_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idLM return Application_Types.Base_Integer_Type is
   begin
      idLM_Value :=
         Application_Types.Base_Integer_Type'succ (idLM_Value);
      return idLM_Value;
   end Obtain_Subsequent_idLM;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_objLM_Type (This_Object.all).idLM;
   end Get_idLM;
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objLM_Type (This_Object.all).idLM :=
         idLM_Value;
   end Put_idLM;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_objLM_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Relationships_objLM_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objLM_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objLM_Type(This_Object.all).idLM := Application_Types.Base_Integer_Type_First;
         Relationships_objLM_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.objLM;
