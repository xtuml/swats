...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.assMR.ads
...
--* Description:             
--*                          Domain specification Root_Object.RelationshipsassMR
...
--  ----------------------------------  
--  package Root_Object.Relationships.assMR
...
package Root_Object.Relationships.assMR is
--
------------------------------------------------------------------------
   --
   --**************  Object MR_Assoc Information **************
   --
   -- Object assMR is PASSIVE
   --
   --
   --
   -- Object assMR does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object assMR has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "assMR";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Relationships_assMR_Type is new Relationships_Type with record

      --
      -- Non initialised identifying referential
      idMO : Application_Types.Base_Integer_Type;

      --
      -- Non Identifying referential. Thou Shalt Not Use. 
      -- idRO : Application_Types.Base_Integer_Type;
   
      --
      -- Initialised Non identifying non referential
      idMR : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_idMO (
      ...
      idMO_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idMO);
   pragma inline (Put_idMO);
   ...
   procedure Put_idMR (
      This_Object : in Root_Object.Object_Access;
      idMR_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idMR);
   pragma inline (Put_idMR);
...
end Root_Object.Relationships.assMR;
