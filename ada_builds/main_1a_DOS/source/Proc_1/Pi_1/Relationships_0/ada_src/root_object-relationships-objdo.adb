...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objDO.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjDO
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objDO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objDO_Type (This_Object.all).idO;
   end Get_idO;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_idO (
      ...
      idO_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objDO_Type (This_Object.all).idO :=
         idO_Value;
   end Put_idO;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_idDO (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Relationships_objDO_Type (This_Object.all).idDO;
   end Get_idDO;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_idDO (
      This_Object : in Root_Object.Object_Access;
      idDO_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objDO_Type (This_Object.all).idDO :=
         idDO_Value;
   end Put_idDO;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objDO_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objDO_Type(This_Object.all).idO := Application_Types.Base_Integer_Type_First;
         Relationships_objDO_Type(This_Object.all).idDO := Application_Types.Base_Integer_Type_First;
