...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objQ.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjQ
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objQ is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idQ_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idQ return Application_Types.Base_Integer_Type is
   begin
      idQ_Value :=
         Application_Types.Base_Integer_Type'succ (idQ_Value);
      return idQ_Value;
   end Obtain_Subsequent_idQ;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Relationships_objQ_Type (This_Object.all).idQ;
   end Get_idQ;
...
--ADATEST IGNORE_ON
   procedure Put_idQ (
      ...
      idQ_Value : in Application_Types.Base_Integer_Type) is
   begin
      Relationships_objQ_Type (This_Object.all).idQ :=
         idQ_Value;
   end Put_idQ;
...
------------------------------------------------------------------------
   --
   -- procedure Put_idR and 
   --
   -- function Get_idR
   --
   -- have not been generated for idR
   -- as this attribute is non-identifying referential.
   --
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objQ_Type (This_Object.all).R20_A;
   end Get_R20_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R20_A (
      This_Object : in Root_Object.Object_Access;
      R20_A_Value : in Root_Object.Object_Access) is
   begin
      Relationships_objQ_Type (This_Object.all).R20_A :=
         R20_A_Value;
   end Put_R20_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R21_B (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return Relationships_objQ_Type (This_Object.all).R21_B;
   end Get_R21_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R21_B (
      This_Object : in Root_Object.Object_Access;
      R21_B_Value : in Root_Object.Object_Access) is
   begin
      Relationships_objQ_Type (This_Object.all).R21_B :=
         R21_B_Value;
   end Put_R21_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objQ_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objQ_Type(This_Object.all).idQ := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.objQ;
