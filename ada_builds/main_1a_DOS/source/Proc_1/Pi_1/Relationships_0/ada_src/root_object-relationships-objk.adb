...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Relationships.objK.adb
...
--* Description:             
--*                          Domain body Root_Object.RelationshipsobjK
...
------------------------------------------------------------------------
--
package body Root_Object.Relationships.objK is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   procedure Put_idK (
      ...
      idK_Value : in Application_Types.Base_Integer_Type) is
   begin
...
------------------------------------------------------------------------
   --
   -- procedure Put_idH and 
   --
   -- function Get_idH
   --
   -- have not been generated for idH
...
--ADATEST IGNORE_ON
   ...
   begin
      return Relationships_objK_Type (This_Object.all).R32_B;
   end Get_R32_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R32_B (
      This_Object : in Root_Object.Object_Access;
      R32_B_Value : in Root_Object.Object_Access) is
   begin
      Relationships_objK_Type (This_Object.all).R32_B :=
         R32_B_Value;
   end Put_R32_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Relationships_objK_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Relationships_objK_Type(This_Object.all).idK := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Relationships.objK;
