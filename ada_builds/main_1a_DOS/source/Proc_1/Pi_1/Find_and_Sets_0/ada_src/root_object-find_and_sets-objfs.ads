...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Find_and_Sets.objFS.ads
...
--* Description:             
--*                          Domain specification Root_Object.Find_and_SetsobjFS
...
--  ----------------------------------  
--  package Root_Object.Find_and_Sets.objFS
...
package Root_Object.Find_and_Sets.objFS is
--
------------------------------------------------------------------------
   --
   --**************  Object Find_Set Information **************
   --
   -- Object objFS is PASSIVE
   --
   --
   --
   -- Object objFS has an identifying non-referential attribute idFS 
   -- and therefore may be uniquely created.
   -- 
   -- Object objFS has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objFS";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Find_and_Sets_objFS_Type is new Find_and_Sets_Type with record

      --
      -- Non initialised identifying non referential
      idFS : Application_Types.Base_Integer_Type;

      --
      -- Initialised Non identifying non referential
      ResultFS : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_idFS (
      ...
      idFS_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idFS);
   pragma inline (Put_idFS);
   ...
   procedure Put_ResultFS (
      This_Object : in Root_Object.Object_Access;
      ResultFS_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_ResultFS);
   pragma inline (Put_ResultFS);
