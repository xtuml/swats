...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Find_and_Sets.objFM.ads
...
--* Description:             
--*                          Domain specification Root_Object.Find_and_SetsobjFM
...
--  ----------------------------------  
--  package Root_Object.Find_and_Sets.objFM
...
package Root_Object.Find_and_Sets.objFM is
--
------------------------------------------------------------------------
   --
   --**************  Object Find_Many Information **************
   --
   -- Object objFM is PASSIVE
   --
   --
   --
   -- Object objFM has an identifying non-referential attribute idFM 
   -- and therefore may be uniquely created.
   -- 
   -- Object objFM has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objFM";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Find_and_Sets_objFM_Type is new Find_and_Sets_Type with record

      --
      -- Non initialised identifying non referential
      idFM : Application_Types.Base_Integer_Type;

      --
      -- Initialised Non identifying non referential
      ResultFM : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_idFM (
      ...
      idFM_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idFM);
   pragma inline (Put_idFM);
   ...
   procedure Put_ResultFM (
      This_Object : in Root_Object.Object_Access;
      ResultFM_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_ResultFM);
   pragma inline (Put_ResultFM);
