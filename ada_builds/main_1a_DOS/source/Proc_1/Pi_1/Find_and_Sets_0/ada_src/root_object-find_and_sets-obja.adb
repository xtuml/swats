...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Find_and_Sets.objA.adb
...
--* Description:             
--*                          Domain body Root_Object.Find_and_SetsobjA
...
------------------------------------------------------------------------
--
package body Root_Object.Find_and_Sets.objA is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return Find_and_Sets_objA_Type (This_Object.all).idA;
   end Get_idA;
...
--ADATEST IGNORE_ON
   ...
   begin
      Find_and_Sets_objA_Type (This_Object.all).idA :=
         idA_Value;
   end Put_idA;
...
--ADATEST IGNORE_ON
   function Get_IntegerA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Find_and_Sets_objA_Type (This_Object.all).IntegerA;
   end Get_IntegerA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Find_and_Sets_objA_Type (This_Object.all).IntegerA :=
         IntegerA_Value;
   end Put_IntegerA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Find_and_Sets_objA_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Find_and_Sets_objA_Type(This_Object.all).idA := Application_Types.Base_Integer_Type_First;
         Find_and_Sets_objA_Type(This_Object.all).IntegerA := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Find_and_Sets.objA;
