...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Find_and_Sets.objAO.ads
...
--* Description:             
--*                          Domain specification Root_Object.Find_and_SetsobjAO
...
--  ----------------------------------  
--  package Root_Object.Find_and_Sets.objAO
...
package Root_Object.Find_and_Sets.objAO is
--
------------------------------------------------------------------------
   --
   --**************  Object Assoc_Obj Information **************
   --
   -- Object objAO is PASSIVE
   --
   --
   --
   -- Object objAO does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objAO has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objAO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Find_and_Sets_objAO_Type is new Find_and_Sets_Type with record

      --
      -- Initialised Non identifying non referential
      idAO : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Non initialised identifying referential
      objLO_id : Application_Types.Base_Integer_Type;

      --
      -- Non initialised identifying referential
      objRO_id : Application_Types.Base_Integer_Type;
   ...
   procedure Put_idAO (
      ...
      idAO_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idAO);
   pragma inline (Put_idAO);
   ...
   procedure Put_objLO_id (
      This_Object : in Root_Object.Object_Access;
      objLO_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_objLO_id);
   pragma inline (Put_objLO_id);
   ...
   procedure Put_objRO_id (
      This_Object : in Root_Object.Object_Access;
      objRO_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_objRO_id);
   pragma inline (Put_objRO_id);
