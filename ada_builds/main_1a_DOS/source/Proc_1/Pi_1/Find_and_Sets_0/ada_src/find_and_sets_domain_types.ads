...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Find_and_Sets_domain_types.ads
...
--* Description:             
--*                          Find_and_Sets Domain Data Types Package Specification
...
--*  package specification Find_and_Sets_Domain_Types 
--*
--*************************************************************************************
--  MODIFICATION RECORD
--  --------------------
...
package Find_and_Sets_Domain_Types is
   pragma Elaborate_Body (Find_and_Sets_Domain_Types);
...
--
   ...
   type Simple_Structure_Type_Node is record
      an_integer_of_structure : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
      a_real_of_structure : Application_Types.Base_Float_Type := Application_Types.Base_Float_Type_First;
      some_text_of_structure : Application_Types.Base_Text_Type := Application_Types.Base_Text_Type_First;
...
--
   ...
   type Complex_Structure_Type_Node;
   type Complex_Structure_Type_Node_Access is access all Complex_Structure_Type_Node;
   type Complex_Structure_Type_Node_Access_Pointer is access Complex_Structure_Type_Node_Access;
     
   type Complex_Structure_Type is new Domain_Structure with record
      Iterator          : Complex_Structure_Type_Node_Access_Pointer := null;
      First_Entry       : Complex_Structure_Type_Node_Access := null;
      Last_Entry        : Complex_Structure_Type_Node_Access := null;
      Number_Of_Entries : Application_Types.Base_Integer_Type := 0;
   end record;
       
   type Complex_Structure_Type_Node is record
      Number_Of_Simple_Structures : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
      list_of_structures : Find_and_Sets_Domain_Types.Simple_Structure_Type;
      Next_Structure     : Complex_Structure_Type_Node_Access := null;
      Previous_Structure : Complex_Structure_Type_Node_Access := null;
   end record;
    
   procedure Initialize (Object : in out Complex_Structure_Type);

   procedure Adjust     (Object : in out Complex_Structure_Type);

   procedure Finalize   (Object : in out Complex_Structure_Type);
