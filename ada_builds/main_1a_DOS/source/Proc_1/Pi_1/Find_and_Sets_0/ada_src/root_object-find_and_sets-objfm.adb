...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Find_and_Sets.objFM.adb
...
--* Description:             
--*                          Domain body Root_Object.Find_and_SetsobjFM
...
------------------------------------------------------------------------
--
package body Root_Object.Find_and_Sets.objFM is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idFM_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idFM return Application_Types.Base_Integer_Type is
   begin
      idFM_Value :=
         Application_Types.Base_Integer_Type'succ (idFM_Value);
      return idFM_Value;
   end Obtain_Subsequent_idFM;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Find_and_Sets_objFM_Type (This_Object.all).idFM;
   end Get_idFM;
...
--ADATEST IGNORE_ON
   procedure Put_idFM (
      ...
      idFM_Value : in Application_Types.Base_Integer_Type) is
   begin
      Find_and_Sets_objFM_Type (This_Object.all).idFM :=
         idFM_Value;
   end Put_idFM;
...
--ADATEST IGNORE_ON
   function Get_ResultFM (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Find_and_Sets_objFM_Type (This_Object.all).ResultFM;
   end Get_ResultFM;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_ResultFM (
      This_Object : in Root_Object.Object_Access;
      ResultFM_Value : in Application_Types.Base_Integer_Type) is
   begin
      Find_and_Sets_objFM_Type (This_Object.all).ResultFM :=
         ResultFM_Value;
   end Put_ResultFM;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Find_and_Sets_objFM_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Find_and_Sets_objFM_Type(This_Object.all).idFM := Application_Types.Base_Integer_Type_First;
         Find_and_Sets_objFM_Type(This_Object.all).ResultFM := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Find_and_Sets.objFM;
