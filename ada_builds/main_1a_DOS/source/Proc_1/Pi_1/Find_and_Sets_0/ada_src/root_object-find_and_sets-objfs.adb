...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Find_and_Sets.objFS.adb
...
--* Description:             
--*                          Domain body Root_Object.Find_and_SetsobjFS
...
------------------------------------------------------------------------
--
package body Root_Object.Find_and_Sets.objFS is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idFS_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idFS return Application_Types.Base_Integer_Type is
   begin
      idFS_Value :=
         Application_Types.Base_Integer_Type'succ (idFS_Value);
      return idFS_Value;
   end Obtain_Subsequent_idFS;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Find_and_Sets_objFS_Type (This_Object.all).idFS;
   end Get_idFS;
...
--ADATEST IGNORE_ON
   procedure Put_idFS (
      ...
      idFS_Value : in Application_Types.Base_Integer_Type) is
   begin
      Find_and_Sets_objFS_Type (This_Object.all).idFS :=
         idFS_Value;
   end Put_idFS;
...
--ADATEST IGNORE_ON
   function Get_ResultFS (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Find_and_Sets_objFS_Type (This_Object.all).ResultFS;
   end Get_ResultFS;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_ResultFS (
      This_Object : in Root_Object.Object_Access;
      ResultFS_Value : in Application_Types.Base_Integer_Type) is
   begin
      Find_and_Sets_objFS_Type (This_Object.all).ResultFS :=
         ResultFS_Value;
   end Put_ResultFS;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Find_and_Sets_objFS_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Find_and_Sets_objFS_Type(This_Object.all).idFS := Application_Types.Base_Integer_Type_First;
         Find_and_Sets_objFS_Type(This_Object.all).ResultFS := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Find_and_Sets.objFS;
