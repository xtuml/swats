...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Find_and_Sets.objLO.adb
...
--* Description:             
--*                          Domain body Root_Object.Find_and_SetsobjLO
...
------------------------------------------------------------------------
--
package body Root_Object.Find_and_Sets.objLO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   objLO_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_objLO_id return Application_Types.Base_Integer_Type is
   begin
      objLO_id_Value :=
         Application_Types.Base_Integer_Type'succ (objLO_id_Value);
      return objLO_id_Value;
   end Obtain_Subsequent_objLO_id;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Find_and_Sets_objLO_Type (This_Object.all).objLO_id;
   end Get_objLO_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      Find_and_Sets_objLO_Type (This_Object.all).objLO_id :=
         objLO_id_Value;
   end Put_objLO_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Find_and_Sets_objLO_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Find_and_Sets_objLO_Type(This_Object.all).objLO_id := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Find_and_Sets.objLO;
