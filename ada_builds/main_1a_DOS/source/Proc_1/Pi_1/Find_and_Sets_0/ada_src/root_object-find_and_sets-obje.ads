...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Find_and_Sets.objE.ads
...
--* Description:             
--*                          Domain specification Root_Object.Find_and_SetsobjE
...
--  ----------------------------------  
--  package Root_Object.Find_and_Sets.objE
...
package Root_Object.Find_and_Sets.objE is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_E Information **************
   --
   -- Object objE is PASSIVE
   --
   --
   --
   -- Object objE has an identifying non-referential attribute idE 
   ...
   type Find_and_Sets_objE_Type is new Find_and_Sets_Type with record

      --
      -- Non initialised identifying non referential
      idE : Application_Types.Base_Integer_Type;
      ...
      --
      -- Initialised Non identifying non referential
      IntegerB : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_idE (
      ...
      idE_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idE);
   pragma inline (Put_idE);
   ...
   procedure Put_IntegerB (
      This_Object : in Root_Object.Object_Access;
      IntegerB_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_IntegerB);
   pragma inline (Put_IntegerB);
