...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Find_and_Sets.objB.ads
...
--* Description:             
--*                          Domain specification Root_Object.Find_and_SetsobjB
...
--  ----------------------------------  
--  package Root_Object.Find_and_Sets.objB
...
package Root_Object.Find_and_Sets.objB is
--
------------------------------------------------------------------------
   --
   ...
   type Find_and_Sets_objB_Type is new Find_and_Sets_Type with record
