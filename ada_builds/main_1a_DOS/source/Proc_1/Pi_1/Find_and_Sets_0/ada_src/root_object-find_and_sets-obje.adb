...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Find_and_Sets.objE.adb
...
--* Description:             
--*                          Domain body Root_Object.Find_and_SetsobjE
...
------------------------------------------------------------------------
--
package body Root_Object.Find_and_Sets.objE is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idE_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idE return Application_Types.Base_Integer_Type is
   begin
      idE_Value :=
         Application_Types.Base_Integer_Type'succ (idE_Value);
      return idE_Value;
   end Obtain_Subsequent_idE;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Find_and_Sets_objE_Type (This_Object.all).idE;
   end Get_idE;
...
--ADATEST IGNORE_ON
   procedure Put_idE (
      ...
      idE_Value : in Application_Types.Base_Integer_Type) is
   begin
      Find_and_Sets_objE_Type (This_Object.all).idE :=
         idE_Value;
   end Put_idE;
...
--ADATEST IGNORE_ON
   function Get_IntegerA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Find_and_Sets_objE_Type (This_Object.all).IntegerA;
   end Get_IntegerA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      Find_and_Sets_objE_Type (This_Object.all).IntegerA :=
         IntegerA_Value;
   end Put_IntegerA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_IntegerB (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Find_and_Sets_objE_Type (This_Object.all).IntegerB;
   end Get_IntegerB;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_IntegerB (
      This_Object : in Root_Object.Object_Access;
      IntegerB_Value : in Application_Types.Base_Integer_Type) is
   begin
      Find_and_Sets_objE_Type (This_Object.all).IntegerB :=
         IntegerB_Value;
   end Put_IntegerB;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Find_and_Sets_objE_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Find_and_Sets_objE_Type(This_Object.all).idE := Application_Types.Base_Integer_Type_First;
         Find_and_Sets_objE_Type(This_Object.all).IntegerA := Application_Types.Base_Integer_Type_First;
         Find_and_Sets_objE_Type(This_Object.all).IntegerB := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Find_and_Sets.objE;
