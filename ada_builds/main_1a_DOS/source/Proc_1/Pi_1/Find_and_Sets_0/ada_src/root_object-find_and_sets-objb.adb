...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Find_and_Sets.objB.adb
...
--* Description:             
--*                          Domain body Root_Object.Find_and_SetsobjB
...
------------------------------------------------------------------------
--
package body Root_Object.Find_and_Sets.objB is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return Find_and_Sets_objB_Type (This_Object.all).idB;
   end Get_idB;
...
--ADATEST IGNORE_ON
   ...
   begin
      Find_and_Sets_objB_Type (This_Object.all).idB :=
         idB_Value;
   end Put_idB;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Find_and_Sets_objB_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Find_and_Sets_objB_Type(This_Object.all).idB := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Find_and_Sets.objB;
