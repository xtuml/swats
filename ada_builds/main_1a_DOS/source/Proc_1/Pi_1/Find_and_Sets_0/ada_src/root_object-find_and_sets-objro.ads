...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Find_and_Sets.objRO.ads
...
--* Description:             
--*                          Domain specification Root_Object.Find_and_SetsobjRO
...
--  ----------------------------------  
--  package Root_Object.Find_and_Sets.objRO
...
package Root_Object.Find_and_Sets.objRO is
--
------------------------------------------------------------------------
   --
   --**************  Object Right_Obj Information **************
   --
   -- Object objRO is PASSIVE
   --
   --
   --
   -- Object objRO has an identifying non-referential attribute objRO_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object objRO has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objRO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Find_and_Sets_objRO_Type is new Find_and_Sets_Type with record
