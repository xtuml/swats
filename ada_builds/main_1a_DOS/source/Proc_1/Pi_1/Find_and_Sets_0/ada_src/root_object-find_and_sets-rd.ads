...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Find_and_Sets.RD.ads
...
--* Description:             
--*                          Domain specification Root_Object.Find_and_SetsRD
...
--  ----------------------------------  
--  package Root_Object.Find_and_Sets.RD
...
package Root_Object.Find_and_Sets.RD is
--
------------------------------------------------------------------------
   --
   ...
   type Find_and_Sets_RD_Type is new Find_and_Sets_Type with record
