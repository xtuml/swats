...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Find_and_Sets.objFSI.adb
...
--* Description:             
--*                          Domain body Root_Object.Find_and_SetsobjFSI
...
------------------------------------------------------------------------
--
package body Root_Object.Find_and_Sets.objFSI is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idFSI_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idFSI return Application_Types.Base_Integer_Type is
   begin
      idFSI_Value :=
         Application_Types.Base_Integer_Type'succ (idFSI_Value);
      return idFSI_Value;
   end Obtain_Subsequent_idFSI;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Find_and_Sets_objFSI_Type (This_Object.all).idFSI;
   end Get_idFSI;
...
--ADATEST IGNORE_ON
   procedure Put_idFSI (
      ...
      idFSI_Value : in Application_Types.Base_Integer_Type) is
   begin
      Find_and_Sets_objFSI_Type (This_Object.all).idFSI :=
         idFSI_Value;
   end Put_idFSI;
...
--ADATEST IGNORE_ON
   function Get_ResultFSI (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Find_and_Sets_objFSI_Type (This_Object.all).ResultFSI;
   end Get_ResultFSI;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_ResultFSI (
      This_Object : in Root_Object.Object_Access;
      ResultFSI_Value : in Application_Types.Base_Integer_Type) is
   begin
      Find_and_Sets_objFSI_Type (This_Object.all).ResultFSI :=
         ResultFSI_Value;
   end Put_ResultFSI;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Find_and_Sets_objFSI_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Find_and_Sets_objFSI_Type(This_Object.all).idFSI := Application_Types.Base_Integer_Type_First;
         Find_and_Sets_objFSI_Type(This_Object.all).ResultFSI := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Find_and_Sets.objFSI;
