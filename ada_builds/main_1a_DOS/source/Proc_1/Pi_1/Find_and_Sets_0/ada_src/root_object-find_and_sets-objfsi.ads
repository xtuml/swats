...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Find_and_Sets.objFSI.ads
...
--* Description:             
--*                          Domain specification Root_Object.Find_and_SetsobjFSI
...
--  ----------------------------------  
--  package Root_Object.Find_and_Sets.objFSI
...
package Root_Object.Find_and_Sets.objFSI is
--
------------------------------------------------------------------------
   --
   --**************  Object Find_Single Information **************
   --
   -- Object objFSI is PASSIVE
   --
   --
   --
   -- Object objFSI has an identifying non-referential attribute idFSI 
   -- and therefore may be uniquely created.
   -- 
   -- Object objFSI has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objFSI";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Find_and_Sets_objFSI_Type is new Find_and_Sets_Type with record

      --
      -- Non initialised identifying non referential
      idFSI : Application_Types.Base_Integer_Type;

      --
      -- Initialised Non identifying non referential
      ResultFSI : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_idFSI (
      ...
      idFSI_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idFSI);
   pragma inline (Put_idFSI);
   ...
   procedure Put_ResultFSI (
      This_Object : in Root_Object.Object_Access;
      ResultFSI_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_ResultFSI);
   pragma inline (Put_ResultFSI);
