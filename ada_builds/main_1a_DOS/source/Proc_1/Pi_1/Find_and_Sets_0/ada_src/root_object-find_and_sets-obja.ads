...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Find_and_Sets.objA.ads
...
--* Description:             
--*                          Domain specification Root_Object.Find_and_SetsobjA
...
--  ----------------------------------  
--  package Root_Object.Find_and_Sets.objA
...
package Root_Object.Find_and_Sets.objA is
--
------------------------------------------------------------------------
   --
   ...
   type Find_and_Sets_objA_Type is new Find_and_Sets_Type with record
