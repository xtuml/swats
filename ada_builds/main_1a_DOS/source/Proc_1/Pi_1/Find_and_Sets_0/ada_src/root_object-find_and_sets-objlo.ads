...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Find_and_Sets.objLO.ads
...
--* Description:             
--*                          Domain specification Root_Object.Find_and_SetsobjLO
...
--  ----------------------------------  
--  package Root_Object.Find_and_Sets.objLO
...
package Root_Object.Find_and_Sets.objLO is
--
------------------------------------------------------------------------
   --
   --**************  Object Left_Obj Information **************
   --
   -- Object objLO is PASSIVE
   --
   --
   --
   -- Object objLO has an identifying non-referential attribute objLO_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object objLO has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objLO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Find_and_Sets_objLO_Type is new Find_and_Sets_Type with record
