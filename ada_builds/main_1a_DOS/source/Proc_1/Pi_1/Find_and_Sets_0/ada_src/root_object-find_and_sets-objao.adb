...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Find_and_Sets.objAO.adb
...
--* Description:             
--*                          Domain body Root_Object.Find_and_SetsobjAO
...
------------------------------------------------------------------------
--
package body Root_Object.Find_and_Sets.objAO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return Find_and_Sets_objAO_Type (This_Object.all).idAO;
   end Get_idAO;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_idAO (
      ...
      idAO_Value : in Application_Types.Base_Integer_Type) is
   begin
      Find_and_Sets_objAO_Type (This_Object.all).idAO :=
         idAO_Value;
   end Put_idAO;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_objLO_id (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Find_and_Sets_objAO_Type (This_Object.all).objLO_id;
   end Get_objLO_id;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_objLO_id (
      This_Object : in Root_Object.Object_Access;
      objLO_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Find_and_Sets_objAO_Type (This_Object.all).objLO_id :=
         objLO_id_Value;
   end Put_objLO_id;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_objRO_id (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Find_and_Sets_objAO_Type (This_Object.all).objRO_id;
   end Get_objRO_id;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_objRO_id (
      This_Object : in Root_Object.Object_Access;
      objRO_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Find_and_Sets_objAO_Type (This_Object.all).objRO_id :=
         objRO_id_Value;
   end Put_objRO_id;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Find_and_Sets_objAO_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Find_and_Sets_objAO_Type(This_Object.all).idAO := Application_Types.Base_Integer_Type_First;
         Find_and_Sets_objAO_Type(This_Object.all).objLO_id := Application_Types.Base_Integer_Type_First;
         Find_and_Sets_objAO_Type(This_Object.all).objRO_id := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Find_and_Sets.objAO;
