...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Find_and_Sets.objRO.adb
...
--* Description:             
--*                          Domain body Root_Object.Find_and_SetsobjRO
...
------------------------------------------------------------------------
--
package body Root_Object.Find_and_Sets.objRO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   objRO_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_objRO_id return Application_Types.Base_Integer_Type is
   begin
      objRO_id_Value :=
         Application_Types.Base_Integer_Type'succ (objRO_id_Value);
      return objRO_id_Value;
   end Obtain_Subsequent_objRO_id;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Find_and_Sets_objRO_Type (This_Object.all).objRO_id;
   end Get_objRO_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      Find_and_Sets_objRO_Type (This_Object.all).objRO_id :=
         objRO_id_Value;
   end Put_objRO_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Find_and_Sets_objRO_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Find_and_Sets_objRO_Type(This_Object.all).objRO_id := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Find_and_Sets.objRO;
