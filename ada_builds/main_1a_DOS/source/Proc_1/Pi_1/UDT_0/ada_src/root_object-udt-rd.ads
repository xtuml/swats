...
--* Description:             
--*                          TAGGED Domain specification Root_Object.UDTRD
...
------------------------------------------------------------------------
   ...
   type UDT_RD_Type is new UDT_Type with record
