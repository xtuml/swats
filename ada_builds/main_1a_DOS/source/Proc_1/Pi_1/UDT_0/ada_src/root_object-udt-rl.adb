...
------------------------------------------------------------------------
--
package body Root_Object.UDT.RL is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return UDT_RL_Type (This_Object.all).Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      UDT_RL_Type (This_Object.all).Unique_Identifier :=
         Unique_Identifier_Value;
...
--ADATEST IGNORE_ON
   function Get_First_Real (
      This_Object: Root_Object.Object_Access) return UDT_Domain_Types.Subset_1_Of_Real is
   begin
      return UDT_RL_Type (This_Object.all).First_Real;
   end Get_First_Real;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_First_Real (
      This_Object : in Root_Object.Object_Access;
      First_Real_Value : in UDT_Domain_Types.Subset_1_Of_Real) is
   begin
      UDT_RL_Type (This_Object.all).First_Real :=
         First_Real_Value;
   end Put_First_Real;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Second_Real (
      This_Object: Root_Object.Object_Access) return UDT_Domain_Types.Subset_Minus_1_Of_Real is
   begin
      return UDT_RL_Type (This_Object.all).Second_Real;
   end Get_Second_Real;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Second_Real (
      This_Object : in Root_Object.Object_Access;
      Second_Real_Value : in UDT_Domain_Types.Subset_Minus_1_Of_Real) is
   begin
      UDT_RL_Type (This_Object.all).Second_Real :=
         Second_Real_Value;
   end Put_Second_Real;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Third_Real (
      This_Object: Root_Object.Object_Access) return UDT_Domain_Types.Subset_Zero_Of_Real is
   begin
      return UDT_RL_Type (This_Object.all).Third_Real;
   end Get_Third_Real;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Third_Real (
      This_Object : in Root_Object.Object_Access;
      Third_Real_Value : in UDT_Domain_Types.Subset_Zero_Of_Real) is
   begin
      UDT_RL_Type (This_Object.all).Third_Real :=
         Third_Real_Value;
   end Put_Third_Real;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Fourth_Real (
      This_Object: Root_Object.Object_Access) return UDT_Domain_Types.One_To_Maximum_Of_Real is
   begin
      return UDT_RL_Type (This_Object.all).Fourth_Real;
   end Get_Fourth_Real;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Fourth_Real (
      This_Object : in Root_Object.Object_Access;
      Fourth_Real_Value : in UDT_Domain_Types.One_To_Maximum_Of_Real) is
   begin
      UDT_RL_Type (This_Object.all).Fourth_Real :=
         Fourth_Real_Value;
   end Put_Fourth_Real;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Fifth_Real (
      This_Object: Root_Object.Object_Access) return UDT_Domain_Types.Minimum_To_Minus_One_Of_Real is
   begin
      return UDT_RL_Type (This_Object.all).Fifth_Real;
   end Get_Fifth_Real;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Fifth_Real (
      This_Object : in Root_Object.Object_Access;
      Fifth_Real_Value : in UDT_Domain_Types.Minimum_To_Minus_One_Of_Real) is
   begin
      UDT_RL_Type (This_Object.all).Fifth_Real :=
         Fifth_Real_Value;
   end Put_Fifth_Real;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new UDT_RL_Type;
   
      else
         This_Object := Free_List.First_Entry;
         UDT_RL_Type(This_Object.all).Unique_Identifier := Application_Types.Base_Integer_Type_First;
         UDT_RL_Type(This_Object.all).First_Real := UDT_Domain_Types.Subset_1_Of_Real_First;
         UDT_RL_Type(This_Object.all).Second_Real := UDT_Domain_Types.Subset_Minus_1_Of_Real_First;
