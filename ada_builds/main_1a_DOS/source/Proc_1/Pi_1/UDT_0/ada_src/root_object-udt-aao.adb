...
--* Description:             
--*                          Domain body Root_Object.UDTAAO
...
------------------------------------------------------------------------
--
package body Root_Object.UDT.AAO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   procedure Put_The_Test_Number (
      ...
      The_Test_Number_Value : in Application_Types.Base_Integer_Type) is
   begin
...
--ADATEST IGNORE_ON
   function Get_Why (
      This_Object: Root_Object.Object_Access) return UDT_Domain_Types.Active_Object_Status_Type is
   begin
      return UDT_AAO_Type (This_Object.all).Why;
   end Get_Why;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Why (
      This_Object : in Root_Object.Object_Access;
      Why_Value : in UDT_Domain_Types.Active_Object_Status_Type) is
   begin
      UDT_AAO_Type (This_Object.all).Why :=
         Why_Value;
   end Put_Why;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return UDT_AAO_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      UDT_AAO_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new UDT_AAO_Type;
   
      else
         This_Object := Free_List.First_Entry;
         UDT_AAO_Type(This_Object.all).The_Test_Number := Application_Types.Base_Integer_Type_First;
         UDT_AAO_Type(This_Object.all).Why := UDT_Domain_Types.Active_Object_Status_Type_First;
         UDT_AAO_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure UDT_AAO_2 (
      Enum_Parameter : in UDT_Domain_Types.Simple_Enumeration_Type;
   ...
   procedure UDT_AAO_4 (
      Reason : in UDT_Domain_Types.Active_Object_Status_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;
...
--
   procedure AAO1_To_Do_It (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      UDT_AAO_Type (This_Instance.all).Current_State := 
         Root_Object.UDT.AAO.Object_State_Type(Do_It);

      UDT_AAO_2 (
         Enum_Parameter =>  UDT_AAO1(This_Event.all).Enum_Parameter,
         This_Instance => This_Instance );

   end AAO1_To_Do_It;
--
   procedure AAO2_To_Do_It_Again (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      UDT_AAO_Type (This_Instance.all).Current_State := 
         Root_Object.UDT.AAO.Object_State_Type(Do_It_Again);

      UDT_AAO_3 (
         Enum_Parameter =>  UDT_AAO2(This_Event.all).Enum_Parameter,
         Subset_Param =>  UDT_AAO2(This_Event.all).Subset_Param,
         This_Instance => This_Instance );

   end AAO2_To_Do_It_Again;
--
   procedure AAO3_To_It_Failed (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      UDT_AAO_Type (This_Instance.all).Current_State := 
         Root_Object.UDT.AAO.Object_State_Type(It_Failed);

      UDT_AAO_4 (
         Reason =>  UDT_AAO3(This_Event.all).Reason,
         This_Instance => This_Instance );

   end AAO3_To_It_Failed;
--
   procedure AAO4_To_It_Passed (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      UDT_AAO_Type (This_Instance.all).Current_State := 
         Root_Object.UDT.AAO.Object_State_Type(It_Passed);

      UDT_AAO_5 (
         Reason =>  UDT_AAO4(This_Event.all).Reason,
         This_Instance => This_Instance );

   end AAO4_To_It_Passed;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      UDT_AAO_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => UDT_AAO_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return UDT_AAO_Event_Queue.Queue_Length (UDT_AAO_Queue);
...
--
   This_Event_Dispatch_Matrix (AAO1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAO2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAO3, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAO4, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAO1, Idle) := AAO1_To_Do_It'access;
   This_Event_Dispatch_Matrix (AAO2, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAO3, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAO4, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAO1, Do_It) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAO2, Do_It) := AAO2_To_Do_It_Again'access;
   This_Event_Dispatch_Matrix (AAO3, Do_It) := AAO3_To_It_Failed'access;
   This_Event_Dispatch_Matrix (AAO4, Do_It) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAO1, Do_It_Again) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAO2, Do_It_Again) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAO3, Do_It_Again) := AAO3_To_It_Failed'access;
   This_Event_Dispatch_Matrix (AAO4, Do_It_Again) := AAO4_To_It_Passed'access;
   This_Event_Dispatch_Matrix (AAO1, It_Failed) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAO2, It_Failed) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAO3, It_Failed) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAO4, It_Failed) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAO1, It_Passed) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAO2, It_Passed) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAO3, It_Passed) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAO4, It_Passed) :=  Cannot_Happen_Action'access;
