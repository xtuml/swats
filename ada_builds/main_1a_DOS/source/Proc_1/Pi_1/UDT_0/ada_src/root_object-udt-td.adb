...
------------------------------------------------------------------------
--
package body Root_Object.UDT.TD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return UDT_TD_Type (This_Object.all).td_id;
   end Get_td_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      UDT_TD_Type (This_Object.all).td_id :=
         td_id_Value;
   end Put_td_id;
...
--ADATEST IGNORE_ON
   function Get_Testing_For_What (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Text_Type is
   begin
      return UDT_TD_Type (This_Object.all).Testing_For_What;
   end Get_Testing_For_What;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Testing_For_What (
      This_Object : in Root_Object.Object_Access;
      Testing_For_What_Value : in Application_Types.Base_Text_Type) is
   begin
      UDT_TD_Type (This_Object.all).Testing_For_What :=
         Testing_For_What_Value;
   end Put_Testing_For_What;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_The_Test_Number (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return UDT_TD_Type (This_Object.all).The_Test_Number;
...
--ADATEST IGNORE_ON
   ...
   begin
      UDT_TD_Type (This_Object.all).The_Test_Number :=
...
--ADATEST IGNORE_ON
   ...
   begin
      return UDT_TD_Type (This_Object.all).R1_A;
   end Get_R1_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      UDT_TD_Type (This_Object.all).R1_A :=
         R1_A_Value;
   end Put_R1_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return UDT_TD_Type (This_Object.all).R1_B;
   end Get_R1_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      UDT_TD_Type (This_Object.all).R1_B :=
         R1_B_Value;
   end Put_R1_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new UDT_TD_Type;
   
      else
         This_Object := Free_List.First_Entry;
         UDT_TD_Type(This_Object.all).td_id := Application_Types.Base_Integer_Type_First;
         UDT_TD_Type(This_Object.all).Testing_For_What := Application_Types.Base_Text_Type_First;
         UDT_TD_Type(This_Object.all).The_Test_Number := Application_Types.Base_Integer_Type_First;
