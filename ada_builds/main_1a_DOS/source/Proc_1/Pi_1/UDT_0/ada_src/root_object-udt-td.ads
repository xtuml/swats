...
--* Description:             
--*                          TAGGED Domain specification Root_Object.UDTTD
...
------------------------------------------------------------------------
   ...
   type UDT_TD_Type is new UDT_Type with record

      --
      -- Initialised Non identifying non referential
      Testing_For_What : Application_Types.Base_Text_Type := Application_Types.Base_Text_Type_First;
   ...
   procedure Put_Testing_For_What (
      ...
      Testing_For_What_Value : in Application_Types.Base_Text_Type);

   pragma inline (Get_Testing_For_What);
   pragma inline (Put_Testing_For_What);
