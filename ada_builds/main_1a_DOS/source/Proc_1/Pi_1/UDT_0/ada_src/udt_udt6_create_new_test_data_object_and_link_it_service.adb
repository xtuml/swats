...
--*************************************************************************************
--*                                                                                   *
--* File Name:               UDT6_Create_New_Test_Data_Object_And_Link_It_Service.adb
...
package body UDT_UDT6_Create_New_Test_Data_Object_And_Link_It_Service is
   ...
   begin
   -- start of UDT6_Create_New_Test_Data_Object_And_Link_It
      
      if New_Set =  True then
         
         Returned_IH := Root_Object.UDT.TD.Create;
         ...
         local_Test_Data_IH := Root_Object.UDT.TD.Create;
   ...
   end UDT_UDT6_Create_New_Test_Data_Object_And_Link_It;
   
end UDT_UDT6_Create_New_Test_Data_Object_And_Link_It_Service;

--
-- End of file UDT_UDT6_Create_New_Test_Data_Object_And_Link_It_Service.adb
--
