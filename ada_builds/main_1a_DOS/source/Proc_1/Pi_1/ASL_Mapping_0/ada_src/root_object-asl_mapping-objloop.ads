...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objLOOP.ads
...
--* Description:             
--*                          Domain specification Root_Object.ASL_MappingobjLOOP
...
--  ----------------------------------  
--  package Root_Object.ASL_Mapping.objLOOP
...
package Root_Object.ASL_Mapping.objLOOP is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_LOOP Information **************
   --
   -- Object objLOOP is PASSIVE
   --
   --
   --
   -- Object objLOOP has an identifying non-referential attribute ReferenceLOOP 
   -- and therefore may be uniquely created.
   -- 
   -- Object objLOOP has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objLOOP";

   --
   -------------------------------------------------------------------------------------------------
   --

   type ASL_Mapping_objLOOP_Type is new ASL_Mapping_Type with record

      --
      -- Non initialised identifying non referential
      ReferenceLOOP : Application_Types.Base_Integer_Type;
   ...
   procedure Put_ReferenceLOOP (
      ...
      ReferenceLOOP_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_ReferenceLOOP);
   pragma inline (Put_ReferenceLOOP);
