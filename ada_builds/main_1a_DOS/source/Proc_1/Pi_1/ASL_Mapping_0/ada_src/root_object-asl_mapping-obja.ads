...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objA.ads
...
--* Description:             
--*                          Domain specification Root_Object.ASL_MappingobjA
...
--  ----------------------------------  
--  package Root_Object.ASL_Mapping.objA
...
package Root_Object.ASL_Mapping.objA is
--
------------------------------------------------------------------------
   --
   --**************  Object ObjectA Information **************
   --
   ...
   type ASL_Mapping_objA_Type is new ASL_Mapping_Type with record
      ...
      --
      -- Initialised Non identifying non referential
      The_Int2 : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_The_Int1 (
      This_Object : in Root_Object.Object_Access;
      The_Int1_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_The_Int1);
   pragma inline (Put_The_Int1);


   function Get_The_Int2 (
      This_Object : Root_Object.Object_Access) 
   return Application_Types.Base_Integer_Type;

   procedure Put_The_Int2 (
      This_Object : in Root_Object.Object_Access;
      The_Int2_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_The_Int2);
   pragma inline (Put_The_Int2);
...
end Root_Object.ASL_Mapping.objA;
