...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objLeft.ads
...
--* Description:             
--*                          Domain specification Root_Object.ASL_MappingobjLeft
...
--  ----------------------------------  
--  package Root_Object.ASL_Mapping.objLeft
...
package Root_Object.ASL_Mapping.objLeft is
--
------------------------------------------------------------------------
   --
   --**************  Object Left Information **************
   --
   -- Object objLeft is PASSIVE
   --
   --
   --
   -- Object objLeft has an identifying non-referential attribute idL 
   -- and therefore may be uniquely created.
   -- 
   -- Object objLeft has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objLeft";

   --
   -------------------------------------------------------------------------------------------------
   --

   type ASL_Mapping_objLeft_Type is new ASL_Mapping_Type with record
      ...
      attrL : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_attrL (
      This_Object : in Root_Object.Object_Access;
      attrL_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_attrL);
   pragma inline (Put_attrL);
