...
--*************************************************************************************
--*                                                                                   *
--* File Name:               ASL_Mapping_domain_types.ops.adb
...
--*  package body ASL_Mapping_Domain_Types.Ops 
--*
--*************************************************************************************
--  MODIFICATION RECORD
--  --------------------
...
package body ASL_Mapping_Domain_Types.Ops is
   ...
   Temp_Structure: Simple_Structure_Type_Node_Access :=
      new Simple_Structure_Type_Node'(
         Simple_Int  => A_Simple_Int,
         Simple_Real  => A_Simple_Real,
         Simple_String  => A_Simple_String,
         Simple_Boolean  => A_Simple_Boolean,
         Simple_Enum  => A_Simple_Enum,
         Next_Structure     => null,
...
--  --
   ...
   begin
      ...
      A_Simple_Int := From_Structure.Iterator.all.Simple_Int;
      A_Simple_Real := From_Structure.Iterator.all.Simple_Real;
      A_Simple_String := From_Structure.Iterator.all.Simple_String;
      A_Simple_Boolean := From_Structure.Iterator.all.Simple_Boolean;
      A_Simple_Enum := From_Structure.Iterator.all.Simple_Enum;
