...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objB.ads
...
--* Description:             
--*                          Domain specification Root_Object.ASL_MappingobjB
...
--  ----------------------------------  
--  package Root_Object.ASL_Mapping.objB
...
package Root_Object.ASL_Mapping.objB is
--
------------------------------------------------------------------------
   --
   --**************  Object ObjectB Information **************
   --
   -- Object objB is PASSIVE
   --
   --
   --
   -- Object objB has an identifying non-referential attribute objB_id 
   ...
   type ASL_Mapping_objB_Type is new ASL_Mapping_Type with record

      --
      -- Non initialised identifying non referential
      objB_id : Application_Types.Base_Integer_Type;

      --
      -- Initialised Non identifying non referential
      The_IntB1 : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      The_IntB2 : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_objB_id (
      ...
      objB_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_objB_id);
   pragma inline (Put_objB_id);
   ...
   procedure Put_The_IntB1 (
      This_Object : in Root_Object.Object_Access;
      The_IntB1_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_The_IntB1);
   pragma inline (Put_The_IntB1);
   ...
   procedure Put_The_IntB2 (
      This_Object : in Root_Object.Object_Access;
      The_IntB2_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_The_IntB2);
   pragma inline (Put_The_IntB2);
