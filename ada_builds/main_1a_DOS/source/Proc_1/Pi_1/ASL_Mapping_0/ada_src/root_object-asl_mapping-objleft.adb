...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objLeft.adb
...
--* Description:             
--*                          Domain body Root_Object.ASL_MappingobjLeft
...
------------------------------------------------------------------------
--
package body Root_Object.ASL_Mapping.objLeft is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idL_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idL return Application_Types.Base_Integer_Type is
   begin
      idL_Value :=
         Application_Types.Base_Integer_Type'succ (idL_Value);
      return idL_Value;
   end Obtain_Subsequent_idL;
...
--ADATEST IGNORE_ON
   ...
   begin
       return ASL_Mapping_objLeft_Type (This_Object.all).idL;
   end Get_idL;
...
--ADATEST IGNORE_ON
   ...
   begin
      ASL_Mapping_objLeft_Type (This_Object.all).idL :=
         idL_Value;
   end Put_idL;
...
--ADATEST IGNORE_ON
   function Get_attrL (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return ASL_Mapping_objLeft_Type (This_Object.all).attrL;
   end Get_attrL;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_attrL (
      This_Object : in Root_Object.Object_Access;
      attrL_Value : in Application_Types.Base_Integer_Type) is
   begin
      ASL_Mapping_objLeft_Type (This_Object.all).attrL :=
         attrL_Value;
   end Put_attrL;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new ASL_Mapping_objLeft_Type;
   
      else
         This_Object := Free_List.First_Entry;
         ASL_Mapping_objLeft_Type(This_Object.all).idL := Application_Types.Base_Integer_Type_First;
         ASL_Mapping_objLeft_Type(This_Object.all).attrL := Application_Types.Base_Integer_Type_First;
...
end Root_Object.ASL_Mapping.objLeft;
