...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.DV.ads
...
--* Description:             
--*                          Domain specification Root_Object.ASL_MappingDV
...
--  ----------------------------------  
--  package Root_Object.ASL_Mapping.DV
...
package Root_Object.ASL_Mapping.DV is
--
------------------------------------------------------------------------
   --
   --**************  Object Default_Vals Information **************
   --
   -- Object DV is PASSIVE
   --
   --
   --
   ...
   type ASL_Mapping_DV_Type is new ASL_Mapping_Type with record
      ...
      --
      -- Initialised Non identifying non referential
      The_Text : Application_Types.Base_Text_Type := Application_Types.Base_Text_Type_First;
   ...
   procedure Put_The_Text (
      This_Object : in Root_Object.Object_Access;
      The_Text_Value : in Application_Types.Base_Text_Type);

   pragma inline (Get_The_Text);
   pragma inline (Put_The_Text);
