...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.DV.adb
...
--* Description:             
--*                          Domain body Root_Object.ASL_MappingDV
...
------------------------------------------------------------------------
--
package body Root_Object.ASL_Mapping.DV is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   function Get_The_Integer (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return ASL_Mapping_DV_Type (This_Object.all).The_Integer;
   end Get_The_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ASL_Mapping_DV_Type (This_Object.all).The_Integer :=
         The_Integer_Value;
   end Put_The_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return ASL_Mapping_DV_Type (This_Object.all).The_Real;
   end Get_The_Real;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ASL_Mapping_DV_Type (This_Object.all).The_Real :=
         The_Real_Value;
   end Put_The_Real;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return ASL_Mapping_DV_Type (This_Object.all).The_Text;
   end Get_The_Text;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_The_Text (
      This_Object : in Root_Object.Object_Access;
      The_Text_Value : in Application_Types.Base_Text_Type) is
   begin
      ASL_Mapping_DV_Type (This_Object.all).The_Text :=
         The_Text_Value;
   end Put_The_Text;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return ASL_Mapping_DV_Type (This_Object.all).The_Boolean;
   end Get_The_Boolean;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ASL_Mapping_DV_Type (This_Object.all).The_Boolean :=
         The_Boolean_Value;
   end Put_The_Boolean;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new ASL_Mapping_DV_Type;
         ...
         ASL_Mapping_DV_Type(This_Object.all).The_Boolean := Application_Types.Boolean_First;
...
end Root_Object.ASL_Mapping.DV;
