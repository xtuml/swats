...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.RD.ads
...
--* Description:             
--*                          Domain specification Root_Object.ASL_MappingRD
...
--  ----------------------------------  
--  package Root_Object.ASL_Mapping.RD
...
package Root_Object.ASL_Mapping.RD is
--
------------------------------------------------------------------------
   --
   ...
   type ASL_Mapping_RD_Type is new ASL_Mapping_Type with record
