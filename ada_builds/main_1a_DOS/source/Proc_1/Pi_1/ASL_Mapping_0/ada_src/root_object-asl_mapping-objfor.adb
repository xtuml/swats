...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objFOR.adb
...
--* Description:             
--*                          Domain body Root_Object.ASL_MappingobjFOR
...
------------------------------------------------------------------------
--
package body Root_Object.ASL_Mapping.objFOR is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   ReferenceFOR_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceFOR return Application_Types.Base_Integer_Type is
   begin
      ReferenceFOR_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceFOR_Value);
      return ReferenceFOR_Value;
   end Obtain_Subsequent_ReferenceFOR;
...
--ADATEST IGNORE_ON
   function Get_ReferenceFOR (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return ASL_Mapping_objFOR_Type (This_Object.all).ReferenceFOR;
   end Get_ReferenceFOR;
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceFOR (
      This_Object : in Root_Object.Object_Access;
      ReferenceFOR_Value : in Application_Types.Base_Integer_Type) is
   begin
      ASL_Mapping_objFOR_Type (This_Object.all).ReferenceFOR :=
         ReferenceFOR_Value;
   end Put_ReferenceFOR;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return ASL_Mapping_objFOR_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ASL_Mapping_objFOR_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new ASL_Mapping_objFOR_Type;
   
      else
         This_Object := Free_List.First_Entry;
         ASL_Mapping_objFOR_Type(This_Object.all).ReferenceFOR := Application_Types.Base_Integer_Type_First;
         ASL_Mapping_objFOR_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      ASL_Mapping_objFOR_Type(This_Object.all).ReferenceFOR :=
         Obtain_Subsequent_ReferenceFOR;
...
end Root_Object.ASL_Mapping.objFOR;
