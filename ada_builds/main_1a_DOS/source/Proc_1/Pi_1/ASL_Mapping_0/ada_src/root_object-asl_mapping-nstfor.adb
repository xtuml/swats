...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.NstFOR.adb
...
--* Description:             
--*                          Domain body Root_Object.ASL_MappingNstFOR
...
------------------------------------------------------------------------
--
package body Root_Object.ASL_Mapping.NstFOR is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   ReferenceNstFOR_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceNstFOR return Application_Types.Base_Integer_Type is
   begin
      ReferenceNstFOR_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceNstFOR_Value);
      return ReferenceNstFOR_Value;
   end Obtain_Subsequent_ReferenceNstFOR;
...
--ADATEST IGNORE_ON
   function Get_ReferenceNstFOR (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return ASL_Mapping_NstFOR_Type (This_Object.all).ReferenceNstFOR;
   end Get_ReferenceNstFOR;
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceNstFOR (
      This_Object : in Root_Object.Object_Access;
      ReferenceNstFOR_Value : in Application_Types.Base_Integer_Type) is
   begin
      ASL_Mapping_NstFOR_Type (This_Object.all).ReferenceNstFOR :=
         ReferenceNstFOR_Value;
   end Put_ReferenceNstFOR;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return ASL_Mapping_NstFOR_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ASL_Mapping_NstFOR_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new ASL_Mapping_NstFOR_Type;
   
      else
         This_Object := Free_List.First_Entry;
         ASL_Mapping_NstFOR_Type(This_Object.all).ReferenceNstFOR := Application_Types.Base_Integer_Type_First;
         ASL_Mapping_NstFOR_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      ASL_Mapping_NstFOR_Type(This_Object.all).ReferenceNstFOR :=
         Obtain_Subsequent_ReferenceNstFOR;
...
end Root_Object.ASL_Mapping.NstFOR;
