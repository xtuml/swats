...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objA.adb
...
--* Description:             
--*                          Domain body Root_Object.ASL_MappingobjA
...
------------------------------------------------------------------------
--
package body Root_Object.ASL_Mapping.objA is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   function Get_The_Int1 (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return ASL_Mapping_objA_Type (This_Object.all).The_Int1;
   end Get_The_Int1;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_The_Int1 (
      This_Object : in Root_Object.Object_Access;
      The_Int1_Value : in Application_Types.Base_Integer_Type) is
   begin
      ASL_Mapping_objA_Type (This_Object.all).The_Int1 :=
         The_Int1_Value;
   end Put_The_Int1;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_The_Int2 (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return ASL_Mapping_objA_Type (This_Object.all).The_Int2;
   end Get_The_Int2;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_The_Int2 (
      This_Object : in Root_Object.Object_Access;
      The_Int2_Value : in Application_Types.Base_Integer_Type) is
   begin
      ASL_Mapping_objA_Type (This_Object.all).The_Int2 :=
         The_Int2_Value;
   end Put_The_Int2;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new ASL_Mapping_objA_Type;
