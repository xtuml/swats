...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objIF.ads
...
--* Description:             
--*                          Domain specification Root_Object.ASL_MappingobjIF
...
--  ----------------------------------  
--  package Root_Object.ASL_Mapping.objIF
...
package Root_Object.ASL_Mapping.objIF is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_IF Information **************
   --
   -- Object objIF is PASSIVE
   --
   --
   --
   -- Object objIF has an identifying non-referential attribute ReferenceIF 
   -- and therefore may be uniquely created.
   -- 
   -- Object objIF has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objIF";

   --
   -------------------------------------------------------------------------------------------------
   --

   type ASL_Mapping_objIF_Type is new ASL_Mapping_Type with record

      --
      -- Non initialised identifying non referential
      ReferenceIF : Application_Types.Base_Integer_Type;
   ...
   procedure Put_ReferenceIF (
      ...
      ReferenceIF_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_ReferenceIF);
   pragma inline (Put_ReferenceIF);
