...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objLOOP.adb
...
--* Description:             
--*                          Domain body Root_Object.ASL_MappingobjLOOP
...
------------------------------------------------------------------------
--
package body Root_Object.ASL_Mapping.objLOOP is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   ReferenceLOOP_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceLOOP return Application_Types.Base_Integer_Type is
   begin
      ReferenceLOOP_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceLOOP_Value);
      return ReferenceLOOP_Value;
   end Obtain_Subsequent_ReferenceLOOP;
...
--ADATEST IGNORE_ON
   function Get_ReferenceLOOP (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return ASL_Mapping_objLOOP_Type (This_Object.all).ReferenceLOOP;
   end Get_ReferenceLOOP;
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceLOOP (
      This_Object : in Root_Object.Object_Access;
      ReferenceLOOP_Value : in Application_Types.Base_Integer_Type) is
   begin
      ASL_Mapping_objLOOP_Type (This_Object.all).ReferenceLOOP :=
         ReferenceLOOP_Value;
   end Put_ReferenceLOOP;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return ASL_Mapping_objLOOP_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ASL_Mapping_objLOOP_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new ASL_Mapping_objLOOP_Type;
   
      else
         This_Object := Free_List.First_Entry;
         ASL_Mapping_objLOOP_Type(This_Object.all).ReferenceLOOP := Application_Types.Base_Integer_Type_First;
         ASL_Mapping_objLOOP_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      ASL_Mapping_objLOOP_Type(This_Object.all).ReferenceLOOP :=
         Obtain_Subsequent_ReferenceLOOP;
...
end Root_Object.ASL_Mapping.objLOOP;
