...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.NstLOOP.adb
...
--* Description:             
--*                          Domain body Root_Object.ASL_MappingNstLOOP
...
------------------------------------------------------------------------
--
package body Root_Object.ASL_Mapping.NstLOOP is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   ReferenceNstLOOP_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceNstLOOP return Application_Types.Base_Integer_Type is
   begin
      ReferenceNstLOOP_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceNstLOOP_Value);
      return ReferenceNstLOOP_Value;
   end Obtain_Subsequent_ReferenceNstLOOP;
...
--ADATEST IGNORE_ON
   function Get_ReferenceNstLOOP (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return ASL_Mapping_NstLOOP_Type (This_Object.all).ReferenceNstLOOP;
   end Get_ReferenceNstLOOP;
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceNstLOOP (
      This_Object : in Root_Object.Object_Access;
      ReferenceNstLOOP_Value : in Application_Types.Base_Integer_Type) is
   begin
      ASL_Mapping_NstLOOP_Type (This_Object.all).ReferenceNstLOOP :=
         ReferenceNstLOOP_Value;
   end Put_ReferenceNstLOOP;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return ASL_Mapping_NstLOOP_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ASL_Mapping_NstLOOP_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new ASL_Mapping_NstLOOP_Type;
   
      else
         This_Object := Free_List.First_Entry;
         ASL_Mapping_NstLOOP_Type(This_Object.all).ReferenceNstLOOP := Application_Types.Base_Integer_Type_First;
         ASL_Mapping_NstLOOP_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      ASL_Mapping_NstLOOP_Type(This_Object.all).ReferenceNstLOOP :=
         Obtain_Subsequent_ReferenceNstLOOP;
...
end Root_Object.ASL_Mapping.NstLOOP;
