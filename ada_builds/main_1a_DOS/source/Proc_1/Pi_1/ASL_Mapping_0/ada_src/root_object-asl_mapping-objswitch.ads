...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objSWITCH.ads
...
--* Description:             
--*                          Domain specification Root_Object.ASL_MappingobjSWITCH
...
--  ----------------------------------  
--  package Root_Object.ASL_Mapping.objSWITCH
...
package Root_Object.ASL_Mapping.objSWITCH is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_SWITCH Information **************
   --
   -- Object objSWITCH is PASSIVE
   --
   --
   --
   -- Object objSWITCH has an identifying non-referential attribute ReferenceSWITCH 
   -- and therefore may be uniquely created.
   -- 
   -- Object objSWITCH has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objSWITCH";

   --
   -------------------------------------------------------------------------------------------------
   --

   type ASL_Mapping_objSWITCH_Type is new ASL_Mapping_Type with record

      --
      -- Non initialised identifying non referential
      ReferenceSWITCH : Application_Types.Base_Integer_Type;
   ...
   procedure Put_ReferenceSWITCH (
      ...
      ReferenceSWITCH_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_ReferenceSWITCH);
   pragma inline (Put_ReferenceSWITCH);
