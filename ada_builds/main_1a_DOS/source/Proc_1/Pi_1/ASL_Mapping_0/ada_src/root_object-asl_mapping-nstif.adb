...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.NstIF.adb
...
--* Description:             
--*                          Domain body Root_Object.ASL_MappingNstIF
...
------------------------------------------------------------------------
--
package body Root_Object.ASL_Mapping.NstIF is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   ReferenceNstIF_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceNstIF return Application_Types.Base_Integer_Type is
   begin
      ReferenceNstIF_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceNstIF_Value);
      return ReferenceNstIF_Value;
   end Obtain_Subsequent_ReferenceNstIF;
...
--ADATEST IGNORE_ON
   function Get_ReferenceNstIF (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return ASL_Mapping_NstIF_Type (This_Object.all).ReferenceNstIF;
   end Get_ReferenceNstIF;
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceNstIF (
      This_Object : in Root_Object.Object_Access;
      ReferenceNstIF_Value : in Application_Types.Base_Integer_Type) is
   begin
      ASL_Mapping_NstIF_Type (This_Object.all).ReferenceNstIF :=
         ReferenceNstIF_Value;
   end Put_ReferenceNstIF;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return ASL_Mapping_NstIF_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ASL_Mapping_NstIF_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new ASL_Mapping_NstIF_Type;
   
      else
         This_Object := Free_List.First_Entry;
         ASL_Mapping_NstIF_Type(This_Object.all).ReferenceNstIF := Application_Types.Base_Integer_Type_First;
         ASL_Mapping_NstIF_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      ASL_Mapping_NstIF_Type(This_Object.all).ReferenceNstIF :=
         Obtain_Subsequent_ReferenceNstIF;
...
end Root_Object.ASL_Mapping.NstIF;
