...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objAR.ads
...
--* Description:             
--*                          Domain specification Root_Object.ASL_MappingobjAR
...
--  ----------------------------------  
--  package Root_Object.ASL_Mapping.objAR
...
package Root_Object.ASL_Mapping.objAR is
--
------------------------------------------------------------------------
   --
   --**************  Object Another_Right Information **************
   --
   -- Object objAR is PASSIVE
   --
   --
   --
   -- Object objAR has an identifying non-referential attribute idAR 
   -- and therefore may be uniquely created.
   -- 
   -- Object objAR has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objAR";

   --
   -------------------------------------------------------------------------------------------------
   --

   type ASL_Mapping_objAR_Type is new ASL_Mapping_Type with record
   ...
   procedure Put_idAR (
      ...
      idAR_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idAR);
   pragma inline (Put_idAR);
