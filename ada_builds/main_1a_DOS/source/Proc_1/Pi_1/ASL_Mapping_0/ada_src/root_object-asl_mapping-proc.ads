...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.PROC.ads
...
--* Description:             
--*                          Domain specification Root_Object.ASL_MappingPROC
...
--  ----------------------------------  
--  package Root_Object.ASL_Mapping.PROC
...
package Root_Object.ASL_Mapping.PROC is
--
------------------------------------------------------------------------
   --
   --**************  Object Processor Information **************
   --
   -- Object PROC is PASSIVE
   --
   --
   --
   -- Object PROC has an identifying non-referential attribute Processor_Id 
   -- and therefore may be uniquely created.
   -- 
   -- Object PROC has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "PROC";

   --
   -------------------------------------------------------------------------------------------------
   --

   type ASL_Mapping_PROC_Type is new ASL_Mapping_Type with record

      --
      -- Non initialised identifying non referential
      Processor_Id : ASL_Mapping_Domain_Types.Processor_Id_Type;

      --
      -- Initialised Non identifying non referential
      Background_Processing_Timer_Id : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      Communications_Enabled :  Boolean := Application_Types.Boolean_First;
   ...
   return ASL_Mapping_Domain_Types.Processor_Id_Type;

   procedure Put_Processor_Id (
      This_Object : in Root_Object.Object_Access;
      Processor_Id_Value : in ASL_Mapping_Domain_Types.Processor_Id_Type);

   pragma inline (Get_Processor_Id);
   pragma inline (Put_Processor_Id);
   ...
   procedure Put_Background_Processing_Timer_Id (
      This_Object : in Root_Object.Object_Access;
      Background_Processing_Timer_Id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Background_Processing_Timer_Id);
   pragma inline (Put_Background_Processing_Timer_Id);
   ...
   procedure Put_Communications_Enabled (
      This_Object : in Root_Object.Object_Access;
      Communications_Enabled_Value : in  Boolean);

   pragma inline (Get_Communications_Enabled);
   pragma inline (Put_Communications_Enabled);
