...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.PROC.adb
...
--* Description:             
--*                          Domain body Root_Object.ASL_MappingPROC
...
------------------------------------------------------------------------
--
package body Root_Object.ASL_Mapping.PROC is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Processor_Id_Value : ASL_Mapping_Domain_Types.Processor_Id_Type := ASL_Mapping_Domain_Types.Processor_Id_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Processor_Id return ASL_Mapping_Domain_Types.Processor_Id_Type is
   begin
      Processor_Id_Value :=
         ASL_Mapping_Domain_Types.Processor_Id_Type'succ (Processor_Id_Value);
      return Processor_Id_Value;
   end Obtain_Subsequent_Processor_Id;
...
--ADATEST IGNORE_ON
   function Get_Processor_Id (
      This_Object : Root_Object.Object_Access) return ASL_Mapping_Domain_Types.Processor_Id_Type is
   begin
       return ASL_Mapping_PROC_Type (This_Object.all).Processor_Id;
   end Get_Processor_Id;
...
--ADATEST IGNORE_ON
   procedure Put_Processor_Id (
      This_Object : in Root_Object.Object_Access;
      Processor_Id_Value : in ASL_Mapping_Domain_Types.Processor_Id_Type) is
   begin
      ASL_Mapping_PROC_Type (This_Object.all).Processor_Id :=
         Processor_Id_Value;
   end Put_Processor_Id;
...
--ADATEST IGNORE_ON
   function Get_Background_Processing_Timer_Id (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return ASL_Mapping_PROC_Type (This_Object.all).Background_Processing_Timer_Id;
   end Get_Background_Processing_Timer_Id;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Background_Processing_Timer_Id (
      This_Object : in Root_Object.Object_Access;
      Background_Processing_Timer_Id_Value : in Application_Types.Base_Integer_Type) is
   begin
      ASL_Mapping_PROC_Type (This_Object.all).Background_Processing_Timer_Id :=
         Background_Processing_Timer_Id_Value;
   end Put_Background_Processing_Timer_Id;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   function Get_Communications_Enabled (
      This_Object: Root_Object.Object_Access) return  Boolean is
   begin
      return ASL_Mapping_PROC_Type (This_Object.all).Communications_Enabled;
   end Get_Communications_Enabled;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Communications_Enabled (
      This_Object : in Root_Object.Object_Access;
      Communications_Enabled_Value : in  Boolean) is
   begin
      ASL_Mapping_PROC_Type (This_Object.all).Communications_Enabled :=
         Communications_Enabled_Value;
   end Put_Communications_Enabled;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new ASL_Mapping_PROC_Type;
   
      else
         This_Object := Free_List.First_Entry;
         ASL_Mapping_PROC_Type(This_Object.all).Processor_Id := ASL_Mapping_Domain_Types.Processor_Id_Type_First;
         ASL_Mapping_PROC_Type(This_Object.all).Background_Processing_Timer_Id := Application_Types.Base_Integer_Type_First;
         ASL_Mapping_PROC_Type(This_Object.all).Communications_Enabled := Application_Types.Boolean_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      ASL_Mapping_PROC_Type(This_Object.all).Processor_Id :=
         Obtain_Subsequent_Processor_Id;
...
end Root_Object.ASL_Mapping.PROC;
