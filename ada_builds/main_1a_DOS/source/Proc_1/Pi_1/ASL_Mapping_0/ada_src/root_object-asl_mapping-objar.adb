...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objAR.adb
...
--* Description:             
--*                          Domain body Root_Object.ASL_MappingobjAR
...
------------------------------------------------------------------------
--
package body Root_Object.ASL_Mapping.objAR is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idAR_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idAR return Application_Types.Base_Integer_Type is
   begin
      idAR_Value :=
         Application_Types.Base_Integer_Type'succ (idAR_Value);
      return idAR_Value;
   end Obtain_Subsequent_idAR;
...
--ADATEST IGNORE_ON
   ...
   begin
       return ASL_Mapping_objAR_Type (This_Object.all).idAR;
   end Get_idAR;
...
--ADATEST IGNORE_ON
   procedure Put_idAR (
      ...
      idAR_Value : in Application_Types.Base_Integer_Type) is
   begin
      ASL_Mapping_objAR_Type (This_Object.all).idAR :=
         idAR_Value;
   end Put_idAR;
...
--ADATEST IGNORE_ON
   ...
   begin
      return ASL_Mapping_objAR_Type (This_Object.all).R2_A;
   end Get_R2_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ASL_Mapping_objAR_Type (This_Object.all).R2_A :=
         R2_A_Value;
   end Put_R2_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new ASL_Mapping_objAR_Type;
   
      else
         This_Object := Free_List.First_Entry;
         ASL_Mapping_objAR_Type(This_Object.all).idAR := Application_Types.Base_Integer_Type_First;
...
end Root_Object.ASL_Mapping.objAR;
