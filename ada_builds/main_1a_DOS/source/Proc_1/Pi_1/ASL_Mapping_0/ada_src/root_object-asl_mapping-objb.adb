...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objB.adb
...
--* Description:             
--*                          Domain body Root_Object.ASL_MappingobjB
...
------------------------------------------------------------------------
--
package body Root_Object.ASL_Mapping.objB is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   objB_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_objB_id return Application_Types.Base_Integer_Type is
   begin
      objB_id_Value :=
         Application_Types.Base_Integer_Type'succ (objB_id_Value);
      return objB_id_Value;
   end Obtain_Subsequent_objB_id;
...
--ADATEST IGNORE_ON
   procedure Put_objB_id (
      This_Object : in Root_Object.Object_Access;
      objB_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      ASL_Mapping_objB_Type (This_Object.all).objB_id :=
         objB_id_Value;
   end Put_objB_id;
...
--ADATEST IGNORE_ON
   function Get_The_IntB1 (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return ASL_Mapping_objB_Type (This_Object.all).The_IntB1;
   end Get_The_IntB1;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_The_IntB1 (
      This_Object : in Root_Object.Object_Access;
      The_IntB1_Value : in Application_Types.Base_Integer_Type) is
   begin
      ASL_Mapping_objB_Type (This_Object.all).The_IntB1 :=
         The_IntB1_Value;
   end Put_The_IntB1;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_The_IntB2 (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return ASL_Mapping_objB_Type (This_Object.all).The_IntB2;
   end Get_The_IntB2;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_The_IntB2 (
      This_Object : in Root_Object.Object_Access;
      The_IntB2_Value : in Application_Types.Base_Integer_Type) is
   begin
      ASL_Mapping_objB_Type (This_Object.all).The_IntB2 :=
         The_IntB2_Value;
   end Put_The_IntB2;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new ASL_Mapping_objB_Type;
   
      else
         This_Object := Free_List.First_Entry;
         ASL_Mapping_objB_Type(This_Object.all).objB_id := Application_Types.Base_Integer_Type_First;
         ASL_Mapping_objB_Type(This_Object.all).The_IntB1 := Application_Types.Base_Integer_Type_First;
         ASL_Mapping_objB_Type(This_Object.all).The_IntB2 := Application_Types.Base_Integer_Type_First;
...
end Root_Object.ASL_Mapping.objB;
