...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objLOGIC.ads
...
--* Description:             
--*                          Domain specification Root_Object.ASL_MappingobjLOGIC
...
--  ----------------------------------  
--  package Root_Object.ASL_Mapping.objLOGIC
...
package Root_Object.ASL_Mapping.objLOGIC is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_LOGIC Information **************
   --
   -- Object objLOGIC is PASSIVE
   --
   --
   --
   -- Object objLOGIC has an identifying non-referential attribute ReferenceLOGIC 
   -- and therefore may be uniquely created.
   -- 
   -- Object objLOGIC has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objLOGIC";

   --
   -------------------------------------------------------------------------------------------------
   --

   type ASL_Mapping_objLOGIC_Type is new ASL_Mapping_Type with record

      --
      -- Initialised Non identifying non referential
      IntegerAttr : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      TextAttr : Application_Types.Base_Text_Type := Application_Types.Base_Text_Type_First;

      --
      -- Initialised Non identifying non referential
      EnumerationAttr : ASL_Mapping_Domain_Types.Enum := ASL_Mapping_Domain_Types.Enum_First;

      --
      -- Initialised Non identifying non referential
      BooleanAttr :  Boolean := Application_Types.Boolean_First;
      ...
      ReferenceLOGIC : Application_Types.Base_Integer_Type;

      --
      -- Initialised Non identifying non referential
      RealAttr : Application_Types.Base_Float_Type := Application_Types.Base_Float_Type_First;
   ...
   procedure Put_IntegerAttr (
      ...
      IntegerAttr_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_IntegerAttr);
   pragma inline (Put_IntegerAttr);
   ...
   procedure Put_TextAttr (
      This_Object : in Root_Object.Object_Access;
      TextAttr_Value : in Application_Types.Base_Text_Type);

   pragma inline (Get_TextAttr);
   pragma inline (Put_TextAttr);


   function Get_EnumerationAttr (
      This_Object : Root_Object.Object_Access) 
   return ASL_Mapping_Domain_Types.Enum;

   procedure Put_EnumerationAttr (
      This_Object : in Root_Object.Object_Access;
      EnumerationAttr_Value : in ASL_Mapping_Domain_Types.Enum);

   pragma inline (Get_EnumerationAttr);
   pragma inline (Put_EnumerationAttr);
   ...
   procedure Put_BooleanAttr (
      This_Object : in Root_Object.Object_Access;
      BooleanAttr_Value : in  Boolean);

   pragma inline (Get_BooleanAttr);
   pragma inline (Put_BooleanAttr);
   ...
   procedure Put_ReferenceLOGIC (
      This_Object : in Root_Object.Object_Access;
      ReferenceLOGIC_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_ReferenceLOGIC);
   pragma inline (Put_ReferenceLOGIC);
   ...
   procedure Put_RealAttr (
      This_Object : in Root_Object.Object_Access;
      RealAttr_Value : in Application_Types.Base_Float_Type);

   pragma inline (Get_RealAttr);
   pragma inline (Put_RealAttr);
