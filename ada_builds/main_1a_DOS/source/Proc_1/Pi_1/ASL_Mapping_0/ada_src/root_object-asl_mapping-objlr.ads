...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objLR.ads
...
--* Description:             
--*                          Domain specification Root_Object.ASL_MappingobjLR
...
--  ----------------------------------  
--  package Root_Object.ASL_Mapping.objLR
...
package Root_Object.ASL_Mapping.objLR is
--
------------------------------------------------------------------------
   --
   --**************  Object LeftRight Information **************
   --
   -- Object objLR is PASSIVE
   --
   --
   --
   -- Object objLR does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object objLR has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objLR";

   --
   -------------------------------------------------------------------------------------------------
   --

   type ASL_Mapping_objLR_Type is new ASL_Mapping_Type with record

      --
      -- Non initialised identifying referential
      idL : Application_Types.Base_Integer_Type;
      ...
      -- idAR : Application_Types.Base_Integer_Type;
   ...
   procedure Put_idR (
      This_Object : in Root_Object.Object_Access;
      idR_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idR);
   pragma inline (Put_idR);
...
end Root_Object.ASL_Mapping.objLR;
