...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objIF.adb
...
--* Description:             
--*                          Domain body Root_Object.ASL_MappingobjIF
...
------------------------------------------------------------------------
--
package body Root_Object.ASL_Mapping.objIF is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   ReferenceIF_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceIF return Application_Types.Base_Integer_Type is
   begin
      ReferenceIF_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceIF_Value);
      return ReferenceIF_Value;
   end Obtain_Subsequent_ReferenceIF;
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceIF (
      This_Object : in Root_Object.Object_Access;
      ReferenceIF_Value : in Application_Types.Base_Integer_Type) is
   begin
      ASL_Mapping_objIF_Type (This_Object.all).ReferenceIF :=
         ReferenceIF_Value;
   end Put_ReferenceIF;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return ASL_Mapping_objIF_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ASL_Mapping_objIF_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new ASL_Mapping_objIF_Type;
   
      else
         This_Object := Free_List.First_Entry;
         ASL_Mapping_objIF_Type(This_Object.all).ReferenceIF := Application_Types.Base_Integer_Type_First;
         ASL_Mapping_objIF_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
...
end Root_Object.ASL_Mapping.objIF;
