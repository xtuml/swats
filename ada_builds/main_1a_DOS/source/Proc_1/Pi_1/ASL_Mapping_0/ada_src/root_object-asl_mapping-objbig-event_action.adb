...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objBIG.event_action.ada
...
--*  separate of Root_Object.ASL_MappingobjBIG
--*     Event_Action
--*
--*************************************************************************************
--  MODIFICATION RECORD
...
begin
   ...
   This_Action := ASL_Mapping_objBIG_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := ASL_Mapping_objBIG_Instance_Event_Type(This_Event.all).Target_Instance;


   -- Ensure that the source instance still exists. 
   if This /= null then
      This_Event_Dispatch_Matrix (This_Action, ASL_Mapping_objBIG_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
