...
--*************************************************************************************
--*                                                                                   *
--* File Name:               ASL_Mapping_objLOGIC2_Perform_Attribute_Assignment_Service.adb
...
package body ASL_Mapping_objLOGIC2_Perform_Attribute_Assignment_Service is
   
   procedure ASL_Mapping_objLOGIC2_Perform_Attribute_Assignment (
   ...
   begin
   -- start of objLOGIC2_Perform_Attribute_Assignment
      ...
      ASL_Mapping_RPT1_Start_Test_Bridge.ASL_Mapping_RPT1_Start_Test (
         ...
         Invoking_Object => "Passive Object Service Perform A",
   ...
   end ASL_Mapping_objLOGIC2_Perform_Attribute_Assignment;
   
end ASL_Mapping_objLOGIC2_Perform_Attribute_Assignment_Service;

--
-- End of file ASL_Mapping_objLOGIC2_Perform_Attribute_Assignment_Service.adb
--
