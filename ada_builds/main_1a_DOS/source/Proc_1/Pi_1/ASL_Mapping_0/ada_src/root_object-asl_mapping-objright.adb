...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objRight.adb
...
--* Description:             
--*                          Domain body Root_Object.ASL_MappingobjRight
...
------------------------------------------------------------------------
--
package body Root_Object.ASL_Mapping.objRight is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return ASL_Mapping_objRight_Type (This_Object.all).idR;
   end Get_idR;
...
--ADATEST IGNORE_ON
   ...
   begin
      ASL_Mapping_objRight_Type (This_Object.all).idR :=
         idR_Value;
   end Put_idR;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new ASL_Mapping_objRight_Type;
   
      else
         This_Object := Free_List.First_Entry;
         ASL_Mapping_objRight_Type(This_Object.all).idR := Application_Types.Base_Integer_Type_First;
...
end Root_Object.ASL_Mapping.objRight;
