...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.NstFOR.ads
...
--* Description:             
--*                          Domain specification Root_Object.ASL_MappingNstFOR
...
--  ----------------------------------  
--  package Root_Object.ASL_Mapping.NstFOR
...
package Root_Object.ASL_Mapping.NstFOR is
--
------------------------------------------------------------------------
   --
   --**************  Object Nested_FOR Information **************
   --
   -- Object NstFOR is PASSIVE
   --
   --
   --
   -- Object NstFOR has an identifying non-referential attribute ReferenceNstFOR 
   -- and therefore may be uniquely created.
   -- 
   -- Object NstFOR has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "NstFOR";

   --
   -------------------------------------------------------------------------------------------------
   --

   type ASL_Mapping_NstFOR_Type is new ASL_Mapping_Type with record

      --
      -- Non initialised identifying non referential
      ReferenceNstFOR : Application_Types.Base_Integer_Type;
   ...
   procedure Put_ReferenceNstFOR (
      ...
      ReferenceNstFOR_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_ReferenceNstFOR);
   pragma inline (Put_ReferenceNstFOR);
