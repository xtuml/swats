...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objNESTED.ads
...
--* Description:             
--*                          Domain specification Root_Object.ASL_MappingobjNESTED
...
--  ----------------------------------  
--  package Root_Object.ASL_Mapping.objNESTED
...
package Root_Object.ASL_Mapping.objNESTED is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_NESTED Information **************
   --
   -- Object objNESTED is PASSIVE
   --
   --
   --
   -- Object objNESTED has an identifying non-referential attribute ReferenceNESTED 
   -- and therefore may be uniquely created.
   -- 
   -- Object objNESTED has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objNESTED";

   --
   -------------------------------------------------------------------------------------------------
   --

   type ASL_Mapping_objNESTED_Type is new ASL_Mapping_Type with record

      --
      -- Non initialised identifying non referential
      ReferenceNESTED : Application_Types.Base_Integer_Type;
   ...
   procedure Put_ReferenceNESTED (
      ...
      ReferenceNESTED_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_ReferenceNESTED);
   pragma inline (Put_ReferenceNESTED);
