...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.NstLOOP.ads
...
--* Description:             
--*                          Domain specification Root_Object.ASL_MappingNstLOOP
...
--  ----------------------------------  
--  package Root_Object.ASL_Mapping.NstLOOP
...
package Root_Object.ASL_Mapping.NstLOOP is
--
------------------------------------------------------------------------
   --
   --**************  Object Nested_LOOP Information **************
   --
   -- Object NstLOOP is PASSIVE
   --
   --
   --
   -- Object NstLOOP has an identifying non-referential attribute ReferenceNstLOOP 
   -- and therefore may be uniquely created.
   -- 
   -- Object NstLOOP has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "NstLOOP";

   --
   -------------------------------------------------------------------------------------------------
   --

   type ASL_Mapping_NstLOOP_Type is new ASL_Mapping_Type with record

      --
      -- Non initialised identifying non referential
      ReferenceNstLOOP : Application_Types.Base_Integer_Type;
   ...
   procedure Put_ReferenceNstLOOP (
      ...
      ReferenceNstLOOP_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_ReferenceNstLOOP);
   pragma inline (Put_ReferenceNstLOOP);
