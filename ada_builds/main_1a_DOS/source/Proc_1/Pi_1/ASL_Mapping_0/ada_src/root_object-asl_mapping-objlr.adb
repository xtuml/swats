...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objLR.adb
...
--* Description:             
--*                          Domain body Root_Object.ASL_MappingobjLR
...
------------------------------------------------------------------------
--
package body Root_Object.ASL_Mapping.objLR is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return ASL_Mapping_objLR_Type (This_Object.all).idL;
   end Get_idL;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ASL_Mapping_objLR_Type (This_Object.all).idL :=
         idL_Value;
   end Put_idL;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_idR (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return ASL_Mapping_objLR_Type (This_Object.all).idR;
   end Get_idR;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ASL_Mapping_objLR_Type (This_Object.all).idR :=
         idR_Value;
   end Put_idR;
--ADATEST IGNORE_OFF
...
------------------------------------------------------------------------
   --
   -- procedure Put_idAR and 
   --
   -- function Get_idAR
   --
   -- have not been generated for idAR
...
--ADATEST IGNORE_ON
   ...
   begin
      return ASL_Mapping_objLR_Type (This_Object.all).R2_B;
   end Get_R2_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ASL_Mapping_objLR_Type (This_Object.all).R2_B :=
         R2_B_Value;
   end Put_R2_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new ASL_Mapping_objLR_Type;
   
      else
         This_Object := Free_List.First_Entry;
         ASL_Mapping_objLR_Type(This_Object.all).idL := Application_Types.Base_Integer_Type_First;
         ASL_Mapping_objLR_Type(This_Object.all).idR := Application_Types.Base_Integer_Type_First;
