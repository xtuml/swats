...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objLOGIC.adb
...
--* Description:             
--*                          Domain body Root_Object.ASL_MappingobjLOGIC
...
------------------------------------------------------------------------
--
package body Root_Object.ASL_Mapping.objLOGIC is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   function Get_IntegerAttr (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return ASL_Mapping_objLOGIC_Type (This_Object.all).IntegerAttr;
   end Get_IntegerAttr;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_IntegerAttr (
      This_Object : in Root_Object.Object_Access;
      IntegerAttr_Value : in Application_Types.Base_Integer_Type) is
   begin
      ASL_Mapping_objLOGIC_Type (This_Object.all).IntegerAttr :=
         IntegerAttr_Value;
   end Put_IntegerAttr;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_TextAttr (
      This_Object : in Root_Object.Object_Access;
      TextAttr_Value : in Application_Types.Base_Text_Type) is
   begin
      ASL_Mapping_objLOGIC_Type (This_Object.all).TextAttr :=
         TextAttr_Value;
   end Put_TextAttr;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_EnumerationAttr (
      This_Object: Root_Object.Object_Access) return ASL_Mapping_Domain_Types.Enum is
   begin
      return ASL_Mapping_objLOGIC_Type (This_Object.all).EnumerationAttr;
   end Get_EnumerationAttr;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_EnumerationAttr (
      This_Object : in Root_Object.Object_Access;
      EnumerationAttr_Value : in ASL_Mapping_Domain_Types.Enum) is
   begin
      ASL_Mapping_objLOGIC_Type (This_Object.all).EnumerationAttr :=
         EnumerationAttr_Value;
   end Put_EnumerationAttr;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   function Get_BooleanAttr (
      This_Object: Root_Object.Object_Access) return  Boolean is
   begin
      return ASL_Mapping_objLOGIC_Type (This_Object.all).BooleanAttr;
   end Get_BooleanAttr;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_BooleanAttr (
      This_Object : in Root_Object.Object_Access;
      BooleanAttr_Value : in  Boolean) is
   begin
      ASL_Mapping_objLOGIC_Type (This_Object.all).BooleanAttr :=
         BooleanAttr_Value;
   end Put_BooleanAttr;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return ASL_Mapping_objLOGIC_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ASL_Mapping_objLOGIC_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
------------------------------------------------------------------------
   ...
   ReferenceLOGIC_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceLOGIC return Application_Types.Base_Integer_Type is
   begin
      ReferenceLOGIC_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceLOGIC_Value);
      return ReferenceLOGIC_Value;
   end Obtain_Subsequent_ReferenceLOGIC;
...
--ADATEST IGNORE_ON
   function Get_ReferenceLOGIC (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return ASL_Mapping_objLOGIC_Type (This_Object.all).ReferenceLOGIC;
   end Get_ReferenceLOGIC;
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceLOGIC (
      This_Object : in Root_Object.Object_Access;
      ReferenceLOGIC_Value : in Application_Types.Base_Integer_Type) is
   begin
      ASL_Mapping_objLOGIC_Type (This_Object.all).ReferenceLOGIC :=
         ReferenceLOGIC_Value;
   end Put_ReferenceLOGIC;
...
--ADATEST IGNORE_ON
   procedure Put_RealAttr (
      This_Object : in Root_Object.Object_Access;
      RealAttr_Value : in Application_Types.Base_Float_Type) is
   begin
      ASL_Mapping_objLOGIC_Type (This_Object.all).RealAttr :=
         RealAttr_Value;
   end Put_RealAttr;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new ASL_Mapping_objLOGIC_Type;
   
      else
         This_Object := Free_List.First_Entry;
         ASL_Mapping_objLOGIC_Type(This_Object.all).IntegerAttr := Application_Types.Base_Integer_Type_First;
         ASL_Mapping_objLOGIC_Type(This_Object.all).TextAttr := Application_Types.Base_Text_Type_First;
         ASL_Mapping_objLOGIC_Type(This_Object.all).EnumerationAttr := ASL_Mapping_Domain_Types.Enum_First;
         ASL_Mapping_objLOGIC_Type(This_Object.all).BooleanAttr := Application_Types.Boolean_First;
         ASL_Mapping_objLOGIC_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
         ASL_Mapping_objLOGIC_Type(This_Object.all).ReferenceLOGIC := Application_Types.Base_Integer_Type_First;
         ASL_Mapping_objLOGIC_Type(This_Object.all).RealAttr := Application_Types.Base_Float_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      ASL_Mapping_objLOGIC_Type(This_Object.all).ReferenceLOGIC :=
         Obtain_Subsequent_ReferenceLOGIC;
...
end Root_Object.ASL_Mapping.objLOGIC;
