...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objSWITCH.adb
...
--* Description:             
--*                          Domain body Root_Object.ASL_MappingobjSWITCH
...
------------------------------------------------------------------------
--
package body Root_Object.ASL_Mapping.objSWITCH is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   ReferenceSWITCH_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceSWITCH return Application_Types.Base_Integer_Type is
   begin
      ReferenceSWITCH_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceSWITCH_Value);
      return ReferenceSWITCH_Value;
   end Obtain_Subsequent_ReferenceSWITCH;
...
--ADATEST IGNORE_ON
   function Get_ReferenceSWITCH (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return ASL_Mapping_objSWITCH_Type (This_Object.all).ReferenceSWITCH;
   end Get_ReferenceSWITCH;
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceSWITCH (
      This_Object : in Root_Object.Object_Access;
      ReferenceSWITCH_Value : in Application_Types.Base_Integer_Type) is
   begin
      ASL_Mapping_objSWITCH_Type (This_Object.all).ReferenceSWITCH :=
         ReferenceSWITCH_Value;
   end Put_ReferenceSWITCH;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return ASL_Mapping_objSWITCH_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ASL_Mapping_objSWITCH_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_IntegerAttr (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return ASL_Mapping_objSWITCH_Type (This_Object.all).IntegerAttr;
   end Get_IntegerAttr;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ASL_Mapping_objSWITCH_Type (This_Object.all).IntegerAttr :=
         IntegerAttr_Value;
   end Put_IntegerAttr;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new ASL_Mapping_objSWITCH_Type;
   
      else
         This_Object := Free_List.First_Entry;
         ASL_Mapping_objSWITCH_Type(This_Object.all).ReferenceSWITCH := Application_Types.Base_Integer_Type_First;
         ASL_Mapping_objSWITCH_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
         ASL_Mapping_objSWITCH_Type(This_Object.all).IntegerAttr := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      ASL_Mapping_objSWITCH_Type(This_Object.all).ReferenceSWITCH :=
         Obtain_Subsequent_ReferenceSWITCH;
...
end Root_Object.ASL_Mapping.objSWITCH;
