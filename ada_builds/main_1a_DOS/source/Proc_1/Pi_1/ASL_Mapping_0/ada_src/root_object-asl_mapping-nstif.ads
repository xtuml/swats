...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.NstIF.ads
...
--* Description:             
--*                          Domain specification Root_Object.ASL_MappingNstIF
...
--  ----------------------------------  
--  package Root_Object.ASL_Mapping.NstIF
...
package Root_Object.ASL_Mapping.NstIF is
--
------------------------------------------------------------------------
   --
   --**************  Object Nested_IF Information **************
   --
   -- Object NstIF is PASSIVE
   --
   --
   --
   -- Object NstIF has an identifying non-referential attribute ReferenceNstIF 
   -- and therefore may be uniquely created.
   -- 
   -- Object NstIF has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "NstIF";

   --
   -------------------------------------------------------------------------------------------------
   --

   type ASL_Mapping_NstIF_Type is new ASL_Mapping_Type with record

      --
      -- Non initialised identifying non referential
      ReferenceNstIF : Application_Types.Base_Integer_Type;
   ...
   procedure Put_ReferenceNstIF (
      ...
      ReferenceNstIF_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_ReferenceNstIF);
   pragma inline (Put_ReferenceNstIF);
