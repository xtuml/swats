...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objNESTED.adb
...
--* Description:             
--*                          Domain body Root_Object.ASL_MappingobjNESTED
...
------------------------------------------------------------------------
--
package body Root_Object.ASL_Mapping.objNESTED is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   ReferenceNESTED_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceNESTED return Application_Types.Base_Integer_Type is
   begin
      ReferenceNESTED_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceNESTED_Value);
      return ReferenceNESTED_Value;
   end Obtain_Subsequent_ReferenceNESTED;
...
--ADATEST IGNORE_ON
   function Get_ReferenceNESTED (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return ASL_Mapping_objNESTED_Type (This_Object.all).ReferenceNESTED;
   end Get_ReferenceNESTED;
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceNESTED (
      This_Object : in Root_Object.Object_Access;
      ReferenceNESTED_Value : in Application_Types.Base_Integer_Type) is
   begin
      ASL_Mapping_objNESTED_Type (This_Object.all).ReferenceNESTED :=
         ReferenceNESTED_Value;
   end Put_ReferenceNESTED;
...
--ADATEST IGNORE_ON
   function Get_ResultA (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return ASL_Mapping_objNESTED_Type (This_Object.all).ResultA;
   end Get_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ASL_Mapping_objNESTED_Type (This_Object.all).ResultA :=
         ResultA_Value;
   end Put_ResultA;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_ResultB (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return ASL_Mapping_objNESTED_Type (This_Object.all).ResultB;
   end Get_ResultB;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ASL_Mapping_objNESTED_Type (This_Object.all).ResultB :=
         ResultB_Value;
   end Put_ResultB;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new ASL_Mapping_objNESTED_Type;
   
      else
         This_Object := Free_List.First_Entry;
         ASL_Mapping_objNESTED_Type(This_Object.all).ReferenceNESTED := Application_Types.Base_Integer_Type_First;
         ASL_Mapping_objNESTED_Type(This_Object.all).ResultA := Application_Types.Base_Integer_Type_First;
         ASL_Mapping_objNESTED_Type(This_Object.all).ResultB := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      ASL_Mapping_objNESTED_Type(This_Object.all).ReferenceNESTED :=
         Obtain_Subsequent_ReferenceNESTED;
...
end Root_Object.ASL_Mapping.objNESTED;
