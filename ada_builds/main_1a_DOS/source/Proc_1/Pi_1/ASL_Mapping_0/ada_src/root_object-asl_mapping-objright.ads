...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objRight.ads
...
--* Description:             
--*                          Domain specification Root_Object.ASL_MappingobjRight
...
--  ----------------------------------  
--  package Root_Object.ASL_Mapping.objRight
...
package Root_Object.ASL_Mapping.objRight is
--
------------------------------------------------------------------------
   --
   --**************  Object Right Information **************
   --
   -- Object objRight is PASSIVE
   --
   --
   --
   -- Object objRight has an identifying non-referential attribute idR 
   -- and therefore may be uniquely created.
   -- 
   -- Object objRight has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objRight";

   --
   -------------------------------------------------------------------------------------------------
   --

   type ASL_Mapping_objRight_Type is new ASL_Mapping_Type with record
