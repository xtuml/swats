...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.ASL_Mapping.objFOR.ads
...
--* Description:             
--*                          Domain specification Root_Object.ASL_MappingobjFOR
...
--  ----------------------------------  
--  package Root_Object.ASL_Mapping.objFOR
...
package Root_Object.ASL_Mapping.objFOR is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_FOR Information **************
   --
   -- Object objFOR is PASSIVE
   --
   --
   --
   -- Object objFOR has an identifying non-referential attribute ReferenceFOR 
   -- and therefore may be uniquely created.
   -- 
   -- Object objFOR has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "objFOR";

   --
   -------------------------------------------------------------------------------------------------
   --

   type ASL_Mapping_objFOR_Type is new ASL_Mapping_Type with record

      --
      -- Non initialised identifying non referential
      ReferenceFOR : Application_Types.Base_Integer_Type;
   ...
   procedure Put_ReferenceFOR (
      ...
      ReferenceFOR_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_ReferenceFOR);
   pragma inline (Put_ReferenceFOR);
