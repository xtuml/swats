...
--*************************************************************************************
--*                                                                                   *
--* File Name:               ASL_Mapping_objBIG1_Receive_Unfeasonableness_Service.ads
...
package ASL_Mapping_objBIG1_Receive_Unfeasonableness_Service is
   ...
   procedure ASL_Mapping_objBIG1_Receive_Unfeasonableness (
      ...
      Expected_Attribute : in     Application_Types.Base_Integer_Type);
   
end ASL_Mapping_objBIG1_Receive_Unfeasonableness_Service;

--
-- End of file ASL_Mapping_objBIG1_Receive_Unfeasonableness_Service.ads
--
