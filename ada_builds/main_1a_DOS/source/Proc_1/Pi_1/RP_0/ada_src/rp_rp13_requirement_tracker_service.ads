...
--*************************************************************************************
--*                                                                                   *
--* File Name:               RP13_Requirement_Tracker_Service.ads
...
package RP_RP13_Requirement_Tracker_Service is
   ...
   procedure RP_RP13_Requirement_Tracker (
      ...
      Updated_Result      : in     RP_Domain_Types.Result_Type);
   
end RP_RP13_Requirement_Tracker_Service;

--
-- End of file RP_RP13_Requirement_Tracker_Service.ads
--
