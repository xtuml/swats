...
------------------------------------------------------------------------
--
package body Root_Object.RP.TS is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Unique_TS_Identifier_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Unique_TS_Identifier return Application_Types.Base_Integer_Type is
   begin
      Unique_TS_Identifier_Value :=
         Application_Types.Base_Integer_Type'succ (Unique_TS_Identifier_Value);
      return Unique_TS_Identifier_Value;
   end Obtain_Subsequent_Unique_TS_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
       return RP_TS_Type (This_Object.all).Unique_TS_Identifier;
   end Get_Unique_TS_Identifier;
...
--ADATEST IGNORE_ON
   procedure Put_Unique_TS_Identifier (
      This_Object : in Root_Object.Object_Access;
      Unique_TS_Identifier_Value : in Application_Types.Base_Integer_Type) is
   begin
      RP_TS_Type (This_Object.all).Unique_TS_Identifier :=
         Unique_TS_Identifier_Value;
   end Put_Unique_TS_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_TS_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      RP_TS_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_TS_Type (This_Object.all).R10_B;
   end Get_R10_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R10_B (
      This_Object : in Root_Object.Object_Access;
      R10_B_Value : in Root_Object.Object_List.List_Header_Access_Type) is
   begin
      RP_TS_Type (This_Object.all).R10_B :=
         R10_B_Value;
   end Put_R10_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_R11_A  (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_List.List_Header_Access_Type is
   begin
      return RP_TS_Type (This_Object.all).R11_A;
   end Get_R11_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R11_A (
      This_Object : in Root_Object.Object_Access;
      R11_A_Value : in Root_Object.Object_List.List_Header_Access_Type) is
   begin
      RP_TS_Type (This_Object.all).R11_A :=
         R11_A_Value;
   end Put_R11_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new RP_TS_Type;
   
         RP_TS_Type(This_Object.all).R10_B := Root_Object.Object_List.Initialise;
         RP_TS_Type(This_Object.all).R11_A := Root_Object.Object_List.Initialise;
      else
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      RP_TS_Type(This_Object.all).Unique_TS_Identifier :=
         Obtain_Subsequent_Unique_TS_Identifier;
...
--
   procedure TS1_To_Trace_Requirements (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      RP_TS_Type (This_Instance.all).Current_State := 
         Root_Object.RP.TS.Object_State_Type(Trace_Requirements);

      RP_TS_2 (
         This_Instance => This_Instance );

   end TS1_To_Trace_Requirements;
--
   procedure TS2_To_Complete_Analysis (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      RP_TS_Type (This_Instance.all).Current_State := 
         Root_Object.RP.TS.Object_State_Type(Complete_Analysis);

      RP_TS_3 (
         This_Instance => This_Instance );

   end TS2_To_Complete_Analysis;
--
   procedure TS3_To_Waiting (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      RP_TS_Type (This_Instance.all).Current_State := 
         Root_Object.RP.TS.Object_State_Type(Waiting);
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     RP_TS_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     RP_TS_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      RP_TS_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => RP_TS_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return RP_TS_Event_Queue.Queue_Length (RP_TS_Queue);
...
--
   ...
   This_Event_Dispatch_Matrix (TS1, Waiting) := TS1_To_Trace_Requirements'access;
   This_Event_Dispatch_Matrix (TS2, Waiting) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TS3, Waiting) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TS1, Trace_Requirements) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TS2, Trace_Requirements) := TS2_To_Complete_Analysis'access;
   This_Event_Dispatch_Matrix (TS3, Trace_Requirements) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TS1, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (TS2, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (TS3, Idle) := TS3_To_Waiting'access;

end Root_Object.RP.TS;
