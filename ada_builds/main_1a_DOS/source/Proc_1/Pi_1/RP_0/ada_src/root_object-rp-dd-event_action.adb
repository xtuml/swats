...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.RP.DD.event_action.ada
...
begin
   ...
   This_Action := RP_DD_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := RP_DD_Instance_Event_Type(This_Event.all).Target_Instance;


   -- Ensure that the source instance still exists. 
   if This /= null then
      This_Event_Dispatch_Matrix (This_Action, RP_DD_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
