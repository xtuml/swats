...
--* Description:             
--*                          Domain specification Root_Object.RPREQS
...
package Root_Object.RP.REQS is
--
------------------------------------------------------------------------
   --
   --**************  Object All_Requirements_In_Test_Suite Information **************
   --
   -- Object REQS is PASSIVE
   --
   --
   --
   -- Object REQS has an identifying non-referential attribute Unique_REQS_ID 
   -- and therefore may be uniquely created.
   -- 
   -- Object REQS has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "REQS";

   --
   -------------------------------------------------------------------------------------------------
   --

   type RP_REQS_Type is new RP_Type with record
      ...
      --
      -- Initialised Non identifying non referential
      Requid_Test_Status : RP_Domain_Types.Requid_Status_Type := RP_Domain_Types.Requid_Status_Type_First;

      --
      -- Initialised Non identifying non referential
      Requid_Text : Application_Types.Base_Text_Type := Application_Types.Base_Text_Type_First;

      --
      R11_B : Root_Object.Object_Access := null;
      R12_B : Root_Object.Object_List.List_Header_Access_Type;
   ...
   procedure Put_Unique_REQS_ID (
      ...
      Unique_REQS_ID_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Unique_REQS_ID);
   pragma inline (Put_Unique_REQS_ID);
   ...
   procedure Put_REQUID (
      This_Object : in Root_Object.Object_Access;
      REQUID_Value : in Application_Types.Base_Text_Type);

   pragma inline (Get_REQUID);
   pragma inline (Put_REQUID);


   function Get_Requid_Test_Status (
      This_Object : Root_Object.Object_Access) 
   return RP_Domain_Types.Requid_Status_Type;

   procedure Put_Requid_Test_Status (
      This_Object : in Root_Object.Object_Access;
      Requid_Test_Status_Value : in RP_Domain_Types.Requid_Status_Type);

   pragma inline (Get_Requid_Test_Status);
   pragma inline (Put_Requid_Test_Status);
   ...
   procedure Put_Requid_Text (
      This_Object : in Root_Object.Object_Access;
      Requid_Text_Value : in Application_Types.Base_Text_Type);

   pragma inline (Get_Requid_Text);
   pragma inline (Put_Requid_Text);
   ...
   procedure Put_R11_B (
      This_Object :   in  Root_Object.Object_Access;
      R11_B_Value : in Root_Object.Object_Access);

   pragma inline (Get_R11_B);
   pragma inline (Put_R11_B);
   ...
   procedure Put_R12_B  (
      This_Object :    in  Root_Object.Object_Access;
      R12_B_Value : in Root_Object.Object_List.List_Header_Access_Type);

   pragma inline (Get_R12_B);
   pragma inline (Put_R12_B);
