...
--* Description:             
--*                          Domain body Root_Object.RPPASS
...
------------------------------------------------------------------------
--
package body Root_Object.RP.PASS is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   function Get_Passed_Counter (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return RP_PASS_Type (This_Object.all).Passed_Counter;
   end Get_Passed_Counter;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Passed_Counter (
      This_Object : in Root_Object.Object_Access;
      Passed_Counter_Value : in Application_Types.Base_Integer_Type) is
   begin
      RP_PASS_Type (This_Object.all).Passed_Counter :=
         Passed_Counter_Value;
   end Put_Passed_Counter;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_PASS_Type (This_Object.all).R1_A;
   end Get_R1_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      RP_PASS_Type (This_Object.all).R1_A :=
         R1_A_Value;
   end Put_R1_A;
--ADATEST IGNORE_OFF
