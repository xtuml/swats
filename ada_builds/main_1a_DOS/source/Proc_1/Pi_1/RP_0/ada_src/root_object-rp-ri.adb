...
------------------------------------------------------------------------
--
package body Root_Object.RP.RI is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_RI_Type (This_Object.all).requid;
   end Get_requid;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      RP_RI_Type (This_Object.all).requid :=
         requid_Value;
   end Put_requid;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_RI_Type (This_Object.all).R7_A;
   end Get_R7_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      RP_RI_Type (This_Object.all).R7_A :=
         R7_A_Value;
   end Put_R7_A;
--ADATEST IGNORE_OFF
