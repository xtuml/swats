...
--* Description:             
--*                          Domain specification Root_Object.RPRI
...
package Root_Object.RP.RI is
--
------------------------------------------------------------------------
   --
   --**************  Object Requirement_Identifier_For_Test Information **************
   --
   -- Object RI is PASSIVE
   --
   --
   --
