...
--* Description:             
--*                          Domain specification Root_Object.RPSC
...
package Root_Object.RP.SC is
--
------------------------------------------------------------------------
   --
   --**************  Object Supporting_Comments Information **************
   --
   -- Object SC is PASSIVE
   --
   --
   --
   -- Object SC has an identifying non-referential attribute sc_id 
   ...
   type RP_SC_Type is new RP_Type with record

      --
      -- Non initialised identifying non referential
      sc_id : Application_Types.Base_Integer_Type;
      ...
      The_Comment : Application_Types.Base_Text_Type := Application_Types.Base_Text_Type_First;
      ...
      --
      -- Initialised Non identifying non referential
      Comment_ID : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      R9_A : Root_Object.Object_Access := null;
   ...
   procedure Put_sc_id (
      ...
      sc_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_sc_id);
   pragma inline (Put_sc_id);


   function Get_The_Comment (
      This_Object : Root_Object.Object_Access) 
   return Application_Types.Base_Text_Type;

   procedure Put_The_Comment (
      This_Object : in Root_Object.Object_Access;
      The_Comment_Value : in Application_Types.Base_Text_Type);

   pragma inline (Get_The_Comment);
   pragma inline (Put_The_Comment);
   ...
   procedure Put_Comment_ID (
      This_Object : in Root_Object.Object_Access;
      Comment_ID_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Comment_ID);
   pragma inline (Put_Comment_ID);
   ...
   procedure Put_R9_A (
      This_Object :   in  Root_Object.Object_Access;
      R9_A_Value : in Root_Object.Object_Access);

   pragma inline (Get_R9_A);
   pragma inline (Put_R9_A);
