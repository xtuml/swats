...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSMGR
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.MGR is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
   ...
   The_Object_Array    : array (1 .. Maximum_Number_Of_Instances) of aliased TAGS_MGR_Type;
...
------------------------------------------------------------------------
   ...
   mgr_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_mgr_id return Application_Types.Base_Integer_Type is
   begin
      mgr_id_Value :=
         Application_Types.Base_Integer_Type'succ (mgr_id_Value);
      return mgr_id_Value;
   end Obtain_Subsequent_mgr_id;
...
--ADATEST IGNORE_ON
   ...
   begin
       return TAGS_MGR_Type (This_Object.all).mgr_id;
   end Get_mgr_id;
...
--ADATEST IGNORE_ON
   procedure Put_mgr_id (
      This_Object : in Root_Object.Object_Access;
      mgr_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      TAGS_MGR_Type (This_Object.all).mgr_id :=
         mgr_id_Value;
   end Put_mgr_id;
...
--ADATEST IGNORE_ON
   function Get_An_Integer (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_MGR_Type (This_Object.all).An_Integer;
   end Get_An_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_MGR_Type (This_Object.all).An_Integer :=
         An_Integer_Value;
   end Put_An_Integer;
--ADATEST IGNORE_OFF
...
---------------------------------------------------------------------
   ...
   begin
      ...
      TAGS_MGR_Type(Old_Instance.all).Created := FALSE;
