...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSATSUBONE
...
--*  OVERVIEW                                                                         *
--*  --------                                                                         *
--*  Object has been tagged MULTIPLICITY ARRAY with 2 elements
--*
--*  ERROR HANDLING                                                                   *
--*  --------------                                                                   *
--*  None                                                                             *
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.ATSUBONE is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
   ...
   Maximum_Number_Of_Instances : constant Application_Types.Base_Integer_Type := 2;
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_ATSUBONE_Type (This_Object.all).Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ATSUBONE_Type (This_Object.all).Unique_Identifier :=
...
--ADATEST IGNORE_ON
   function Get_Subtype_One_Data (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_ATSUBONE_Type (This_Object.all).Subtype_One_Data;
   end Get_Subtype_One_Data;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Subtype_One_Data (
      This_Object : in Root_Object.Object_Access;
      Subtype_One_Data_Value : in Application_Types.Base_Integer_Type) is
   begin
      TAGS_ATSUBONE_Type (This_Object.all).Subtype_One_Data :=
         Subtype_One_Data_Value;
   end Put_Subtype_One_Data;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Test_No (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_ATSUBONE_Type (This_Object.all).Test_No;
   end Get_Test_No;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ATSUBONE_Type (This_Object.all).Test_No :=
         Test_No_Value;
   end Put_Test_No;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_ATSUBONE_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ATSUBONE_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_ATSUBONE_Type (This_Object.all).R6_Super;
   end Get_R6_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ATSUBONE_Type (This_Object.all).R6_Super :=
         R6_Super_Value;
   end Put_R6_Super;
--ADATEST IGNORE_OFF
   ...
   begin
      ...
      if Object_List.Size < Maximum_Number_Of_Instances then
         ...
         if Free_List.First_Entry = null then
            This_Object := new TAGS_ATSUBONE_Type;
   
         else
            This_Object := Free_List.First_Entry;
            TAGS_ATSUBONE_Type(This_Object.all).Unique_Identifier := Application_Types.Base_Integer_Type_First;
            TAGS_ATSUBONE_Type(This_Object.all).Subtype_One_Data := Application_Types.Base_Integer_Type_First;
            TAGS_ATSUBONE_Type(This_Object.all).Test_No := Application_Types.Base_Integer_Type_First;
            TAGS_ATSUBONE_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
----------------------------------------------------------------------------
   ...
   procedure Polymorphic_Put (
      This_Object : in out TAGS_ATSUBONE_Type;
   ...
   begin
      ...
      case Parent_Event_Type is
         ...
         when Root_Object.TAGS.ATSUPER.ATSUPER1 =>
            ...
            Next_Event := new Root_Object.TAGS.ATSUBONE.TAGS_ATSUPER1'(
            Root_Event_Type with
               This_Event_Class => Root_Object.TAGS.ATSUBONE.ATSUPER1,
...
--
   ...
   procedure TAGS_ATSUBONE_2 (
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure ATSUPER1_To_Sub_One_State (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      TAGS_ATSUBONE_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.ATSUBONE.Object_State_Type(Sub_One_State);

      TAGS_ATSUBONE_2 (
         This_Instance => This_Instance );

   end ATSUPER1_To_Sub_One_State;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     TAGS_ATSUBONE_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     TAGS_ATSUBONE_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      TAGS_ATSUBONE_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => TAGS_ATSUBONE_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return TAGS_ATSUBONE_Event_Queue.Queue_Length (TAGS_ATSUBONE_Queue);
...
--ADATEST IGNORE_ON
   procedure Put_Event (
      ...
      To_Class : in TAGS_ATSUBONE_Type;
...
--
   ...
   This_Event_Dispatch_Matrix (ATSUPER1, Idle) := ATSUPER1_To_Sub_One_State'access;
   This_Event_Dispatch_Matrix (ATSUPER1, Sub_One_State) :=  Ignore_Action'access;

end Root_Object.TAGS.ATSUBONE;
