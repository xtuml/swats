...
--* Description:             
--*                          TAGGED Domain specification Root_Object.TAGSASO
...
package Root_Object.TAGS.ASO is
--
------------------------------------------------------------------------
   --
   --**************  Object A_Static_Object Information **************
   --
   -- Object ASO is PASSIVE
   --
   --
   --
   -- Object ASO has an identifying non-referential attribute Unique_ID 
   -- and therefore may be uniquely created.
   --
   -- Object ASO is STATIC and therefore may not be deleted.
   --
   -- Object ASO has the following TAGS attached :
   --    STATIC 
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ...
   Object_String : String := "ASO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_ASO_Type is new TAGS_Type with record
