...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSATML
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.ATML is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return TAGS_ATML_Type (This_Object.all).Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ATML_Type (This_Object.all).Unique_Identifier :=
         Unique_Identifier_Value;
...
--ADATEST IGNORE_ON
   function Get_Attribute_One (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_ATML_Type (This_Object.all).Attribute_One;
   end Get_Attribute_One;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Attribute_One (
      This_Object : in Root_Object.Object_Access;
      Attribute_One_Value : in Application_Types.Base_Integer_Type) is
   begin
      TAGS_ATML_Type (This_Object.all).Attribute_One :=
         Attribute_One_Value;
   end Put_Attribute_One;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_ATML_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ATML_Type (This_Object.all).Current_State :=
         Current_State_Value;
   ...
   begin
      ...
      if Object_List.Size < Maximum_Number_Of_Instances then
         ...
         if Free_List.First_Entry = null then
            This_Object := new TAGS_ATML_Type;
   
         else
            This_Object := Free_List.First_Entry;
            TAGS_ATML_Type(This_Object.all).Unique_Identifier := Application_Types.Base_Integer_Type_First;
            TAGS_ATML_Type(This_Object.all).Attribute_One := Application_Types.Base_Integer_Type_First;
            TAGS_ATML_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure TAGS_ATML_2 (
      ATML_Test_No : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure ATML1_To_Active (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      TAGS_ATML_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.ATML.Object_State_Type(Active);

      TAGS_ATML_2 (
         ATML_Test_No =>  TAGS_ATML1(This_Event.all).ATML_Test_No,
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     TAGS_ATML_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     TAGS_ATML_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      TAGS_ATML_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => TAGS_ATML_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return TAGS_ATML_Event_Queue.Queue_Length (TAGS_ATML_Queue);
...
--
   This_Event_Dispatch_Matrix (ATML1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ATML1, Idle) := ATML1_To_Active'access;
   This_Event_Dispatch_Matrix (ATML1, Active) :=  Cannot_Happen_Action'access;

end Root_Object.TAGS.ATML;
