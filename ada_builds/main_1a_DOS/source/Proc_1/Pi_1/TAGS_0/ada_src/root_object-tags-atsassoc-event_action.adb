...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.TAGS.ATSASSOC.event_action.ada
...
--*  separate of Root_Object.TAGSATSASSOC
--*     Event_Action
--*
--*************************************************************************************
--  MODIFICATION RECORD
...
begin
   ...
   This_Action := TAGS_ATSASSOC_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := TAGS_ATSASSOC_Instance_Event_Type(This_Event.all).Target_Instance;


   -- Ensure that the source instance still exists. 
   if This /= null then
      This_Event_Dispatch_Matrix (This_Action, TAGS_ATSASSOC_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
