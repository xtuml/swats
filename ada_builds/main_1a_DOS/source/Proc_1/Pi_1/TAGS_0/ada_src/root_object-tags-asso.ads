...
--* Description:             
--*                          TAGGED Domain specification Root_Object.TAGSASSO
...
package Root_Object.TAGS.ASSO is
--
------------------------------------------------------------------------
   --
   --**************  Object A_Single_Static_Object Information **************
   --
   -- Object ASSO is PASSIVE
   --
   --
   --
   -- Object ASSO has an identifying non-referential attribute Unique_ID 
   -- and therefore may be uniquely created.
   --
   -- Object ASSO is STATIC and therefore may not be deleted.
   --
   -- Object ASSO has the following TAGS attached :
   --    STATIC 
   --    SINGLETON 
   --
   ------------------------------------------------------------------------
   ...
   Object_String : String := "ASSO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_ASSO_Type is new TAGS_Type with record
