...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSMTO
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.MTO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return TAGS_MTO_Type (This_Object.all).Other_Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_MTO_Type (This_Object.all).Other_Unique_Identifier :=
         Other_Unique_Identifier_Value;
...
--ADATEST IGNORE_ON
   function Get_Attribute_Two (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_MTO_Type (This_Object.all).Attribute_Two;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_MTO_Type (This_Object.all).Attribute_Two :=
         Attribute_Two_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_MTO_Type (This_Object.all).R1_A;
   end Get_R1_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R1_A (
      This_Object : in Root_Object.Object_Access;
      R1_A_Value : in Root_Object.Object_Access) is
   begin
      TAGS_MTO_Type (This_Object.all).R1_A :=
         R1_A_Value;
   end Put_R1_A;
--ADATEST IGNORE_OFF
   ...
   begin
      ...
      if Object_List.Size < Maximum_Number_Of_Instances then
         ...
         if Free_List.First_Entry = null then
            This_Object := new TAGS_MTO_Type;
   
         else
            This_Object := Free_List.First_Entry;
            TAGS_MTO_Type(This_Object.all).Other_Unique_Identifier := Application_Types.Base_Integer_Type_First;
            TAGS_MTO_Type(This_Object.all).Attribute_Two := Application_Types.Base_Integer_Type_First;
