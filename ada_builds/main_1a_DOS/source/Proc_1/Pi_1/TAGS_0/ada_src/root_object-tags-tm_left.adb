...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSTM_LEFT
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.TM_LEFT is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return TAGS_TM_LEFT_Type (This_Object.all).Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_TM_LEFT_Type (This_Object.all).Unique_Identifier :=
         Unique_Identifier_Value;
...
--ADATEST IGNORE_ON
   function Get_Attribute_One (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_TM_LEFT_Type (This_Object.all).Attribute_One;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_TM_LEFT_Type (This_Object.all).Attribute_One :=
         Attribute_One_Value;
   ...
   begin
      ...
      if Object_List.Size < Maximum_Number_Of_Instances then
         ...
         if Free_List.First_Entry = null then
            This_Object := new TAGS_TM_LEFT_Type;
   
         else
            This_Object := Free_List.First_Entry;
            TAGS_TM_LEFT_Type(This_Object.all).Unique_Identifier := Application_Types.Base_Integer_Type_First;
            TAGS_TM_LEFT_Type(This_Object.all).Attribute_One := Application_Types.Base_Integer_Type_First;
