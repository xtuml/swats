...
--* Description:             
--*                          Domain specification Root_Object.TAGSMTO
...
package Root_Object.TAGS.MTO is
--
------------------------------------------------------------------------
   --
   --**************  Object Many_Tagged_Objects Information **************
   --
   -- Object MTO is PASSIVE
   --
   --
   --
   -- Object MTO has an identifying non-referential attribute Other_Unique_Identifier 
   -- and therefore may be uniquely created.
   --
   -- Object MTO has the following TAGS attached :
   --    ARRAY (3)
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ...
   Object_String : String := "MTO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_MTO_Type is new TAGS_Type with record
