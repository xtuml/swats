...
--* Description:             
--*                          Domain specification Root_Object.TAGSTM_LEFT
...
--  ----------------------------------  
--  package Root_Object.TAGS.TM_LEFT
...
package Root_Object.TAGS.TM_LEFT is
--
------------------------------------------------------------------------
   --
   --**************  Object Tagged_Many_Left Information **************
   --
   -- Object TM_LEFT is PASSIVE
   --
   --
   --
   -- Object TM_LEFT has an identifying non-referential attribute Unique_Identifier 
   -- and therefore may be uniquely created.
   --
   -- Object TM_LEFT has the following TAGS attached :
   --    ARRAY (3)
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ...
   Object_String : String := "TM_LEFT";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_TM_LEFT_Type is new TAGS_Type with record
