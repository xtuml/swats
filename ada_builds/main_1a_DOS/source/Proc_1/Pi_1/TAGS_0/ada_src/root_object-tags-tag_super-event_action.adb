...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.TAGS.TAG_SUPER.event_action.ada
...
--*  separate of Root_Object.TAGSTAG_SUPER
--*     Event_Action
--*
--*************************************************************************************
--  MODIFICATION RECORD
...
separate (Root_Object.TAGS.TAG_SUPER)
...
begin
   ...
   This_Action := TAGS_TAG_SUPER_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := TAGS_TAG_SUPER_Instance_Event_Type(This_Event.all).Target_Instance;
   ...
   if This /= null then
      ...
      --  
      This_Event_Dispatch_Matrix (This_Action, TAGS_TAG_SUPER_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
