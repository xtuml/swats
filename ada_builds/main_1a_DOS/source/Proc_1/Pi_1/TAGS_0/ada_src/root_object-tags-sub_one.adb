...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSSUB_ONE
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.SUB_ONE is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_SUB_ONE_Type (This_Object.all).Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_SUB_ONE_Type (This_Object.all).Unique_Identifier :=
...
--ADATEST IGNORE_ON
   function Get_Subtype_1_Data (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_SUB_ONE_Type (This_Object.all).Subtype_1_Data;
   end Get_Subtype_1_Data;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Subtype_1_Data (
      This_Object : in Root_Object.Object_Access;
      Subtype_1_Data_Value : in Application_Types.Base_Integer_Type) is
   begin
      TAGS_SUB_ONE_Type (This_Object.all).Subtype_1_Data :=
         Subtype_1_Data_Value;
   end Put_Subtype_1_Data;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_SUB_ONE_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_SUB_ONE_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_SUB_ONE_Type (This_Object.all).R4_Super;
   end Get_R4_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_SUB_ONE_Type (This_Object.all).R4_Super :=
         R4_Super_Value;
   end Put_R4_Super;
--ADATEST IGNORE_OFF
   ...
   begin
      ...
      if Object_List.Size < Maximum_Number_Of_Instances then
         ...
         if Free_List.First_Entry = null then
            This_Object := new TAGS_SUB_ONE_Type;
   
         else
            This_Object := Free_List.First_Entry;
            TAGS_SUB_ONE_Type(This_Object.all).Unique_Identifier := Application_Types.Base_Integer_Type_First;
            TAGS_SUB_ONE_Type(This_Object.all).Subtype_1_Data := Application_Types.Base_Integer_Type_First;
            TAGS_SUB_ONE_Type(This_Object.all).Current_State :=  Object_State_Type_First;
