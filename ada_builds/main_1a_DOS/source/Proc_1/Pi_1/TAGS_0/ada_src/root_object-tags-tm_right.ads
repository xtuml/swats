...
--* Description:             
--*                          Domain specification Root_Object.TAGSTM_RIGHT
...
--  ----------------------------------  
--  package Root_Object.TAGS.TM_RIGHT
...
package Root_Object.TAGS.TM_RIGHT is
--
------------------------------------------------------------------------
   --
   --**************  Object Tagged_Many_Right Information **************
   --
   -- Object TM_RIGHT is PASSIVE
   --
   --
   --
   -- Object TM_RIGHT has an identifying non-referential attribute Other_Unique_Identifier 
   -- and therefore may be uniquely created.
   --
   -- Object TM_RIGHT has the following TAGS attached :
   --    ARRAY (3)
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ...
   Object_String : String := "TM_RIGHT";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_TM_RIGHT_Type is new TAGS_Type with record
