...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSAAAOTO
...
--*  OVERVIEW                                                                         *
--*  --------                                                                         *
--*  Object has been tagged MULTIPLICITY ARRAY with 3 elements
--*
--*  ERROR HANDLING                                                                   *
--*  --------------                                                                   *
--*  None                                                                             *
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.AAAOTO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
   ...
   Maximum_Number_Of_Instances : constant Application_Types.Base_Integer_Type := 3;
...
--ADATEST IGNORE_ON
   ...
   begin
       return TAGS_AAAOTO_Type (This_Object.all).Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_AAAOTO_Type (This_Object.all).Unique_Identifier :=
         Unique_Identifier_Value;
...
--ADATEST IGNORE_ON
   function Get_Result (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_AAAOTO_Type (This_Object.all).Result;
   end Get_Result;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_AAAOTO_Type (This_Object.all).Result :=
         Result_Value;
   end Put_Result;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_AAAOTO_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_AAAOTO_Type (This_Object.all).Current_State :=
         Current_State_Value;
   ...
   begin
      ...
      if Object_List.Size < Maximum_Number_Of_Instances then
         ...
         if Free_List.First_Entry = null then
            This_Object := new TAGS_AAAOTO_Type;
   
         else
            This_Object := Free_List.First_Entry;
            TAGS_AAAOTO_Type(This_Object.all).Unique_Identifier := Application_Types.Base_Integer_Type_First;
            TAGS_AAAOTO_Type(This_Object.all).Result := Application_Types.Base_Integer_Type_First;
            TAGS_AAAOTO_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure TAGS_AAAOTO_3 (
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure TAGS_AAAOTO_4 (
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure TAGS_AAAOTO_1 (
...
--
   procedure AAAOTO1_To_Do_Something (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      TAGS_AAAOTO_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.AAAOTO.Object_State_Type(Do_Something);

      TAGS_AAAOTO_2 (
         Test_Number =>  TAGS_AAAOTO1(This_Event.all).Test_Number,
         Add =>  TAGS_AAAOTO1(This_Event.all).Add,
         Purpose =>  TAGS_AAAOTO1(This_Event.all).Purpose,
         Expected_Result =>  TAGS_AAAOTO1(This_Event.all).Expected_Result,
         This_Instance => This_Instance );

   end AAAOTO1_To_Do_Something;
--
   procedure AAAOTO3_To_Delete_One_Self (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      TAGS_AAAOTO_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.AAAOTO.Object_State_Type(Delete_One_Self);

      TAGS_AAAOTO_3 (
         This_Instance => This_Instance );

   end AAAOTO3_To_Delete_One_Self;
--
   procedure AAAOTO4_To_More_Tests (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      TAGS_AAAOTO_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.AAAOTO.Object_State_Type(More_Tests);

      TAGS_AAAOTO_4 (
         This_Instance => This_Instance );

   end AAAOTO4_To_More_Tests;
--
   procedure AAAOTO2_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      TAGS_AAAOTO_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.AAAOTO.Object_State_Type(Idle);

      TAGS_AAAOTO_1 (
         Final_Value =>  TAGS_AAAOTO2(This_Event.all).Final_Value,
         Test_Number =>  TAGS_AAAOTO2(This_Event.all).Test_Number,
         Purpose =>  TAGS_AAAOTO2(This_Event.all).Purpose,
         Tell_Tales =>  TAGS_AAAOTO2(This_Event.all).Tell_Tales,
         This_Instance => This_Instance );
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     TAGS_AAAOTO_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     TAGS_AAAOTO_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      TAGS_AAAOTO_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => TAGS_AAAOTO_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return TAGS_AAAOTO_Event_Queue.Queue_Length (TAGS_AAAOTO_Queue);
...
--
   This_Event_Dispatch_Matrix (AAAOTO1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOTO2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOTO3, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOTO4, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOTO1, Idle) := AAAOTO1_To_Do_Something'access;
   This_Event_Dispatch_Matrix (AAAOTO2, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOTO3, Idle) := AAAOTO3_To_Delete_One_Self'access;
   This_Event_Dispatch_Matrix (AAAOTO4, Idle) := AAAOTO4_To_More_Tests'access;
   This_Event_Dispatch_Matrix (AAAOTO1, Do_Something) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOTO2, Do_Something) := AAAOTO2_To_Idle'access;
   This_Event_Dispatch_Matrix (AAAOTO3, Do_Something) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOTO4, Do_Something) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOTO1, Delete_One_Self) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOTO2, Delete_One_Self) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOTO3, Delete_One_Self) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOTO4, Delete_One_Self) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOTO1, More_Tests) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOTO2, More_Tests) := AAAOTO2_To_Idle'access;
   This_Event_Dispatch_Matrix (AAAOTO3, More_Tests) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOTO4, More_Tests) :=  Cannot_Happen_Action'access;

end Root_Object.TAGS.AAAOTO;
