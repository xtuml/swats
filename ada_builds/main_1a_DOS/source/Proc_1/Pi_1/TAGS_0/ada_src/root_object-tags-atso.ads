...
--* Description:             
--*                          Domain specification Root_Object.TAGSATSO
...
package Root_Object.TAGS.ATSO is
--
------------------------------------------------------------------------
   --
   --**************  Object Active_Tagged_Single_Object Information **************
   --
   -- Object ATSO is ACTIVE
   --
   --
   --
   -- Object ATSO is ACTIVE and has the following state actions defined
   --   Non_Existent,
   --   Idle,
   --   State_1.
   --
   -- Object ATSO has an identifying non-referential attribute Unique_Identifier 
   -- and therefore may be uniquely created.
   --
   -- Object ATSO has the following TAGS attached :
   --    SINGLETON 
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ...
   Object_String : String := "ATSO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_ATSO_Type is new TAGS_Type with record
      ...
      Attribute_One : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      Current_State :  Object_State_Type :=  Object_State_Type_First;

      R2_B : Root_Object.Object_List.List_Header_Access_Type  := Root_Object.Object_List.Initialise;
   ...
   procedure Put_Attribute_One (
      This_Object : in Root_Object.Object_Access;
      Attribute_One_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Attribute_One);
   pragma inline (Put_Attribute_One);
   ...
   procedure Put_R2_B  (
      This_Object :    in  Root_Object.Object_Access;
      R2_B_Value : in Root_Object.Object_List.List_Header_Access_Type);
   ...
   -- EVENT DECLARATION
   --
   type TAGS_ATSO_Event_Type is new TAGS_Event_Type with
   record
   ...
   procedure Event_Action (
      Dispatch_Event : in     TAGS_ATSO_Event_Type;
      This_Event     : in out Root_Object.Root_Event_Access_Type);


   --    
   type TAGS_ATSO_Instance_Event_Type is new TAGS_ATSO_Event_Type with
   record
   ...
   -- 
   procedure Event_Action (
      Dispatch_Event : in     TAGS_ATSO_Instance_Event_Type;
      This_Event     : in out Root_Object.Root_Event_Access_Type);


   ------------------------------------------------------------------------
   type TAGS_ATSO_Description_Event is new TAGS_ATSO_Instance_Event_Type with
   record
      null;
   end record;  
   --
   ...
   type TAGS_ATSO1 is new TAGS_ATSO_Instance_Event_Type with
   record 
      The_Test_No : Application_Types.Base_Integer_Type;
   end record;
   ...
   package TAGS_ATSO_Event_Queue is new Generic_FIFO (Root_Object.Root_Event_Access_Type); 

   TAGS_ATSO_Queue: TAGS_ATSO_Event_Queue.FIFO_Type;
