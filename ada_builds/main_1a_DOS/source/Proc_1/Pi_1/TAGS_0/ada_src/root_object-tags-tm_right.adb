...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSTM_RIGHT
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.TM_RIGHT is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return TAGS_TM_RIGHT_Type (This_Object.all).Other_Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_TM_RIGHT_Type (This_Object.all).Other_Unique_Identifier :=
         Other_Unique_Identifier_Value;
...
--ADATEST IGNORE_ON
   function Get_Attribute_Two (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_TM_RIGHT_Type (This_Object.all).Attribute_Two;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_TM_RIGHT_Type (This_Object.all).Attribute_Two :=
         Attribute_Two_Value;
   ...
   begin
      ...
      if Object_List.Size < Maximum_Number_Of_Instances then
         ...
         if Free_List.First_Entry = null then
            This_Object := new TAGS_TM_RIGHT_Type;
   
         else
            This_Object := Free_List.First_Entry;
            TAGS_TM_RIGHT_Type(This_Object.all).Other_Unique_Identifier := Application_Types.Base_Integer_Type_First;
            TAGS_TM_RIGHT_Type(This_Object.all).Attribute_Two := Application_Types.Base_Integer_Type_First;
