...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSASSO
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.ASSO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
   ...
   The_Object: aliased TAGS_ASSO_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
       return TAGS_ASSO_Type (This_Object.all).Unique_ID;
   end Get_Unique_ID;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ASSO_Type (This_Object.all).Unique_ID :=
         Unique_ID_Value;
   end Put_Unique_ID;
