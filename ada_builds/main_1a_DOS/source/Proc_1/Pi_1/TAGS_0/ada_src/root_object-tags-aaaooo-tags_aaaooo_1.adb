...
separate(Root_Object.TAGS.AAAOOO)
   ...
   procedure TAGS_AAAOOO_1 (Final_Value   : in     Application_Types.Base_Integer_Type;
   ...
   begin
      ...
      if Root_Object.TAGS.AAAOOO.TAGS_AAAOOO_type(This_Instance.all).Result =  Final_Value then
