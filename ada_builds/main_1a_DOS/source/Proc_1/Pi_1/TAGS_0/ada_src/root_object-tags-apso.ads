...
--* Description:             
--*                          Domain specification Root_Object.TAGSAPSO
...
package Root_Object.TAGS.APSO is
--
------------------------------------------------------------------------
   --
   --**************  Object A_Passive_Static_Object Information **************
   --
   -- Object APSO is PASSIVE
   --
   --
   --
   -- Object APSO has an identifying non-referential attribute Unique_Identifier 
   -- and therefore may be uniquely created.
   --
   -- Object APSO has the following TAGS attached :
   --    SINGLETON 
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ...
   Object_String : String := "APSO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_APSO_Type is new TAGS_Type with record
      ...
      Size : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_Size (
      This_Object : in Root_Object.Object_Access;
      Size_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Size);
   pragma inline (Put_Size);
