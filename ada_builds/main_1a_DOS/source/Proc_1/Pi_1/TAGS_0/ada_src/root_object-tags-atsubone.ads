...
--* Description:             
--*                          Domain specification Root_Object.TAGSATSUBONE
...
--  ----------------------------------  
--  package Root_Object.TAGS.ATSUBONE
...
package Root_Object.TAGS.ATSUBONE is
--
------------------------------------------------------------------------
   --
   --**************  Object Active_Tagged_Subtype_One Information **************
   --
   -- Object ATSUBONE is ACTIVE
   --
   -- Object ATSUBONE participates in a super sub type relationship
   --
   --
   --
   -- Object ATSUBONE is ACTIVE and has the following state actions defined
   --   Non_Existent,
   --   Idle,
   --   Sub_One_State.
   --
   -- Object ATSUBONE is a SUB type of ATSUPER via Relationship R6
   --
   -- Object ATSUBONE does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   --
   -- Object ATSUBONE has the following TAGS attached :
   --    ARRAY (2)
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ...
   Object_String : String := "ATSUBONE";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_ATSUBONE_Type is new TAGS_Type with record
      ...
      Subtype_One_Data : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_Subtype_One_Data (
      This_Object : in Root_Object.Object_Access;
      Subtype_One_Data_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Subtype_One_Data);
   pragma inline (Put_Subtype_One_Data);
   ...
   -- EVENT DECLARATION
   --
   type TAGS_ATSUBONE_Event_Type is new TAGS_Event_Type with
   record
   ...
   --    
   type TAGS_ATSUBONE_Instance_Event_Type is new TAGS_ATSUBONE_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type TAGS_ATSUBONE_Description_Event is new TAGS_ATSUBONE_Instance_Event_Type with
   record
      null;
   end record;  
   --
   ...
   type TAGS_ATSUPER1 is new TAGS_ATSUBONE_Instance_Event_Type with
   record 
      null;
   end record;
   ...
   package TAGS_ATSUBONE_Event_Queue is new Generic_FIFO (Root_Object.Root_Event_Access_Type); 

   TAGS_ATSUBONE_Queue: TAGS_ATSUBONE_Event_Queue.FIFO_Type;
