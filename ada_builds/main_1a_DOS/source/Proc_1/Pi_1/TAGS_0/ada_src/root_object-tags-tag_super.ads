...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.TAGS.TAG_SUPER.ads
...
--* Description:             
--*                          Domain specification Root_Object.TAGSTAG_SUPER
...
--  ----------------------------------  
--  package Root_Object.TAGS.TAG_SUPER
...
package Root_Object.TAGS.TAG_SUPER is
--
------------------------------------------------------------------------
   --
   --**************  Object Tagged_Many_Supertype Information **************
   --
   -- Object TAG_SUPER is PASSIVE
   --
   -- Object TAG_SUPER participates in a super sub type relationship
   --
   --
   --
   -- Object TAG_SUPER is a SUPER type of 
   --    SUB_ONE,
   --    SUB_TWO
   --    via Relationship R4
   --
   -- Object TAG_SUPER has an identifying non-referential attribute Unique_Identifier 
   -- and therefore may be uniquely created.
   --
   -- Object TAG_SUPER has the following TAGS attached :
   --    ARRAY (1)
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ...
   Object_String : String := "TAG_SUPER";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_TAG_SUPER_Type is new TAGS_Type with record
   ...
   --
   type TAGS_TAG_SUPER_Event_Type is new TAGS_Event_Type with
   record
   ...
   --    
   type TAGS_TAG_SUPER_Instance_Event_Type is new TAGS_TAG_SUPER_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type TAGS_TAG_SUPER_Description_Event is new TAGS_TAG_SUPER_Instance_Event_Type with
   record
      null;
   end record;
   --
