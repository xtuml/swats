...
--* Description:             
--*                          Domain specification Root_Object.TAGSAPAOTO
...
--  ----------------------------------  
--  package Root_Object.TAGS.APAOTO
...
package Root_Object.TAGS.APAOTO is
--
------------------------------------------------------------------------
   --
   --**************  Object A_Passive_Array_Of_Three_Objects Information **************
   --
   -- Object APAOTO is PASSIVE
   --
   --
   --
   -- Object APAOTO has an identifying non-referential attribute Unique_Identifier 
   -- and therefore may be uniquely created.
   --
   -- Object APAOTO has the following TAGS attached :
   --    ARRAY (3)
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ...
   Object_String : String := "APAOTO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_APAOTO_Type is new TAGS_Type with record
