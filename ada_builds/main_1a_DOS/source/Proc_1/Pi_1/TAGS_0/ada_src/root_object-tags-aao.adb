...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSAAO
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.AAO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
   ...
   The_Object: aliased TAGS_AAO_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
       return TAGS_AAO_Type (This_Object.all).Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_AAO_Type (This_Object.all).Unique_Identifier :=
         Unique_Identifier_Value;
...
--ADATEST IGNORE_ON
   function Get_Result (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_AAO_Type (This_Object.all).Result;
   end Get_Result;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_AAO_Type (This_Object.all).Result :=
         Result_Value;
   end Put_Result;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_AAO_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_AAO_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
---------------------------------------------------------------------
   ...
   begin
      ...
      TAGS_AAO_Type(Old_Instance.all).Created := FALSE;
...
--
   ...
   procedure TAGS_AAO_2 (
      Value_To_Add : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure TAGS_AAO_1 (
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure TAGS_AAO_3 (
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure TAGS_AAO_4 (
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure AAO1_To_Act (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      TAGS_AAO_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.AAO.Object_State_Type(Act);

      TAGS_AAO_2 (
         Value_To_Add =>  TAGS_AAO1(This_Event.all).Value_To_Add,
         This_Instance => This_Instance );

   end AAO1_To_Act;
--
   procedure AAO2_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      TAGS_AAO_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.AAO.Object_State_Type(Idle);
...
--
   ...
   begin
      ...
      TAGS_AAO_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.AAO.Object_State_Type(Exterminate);

      TAGS_AAO_3 (
         This_Instance => This_Instance );

   end AAO3_To_Exterminate;
--
   procedure AAO4_To_Expire (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      TAGS_AAO_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.AAO.Object_State_Type(Expire);
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     TAGS_AAO_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     TAGS_AAO_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      TAGS_AAO_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => TAGS_AAO_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return TAGS_AAO_Event_Queue.Queue_Length (TAGS_AAO_Queue);
...
--
   ...
   This_Event_Dispatch_Matrix (AAO1, Idle) := AAO1_To_Act'access;
   This_Event_Dispatch_Matrix (AAO2, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (AAO3, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (AAO4, Idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (AAO1, Act) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (AAO2, Act) := AAO2_To_Idle'access;
   This_Event_Dispatch_Matrix (AAO3, Act) := AAO3_To_Exterminate'access;
   This_Event_Dispatch_Matrix (AAO4, Act) := AAO4_To_Expire'access;
   This_Event_Dispatch_Matrix (AAO1, Exterminate) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (AAO2, Exterminate) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (AAO3, Exterminate) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (AAO4, Exterminate) := AAO4_To_Expire'access;

end Root_Object.TAGS.AAO;
