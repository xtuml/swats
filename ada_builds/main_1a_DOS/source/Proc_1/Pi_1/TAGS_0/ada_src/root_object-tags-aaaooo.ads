...
--* Description:             
--*                          Domain specification Root_Object.TAGSAAAOOO
...
--  ----------------------------------  
--  package Root_Object.TAGS.AAAOOO
...
package Root_Object.TAGS.AAAOOO is
--
------------------------------------------------------------------------
   --
   --**************  Object An_Active_Array_Of_One_Object Information **************
   --
   -- Object AAAOOO is ACTIVE
   --
   --
   --
   -- Object AAAOOO is ACTIVE and has the following state actions defined
   --   Non_Existent,
   --   Idle,
   --   Do_Something,
   --   Delete_Self,
   --   Do_Some_More_Tests.
   --
   -- Object AAAOOO has an identifying non-referential attribute Unique_Identifier 
   -- and therefore may be uniquely created.
   --
   -- Object AAAOOO has the following TAGS attached :
   --    ARRAY (1)
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ...
   Object_String : String := "AAAOOO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_AAAOOO_Type is new TAGS_Type with record
   ...
   -- EVENT DECLARATION
   --
   type TAGS_AAAOOO_Event_Type is new TAGS_Event_Type with
   record
   ...
   --    
   type TAGS_AAAOOO_Instance_Event_Type is new TAGS_AAAOOO_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type TAGS_AAAOOO_Description_Event is new TAGS_AAAOOO_Instance_Event_Type with
   record
      null;
   end record;  
   --
   ...
   type TAGS_AAAOOO1 is new TAGS_AAAOOO_Instance_Event_Type with
   record 
   ...
   type TAGS_AAAOOO2 is new TAGS_AAAOOO_Instance_Event_Type with
   record 
   ...
   type TAGS_AAAOOO3 is new TAGS_AAAOOO_Instance_Event_Type with
   record 
      null;
   end record;

   type TAGS_AAAOOO4 is new TAGS_AAAOOO_Instance_Event_Type with
   record 
      null;
   end record;
   ...
   package TAGS_AAAOOO_Event_Queue is new Generic_FIFO (Root_Object.Root_Event_Access_Type); 

   TAGS_AAAOOO_Queue: TAGS_AAAOOO_Event_Queue.FIFO_Type;
