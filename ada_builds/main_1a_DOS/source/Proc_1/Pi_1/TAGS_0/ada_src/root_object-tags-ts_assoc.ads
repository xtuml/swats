...
--* Description:             
--*                          Domain specification Root_Object.TAGSTS_ASSOC
...
--  ----------------------------------  
--  package Root_Object.TAGS.TS_ASSOC
...
package Root_Object.TAGS.TS_ASSOC is
--
------------------------------------------------------------------------
   --
   --**************  Object Tagged_Single_Assoc Information **************
   --
   -- Object TS_ASSOC is PASSIVE
   --
   --
   --
   -- Object TS_ASSOC does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   --
   -- Object TS_ASSOC has the following TAGS attached :
   --    ARRAY (9)
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ...
   Object_String : String := "TS_ASSOC";

   --
   -------------------------------------------------------------------------------------------------
   --

   type TAGS_TS_ASSOC_Type is new TAGS_Type with record

      --
      -- Initialised Non identifying non referential
      Assoc_Unique_Identifier : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
