...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSATMR
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.ATMR is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return TAGS_ATMR_Type (This_Object.all).Other_Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ATMR_Type (This_Object.all).Other_Unique_Identifier :=
         Other_Unique_Identifier_Value;
...
--ADATEST IGNORE_ON
   function Get_Attribute_Two (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_ATMR_Type (This_Object.all).Attribute_Two;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ATMR_Type (This_Object.all).Attribute_Two :=
         Attribute_Two_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_ATMR_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_ATMR_Type (This_Object.all).Current_State :=
         Current_State_Value;
   ...
   begin
      ...
      if Object_List.Size < Maximum_Number_Of_Instances then
         ...
         if Free_List.First_Entry = null then
            This_Object := new TAGS_ATMR_Type;
   
         else
            This_Object := Free_List.First_Entry;
            TAGS_ATMR_Type(This_Object.all).Other_Unique_Identifier := Application_Types.Base_Integer_Type_First;
            TAGS_ATMR_Type(This_Object.all).Attribute_Two := Application_Types.Base_Integer_Type_First;
            TAGS_ATMR_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure TAGS_ATMR_2 (
      ATMR_Test_No : in Application_Types.Base_Integer_Type;
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure ATMR1_To_Under_Power (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      TAGS_ATMR_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.ATMR.Object_State_Type(Under_Power);

      TAGS_ATMR_2 (
         ATMR_Test_No =>  TAGS_ATMR1(This_Event.all).ATMR_Test_No,
         This_Instance => This_Instance );

   end ATMR1_To_Under_Power;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     TAGS_ATMR_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     TAGS_ATMR_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      TAGS_ATMR_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => TAGS_ATMR_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return TAGS_ATMR_Event_Queue.Queue_Length (TAGS_ATMR_Queue);
...
--
   This_Event_Dispatch_Matrix (ATMR1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (ATMR1, Idle) := ATMR1_To_Under_Power'access;
   This_Event_Dispatch_Matrix (ATMR1, Under_Power) :=  Cannot_Happen_Action'access;

end Root_Object.TAGS.ATMR;
