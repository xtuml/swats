...
--* Description:             
--*                          TAGGED Domain body Root_Object.TAGSAAAOOO
...
--*  OVERVIEW                                                                         *
--*  --------                                                                         *
--*  Object has been tagged MULTIPLICITY ARRAY with 1 elements
--*
--*  ERROR HANDLING                                                                   *
--*  --------------                                                                   *
--*  None                                                                             *
...
------------------------------------------------------------------------
--
package body Root_Object.TAGS.AAAOOO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------

   -- Multiplicity Array of Objects
   Maximum_Number_Of_Instances : constant Application_Types.Base_Integer_Type := 1;
...
--ADATEST IGNORE_ON
   ...
   begin
       return TAGS_AAAOOO_Type (This_Object.all).Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_AAAOOO_Type (This_Object.all).Unique_Identifier :=
         Unique_Identifier_Value;
...
--ADATEST IGNORE_ON
   function Get_Result (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TAGS_AAAOOO_Type (This_Object.all).Result;
   end Get_Result;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_AAAOOO_Type (This_Object.all).Result :=
         Result_Value;
   end Put_Result;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return TAGS_AAAOOO_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      TAGS_AAAOOO_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Object_List.Size < Maximum_Number_Of_Instances then

         -- Initialised Multiplicity Array tagged object

         --
         if Free_List.First_Entry = null then
            This_Object := new TAGS_AAAOOO_Type;
   
         else
            This_Object := Free_List.First_Entry;
            TAGS_AAAOOO_Type(This_Object.all).Unique_Identifier := Application_Types.Base_Integer_Type_First;
            TAGS_AAAOOO_Type(This_Object.all).Result := Application_Types.Base_Integer_Type_First;
            TAGS_AAAOOO_Type(This_Object.all).Current_State :=  Object_State_Type_First;
         ...
         -- No way, Jose. Maximum number of instances already in existance
         This_Object := null;
      end if;
...
--
   ...
   procedure TAGS_AAAOOO_4 (
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure TAGS_AAAOOO_3 (
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure TAGS_AAAOOO_1 (
      Final_Value : in Application_Types.Base_Integer_Type;
      Test_Number : in Application_Types.Base_Integer_Type;
      Purpose : in Application_Types.Base_Text_Type;
...
--
   procedure AAAOOO1_To_Do_Something (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      TAGS_AAAOOO_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.AAAOOO.Object_State_Type(Do_Something);

      TAGS_AAAOOO_2 (
         Test_Number =>  TAGS_AAAOOO1(This_Event.all).Test_Number,
         Add =>  TAGS_AAAOOO1(This_Event.all).Add,
         Purpose =>  TAGS_AAAOOO1(This_Event.all).Purpose,
         Expected_Result =>  TAGS_AAAOOO1(This_Event.all).Expected_Result,
         This_Instance => This_Instance );

   end AAAOOO1_To_Do_Something;
--
   procedure AAAOOO3_To_Do_Some_More_Tests (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      TAGS_AAAOOO_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.AAAOOO.Object_State_Type(Do_Some_More_Tests);

      TAGS_AAAOOO_4 (
         This_Instance => This_Instance );

   end AAAOOO3_To_Do_Some_More_Tests;
--
   procedure AAAOOO4_To_Delete_Self (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      TAGS_AAAOOO_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.AAAOOO.Object_State_Type(Delete_Self);

      TAGS_AAAOOO_3 (
         This_Instance => This_Instance );

   end AAAOOO4_To_Delete_Self;
--
   procedure AAAOOO2_To_Idle (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      TAGS_AAAOOO_Type (This_Instance.all).Current_State := 
         Root_Object.TAGS.AAAOOO.Object_State_Type(Idle);

      TAGS_AAAOOO_1 (
         Final_Value =>  TAGS_AAAOOO2(This_Event.all).Final_Value,
         Test_Number =>  TAGS_AAAOOO2(This_Event.all).Test_Number,
         Purpose =>  TAGS_AAAOOO2(This_Event.all).Purpose,
         Tell_Tales =>  TAGS_AAAOOO2(This_Event.all).Tell_Tales,
         This_Instance => This_Instance );
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     TAGS_AAAOOO_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     TAGS_AAAOOO_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      TAGS_AAAOOO_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => TAGS_AAAOOO_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return TAGS_AAAOOO_Event_Queue.Queue_Length (TAGS_AAAOOO_Queue);
...
--
   This_Event_Dispatch_Matrix (AAAOOO1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOOO2, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOOO3, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOOO4, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOOO1, Idle) := AAAOOO1_To_Do_Something'access;
   This_Event_Dispatch_Matrix (AAAOOO2, Idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOOO3, Idle) := AAAOOO3_To_Do_Some_More_Tests'access;
   This_Event_Dispatch_Matrix (AAAOOO4, Idle) := AAAOOO4_To_Delete_Self'access;
   This_Event_Dispatch_Matrix (AAAOOO1, Do_Something) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOOO2, Do_Something) := AAAOOO2_To_Idle'access;
   This_Event_Dispatch_Matrix (AAAOOO3, Do_Something) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOOO4, Do_Something) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOOO1, Delete_Self) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOOO2, Delete_Self) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOOO3, Delete_Self) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOOO4, Delete_Self) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOOO1, Do_Some_More_Tests) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOOO2, Do_Some_More_Tests) := AAAOOO2_To_Idle'access;
   This_Event_Dispatch_Matrix (AAAOOO3, Do_Some_More_Tests) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (AAAOOO4, Do_Some_More_Tests) :=  Cannot_Happen_Action'access;

end Root_Object.TAGS.AAAOOO;
