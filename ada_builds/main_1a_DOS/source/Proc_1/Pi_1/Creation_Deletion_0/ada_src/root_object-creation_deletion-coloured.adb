...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.coloured.adb
...
--* Description:             
--*                          Domain body Root_Object.Creation_Deletioncoloured
...
------------------------------------------------------------------------
--
package body Root_Object.Creation_Deletion.coloured is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Coloured_Value : Creation_Deletion_Domain_Types.Coloured_Type := Creation_Deletion_Domain_Types.Coloured_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Coloured return Creation_Deletion_Domain_Types.Coloured_Type is
   begin
      Coloured_Value :=
         Creation_Deletion_Domain_Types.Coloured_Type'succ (Coloured_Value);
      return Coloured_Value;
   end Obtain_Subsequent_Coloured;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Creation_Deletion_coloured_Type (This_Object.all).Coloured;
   end Get_Coloured;
...
--ADATEST IGNORE_ON
   ...
   begin
      Creation_Deletion_coloured_Type (This_Object.all).Coloured :=
         Coloured_Value;
   end Put_Coloured;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Creation_Deletion_coloured_Type (This_Object.all).Intensity;
   end Get_Intensity;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Intensity (
      This_Object : in Root_Object.Object_Access;
      Intensity_Value : in Application_Types.Base_Integer_Type) is
   begin
      Creation_Deletion_coloured_Type (This_Object.all).Intensity :=
         Intensity_Value;
   end Put_Intensity;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Creation_Deletion_coloured_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Creation_Deletion_coloured_Type(This_Object.all).Coloured := Creation_Deletion_Domain_Types.Coloured_Type_First;
         Creation_Deletion_coloured_Type(This_Object.all).Intensity := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Creation_Deletion.coloured;
