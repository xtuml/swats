...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.objTS.event_action.ada
...
--*  separate of Root_Object.Creation_DeletionobjTS
--*     Event_Action
--*
--*************************************************************************************
--  MODIFICATION RECORD
...
begin
   ...
   This_Action := Creation_Deletion_objTS_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := Creation_Deletion_objTS_Instance_Event_Type(This_Event.all).Target_Instance;


   -- Ensure that the source instance still exists. 
   if This /= null then
      This_Event_Dispatch_Matrix (This_Action, Creation_Deletion_objTS_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
