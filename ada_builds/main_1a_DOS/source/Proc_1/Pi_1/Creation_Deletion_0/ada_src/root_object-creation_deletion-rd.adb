...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.RD.adb
...
--* Description:             
--*                          Domain body Root_Object.Creation_DeletionRD
...
------------------------------------------------------------------------
--
package body Root_Object.Creation_Deletion.RD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Report_Data_Unique_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Report_Data_Unique_id return Application_Types.Base_Integer_Type is
   begin
      Report_Data_Unique_id_Value :=
         Application_Types.Base_Integer_Type'succ (Report_Data_Unique_id_Value);
      return Report_Data_Unique_id_Value;
   end Obtain_Subsequent_Report_Data_Unique_id;
...
--ADATEST IGNORE_ON
   function Get_Report_Data_Unique_id (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return Creation_Deletion_RD_Type (This_Object.all).Report_Data_Unique_id;
   end Get_Report_Data_Unique_id;
...
--ADATEST IGNORE_ON
   procedure Put_Report_Data_Unique_id (
      This_Object : in Root_Object.Object_Access;
      Report_Data_Unique_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      Creation_Deletion_RD_Type (This_Object.all).Report_Data_Unique_id :=
         Report_Data_Unique_id_Value;
   end Put_Report_Data_Unique_id;
...
--ADATEST IGNORE_ON
   function Get_Reported_Domain_Number (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Creation_Deletion_RD_Type (This_Object.all).Reported_Domain_Number;
   end Get_Reported_Domain_Number;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Reported_Domain_Number (
      This_Object : in Root_Object.Object_Access;
      Reported_Domain_Number_Value : in Application_Types.Base_Integer_Type) is
   begin
      Creation_Deletion_RD_Type (This_Object.all).Reported_Domain_Number :=
         Reported_Domain_Number_Value;
   end Put_Reported_Domain_Number;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Creation_Deletion_RD_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Creation_Deletion_RD_Type(This_Object.all).Report_Data_Unique_id := Application_Types.Base_Integer_Type_First;
         Creation_Deletion_RD_Type(This_Object.all).Reported_Domain_Number := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Creation_Deletion_RD_Type(This_Object.all).Report_Data_Unique_id :=
         Obtain_Subsequent_Report_Data_Unique_id;
...
end Root_Object.Creation_Deletion.RD;
