...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.enemy.ads
...
--* Description:             
--*                          Domain specification Root_Object.Creation_Deletionenemy
...
--  ----------------------------------  
--  package Root_Object.Creation_Deletion.enemy
...
package Root_Object.Creation_Deletion.enemy is
--
------------------------------------------------------------------------
   --
   --**************  Object Enemy Information **************
   --
   -- Object enemy is PASSIVE
   --
   --
   --
   -- Object enemy has an identifying non-referential attribute Humanoid 
   -- and therefore may be uniquely created.
   -- 
   -- Object enemy has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "enemy";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Creation_Deletion_enemy_Type is new Creation_Deletion_Type with record
      ...
      can_climb_stairs :  Boolean := Application_Types.Boolean_First;
   ...
   procedure Put_can_climb_stairs (
      This_Object : in Root_Object.Object_Access;
      can_climb_stairs_Value : in  Boolean);

   pragma inline (Get_can_climb_stairs);
   pragma inline (Put_can_climb_stairs);
