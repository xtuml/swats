...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.flavoured.adb
...
--* Description:             
--*                          Domain body Root_Object.Creation_Deletionflavoured
...
------------------------------------------------------------------------
--
package body Root_Object.Creation_Deletion.flavoured is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Flavoured_Value : Creation_Deletion_Domain_Types.Flavoured_Type := Creation_Deletion_Domain_Types.Flavoured_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Flavoured return Creation_Deletion_Domain_Types.Flavoured_Type is
   begin
      Flavoured_Value :=
         Creation_Deletion_Domain_Types.Flavoured_Type'succ (Flavoured_Value);
      return Flavoured_Value;
   end Obtain_Subsequent_Flavoured;
...
--ADATEST IGNORE_ON
   ...
   begin
       return Creation_Deletion_flavoured_Type (This_Object.all).Flavoured;
   end Get_Flavoured;
...
--ADATEST IGNORE_ON
   ...
   begin
      Creation_Deletion_flavoured_Type (This_Object.all).Flavoured :=
         Flavoured_Value;
   end Put_Flavoured;
...
--ADATEST IGNORE_ON
   function Get_How_Spicy (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Creation_Deletion_flavoured_Type (This_Object.all).How_Spicy;
   end Get_How_Spicy;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_How_Spicy (
      This_Object : in Root_Object.Object_Access;
      How_Spicy_Value : in Application_Types.Base_Integer_Type) is
   begin
      Creation_Deletion_flavoured_Type (This_Object.all).How_Spicy :=
         How_Spicy_Value;
   end Put_How_Spicy;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Creation_Deletion_flavoured_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Creation_Deletion_flavoured_Type(This_Object.all).Flavoured := Creation_Deletion_Domain_Types.Flavoured_Type_First;
         Creation_Deletion_flavoured_Type(This_Object.all).How_Spicy := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Creation_Deletion.flavoured;
