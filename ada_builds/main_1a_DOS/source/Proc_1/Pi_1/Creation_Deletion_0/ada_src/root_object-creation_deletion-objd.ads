...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.objD.ads
...
--* Description:             
--*                          Domain specification Root_Object.Creation_DeletionobjD
...
--  ----------------------------------  
--  package Root_Object.Creation_Deletion.objD
...
package Root_Object.Creation_Deletion.objD is
--
------------------------------------------------------------------------
   --
   --**************  Object Object_D Information **************
   --
   -- Object objD is PASSIVE
   --
   --
   --
   ...
   type Creation_Deletion_objD_Type is new Creation_Deletion_Type with record
