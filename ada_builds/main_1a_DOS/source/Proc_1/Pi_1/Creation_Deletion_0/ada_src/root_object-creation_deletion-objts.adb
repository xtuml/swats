...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.objTS.adb
...
--* Description:             
--*                          Domain body Root_Object.Creation_DeletionobjTS
...
------------------------------------------------------------------------
--
package body Root_Object.Creation_Deletion.objTS is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   ReferenceTS_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_ReferenceTS return Application_Types.Base_Integer_Type is
   begin
      ReferenceTS_Value :=
         Application_Types.Base_Integer_Type'succ (ReferenceTS_Value);
      return ReferenceTS_Value;
   end Obtain_Subsequent_ReferenceTS;
...
--ADATEST IGNORE_ON
   function Get_ReferenceTS (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return Creation_Deletion_objTS_Type (This_Object.all).ReferenceTS;
   end Get_ReferenceTS;
...
--ADATEST IGNORE_ON
   procedure Put_ReferenceTS (
      This_Object : in Root_Object.Object_Access;
      ReferenceTS_Value : in Application_Types.Base_Integer_Type) is
   begin
      Creation_Deletion_objTS_Type (This_Object.all).ReferenceTS :=
         ReferenceTS_Value;
   end Put_ReferenceTS;
...
--ADATEST IGNORE_ON
   ...
   begin
      return Creation_Deletion_objTS_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      Creation_Deletion_objTS_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Creation_Deletion_objTS_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Creation_Deletion_objTS_Type(This_Object.all).ReferenceTS := Application_Types.Base_Integer_Type_First;
         Creation_Deletion_objTS_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure Creation_Deletion_objTS_2 (
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure objTS3_To_Deletion_in_a_terminal_state (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      Creation_Deletion_objTS_Type (This_Instance.all).Current_State := 
         Root_Object.Creation_Deletion.objTS.Object_State_Type(Deletion_in_a_terminal_state);

      Creation_Deletion_objTS_2 (
         This_Instance => This_Instance );

   end objTS3_To_Deletion_in_a_terminal_state;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     Creation_Deletion_objTS_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     Creation_Deletion_objTS_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Creation_Deletion_objTS_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => Creation_Deletion_objTS_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Creation_Deletion_objTS_Event_Queue.Pop (
         Item        => Temp_Event,
         Target_FIFO => Creation_Deletion_objTS_Queue);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return Creation_Deletion_objTS_Event_Queue.Queue_Length (Creation_Deletion_objTS_Queue);
...
--ADATEST IGNORE_ON
   procedure Put_Event (
      ...
      To_Class : in Creation_Deletion_objTS_Type;
...
--
   This_Event_Dispatch_Matrix (objTS3, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objTS3, Idle) := objTS3_To_Deletion_in_a_terminal_state'access;

end Root_Object.Creation_Deletion.objTS;
