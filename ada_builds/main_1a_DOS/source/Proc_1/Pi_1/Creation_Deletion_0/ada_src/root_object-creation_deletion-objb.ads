...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.objB.ads
...
--* Description:             
--*                          Domain specification Root_Object.Creation_DeletionobjB
...
--  ----------------------------------  
--  package Root_Object.Creation_Deletion.objB
...
package Root_Object.Creation_Deletion.objB is
--
------------------------------------------------------------------------
   --
   ...
   type Creation_Deletion_objB_Type is new Creation_Deletion_Type with record
