...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.dr.ads
...
--* Description:             
--*                          Domain specification Root_Object.Creation_Deletiondr
...
--  ----------------------------------  
--  package Root_Object.Creation_Deletion.dr
...
package Root_Object.Creation_Deletion.dr is
--
------------------------------------------------------------------------
   --
   --**************  Object Doctor Information **************
   --
   -- Object dr is PASSIVE
   --
   --
   --
   -- Object dr has an identifying non-referential attribute Actor 
   -- and therefore may be uniquely created.
   -- 
   -- Object dr has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "dr";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Creation_Deletion_dr_Type is new Creation_Deletion_Type with record
      ...
      length_of_scarf : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   return Creation_Deletion_Domain_Types.actors_who_have_played_the_doctor;

   procedure Put_Actor (
      This_Object : in Root_Object.Object_Access;
      Actor_Value : in Creation_Deletion_Domain_Types.actors_who_have_played_the_doctor);

   pragma inline (Get_Actor);
   pragma inline (Put_Actor);
   ...
   procedure Put_length_of_scarf (
      This_Object : in Root_Object.Object_Access;
      length_of_scarf_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_length_of_scarf);
   pragma inline (Put_length_of_scarf);
