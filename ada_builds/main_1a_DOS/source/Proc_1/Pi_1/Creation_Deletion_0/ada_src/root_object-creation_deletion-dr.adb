...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.dr.adb
...
--* Description:             
--*                          Domain body Root_Object.Creation_Deletiondr
...
------------------------------------------------------------------------
--
package body Root_Object.Creation_Deletion.dr is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Actor_Value : Creation_Deletion_Domain_Types.actors_who_have_played_the_doctor := Creation_Deletion_Domain_Types.actors_who_have_played_the_doctor_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Actor return Creation_Deletion_Domain_Types.actors_who_have_played_the_doctor is
   begin
      Actor_Value :=
         Creation_Deletion_Domain_Types.actors_who_have_played_the_doctor'succ (Actor_Value);
      return Actor_Value;
   end Obtain_Subsequent_Actor;
...
--ADATEST IGNORE_ON
   function Get_Actor (
      This_Object : Root_Object.Object_Access) return Creation_Deletion_Domain_Types.actors_who_have_played_the_doctor is
   begin
       return Creation_Deletion_dr_Type (This_Object.all).Actor;
   end Get_Actor;
...
--ADATEST IGNORE_ON
   procedure Put_Actor (
      ...
      Actor_Value : in Creation_Deletion_Domain_Types.actors_who_have_played_the_doctor) is
   begin
      Creation_Deletion_dr_Type (This_Object.all).Actor :=
         Actor_Value;
   end Put_Actor;
...
--ADATEST IGNORE_ON
   function Get_length_of_scarf (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Creation_Deletion_dr_Type (This_Object.all).length_of_scarf;
   end Get_length_of_scarf;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_length_of_scarf (
      This_Object : in Root_Object.Object_Access;
      length_of_scarf_Value : in Application_Types.Base_Integer_Type) is
   begin
      Creation_Deletion_dr_Type (This_Object.all).length_of_scarf :=
         length_of_scarf_Value;
   end Put_length_of_scarf;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Creation_Deletion_dr_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Creation_Deletion_dr_Type(This_Object.all).Actor := Creation_Deletion_Domain_Types.actors_who_have_played_the_doctor_First;
         Creation_Deletion_dr_Type(This_Object.all).length_of_scarf := Application_Types.Base_Integer_Type_First;
...
end Root_Object.Creation_Deletion.dr;
