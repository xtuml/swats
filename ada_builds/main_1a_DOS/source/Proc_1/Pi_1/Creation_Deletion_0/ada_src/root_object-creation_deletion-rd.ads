...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.RD.ads
...
--* Description:             
--*                          Domain specification Root_Object.Creation_DeletionRD
...
--  ----------------------------------  
--  package Root_Object.Creation_Deletion.RD
...
package Root_Object.Creation_Deletion.RD is
--
------------------------------------------------------------------------
   --
   --**************  Object Report_Data Information **************
   --
   -- Object RD is PASSIVE
   --
   --
   --
   -- Object RD has an identifying non-referential attribute Report_Data_Unique_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object RD has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "RD";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Creation_Deletion_RD_Type is new Creation_Deletion_Type with record

      --
      -- Non initialised identifying non referential
      Report_Data_Unique_id : Application_Types.Base_Integer_Type;

      --
      -- Initialised Non identifying non referential
      Reported_Domain_Number : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_Report_Data_Unique_id (
      ...
      Report_Data_Unique_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Report_Data_Unique_id);
   pragma inline (Put_Report_Data_Unique_id);
   ...
   procedure Put_Reported_Domain_Number (
      This_Object : in Root_Object.Object_Access;
      Reported_Domain_Number_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Reported_Domain_Number);
   pragma inline (Put_Reported_Domain_Number);
