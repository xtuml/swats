...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.fandc.ads
...
--* Description:             
--*                          Domain specification Root_Object.Creation_Deletionfandc
...
--  ----------------------------------  
--  package Root_Object.Creation_Deletion.fandc
...
package Root_Object.Creation_Deletion.fandc is
--
------------------------------------------------------------------------
   --
   --**************  Object Flavour_and_Colour Information **************
   --
   -- Object fandc is PASSIVE
   --
   --
   --
   -- Object fandc does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object fandc has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "fandc";

   --
   -------------------------------------------------------------------------------------------------
   --

   type Creation_Deletion_fandc_Type is new Creation_Deletion_Type with record

      --
      -- Non initialised identifying referential
      Coloured : Creation_Deletion_Domain_Types.Coloured_Type;

      --
      -- Non initialised identifying referential
      Flavoured : Creation_Deletion_Domain_Types.Flavoured_Type;

      --
      -- Initialised Non identifying non referential
      Dish_Number : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   return Creation_Deletion_Domain_Types.Coloured_Type;

   procedure Put_Coloured (
      This_Object : in Root_Object.Object_Access;
      Coloured_Value : in Creation_Deletion_Domain_Types.Coloured_Type);

   pragma inline (Get_Coloured);
   pragma inline (Put_Coloured);


   function Get_Flavoured (
      This_Object : Root_Object.Object_Access) 
   return Creation_Deletion_Domain_Types.Flavoured_Type;

   procedure Put_Flavoured (
      This_Object : in Root_Object.Object_Access;
      Flavoured_Value : in Creation_Deletion_Domain_Types.Flavoured_Type);

   pragma inline (Get_Flavoured);
   pragma inline (Put_Flavoured);
   ...
   procedure Put_Dish_Number (
      This_Object : in Root_Object.Object_Access;
      Dish_Number_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Dish_Number);
   pragma inline (Put_Dish_Number);
