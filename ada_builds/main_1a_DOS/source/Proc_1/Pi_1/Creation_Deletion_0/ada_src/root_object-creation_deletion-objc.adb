...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.Creation_Deletion.objC.adb
...
--* Description:             
--*                          Domain body Root_Object.Creation_DeletionobjC
...
------------------------------------------------------------------------
--
package body Root_Object.Creation_Deletion.objC is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Reference1C_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Reference1C return Application_Types.Base_Integer_Type is
   begin
      Reference1C_Value :=
         Application_Types.Base_Integer_Type'succ (Reference1C_Value);
      return Reference1C_Value;
   end Obtain_Subsequent_Reference1C;
...
--ADATEST IGNORE_ON
   function Get_Reference1C (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return Creation_Deletion_objC_Type (This_Object.all).Reference1C;
   end Get_Reference1C;
...
--ADATEST IGNORE_ON
   procedure Put_Reference1C (
      This_Object : in Root_Object.Object_Access;
      Reference1C_Value : in Application_Types.Base_Integer_Type) is
   begin
      Creation_Deletion_objC_Type (This_Object.all).Reference1C :=
         Reference1C_Value;
   end Put_Reference1C;
...
------------------------------------------------------------------------
   ...
   Reference2C_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Reference2C return Application_Types.Base_Integer_Type is
   begin
      Reference2C_Value :=
         Application_Types.Base_Integer_Type'succ (Reference2C_Value);
      return Reference2C_Value;
   end Obtain_Subsequent_Reference2C;
...
--ADATEST IGNORE_ON
   function Get_Reference2C (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return Creation_Deletion_objC_Type (This_Object.all).Reference2C;
   end Get_Reference2C;
...
--ADATEST IGNORE_ON
   procedure Put_Reference2C (
      This_Object : in Root_Object.Object_Access;
      Reference2C_Value : in Application_Types.Base_Integer_Type) is
   begin
      Creation_Deletion_objC_Type (This_Object.all).Reference2C :=
         Reference2C_Value;
   end Put_Reference2C;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Creation_Deletion_objC_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Creation_Deletion_objC_Type(This_Object.all).Reference1C := Application_Types.Base_Integer_Type_First;
         Creation_Deletion_objC_Type(This_Object.all).Reference2C := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      Creation_Deletion_objC_Type(This_Object.all).Reference1C :=
         Obtain_Subsequent_Reference1C;
      Creation_Deletion_objC_Type(This_Object.all).Reference2C :=
         Obtain_Subsequent_Reference2C;
...
end Root_Object.Creation_Deletion.objC;
