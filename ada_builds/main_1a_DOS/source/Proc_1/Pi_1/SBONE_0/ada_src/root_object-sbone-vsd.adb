...
--* Description:             
--*                          Domain body Root_Object.SBONEVSD
...
------------------------------------------------------------------------
--
package body Root_Object.SBONE.VSD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return SBONE_VSD_Type (This_Object.all).Object_Reference_VSD;
...
--ADATEST IGNORE_ON
   ...
   begin
      SBONE_VSD_Type (This_Object.all).Object_Reference_VSD :=
         Object_Reference_VSD_Value;
...
--ADATEST IGNORE_ON
   function Get_Object_Simple_Integer (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return SBONE_VSD_Type (This_Object.all).Object_Simple_Integer;
...
--ADATEST IGNORE_ON
   ...
   begin
      SBONE_VSD_Type (This_Object.all).Object_Simple_Integer :=
...
--ADATEST IGNORE_ON
   ...
   begin
      return SBONE_VSD_Type (This_Object.all).Object_Simple_Real;
...
--ADATEST IGNORE_ON
   ...
   begin
      SBONE_VSD_Type (This_Object.all).Object_Simple_Real :=
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new SBONE_VSD_Type;
   
      else
         This_Object := Free_List.First_Entry;
         SBONE_VSD_Type(This_Object.all).Object_Reference_VSD := Application_Types.Base_Integer_Type_First;
         SBONE_VSD_Type(This_Object.all).Object_Simple_Integer := Application_Types.Base_Integer_Type_First;
         SBONE_VSD_Type(This_Object.all).Object_Simple_Real := Application_Types.Base_Float_Type_First;
