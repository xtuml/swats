...
--* Description:             
--*                          Domain specification Root_Object.SBONERD
...
package Root_Object.SBONE.RD is
--
------------------------------------------------------------------------
   --
   ...
   type SBONE_RD_Type is new SBONE_Type with record
