...
package body SBONE_Domain_Types is
   ...
   procedure Initialize (Object: in out IH_Struct) is

   begin
   
      Object.Iterator    := new IH_Struct_Node_Access;
      Object.First_Entry := null;
      Object.Last_Entry  := null;
   ...
   procedure Adjust (Object: in out IH_Struct) is
    
      Next:        IH_Struct_Node_Access := null;
      Header_Cell: IH_Struct_Node_Access := null;
      Last_Cell:   IH_Struct_Node_Access := null;
      New_Cell:    IH_Struct_Node_Access := null;
   ...
   begin
      ...
      if Object.First_Entry /= null then
         ...
         Next        := Object.First_Entry;
         Header_Cell := new IH_Struct_Node;
         Last_Cell   := Header_Cell;
      
         Header_Cell.The_VSD_IH := Next.The_VSD_IH;
    
         Next := Next.Next_Structure;

         while Next /= null loop

            New_Cell := new IH_Struct_Node'(
               The_VSD_IH => Next.The_VSD_IH,
               Next_Structure     => null,
               Previous_Structure => null);
   ...
   procedure Finalize (Object: in out IH_Struct) is

      Next:     IH_Struct_Node_Access := null;
      Old_Cell: IH_Struct_Node_Access := null;
      ...
      procedure Free is new Ada.Unchecked_Deallocation (
         Object => IH_Struct_Node_Access, 
         Name   => IH_Struct_Node_Access_Pointer);
