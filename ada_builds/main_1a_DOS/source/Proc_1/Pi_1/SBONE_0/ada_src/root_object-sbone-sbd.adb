...
--* Description:             
--*                          Domain body Root_Object.SBONESBD
...
------------------------------------------------------------------------
--
package body Root_Object.SBONE.SBD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return SBONE_SBD_Type (This_Object.all).Reference;
   end Get_Reference;
...
--ADATEST IGNORE_ON
   ...
   begin
      SBONE_SBD_Type (This_Object.all).Reference :=
         Reference_Value;
   end Put_Reference;
...
--ADATEST IGNORE_ON
   function Get_The_Integer (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return SBONE_SBD_Type (This_Object.all).The_Integer;
   end Get_The_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      SBONE_SBD_Type (This_Object.all).The_Integer :=
         The_Integer_Value;
   end Put_The_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return SBONE_SBD_Type (This_Object.all).The_Real;
   end Get_The_Real;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      SBONE_SBD_Type (This_Object.all).The_Real :=
         The_Real_Value;
   end Put_The_Real;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return SBONE_SBD_Type (This_Object.all).The_String;
   end Get_The_String;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      SBONE_SBD_Type (This_Object.all).The_String :=
         The_String_Value;
   end Put_The_String;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_The_Colour (
      This_Object: Root_Object.Object_Access) return SBONE_Domain_Types.Colour_Type is
   begin
      return SBONE_SBD_Type (This_Object.all).The_Colour;
   end Get_The_Colour;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_The_Colour (
      This_Object : in Root_Object.Object_Access;
      The_Colour_Value : in SBONE_Domain_Types.Colour_Type) is
   begin
      SBONE_SBD_Type (This_Object.all).The_Colour :=
         The_Colour_Value;
   end Put_The_Colour;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return SBONE_SBD_Type (This_Object.all).The_Boolean;
   end Get_The_Boolean;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      SBONE_SBD_Type (This_Object.all).The_Boolean :=
         The_Boolean_Value;
   end Put_The_Boolean;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new SBONE_SBD_Type;
   
      else
         This_Object := Free_List.First_Entry;
         SBONE_SBD_Type(This_Object.all).Reference := Application_Types.Base_Integer_Type_First;
         SBONE_SBD_Type(This_Object.all).The_Integer := Application_Types.Base_Integer_Type_First;
         SBONE_SBD_Type(This_Object.all).The_Real := Application_Types.Base_Float_Type_First;
         SBONE_SBD_Type(This_Object.all).The_String := Application_Types.Base_Text_Type_First;
         SBONE_SBD_Type(This_Object.all).The_Colour := SBONE_Domain_Types.Colour_Type_First;
         SBONE_SBD_Type(This_Object.all).The_Boolean := Application_Types.Boolean_First;
