...
--* Description:             
--*                          Domain body Root_Object.SBONETD
...
------------------------------------------------------------------------
--
package body Root_Object.SBONE.TD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return SBONE_TD_Type (This_Object.all).td_id;
   end Get_td_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      SBONE_TD_Type (This_Object.all).td_id :=
         td_id_Value;
   end Put_td_id;
...
--ADATEST IGNORE_ON
   function Get_This_Test_Number (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return SBONE_TD_Type (This_Object.all).This_Test_Number;
...
--ADATEST IGNORE_ON
   ...
   begin
      SBONE_TD_Type (This_Object.all).This_Test_Number :=
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new SBONE_TD_Type;
   
      else
         This_Object := Free_List.First_Entry;
         SBONE_TD_Type(This_Object.all).td_id := Application_Types.Base_Integer_Type_First;
         SBONE_TD_Type(This_Object.all).This_Test_Number := Application_Types.Base_Integer_Type_First;
