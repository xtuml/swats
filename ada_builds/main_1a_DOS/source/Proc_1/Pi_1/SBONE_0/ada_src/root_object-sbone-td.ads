...
--* Description:             
--*                          Domain specification Root_Object.SBONETD
...
package Root_Object.SBONE.TD is
--
------------------------------------------------------------------------
   --
   ...
   type SBONE_TD_Type is new SBONE_Type with record
