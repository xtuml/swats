...
--* Description:             
--*                          Domain specification Root_Object.SBONESBD
...
package Root_Object.SBONE.SBD is
--
------------------------------------------------------------------------
   --
   ...
   type SBONE_SBD_Type is new SBONE_Type with record
      ...
      --
      -- Initialised Non identifying non referential
      The_Colour : SBONE_Domain_Types.Colour_Type := SBONE_Domain_Types.Colour_Type_First;
   ...
   function Get_The_Colour (
      This_Object : Root_Object.Object_Access) 
   return SBONE_Domain_Types.Colour_Type;

   procedure Put_The_Colour (
      This_Object : in Root_Object.Object_Access;
      The_Colour_Value : in SBONE_Domain_Types.Colour_Type);
