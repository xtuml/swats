...
--* Description:             
--*                          Domain specification Root_Object.SBONEVSD
...
package Root_Object.SBONE.VSD is
--
------------------------------------------------------------------------
   --
   ...
   type SBONE_VSD_Type is new SBONE_Type with record
