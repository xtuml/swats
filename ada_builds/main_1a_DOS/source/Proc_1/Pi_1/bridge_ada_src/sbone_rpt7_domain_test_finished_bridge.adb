...
--*************************************************************************************
--*                                                                                   *
--* File Name:               SBONE_RPT7_Domain_Test_Finished_Bridge.adb
...
package body SBONE_RPT7_Domain_Test_Finished_Bridge is
   
   procedure SBONE_RPT7_Domain_Test_Finished (
   ...
   -- start of RPT7_Domain_Test_Finished
      ...
      My_Report := Root_Object.SBONE.RD.Unconditional_Find_One;
...
--
         ...
         local_domain_number := Root_Object.SBONE.RD.SBONE_RD_type(My_Report.all).Reported_Domain_Number;
...
--
   ...
   end SBONE_RPT7_Domain_Test_Finished;
   
end SBONE_RPT7_Domain_Test_Finished_Bridge;

--
-- End of file SBONE_RPT7_Domain_Test_Finished_Bridge.adb
--
