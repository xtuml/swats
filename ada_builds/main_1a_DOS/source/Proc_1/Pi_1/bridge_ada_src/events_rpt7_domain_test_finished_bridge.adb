...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Events_RPT7_Domain_Test_Finished_Bridge.adb
...
package body Events_RPT7_Domain_Test_Finished_Bridge is
   
   procedure Events_RPT7_Domain_Test_Finished (
   ...
   -- start of RPT7_Domain_Test_Finished
      ...
      My_Report := Root_Object.Events.RD.Unconditional_Find_One;
...
--
         ...
         local_domain_number := Root_Object.Events.RD.Events_RD_type(My_Report.all).Reported_Domain_Number;
...
--
   ...
   end Events_RPT7_Domain_Test_Finished;
   
end Events_RPT7_Domain_Test_Finished_Bridge;

--
-- End of file Events_RPT7_Domain_Test_Finished_Bridge.adb
--
