...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainB_RPT6_Domain_Test_Start_Bridge.adb
...
package body DomainB_RPT6_Domain_Test_Start_Bridge is
   
   procedure DomainB_RPT6_Domain_Test_Start (
...
--
         ...
         Root_Object.DomainB.RD.DomainB_RD_type(My_Report.all).Reported_Domain_Number := New_Domain_Number;
         
      end if;
      
      
   end DomainB_RPT6_Domain_Test_Start;
   
end DomainB_RPT6_Domain_Test_Start_Bridge;

--
-- End of file DomainB_RPT6_Domain_Test_Start_Bridge.adb
--
