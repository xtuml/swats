...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainA_RPT4_Test_Unsupported_Bridge.adb
...
package body DomainA_RPT4_Test_Unsupported_Bridge is
   
   procedure DomainA_RPT4_Test_Unsupported (
   ...
   -- start of RPT4_Test_Unsupported
      ...
      The_Reporter_Object := Root_Object.DomainA.RD.Unconditional_Find_One;
...
--
         ...
         Unique_Domain_ID := Root_Object.DomainA.RD.DomainA_RD_type(The_Reporter_Object.all).Reported_Domain_Number;
...
--
   ...
   end DomainA_RPT4_Test_Unsupported;
   
end DomainA_RPT4_Test_Unsupported_Bridge;

--
-- End of file DomainA_RPT4_Test_Unsupported_Bridge.adb
--
