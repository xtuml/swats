...
--*************************************************************************************
--*                                                                                   *
--* File Name:               UDT_RPT1_Start_Test_Bridge.adb
...
package body UDT_RPT1_Start_Test_Bridge is
   
   procedure UDT_RPT1_Start_Test (
...
--
   ...
   end UDT_RPT1_Start_Test;
   
end UDT_RPT1_Start_Test_Bridge;

--
-- End of file UDT_RPT1_Start_Test_Bridge.adb
--
