...
--*************************************************************************************
--*                                                                                   *
--* File Name:               UDT_RPT6_Domain_Test_Start_Bridge.adb
...
package body UDT_RPT6_Domain_Test_Start_Bridge is
   
   procedure UDT_RPT6_Domain_Test_Start (
...
--
         ...
         Root_Object.UDT.RD.UDT_RD_type(My_Report.all).Reported_Domain_Number := New_Domain_Number;
         
      end if;
      
      
   end UDT_RPT6_Domain_Test_Start;
   
end UDT_RPT6_Domain_Test_Start_Bridge;

--
-- End of file UDT_RPT6_Domain_Test_Start_Bridge.adb
--
