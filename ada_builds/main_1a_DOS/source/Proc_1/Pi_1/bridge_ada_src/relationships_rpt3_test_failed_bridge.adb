...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Relationships_RPT3_Test_Failed_Bridge.adb
...
package body Relationships_RPT3_Test_Failed_Bridge is
   
   procedure Relationships_RPT3_Test_Failed (
...
--
   ...
   end Relationships_RPT3_Test_Failed;
   
end Relationships_RPT3_Test_Failed_Bridge;

--
-- End of file Relationships_RPT3_Test_Failed_Bridge.adb
--
