...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_RPT1_Start_Test_Bridge.adb
...
package body Function_Calls_RPT1_Start_Test_Bridge is
   
   procedure Function_Calls_RPT1_Start_Test (
...
--
   ...
   end Function_Calls_RPT1_Start_Test;
   
end Function_Calls_RPT1_Start_Test_Bridge;

--
-- End of file Function_Calls_RPT1_Start_Test_Bridge.adb
--
