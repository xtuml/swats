...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Events_RPT4_Test_Unsupported_Bridge.adb
...
package body Events_RPT4_Test_Unsupported_Bridge is
   
   procedure Events_RPT4_Test_Unsupported (
   ...
   -- start of RPT4_Test_Unsupported
      ...
      The_Reporter_Object := Root_Object.Events.RD.Unconditional_Find_One;
...
--
         ...
         Unique_Domain_ID := Root_Object.Events.RD.Events_RD_type(The_Reporter_Object.all).Reported_Domain_Number;
...
--
   ...
   end Events_RPT4_Test_Unsupported;
   
end Events_RPT4_Test_Unsupported_Bridge;

--
-- End of file Events_RPT4_Test_Unsupported_Bridge.adb
--
