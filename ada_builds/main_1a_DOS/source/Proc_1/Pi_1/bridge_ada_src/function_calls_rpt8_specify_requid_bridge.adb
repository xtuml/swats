...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_RPT8_Specify_Requid_Bridge.adb
...
package body Function_Calls_RPT8_Specify_Requid_Bridge is
   
   procedure Function_Calls_RPT8_Specify_Requid (
...
--
   ...
   end Function_Calls_RPT8_Specify_Requid;
   
end Function_Calls_RPT8_Specify_Requid_Bridge;

--
-- End of file Function_Calls_RPT8_Specify_Requid_Bridge.adb
--
