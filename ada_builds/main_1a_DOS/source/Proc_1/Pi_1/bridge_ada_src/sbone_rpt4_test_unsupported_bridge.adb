...
--*************************************************************************************
--*                                                                                   *
--* File Name:               SBONE_RPT4_Test_Unsupported_Bridge.adb
...
package body SBONE_RPT4_Test_Unsupported_Bridge is
   
   procedure SBONE_RPT4_Test_Unsupported (
...
--
   ...
   end SBONE_RPT4_Test_Unsupported;
   
end SBONE_RPT4_Test_Unsupported_Bridge;

--
-- End of file SBONE_RPT4_Test_Unsupported_Bridge.adb
--
