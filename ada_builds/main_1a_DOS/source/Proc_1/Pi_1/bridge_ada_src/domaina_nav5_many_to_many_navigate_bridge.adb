...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainA_NAV5_Many_to_Many_Navigate_Bridge.adb
...
package body DomainA_NAV5_Many_to_Many_Navigate_Bridge is
   
   procedure DomainA_NAV5_Many_to_Many_Navigate (
   ...
   begin
   -- start of NAV5_Many_to_Many_Navigate
...
-- RP start _____________________________________________v--RP--v_______________________________________________________start RP
         ...
         RP_RP4_Test_Description_Service.RP_RP4_Test_Description (
            ...
            Write_Object                => "Bridge                          ",
            Write_Test_Purpose          => "local many to many nav          ",
            Write_Invoker_Domain_Number => This_Domain_Number);
         
-- RP end   _____________________________________________^--RP--^_______________________________________________________end   RP
--

         left_side := Root_Object.DomainA.mtmls.Conditional_Find_One;
         while (left_side /= null) and then (not (Root_Object.DomainA.mtmls.DomainA_mtmls_Type(left_side.all).mtmls_id =  Test) ) loop
         ...
         begin
            ...
            while (Temp_Entry /= null) loop
               ...
               if Root_Object.DomainA.mtmrs.DomainA_mtmrs_type(a_right_side.all).mtmrs_id =  Test then
...
--
   ...
   end DomainA_NAV5_Many_to_Many_Navigate;
   
end DomainA_NAV5_Many_to_Many_Navigate_Bridge;

--
-- End of file DomainA_NAV5_Many_to_Many_Navigate_Bridge.adb
--
