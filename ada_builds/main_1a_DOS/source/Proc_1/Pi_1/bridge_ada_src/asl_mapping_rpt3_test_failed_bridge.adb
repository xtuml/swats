...
--*************************************************************************************
--*                                                                                   *
--* File Name:               ASL_Mapping_RPT3_Test_Failed_Bridge.adb
...
package body ASL_Mapping_RPT3_Test_Failed_Bridge is
   
   procedure ASL_Mapping_RPT3_Test_Failed (
...
--
   ...
   end ASL_Mapping_RPT3_Test_Failed;
   
end ASL_Mapping_RPT3_Test_Failed_Bridge;

--
-- End of file ASL_Mapping_RPT3_Test_Failed_Bridge.adb
--
