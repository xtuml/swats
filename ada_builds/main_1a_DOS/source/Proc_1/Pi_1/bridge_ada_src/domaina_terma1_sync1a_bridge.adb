...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainA_termA1_Sync1A_Bridge.adb
...
with DomainB_DomainB1_Sync1B_Service;
...
package body DomainA_termA1_Sync1A_Bridge is
   
   procedure DomainA_termA1_Sync1A (
...
-- DomainB start _____________________________________________v--DomainB--v_______________________________________________________start DomainB
      ...
      DomainB_DomainB1_Sync1B_Service.DomainB_DomainB1_Sync1B (
         inputA  => inputA,
         inputB  => inputB,
         Test    => Test,
         outputA => returnA,
...
--
   ...
   end DomainA_termA1_Sync1A;
   
end DomainA_termA1_Sync1A_Bridge;

--
-- End of file DomainA_termA1_Sync1A_Bridge.adb
--
