...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainA_RPT7_Domain_Test_Finished_Bridge.adb
...
package body DomainA_RPT7_Domain_Test_Finished_Bridge is
   
   procedure DomainA_RPT7_Domain_Test_Finished (
...
--
         ...
         local_domain_number := Root_Object.DomainA.RD.DomainA_RD_type(My_Report.all).Reported_Domain_Number;
...
--
   ...
   end DomainA_RPT7_Domain_Test_Finished;
   
end DomainA_RPT7_Domain_Test_Finished_Bridge;

--
-- End of file DomainA_RPT7_Domain_Test_Finished_Bridge.adb
--
