...
--*************************************************************************************
--*                                                                                   *
--* File Name:               TAGS_RPT8_Specify_Requid_Bridge.adb
...
package body TAGS_RPT8_Specify_Requid_Bridge is
   
   procedure TAGS_RPT8_Specify_Requid (
...
--
   ...
   end TAGS_RPT8_Specify_Requid;
   
end TAGS_RPT8_Specify_Requid_Bridge;

--
-- End of file TAGS_RPT8_Specify_Requid_Bridge.adb
--
