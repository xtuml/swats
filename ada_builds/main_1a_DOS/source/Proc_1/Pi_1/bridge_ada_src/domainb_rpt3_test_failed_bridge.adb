...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainB_RPT3_Test_Failed_Bridge.adb
...
package body DomainB_RPT3_Test_Failed_Bridge is
   
   procedure DomainB_RPT3_Test_Failed (
...
--
   ...
   end DomainB_RPT3_Test_Failed;
   
end DomainB_RPT3_Test_Failed_Bridge;

--
-- End of file DomainB_RPT3_Test_Failed_Bridge.adb
--
