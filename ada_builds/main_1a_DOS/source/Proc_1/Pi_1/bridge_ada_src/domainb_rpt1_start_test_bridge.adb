...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainB_RPT1_Start_Test_Bridge.adb
...
package body DomainB_RPT1_Start_Test_Bridge is
   
   procedure DomainB_RPT1_Start_Test (
...
--
   ...
   end DomainB_RPT1_Start_Test;
   
end DomainB_RPT1_Start_Test_Bridge;

--
-- End of file DomainB_RPT1_Start_Test_Bridge.adb
--
