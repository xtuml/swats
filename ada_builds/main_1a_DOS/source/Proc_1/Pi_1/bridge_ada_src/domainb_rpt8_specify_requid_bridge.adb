...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainB_RPT8_Specify_Requid_Bridge.adb
...
package body DomainB_RPT8_Specify_Requid_Bridge is
   
   procedure DomainB_RPT8_Specify_Requid (
...
--
   ...
   end DomainB_RPT8_Specify_Requid;
   
end DomainB_RPT8_Specify_Requid_Bridge;

--
-- End of file DomainB_RPT8_Specify_Requid_Bridge.adb
--
