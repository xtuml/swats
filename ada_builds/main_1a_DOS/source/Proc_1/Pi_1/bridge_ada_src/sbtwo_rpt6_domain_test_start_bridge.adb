...
--*************************************************************************************
--*                                                                                   *
--* File Name:               SBTWO_RPT6_Domain_Test_Start_Bridge.adb
...
package body SBTWO_RPT6_Domain_Test_Start_Bridge is
   
   procedure SBTWO_RPT6_Domain_Test_Start (
...
--
         ...
         Root_Object.SBTWO.RD.SBTWO_RD_type(My_Report.all).Reported_Domain_Number := New_Domain_Number;
         
      end if;
      
      
   end SBTWO_RPT6_Domain_Test_Start;
   
end SBTWO_RPT6_Domain_Test_Start_Bridge;

--
-- End of file SBTWO_RPT6_Domain_Test_Start_Bridge.adb
--
