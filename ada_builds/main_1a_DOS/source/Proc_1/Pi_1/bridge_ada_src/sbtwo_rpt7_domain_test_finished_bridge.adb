...
--*************************************************************************************
--*                                                                                   *
--* File Name:               SBTWO_RPT7_Domain_Test_Finished_Bridge.adb
...
package body SBTWO_RPT7_Domain_Test_Finished_Bridge is
   
   procedure SBTWO_RPT7_Domain_Test_Finished (
   ...
   -- start of RPT7_Domain_Test_Finished
      ...
      My_Report := Root_Object.SBTWO.RD.Unconditional_Find_One;
...
--
         ...
         local_domain_number := Root_Object.SBTWO.RD.SBTWO_RD_type(My_Report.all).Reported_Domain_Number;
...
--
   ...
   end SBTWO_RPT7_Domain_Test_Finished;
   
end SBTWO_RPT7_Domain_Test_Finished_Bridge;

--
-- End of file SBTWO_RPT7_Domain_Test_Finished_Bridge.adb
--
