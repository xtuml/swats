...
--*************************************************************************************
--*                                                                                   *
--* File Name:               UDT_RPT7_Domain_Test_Finished_Bridge.adb
...
package body UDT_RPT7_Domain_Test_Finished_Bridge is
   
   procedure UDT_RPT7_Domain_Test_Finished (
...
--
         ...
         local_domain_number := Root_Object.UDT.RD.UDT_RD_type(My_Report.all).Reported_Domain_Number;
...
--
   ...
   end UDT_RPT7_Domain_Test_Finished;
   
end UDT_RPT7_Domain_Test_Finished_Bridge;

--
-- End of file UDT_RPT7_Domain_Test_Finished_Bridge.adb
--
