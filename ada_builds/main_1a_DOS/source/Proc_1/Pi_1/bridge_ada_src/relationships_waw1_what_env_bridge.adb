...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Relationships_WAW1_What_Env_Bridge.adb
...
package body Relationships_WAW1_What_Env_Bridge is
...
--
   ...
   end Relationships_WAW1_What_Env;
   
end Relationships_WAW1_What_Env_Bridge;

--
-- End of file Relationships_WAW1_What_Env_Bridge.adb
--
