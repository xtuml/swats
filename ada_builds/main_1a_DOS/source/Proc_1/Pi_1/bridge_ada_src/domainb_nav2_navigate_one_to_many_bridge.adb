...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainB_NAV2_Navigate_One_to_Many_Bridge.adb
...
package body DomainB_NAV2_Navigate_One_to_Many_Bridge is
   
   procedure DomainB_NAV2_Navigate_One_to_Many (
   ...
   begin
   -- start of NAV2_Navigate_One_to_Many
...
-- RP start _____________________________________________v--RP--v_______________________________________________________start RP
         ...
         RP_RP4_Test_Description_Service.RP_RP4_Test_Description (
            ...
            Write_Test_Purpose          => "one to many nav                 ",
...
-- DomainA start _____________________________________________v--DomainA--v_______________________________________________________start DomainA
         left_side := Root_Object.DomainA.otmls.Unconditional_Find_One;
...
--
   ...
   end DomainB_NAV2_Navigate_One_to_Many;
   
end DomainB_NAV2_Navigate_One_to_Many_Bridge;

--
-- End of file DomainB_NAV2_Navigate_One_to_Many_Bridge.adb
--
