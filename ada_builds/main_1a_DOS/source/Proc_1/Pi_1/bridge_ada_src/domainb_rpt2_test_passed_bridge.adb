...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainB_RPT2_Test_Passed_Bridge.adb
...
package body DomainB_RPT2_Test_Passed_Bridge is
   
   procedure DomainB_RPT2_Test_Passed (
...
--
   ...
   end DomainB_RPT2_Test_Passed;
   
end DomainB_RPT2_Test_Passed_Bridge;

--
-- End of file DomainB_RPT2_Test_Passed_Bridge.adb
--
