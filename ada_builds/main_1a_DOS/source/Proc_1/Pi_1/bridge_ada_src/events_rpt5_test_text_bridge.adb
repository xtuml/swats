...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Events_RPT5_Test_Text_Bridge.adb
...
package body Events_RPT5_Test_Text_Bridge is
   
   procedure Events_RPT5_Test_Text (
...
--
   ...
   end Events_RPT5_Test_Text;
   
end Events_RPT5_Test_Text_Bridge;

--
-- End of file Events_RPT5_Test_Text_Bridge.adb
--
