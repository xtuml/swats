...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Relationships_RPT4_Test_Unsupported_Bridge.adb
...
package body Relationships_RPT4_Test_Unsupported_Bridge is
   
   procedure Relationships_RPT4_Test_Unsupported (
   ...
   -- start of RPT4_Test_Unsupported
      ...
      The_Reporter_Object := Root_Object.Relationships.RD.Unconditional_Find_One;
...
--
         ...
         Unique_Domain_ID := Root_Object.Relationships.RD.Relationships_RD_type(The_Reporter_Object.all).Reported_Domain_Number;
...
--
   ...
   end Relationships_RPT4_Test_Unsupported;
   
end Relationships_RPT4_Test_Unsupported_Bridge;

--
-- End of file Relationships_RPT4_Test_Unsupported_Bridge.adb
--
