...
--*************************************************************************************
--*                                                                                   *
--* File Name:               ASL_Mapping_RPT7_Domain_Test_Finished_Bridge.adb
...
package body ASL_Mapping_RPT7_Domain_Test_Finished_Bridge is
   
   procedure ASL_Mapping_RPT7_Domain_Test_Finished (
   ...
   -- start of RPT7_Domain_Test_Finished
      ...
      My_Report := Root_Object.ASL_Mapping.RD.Unconditional_Find_One;
...
--
         ...
         local_domain_number := Root_Object.ASL_Mapping.RD.ASL_Mapping_RD_type(My_Report.all).Reported_Domain_Number;
...
--
   ...
   end ASL_Mapping_RPT7_Domain_Test_Finished;
   
end ASL_Mapping_RPT7_Domain_Test_Finished_Bridge;

--
-- End of file ASL_Mapping_RPT7_Domain_Test_Finished_Bridge.adb
--
