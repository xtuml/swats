...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainB_RPT5_Test_Text_Bridge.adb
...
package body DomainB_RPT5_Test_Text_Bridge is
   
   procedure DomainB_RPT5_Test_Text (
...
--
   ...
   end DomainB_RPT5_Test_Text;
   
end DomainB_RPT5_Test_Text_Bridge;

--
-- End of file DomainB_RPT5_Test_Text_Bridge.adb
--
