...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainA_RPT3_Test_Failed_Bridge.adb
...
package body DomainA_RPT3_Test_Failed_Bridge is
   
   procedure DomainA_RPT3_Test_Failed (
...
--
   ...
   end DomainA_RPT3_Test_Failed;
   
end DomainA_RPT3_Test_Failed_Bridge;

--
-- End of file DomainA_RPT3_Test_Failed_Bridge.adb
--
