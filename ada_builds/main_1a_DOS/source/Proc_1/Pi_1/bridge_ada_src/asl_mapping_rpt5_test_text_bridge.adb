...
--*************************************************************************************
--*                                                                                   *
--* File Name:               ASL_Mapping_RPT5_Test_Text_Bridge.adb
...
package body ASL_Mapping_RPT5_Test_Text_Bridge is
   
   procedure ASL_Mapping_RPT5_Test_Text (
...
--
   ...
   end ASL_Mapping_RPT5_Test_Text;
   
end ASL_Mapping_RPT5_Test_Text_Bridge;

--
-- End of file ASL_Mapping_RPT5_Test_Text_Bridge.adb
--
