...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainA_RPT8_Specify_Requid_Bridge.adb
...
package body DomainA_RPT8_Specify_Requid_Bridge is
   
   procedure DomainA_RPT8_Specify_Requid (
...
--
   ...
   end DomainA_RPT8_Specify_Requid;
   
end DomainA_RPT8_Specify_Requid_Bridge;

--
-- End of file DomainA_RPT8_Specify_Requid_Bridge.adb
--
