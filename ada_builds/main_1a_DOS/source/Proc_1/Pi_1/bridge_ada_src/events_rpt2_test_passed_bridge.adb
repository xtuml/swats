...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Events_RPT2_Test_Passed_Bridge.adb
...
package body Events_RPT2_Test_Passed_Bridge is
   
   procedure Events_RPT2_Test_Passed (
...
--
   ...
   end Events_RPT2_Test_Passed;
   
end Events_RPT2_Test_Passed_Bridge;

--
-- End of file Events_RPT2_Test_Passed_Bridge.adb
--
