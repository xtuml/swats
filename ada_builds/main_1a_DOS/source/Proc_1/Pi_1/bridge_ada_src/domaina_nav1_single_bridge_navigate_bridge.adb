...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainA_NAV1_Single_Bridge_Navigate_Bridge.adb
...
package body DomainA_NAV1_Single_Bridge_Navigate_Bridge is
   
   procedure DomainA_NAV1_Single_Bridge_Navigate (
   ...
   begin
   -- start of NAV1_Single_Bridge_Navigate
...
-- RP start _____________________________________________v--RP--v_______________________________________________________start RP
         ...
         RP_RP4_Test_Description_Service.RP_RP4_Test_Description (
            ...
            Write_Object                => "Bridge                          ",
            Write_Test_Purpose          => "non shared bridge               ",
...
--
   ...
   end DomainA_NAV1_Single_Bridge_Navigate;
   
end DomainA_NAV1_Single_Bridge_Navigate_Bridge;

--
-- End of file DomainA_NAV1_Single_Bridge_Navigate_Bridge.adb
--
