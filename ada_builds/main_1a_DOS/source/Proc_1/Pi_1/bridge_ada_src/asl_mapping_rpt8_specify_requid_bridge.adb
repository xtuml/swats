...
--*************************************************************************************
--*                                                                                   *
--* File Name:               ASL_Mapping_RPT8_Specify_Requid_Bridge.adb
...
package body ASL_Mapping_RPT8_Specify_Requid_Bridge is
   
   procedure ASL_Mapping_RPT8_Specify_Requid (
...
--
   ...
   end ASL_Mapping_RPT8_Specify_Requid;
   
end ASL_Mapping_RPT8_Specify_Requid_Bridge;

--
-- End of file ASL_Mapping_RPT8_Specify_Requid_Bridge.adb
--
