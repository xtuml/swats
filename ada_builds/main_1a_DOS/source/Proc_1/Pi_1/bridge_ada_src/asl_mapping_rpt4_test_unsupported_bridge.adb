...
--*************************************************************************************
--*                                                                                   *
--* File Name:               ASL_Mapping_RPT4_Test_Unsupported_Bridge.adb
...
package body ASL_Mapping_RPT4_Test_Unsupported_Bridge is
   
   procedure ASL_Mapping_RPT4_Test_Unsupported (
   ...
   -- start of RPT4_Test_Unsupported
      ...
      The_Reporter_Object := Root_Object.ASL_Mapping.RD.Unconditional_Find_One;
...
--
         ...
         Unique_Domain_ID := Root_Object.ASL_Mapping.RD.ASL_Mapping_RD_type(The_Reporter_Object.all).Reported_Domain_Number;
...
--
   ...
   end ASL_Mapping_RPT4_Test_Unsupported;
   
end ASL_Mapping_RPT4_Test_Unsupported_Bridge;

--
-- End of file ASL_Mapping_RPT4_Test_Unsupported_Bridge.adb
--
