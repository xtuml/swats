...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_RPT3_Test_Failed_Bridge.adb
...
package body Function_Calls_RPT3_Test_Failed_Bridge is
   
   procedure Function_Calls_RPT3_Test_Failed (
...
--
   ...
   end Function_Calls_RPT3_Test_Failed;
   
end Function_Calls_RPT3_Test_Failed_Bridge;

--
-- End of file Function_Calls_RPT3_Test_Failed_Bridge.adb
--
