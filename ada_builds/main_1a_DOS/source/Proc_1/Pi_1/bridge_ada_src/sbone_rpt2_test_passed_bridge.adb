...
--*************************************************************************************
--*                                                                                   *
--* File Name:               SBONE_RPT2_Test_Passed_Bridge.adb
...
package body SBONE_RPT2_Test_Passed_Bridge is
...
--
   ...
   end SBONE_RPT2_Test_Passed;
   
end SBONE_RPT2_Test_Passed_Bridge;

--
-- End of file SBONE_RPT2_Test_Passed_Bridge.adb
--
