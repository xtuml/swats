...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainA_RPT1_Start_Test_Bridge.adb
...
package body DomainA_RPT1_Start_Test_Bridge is
   
   procedure DomainA_RPT1_Start_Test (
...
--
   ...
   end DomainA_RPT1_Start_Test;
   
end DomainA_RPT1_Start_Test_Bridge;

--
-- End of file DomainA_RPT1_Start_Test_Bridge.adb
--
