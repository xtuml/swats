...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainB_RPT4_Test_Unsupported_Bridge.adb
...
package body DomainB_RPT4_Test_Unsupported_Bridge is
   
   procedure DomainB_RPT4_Test_Unsupported (
   ...
   -- start of RPT4_Test_Unsupported
      ...
      The_Reporter_Object := Root_Object.DomainB.RD.Unconditional_Find_One;
...
--
         ...
         Unique_Domain_ID := Root_Object.DomainB.RD.DomainB_RD_type(The_Reporter_Object.all).Reported_Domain_Number;
...
--
   ...
   end DomainB_RPT4_Test_Unsupported;
   
end DomainB_RPT4_Test_Unsupported_Bridge;

--
-- End of file DomainB_RPT4_Test_Unsupported_Bridge.adb
--
