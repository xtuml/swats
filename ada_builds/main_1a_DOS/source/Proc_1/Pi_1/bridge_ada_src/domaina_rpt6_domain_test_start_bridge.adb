...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainA_RPT6_Domain_Test_Start_Bridge.adb
...
package body DomainA_RPT6_Domain_Test_Start_Bridge is
   
   procedure DomainA_RPT6_Domain_Test_Start (
...
--
         ...
         Root_Object.DomainA.RD.DomainA_RD_type(My_Report.all).Reported_Domain_Number := New_Domain_Number;
         
      end if;
      
      
   end DomainA_RPT6_Domain_Test_Start;
   
end DomainA_RPT6_Domain_Test_Start_Bridge;

--
-- End of file DomainA_RPT6_Domain_Test_Start_Bridge.adb
--
