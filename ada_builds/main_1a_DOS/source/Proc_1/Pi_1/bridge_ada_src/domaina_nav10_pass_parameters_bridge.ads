...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainA_NAV10_Pass_Parameters_Bridge.ads
...
package DomainA_NAV10_Pass_Parameters_Bridge is
   ...
   procedure DomainA_NAV10_Pass_Parameters (
      ...
      The_Result     :    out Application_Types.Base_Integer_Type);
   
end DomainA_NAV10_Pass_Parameters_Bridge;

--
-- End of file DomainA_NAV10_Pass_Parameters_Bridge.ads
--
