...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_RPT2_Test_Passed_Bridge.adb
...
package body Function_Calls_RPT2_Test_Passed_Bridge is
   
   procedure Function_Calls_RPT2_Test_Passed (
...
--
   ...
   end Function_Calls_RPT2_Test_Passed;
   
end Function_Calls_RPT2_Test_Passed_Bridge;

--
-- End of file Function_Calls_RPT2_Test_Passed_Bridge.adb
--
