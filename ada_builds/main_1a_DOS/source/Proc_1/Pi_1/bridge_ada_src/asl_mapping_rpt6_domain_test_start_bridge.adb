...
--*************************************************************************************
--*                                                                                   *
--* File Name:               ASL_Mapping_RPT6_Domain_Test_Start_Bridge.adb
...
package body ASL_Mapping_RPT6_Domain_Test_Start_Bridge is
   
   procedure ASL_Mapping_RPT6_Domain_Test_Start (
...
--
         ...
         Root_Object.ASL_Mapping.RD.ASL_Mapping_RD_type(My_Report.all).Reported_Domain_Number := New_Domain_Number;
         
      end if;
      
      
   end ASL_Mapping_RPT6_Domain_Test_Start;
   
end ASL_Mapping_RPT6_Domain_Test_Start_Bridge;

--
-- End of file ASL_Mapping_RPT6_Domain_Test_Start_Bridge.adb
--
