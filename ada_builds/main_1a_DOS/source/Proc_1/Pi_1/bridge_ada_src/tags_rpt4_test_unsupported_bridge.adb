...
--*************************************************************************************
--*                                                                                   *
--* File Name:               TAGS_RPT4_Test_Unsupported_Bridge.adb
...
package body TAGS_RPT4_Test_Unsupported_Bridge is
   
   procedure TAGS_RPT4_Test_Unsupported (
   ...
   -- start of RPT4_Test_Unsupported
      ...
      The_Reporter_Object := Root_Object.TAGS.RD.Unconditional_Find_One;
...
--
         ...
         Unique_Domain_ID := Root_Object.TAGS.RD.TAGS_RD_type(The_Reporter_Object.all).Reported_Domain_Number;
...
--
   ...
   end TAGS_RPT4_Test_Unsupported;
   
end TAGS_RPT4_Test_Unsupported_Bridge;

--
-- End of file TAGS_RPT4_Test_Unsupported_Bridge.adb
--
