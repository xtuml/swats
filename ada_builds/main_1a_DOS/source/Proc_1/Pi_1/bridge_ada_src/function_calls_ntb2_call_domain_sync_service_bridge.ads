...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_NTB2_Call_Domain_Sync_Service_Bridge.ads
...
package Function_Calls_NTB2_Call_Domain_Sync_Service_Bridge is
   ...
   procedure Function_Calls_NTB2_Call_Domain_Sync_Service (
      ...
      InputValue3 : in     Application_Types.Base_Integer_Type);
   
end Function_Calls_NTB2_Call_Domain_Sync_Service_Bridge;

--
-- End of file Function_Calls_NTB2_Call_Domain_Sync_Service_Bridge.ads
--
