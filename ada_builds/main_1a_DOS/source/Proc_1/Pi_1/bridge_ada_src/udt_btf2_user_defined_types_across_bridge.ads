...
--*************************************************************************************
--*                                                                                   *
--* File Name:               UDT_BTF2_User_Defined_Types_Across_Bridge.ads
...
package UDT_BTF2_User_Defined_Types_Across_Bridge is
   ...
   procedure UDT_BTF2_User_Defined_Types_Across (
      ...
      A_Return_Param :    out UDT_Domain_Types.One_To_Maximum_Integer);
   
end UDT_BTF2_User_Defined_Types_Across_Bridge;

--
-- End of file UDT_BTF2_User_Defined_Types_Across_Bridge.ads
--
