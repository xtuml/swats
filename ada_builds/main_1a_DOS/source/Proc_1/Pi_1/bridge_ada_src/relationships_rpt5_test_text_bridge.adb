...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Relationships_RPT5_Test_Text_Bridge.adb
...
package body Relationships_RPT5_Test_Text_Bridge is
   
   procedure Relationships_RPT5_Test_Text (
...
--
   ...
   end Relationships_RPT5_Test_Text;
   
end Relationships_RPT5_Test_Text_Bridge;

--
-- End of file Relationships_RPT5_Test_Text_Bridge.adb
--
