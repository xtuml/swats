...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Relationships_RPT6_Domain_Test_Start_Bridge.adb
...
package body Relationships_RPT6_Domain_Test_Start_Bridge is
   
   procedure Relationships_RPT6_Domain_Test_Start (
...
--
         ...
         Root_Object.Relationships.RD.Relationships_RD_type(My_Report.all).Reported_Domain_Number := New_Domain_Number;
         
      end if;
      
      
   end Relationships_RPT6_Domain_Test_Start;
   
end Relationships_RPT6_Domain_Test_Start_Bridge;

--
-- End of file Relationships_RPT6_Domain_Test_Start_Bridge.adb
--
