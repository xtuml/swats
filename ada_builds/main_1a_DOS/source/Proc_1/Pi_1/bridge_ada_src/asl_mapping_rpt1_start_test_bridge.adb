...
--*************************************************************************************
--*                                                                                   *
--* File Name:               ASL_Mapping_RPT1_Start_Test_Bridge.adb
...
package body ASL_Mapping_RPT1_Start_Test_Bridge is
   
   procedure ASL_Mapping_RPT1_Start_Test (
...
--
   ...
   end ASL_Mapping_RPT1_Start_Test;
   
end ASL_Mapping_RPT1_Start_Test_Bridge;

--
-- End of file ASL_Mapping_RPT1_Start_Test_Bridge.adb
--
