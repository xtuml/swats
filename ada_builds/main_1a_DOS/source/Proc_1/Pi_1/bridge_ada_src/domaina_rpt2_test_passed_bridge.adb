...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainA_RPT2_Test_Passed_Bridge.adb
...
package body DomainA_RPT2_Test_Passed_Bridge is
   
   procedure DomainA_RPT2_Test_Passed (
...
--
   ...
   end DomainA_RPT2_Test_Passed;
   
end DomainA_RPT2_Test_Passed_Bridge;

--
-- End of file DomainA_RPT2_Test_Passed_Bridge.adb
--
