...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainB_RPT7_Domain_Test_Finished_Bridge.adb
...
package body DomainB_RPT7_Domain_Test_Finished_Bridge is
   
   procedure DomainB_RPT7_Domain_Test_Finished (
...
--
         ...
         local_domain_number := Root_Object.DomainB.RD.DomainB_RD_type(My_Report.all).Reported_Domain_Number;
...
--
   ...
   end DomainB_RPT7_Domain_Test_Finished;
   
end DomainB_RPT7_Domain_Test_Finished_Bridge;

--
-- End of file DomainB_RPT7_Domain_Test_Finished_Bridge.adb
--
