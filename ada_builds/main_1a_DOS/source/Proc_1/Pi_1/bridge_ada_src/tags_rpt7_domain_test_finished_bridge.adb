...
--*************************************************************************************
--*                                                                                   *
--* File Name:               TAGS_RPT7_Domain_Test_Finished_Bridge.adb
...
package body TAGS_RPT7_Domain_Test_Finished_Bridge is
   
   procedure TAGS_RPT7_Domain_Test_Finished (
   ...
   -- start of RPT7_Domain_Test_Finished
      ...
      My_Report := Root_Object.TAGS.RD.Unconditional_Find_One;
...
--
         ...
         local_domain_number := Root_Object.TAGS.RD.TAGS_RD_type(My_Report.all).Reported_Domain_Number;
...
--
   ...
   end TAGS_RPT7_Domain_Test_Finished;
   
end TAGS_RPT7_Domain_Test_Finished_Bridge;

--
-- End of file TAGS_RPT7_Domain_Test_Finished_Bridge.adb
--
