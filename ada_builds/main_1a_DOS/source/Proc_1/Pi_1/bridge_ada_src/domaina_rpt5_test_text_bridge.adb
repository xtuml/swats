...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainA_RPT5_Test_Text_Bridge.adb
...
package body DomainA_RPT5_Test_Text_Bridge is
   
   procedure DomainA_RPT5_Test_Text (
...
--
   ...
   end DomainA_RPT5_Test_Text;
   
end DomainA_RPT5_Test_Text_Bridge;

--
-- End of file DomainA_RPT5_Test_Text_Bridge.adb
--
