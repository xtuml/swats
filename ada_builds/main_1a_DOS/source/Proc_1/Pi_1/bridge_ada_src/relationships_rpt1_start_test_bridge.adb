...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Relationships_RPT1_Start_Test_Bridge.adb
...
package body Relationships_RPT1_Start_Test_Bridge is
   
   procedure Relationships_RPT1_Start_Test (
...
--
   ...
   end Relationships_RPT1_Start_Test;
   
end Relationships_RPT1_Start_Test_Bridge;

--
-- End of file Relationships_RPT1_Start_Test_Bridge.adb
--
