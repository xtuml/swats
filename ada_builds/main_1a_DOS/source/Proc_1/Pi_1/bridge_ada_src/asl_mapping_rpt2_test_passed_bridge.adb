...
--*************************************************************************************
--*                                                                                   *
--* File Name:               ASL_Mapping_RPT2_Test_Passed_Bridge.adb
...
package body ASL_Mapping_RPT2_Test_Passed_Bridge is
   
   procedure ASL_Mapping_RPT2_Test_Passed (
...
--
   ...
   end ASL_Mapping_RPT2_Test_Passed;
   
end ASL_Mapping_RPT2_Test_Passed_Bridge;

--
-- End of file ASL_Mapping_RPT2_Test_Passed_Bridge.adb
--
