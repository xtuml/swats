...
--*************************************************************************************
--*                                                                                   *
--* File Name:               SBONE_RPT6_Domain_Test_Start_Bridge.adb
...
package body SBONE_RPT6_Domain_Test_Start_Bridge is
   
   procedure SBONE_RPT6_Domain_Test_Start (
...
--
         ...
         Root_Object.SBONE.RD.SBONE_RD_type(My_Report.all).Reported_Domain_Number := New_Domain_Number;
         
      end if;
      
      
   end SBONE_RPT6_Domain_Test_Start;
   
end SBONE_RPT6_Domain_Test_Start_Bridge;

--
-- End of file SBONE_RPT6_Domain_Test_Start_Bridge.adb
--
