...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Relationships_RPT2_Test_Passed_Bridge.adb
...
package body Relationships_RPT2_Test_Passed_Bridge is
   
   procedure Relationships_RPT2_Test_Passed (
...
--
   ...
   end Relationships_RPT2_Test_Passed;
   
end Relationships_RPT2_Test_Passed_Bridge;

--
-- End of file Relationships_RPT2_Test_Passed_Bridge.adb
--
