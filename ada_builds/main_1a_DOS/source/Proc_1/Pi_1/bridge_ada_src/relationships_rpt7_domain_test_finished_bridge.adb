...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Relationships_RPT7_Domain_Test_Finished_Bridge.adb
...
package body Relationships_RPT7_Domain_Test_Finished_Bridge is
   
   procedure Relationships_RPT7_Domain_Test_Finished (
   ...
   -- start of RPT7_Domain_Test_Finished
      ...
      My_Report := Root_Object.Relationships.RD.Unconditional_Find_One;
...
--
         ...
         local_domain_number := Root_Object.Relationships.RD.Relationships_RD_type(My_Report.all).Reported_Domain_Number;
...
--
   ...
   end Relationships_RPT7_Domain_Test_Finished;
   
end Relationships_RPT7_Domain_Test_Finished_Bridge;

--
-- End of file Relationships_RPT7_Domain_Test_Finished_Bridge.adb
--
