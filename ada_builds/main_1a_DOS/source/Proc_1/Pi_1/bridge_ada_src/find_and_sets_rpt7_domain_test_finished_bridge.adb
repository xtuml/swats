...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Find_and_Sets_RPT7_Domain_Test_Finished_Bridge.adb
...
package body Find_and_Sets_RPT7_Domain_Test_Finished_Bridge is
   
   procedure Find_and_Sets_RPT7_Domain_Test_Finished (
...
--
         ...
         local_domain_number := Root_Object.Find_and_Sets.RD.Find_and_Sets_RD_type(My_Report.all).Reported_Domain_Number;
...
--
   ...
   end Find_and_Sets_RPT7_Domain_Test_Finished;
   
end Find_and_Sets_RPT7_Domain_Test_Finished_Bridge;

--
-- End of file Find_and_Sets_RPT7_Domain_Test_Finished_Bridge.adb
--
