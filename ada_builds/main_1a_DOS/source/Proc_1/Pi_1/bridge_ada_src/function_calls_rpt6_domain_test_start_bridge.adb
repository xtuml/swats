...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_RPT6_Domain_Test_Start_Bridge.adb
...
package body Function_Calls_RPT6_Domain_Test_Start_Bridge is
   
   procedure Function_Calls_RPT6_Domain_Test_Start (
...
--
         ...
         Root_Object.Function_Calls.RD.Function_Calls_RD_type(My_Report.all).Reported_Domain_Number := New_Domain_Number;
         
      end if;
      
      
   end Function_Calls_RPT6_Domain_Test_Start;
   
end Function_Calls_RPT6_Domain_Test_Start_Bridge;

--
-- End of file Function_Calls_RPT6_Domain_Test_Start_Bridge.adb
--
