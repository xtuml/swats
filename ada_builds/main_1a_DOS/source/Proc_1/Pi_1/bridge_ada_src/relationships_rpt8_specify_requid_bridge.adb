...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Relationships_RPT8_Specify_Requid_Bridge.adb
...
package body Relationships_RPT8_Specify_Requid_Bridge is
   
   procedure Relationships_RPT8_Specify_Requid (
...
--
   ...
   end Relationships_RPT8_Specify_Requid;
   
end Relationships_RPT8_Specify_Requid_Bridge;

--
-- End of file Relationships_RPT8_Specify_Requid_Bridge.adb
--
