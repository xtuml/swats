...
--*************************************************************************************
--*                                                                                   *
--* File Name:               SBONE_ITGWO2_Wide_Blue_Yonder_Bridge.ads
...
package SBONE_ITGWO2_Wide_Blue_Yonder_Bridge is
   
   
   procedure SBONE_ITGWO2_Wide_Blue_Yonder (
      Test                    : in     Application_Types.Base_Integer_Type;
      Simple_Source_Structure : in out SBONE_Domain_Types.Very_Simple_Structure_Type);
   
end SBONE_ITGWO2_Wide_Blue_Yonder_Bridge;

--
-- End of file SBONE_ITGWO2_Wide_Blue_Yonder_Bridge.ads
--
