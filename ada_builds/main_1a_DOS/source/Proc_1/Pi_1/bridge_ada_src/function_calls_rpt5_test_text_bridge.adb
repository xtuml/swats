...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_RPT5_Test_Text_Bridge.adb
...
package body Function_Calls_RPT5_Test_Text_Bridge is
   
   procedure Function_Calls_RPT5_Test_Text (
...
--
   ...
   end Function_Calls_RPT5_Test_Text;
   
end Function_Calls_RPT5_Test_Text_Bridge;

--
-- End of file Function_Calls_RPT5_Test_Text_Bridge.adb
--
