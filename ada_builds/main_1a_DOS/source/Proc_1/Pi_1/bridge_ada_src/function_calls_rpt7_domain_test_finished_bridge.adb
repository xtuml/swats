...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_RPT7_Domain_Test_Finished_Bridge.adb
...
package body Function_Calls_RPT7_Domain_Test_Finished_Bridge is
   
   procedure Function_Calls_RPT7_Domain_Test_Finished (
   ...
   -- start of RPT7_Domain_Test_Finished
      ...
      My_Report := Root_Object.Function_Calls.RD.Unconditional_Find_One;
...
--
         ...
         local_domain_number := Root_Object.Function_Calls.RD.Function_Calls_RD_type(My_Report.all).Reported_Domain_Number;
...
--
   ...
   end Function_Calls_RPT7_Domain_Test_Finished;
   
end Function_Calls_RPT7_Domain_Test_Finished_Bridge;

--
-- End of file Function_Calls_RPT7_Domain_Test_Finished_Bridge.adb
--
