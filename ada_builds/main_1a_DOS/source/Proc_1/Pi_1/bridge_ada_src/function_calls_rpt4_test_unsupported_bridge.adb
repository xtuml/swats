...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Function_Calls_RPT4_Test_Unsupported_Bridge.adb
...
package body Function_Calls_RPT4_Test_Unsupported_Bridge is
   
   procedure Function_Calls_RPT4_Test_Unsupported (
   ...
   -- start of RPT4_Test_Unsupported
      ...
      The_Reporter_Object := Root_Object.Function_Calls.RD.Unconditional_Find_One;
...
--
         ...
         Unique_Domain_ID := Root_Object.Function_Calls.RD.Function_Calls_RD_type(The_Reporter_Object.all).Reported_Domain_Number;
...
--
   ...
   end Function_Calls_RPT4_Test_Unsupported;
   
end Function_Calls_RPT4_Test_Unsupported_Bridge;

--
-- End of file Function_Calls_RPT4_Test_Unsupported_Bridge.adb
--
