...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.DomainB.DOMAIN_B_SUBA.adb
...
--* Description:             
--*                          Domain body Root_Object.DomainBDOMAIN_B_SUBA
...
------------------------------------------------------------------------
--
package body Root_Object.DomainB.DOMAIN_B_SUBA is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   procedure Put_idSUPER_B (
      This_Object : in Root_Object.Object_Access;
      idSUPER_B_Value : in Application_Types.Base_Integer_Type) is
   begin
      DomainB_DOMAIN_B_SUBA_Type (This_Object.all).idSUPER_B :=
         idSUPER_B_Value;
   end Put_idSUPER_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_SubA_Attribute (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return DomainB_DOMAIN_B_SUBA_Type (This_Object.all).SubA_Attribute;
   end Get_SubA_Attribute;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_SubA_Attribute (
      This_Object : in Root_Object.Object_Access;
      SubA_Attribute_Value : in Application_Types.Base_Integer_Type) is
   begin
      DomainB_DOMAIN_B_SUBA_Type (This_Object.all).SubA_Attribute :=
         SubA_Attribute_Value;
   end Put_SubA_Attribute;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return DomainB_DOMAIN_B_SUBA_Type (This_Object.all).A_Text;
   end Get_A_Text;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_A_Text (
      This_Object : in Root_Object.Object_Access;
      A_Text_Value : in Application_Types.Base_Text_Type) is
   begin
      DomainB_DOMAIN_B_SUBA_Type (This_Object.all).A_Text :=
         A_Text_Value;
   end Put_A_Text;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return DomainB_DOMAIN_B_SUBA_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainB_DOMAIN_B_SUBA_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return DomainB_DOMAIN_B_SUBA_Type (This_Object.all).R4_Super;
   end Get_R4_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainB_DOMAIN_B_SUBA_Type (This_Object.all).R4_Super :=
         R4_Super_Value;
   end Put_R4_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new DomainB_DOMAIN_B_SUBA_Type;
   
      else
         This_Object := Free_List.First_Entry;
         DomainB_DOMAIN_B_SUBA_Type(This_Object.all).idSUPER_B := Application_Types.Base_Integer_Type_First;
         DomainB_DOMAIN_B_SUBA_Type(This_Object.all).SubA_Attribute := Application_Types.Base_Integer_Type_First;
         DomainB_DOMAIN_B_SUBA_Type(This_Object.all).A_Text := Application_Types.Base_Text_Type_First;
         DomainB_DOMAIN_B_SUBA_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
end Root_Object.DomainB.DOMAIN_B_SUBA;
