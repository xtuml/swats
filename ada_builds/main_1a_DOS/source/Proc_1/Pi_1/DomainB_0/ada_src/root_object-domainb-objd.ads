...
--* Description:             
--*                          Domain specification Root_Object.DomainBobjD
...
--  ----------------------------------  
--  package Root_Object.DomainB.objD
...
package Root_Object.DomainB.objD is
--
------------------------------------------------------------------------
   --
   ...
   type DomainB_objD_Type is new DomainB_Type with record
      ...
      D_Number : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_D_Number (
      This_Object : in Root_Object.Object_Access;
      D_Number_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_D_Number);
   pragma inline (Put_D_Number);
