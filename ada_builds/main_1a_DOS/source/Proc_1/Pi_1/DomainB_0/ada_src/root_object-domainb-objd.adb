...
--* Description:             
--*                          Domain body Root_Object.DomainBobjD
...
------------------------------------------------------------------------
--
package body Root_Object.DomainB.objD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return DomainB_objD_Type (This_Object.all).idD;
   end Get_idD;
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainB_objD_Type (This_Object.all).idD :=
         idD_Value;
   end Put_idD;
...
--ADATEST IGNORE_ON
   function Get_D_Number (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return DomainB_objD_Type (This_Object.all).D_Number;
   end Get_D_Number;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_D_Number (
      This_Object : in Root_Object.Object_Access;
      D_Number_Value : in Application_Types.Base_Integer_Type) is
   begin
      DomainB_objD_Type (This_Object.all).D_Number :=
         D_Number_Value;
   end Put_D_Number;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new DomainB_objD_Type;
   
      else
         This_Object := Free_List.First_Entry;
         DomainB_objD_Type(This_Object.all).idD := Application_Types.Base_Integer_Type_First;
         DomainB_objD_Type(This_Object.all).D_Number := Application_Types.Base_Integer_Type_First;
