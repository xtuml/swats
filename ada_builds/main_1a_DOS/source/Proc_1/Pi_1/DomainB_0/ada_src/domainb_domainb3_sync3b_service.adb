...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainB3_Sync3B_Service.adb
...
package body DomainB_DomainB3_Sync3B_Service is
   
   procedure DomainB_DomainB3_Sync3B (
   ...
   -- start of DomainB3_Sync3B
      ...
      DomainB_RPT1_Start_Test_Bridge.DomainB_RPT1_Start_Test (
         ...
         Invoking_Object => "DSS 3                           ",
         Purpose         => "sync service sync3B called      ");
      
      
      if inputA =  3 and then
         inputB =  4 then
         ...
         while (an_instanceB /= null) and then (not (Root_Object.DomainB.objB.DomainB_objB_Type(an_instanceB.all).idB =  5) ) loop
            
            an_instanceB := an_instanceB.Next_Object;
         end loop;
         
         
         Root_Object.DomainB.objB.DomainB_objB_type(an_instanceB.all).ResultB := 50;
         outputA := 5;
         outputB := 6;
         
         DomainB_RPT2_Test_Passed_Bridge.DomainB_RPT2_Test_Passed (
            Test_Object_Domain => "DSS 3                           ",
            Test_Number        => local_test,
   ...
   end DomainB_DomainB3_Sync3B;
   
end DomainB_DomainB3_Sync3B_Service;

--
-- End of file DomainB_DomainB3_Sync3B_Service.adb
--
