...
--* Description:             
--*                          Domain specification Root_Object.DomainBTD
...
--  ----------------------------------  
--  package Root_Object.DomainB.TD
...
package Root_Object.DomainB.TD is
--
------------------------------------------------------------------------
   --
   ...
   type DomainB_TD_Type is new DomainB_Type with record
