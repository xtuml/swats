...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.DomainB.DOMAIN_B_SUBB.ads
...
--* Description:             
--*                          Domain specification Root_Object.DomainBDOMAIN_B_SUBB
...
--  ----------------------------------  
--  package Root_Object.DomainB.DOMAIN_B_SUBB
...
package Root_Object.DomainB.DOMAIN_B_SUBB is
--
------------------------------------------------------------------------
   --
   --**************  Object Domain_B_Object_SubB Information **************
   --
   -- Object DOMAIN_B_SUBB is PASSIVE
   --
   -- Object DOMAIN_B_SUBB participates in a super sub type relationship
   --
   --
   --
   -- Object DOMAIN_B_SUBB is a SUB type of DOMAIN_B_SUPER via Relationship R4
   --
   -- Object DOMAIN_B_SUBB does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object DOMAIN_B_SUBB has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "DOMAIN_B_SUBB";

   --
   -------------------------------------------------------------------------------------------------
   --

   type DomainB_DOMAIN_B_SUBB_Type is new DomainB_Type with record

      --
      -- Non initialised identifying referential
      idSUPER_B : Application_Types.Base_Integer_Type;

      --
      -- Initialised Non identifying non referential
      SubB_Attribute : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      B_Text : Application_Types.Base_Text_Type := Application_Types.Base_Text_Type_First;
   ...
   procedure Put_idSUPER_B (
      ...
      idSUPER_B_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_idSUPER_B);
   pragma inline (Put_idSUPER_B);
   ...
   procedure Put_SubB_Attribute (
      This_Object : in Root_Object.Object_Access;
      SubB_Attribute_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_SubB_Attribute);
   pragma inline (Put_SubB_Attribute);
   ...
   procedure Put_B_Text (
      This_Object : in Root_Object.Object_Access;
      B_Text_Value : in Application_Types.Base_Text_Type);

   pragma inline (Get_B_Text);
   pragma inline (Put_B_Text);
