...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.DomainB.DOMAIN_B_SUPER.event_action.ada
...
--*  separate of Root_Object.DomainBDOMAIN_B_SUPER
--*     Event_Action
--*
--*************************************************************************************
--  MODIFICATION RECORD
...
separate (Root_Object.DomainB.DOMAIN_B_SUPER)
...
begin
   ...
   This_Action := DomainB_DOMAIN_B_SUPER_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := DomainB_DOMAIN_B_SUPER_Instance_Event_Type(This_Event.all).Target_Instance;
   ...
   if This /= null then
      ...
      --  
      This_Event_Dispatch_Matrix (This_Action, DomainB_DOMAIN_B_SUPER_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
