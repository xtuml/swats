...
--* Description:             
--*                          Domain specification Root_Object.DomainBRD
...
--  ----------------------------------  
--  package Root_Object.DomainB.RD
...
package Root_Object.DomainB.RD is
--
------------------------------------------------------------------------
   --
   ...
   type DomainB_RD_Type is new DomainB_Type with record
