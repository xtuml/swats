...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.DomainB.DOMAIN_B_SUPER.ads
...
--* Description:             
--*                          Domain specification Root_Object.DomainBDOMAIN_B_SUPER
...
--  ----------------------------------  
--  package Root_Object.DomainB.DOMAIN_B_SUPER
...
package Root_Object.DomainB.DOMAIN_B_SUPER is
--
------------------------------------------------------------------------
   --
   --**************  Object Domain_B_Object_Super Information **************
   --
   -- Object DOMAIN_B_SUPER is PASSIVE
   --
   -- Object DOMAIN_B_SUPER participates in a super sub type relationship
   --
   --
   --
   -- Object DOMAIN_B_SUPER is a SUPER type of 
   --    DOMAIN_B_SUBA,
   --    DOMAIN_B_SUBB
   --    via Relationship R4
   --
   -- Object DOMAIN_B_SUPER has an identifying non-referential attribute idSUPER_B 
   -- and therefore may be uniquely created.
   -- 
   -- Object DOMAIN_B_SUPER has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "DOMAIN_B_SUPER";

   --
   -------------------------------------------------------------------------------------------------
   --

   type DomainB_DOMAIN_B_SUPER_Type is new DomainB_Type with record
   ...
   --
   type DomainB_DOMAIN_B_SUPER_Event_Type is new DomainB_Event_Type with
   record
   ...
   --    
   type DomainB_DOMAIN_B_SUPER_Instance_Event_Type is new DomainB_DOMAIN_B_SUPER_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type DomainB_DOMAIN_B_SUPER_Description_Event is new DomainB_DOMAIN_B_SUPER_Instance_Event_Type with
   record
      null;
   end record;
   --
