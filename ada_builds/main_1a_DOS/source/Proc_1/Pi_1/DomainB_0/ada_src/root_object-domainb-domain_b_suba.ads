...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.DomainB.DOMAIN_B_SUBA.ads
...
--* Description:             
--*                          Domain specification Root_Object.DomainBDOMAIN_B_SUBA
...
--  ----------------------------------  
--  package Root_Object.DomainB.DOMAIN_B_SUBA
...
package Root_Object.DomainB.DOMAIN_B_SUBA is
--
------------------------------------------------------------------------
   --
   --**************  Object Domain_B_Object_SubA Information **************
   --
   -- Object DOMAIN_B_SUBA is PASSIVE
   --
   -- Object DOMAIN_B_SUBA participates in a super sub type relationship
   --
   --
   --
   -- Object DOMAIN_B_SUBA is a SUB type of DOMAIN_B_SUPER via Relationship R4
   --
   -- Object DOMAIN_B_SUBA does not have an identifying non-referential attribute and 
   -- therefore may not be uniquely created.
   -- 
   -- Object DOMAIN_B_SUBA has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "DOMAIN_B_SUBA";

   --
   -------------------------------------------------------------------------------------------------
   --

   type DomainB_DOMAIN_B_SUBA_Type is new DomainB_Type with record
      ...
      SubA_Attribute : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      A_Text : Application_Types.Base_Text_Type := Application_Types.Base_Text_Type_First;
   ...
   procedure Put_SubA_Attribute (
      This_Object : in Root_Object.Object_Access;
      SubA_Attribute_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_SubA_Attribute);
   pragma inline (Put_SubA_Attribute);
   ...
   procedure Put_A_Text (
      This_Object : in Root_Object.Object_Access;
      A_Text_Value : in Application_Types.Base_Text_Type);

   pragma inline (Get_A_Text);
   pragma inline (Put_A_Text);
