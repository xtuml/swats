...
--* Description:             
--*                          Domain specification Root_Object.DomainBobjC
...
--  ----------------------------------  
--  package Root_Object.DomainB.objC
...
package Root_Object.DomainB.objC is
--
------------------------------------------------------------------------
   --
   ...
   type DomainB_objC_Type is new DomainB_Type with record
      ...
      a_number : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_a_number (
      This_Object : in Root_Object.Object_Access;
      a_number_Value : in Application_Types.Base_Integer_Type);
