...
--* Description:             
--*                          Domain body Root_Object.DomainBobjCD
...
------------------------------------------------------------------------
--
package body Root_Object.DomainB.objCD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return DomainB_objCD_Type (This_Object.all).idC;
   end Get_idC;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainB_objCD_Type (This_Object.all).idC :=
         idC_Value;
   end Put_idC;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_idD (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return DomainB_objCD_Type (This_Object.all).idD;
   end Get_idD;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainB_objCD_Type (This_Object.all).idD :=
         idD_Value;
   end Put_idD;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return DomainB_objCD_Type (This_Object.all).a_name;
   end Get_a_name;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_a_name (
      This_Object : in Root_Object.Object_Access;
      a_name_Value : in Application_Types.Base_Text_Type) is
   begin
      DomainB_objCD_Type (This_Object.all).a_name :=
         a_name_Value;
   end Put_a_name;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new DomainB_objCD_Type;
   
      else
         This_Object := Free_List.First_Entry;
         DomainB_objCD_Type(This_Object.all).idC := Application_Types.Base_Integer_Type_First;
         DomainB_objCD_Type(This_Object.all).idD := Application_Types.Base_Integer_Type_First;
         DomainB_objCD_Type(This_Object.all).a_name := Application_Types.Base_Text_Type_First;
