...
--* Description:             
--*                          Domain body Root_Object.DomainBobjC
...
------------------------------------------------------------------------
--
package body Root_Object.DomainB.objC is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return DomainB_objC_Type (This_Object.all).idC;
   end Get_idC;
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainB_objC_Type (This_Object.all).idC :=
         idC_Value;
   end Put_idC;
...
--ADATEST IGNORE_ON
   function Get_a_number (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return DomainB_objC_Type (This_Object.all).a_number;
   end Get_a_number;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_a_number (
      This_Object : in Root_Object.Object_Access;
      a_number_Value : in Application_Types.Base_Integer_Type) is
   begin
      DomainB_objC_Type (This_Object.all).a_number :=
         a_number_Value;
   end Put_a_number;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new DomainB_objC_Type;
   
      else
         This_Object := Free_List.First_Entry;
         DomainB_objC_Type(This_Object.all).idC := Application_Types.Base_Integer_Type_First;
         DomainB_objC_Type(This_Object.all).a_number := Application_Types.Base_Integer_Type_First;
