...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.DomainB.objB.event_action.ada
...
--*  separate of Root_Object.DomainBobjB
--*     Event_Action
--*
--*************************************************************************************
--  MODIFICATION RECORD
...
begin
   ...
   This_Action := DomainB_objB_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := DomainB_objB_Instance_Event_Type(This_Event.all).Target_Instance;


   -- Ensure that the source instance still exists. 
   if This /= null then
      This_Event_Dispatch_Matrix (This_Action, DomainB_objB_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
