...
--
--    db      07/05/02        SRLE100001027     Conditionally generated 'with' for DomainB domain types package.
--
...
package Root_Object.DomainB is
-------------------------------------------------------------------------------------------------
  type DomainB_Type is new Root_Object.Object_Type with
    record
      null;
    end record;
-------------------------------------------------------------------------------------------------
  type DomainB_Event_Type is new Root_Object.Root_Event_Type with
    record
      null;
    end record;
-------------------------------------------------------------------------------------------------
