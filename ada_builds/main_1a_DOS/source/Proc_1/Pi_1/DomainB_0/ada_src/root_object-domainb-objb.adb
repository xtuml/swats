...
--* Description:             
--*                          Domain body Root_Object.DomainBobjB
...
------------------------------------------------------------------------
--
package body Root_Object.DomainB.objB is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idB_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idB return Application_Types.Base_Integer_Type is
   begin
      idB_Value :=
         Application_Types.Base_Integer_Type'succ (idB_Value);
      return idB_Value;
   end Obtain_Subsequent_idB;
...
--ADATEST IGNORE_ON
   ...
   begin
       return DomainB_objB_Type (This_Object.all).idB;
   end Get_idB;
...
--ADATEST IGNORE_ON
   procedure Put_idB (
      ...
      idB_Value : in Application_Types.Base_Integer_Type) is
   begin
      DomainB_objB_Type (This_Object.all).idB :=
         idB_Value;
   end Put_idB;
...
--ADATEST IGNORE_ON
   function Get_ResultB (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return DomainB_objB_Type (This_Object.all).ResultB;
   end Get_ResultB;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_ResultB (
      This_Object : in Root_Object.Object_Access;
      ResultB_Value : in Application_Types.Base_Integer_Type) is
   begin
      DomainB_objB_Type (This_Object.all).ResultB :=
         ResultB_Value;
   end Put_ResultB;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return DomainB_objB_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainB_objB_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new DomainB_objB_Type;
   
      else
         This_Object := Free_List.First_Entry;
         DomainB_objB_Type(This_Object.all).idB := Application_Types.Base_Integer_Type_First;
         DomainB_objB_Type(This_Object.all).ResultB := Application_Types.Base_Integer_Type_First;
         DomainB_objB_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--
   ...
   procedure DomainB_objB_2 (
      paramA : in Application_Types.Base_Integer_Type;
   ...
   procedure DomainB_objB_3 (
      This_Instance : in out Root_Object.Object_Access ) is separate;

   procedure DomainB_objB_1 (
      This_Instance : in out Root_Object.Object_Access ) is separate;


--
   procedure objB1_To_Sync_service_DomainA_to_an_event_DomainB (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      DomainB_objB_Type (This_Instance.all).Current_State := 
         Root_Object.DomainB.objB.Object_State_Type(Sync_service_DomainA_to_an_event_DomainB);

      DomainB_objB_2 (
         paramA =>  DomainB_objB1(This_Event.all).paramA,
         paramB =>  DomainB_objB1(This_Event.all).paramB,
         Test =>  DomainB_objB1(This_Event.all).Test,
         This_Instance => This_Instance );

   end objB1_To_Sync_service_DomainA_to_an_event_DomainB;
--
   procedure objB2_To_Fail (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is
   ...
   begin
      ...
      DomainB_objB_Type (This_Instance.all).Current_State := 
         Root_Object.DomainB.objB.Object_State_Type(Fail);
...
--
   ...
   begin
      ...
      DomainB_objB_Type (This_Instance.all).Current_State := 
         Root_Object.DomainB.objB.Object_State_Type(Idle);
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     DomainB_objB_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     DomainB_objB_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      DomainB_objB_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => DomainB_objB_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return DomainB_objB_Event_Queue.Queue_Length (DomainB_objB_Queue);
...
--
   ...
   This_Event_Dispatch_Matrix (objB3, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objB1, Idle) := objB1_To_Sync_service_DomainA_to_an_event_DomainB'access;
   ...
   This_Event_Dispatch_Matrix (objB1, Sync_service_DomainA_to_an_event_DomainB) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (objB2, Sync_service_DomainA_to_an_event_DomainB) := objB2_To_Fail'access;
   This_Event_Dispatch_Matrix (objB3, Sync_service_DomainA_to_an_event_DomainB) := objB3_To_Idle'access;
   This_Event_Dispatch_Matrix (objB1, Fail) :=  Cannot_Happen_Action'access;
