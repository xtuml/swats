...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.DomainB.DOMAIN_B_SUPER.adb
...
--* Description:             
--*                          Domain body Root_Object.DomainBDOMAIN_B_SUPER
...
------------------------------------------------------------------------
--
package body Root_Object.DomainB.DOMAIN_B_SUPER is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   idSUPER_B_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_idSUPER_B return Application_Types.Base_Integer_Type is
   begin
      idSUPER_B_Value :=
         Application_Types.Base_Integer_Type'succ (idSUPER_B_Value);
      return idSUPER_B_Value;
   end Obtain_Subsequent_idSUPER_B;
...
--ADATEST IGNORE_ON
   ...
   begin
       return DomainB_DOMAIN_B_SUPER_Type (This_Object.all).idSUPER_B;
   end Get_idSUPER_B;
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainB_DOMAIN_B_SUPER_Type (This_Object.all).idSUPER_B :=
         idSUPER_B_Value;
   end Put_idSUPER_B;
...
--ADATEST IGNORE_ON
   ...
   begin
      return DomainB_DOMAIN_B_SUPER_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainB_DOMAIN_B_SUPER_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return DomainB_DOMAIN_B_SUPER_Type (This_Object.all).R4_Sub;
   end Get_R4_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      DomainB_DOMAIN_B_SUPER_Type (This_Object.all).R4_Sub :=
         R4_Sub_Value;
   end Put_R4_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new DomainB_DOMAIN_B_SUPER_Type;
   
      else
         This_Object := Free_List.First_Entry;
         DomainB_DOMAIN_B_SUPER_Type(This_Object.all).idSUPER_B := Application_Types.Base_Integer_Type_First;
         DomainB_DOMAIN_B_SUPER_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     DomainB_DOMAIN_B_SUPER_Event_Type;
...
------------------------------------------------------------------------
   procedure Event_Action (
      Dispatch_Event : in     DomainB_DOMAIN_B_SUPER_Instance_Event_Type;
      This_Event     : in out Root_Object.Root_Event_Access_Type) is separate;


end Root_Object.DomainB.DOMAIN_B_SUPER;
