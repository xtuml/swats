...
--*************************************************************************************
--*                                                                                   *
--* File Name:               DomainB8_Service_Params_Service.ads
...
package DomainB_DomainB8_Service_Params_Service is
   ...
   procedure DomainB_DomainB8_Service_Params (
      ...
      The_Return_Val :    out Application_Types.Base_Integer_Type);
   
end DomainB_DomainB8_Service_Params_Service;

--
-- End of file DomainB_DomainB8_Service_Params_Service.ads
--
