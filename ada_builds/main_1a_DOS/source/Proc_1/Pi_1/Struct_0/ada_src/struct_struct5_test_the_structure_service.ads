...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Struct5_Test_The_Structure_Service.ads
...
package Struct_Struct5_Test_The_Structure_Service is
   ...
   procedure Struct_Struct5_Test_The_Structure (
      ...
      The_Return_Structure :    out Struct_Domain_Types.My_Simple_Structure);
   
end Struct_Struct5_Test_The_Structure_Service;

--
-- End of file Struct_Struct5_Test_The_Structure_Service.ads
--
