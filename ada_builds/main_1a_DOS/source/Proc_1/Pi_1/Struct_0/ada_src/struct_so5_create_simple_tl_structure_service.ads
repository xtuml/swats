...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Struct_SO5_Create_Simple_TL_Structure_Service.ads
...
package Struct_SO5_Create_Simple_TL_Structure_Service is
   ...
   procedure Struct_SO5_Create_Simple_TL_Structure (
      ...
      Returned_Simple_Structure :    out Struct_Domain_Types.Type_Linked_Simple_Structure_Type);
   
end Struct_SO5_Create_Simple_TL_Structure_Service;

--
-- End of file Struct_SO5_Create_Simple_TL_Structure_Service.ads
--
