...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Struct_SO1_Create_Simple_Structure_Service.adb
...
package body Struct_SO1_Create_Simple_Structure_Service is
   
   procedure Struct_SO1_Create_Simple_Structure (
      Test                      : in     Application_Types.Base_Integer_Type;
      Object_Instance_Handle    : in     Root_Object.Object_Access;
      Returned_Simple_Structure :    out Struct_Domain_Types.Simple_Structure_Type) is
   ...
   begin
   -- start of SO1_Create_Simple_Structure
      ...
      Struct_RPT1_Start_Test_Bridge.Struct_RPT1_Start_Test (
         ...
         Purpose         => "Construct simple structure      ");
      ...
      loop
         ...
         Struct_Domain_Types.Ops.Append (
            A_S_Integer    => Root_Object.Struct.SO.Struct_SO_type(Object_Instance_Handle.all).An_Integer,
            A_S_Real       => Root_Object.Struct.SO.Struct_SO_type(Object_Instance_Handle.all).A_Real,
            A_S_Text       => Root_Object.Struct.SO.Struct_SO_type(Object_Instance_Handle.all).Some_Text,
            A_S_Boolean    => Root_Object.Struct.SO.Struct_SO_type(Object_Instance_Handle.all).A_Boolean,
            A_S_Colour     => Root_Object.Struct.SO.Struct_SO_type(Object_Instance_Handle.all).A_Colour, 
   ...
   end Struct_SO1_Create_Simple_Structure;
   
end Struct_SO1_Create_Simple_Structure_Service;

--
-- End of file Struct_SO1_Create_Simple_Structure_Service.adb
--
