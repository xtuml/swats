...
--* Description:             
--*                          Domain specification Root_Object.StructRD
...
package Root_Object.Struct.RD is
--
------------------------------------------------------------------------
   --
   ...
   type Struct_RD_Type is new Struct_Type with record
