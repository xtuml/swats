...
--* Description:             
--*                          Domain specification Root_Object.StructTD
...
package Root_Object.Struct.TD is
--
------------------------------------------------------------------------
   --
   ...
   type Struct_TD_Type is new Struct_Type with record
