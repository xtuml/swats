...
--* Description:             
--*                          Domain body Root_Object.StructTD
...
------------------------------------------------------------------------
--
package body Root_Object.Struct.TD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return Struct_TD_Type (This_Object.all).td_id;
   end Get_td_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      Struct_TD_Type (This_Object.all).td_id :=
         td_id_Value;
   end Put_td_id;
...
--ADATEST IGNORE_ON
   function Get_The_Test_Number (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return Struct_TD_Type (This_Object.all).The_Test_Number;
...
--ADATEST IGNORE_ON
   ...
   begin
      Struct_TD_Type (This_Object.all).The_Test_Number :=
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new Struct_TD_Type;
   
      else
         This_Object := Free_List.First_Entry;
         Struct_TD_Type(This_Object.all).td_id := Application_Types.Base_Integer_Type_First;
         Struct_TD_Type(This_Object.all).The_Test_Number := Application_Types.Base_Integer_Type_First;
