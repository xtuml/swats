...
--*************************************************************************************
--*                                                                                   *
--* File Name:               SBTWO_domain_types.ads
...
--* Description:             
--*                          SBTWO Domain Data Types Package Specification
...
--*  package specification SBTWO_Domain_Types 
--*
--*************************************************************************************
--  MODIFICATION RECORD
--  --------------------
...
package SBTWO_Domain_Types is
   pragma Elaborate_Body (SBTWO_Domain_Types);
...
--
   ...
   type Source_Structure_Type_Node is record
      ...
      Source_Colour : SBTWO_Domain_Types.Colour_Type := SBTWO_Domain_Types.Colour_Type_First;
