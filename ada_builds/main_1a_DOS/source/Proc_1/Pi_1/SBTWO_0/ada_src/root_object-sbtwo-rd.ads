...
--* Description:             
--*                          Domain specification Root_Object.SBTWORD
...
package Root_Object.SBTWO.RD is
--
------------------------------------------------------------------------
   --
   ...
   type SBTWO_RD_Type is new SBTWO_Type with record
