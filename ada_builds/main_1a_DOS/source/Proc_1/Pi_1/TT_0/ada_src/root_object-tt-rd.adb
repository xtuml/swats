...
------------------------------------------------------------------------
--
package body Root_Object.TT.RD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return TT_RD_Type (This_Object.all).id;
   end Get_id;
...
--ADATEST IGNORE_ON
   function Get_Reported_Domain_Number (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TT_RD_Type (This_Object.all).Reported_Domain_Number;
...
--ADATEST IGNORE_ON
   ...
   begin
      TT_RD_Type (This_Object.all).Reported_Domain_Number :=
...
--ADATEST IGNORE_ON
   ...
   begin
      return TT_RD_Type (This_Object.all).R3_A;
   end Get_R3_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TT_RD_Type (This_Object.all).R3_A :=
         R3_A_Value;
   end Put_R3_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new TT_RD_Type;
   
      else
         This_Object := Free_List.First_Entry;
         TT_RD_Type(This_Object.all).id := Application_Types.Base_Integer_Type_First;
         TT_RD_Type(This_Object.all).Reported_Domain_Number := Application_Types.Base_Integer_Type_First;
