...
------------------------------------------------------------------------
--
package body Root_Object.TT.T is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return TT_T_Type (This_Object.all).id;
   end Get_id;
...
------------------------------------------------------------------------
   --
   -- procedure Put_next_test_id and 
   --
   -- function Get_next_test_id
   --
   -- have not been generated for next_test_id
...
--ADATEST IGNORE_ON
   ...
   begin
      return TT_T_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      TT_T_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return TT_T_Type (This_Object.all).R1_A;
   end Get_R1_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TT_T_Type (This_Object.all).R1_A :=
         R1_A_Value;
   end Put_R1_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R2_Sub (
      This_Object: Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return TT_T_Type (This_Object.all).R2_Sub;
   end Get_R2_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TT_T_Type (This_Object.all).R2_Sub :=
         R2_Sub_Value;
   end Put_R2_Sub;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function  Get_R4_A (
      This_Object : Root_Object.Object_Access) return Root_Object.Object_Access is
   begin
      return TT_T_Type (This_Object.all).R4_A;
   end Get_R4_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TT_T_Type (This_Object.all).R4_A :=
         R4_A_Value;
   end Put_R4_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return TT_T_Type (This_Object.all).R4_B;
   end Get_R4_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TT_T_Type (This_Object.all).R4_B :=
         R4_B_Value;
   end Put_R4_B;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new TT_T_Type;
   
      else
         This_Object := Free_List.First_Entry;
         TT_T_Type(This_Object.all).id := Application_Types.Base_Integer_Type_First;
         TT_T_Type(This_Object.all).Current_State :=  Object_State_Type_First;
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     TT_T_Event_Type;
