...
package body TT_Domain_Types is

   procedure Initialize (Object: in out integer_array) is

   begin
   
      Object.Iterator    := new integer_array_Node_Access;
   ...
   procedure Adjust (Object: in out integer_array) is
    
      Next:        integer_array_Node_Access := null;
      Header_Cell: integer_array_Node_Access := null;
      Last_Cell:   integer_array_Node_Access := null;
      New_Cell:    integer_array_Node_Access := null;
   ...
   begin
      ...
      if Object.First_Entry /= null then
         ...
         Header_Cell := new integer_array_Node;
         Last_Cell   := Header_Cell;
      
         Header_Cell.array_element := Next.array_element;
    
         Next := Next.Next_Structure;

         while Next /= null loop

            New_Cell := new integer_array_Node'(
               array_element => Next.array_element,
               Next_Structure     => null,
   ...
   procedure Finalize (Object: in out integer_array) is

      Next:     integer_array_Node_Access := null;
      Old_Cell: integer_array_Node_Access := null;
      ...
      procedure Free is new Ada.Unchecked_Deallocation (
         Object => integer_array_Node_Access, 
         Name   => integer_array_Node_Access_Pointer);
