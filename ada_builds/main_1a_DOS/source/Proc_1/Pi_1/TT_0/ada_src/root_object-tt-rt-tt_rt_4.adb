...
separate(Root_Object.TT.RT)
   ...
   procedure TT_RT_4 (This_Instance : in out Root_Object.Object_Access) is
   ...
   begin
      ...
      TT_RPT2_Test_Passed_Bridge.TT_RPT2_Test_Passed (
         Test_Object_Domain => "Reset_Timer                     ",
      ...
      begin
         Pushed_Event := new
         Root_Object.TT.RT.TT_RT4'(Root_Object.Root_Event_Type with
            This_Event_Class => Root_Object.TT.RT.RT4,
