...
separate(Root_Object.TT.RT)
   ...
   procedure TT_RT_5 (This_Instance : in out Root_Object.Object_Access) is
   ...
   begin
      ...
      begin
         Pushed_Event := new
         Root_Object.TT.RT.TT_RT5'(Root_Object.Root_Event_Type with
            This_Event_Class => Root_Object.TT.RT.RT5,
