...
------------------------------------------------------------------------
--
package body Root_Object.TT.U is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return TT_U_Type (This_Object.all).id;
   end Get_id;
...
--ADATEST IGNORE_ON
   function Get_test_id (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return TT_U_Type (This_Object.all).test_id;
   end Get_test_id;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TT_U_Type (This_Object.all).test_id :=
         test_id_Value;
   end Put_test_id;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return TT_U_Type (This_Object.all).Current_State;
...
--ADATEST IGNORE_ON
   ...
   begin
      TT_U_Type (This_Object.all).Current_State :=
         Current_State_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return TT_U_Type (This_Object.all).R2_Super;
   end Get_R2_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      TT_U_Type (This_Object.all).R2_Super :=
         R2_Super_Value;
   end Put_R2_Super;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new TT_U_Type;
   
      else
         This_Object := Free_List.First_Entry;
         TT_U_Type(This_Object.all).id := Application_Types.Base_Integer_Type_First;
         TT_U_Type(This_Object.all).test_id := Application_Types.Base_Integer_Type_First;
         TT_U_Type(This_Object.all).Current_State :=  Object_State_Type_First;
   ...
   begin
      ...
      case Parent_Event_Type is
         ...
         when Root_Object.TT.T.T1 =>
            ...
            Next_Event := new Root_Object.TT.U.TT_T1'(
            Root_Event_Type with
               This_Event_Class => Root_Object.TT.U.T1,
               Target_Instance  => This_Object'Unchecked_Access);

         when Root_Object.TT.T.T2 =>

            Next_Event := new Root_Object.TT.U.TT_T2'(
            Root_Event_Type with
               This_Event_Class => Root_Object.TT.U.T2,
               Target_Instance  => This_Object'Unchecked_Access);
...
--
   procedure T1_To_log_test_results (
      This_Instance : in out Root_Object.Object_Access;
      This_Event    : in     Root_Object.Root_Event_Access_Type) is

   begin

      TT_U_Type (This_Instance.all).Current_State := 
         Root_Object.TT.U.Object_State_Type(log_test_results);

      TT_U_3 (
         This_Instance => This_Instance );

   end T1_To_log_test_results;
--
   ...
   begin
      ...
      TT_U_Type (This_Instance.all).Current_State := 
         Root_Object.TT.U.Object_State_Type(deletion);
...
--
   ...
   begin
      ...
      TT_U_Type (This_Instance.all).Current_State := 
         Root_Object.TT.U.Object_State_Type(complete);
...
--ADATEST IGNORE_ON
   procedure Event_Action (
      Dispatch_Event : in     TT_U_Event_Type;
...
--
   procedure Event_Action (
      Dispatch_Event : in     TT_U_Instance_Event_Type;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      TT_U_Event_Queue.Push (
         Item        => Event,
         Target_FIFO => TT_U_Queue,
         Top         => To_Top);
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      return TT_U_Event_Queue.Queue_Length (TT_U_Queue);
...
--
   ...
   This_Event_Dispatch_Matrix (U1, Non_Existent) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (T1, idle) := T1_To_log_test_results'access;
   This_Event_Dispatch_Matrix (T2, idle) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (U1, idle) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (T1, complete) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (T2, complete) := T2_To_deletion'access;
   This_Event_Dispatch_Matrix (U1, complete) :=  Cannot_Happen_Action'access;
   This_Event_Dispatch_Matrix (T1, log_test_results) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (T2, log_test_results) :=  Ignore_Action'access;
   This_Event_Dispatch_Matrix (U1, log_test_results) := U1_To_complete'access;

end Root_Object.TT.U;
