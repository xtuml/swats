...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.TT.T.event_action.ada
...
begin
   ...
   This_Action := TT_T_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := TT_T_Instance_Event_Type(This_Event.all).Target_Instance;
   ...
   if This /= null then
      ...
      --  
      This_Event_Dispatch_Matrix (This_Action, TT_T_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
