...
separate(Root_Object.TT.DT)
   ...
   procedure TT_DT_4 (This_Instance : in out Root_Object.Object_Access) is
   ...
   begin
      ...
      begin
         Pushed_Event := new
         Root_Object.TT.DT.TT_DT3'(Root_Object.Root_Event_Type with
            This_Event_Class => Root_Object.TT.DT.DT3,
