...
separate(Root_Object.TT.RT)
   ...
   begin
      ...
      Root_Object.TT.RT.TT_RT_type(This_Instance.all).timer_id_one := timer_identifier_one;
      Root_Object.TT.RT.TT_RT_type(This_Instance.all).timer_id_two := timer_identifier_two;
