...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.TT.DT.event_action.ada
...
begin
   ...
   This_Action := TT_DT_Instance_Event_Type(This_Event.all).This_Event_Class;
   This := TT_DT_Instance_Event_Type(This_Event.all).Target_Instance;


   -- Ensure that the source instance still exists. 
   if This /= null then
      This_Event_Dispatch_Matrix (This_Action, TT_DT_Type(This.all).Current_State) (This, This_Event);
      --
   end if;
