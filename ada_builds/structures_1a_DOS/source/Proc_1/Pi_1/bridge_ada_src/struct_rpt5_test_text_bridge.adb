...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Struct_RPT5_Test_Text_Bridge.adb
...
package body Struct_RPT5_Test_Text_Bridge is
   
   procedure Struct_RPT5_Test_Text (
...
--
   ...
   end Struct_RPT5_Test_Text;
   
end Struct_RPT5_Test_Text_Bridge;

--
-- End of file Struct_RPT5_Test_Text_Bridge.adb
--
