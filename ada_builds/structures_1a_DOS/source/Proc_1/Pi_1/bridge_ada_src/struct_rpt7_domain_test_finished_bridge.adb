...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Struct_RPT7_Domain_Test_Finished_Bridge.adb
...
--*  -----------------                                                                *
--*                                                                                   *
--*  Project Key Letter : Struct_BSet
--*  Project Version    : 0
--*  Build Set          : 0
--*                                                                                   *
--*  Build Target       : Dos
...
package body Struct_RPT7_Domain_Test_Finished_Bridge is
   
   procedure Struct_RPT7_Domain_Test_Finished (
   ...
   -- start of RPT7_Domain_Test_Finished
      ...
      My_Report := Root_Object.Struct.RD.Unconditional_Find_One;
...
--
         ...
         local_domain_number := Root_Object.Struct.RD.Struct_RD_type(My_Report.all).Reported_Domain_Number;
...
--
   ...
   end Struct_RPT7_Domain_Test_Finished;
   
end Struct_RPT7_Domain_Test_Finished_Bridge;

--
-- End of file Struct_RPT7_Domain_Test_Finished_Bridge.adb
--
