...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Struct_RPT8_Specify_Requid_Bridge.adb
...
package body Struct_RPT8_Specify_Requid_Bridge is
   
   procedure Struct_RPT8_Specify_Requid (
...
--
   ...
   end Struct_RPT8_Specify_Requid;
   
end Struct_RPT8_Specify_Requid_Bridge;

--
-- End of file Struct_RPT8_Specify_Requid_Bridge.adb
--
