...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Struct_RPT2_Test_Passed_Bridge.adb
...
package body Struct_RPT2_Test_Passed_Bridge is
   
   procedure Struct_RPT2_Test_Passed (
...
--
   ...
   end Struct_RPT2_Test_Passed;
   
end Struct_RPT2_Test_Passed_Bridge;

--
-- End of file Struct_RPT2_Test_Passed_Bridge.adb
--
