...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Struct_RPT1_Start_Test_Bridge.adb
...
package body Struct_RPT1_Start_Test_Bridge is
   
   procedure Struct_RPT1_Start_Test (
...
--
   ...
   end Struct_RPT1_Start_Test;
   
end Struct_RPT1_Start_Test_Bridge;

--
-- End of file Struct_RPT1_Start_Test_Bridge.adb
--
