...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Struct_RPT4_Test_Unsupported_Bridge.adb
...
package body Struct_RPT4_Test_Unsupported_Bridge is
   
   procedure Struct_RPT4_Test_Unsupported (
   ...
   -- start of RPT4_Test_Unsupported
      ...
      The_Reporter_Object := Root_Object.Struct.RD.Unconditional_Find_One;
...
--
         ...
         Unique_Domain_ID := Root_Object.Struct.RD.Struct_RD_type(The_Reporter_Object.all).Reported_Domain_Number;
...
--
   ...
   end Struct_RPT4_Test_Unsupported;
   
end Struct_RPT4_Test_Unsupported_Bridge;

--
-- End of file Struct_RPT4_Test_Unsupported_Bridge.adb
--
