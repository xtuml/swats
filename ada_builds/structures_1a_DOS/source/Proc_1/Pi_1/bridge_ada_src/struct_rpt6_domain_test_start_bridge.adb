...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Struct_RPT6_Domain_Test_Start_Bridge.adb
...
package body Struct_RPT6_Domain_Test_Start_Bridge is
   
   procedure Struct_RPT6_Domain_Test_Start (
...
--
         ...
         Root_Object.Struct.RD.Struct_RD_type(My_Report.all).Reported_Domain_Number := New_Domain_Number;
         
      end if;
      
      
   end Struct_RPT6_Domain_Test_Start;
   
end Struct_RPT6_Domain_Test_Start_Bridge;

--
-- End of file Struct_RPT6_Domain_Test_Start_Bridge.adb
--
