...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Struct_RPT3_Test_Failed_Bridge.adb
...
package body Struct_RPT3_Test_Failed_Bridge is
   
   procedure Struct_RPT3_Test_Failed (
...
--
   ...
   end Struct_RPT3_Test_Failed;
   
end Struct_RPT3_Test_Failed_Bridge;

--
-- End of file Struct_RPT3_Test_Failed_Bridge.adb
--
