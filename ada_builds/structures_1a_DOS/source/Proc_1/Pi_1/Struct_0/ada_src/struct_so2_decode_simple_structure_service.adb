...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Struct_SO2_Decode_Simple_Structure_Service.adb
...
package body Struct_SO2_Decode_Simple_Structure_Service is
   
   procedure Struct_SO2_Decode_Simple_Structure (
      Test             : in     Application_Types.Base_Integer_Type;
      A_Structure      : in out Struct_Domain_Types.Simple_Structure_Type;
   ...
   begin
   -- start of SO2_Decode_Simple_Structure
      ...
      Struct_RPT1_Start_Test_Bridge.Struct_RPT1_Start_Test (
         ...
         Purpose         => "Decode simple data structures   ");
            ...
            for i in 1 .. Struct_Domain_Types.Ops.Count_Of (In_Structure => A_Structure) loop
               ...
               if Count =  Termination_Condition then
                  ...
                  if local_integer =  Root_Object.Struct.SO.Struct_SO_type(Instance_Handle.all).An_Integer and then
                     ...
                     local_boolean =  Root_Object.Struct.SO.Struct_SO_type(Instance_Handle.all).A_Boolean and then
                     local_colour  =  Root_Object.Struct.SO.Struct_SO_type(Instance_Handle.all).A_Colour then
   ...
   end Struct_SO2_Decode_Simple_Structure;
   
end Struct_SO2_Decode_Simple_Structure_Service;

--
-- End of file Struct_SO2_Decode_Simple_Structure_Service.adb
--
