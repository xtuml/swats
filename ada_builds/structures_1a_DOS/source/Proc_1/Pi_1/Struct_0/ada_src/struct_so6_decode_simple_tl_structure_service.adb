...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Struct_SO6_Decode_Simple_TL_Structure_Service.adb
...
package body Struct_SO6_Decode_Simple_TL_Structure_Service is
   
   procedure Struct_SO6_Decode_Simple_TL_Structure (
      Test             : in     Application_Types.Base_Integer_Type;
      A_Structure      : in out Struct_Domain_Types.Type_Linked_Simple_Structure_Type;
   ...
   begin
   -- start of SO6_Decode_Simple_TL_Structure
      ...
      Struct_RPT1_Start_Test_Bridge.Struct_RPT1_Start_Test (
         ...
         Purpose         => "Decode simple TL data structures");
   ...
   end Struct_SO6_Decode_Simple_TL_Structure;
   
end Struct_SO6_Decode_Simple_TL_Structure_Service;

--
-- End of file Struct_SO6_Decode_Simple_TL_Structure_Service.adb
--
