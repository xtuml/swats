...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Struct_Scenario4.ada
...
with Struct_Struct6_Decode_Simple_NTL_Structure_Service;
with Struct_SO8_Decode_Simple_NTL_Structure_Service;
with Struct_SO7_Create_Simple_NTL_Structure_Service;
...
use type Root_Object.Object_Access;
   ...
   procedure Struct_Scenario4 is
      ...
      NTL_Empty_Set                   : Struct_Domain_Types.Name_and_Type_Linked_Simple_Structure_Type;
      NTL_Returned_Simple_Structure_1 : Struct_Domain_Types.Name_and_Type_Linked_Simple_Structure_Type;
      NTL_Returned_Simple_Structure_2 : Struct_Domain_Types.Name_and_Type_Linked_Simple_Structure_Type;
      NTL_Simple_Object_Structure_3   : Struct_Domain_Types.Name_and_Type_Linked_Simple_Structure_Type;
      NTL_Simple_Object_Structure_4   : Struct_Domain_Types.Name_and_Type_Linked_Simple_Structure_Type;
      NTL_Simple_Object_Structure_5   : Struct_Domain_Types.Name_and_Type_Linked_Simple_Structure_Type;
   ...
   begin
      ...
      Struct_RPT1_Start_Test_Bridge.Struct_RPT1_Start_Test (
         ...
         Purpose         => "Create empty NTL structure      ");
      
      -- {NTL_Empty_Set} is Name_and_Type_Linked_Simple_Structure_Type
      Struct_Domain_Types.Ops.Initialise (NTL_Empty_Set);
      
      
      Naught :=  Struct_Domain_Types.Ops.Count_Of(NTL_Empty_Set);
      ...
      Struct_RPT1_Start_Test_Bridge.Struct_RPT1_Start_Test (
         ...
         Invoking_Domain => "Structures                      ",
         Invoking_Object => "Scenario                        ",
         Purpose         => "Add first NTL structure to set  ");
      ...
      Struct_Domain_Types.Ops.Append (
         A_An_Integer   => A_First_Local_Number,
         A_A_Real       => A_First_Local_Real,
         A_Some_Text    => A_First_Local_String,
         A_A_Boolean    => A_First_Local_Boolean, 
         To_Structure   => NTL_Empty_Set);
      -- end of append members to structure
      --
      
      
      One :=  Struct_Domain_Types.Ops.Count_Of(NTL_Empty_Set);
      ...
      Struct_RPT1_Start_Test_Bridge.Struct_RPT1_Start_Test (
         ...
         Invoking_Domain => "Structures                      ",
         Invoking_Object => "Scenario                        ",
         Purpose         => "Add second NTL structure to set ");
      ...
      -- start of append members to structure
      Struct_Domain_Types.Ops.Append (
         A_An_Integer   => A_Second_Local_Number,
         A_A_Real       => A_Second_Local_Real,
         A_Some_Text    => A_Second_Local_String,
         A_A_Boolean    => A_Second_Local_Boolean, 
         To_Structure   => NTL_Empty_Set);
      -- end of append members to structure
      --
      
      
      Two :=  Struct_Domain_Types.Ops.Count_Of(NTL_Empty_Set);
      ...
      begin
         Struct_Domain_Types.Ops.Go_To_Start (NTL_Empty_Set);
         for i in 1 .. Struct_Domain_Types.Ops.Count_Of (In_Structure => NTL_Empty_Set) loop
            Struct_Domain_Types.Ops.Extract (
               A_An_Integer     => A_Read_Number,
               A_A_Real         => A_Read_Real,
               A_Some_Text      => A_Read_String,
               A_A_Boolean      => A_Read_Boolean,
               From_Structure   => NTL_Empty_Set);
            ...
            Counter := Counter + 1;
         end loop; -- end of i in 1 .. Struct_Domain_Types.Ops.Count_Of (In_Structure => NTL_Empty_Set) loop
      ...
      Local_Test_Passed := False;
      How_Many          :=  Struct_Domain_Types.Ops.Count_Of(NTL_Empty_Set);
      ...
      Struct_Domain_Types.Ops.Initialise (NTL_Returned_Simple_Structure_1);
      ...
      Root_Object.Struct.SO.Struct_SO_Type(struct_1.all).A_Colour      := Struct_Domain_Types.Blue;
      Root_Object.Struct.SO.Struct_SO_Type(struct_1.all).Current_State := Root_Object.Struct.SO.Idle;
      
      
      Struct_SO7_Create_Simple_NTL_Structure_Service.Struct_SO7_Create_Simple_NTL_Structure (
         Test                      => Test,
         Object_Instance_Handle    => struct_1,
         Returned_Simple_Structure => NTL_Returned_Simple_Structure_1);
      
      
      Test := Test + 1;
      
      Struct_SO8_Decode_Simple_NTL_Structure_Service.Struct_SO8_Decode_Simple_NTL_Structure (
         Test             => Test,
         A_Structure      => NTL_Returned_Simple_Structure_1,
      ...
      Struct_Domain_Types.Ops.Initialise (NTL_Returned_Simple_Structure_2);
      ...
      loop
         ...
         Root_Object.Struct.SO.Struct_SO_Type(struct_2.all).A_Colour      := Struct_Domain_Types.Blue;
         ...
         Struct_SO7_Create_Simple_NTL_Structure_Service.Struct_SO7_Create_Simple_NTL_Structure (
            ...
            Returned_Simple_Structure => NTL_Returned_Simple_Structure_2);
         ...
         Struct_SO8_Decode_Simple_NTL_Structure_Service.Struct_SO8_Decode_Simple_NTL_Structure (
            Test             => Test,
            A_Structure      => NTL_Returned_Simple_Structure_2,
      ...
      Root_Object.Struct.SO.Struct_SO_Type(struct_3.all).A_Colour      := Struct_Domain_Types.Blue;
      ...
      Struct_Domain_Types.Ops.Initialise (NTL_Simple_Object_Structure_3);
      
      --
      -- start of append members to structure
      Struct_Domain_Types.Ops.Append (
         A_An_Integer   => Root_Object.Struct.SO.Struct_SO_type(struct_3.all).Reference_SO,
         A_A_Real       => Root_Object.Struct.SO.Struct_SO_type(struct_3.all).A_Real,
         A_Some_Text    => Root_Object.Struct.SO.Struct_SO_type(struct_3.all).Some_Text,
         A_A_Boolean    => Root_Object.Struct.SO.Struct_SO_type(struct_3.all).A_Boolean, 
         To_Structure   => NTL_Simple_Object_Structure_3);
      -- end of append members to structure
      --
      ...
      begin
         Pushed_Event := new
         Root_Object.Struct.SO.Struct_SO6'(Root_Object.Root_Event_Type with
            This_Event_Class => Root_Object.Struct.SO.SO6,
            Target_Instance  => struct_3,
            Test             => Test,
            A_NTL_Structure  => NTL_Simple_Object_Structure_3);
      ...
      Root_Object.Struct.SO.Struct_SO_Type(struct_4.all).A_Colour      := Struct_Domain_Types.Blue;
      ...
      Struct_Domain_Types.Ops.Initialise (NTL_Simple_Object_Structure_4);
      ...
      loop
         ...
         -- start of append members to structure
         Struct_Domain_Types.Ops.Append (
            A_An_Integer   => Root_Object.Struct.SO.Struct_SO_type(struct_4.all).An_Integer,
            A_A_Real       => Root_Object.Struct.SO.Struct_SO_type(struct_4.all).A_Real,
            A_Some_Text    => Root_Object.Struct.SO.Struct_SO_type(struct_4.all).Some_Text,
            A_A_Boolean    => Root_Object.Struct.SO.Struct_SO_type(struct_4.all).A_Boolean, 
            To_Structure   => NTL_Simple_Object_Structure_4);
         -- end of append members to structure
         --
      ...
      begin
         ...
         Root_Object.Struct.SO.Struct_SO6'(Root_Object.Root_Event_Type with
            ...
            Test             => Test,
            A_NTL_Structure  => NTL_Simple_Object_Structure_4);
      ...
      Root_Object.Struct.SO.Struct_SO_Type(struct_5.all).A_Colour      := Struct_Domain_Types.Blue;
      ...
      Struct_Domain_Types.Ops.Initialise (NTL_Simple_Object_Structure_5);
      ...
      loop
         ...
         -- start of append members to structure
         Struct_Domain_Types.Ops.Append (
            A_An_Integer   => Root_Object.Struct.SO.Struct_SO_type(struct_5.all).An_Integer,
            A_A_Real       => Root_Object.Struct.SO.Struct_SO_type(struct_5.all).A_Real,
            A_Some_Text    => Root_Object.Struct.SO.Struct_SO_type(struct_5.all).Some_Text,
            A_A_Boolean    => Root_Object.Struct.SO.Struct_SO_type(struct_5.all).A_Boolean, 
            To_Structure   => NTL_Simple_Object_Structure_5);
         -- end of append members to structure
         --
   ...
   end Struct_Scenario4;
   
--
-- End of file Struct_Scenario4.ada
--
