...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Struct_SO7_Create_Simple_NTL_Structure_Service.adb
...
package body Struct_SO7_Create_Simple_NTL_Structure_Service is
   
   procedure Struct_SO7_Create_Simple_NTL_Structure (
      Test                      : in     Application_Types.Base_Integer_Type;
      Object_Instance_Handle    : in     Root_Object.Object_Access;
      Returned_Simple_Structure :    out Struct_Domain_Types.Name_and_Type_Linked_Simple_Structure_Type) is
   ...
   begin
   -- start of SO7_Create_Simple_NTL_Structure
      ...
      Struct_RPT1_Start_Test_Bridge.Struct_RPT1_Start_Test (
         ...
         Purpose         => "Construct simple NTL structure  ");
      ...
      loop
         ...
         Struct_Domain_Types.Ops.Append (
            A_An_Integer   => Root_Object.Struct.SO.Struct_SO_type(Object_Instance_Handle.all).An_Integer,
            A_A_Real       => Root_Object.Struct.SO.Struct_SO_type(Object_Instance_Handle.all).A_Real,
            A_Some_Text    => Root_Object.Struct.SO.Struct_SO_type(Object_Instance_Handle.all).Some_Text,
            A_A_Boolean    => Root_Object.Struct.SO.Struct_SO_type(Object_Instance_Handle.all).A_Boolean, 
   ...
   end Struct_SO7_Create_Simple_NTL_Structure;
   
end Struct_SO7_Create_Simple_NTL_Structure_Service;

--
-- End of file Struct_SO7_Create_Simple_NTL_Structure_Service.adb
--
