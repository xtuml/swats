...
separate(Root_Object.Struct.SO)
   ...
   procedure Struct_SO_5 (Test           : in     Application_Types.Base_Integer_Type;
   ...
   begin
      ...
      Struct_RPT1_Start_Test_Bridge.Struct_RPT1_Start_Test (
         ...
         Purpose         => "generate simple TL decode       ");
      ...
      How_Many :=  Struct_Domain_Types.Ops.Count_Of(A_TL_Structure);
      ...
      begin
         Struct_Domain_Types.Ops.Go_To_Start (A_TL_Structure);
         for i in 1 .. Struct_Domain_Types.Ops.Count_Of (In_Structure => A_TL_Structure) loop
            Struct_Domain_Types.Ops.Extract (
               A_TLS_Integer    => the_integer,
               A_TLS_Real       => the_real,
               A_TLS_Text       => the_text,
               A_TLS_Boolean    => the_boolean,
               From_Structure   => A_TL_Structure);
         ...
         end loop; -- end of i in 1 .. Struct_Domain_Types.Ops.Count_Of (In_Structure => A_TL_Structure) loop
