...
--*************************************************************************************
--*                                                                                   *
--* File Name:               Struct_Scenario7.ada
...
use type Root_Object.Object_Access;
   ...
   begin
      ...
      if my_test_data /= Null then
         
         Root_Object.Struct.TD.Delete (
            Old_Instance => my_test_data);
      end if;
      
   end Struct_Scenario7;
   
--
-- End of file Struct_Scenario7.ada
--
