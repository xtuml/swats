...
--*************************************************************************************
--*                                                                                   *
--* File Name:               FTE1_Environment_String_Service.ads
...
package FTE_FTE1_Environment_String_Service is
   
   
   procedure FTE_FTE1_Environment_String (
      This_Environment :    out Application_Types.Base_Text_Type);
   
end FTE_FTE1_Environment_String_Service;

--
-- End of file FTE_FTE1_Environment_String_Service.ads
--
