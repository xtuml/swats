...
--*************************************************************************************
--*                                                                                   *
--* File Name:               FTE2_Environment_Number_Service.ads
...
package FTE_FTE2_Environment_Number_Service is
   
   
   procedure FTE_FTE2_Environment_Number (
      Env_Number :    out Application_Types.Base_Integer_Type);
   
end FTE_FTE2_Environment_Number_Service;

--
-- End of file FTE_FTE2_Environment_Number_Service.ads
--
