...
--*************************************************************************************
--*                                                                                   *
--* File Name:               UDT_RPT4_Test_Unsupported_Bridge.adb
...
package body UDT_RPT4_Test_Unsupported_Bridge is
   
   procedure UDT_RPT4_Test_Unsupported (
...
--
   ...
   end UDT_RPT4_Test_Unsupported;
   
end UDT_RPT4_Test_Unsupported_Bridge;

--
-- End of file UDT_RPT4_Test_Unsupported_Bridge.adb
--
