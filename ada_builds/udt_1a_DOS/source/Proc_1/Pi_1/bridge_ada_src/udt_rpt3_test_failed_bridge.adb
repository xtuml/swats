...
--*************************************************************************************
--*                                                                                   *
--* File Name:               UDT_RPT3_Test_Failed_Bridge.adb
...
package body UDT_RPT3_Test_Failed_Bridge is
...
--
   ...
   end UDT_RPT3_Test_Failed;
   
end UDT_RPT3_Test_Failed_Bridge;

--
-- End of file UDT_RPT3_Test_Failed_Bridge.adb
--
