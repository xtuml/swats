...
--*************************************************************************************
--*                                                                                   *
--* File Name:               UDT_RPT2_Test_Passed_Bridge.adb
...
package body UDT_RPT2_Test_Passed_Bridge is
...
--
   ...
   end UDT_RPT2_Test_Passed;
   
end UDT_RPT2_Test_Passed_Bridge;

--
-- End of file UDT_RPT2_Test_Passed_Bridge.adb
--
