...
--* Description:             
--*                          Domain body Root_Object.RPDUPLICATED
...
------------------------------------------------------------------------
--
package body Root_Object.RP.DUPLICATED is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_DUPLICATED_Type (This_Object.all).Who_Reported_The_Duplicated_Result;
   end Get_Who_Reported_The_Duplicated_Result;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Who_Reported_The_Duplicated_Result (
      ...
      Who_Reported_The_Duplicated_Result_Value : in RP_Domain_Types.Result_Type) is
   begin
      RP_DUPLICATED_Type (This_Object.all).Who_Reported_The_Duplicated_Result :=
         Who_Reported_The_Duplicated_Result_Value;
   end Put_Who_Reported_The_Duplicated_Result;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_DUPLICATED_Type (This_Object.all).Duplicated_Test_Count;
   end Get_Duplicated_Test_Count;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Duplicated_Test_Count (
      This_Object : in Root_Object.Object_Access;
      Duplicated_Test_Count_Value : in Application_Types.Base_Integer_Type) is
   begin
      RP_DUPLICATED_Type (This_Object.all).Duplicated_Test_Count :=
         Duplicated_Test_Count_Value;
   end Put_Duplicated_Test_Count;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Duplicated_Test_Number (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return RP_DUPLICATED_Type (This_Object.all).Duplicated_Test_Number;
   end Get_Duplicated_Test_Number;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Duplicated_Test_Number (
      This_Object : in Root_Object.Object_Access;
      Duplicated_Test_Number_Value : in Application_Types.Base_Integer_Type) is
   begin
      RP_DUPLICATED_Type (This_Object.all).Duplicated_Test_Number :=
         Duplicated_Test_Number_Value;
   end Put_Duplicated_Test_Number;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Which_Test_Number (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return RP_DUPLICATED_Type (This_Object.all).Which_Test_Number;
   end Get_Which_Test_Number;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Which_Test_Number (
      This_Object : in Root_Object.Object_Access;
      Which_Test_Number_Value : in Application_Types.Base_Integer_Type) is
   begin
      RP_DUPLICATED_Type (This_Object.all).Which_Test_Number :=
         Which_Test_Number_Value;
   end Put_Which_Test_Number;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_DUPLICATED_Type (This_Object.all).R4_A;
   end Get_R4_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R4_A (
      This_Object : in Root_Object.Object_Access;
      R4_A_Value : in Root_Object.Object_Access) is
   begin
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new RP_DUPLICATED_Type;
