...
------------------------------------------------------------------------
--
package body Root_Object.RP.RM is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Unique_Req_Met_ID_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Unique_Req_Met_ID return Application_Types.Base_Integer_Type is
   begin
      Unique_Req_Met_ID_Value :=
         Application_Types.Base_Integer_Type'succ (Unique_Req_Met_ID_Value);
      return Unique_Req_Met_ID_Value;
   end Obtain_Subsequent_Unique_Req_Met_ID;
...
--ADATEST IGNORE_ON
   function Get_Unique_Req_Met_ID (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return RP_RM_Type (This_Object.all).Unique_Req_Met_ID;
   end Get_Unique_Req_Met_ID;
...
--ADATEST IGNORE_ON
   procedure Put_Unique_Req_Met_ID (
      This_Object : in Root_Object.Object_Access;
      Unique_Req_Met_ID_Value : in Application_Types.Base_Integer_Type) is
   begin
      RP_RM_Type (This_Object.all).Unique_Req_Met_ID :=
         Unique_Req_Met_ID_Value;
   end Put_Unique_Req_Met_ID;

--ADATEST IGNORE_OFF

------------------------------------------------------------------------
   --
   -- procedure Put_Unique_REQS_ID and 
   --
   -- function Get_Unique_REQS_ID
   --
   -- have not been generated for Unique_REQS_ID
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_RM_Type (This_Object.all).Domain_Name;
   end Get_Domain_Name;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      RP_RM_Type (This_Object.all).Domain_Name :=
         Domain_Name_Value;
   end Put_Domain_Name;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Meeting_Test_Number (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return RP_RM_Type (This_Object.all).Meeting_Test_Number;
   end Get_Meeting_Test_Number;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Meeting_Test_Number (
      This_Object : in Root_Object.Object_Access;
      Meeting_Test_Number_Value : in Application_Types.Base_Integer_Type) is
   begin
      RP_RM_Type (This_Object.all).Meeting_Test_Number :=
         Meeting_Test_Number_Value;
   end Put_Meeting_Test_Number;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   function Get_Requid_Test_Result (
      This_Object: Root_Object.Object_Access) return RP_Domain_Types.Result_Type is
   begin
      return RP_RM_Type (This_Object.all).Requid_Test_Result;
   end Get_Requid_Test_Result;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Requid_Test_Result (
      This_Object : in Root_Object.Object_Access;
      Requid_Test_Result_Value : in RP_Domain_Types.Result_Type) is
   begin
      RP_RM_Type (This_Object.all).Requid_Test_Result :=
         Requid_Test_Result_Value;
   end Put_Requid_Test_Result;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Domain_Number (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return RP_RM_Type (This_Object.all).Domain_Number;
...
--ADATEST IGNORE_ON
   ...
   begin
      RP_RM_Type (This_Object.all).Domain_Number :=
         Domain_Number_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_RM_Type (This_Object.all).R12_A;
   end Get_R12_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R12_A (
      This_Object : in Root_Object.Object_Access;
      R12_A_Value : in Root_Object.Object_Access) is
   begin
      RP_RM_Type (This_Object.all).R12_A :=
         R12_A_Value;
   end Put_R12_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new RP_RM_Type;
   
      else
         This_Object := Free_List.First_Entry;
         RP_RM_Type(This_Object.all).Unique_Req_Met_ID := Application_Types.Base_Integer_Type_First;
         RP_RM_Type(This_Object.all).Domain_Name := Application_Types.Base_Text_Type_First;
         RP_RM_Type(This_Object.all).Meeting_Test_Number := Application_Types.Base_Integer_Type_First;
         RP_RM_Type(This_Object.all).Requid_Test_Result := RP_Domain_Types.Result_Type_First;
         RP_RM_Type(This_Object.all).Domain_Number := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      RP_RM_Type(This_Object.all).Unique_Req_Met_ID :=
         Obtain_Subsequent_Unique_Req_Met_ID;
