...
--*************************************************************************************
--*                                                                                   *
--* File Name:               RP2_Test_Failed_Service.ads
...
package RP_RP2_Test_Failed_Service is
   ...
   procedure RP_RP2_Test_Failed (
      ...
      Failed_Domain_Number : in     Application_Types.Base_Integer_Type);
   
end RP_RP2_Test_Failed_Service;

--
-- End of file RP_RP2_Test_Failed_Service.ads
--
