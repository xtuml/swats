...
--* Description:             
--*                          Domain body Root_Object.UDTINT
...
------------------------------------------------------------------------
--
package body Root_Object.UDT.INT is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return UDT_INT_Type (This_Object.all).First_Integer;
   end Get_First_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_First_Integer (
      ...
      First_Integer_Value : in UDT_Domain_Types.Subset_1_Of_Integer) is
   begin
      UDT_INT_Type (This_Object.all).First_Integer :=
         First_Integer_Value;
   end Put_First_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Second_Integer (
      This_Object: Root_Object.Object_Access) return UDT_Domain_Types.Subset_Minus_1_Of_Integer is
   begin
      return UDT_INT_Type (This_Object.all).Second_Integer;
   end Get_Second_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Second_Integer (
      This_Object : in Root_Object.Object_Access;
      Second_Integer_Value : in UDT_Domain_Types.Subset_Minus_1_Of_Integer) is
   begin
      UDT_INT_Type (This_Object.all).Second_Integer :=
         Second_Integer_Value;
   end Put_Second_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Third_Integer (
      This_Object: Root_Object.Object_Access) return UDT_Domain_Types.Subset_Zero_Of_Integer is
   begin
      return UDT_INT_Type (This_Object.all).Third_Integer;
   end Get_Third_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Third_Integer (
      This_Object : in Root_Object.Object_Access;
      Third_Integer_Value : in UDT_Domain_Types.Subset_Zero_Of_Integer) is
   begin
      UDT_INT_Type (This_Object.all).Third_Integer :=
         Third_Integer_Value;
   end Put_Third_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Fourth_Integer (
      This_Object: Root_Object.Object_Access) return UDT_Domain_Types.One_To_Maximum_Integer is
   begin
      return UDT_INT_Type (This_Object.all).Fourth_Integer;
   end Get_Fourth_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Fourth_Integer (
      This_Object : in Root_Object.Object_Access;
      Fourth_Integer_Value : in UDT_Domain_Types.One_To_Maximum_Integer) is
   begin
      UDT_INT_Type (This_Object.all).Fourth_Integer :=
         Fourth_Integer_Value;
   end Put_Fourth_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Fifth_Integer (
      This_Object: Root_Object.Object_Access) return UDT_Domain_Types.Minimum_To_Minus_One_Integer is
   begin
      return UDT_INT_Type (This_Object.all).Fifth_Integer;
   end Get_Fifth_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Fifth_Integer (
      This_Object : in Root_Object.Object_Access;
      Fifth_Integer_Value : in UDT_Domain_Types.Minimum_To_Minus_One_Integer) is
   begin
      UDT_INT_Type (This_Object.all).Fifth_Integer :=
         Fifth_Integer_Value;
   end Put_Fifth_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Sixth_Integer (
      This_Object: Root_Object.Object_Access) return UDT_Domain_Types.Minimum_To_Maximum_Integer is
   begin
      return UDT_INT_Type (This_Object.all).Sixth_Integer;
   end Get_Sixth_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Sixth_Integer (
      This_Object : in Root_Object.Object_Access;
      Sixth_Integer_Value : in UDT_Domain_Types.Minimum_To_Maximum_Integer) is
   begin
      UDT_INT_Type (This_Object.all).Sixth_Integer :=
         Sixth_Integer_Value;
   end Put_Sixth_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
       return UDT_INT_Type (This_Object.all).Unique_Identifier;
...
--ADATEST IGNORE_ON
   ...
   begin
      UDT_INT_Type (This_Object.all).Unique_Identifier :=
         Unique_Identifier_Value;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new UDT_INT_Type;
   
      else
         This_Object := Free_List.First_Entry;
         UDT_INT_Type(This_Object.all).First_Integer := UDT_Domain_Types.Subset_1_Of_Integer_First;
         UDT_INT_Type(This_Object.all).Second_Integer := UDT_Domain_Types.Subset_Minus_1_Of_Integer_First;
         UDT_INT_Type(This_Object.all).Third_Integer := UDT_Domain_Types.Subset_Zero_Of_Integer_First;
         UDT_INT_Type(This_Object.all).Fourth_Integer := UDT_Domain_Types.One_To_Maximum_Integer_First;
         UDT_INT_Type(This_Object.all).Fifth_Integer := UDT_Domain_Types.Minimum_To_Minus_One_Integer_First;
         UDT_INT_Type(This_Object.all).Sixth_Integer := UDT_Domain_Types.Minimum_To_Maximum_Integer_First;
         UDT_INT_Type(This_Object.all).Unique_Identifier := Application_Types.Base_Integer_Type_First;
