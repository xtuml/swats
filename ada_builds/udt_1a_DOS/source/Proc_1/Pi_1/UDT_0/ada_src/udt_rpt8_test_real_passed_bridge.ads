...
--*************************************************************************************
--*                                                                                   *
--* File Name:               UDT_RPT8_Test_Real_Passed_Bridge.ads
...
package UDT_RPT8_Test_Real_Passed_Bridge is
   ...
   procedure UDT_RPT8_Test_Real_Passed (
      ...
      Test_Result        : in     Application_Types.Base_Float_Type);
   
end UDT_RPT8_Test_Real_Passed_Bridge;

--
-- End of file UDT_RPT8_Test_Real_Passed_Bridge.ads
--
