...
--* Description:             
--*                          Domain body Root_Object.UDTFTD
...
------------------------------------------------------------------------
--
package body Root_Object.UDT.FTD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return UDT_FTD_Type (This_Object.all).Final_Test_Number;
   end Get_Final_Test_Number;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Final_Test_Number (
      ...
      Final_Test_Number_Value : in Application_Types.Base_Integer_Type) is
   begin
      UDT_FTD_Type (This_Object.all).Final_Test_Number :=
         Final_Test_Number_Value;
   end Put_Final_Test_Number;
--ADATEST IGNORE_OFF
