...
--*************************************************************************************
--*                                                                                   *
--* File Name:               UDT1_Check_The_Integers_Service.ads
...
package UDT_UDT1_Check_The_Integers_Service is
   ...
   procedure UDT_UDT1_Check_The_Integers (
      ...
      The_Requid  : in     Application_Types.Base_Text_Type);
   
end UDT_UDT1_Check_The_Integers_Service;

--
-- End of file UDT_UDT1_Check_The_Integers_Service.ads
--
