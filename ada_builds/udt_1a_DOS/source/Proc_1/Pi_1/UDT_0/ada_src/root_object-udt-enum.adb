...
--* Description:             
--*                          Domain body Root_Object.UDTENUM
...
------------------------------------------------------------------------
--
package body Root_Object.UDT.ENUM is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return UDT_ENUM_Type (This_Object.all).First_Enum;
   end Get_First_Enum;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_First_Enum (
      ...
      First_Enum_Value : in UDT_Domain_Types.Simple_Enumeration_Type) is
   begin
      UDT_ENUM_Type (This_Object.all).First_Enum :=
         First_Enum_Value;
   end Put_First_Enum;
--ADATEST IGNORE_OFF
...
------------------------------------------------------------------------
   ...
   Second_Enum_Value : UDT_Domain_Types.Colour_Type := UDT_Domain_Types.Colour_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Second_Enum return UDT_Domain_Types.Colour_Type is
   begin
      Second_Enum_Value :=
         UDT_Domain_Types.Colour_Type'succ (Second_Enum_Value);
      return Second_Enum_Value;
   end Obtain_Subsequent_Second_Enum;
...
--ADATEST IGNORE_ON
   function Get_Second_Enum (
      This_Object : Root_Object.Object_Access) return UDT_Domain_Types.Colour_Type is
   begin
       return UDT_ENUM_Type (This_Object.all).Second_Enum;
   end Get_Second_Enum;
...
--ADATEST IGNORE_ON
   procedure Put_Second_Enum (
      This_Object : in Root_Object.Object_Access;
      Second_Enum_Value : in UDT_Domain_Types.Colour_Type) is
   begin
      UDT_ENUM_Type (This_Object.all).Second_Enum :=
         Second_Enum_Value;
   end Put_Second_Enum;
...
------------------------------------------------------------------------
   ...
   Third_Enum_Value : UDT_Domain_Types.Temp_Type := UDT_Domain_Types.Temp_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Third_Enum return UDT_Domain_Types.Temp_Type is
   begin
      Third_Enum_Value :=
         UDT_Domain_Types.Temp_Type'succ (Third_Enum_Value);
      return Third_Enum_Value;
   end Obtain_Subsequent_Third_Enum;
...
--ADATEST IGNORE_ON
   function Get_Third_Enum (
      This_Object : Root_Object.Object_Access) return UDT_Domain_Types.Temp_Type is
   begin
       return UDT_ENUM_Type (This_Object.all).Third_Enum;
   end Get_Third_Enum;
...
--ADATEST IGNORE_ON
   procedure Put_Third_Enum (
      This_Object : in Root_Object.Object_Access;
      Third_Enum_Value : in UDT_Domain_Types.Temp_Type) is
   begin
      UDT_ENUM_Type (This_Object.all).Third_Enum :=
         Third_Enum_Value;
   end Put_Third_Enum;
...
--ADATEST IGNORE_ON
   ...
   begin
      return UDT_ENUM_Type (This_Object.all).theID;
   end Get_theID;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_theID (
      This_Object : in Root_Object.Object_Access;
      theID_Value : in Application_Types.Base_Integer_Type) is
   begin
      UDT_ENUM_Type (This_Object.all).theID :=
         theID_Value;
   end Put_theID;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new UDT_ENUM_Type;
   
      else
         This_Object := Free_List.First_Entry;
         UDT_ENUM_Type(This_Object.all).First_Enum := UDT_Domain_Types.Simple_Enumeration_Type_First;
         UDT_ENUM_Type(This_Object.all).Second_Enum := UDT_Domain_Types.Colour_Type_First;
         UDT_ENUM_Type(This_Object.all).Third_Enum := UDT_Domain_Types.Temp_Type_First;
         UDT_ENUM_Type(This_Object.all).theID := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      UDT_ENUM_Type(This_Object.all).Second_Enum :=
         Obtain_Subsequent_Second_Enum;
      UDT_ENUM_Type(This_Object.all).Third_Enum :=
         Obtain_Subsequent_Third_Enum;
