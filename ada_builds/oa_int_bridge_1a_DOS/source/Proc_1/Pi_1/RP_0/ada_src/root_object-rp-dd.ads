...
--* Description:             
--*                          Domain specification Root_Object.RPDD
...
package Root_Object.RP.DD is
--
------------------------------------------------------------------------
   --
   --**************  Object Domain_Details Information **************
   --
   -- Object DD is ACTIVE
   --
   --
   --
   -- Object DD is ACTIVE and has the following state actions defined
   --   Non_Existent,
   --   Idle,
   --   Report_Your_Findings,
   --   Kill_Yourself.
   --
   -- Object DD has an identifying non-referential attribute Domain_Number 
   -- and therefore may be uniquely created.
   -- 
   -- Object DD has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "DD";

   --
   -------------------------------------------------------------------------------------------------
   --

   type RP_DD_Type is new RP_Type with record
      ...
      Domain_Name : Application_Types.Base_Text_Type := Application_Types.Base_Text_Type_First;

      --
      -- Initialised Non identifying non referential
      Last_Reported_Test_Number : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Non Identifying referential. Thou Shalt Not Use. 
      -- Unique_TS_Identifier : Application_Types.Base_Integer_Type;
   
      --
      -- Initialised Non identifying non referential
      Current_State :  Object_State_Type :=  Object_State_Type_First;

      R1_B : Root_Object.Object_Access := null;
      R2_B : Root_Object.Object_Access := null;
      R3_B : Root_Object.Object_Access := null;
      R4_B : Root_Object.Object_List.List_Header_Access_Type;
      R8_B : Root_Object.Object_List.List_Header_Access_Type;
      R10_A : Root_Object.Object_Access := null;
      R9_B : Root_Object.Object_List.List_Header_Access_Type;
   ...
   procedure Put_Domain_Number (
      ...
      Domain_Number_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Domain_Number);
   pragma inline (Put_Domain_Number);
   ...
   procedure Put_Domain_Name (
      This_Object : in Root_Object.Object_Access;
      Domain_Name_Value : in Application_Types.Base_Text_Type);

   pragma inline (Get_Domain_Name);
   pragma inline (Put_Domain_Name);
   ...
   procedure Put_Last_Reported_Test_Number (
      This_Object : in Root_Object.Object_Access;
      Last_Reported_Test_Number_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Last_Reported_Test_Number);
   pragma inline (Put_Last_Reported_Test_Number);
   ...
   procedure Put_R1_B (
      This_Object :   in  Root_Object.Object_Access;
      R1_B_Value : in Root_Object.Object_Access);

   pragma inline (Get_R1_B);
   pragma inline (Put_R1_B);
   ...
   procedure Put_R2_B (
      This_Object :   in  Root_Object.Object_Access;
      R2_B_Value : in Root_Object.Object_Access);

   pragma inline (Get_R2_B);
   pragma inline (Put_R2_B);
   ...
   procedure Put_R3_B (
      This_Object :   in  Root_Object.Object_Access;
      R3_B_Value : in Root_Object.Object_Access);

   pragma inline (Get_R3_B);
   pragma inline (Put_R3_B);
   ...
   procedure Put_R4_B  (
      This_Object :    in  Root_Object.Object_Access;
      R4_B_Value : in Root_Object.Object_List.List_Header_Access_Type);

   pragma inline (Get_R4_B);
   pragma inline (Put_R4_B);
   ...
   procedure Put_R8_B  (
      This_Object :    in  Root_Object.Object_Access;
      R8_B_Value : in Root_Object.Object_List.List_Header_Access_Type);

   pragma inline (Get_R8_B);
   pragma inline (Put_R8_B);
   ...
   procedure Put_R10_A (
      This_Object :   in  Root_Object.Object_Access;
      R10_A_Value : in Root_Object.Object_Access);

   pragma inline (Get_R10_A);
   pragma inline (Put_R10_A);
   ...
   procedure Put_R9_B  (
      This_Object :    in  Root_Object.Object_Access;
      R9_B_Value : in Root_Object.Object_List.List_Header_Access_Type);

   pragma inline (Get_R9_B);
   pragma inline (Put_R9_B);
   ...
   -- EVENT DECLARATION
   --
   type RP_DD_Event_Type is new RP_Event_Type with
   record
   ...
   --    
   type RP_DD_Instance_Event_Type is new RP_DD_Event_Type with
   record
   ...
   ------------------------------------------------------------------------
   type RP_DD_Description_Event is new RP_DD_Instance_Event_Type with
   record
      null;
   end record;  
   --
   ...
   type RP_DD1 is new RP_DD_Instance_Event_Type with
   record 
      null;
   end record;

   type RP_DD2 is new RP_DD_Instance_Event_Type with
   record 
      null;
   end record;
   ...
   package RP_DD_Event_Queue is new Generic_FIFO (Root_Object.Root_Event_Access_Type); 

   RP_DD_Queue: RP_DD_Event_Queue.FIFO_Type;
