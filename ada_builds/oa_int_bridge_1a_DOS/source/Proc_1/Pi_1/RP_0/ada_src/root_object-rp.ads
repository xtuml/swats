...
--
--    db      07/05/02        SRLE100001027     Conditionally generated 'with' for RP domain types package.
--
...
package Root_Object.RP is
-------------------------------------------------------------------------------------------------
  type RP_Type is new Root_Object.Object_Type with
    record
      null;
    end record;
-------------------------------------------------------------------------------------------------
  type RP_Event_Type is new Root_Object.Root_Event_Type with
    record
      null;
    end record;
-------------------------------------------------------------------------------------------------
