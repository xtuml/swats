...
--* Description:             
--*                          Domain specification Root_Object.RPFAIL
...
package Root_Object.RP.FAIL is
--
------------------------------------------------------------------------
   --
   --**************  Object A_Test_That_Failed Information **************
   --
   -- Object FAIL is PASSIVE
   --
   --
   --
   -- Object FAIL has an identifying non-referential attribute fail_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object FAIL has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "FAIL";

   --
   -------------------------------------------------------------------------------------------------
   --

   type RP_FAIL_Type is new RP_Type with record

      --
      -- Non initialised identifying non referential
      fail_id : Application_Types.Base_Integer_Type;
      ...
      Failed_Counter : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
   ...
   procedure Put_fail_id (
      ...
      fail_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_fail_id);
   pragma inline (Put_fail_id);
   ...
   procedure Put_Failed_Counter (
      This_Object : in Root_Object.Object_Access;
      Failed_Counter_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Failed_Counter);
   pragma inline (Put_Failed_Counter);
