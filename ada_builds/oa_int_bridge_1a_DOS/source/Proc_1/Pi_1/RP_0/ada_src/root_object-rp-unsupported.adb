...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.RP.UNSUPPORTED.adb
...
--* Description:             
--*                          Domain body Root_Object.RPUNSUPPORTED
...
------------------------------------------------------------------------
--
package body Root_Object.RP.UNSUPPORTED is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   unsupported_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_unsupported_id return Application_Types.Base_Integer_Type is
   begin
      unsupported_id_Value :=
         Application_Types.Base_Integer_Type'succ (unsupported_id_Value);
      return unsupported_id_Value;
   end Obtain_Subsequent_unsupported_id;
...
--ADATEST IGNORE_ON
   function Get_unsupported_id (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return RP_UNSUPPORTED_Type (This_Object.all).unsupported_id;
   end Get_unsupported_id;
...
--ADATEST IGNORE_ON
   procedure Put_unsupported_id (
      This_Object : in Root_Object.Object_Access;
      unsupported_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      RP_UNSUPPORTED_Type (This_Object.all).unsupported_id :=
         unsupported_id_Value;
   end Put_unsupported_id;
...
--ADATEST IGNORE_ON
   function Get_Unsupported_Counter (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return RP_UNSUPPORTED_Type (This_Object.all).Unsupported_Counter;
   end Get_Unsupported_Counter;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Unsupported_Counter (
      This_Object : in Root_Object.Object_Access;
      Unsupported_Counter_Value : in Application_Types.Base_Integer_Type) is
   begin
      RP_UNSUPPORTED_Type (This_Object.all).Unsupported_Counter :=
         Unsupported_Counter_Value;
   end Put_Unsupported_Counter;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_UNSUPPORTED_Type (This_Object.all).R3_A;
   end Get_R3_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R3_A (
      This_Object : in Root_Object.Object_Access;
      R3_A_Value : in Root_Object.Object_Access) is
   begin
      RP_UNSUPPORTED_Type (This_Object.all).R3_A :=
         R3_A_Value;
   end Put_R3_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new RP_UNSUPPORTED_Type;
   
      else
         This_Object := Free_List.First_Entry;
         RP_UNSUPPORTED_Type(This_Object.all).unsupported_id := Application_Types.Base_Integer_Type_First;
         RP_UNSUPPORTED_Type(This_Object.all).Unsupported_Counter := Application_Types.Base_Integer_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      RP_UNSUPPORTED_Type(This_Object.all).unsupported_id :=
         Obtain_Subsequent_unsupported_id;
...
end Root_Object.RP.UNSUPPORTED;
