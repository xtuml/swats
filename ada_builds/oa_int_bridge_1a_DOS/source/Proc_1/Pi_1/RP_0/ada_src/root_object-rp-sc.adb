...
------------------------------------------------------------------------
--
package body Root_Object.RP.SC is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_SC_Type (This_Object.all).The_Comment;
   end Get_The_Comment;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_The_Comment (
      This_Object : in Root_Object.Object_Access;
      The_Comment_Value : in Application_Types.Base_Text_Type) is
   begin
      RP_SC_Type (This_Object.all).The_Comment :=
         The_Comment_Value;
   end Put_The_Comment;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_The_Test_No (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return RP_SC_Type (This_Object.all).The_Test_No;
   end Get_The_Test_No;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      RP_SC_Type (This_Object.all).The_Test_No :=
         The_Test_No_Value;
   end Put_The_Test_No;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_Comment_ID (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return RP_SC_Type (This_Object.all).Comment_ID;
   end Get_Comment_ID;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_Comment_ID (
      This_Object : in Root_Object.Object_Access;
      Comment_ID_Value : in Application_Types.Base_Integer_Type) is
   begin
      RP_SC_Type (This_Object.all).Comment_ID :=
         Comment_ID_Value;
   end Put_Comment_ID;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return RP_SC_Type (This_Object.all).R9_A;
   end Get_R9_A;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_R9_A (
      This_Object : in Root_Object.Object_Access;
      R9_A_Value : in Root_Object.Object_Access) is
   begin
      RP_SC_Type (This_Object.all).R9_A :=
         R9_A_Value;
   end Put_R9_A;
--ADATEST IGNORE_OFF
