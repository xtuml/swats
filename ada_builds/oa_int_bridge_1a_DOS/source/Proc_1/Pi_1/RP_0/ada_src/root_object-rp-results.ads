...
--* Description:             
--*                          Domain specification Root_Object.RPRESULTS
...
--  ----------------------------------  
--  package Root_Object.RP.RESULTS
...
package Root_Object.RP.RESULTS is
--
------------------------------------------------------------------------
   --
   --**************  Object Results_Of_Tests Information **************
   --
   -- Object RESULTS is PASSIVE
   --
   --
   --
   -- Object RESULTS has an identifying non-referential attribute results_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object RESULTS has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "RESULTS";

   --
   -------------------------------------------------------------------------------------------------
   --

   type RP_RESULTS_Type is new RP_Type with record

      --
      -- Non initialised identifying non referential
      results_id : Application_Types.Base_Integer_Type;

      --
      -- Initialised Non identifying non referential
      The_Number_Of_Test : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      The_Name_Of_The_Domain : Application_Types.Base_Text_Type := Application_Types.Base_Text_Type_First;

      --
      -- Initialised Non identifying non referential
      The_Result_Of_Test : RP_Domain_Types.Result_Type := RP_Domain_Types.Result_Type_First;

      --
      -- Initialised Non identifying non referential
      The_Value_Of_The_Result : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      The_Purpose_Of_Test : Application_Types.Base_Text_Type := Application_Types.Base_Text_Type_First;

      --
      -- Initialised Non identifying non referential
      The_No_Of_Duplicated_Results : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      The_Result_Of_Object : Application_Types.Base_Text_Type := Application_Types.Base_Text_Type_First;
      ...
      --
      -- Initialised Non identifying non referential
      Domain_Test_Details : Application_Types.Base_Text_Type := Application_Types.Base_Text_Type_First;

      --
      R6_A : Root_Object.Object_Access := null;

   end record;

   Attribute_Count : constant Application_Types.Base_Integer_Type := 9;
   ...
   procedure Put_results_id (
      ...
      results_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_results_id);
   pragma inline (Put_results_id);
   ...
   procedure Put_The_Number_Of_Test (
      This_Object : in Root_Object.Object_Access;
      The_Number_Of_Test_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_The_Number_Of_Test);
   pragma inline (Put_The_Number_Of_Test);
   ...
   procedure Put_The_Name_Of_The_Domain (
      This_Object : in Root_Object.Object_Access;
      The_Name_Of_The_Domain_Value : in Application_Types.Base_Text_Type);

   pragma inline (Get_The_Name_Of_The_Domain);
   pragma inline (Put_The_Name_Of_The_Domain);
   ...
   procedure Put_The_Result_Of_Test (
      This_Object : in Root_Object.Object_Access;
      The_Result_Of_Test_Value : in RP_Domain_Types.Result_Type);

   pragma inline (Get_The_Result_Of_Test);
   pragma inline (Put_The_Result_Of_Test);
   ...
   procedure Put_The_Value_Of_The_Result (
      This_Object : in Root_Object.Object_Access;
      The_Value_Of_The_Result_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_The_Value_Of_The_Result);
   pragma inline (Put_The_Value_Of_The_Result);
   ...
   procedure Put_The_Purpose_Of_Test (
      This_Object : in Root_Object.Object_Access;
      The_Purpose_Of_Test_Value : in Application_Types.Base_Text_Type);

   pragma inline (Get_The_Purpose_Of_Test);
   pragma inline (Put_The_Purpose_Of_Test);
   ...
   procedure Put_The_No_Of_Duplicated_Results (
      This_Object : in Root_Object.Object_Access;
      The_No_Of_Duplicated_Results_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_The_No_Of_Duplicated_Results);
   pragma inline (Put_The_No_Of_Duplicated_Results);
   ...
   procedure Put_The_Result_Of_Object (
      This_Object : in Root_Object.Object_Access;
      The_Result_Of_Object_Value : in Application_Types.Base_Text_Type);

   pragma inline (Get_The_Result_Of_Object);
   pragma inline (Put_The_Result_Of_Object);
   ...
   procedure Put_Domain_Test_Details (
      This_Object : in Root_Object.Object_Access;
      Domain_Test_Details_Value : in Application_Types.Base_Text_Type);

   pragma inline (Get_Domain_Test_Details);
   pragma inline (Put_Domain_Test_Details);
   ...
   procedure Put_R6_A (
      This_Object :   in  Root_Object.Object_Access;
      R6_A_Value : in Root_Object.Object_Access);

   pragma inline (Get_R6_A);
   pragma inline (Put_R6_A);
