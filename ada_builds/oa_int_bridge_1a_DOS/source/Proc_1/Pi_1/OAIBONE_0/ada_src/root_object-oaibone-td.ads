...
--* Description:             
--*                          Domain specification Root_Object.OAIBONETD
...
--  ----------------------------------  
--  package Root_Object.OAIBONE.TD
...
package Root_Object.OAIBONE.TD is
--
------------------------------------------------------------------------
   --
   ...
   type OAIBONE_TD_Type is new OAIBONE_Type with record
