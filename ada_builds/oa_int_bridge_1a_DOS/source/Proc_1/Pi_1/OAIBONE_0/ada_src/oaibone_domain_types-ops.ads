...
--*************************************************************************************
--*                                                                                   *
--* File Name:               OAIBONE_domain_types.ops.ads
...
--*  package specification OAIBONE_Domain_Types.Ops 
--*
--*************************************************************************************
--  MODIFICATION RECORD
--  --------------------
...
package OAIBONE_Domain_Types.Ops is
  pragma Elaborate_Body (OAIBONE_Domain_Types.Ops);
  --
  ----------------------------------------------------------------------------------------------
  -- 
   procedure Append (
...
----------------------------------------------------------------------------------------------
   procedure Append (
      A_The_Range: in OAIBONE_Domain_Types.Pos;
      To_Structure: in out Structure_Of_UDTs);
    
   procedure Extract (
      A_The_Range: out OAIBONE_Domain_Types.Pos;
...
----------------------------------------------------------------------------------------------
   procedure Append (
      ...
      A_Source_Colour: in OAIBONE_Domain_Types.Colour_Type;
   ...
   procedure Extract (
      ...
      A_Source_Colour: out OAIBONE_Domain_Types.Colour_Type;
