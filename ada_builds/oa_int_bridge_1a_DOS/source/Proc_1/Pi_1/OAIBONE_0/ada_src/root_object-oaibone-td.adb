...
--* Description:             
--*                          Domain body Root_Object.OAIBONETD
...
------------------------------------------------------------------------
--
package body Root_Object.OAIBONE.TD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
--ADATEST IGNORE_ON
   ...
   begin
       return OAIBONE_TD_Type (This_Object.all).td_id;
   end Get_td_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      OAIBONE_TD_Type (This_Object.all).td_id :=
         td_id_Value;
   end Put_td_id;
...
--ADATEST IGNORE_ON
   function Get_This_Test_Number (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return OAIBONE_TD_Type (This_Object.all).This_Test_Number;
   end Get_This_Test_Number;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_This_Test_Number (
      This_Object : in Root_Object.Object_Access;
      This_Test_Number_Value : in Application_Types.Base_Integer_Type) is
   begin
      OAIBONE_TD_Type (This_Object.all).This_Test_Number :=
         This_Test_Number_Value;
   end Put_This_Test_Number;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new OAIBONE_TD_Type;
   
      else
         This_Object := Free_List.First_Entry;
         OAIBONE_TD_Type(This_Object.all).td_id := Application_Types.Base_Integer_Type_First;
         OAIBONE_TD_Type(This_Object.all).This_Test_Number := Application_Types.Base_Integer_Type_First;
