...
--* Description:             
--*                          Domain body Root_Object.OAIBONESBD
...
------------------------------------------------------------------------
--
package body Root_Object.OAIBONE.SBD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Reference_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Reference return Application_Types.Base_Integer_Type is
   begin
      Reference_Value :=
         Application_Types.Base_Integer_Type'succ (Reference_Value);
      return Reference_Value;
   end Obtain_Subsequent_Reference;
...
--ADATEST IGNORE_ON
   ...
   begin
       return OAIBONE_SBD_Type (This_Object.all).Reference;
   end Get_Reference;
...
--ADATEST IGNORE_ON
   procedure Put_Reference (
      ...
      Reference_Value : in Application_Types.Base_Integer_Type) is
   begin
      OAIBONE_SBD_Type (This_Object.all).Reference :=
         Reference_Value;
   end Put_Reference;
...
--ADATEST IGNORE_ON
   function Get_The_Integer (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return OAIBONE_SBD_Type (This_Object.all).The_Integer;
   end Get_The_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_The_Integer (
      This_Object : in Root_Object.Object_Access;
      The_Integer_Value : in Application_Types.Base_Integer_Type) is
   begin
      OAIBONE_SBD_Type (This_Object.all).The_Integer :=
         The_Integer_Value;
   end Put_The_Integer;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return OAIBONE_SBD_Type (This_Object.all).The_Real;
   end Get_The_Real;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_The_Real (
      This_Object : in Root_Object.Object_Access;
      The_Real_Value : in Application_Types.Base_Float_Type) is
   begin
      OAIBONE_SBD_Type (This_Object.all).The_Real :=
         The_Real_Value;
   end Put_The_Real;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return OAIBONE_SBD_Type (This_Object.all).The_String;
   end Get_The_String;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_The_String (
      This_Object : in Root_Object.Object_Access;
      The_String_Value : in Application_Types.Base_Text_Type) is
   begin
      OAIBONE_SBD_Type (This_Object.all).The_String :=
         The_String_Value;
   end Put_The_String;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   function Get_The_Colour (
      This_Object: Root_Object.Object_Access) return OAIBONE_Domain_Types.Colour_Type is
   begin
      return OAIBONE_SBD_Type (This_Object.all).The_Colour;
   end Get_The_Colour;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_The_Colour (
      This_Object : in Root_Object.Object_Access;
      The_Colour_Value : in OAIBONE_Domain_Types.Colour_Type) is
   begin
      OAIBONE_SBD_Type (This_Object.all).The_Colour :=
         The_Colour_Value;
   end Put_The_Colour;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      return OAIBONE_SBD_Type (This_Object.all).The_Boolean;
   end Get_The_Boolean;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   procedure Put_The_Boolean (
      This_Object : in Root_Object.Object_Access;
      The_Boolean_Value : in  Boolean) is
   begin
      OAIBONE_SBD_Type (This_Object.all).The_Boolean :=
         The_Boolean_Value;
   end Put_The_Boolean;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new OAIBONE_SBD_Type;
   
      else
         This_Object := Free_List.First_Entry;
         OAIBONE_SBD_Type(This_Object.all).Reference := Application_Types.Base_Integer_Type_First;
         OAIBONE_SBD_Type(This_Object.all).The_Integer := Application_Types.Base_Integer_Type_First;
         OAIBONE_SBD_Type(This_Object.all).The_Real := Application_Types.Base_Float_Type_First;
         OAIBONE_SBD_Type(This_Object.all).The_String := Application_Types.Base_Text_Type_First;
         OAIBONE_SBD_Type(This_Object.all).The_Colour := OAIBONE_Domain_Types.Colour_Type_First;
         OAIBONE_SBD_Type(This_Object.all).The_Boolean := Application_Types.Boolean_First;
