...
--*************************************************************************************
--*                                                                                   *
--* File Name:               OAIBONE_domain_types.ads
...
--* Description:             
--*                          OAIBONE Domain Data Types Package Specification
...
--*  package specification OAIBONE_Domain_Types 
--*
--*************************************************************************************
--  MODIFICATION RECORD
--  --------------------
...
package OAIBONE_Domain_Types is
   pragma Elaborate_Body (OAIBONE_Domain_Types);
...
--
   ...
   type Structure_Of_UDTs_Node is record
      The_Range : OAIBONE_Domain_Types.Pos := OAIBONE_Domain_Types.Pos_First;
...
--
   ...
   type Source_Structure_Type_Node is record
      ...
      Source_Colour : OAIBONE_Domain_Types.Colour_Type := OAIBONE_Domain_Types.Colour_Type_First;
