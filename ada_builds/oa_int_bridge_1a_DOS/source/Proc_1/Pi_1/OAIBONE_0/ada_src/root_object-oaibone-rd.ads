...
--* Description:             
--*                          Domain specification Root_Object.OAIBONERD
...
--  ----------------------------------  
--  package Root_Object.OAIBONE.RD
...
package Root_Object.OAIBONE.RD is
--
------------------------------------------------------------------------
   --
   ...
   type OAIBONE_RD_Type is new OAIBONE_Type with record
