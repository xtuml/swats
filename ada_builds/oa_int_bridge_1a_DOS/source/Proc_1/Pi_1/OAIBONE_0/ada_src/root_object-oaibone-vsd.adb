...
--* Description:             
--*                          Domain body Root_Object.OAIBONEVSD
...
------------------------------------------------------------------------
--
package body Root_Object.OAIBONE.VSD is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   Object_Reference_VSD_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_Object_Reference_VSD return Application_Types.Base_Integer_Type is
   begin
      Object_Reference_VSD_Value :=
         Application_Types.Base_Integer_Type'succ (Object_Reference_VSD_Value);
      return Object_Reference_VSD_Value;
   end Obtain_Subsequent_Object_Reference_VSD;
...
--ADATEST IGNORE_ON
   function Get_Object_Reference_VSD (
      This_Object : Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
       return OAIBONE_VSD_Type (This_Object.all).Object_Reference_VSD;
   end Get_Object_Reference_VSD;
...
--ADATEST IGNORE_ON
   procedure Put_Object_Reference_VSD (
      This_Object : in Root_Object.Object_Access;
      Object_Reference_VSD_Value : in Application_Types.Base_Integer_Type) is
   begin
      OAIBONE_VSD_Type (This_Object.all).Object_Reference_VSD :=
         Object_Reference_VSD_Value;
   end Put_Object_Reference_VSD;
...
--ADATEST IGNORE_ON
   function Get_Object_Simple_Integer (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Integer_Type is
   begin
      return OAIBONE_VSD_Type (This_Object.all).Object_Simple_Integer;
   end Get_Object_Simple_Integer;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Object_Simple_Integer (
      This_Object : in Root_Object.Object_Access;
      Object_Simple_Integer_Value : in Application_Types.Base_Integer_Type) is
   begin
      OAIBONE_VSD_Type (This_Object.all).Object_Simple_Integer :=
         Object_Simple_Integer_Value;
   end Put_Object_Simple_Integer;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   function Get_Object_Simple_Real (
      This_Object: Root_Object.Object_Access) return Application_Types.Base_Float_Type is
   begin
      return OAIBONE_VSD_Type (This_Object.all).Object_Simple_Real;
   end Get_Object_Simple_Real;
--ADATEST IGNORE_OFF

------------------------------------------------------------------------

--ADATEST IGNORE_ON
   procedure Put_Object_Simple_Real (
      This_Object : in Root_Object.Object_Access;
      Object_Simple_Real_Value : in Application_Types.Base_Float_Type) is
   begin
      OAIBONE_VSD_Type (This_Object.all).Object_Simple_Real :=
         Object_Simple_Real_Value;
   end Put_Object_Simple_Real;
--ADATEST IGNORE_OFF
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new OAIBONE_VSD_Type;
   
      else
         This_Object := Free_List.First_Entry;
         OAIBONE_VSD_Type(This_Object.all).Object_Reference_VSD := Application_Types.Base_Integer_Type_First;
         OAIBONE_VSD_Type(This_Object.all).Object_Simple_Integer := Application_Types.Base_Integer_Type_First;
         OAIBONE_VSD_Type(This_Object.all).Object_Simple_Real := Application_Types.Base_Float_Type_First;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      OAIBONE_VSD_Type(This_Object.all).Object_Reference_VSD :=
         Obtain_Subsequent_Object_Reference_VSD;
