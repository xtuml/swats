...
--* Description:             
--*                          Domain specification Root_Object.OAIBONEVSD
...
--  ----------------------------------  
--  package Root_Object.OAIBONE.VSD
...
package Root_Object.OAIBONE.VSD is
--
------------------------------------------------------------------------
   --
   --**************  Object Very_Simple_Data_Object Information **************
   --
   -- Object VSD is PASSIVE
   --
   --
   --
   -- Object VSD has an identifying non-referential attribute Object_Reference_VSD 
   -- and therefore may be uniquely created.
   -- 
   -- Object VSD has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "VSD";

   --
   -------------------------------------------------------------------------------------------------
   --

   type OAIBONE_VSD_Type is new OAIBONE_Type with record

      --
      -- Non initialised identifying non referential
      Object_Reference_VSD : Application_Types.Base_Integer_Type;

      --
      -- Initialised Non identifying non referential
      Object_Simple_Integer : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;

      --
      -- Initialised Non identifying non referential
      Object_Simple_Real : Application_Types.Base_Float_Type := Application_Types.Base_Float_Type_First;
   ...
   procedure Put_Object_Reference_VSD (
      ...
      Object_Reference_VSD_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Object_Reference_VSD);
   pragma inline (Put_Object_Reference_VSD);
   ...
   procedure Put_Object_Simple_Integer (
      This_Object : in Root_Object.Object_Access;
      Object_Simple_Integer_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_Object_Simple_Integer);
   pragma inline (Put_Object_Simple_Integer);
   ...
   procedure Put_Object_Simple_Real (
      This_Object : in Root_Object.Object_Access;
      Object_Simple_Real_Value : in Application_Types.Base_Float_Type);

   pragma inline (Get_Object_Simple_Real);
   pragma inline (Put_Object_Simple_Real);
