...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.OAIBTWO.IITGWO.ads
...
--* Description:             
--*                          Domain specification Root_Object.OAIBTWOIITGWO
...
--  ----------------------------------  
--  package Root_Object.OAIBTWO.IITGWO
...
package Root_Object.OAIBTWO.IITGWO is
--
------------------------------------------------------------------------
   --
   --**************  Object I_Into_The_Great_Wide_Open Information **************
   --
   -- Object IITGWO is PASSIVE
   --
   --
   --
   -- Object IITGWO has an identifying non-referential attribute iitgwo_id 
   -- and therefore may be uniquely created.
   -- 
   -- Object IITGWO has no TAGS.
   --
   ------------------------------------------------------------------------
   -- *********************  State Actions ********************************
   ------------------------------------------------------------------------
   ...
   Object_String : String := "IITGWO";

   --
   -------------------------------------------------------------------------------------------------
   --

   type OAIBTWO_IITGWO_Type is new OAIBTWO_Type with record

      --
      -- Non initialised identifying non referential
      iitgwo_id : Application_Types.Base_Integer_Type;
   ...
   procedure Put_iitgwo_id (
      ...
      iitgwo_id_Value : in Application_Types.Base_Integer_Type);

   pragma inline (Get_iitgwo_id);
   pragma inline (Put_iitgwo_id);
