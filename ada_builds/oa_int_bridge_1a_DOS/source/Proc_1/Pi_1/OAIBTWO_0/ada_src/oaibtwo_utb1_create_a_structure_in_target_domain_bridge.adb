...
--*************************************************************************************
--*                                                                                   *
--* File Name:               OAIBTWO_UTB1_Create_A_Structure_In_Target_Domain_Bridge.adb
...
package body OAIBTWO_UTB1_Create_A_Structure_In_Target_Domain_Bridge is
   ...
   end OAIBTWO_UTB1_Create_A_Structure_In_Target_Domain;
   
end OAIBTWO_UTB1_Create_A_Structure_In_Target_Domain_Bridge;

--
-- End of file OAIBTWO_UTB1_Create_A_Structure_In_Target_Domain_Bridge.adb
--
