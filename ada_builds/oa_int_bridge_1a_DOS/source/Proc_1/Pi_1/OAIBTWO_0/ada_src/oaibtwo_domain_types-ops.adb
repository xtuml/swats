...
--*************************************************************************************
--*                                                                                   *
--* File Name:               OAIBTWO_domain_types.ops.adb
...
--*  package body OAIBTWO_Domain_Types.Ops 
--*
--*************************************************************************************
--  MODIFICATION RECORD
--  --------------------
...
package body OAIBTWO_Domain_Types.Ops is
    
   procedure Append (
      A_Source_Simple_Integer : in    Application_Types.Base_Integer_Type;
      A_Source_Simple_Real : in    Application_Types.Base_Float_Type;
      To_Structure : in out Very_Simple_Source_Structure_Type) is
                       
   Temp_Structure: Very_Simple_Source_Structure_Type_Node_Access :=
      new Very_Simple_Source_Structure_Type_Node'(
         Source_Simple_Integer  => A_Source_Simple_Integer,
         Source_Simple_Real  => A_Source_Simple_Real,
         Next_Structure     => null,
...
--  --
   procedure Extract (
      ...
      From_Structure : in    Very_Simple_Source_Structure_Type) is
   ...
   begin
      ...
      A_Source_Simple_Integer := From_Structure.Iterator.all.Source_Simple_Integer;
      A_Source_Simple_Real := From_Structure.Iterator.all.Source_Simple_Real;
...
--  -------------------------------------------------------------------------------------------
--  --
   procedure Go_To_Start (Of_Structure : in Very_Simple_Source_Structure_Type) is
   begin
...
--  -------------------------------------------------------------------------------------------
--  --
   function Not_Empty (In_Structure : Very_Simple_Source_Structure_Type) return boolean is
   begin
...
--  -------------------------------------------------------------------------------------------
--  --
   function  Count_Of    (In_Structure : Very_Simple_Source_Structure_Type) return Application_Types.Base_Integer_Type is
...
--  -------------------------------------------------------------------------------------------
--  --
   procedure Initialise (Object : in out Very_Simple_Source_Structure_Type) is

      Next:     Very_Simple_Source_Structure_Type_Node_Access;
      Old_Cell: Very_Simple_Source_Structure_Type_Node_Access;
...
--  --
   ...
   procedure Append (
      ...
      A_Source_Colour : in    OAIBTWO_Domain_Types.Colour_Type;
...
--  --
   procedure Extract (
      ...
      A_Source_Colour :    out OAIBTWO_Domain_Types.Colour_Type ;
   ...
   begin
      ...
      A_Source_String := From_Structure.Iterator.all.Source_String;
