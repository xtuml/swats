...
--*************************************************************************************
--*                                                                                   *
--* File Name:               r.OAIBTWO.IITGWO.adb
...
--* Description:             
--*                          Domain body Root_Object.OAIBTWOIITGWO
...
------------------------------------------------------------------------
--
package body Root_Object.OAIBTWO.IITGWO is
--
------------------------------------------------------------------------
--***********************  OOA Environment *****************************
------------------------------------------------------------------------
...
------------------------------------------------------------------------
   ...
   iitgwo_id_Value : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_first;
--
--ADATEST IGNORE_ON
   function Obtain_Subsequent_iitgwo_id return Application_Types.Base_Integer_Type is
   begin
      iitgwo_id_Value :=
         Application_Types.Base_Integer_Type'succ (iitgwo_id_Value);
      return iitgwo_id_Value;
   end Obtain_Subsequent_iitgwo_id;
...
--ADATEST IGNORE_ON
   procedure Put_iitgwo_id (
      This_Object : in Root_Object.Object_Access;
      iitgwo_id_Value : in Application_Types.Base_Integer_Type) is
   begin
      OAIBTWO_IITGWO_Type (This_Object.all).iitgwo_id :=
         iitgwo_id_Value;
   end Put_iitgwo_id;
...
--ADATEST IGNORE_ON
   ...
   begin
      ...
      if Free_List.First_Entry = null then
         This_Object := new OAIBTWO_IITGWO_Type;
   
      else
         This_Object := Free_List.First_Entry;
         OAIBTWO_IITGWO_Type(This_Object.all).iitgwo_id := Application_Types.Base_Integer_Type_First;
...
end Root_Object.OAIBTWO.IITGWO;
