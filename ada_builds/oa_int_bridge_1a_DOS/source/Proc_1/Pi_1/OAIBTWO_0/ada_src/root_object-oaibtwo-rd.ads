...
--* Description:             
--*                          Domain specification Root_Object.OAIBTWORD
...
--  ----------------------------------  
--  package Root_Object.OAIBTWO.RD
...
package Root_Object.OAIBTWO.RD is
--
------------------------------------------------------------------------
   --
   ...
   type OAIBTWO_RD_Type is new OAIBTWO_Type with record
