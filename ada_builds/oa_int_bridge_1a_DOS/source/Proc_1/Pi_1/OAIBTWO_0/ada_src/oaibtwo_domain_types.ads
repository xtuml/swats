...
--*************************************************************************************
--*                                                                                   *
--* File Name:               OAIBTWO_domain_types.ads
...
--* Description:             
--*                          OAIBTWO Domain Data Types Package Specification
...
--*  package specification OAIBTWO_Domain_Types 
--*
--*************************************************************************************
--  MODIFICATION RECORD
--  --------------------
...
package OAIBTWO_Domain_Types is
   pragma Elaborate_Body (OAIBTWO_Domain_Types);
...
--
   ...
   type Very_Simple_Source_Structure_Type_Node;
   type Very_Simple_Source_Structure_Type_Node_Access is access all Very_Simple_Source_Structure_Type_Node;
   type Very_Simple_Source_Structure_Type_Node_Access_Pointer is access Very_Simple_Source_Structure_Type_Node_Access;
     
   type Very_Simple_Source_Structure_Type is new Domain_Structure with record
      Iterator          : Very_Simple_Source_Structure_Type_Node_Access_Pointer := null;
      First_Entry       : Very_Simple_Source_Structure_Type_Node_Access := null;
      Last_Entry        : Very_Simple_Source_Structure_Type_Node_Access := null;
      Number_Of_Entries : Application_Types.Base_Integer_Type := 0;
   end record;
       
   type Very_Simple_Source_Structure_Type_Node is record
      Source_Simple_Integer : Application_Types.Base_Integer_Type := Application_Types.Base_Integer_Type_First;
      Source_Simple_Real : Application_Types.Base_Float_Type := Application_Types.Base_Float_Type_First;
      Next_Structure     : Very_Simple_Source_Structure_Type_Node_Access := null;
      Previous_Structure : Very_Simple_Source_Structure_Type_Node_Access := null;
   end record;
    
   procedure Initialize (Object : in out Very_Simple_Source_Structure_Type);

   procedure Adjust     (Object : in out Very_Simple_Source_Structure_Type);

   procedure Finalize   (Object : in out Very_Simple_Source_Structure_Type);
...
--
   ...
   type Source_Structure_Type_Node is record
      ...
      Source_String : Application_Types.Base_Text_Type := Application_Types.Base_Text_Type_First;
      Source_Boolean :  Boolean := Application_Types.Boolean_First;
      Source_Colour : OAIBTWO_Domain_Types.Colour_Type := OAIBTWO_Domain_Types.Colour_Type_First;
