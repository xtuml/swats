...
--*************************************************************************************
--*                                                                                   *
--* File Name:               OAIBONE_RPT1_Start_Test_Bridge.adb
...
package body OAIBONE_RPT1_Start_Test_Bridge is
   
   procedure OAIBONE_RPT1_Start_Test (
...
--
   ...
   end OAIBONE_RPT1_Start_Test;
   
end OAIBONE_RPT1_Start_Test_Bridge;

--
-- End of file OAIBONE_RPT1_Start_Test_Bridge.adb
--
