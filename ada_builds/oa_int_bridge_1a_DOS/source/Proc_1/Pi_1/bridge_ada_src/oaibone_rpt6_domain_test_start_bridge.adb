...
--*************************************************************************************
--*                                                                                   *
--* File Name:               OAIBONE_RPT6_Domain_Test_Start_Bridge.adb
...
package body OAIBONE_RPT6_Domain_Test_Start_Bridge is
   
   procedure OAIBONE_RPT6_Domain_Test_Start (
...
--
         ...
         Root_Object.OAIBONE.RD.OAIBONE_RD_type(My_Report.all).Reported_Domain_Number := New_Domain_Number;
         
      end if;
      
      
   end OAIBONE_RPT6_Domain_Test_Start;
   
end OAIBONE_RPT6_Domain_Test_Start_Bridge;

--
-- End of file OAIBONE_RPT6_Domain_Test_Start_Bridge.adb
--
