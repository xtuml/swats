...
--*************************************************************************************
--*                                                                                   *
--* File Name:               OAIBONE_RPT4_Test_Unsupported_Bridge.adb
...
package body OAIBONE_RPT4_Test_Unsupported_Bridge is
   
   procedure OAIBONE_RPT4_Test_Unsupported (
   ...
   -- start of RPT4_Test_Unsupported
      ...
      The_Reporter_Object := Root_Object.OAIBONE.RD.Unconditional_Find_One;
...
--
         ...
         Unique_Domain_ID := Root_Object.OAIBONE.RD.OAIBONE_RD_type(The_Reporter_Object.all).Reported_Domain_Number;
...
--
   ...
   end OAIBONE_RPT4_Test_Unsupported;
   
end OAIBONE_RPT4_Test_Unsupported_Bridge;

--
-- End of file OAIBONE_RPT4_Test_Unsupported_Bridge.adb
--
