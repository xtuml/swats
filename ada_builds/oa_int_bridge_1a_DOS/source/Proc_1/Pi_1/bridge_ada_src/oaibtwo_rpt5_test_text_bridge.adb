...
--*************************************************************************************
--*                                                                                   *
--* File Name:               OAIBTWO_RPT5_Test_Text_Bridge.adb
...
package body OAIBTWO_RPT5_Test_Text_Bridge is
   
   procedure OAIBTWO_RPT5_Test_Text (
...
--
   ...
   end OAIBTWO_RPT5_Test_Text;
   
end OAIBTWO_RPT5_Test_Text_Bridge;

--
-- End of file OAIBTWO_RPT5_Test_Text_Bridge.adb
--
