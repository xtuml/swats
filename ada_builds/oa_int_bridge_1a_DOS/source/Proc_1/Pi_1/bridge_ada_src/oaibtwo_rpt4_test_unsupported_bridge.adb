...
--*************************************************************************************
--*                                                                                   *
--* File Name:               OAIBTWO_RPT4_Test_Unsupported_Bridge.adb
...
package body OAIBTWO_RPT4_Test_Unsupported_Bridge is
   
   procedure OAIBTWO_RPT4_Test_Unsupported (
   ...
   -- start of RPT4_Test_Unsupported
      ...
      The_Reporter_Object := Root_Object.OAIBTWO.RD.Unconditional_Find_One;
...
--
         ...
         Unique_Domain_ID := Root_Object.OAIBTWO.RD.OAIBTWO_RD_type(The_Reporter_Object.all).Reported_Domain_Number;
...
--
   ...
   end OAIBTWO_RPT4_Test_Unsupported;
   
end OAIBTWO_RPT4_Test_Unsupported_Bridge;

--
-- End of file OAIBTWO_RPT4_Test_Unsupported_Bridge.adb
--
