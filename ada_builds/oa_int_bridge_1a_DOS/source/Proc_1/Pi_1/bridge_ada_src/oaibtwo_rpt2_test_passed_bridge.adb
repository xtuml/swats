...
--*************************************************************************************
--*                                                                                   *
--* File Name:               OAIBTWO_RPT2_Test_Passed_Bridge.adb
...
package body OAIBTWO_RPT2_Test_Passed_Bridge is
   
   procedure OAIBTWO_RPT2_Test_Passed (
...
--
   ...
   end OAIBTWO_RPT2_Test_Passed;
   
end OAIBTWO_RPT2_Test_Passed_Bridge;

--
-- End of file OAIBTWO_RPT2_Test_Passed_Bridge.adb
--
