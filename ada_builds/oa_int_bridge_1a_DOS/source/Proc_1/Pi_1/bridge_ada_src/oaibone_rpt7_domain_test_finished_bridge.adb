...
--*************************************************************************************
--*                                                                                   *
--* File Name:               OAIBONE_RPT7_Domain_Test_Finished_Bridge.adb
...
package body OAIBONE_RPT7_Domain_Test_Finished_Bridge is
   
   procedure OAIBONE_RPT7_Domain_Test_Finished (
   ...
   -- start of RPT7_Domain_Test_Finished
      ...
      My_Report := Root_Object.OAIBONE.RD.Unconditional_Find_One;
...
--
         ...
         local_domain_number := Root_Object.OAIBONE.RD.OAIBONE_RD_type(My_Report.all).Reported_Domain_Number;
...
--
   ...
   end OAIBONE_RPT7_Domain_Test_Finished;
   
end OAIBONE_RPT7_Domain_Test_Finished_Bridge;

--
-- End of file OAIBONE_RPT7_Domain_Test_Finished_Bridge.adb
--
