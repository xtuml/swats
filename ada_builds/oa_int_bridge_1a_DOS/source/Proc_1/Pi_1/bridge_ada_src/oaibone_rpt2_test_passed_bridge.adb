...
--*************************************************************************************
--*                                                                                   *
--* File Name:               OAIBONE_RPT2_Test_Passed_Bridge.adb
...
package body OAIBONE_RPT2_Test_Passed_Bridge is
   
   procedure OAIBONE_RPT2_Test_Passed (
...
--
   ...
   end OAIBONE_RPT2_Test_Passed;
   
end OAIBONE_RPT2_Test_Passed_Bridge;

--
-- End of file OAIBONE_RPT2_Test_Passed_Bridge.adb
--
