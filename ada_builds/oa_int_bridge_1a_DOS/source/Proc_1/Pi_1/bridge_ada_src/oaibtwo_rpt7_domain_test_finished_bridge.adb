...
--*************************************************************************************
--*                                                                                   *
--* File Name:               OAIBTWO_RPT7_Domain_Test_Finished_Bridge.adb
...
package body OAIBTWO_RPT7_Domain_Test_Finished_Bridge is
   
   procedure OAIBTWO_RPT7_Domain_Test_Finished (
...
--
         ...
         local_domain_number := Root_Object.OAIBTWO.RD.OAIBTWO_RD_type(My_Report.all).Reported_Domain_Number;
...
--
   ...
   end OAIBTWO_RPT7_Domain_Test_Finished;
   
end OAIBTWO_RPT7_Domain_Test_Finished_Bridge;

--
-- End of file OAIBTWO_RPT7_Domain_Test_Finished_Bridge.adb
--
