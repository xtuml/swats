...
--*************************************************************************************
--*                                                                                   *
--* File Name:               OAIBONE_RPT5_Test_Text_Bridge.adb
...
package body OAIBONE_RPT5_Test_Text_Bridge is
   
   procedure OAIBONE_RPT5_Test_Text (
...
--
   ...
   end OAIBONE_RPT5_Test_Text;
   
end OAIBONE_RPT5_Test_Text_Bridge;

--
-- End of file OAIBONE_RPT5_Test_Text_Bridge.adb
--
