...
--*************************************************************************************
--*                                                                                   *
--* File Name:               OAIBTWO_RPT1_Start_Test_Bridge.adb
...
package body OAIBTWO_RPT1_Start_Test_Bridge is
   
   procedure OAIBTWO_RPT1_Start_Test (
...
--
   ...
   end OAIBTWO_RPT1_Start_Test;
   
end OAIBTWO_RPT1_Start_Test_Bridge;

--
-- End of file OAIBTWO_RPT1_Start_Test_Bridge.adb
--
