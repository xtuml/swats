...
--*************************************************************************************
--*                                                                                   *
--* File Name:               OAIBTWO_RPT3_Test_Failed_Bridge.adb
...
package body OAIBTWO_RPT3_Test_Failed_Bridge is
   
   procedure OAIBTWO_RPT3_Test_Failed (
...
--
   ...
   end OAIBTWO_RPT3_Test_Failed;
   
end OAIBTWO_RPT3_Test_Failed_Bridge;

--
-- End of file OAIBTWO_RPT3_Test_Failed_Bridge.adb
--
