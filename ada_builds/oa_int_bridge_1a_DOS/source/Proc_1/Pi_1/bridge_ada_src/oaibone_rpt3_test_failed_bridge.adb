...
--*************************************************************************************
--*                                                                                   *
--* File Name:               OAIBONE_RPT3_Test_Failed_Bridge.adb
...
package body OAIBONE_RPT3_Test_Failed_Bridge is
   
   procedure OAIBONE_RPT3_Test_Failed (
...
--
   ...
   end OAIBONE_RPT3_Test_Failed;
   
end OAIBONE_RPT3_Test_Failed_Bridge;

--
-- End of file OAIBONE_RPT3_Test_Failed_Bridge.adb
--
